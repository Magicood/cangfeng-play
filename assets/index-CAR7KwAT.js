...
「养得不错，」他说，「再等等。」`;case`遗孤`:return`那枚旧玉佩终于对上了。有人认出了它，脸色瞬间变了。`;case`双生`:return`你在千里之外受伤的那天，另一个人也在同一处疼。你们从未见过。`;case`罪裔`:return`族谱上那一页被撕掉了。撕掉的地方，纸背还留着压痕 —— 你能认出那几个字。`;case`无名`:return`天机阁推了三次，三次都是空白。掌事的手在抖：「你……是从哪儿来的？」`;case`归来者`:return`你在一具无名尸骸旁停下。它手上戴的储物戒，和你梦里那枚一模一样。`}}function ft(e){let t=pe.find(t=>t.id===e);if(!t)return 1;let n=pe.reduce((e,t)=>e+t.weight,0);return Math.round(n/t.weight*10)/10}var pt=[`金手指`,`残魂`,`真实血脉`,`真实修为`,`杀过某人`,`身世`];function mt(e,t,n,r){e.actor.secrets[t]=k(e.actor.secrets[t]+n,0,100),r&&!e.knowers.some(e=>e.npc===r&&e.secret===t)&&e.knowers.push({npc:r,secret:t,risk:k(n/20,.05,.9)})}function ht(e){let t=e.actor,n=xe(t.僭越),r=Ce(t);n.hunted>0&&(t.secrets.金手指=k(t.secrets.金手指+n.hunted*4,0,100),t.secrets.真实修为=k(t.secrets.真实修为+n.hunted*2,0,100));for(let n of e.knowers)e.rng.chance(n.risk*.06)&&(t.secrets[n.secret]=k(t.secrets[n.secret]+6,0,100));let i=.8+r*2.2;for(let e of pt)t.secrets[e]=Math.max(0,t.secrets[e]-i)}function gt(e){return pt.filter(t=>e.actor.secrets[t]>=E.revealAt)}function _t(e,t){let n=e.knowers.filter(e=>e.npc===t).map(e=>e.secret);e.knowers=e.knowers.filter(e=>e.npc!==t);for(let t of n)e.actor.secrets[t]=Math.max(0,e.actor.secrets[t]-18);return e.actor.业障+=12+n.length*5,e.actor.道心=k(e.actor.道心-3,0,100),n}function vt(e,t){let n=e.knowers.findIndex(e=>e.npc===t);if(n<0)return!1;let r=e.knowers[n];return e.actor.secrets[r.secret]=Math.max(0,e.actor.secrets[r.secret]-10),e.knowers.splice(n,1),e.actor.业障+=2,!0}function yt(e){let t=e.actor;t.僭越=0,t.名望=0,t.锋芒=0;for(let e of pt)t.secrets[e]=0;e.knowers=[],t.factors.情报=.85,t.factors.伙伴=.9,t.factors.道侣=1,e.flags.add(`假死脱身`)}function bt(e){let t=Ce(e.actor);return{faceSlapMult:1+t*(fe.faceSlapMultMax-1),decayBonus:t*fe.decayBonusMax,resourcePenalty:t*fe.resourcePenaltyMax}}function xt(e){let{decayBonus:t}=bt(e),n=1+k(e.actor.功德,0,300)/600;e.actor.僭越=Math.max(0,e.actor.僭越-ae.decayBase*(1+t)*n)}var St={守尸人:{name:`婴死体存 · 守尸人`,grade:`凡碑`,mult:.8,text:`肉身还在，元婴没了。往后的日子靠药和阵撑着，等一个「借婴」的法子。`},痴儿:{name:`神识裂解 · 痴儿`,grade:`凡碑`,mult:.9,text:`修为还在，人不在了。你在山里走来走去，见谁都笑，谁的名字都想不起来。`},虚空漂流:{name:`虚空吞噬 · 漂流者`,grade:`灵碑`,mult:1.1,text:`虚空裂开的那一瞬间你没抓住任何东西。此后你还活着，只是再也回不去了。`},残魂:{name:`道体崩解 · 化为残魂`,grade:`玄碑`,mult:1.4,text:`肉身尽毁，只余一缕。你飘在原地，看着自己的洞府积灰 —— 你终于成了你当年遇到的那种东西。`},地缚灵:{name:`道消 · 地缚`,grade:`凡碑`,mult:.7,text:`执念缚在这片死地上。偶尔有人路过，你想说话，他们听不见。`}},Ct={药王谷:`药王谷谷主`,东海:`东海岛主`,中州:`一城之主`,山野:`山野散人`,宗门:`太上长老`,北荒:`妖蛮部落王`,西域:`佛国住持`,坊市:`坊市巨商`,剑冢:`剑冢守墓人`};function wt(e){let t=e.actor,n=ze(t),r=le;if(e.death&&e.death.cause.kind!==`寿元`){let n=e.death.cause.kind;return{id:`death_${n}`,name:`夭折 · ${n}`,tier:`夭折`,grade:`凡碑`,fruitMult:.3+t.tier*.08,text:e.death.cause.description}}if(e.failedBranch){let n=e.failedBranch.branch?St[e.failedBranch.branch]:void 0;return n?{id:`branch_${e.failedBranch.branch}`,name:n.name,tier:`夭折`,grade:n.grade,fruitMult:n.mult+t.tier*.1,text:n.text}:{id:`tribulation_failed`,name:`${e.failedBranch.name} · ${e.failedBranch.outcome}`,tier:`夭折`,grade:`凡碑`,fruitMult:.6+t.tier*.1,text:e.failedBranch.outcome}}if(t.souls.some(e=>e.possession>=100))return{id:`possessed`,name:`被夺舍 · ${t.souls.find(e=>e.possession>=100).name}`,tier:`夭折`,grade:`凡碑`,fruitMult:.5,text:`你最后的念头是：他早就说过的。`};if(t.堕度>=100)return{id:`possessed_by_demon`,name:`入魔失控`,tier:`夭折`,grade:`血道碑`,fruitMult:1.2,text:`你还在，但那个「你」已经不在了。往后有人会用你的名字，做你不会做的事。`};if(t.tier>=10)return t.path===`武道`&&t.talent.root===`无灵根`&&n>=r.以凡证道.perfection?{id:`mortal_ascend`,name:`以凡证道`,tier:`隐藏`,grade:`无字碑`,fruitMult:O.noSystemMult,text:`你从头到尾都是个凡人。然后你打赢了神仙。`}:n>=r.真仙.perfection&&t.僭越<r.真仙.transgression&&t.hiddenRealms.length>=9&&e.jieXian?{id:`true_immortal`,name:`真仙`,tier:`飞升`,grade:`道碑`,fruitMult:6,text:`云开，天梯落下。你回头看了一眼这座你活了千年的山，然后走了上去。`}:t.堕度>=se.transcendBand[0]&&t.堕度<=se.transcendBand[1]&&n>=r.堕仙.perfection&&(e.reflections??0)>=3?{id:`fallen_immortal`,name:`堕仙 · 魔祖证道`,tier:`飞升`,grade:`血道碑`,fruitMult:O.transcendMult,text:`此道自我而始，亦自我而终。后来者，勿效。`}:{id:`ascend`,name:`飞升 · 上位面一员`,tier:`飞升`,grade:`天碑`,fruitMult:3,text:`天梯尽头是另一片天。你抬头，发现上面还有人在往上走。`};if(e.steppedDown){let r=Ct[e.rootedAt??`山野`]??`一方之主`,i=n>=80?`玄碑`:`灵碑`;return{id:`local_${e.rootedAt??`山野`}`,name:`偏安一隅 · ${r}`,tier:`偏安`,grade:i,fruitMult:1+t.tier*.15+n/100,text:`你在这里住了下来。后来有人问起你是谁，你说，就是个种药的。`}}return!e.death&&t.tier>=5&&t.功德>200&&t.僭越<20&&n>=85?{id:`seclusion`,name:`归隐`,tier:`隐藏`,grade:`无字碑`,fruitMult:4,text:`你把修为散了。散得干干净净，像从来没修过一样。`}:t.tier>=9?n>=r.位面主宰.perfection&&t.僭越<r.位面主宰.transgression?{id:`plane_sovereign`,name:`位面主宰`,tier:`主宰`,grade:`地碑`,fruitMult:2.2,text:`这一界之内，再无人能让你抬头。而你抬头时，看见的还是那层没破的天。`}:{id:`stuck_at_9`,name:`止步渡劫期`,tier:`主宰`,grade:`玄碑`,fruitMult:1.6,text:`你在渡劫期停了下来。天劫还在上面等着，你知道自己过不去。`}:t.tier>=5?{id:`elder_${t.tier}`,name:`一方尊长 · 老死于此界`,tier:`偏安`,grade:n>=80?`玄碑`:`灵碑`,fruitMult:.9+t.tier*.14+n/150,text:`你没能再往上走一步。但这一界之内，认得你名字的人已经不多了 —— 比你年长的都死光了。`}:t.tier>=3?{id:`mortal_end_${t.tier}`,name:`碌碌一生 · 尚有薄名`,tier:`偏安`,grade:`灵碑`,fruitMult:.6+t.tier*.12,text:`结了丹，也就到此为止了。山下的人还记得你，山上的人已经忘了。`}:{id:`mortal_end_${t.tier}`,name:`碌碌一生`,tier:`偏安`,grade:`凡碑`,fruitMult:.5+t.tier*.12,text:`没什么可说的。这样的人，这座山上每年都要埋掉几十个。`}}function Tt(e,t,n={}){let r=ze(e),i=e.tier*10+r*.6,a=t.fruitMult;n.noSystem&&(a*=O.noSystemMult/3),e.堕度>=46&&(a*=O.corruptMult/2),e.goldFingerTier>=0&&(a*=O.tierMult[e.goldFingerTier]??1),a*=O.difficultyMult[n.difficulty??`修士`]??1;let o=e.锋芒>0?Math.max(0,1-e.锋芒/Math.max(e.tier,1)):1;return a*=1+o*.35,Math.round(i*a)}function Et(e){return e.tier>=le.地方大佬.minTier&&e.alive}function Dt(e,t,n){return{tick:t,year:Math.floor(n),tier:e.tier,道心:Math.round(e.道心),僭越:Math.round(e.僭越),堕度:Math.round(e.堕度),气运:Math.round(e.气运),名望:Math.round(e.名望),perfection:Math.round(ze(e))}}function Ot(e,t,n){let r=Math.max(1,Math.floor(n-t.createdYear)),i=t.resolved;if(t.polarity>0)return e.pick([`后来他活得不错，只是再没见过你。他跟人提起过一次，说当年有个人帮过他，可惜没问名字。`,`他记了你一辈子。临终前把这件事讲给了孙辈听，讲得添油加醋。`,`他后来也修出了点名堂。有人问他师承何处，他说，是一个只见过一面的人。`,`他没等到还这份人情的机会。你死的消息传到他那儿时，他沉默了很久。`]);if(t.polarity<0){if(i){let n=[`这笔账在第 ${Math.floor(t.createdYear)+Math.floor(r*.6)} 年了了。之后再没人提起。`,`他死在了你前面。死因与你无关，但也不能说全无关系。`,`你们最后一次见面时谁也没说话。这事就这么过去了。`];return e.pick(n)}let n=[`他等了你 ${r} 年，等到你死也没等来。这口气他带进了棺材。`,`他把这笔账留给了后人。你的名字被写在一张纸上，压在他家祠堂的供桌下面。`,`他后来做了和你一样的事，对另一个人。`,`他一直在找你。你死那年，他刚好走到离你三百里的地方。`];return e.pick(n)}return`此后各自行路，再无交集。`}function kt(e){switch(e.type){case`救助`:case`施恩`:return`你救过/帮过的人`;case`杀戮`:return`死在你手上的人`;case`背叛`:return`被你辜负的人`;case`夺取`:return`被你拿走过东西的人`;case`受辱`:return`欺负过你的人`;case`毁诺`:return`你食言过的人`;case`欺骗`:return`被你骗过的人`;case`传承`:return`把东西留给你的人`;case`放走`:return`你放过一马的人`;case`灭门`:return`被你灭门的人`;case`立誓`:return`你许过诺的人`}}function At(e){let{actor:t,ledger:n,death:r,ending:i}=e,a=new f(`${e.seed}:chronicle`),o=n.filter(e=>e.resolved),s=Je(n),c=new Set,l=[...n].sort((e,t)=>t.weight-e.weight).slice(0,12).map(t=>{let n=Ot(a,t,e.diedAtYear);for(let r=0;r<3&&c.has(n);r++)n=Ot(a,t,e.diedAtYear);return c.add(n),{name:t.target,relation:kt(t),whatYouDid:`第 ${Math.floor(t.createdYear)} 年 · ${t.type}（因果重 ${t.weight}）`,afterward:n}}),u=[...e.flags].filter(e=>e.startsWith(`道·`)||e.startsWith(`结丹·`)||[`无系统`,`得系统`,`拒绝过系统`,`假死脱身`,`手上有人命`,`已立威`].includes(e)),d=ze(t);return{timeline:e.milestones,deathChain:r?jt(r):null,missedWindows:r?.missedWindows??[],karmaResolved:o,karmaUnresolved:s,karmaNet:Math.round(Ye(n)),people:l,curve:e.curve,forks:u,verdict:Mt(t,n,i,e.diedAtYear),unfinished:s.slice(0,8).map(e=>`第 ${Math.floor(e.createdYear)} 年欠下的「${e.type}」—— ${e.target}（重 ${e.weight}）`),name:t.name,path:t.path,origin:t.origin,originRarity:ft(t.origin),tier:t.tier,lifespan:Math.floor(t.ageMonths/12),perfection:Math.round(d*10)/10,concealment:Math.round(Ce(t)*100)/100,ending:i}}function jt(e){return e.chain.map((e,t)=>`${t+1}. 第 ${Math.floor(e.createdYear)} 年 · ${e.type} · ${e.target}（重 ${e.weight}）`).join(`
`)}function Mt(e,t,n,r){let i=ze(e),a=t.filter(e=>e.type===`杀戮`).length,o=t.filter(e=>e.type===`救助`||e.type===`施恩`).length,s=t.filter(e=>e.type===`毁诺`).length,c=t.filter(e=>e.type===`立誓`).length,l=e.origin===`凡俗`?`生于微末，无所凭恃`:e.originRevealed?`身负「${e.origin}」之命`:`生而不知其所以生`,u=e.souls.length>0?`得残魂而起`:n.tier===`隐藏`&&n.id===`mortal_ascend`?`不假外物`:`独行至此`,d=Ce(e)>.6?`一世藏锋，未尝显名`:e.名望>200?`声名赫赫，四海皆闻`:`半明半晦，不为人知`,f=i>=95?`无瑕无垢`:i>=80?`其行有瑕，其志不移`:i>=60?`瑕瑜互见`:`根基已污`,p=[];a&&p.push(`杀${Ft(a)}人`),o&&p.push(`救${Ft(o)}人`),s&&p.push(`负${Ft(s)}诺`),c&&p.push(`践${Ft(c)}誓`);let m=Nt(e,n,i);return[`${l}，${u}，${d}。`,`${f}。${p.length?p.join(`，`)+`。`:``}`,`寿${Ft(Math.floor(e.ageMonths/12))}载，终于${Math.floor(r)}年。`,`——「${m}」`].join(`
`)}function Nt(e,t,n){return t.id===`true_immortal`?`道无捷径，唯诚而已。`:t.id===`fallen_immortal`?`此道自我而始，亦自我而终。`:t.id===`mortal_ascend`?`凡骨亦可撼天，只是无人肯信。`:t.id===`seclusion`?`知其可为而不为，是为大智。`:t.tier===`夭折`&&e.tier<=2?`此山每年埋人数十，其名多不可考。`:t.tier===`夭折`?`知其不可为而为之，是为道心；知其不可留而留之，是为执念。`:t.tier===`偏安`?`止于所当止，亦是一种圆满。`:n<60?`路是自己选的，账也是自己欠的。`:`行至水穷，坐看云起。`}var Pt=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function Ft(e){return e<10?Pt[e]:e<20?`十${e%10?Pt[e%10]:``}`:e<100?`${Pt[Math.floor(e/10)]}十${e%10?Pt[e%10]:``}`:e<1e4?String(e):`${Math.floor(e/1e4)}万${e%1e4?String(e%1e4):``}`}function It(e){let t=[],n=e=>{t.push(``,`── ${e} ──`)};t.push(`═`.repeat(66)),t.push(`《一生录》 · ${e.name}`),t.push(`═`.repeat(66)),t.push(`${e.path} · 位阶 ${e.tier} · 寿 ${e.lifespan} 载`),t.push(`身世「${e.origin}」（约 ${e.originRarity} 局一见）· 道途完满度 ${e.perfection}「${Be(e.perfection)}」`),t.push(`藏拙 ${e.concealment} · 因果净极性 ${e.karmaNet}`),t.push(``),t.push(`【${e.ending.name}】${e.ending.text}`),n(`① 生平`);for(let n of e.timeline.slice(0,24))t.push(`  ${String(n.year).padStart(5)}年  ${n.text}`);if(e.timeline.length>24&&t.push(`  …另有 ${e.timeline.length-24} 条`),e.deathChain&&(n(`② 死因链`),t.push(e.deathChain),e.missedWindows.length)){t.push(``,`  你本可以在这些时刻改变结局：`);for(let n of e.missedWindows)t.push(`  · ${n}`)}n(`③ 因果`),t.push(`  已了结 ${e.karmaResolved.length} 条 · 未了结 ${e.karmaUnresolved.length} 条`),n(`④ 人物志`);for(let n of e.people.slice(0,6))t.push(`  【${n.name}】${n.relation}`),t.push(`    ${n.whatYouDid}`),t.push(`    ${n.afterward}`),t.push(``);if(e.forks.length&&(n(`⑥ 岔路`),t.push(`  ${e.forks.join(` · `)}`)),n(`⑦ 判词`),t.push(e.verdict.split(`
`).map(e=>`  ${e}`).join(`
`)),e.unfinished.length){n(`⑧ 未竟之事`);for(let n of e.unfinished)t.push(`  · ${n}`);t.push(``,`  （这些会跟着你，进入下一局。）`)}return t.push(``),t.join(`
`)}var Lt={正道:[`练气`,`筑基`,`金丹`,`元婴`,`化神`,`炼虚`,`合体`,`大乘`,`渡劫`],魔道:[`聚煞`,`魔基`,`魔丹`,`魔婴`,`化魔`,`炼狱`,`魔身`,`大魔`,`魔劫`],鬼道:[`凝魂`,`阴煞`,`鬼将`,`鬼王`,`幽冥`,`阴神`,`冥主`,`鬼帝`,`鬼仙劫`],妖修:[`开智`,`化形`,`妖丹`,`妖将`,`妖王`,`大妖`,`妖圣`,`妖帝`,`妖皇劫`],佛道:[`入门`,`沙弥`,`比丘`,`罗汉`,`菩萨`,`明王`,`尊者`,`古佛`,`涅槃`],儒道:[`开蒙`,`秀才`,`举人`,`进士`,`大儒`,`亚圣`,`文圣`,`至圣`,`立言`],武道:[`淬体`,`洗髓`,`罡气`,`化劲`,`抱丹`,`宗师`,`武圣`,`武神`,`破凡`],散修:[`练气`,`筑基`,`金丹`,`元婴`,`化神`,`炼虚`,`合体`,`大乘`,`渡劫`]},Rt={正道:`金丹`,魔道:`魔丹`,鬼道:`鬼将印`,妖修:`妖丹`,佛道:`舍利`,儒道:`文心`,武道:`丹劲`,散修:`金丹`};function zt(e,t){return t>=10?`飞升`:(Lt[e]??Lt.正道)[t-1]??`位阶${t}`}var Bt=[`初期`,`中期`,`后期`,`圆满`];function Vt(e){let t=zt(e.path,e.tier);if(e.tier===3&&e.goldenCoreGrade>0){let t=Rt[e.path]??`金丹`;return`${e.goldenCoreGrade>=10?`混沌${t}`:`${t}${e.goldenCoreGrade}品`}`}return e.tier>=10?t:`${t}${Bt[Math.min(3,Math.floor(e.sublevel*4))]}`}var Ht=`甲乙丙丁戊己庚辛壬癸`,Ut=`子丑寅卯辰巳午未申酉戌亥`,Wt=[`零`,`壹`,`贰`,`叁`,`肆`,`伍`,`陆`,`柒`,`捌`,`玖`];function Gt(e){return`${Ht[e%10]}${Ut[e%12]}·${String(e).split(``).map(e=>Wt[Number(e)]).join(``)}`}function Kt(e,t){let n=Math.max(1,Math.floor(e.createdYear-t+16)),r=n<100?`${n}岁`:`${Math.floor(e.createdYear)}年`,i=e.target;switch(e.type){case`杀戮`:return`${r}，杀${i}${e.weight>45?`，血溅五步`:``}。`;case`救助`:return`${r}，救${i}于危难。`;case`施恩`:return`${r}，施恩于${i}，未求报。`;case`背叛`:return`${r}，负${i}。`;case`夺取`:return`${r}，取${i}之物，其人不甘。`;case`受辱`:return`${r}，为${i}所辱，未即报。`;case`毁诺`:return`${r}，毁与${i}之约。`;case`欺骗`:return`${r}，绐${i}。`;case`传承`:return`${r}，得${i}之遗泽。`;case`放走`:return`${r}，纵${i}去。`;case`立誓`:return`${r}，与${i}立誓。`;case`灭门`:return`${r}，屠${i}满门。`}}function qt(e){let{actor:t,ledger:n,ending:r}=e,i=[...n].sort((e,t)=>t.weight-e.weight).slice(0,5).sort((e,t)=>e.createdYear-t.createdYear).map(t=>Kt(t,e.birthYear)),a=[`生${t.path===`武道`?`而无灵根`:`具${t.talent.root}`}，${t.origin===`凡俗`?`无所凭恃`:t.originRevealed?`身负「${t.origin}」`:`来历不明`}。`,...i];a.length<6&&a.push(`终，${r.name}。`);let o=ze(t),s=Jt(r.grade)+ +(o>=95);return{serial:Gt(e.serialIndex),seed:e.seed,grade:r.grade,ending:r.name,daoName:t.name,finalRealm:Vt(t),perfection:Math.round(o*10)/10,verdictShort:e.verdictShort,lifespan:Math.floor(t.ageMonths/12),inscription:a,marks:{僭越:Math.round(t.僭越),因果:Math.round(n.reduce((e,t)=>e+t.polarity*t.weight,0)),功德:Math.round(t.功德),业障:Math.round(t.业障),藏拙:Math.round(Ce(t)*100)/100,堕度:Math.round(t.堕度)},goldFingers:e.goldFingers,rarity:s,createdAtYear:Math.floor(e.diedAtYear)}}function Jt(e){switch(e){case`凡碑`:return 1;case`灵碑`:return 2;case`玄碑`:return 3;case`地碑`:return 4;case`天碑`:return 4;case`血道碑`:return 5;case`道碑`:return 5;case`无字碑`:return 5}}function Yt(e){let t=[];t.push(`┌`+`─`.repeat(60)+`┐`);let n=(e=``)=>{t.push(`│ `+e.padEnd(58)+` │`)};n(`${e.grade}  ${`★`.repeat(e.rarity)}`),n(`编号 ${e.serial}`),n(),n(`【${e.ending}】`),n(`${e.daoName} · ${e.finalRealm}`),n(`寿 ${e.lifespan} 载 · 完满度 ${e.perfection}`),n(`「${e.verdictShort}」`),n();for(let t of e.inscription)n(t);return n(),n(`僭越 ${e.marks.僭越} · 因果 ${e.marks.因果} · 功德 ${e.marks.功德}`),n(`业障 ${e.marks.业障} · 藏拙 ${e.marks.藏拙} · 堕度 ${e.marks.堕度}`),n(`金手指：${e.goldFingers.length?e.goldFingers.join(`、`):`无`}`),n(),n(`世界种子 ${e.seed}`),t.push(`└`+`─`.repeat(60)+`┘`),t.join(`
`)}function Xt(){return{version:1,entries:[],steleCount:0,daoFruit:0,unlockedSystems:[]}}function Zt(e){switch(e.tier){case`飞升`:return`飞升`;case`主宰`:return e.id===`plane_sovereign`?`主宰`:null;case`夭折`:return e.id===`possessed_by_demon`?`魔头`:`尸骸`;case`偏安`:return e.id.startsWith(`local_`)?`传承`:null;case`隐藏`:return e.id===`seclusion`?`隐世`:`飞升`}}function Qt(e,t){e.steleCount++,e.daoFruit+=t.daoFruit;let n=Zt(t.ending);if(!n)return null;let r={kind:n,id:t.stele.serial,daoName:t.actor.name,path:t.actor.path,tier:t.actor.tier,realm:t.stele.finalRealm,inscription:t.stele.inscription,signature:t.signature,place:t.place,relics:t.relics,unfinished:t.unfinished,seed:t.stele.seed,atYear:t.stele.createdAtYear,steleGrade:t.stele.grade};return e.entries.push(r),r}function $t(e,t){return e.entries.filter(e=>(e.kind===`飞升`||e.kind===`隐世`)&&e.tier<=t)}function en(e){return e.entries.filter(e=>e.kind===`魔头`||e.kind===`主宰`)}function tn(e){return e.entries.filter(e=>e.kind===`尸骸`&&e.relics.length>0)}function nn(e){return e.entries.filter(e=>e.kind===`传承`)}function rn(e){switch(e.kind){case`飞升`:return`一缕残魂自称「${e.daoName}」，说他当年也是从这座山走出去的。\n  「${e.signature}」`;case`主宰`:return`${e.place}的主宰之位上坐着「${e.daoName}」，${e.realm}。已在位 ${e.atYear} 年。`;case`魔头`:return`魔头「${e.daoName}」盘踞${e.place}，用的是一套你莫名眼熟的功法。\n  「${e.signature}」`;case`传承`:return`${e.place}有一处旧洞府，主人姓名已不可考，只留下几个字：「${e.signature}」`;case`尸骸`:return`${e.place}的乱石堆里有一具枯骨，手上戴着一枚储物戒。\n  戒中有：${e.relics.join(`、`)}`;case`隐世`:return`据说${e.place}深处住着一位散功的老者，从不见客。`}}var an=[`&&`,`||`,`>=`,`<=`,`==`,`!=`,`>`,`<`,`!`,`+`,`-`,`*`,`/`],on=class extends Error{};function sn(e){let t=[],n=0;for(;n<e.length;){let r=e[n];if(/\s/.test(r)){n++;continue}if(r===`(`){t.push({kind:`lparen`,value:r,pos:n++});continue}if(r===`)`){t.push({kind:`rparen`,value:r,pos:n++});continue}if(r===`,`){t.push({kind:`comma`,value:r,pos:n++});continue}if(r===`'`||r===`"`){let i=r,a=n+1,o=``;for(;a<e.length&&e[a]!==i;)o+=e[a++];if(a>=e.length)throw new on(`字符串未闭合 @${n}: ${e}`);t.push({kind:`str`,value:o,pos:n}),n=a+1;continue}if(/[0-9]/.test(r)){let r=``;for(;n<e.length&&/[0-9.]/.test(e[n]);)r+=e[n++];t.push({kind:`num`,value:r,pos:n});continue}let i=an.find(t=>e.startsWith(t,n));if(i){t.push({kind:`op`,value:i,pos:n}),n+=i.length;continue}if(/[\p{L}_]/u.test(r)){let r=``;for(;n<e.length&&/[\p{L}\p{N}_.]/u.test(e[n]);)r+=e[n++];t.push({kind:`ident`,value:r,pos:n});continue}throw new on(`无法识别的字符 '${r}' @${n}: ${e}`)}return t.push({kind:`eof`,value:``,pos:n}),t}var cn=class{toks;i=0;constructor(e){this.toks=sn(e)}peek(){return this.toks[this.i]}next(){return this.toks[this.i++]}eat(e,t){let n=this.peek();if(n.kind!==e||t!==void 0&&n.value!==t)throw new on(`期望 ${t??e}，实际 '${n.value}' @${n.pos}`);return this.next()}parse(){let e=this.or();return this.eat(`eof`),e}or(){let e=this.and();for(;this.peek().value===`||`;)this.next(),e={t:`bin`,op:`||`,a:e,b:this.and()};return e}and(){let e=this.cmp();for(;this.peek().value===`&&`;)this.next(),e={t:`bin`,op:`&&`,a:e,b:this.cmp()};return e}cmp(){let e=this.add();for(;[`>`,`>=`,`<`,`<=`,`==`,`!=`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.add()};return e}add(){let e=this.mul();for(;[`+`,`-`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.mul()};return e}mul(){let e=this.unary();for(;[`*`,`/`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.unary()};return e}unary(){return[`!`,`-`].includes(this.peek().value)?{t:`un`,op:this.next().value,a:this.unary()}:this.primary()}primary(){let e=this.peek();if(e.kind===`lparen`){this.next();let e=this.or();return this.eat(`rparen`),e}if(e.kind===`num`)return this.next(),{t:`lit`,v:Number(e.value)};if(e.kind===`str`)return this.next(),{t:`lit`,v:e.value};if(e.kind===`ident`){if(this.next(),e.value===`true`)return{t:`lit`,v:!0};if(e.value===`false`)return{t:`lit`,v:!1};if(e.value===`null`)return{t:`lit`,v:null};if(this.peek().kind===`lparen`){this.next();let t=[];if(this.peek().kind!==`rparen`)for(t.push(this.or());this.peek().kind===`comma`;)this.next(),t.push(this.or());return this.eat(`rparen`),{t:`call`,name:e.value,args:t}}return{t:`path`,p:e.value}}throw new on(`意外的记号 '${e.value}' @${e.pos}`)}};function ln(e){return e!==null&&e!==!1&&e!==0&&e!==``}function un(e,t){switch(e.t){case`lit`:return e.v;case`path`:return t.get(e.p);case`call`:return t.call(e.name,e.args.map(e=>un(e,t)));case`un`:{let n=un(e.a,t);return e.op===`!`?!ln(n):-(Number(n)||0)}case`bin`:{if(e.op===`&&`)return ln(un(e.a,t))?ln(un(e.b,t)):!1;if(e.op===`||`)return ln(un(e.a,t))?!0:ln(un(e.b,t));let n=un(e.a,t),r=un(e.b,t);switch(e.op){case`==`:return n===r;case`!=`:return n!==r;case`>`:return Number(n)>Number(r);case`>=`:return Number(n)>=Number(r);case`<`:return Number(n)<Number(r);case`<=`:return Number(n)<=Number(r);case`+`:return typeof n==`string`||typeof r==`string`?String(n)+String(r):Number(n)+Number(r);case`-`:return Number(n)-Number(r);case`*`:return Number(n)*Number(r);case`/`:return Number(r)===0?0:Number(n)/Number(r);default:throw new on(`未知运算符 ${e.op}`)}}}}var dn=new Map;function fn(e){let t=dn.get(e);if(t)return t;let n=new cn(e).parse();return dn.set(e,n),n}function pn(e,t){return un(fn(e),t)}function mn(e,t){return!e||e==="default"||ln(pn(e,t))}var hn={tier:e=>e.actor.tier,sublevel:e=>e.actor.sublevel,path:e=>e.actor.path,goldenCoreGrade:e=>e.actor.goldenCoreGrade,hiddenRealmCount:e=>e.actor.hiddenRealms.length,道心:e=>e.actor.道心,气运:e=>e.actor.气运,功德:e=>e.actor.功德,业障:e=>e.actor.业障,僭越:e=>e.actor.僭越,堕度:e=>e.actor.堕度,丹毒:e=>e.actor.丹毒,名望:e=>e.actor.名望,锋芒:e=>e.actor.锋芒,藏拙:e=>Ce(e.actor),"talent.root":e=>e.actor.talent.root,"talent.purity":e=>e.actor.talent.purity,"talent.悟性":e=>e.actor.talent.悟性,"talent.根骨":e=>e.actor.talent.根骨,"talent.神魂":e=>e.actor.talent.神魂,"factors.功法":e=>e.actor.factors.功法,"factors.法宝":e=>e.actor.factors.法宝,"factors.状态":e=>e.actor.factors.状态,"factors.灵宠":e=>e.actor.factors.灵宠,"factors.伙伴":e=>e.actor.factors.伙伴,"factors.道侣":e=>e.actor.factors.道侣,"factors.情报":e=>e.actor.factors.情报,"expose.金手指":e=>e.actor.secrets.金手指,"expose.残魂":e=>e.actor.secrets.残魂,"expose.真实修为":e=>e.actor.secrets.真实修为,"expose.身世":e=>e.actor.secrets.身世,"expose.杀过某人":e=>e.actor.secrets.杀过某人,origin:e=>e.actor.origin,originRevealed:e=>e.actor.originRevealed,originClues:e=>e.actor.originClues,year:e=>Math.floor(e.year),tick:e=>e.tick,age:e=>Math.floor(e.actor.ageMonths/12),lifespanLeft:e=>e.actor.lifespanYears-e.actor.ageMonths/12,location:e=>e.location,effectiveTier:e=>Se(e.actor),daoPerfection:e=>ze(e.actor),knowerCount:e=>e.knowers.length,maxExpose:e=>Math.max(...Object.values(e.actor.secrets))},gn={hasSystem:(e,[t])=>e.systems.includes(String(t)),hasAnySystem:e=>e.systems.length>0,hasSoul:(e,[t])=>e.actor.souls.some(e=>e.id===t&&!e.dissipated),soulFavor:(e,[t])=>e.actor.souls.find(e=>e.id===t)?.favor??0,soulPossession:(e,[t])=>e.actor.souls.find(e=>e.id===t)?.possession??0,flag:(e,[t])=>e.flags.has(String(t)),karmaWith:(e,[t])=>e.karmaLedger.filter(e=>!e.resolved&&e.target===t).reduce((e,t)=>e+t.polarity*t.weight,0),unresolvedEvil:e=>e.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,seen:(e,[t])=>e.eventHistory.has(String(t)),seenCount:(e,[t])=>e.eventCounts.get(String(t))??0,realmAtLeast:(e,[t])=>e.actor.tier>=Number(t),knows:(e,[t])=>e.knowers.some(e=>e.npc===t),chance:(e,[t])=>e.rng.next()<Number(t),min:(e,t)=>Math.min(...t.map(Number)),max:(e,t)=>Math.max(...t.map(Number))};function _n(e){return{get(t){let n=hn[t];if(!n)throw new on(`未知的字段 '${t}'（不在 scope.ts 白名单内）`);return n(e)},call(t,n){let r=gn[t];if(!r)throw new on(`未知的函数 '${t}()'（不在 scope.ts 白名单内）`);return r(e,n)}}}Object.keys(hn),Object.keys(gn);var vn=class extends Error{},yn={道心:{get:e=>e.actor.道心,set:(e,t)=>{e.actor.道心=k(t,0,100)}},气运:{get:e=>e.actor.气运,set:(e,t)=>{e.actor.气运=k(t,0,100)}},功德:{get:e=>e.actor.功德,set:(e,t)=>{e.actor.功德=Math.max(0,t)}},业障:{get:e=>e.actor.业障,set:(e,t)=>{e.actor.业障=Math.max(0,t)}},僭越:{get:e=>e.actor.僭越,set:(e,t)=>{e.actor.僭越=Math.max(0,t)}},堕度:{get:e=>e.actor.堕度,set:(e,t)=>{e.actor.堕度=k(t,0,100)}},丹毒:{get:e=>e.actor.丹毒,set:(e,t)=>{e.actor.丹毒=k(t,0,100)}},名望:{get:e=>e.actor.名望,set:(e,t)=>{e.actor.名望=k(t,-100,1e3)}},锋芒:{get:e=>e.actor.锋芒,set:(e,t)=>{e.actor.锋芒=Math.max(0,t)}},sublevel:{get:e=>e.actor.sublevel,set:(e,t)=>{e.actor.sublevel=k(t,0,1)}},lifespan:{get:e=>e.actor.lifespanYears,set:(e,t)=>{e.actor.lifespanYears=Math.max(0,t)}},age:{get:e=>e.actor.ageMonths/12,set:(e,t)=>{e.actor.ageMonths=Math.max(0,t*12)}},originClues:{get:e=>e.actor.originClues,set:(e,t)=>{e.actor.originClues=Math.max(0,Math.floor(t))}},悟性:{get:e=>e.actor.talent.悟性,set:(e,t)=>{e.actor.talent.悟性=k(t,1,100)}},根骨:{get:e=>e.actor.talent.根骨,set:(e,t)=>{e.actor.talent.根骨=k(t,1,100)}},神魂:{get:e=>e.actor.talent.神魂,set:(e,t)=>{e.actor.talent.神魂=k(t,1,100)}},纯度:{get:e=>e.actor.talent.purity,set:(e,t)=>{e.actor.talent.purity=k(t,5,100)}}};for(let e of Object.keys(ne))yn[`factors.${e}`]={get:t=>t.actor.factors[e],set:(t,n)=>{t.actor.factors[e]=k(n,ne[e].min,ne[e].max)}};for(let e of[`金手指`,`残魂`,`真实血脉`,`真实修为`,`杀过某人`,`身世`])yn[`expose.${e}`]={get:t=>t.actor.secrets[e],set:(t,n)=>{t.actor.secrets[e]=k(n,0,100)}};function bn(e,t){let n=t.trim();if(!n)return;let r=n.split(/\s+/),i=r[0];switch(i){case`flag`:Sn(r[1],n),e.flags.add(r[1]);return;case`unflag`:Sn(r[1],n),e.flags.delete(r[1]);return;case`move`:Sn(r[1],n),e.location=r[1];return;case`bind.system`:{Sn(r[1],n);let t=r[1];e.systems.includes(t)||e.systems.push(t);return}case`bind.soul`:{Sn(r[1],n);let t=r[1];e.actor.souls.some(e=>e.id===t)||e.actor.souls.push({id:t,name:t,tier:Math.min(Number(r[2]??9),D.maxTier),favor:0,possession:0,dissipated:!1});return}case`devourSoul`:{Sn(r[1],n);let t=rt(e,r[1]);e.flags.add(t.ok?`吞魂成功_${r[1]}`:`吞魂失败_${r[1]}`);return}case`reincarnateSoul`:Sn(r[1],n),it(e,r[1]).ok&&e.flags.add(`送归转世_${r[1]}`);return;case`mergeSoul`:Sn(r[1],n),at(e,r[1]).ok&&e.flags.add(`融合共生_${r[1]}`);return;case`witness`:{Sn(r[1],n),Sn(r[2],n);let t=r[2];if(!pt.includes(t))throw new vn(`未知的秘密类型 '${r[2]}'：${n}`);mt(e,t,8,r[1]);return}case`silence`:Sn(r[1],n),_t(e,r[1]);return;case`eraseMemory`:Sn(r[1],n),vt(e,r[1]);return;case`fakeDeath`:yt(e);return;case`stepDown`:e.flags.add(`止步`);return}if(i.startsWith(`soul.`)){let t=i.split(`.`);if(t.length!==3)throw new vn(`残魂效果格式应为 soul.<id>.<favor|possession>：${n}`);let[,a,o]=t,s=e.actor.souls.find(e=>e.id===a);if(!s)return;let c=Cn(r[1],n);if(o===`favor`)s.favor=k(s.favor+c,-100,100);else if(o===`possession`)s.possession=k(s.possession+c,0,100);else throw new vn(`残魂无此字段 '${o}'：${n}`);return}let a=yn[i];if(!a)throw new vn(`未知的效果目标 '${i}'（不在 effects.ts 白名单内）：${n}`);let o=r[1];if(o===void 0)throw new vn(`缺少数值：${n}`);o.startsWith(`=`)?a.set(e,Number(o.slice(1))):a.set(e,a.get(e)+Cn(o,n))}function xn(e,t){for(let n of t??[])bn(e,n)}function Sn(e,t){if(!e)throw new vn(`缺少参数：${t}`)}function Cn(e,t){if(e===void 0)throw new vn(`缺少数值：${t}`);let n=Number(e);if(Number.isNaN(n))throw new vn(`数值无法解析 '${e}'：${t}`);return n}var wn=[`flag`,`unflag`,`move`,`bind.system`,`bind.soul`,`devourSoul`,`reincarnateSoul`,`mergeSoul`,`silence`,`eraseMemory`],Tn=[`fakeDeath`,`stepDown`];[...Object.keys(yn),...wn,...Tn];function En(e,t,n={}){let r=_n(e),i=n.location??e.location,a=[];for(let o of t.events.values()){if(o.location&&o.location!==i)continue;let t=e.eventHistory.get(o.id);t!==void 0&&(o.once||o.cooldown&&e.tick-t<o.cooldown)||n.excludeTags?.length&&o.tags?.some(e=>n.excludeTags.includes(e))||mn(o.cond,r)&&a.push(o)}return a}function Dn(e,t,n={}){let r=En(e,t,n);if(r.length===0)return null;let i=ge(e.actor),a=r.map(e=>Math.max(.01,e.weight*(1+i*.25)));return e.rng.weighted(r,a)}function On(e,t){if(typeof t.text==`string`)return t.text;if(t.text.length===0)return``;let n=e.eventCounts.get(t.id)??0;return t.text[n%t.text.length]}function kn(e,t){let n=_n(e);return t.choices.filter(e=>mn(e.require,n))}function An(e,t,n){return!n||n===`none`?null:We(e,{type:n.type,source:t.id,actor:`player`,target:n.target,weight:n.weight,polarity:n.polarity??-1,matureWindow:n.matureWindow,hooks:n.hooks}).id}function jn(e,t,n){if(!n)return{text:``,goto:null,karma:null};xn(e,n.effects);let r=An(e,t,n.karma);return{text:n.text??``,goto:n.goto??null,karma:r}}function Mn(e,t,n){e.eventHistory.set(t.id,e.tick),e.eventCounts.set(t.id,(e.eventCounts.get(t.id)??0)+1);let r=An(e,t,n.karma);if(!n.check)return xn(e,n.effects),{outcome:null,text:``,goto:null,karmaCreated:r};let i=_n(e),a=Number(pn(n.check.actor,i)),o=Number(pn(n.check.dc,i)),s=_e(e.rng,{power:a,dc:o,scale:n.check.scale,bonus:n.check.bonus},ge(e.actor)),c=jn(e,t,s===`CRIT_SUCCESS`?n.onCritSuccess??n.onSuccess:s===`SUCCESS`?n.onSuccess:s===`FAIL`?n.onFail:n.onCritFail??n.onFail);return{outcome:s,text:c.text,goto:c.goto,karmaCreated:c.karma??r}}var Nn={你:`亲历（你）`,我:`自述（我）`,他:`说书（道号）`};function Pn(e,t,n=`他`){return t===`你`?e:e.split(`
`).map(e=>e.split(/(「[^」]*」)/).map(e=>e.startsWith(`「`)?e:t===`我`?e.replace(/你们/g,`我们`).replace(/你/g,`我`):e.replace(/你们/g,`几人`).replace(/你/g,n)).join(``)).join(`
`)}function Fn(e,t){return e===`我`?`我`:e===`他`?t:`你`}function In(e,t){return Pn(e,`他`,t)}function Ln(e,t,n){if(e<2)return null;let r=Math.floor(e);return r<4?[`转过年去，又是一年。`,`两三年一晃而过。`,`此后两年，山中无事。`][r%3]:r<12?`此后${zn(r)}年，无事。`:r<50?`一晃，便是${zn(r)}年。`:t>=4?`这一坐，便是${zn(r)}年。出关那日，${n}认得的凡人，坟头草都换了几茬。`:`${zn(r)}年过去了。山下已经换了人间。`}var Rn=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function zn(e){return e<10?Rn[e]:e<20?`十${e%10?Rn[e%10]:``}`:e<100?`${Rn[Math.floor(e/10)]}十${e%10?Rn[e%10]:``}`:String(e)}var Bn=3;function Vn(e){let t=[],n={title:`起于微末`,beats:[]};for(let r of e){let e=r.isMajor&&(r.kind===`scene`||r.kind===`milestone`);e&&n.beats.length>=Bn?(t.push(n),n={title:r.title??r.text.slice(0,12),beats:[r]}):(e&&n.beats.length<Bn&&r.title&&(n.title=n.beats.length===0?r.title??n.title:`${n.title} · ${r.title}`),n.beats.push(r))}return n.beats.length&&t.push(n),t}function Hn(e,t,n){let r=e.text.trim();if(!r)return null;switch(e.kind){case`scene`:return Pn(r,t,n);case`choice`:return r.startsWith(`「`)?r.replace(/^「【[^】]*】/,`「`):`—— ${Pn(r,t,t===`我`?`我`:`他`)}`;case`outcome`:case`notice`:return Pn(r,t,t===`我`?`我`:`他`);case`milestone`:return`是年，${Pn(r,t,n)}${/[。！？」]$/.test(r)?``:`。`}`}}function Un(e){let t=new Set,n=[],r=!1;for(let i of e){if(i.kind===`scene`){if(i.evId&&t.has(i.evId)&&!i.isMajor){r=!0;continue}i.evId&&t.add(i.evId),r=!1,n.push(i);continue}(i.kind===`choice`||i.kind===`outcome`)&&r||((i.kind===`milestone`||i.kind===`notice`)&&(r=!1),n.push(i))}return n}function Wn(e){let{daoName:t,chronicle:n,stele:r}=e,i=e.pov??`他`,a=[];a.push(`# 藏锋录 · ${t}${i===`我`?`自述`:`卷`}`),a.push(``),a.push(`> ${e.signature}`),a.push(`>`),a.push(`> —— ${t}${n.origin!==`凡俗`&&n.ending.tier!==`夭折`?`，${n.origin}`:``}，寿${zn(n.lifespan)}载`),a.push(``);let o=Vn(Un(e.beats)),s=null,c=i===`我`?`我`:t;if(o.forEach((e,n)=>{a.push(`## 第${zn(n+1)}回 · ${e.title}`),a.push(``);for(let n of e.beats){if(s!==null&&n.kind===`scene`){let e=Ln(n.year-s,n.tier,c);e&&(a.push(e),a.push(``))}let e=Hn(n,i,t);e&&(a.push(e),a.push(``)),s=n.year}}),a.push(`## 终 · ${n.ending.name}`),a.push(``),i===`我`&&(a.push(`*（自述至此而止。以下数页为后人所补。）*`),a.push(``)),a.push(In(n.ending.text,t)),a.push(``),n.deathChain){a.push(`后来有人翻起这段公案，把前因后果排了出来：`),a.push(``);for(let e of n.deathChain.split(`
`))a.push(`> ${e}`);n.missedWindows.length&&(a.push(`>`),a.push(`> 局中人未曾察觉的是，有${zn(n.missedWindows.length)}次，事情本可以不是这样。`)),a.push(``)}a.push(`---`),a.push(``),a.push(`## 跋`),a.push(``);for(let e of n.verdict.split(`
`))a.push(`> ${e}`);if(a.push(``),n.people.length){a.push(`### 书中诸人，后来`),a.push(``);for(let e of n.people.slice(0,8))a.push(`**${e.name}**（${In(e.relation,t)}）`),a.push(``),a.push(In(e.afterward,t)),a.push(``)}if(n.unfinished.length){a.push(`### 未了之事`),a.push(``);for(let e of n.unfinished)a.push(`- ${e}`);a.push(``),a.push(`（这些账没有随他入土。它们还在世上走动，等下一个人。）`),a.push(``)}return a.push(`### 碑拓`),a.push(``),a.push("```"),a.push(Yt(r)),a.push("```"),a.push(``),a.push(`*此书由一局真实的推演自动写成。世界种子 \`${e.seed}\` —— 持此种子者，可入同一世界，另写一卷。*`),a.push(``),a.join(`
`)}function Gn(e){return e.replace(/[#>*`\-\s]/g,``).length}function Kn(e){return[...e.effects??[],...e.onCritSuccess?.effects??[],...e.onSuccess?.effects??[],...e.onFail?.effects??[],...e.onCritFail?.effects??[]]}function qn(e,t){let n=[],r=new Set,i=(e,t)=>{r.has(e)||(r.add(e),n.push({text:e,level:t}))};e.tags?.includes(`岔路`)&&i(`人生岔路 · 落子无悔`,`grave`);let a=t.karma;a&&a!==`none`&&(a.hooks?.some(e=>e.lethal)?i(`或招杀身之祸`,`grave`):a.weight>=40&&i(`结下重因果`,`warn`));for(let e of Kn(t)){let t=e.trim();t.startsWith(`fakeDeath`)?i(`假死脱身 · 尽弃身份人脉`,`grave`):t.startsWith(`stepDown`)?i(`就此止步 · 不再求进`,`grave`):t.startsWith(`devourSoul`)?i(`反吞残魂 · 败则身死`,`grave`):t.startsWith(`mergeSoul`)?i(`魂魄相融 · 不可分离`,`grave`):t.startsWith(`silence`)?i(`灭口 · 业障加身`,`grave`):t.startsWith(`bind.soul`)&&i(`引魂入体 · 祸福难料`,`warn`);let n=/^堕度 \+(\d+(?:\.\d+)?)/.exec(t);n&&Number(n[1])>=8&&i(`堕入邪道`,`grave`),n=/^lifespan -(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=5&&i(`折寿${n[1]}载`,`grave`),n=/^僭越 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=8&&i(`僭越大增 · 天道侧目`,`warn`),n=/^业障 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=20&&i(`业障深重`,`warn`),n=/^expose\.[^ ]+ \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=15&&i(`大损隐秘`,`warn`)}return n}function Jn(e,t){return qn(e,t).some(e=>e.level===`grave`)}var Yn=class e{ctx;db;registry;seed;maxTicks;birthYear=16;milestones=[];curve=[];notices=[];beats=[];pendingEvent=null;chainDepth=0;breakthroughCooldown=0;death=null;steppedDown=!1;failedBranch=null;finished=null;lastTags=[];stance=`打坐吐纳`;lastOutcome=null;lastDeltas=[];lastBreakthrough=null;signInYear=-1;autoResolveMinor=!0;note(e,t=`notice`){this.notices.push(e),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:t,text:e})}constructor(e){let t=new f(e.seed);if(this.seed=e.seed,this.db=e.db,this.registry=e.registry,this.maxTicks=e.maxTicks??500,e.restore){let t=structuredClone(e.restore);if(t.pendingEventId&&!e.db.events.has(t.pendingEventId))throw Error(`快照中的事件「${t.pendingEventId}」已不存在（内容已更新）`);this.ctx={rng:f.restore(t.rng),year:t.year,tick:t.tick,actor:t.actor,karmaLedger:t.karmaLedger,log:[],flags:new Set(t.flags),systems:t.systems,eventHistory:new Map(t.eventHistory),eventCounts:new Map(t.eventCounts),location:t.location,knowers:t.knowers},this.milestones.push(...t.milestones),this.curve.push(...t.curve),this.beats.push(...t.beats),this.notices.push(...t.notices),this.pendingEvent=t.pendingEventId?e.db.events.get(t.pendingEventId):null,this.chainDepth=t.chainDepth,this.breakthroughCooldown=t.breakthroughCooldown,this.lastTags=t.lastTags,this.stance=t.stance,this.signInYear=t.signInYear??-1,this.autoResolveMinor=t.autoResolve??!0;return}let n=e.birthplace??t.pick(Ee),r=Ae(t,{birthplace:n,name:e.name??`无名`});this.ctx={rng:t,year:this.birthYear,tick:0,actor:r,karmaLedger:[],log:[],flags:new Set,systems:[],eventHistory:new Map,eventCounts:new Map,location:n.name,knowers:[]},this.milestones.push({year:this.birthYear,kind:`出生`,text:`生于${n.name}，${r.talent.root}`}),this.ctx.flags.add(`出身·${n.id}`),this.ctx.flags.add(`道统·${r.path}`),(r.path===`正道`||r.path===`儒道`)&&this.ctx.flags.add(`宗门弟子`)}snapshot(){return this.finished||!this.ctx.actor.alive?null:structuredClone({v:1,seed:this.seed,name:this.ctx.actor.name,rng:this.ctx.rng.snapshot(),year:this.ctx.year,tick:this.ctx.tick,actor:this.ctx.actor,karmaLedger:this.ctx.karmaLedger,flags:[...this.ctx.flags],systems:this.ctx.systems,eventHistory:[...this.ctx.eventHistory.entries()],eventCounts:[...this.ctx.eventCounts.entries()],location:this.ctx.location,knowers:this.ctx.knowers,milestones:this.milestones,curve:this.curve,beats:this.beats,notices:[...this.notices],pendingEventId:this.pendingEvent?.id??null,chainDepth:this.chainDepth,breakthroughCooldown:this.breakthroughCooldown,lastTags:this.lastTags,stance:this.stance,signInYear:this.signInYear,autoResolve:this.autoResolveMinor})}currentPrompt(){return this.finished?{kind:`gameover`,result:this.finished}:this.pendingEvent?{kind:`event`,card:this.pendingEvent,text:On(this.ctx,this.pendingEvent),choices:kn(this.ctx,this.pendingEvent)}:null}advance(){if(this.finished)return{kind:`gameover`,result:this.finished};if(this.pendingEvent)throw Error(`有未处理的事件，请先 choose()`);let{ctx:e}=this,t=e.actor;for(;t.alive&&e.tick<this.maxTicks;){e.tick++;let n=g[t.tier]??12,r=n/12;e.year+=r,t.ageMonths+=n;let i=Pe(e,this.stance);i.mishap&&this.note(`修炼时气息岔了一下，胸口发闷 —— 走火的前兆。`);for(let n of t.souls){if(n.dissipated||n.favor<=-20||n.possession>=90)continue;let r=et(n,t.tier);r.speedBonus>0&&e.rng.chance(.25)&&(tt(e,n.id),t.sublevel=Math.min(1,t.sublevel+.012*r.speedBonus))}let a=$e(e);a&&this.note(a);let o=e.rng.chance(he.eventChance)?Dn(e,this.db,{excludeTags:this.lastTags}):null;if(o){this.lastTags=o.tags?.slice(0,1)??[];let n=kn(e,o);if(!this.autoResolveMinor||n.length===0||this.isMajor(o,n)){this.pendingEvent=o,this.chainDepth=0;let r=On(e,o);return this.beats.push({year:Math.floor(e.year),tier:t.tier,kind:`scene`,text:r,evId:o.id,title:o.title,isMajor:o.tags?.includes(`主干`)||o.tags?.includes(`岔路`)}),{kind:`event`,card:o,text:r,choices:n}}let r=this.autoResolve(o,n);if(r)return r;if(!t.alive)return{kind:`gameover`,result:this.finalize()}}else this.lastTags=[];let s=this.postTick(r);if(s)return s;if(i.ready&&t.tier<10&&this.breakthroughCooldown<=0){let n=ve({power:Ie(t),dc:Fe(t),scale:Math.max(20,Fe(t)*.2)},ge(t)),r=ye(e.rng,n,ge(t));return{kind:`breakthrough`,toTier:t.tier+1,estimate:r}}this.breakthroughCooldown>0&&this.breakthroughCooldown--,e.tick%4==0&&this.curve.push(Dt(t,e.tick,e.year))}return{kind:`gameover`,result:this.finalize()}}static MAJOR_TAGS=new Set([`主干`,`岔路`,`道德`,`抉择`,`打脸`,`止步`,`结丹`,`定道`,`系统`,`心魔`]);isMajor(t,n){return!!(t.once||t.tags?.some(t=>e.MAJOR_TAGS.has(t))||n.some(e=>!!e.require)||n.some(e=>Jn(t,e))||n.some(e=>e.karma!==`none`&&typeof e.karma==`object`&&e.karma.weight>=30))}autoResolve(e,t){let{ctx:n}=this,r=e,i=t,a=0;for(;r&&a++<5;){let e=On(n,r);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:e,evId:r.id,title:r.title});let t=i.filter(e=>!Jn(r,e)),o=t.length?t:i,s=o.map((e,t)=>1/(t+1)+.3),c=n.rng.weighted(o,s);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`choice`,text:c.text});let l=Mn(n,r,c);if(l.text&&this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`outcome`,text:l.text}),r=l.goto?this.db.events.get(l.goto)??null:null,!r||(i=kn(n,r),i.length===0))break;if(this.isMajor(r,i)){this.pendingEvent=r,this.chainDepth=a;let e=On(n,r);return this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:e,evId:r.id,title:r.title,isMajor:r.tags?.includes(`主干`)||r.tags?.includes(`岔路`)}),{kind:`event`,card:r,text:e,choices:i}}}return null}captureStats(){let e=this.ctx.actor;return{修为:e.sublevel*100,道心:e.道心,气运:e.气运,功德:e.功德,业障:e.业障,僭越:e.僭越,堕度:e.堕度,丹毒:e.丹毒,名望:e.名望,悟性:e.talent.悟性,根骨:e.talent.根骨,神魂:e.talent.神魂,寿元:e.lifespanYears,功法:e.factors.功法,法宝:e.factors.法宝,状态:e.factors.状态,灵宠:e.factors.灵宠,伙伴:e.factors.伙伴,道侣:e.factors.道侣,情报:e.factors.情报,暴露:Math.max(...Object.values(e.secrets))}}static WARN_KEYS=new Set([`业障`,`僭越`,`堕度`,`丹毒`,`暴露`]);static FACTOR_KEYS=new Set([`功法`,`法宝`,`状态`,`灵宠`,`伙伴`,`道侣`,`情报`]);diffStats(t){let n=this.captureStats(),r=[];for(let i of Object.keys(t)){let a=(n[i]??0)-(t[i]??0),o=e.FACTOR_KEYS.has(i);if(Math.abs(a)<(o?.015:.5))continue;let s=e.WARN_KEYS.has(i)?a>0?`warn`:`good`:a>0?`good`:`bad`,c=o?a>0?`+${a.toFixed(2)}`:a.toFixed(2):i===`修为`?`${a>0?`+`:``}${a.toFixed(1)}%`:`${a>0?`+`:``}${Math.round(a)}`;r.push({key:i,delta:a,kind:s,text:`${i} ${c}`})}return r}choose(e){let t=this.pendingEvent;if(!t)throw Error(`当前没有待处理的事件`);let n=kn(this.ctx,t),r=n[e];if(!r)throw Error(`选项 ${e} 不存在（共 ${n.length} 项）`);this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`choice`,text:r.text});let i=this.captureStats(),a=Mn(this.ctx,t,r);if(this.lastOutcome=a.outcome,this.lastDeltas=this.diffStats(i),a.karmaCreated){let e=this.ctx.karmaLedger.find(e=>e.id===a.karmaCreated);e&&this.lastDeltas.push({key:`因果`,delta:e.polarity,kind:e.polarity>0?`good`:e.polarity<0?`warn`:`bad`,text:`因果 · ${e.type}`})}if(a.text&&(this.notices.push(a.text),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`outcome`,text:a.text})),(t.tags?.includes(`岔路`)||t.tags?.includes(`主干`))&&this.milestones.push({year:Math.floor(this.ctx.year),kind:`岔路`,text:`【${t.title}】`}),a.goto&&this.chainDepth<4){let e=this.db.events.get(a.goto);if(e){this.chainDepth++,this.pendingEvent=e;let t=kn(this.ctx,e);if(t.length>0){let n=On(this.ctx,e);return this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`scene`,text:n,evId:e.id,title:e.title,isMajor:e.tags?.includes(`主干`)||e.tags?.includes(`岔路`)}),{kind:`event`,card:e,text:n,choices:t}}}}if(this.pendingEvent=null,!this.ctx.actor.alive)return{kind:`gameover`,result:this.finalize()};if(this.ctx.flags.has(`止步`)&&Et(this.ctx.actor))return this.steppedDown=!0,this.milestones.push({year:Math.floor(this.ctx.year),kind:`结局`,text:`止步 —— 不再求进`}),{kind:`gameover`,result:this.finalize()};let o=g[this.ctx.actor.tier]??12;return this.postTick(o/12)||this.advance()}decideBreakthrough(e,t=!1){let n=this.ctx.actor;if(this.lastBreakthrough=null,!e)return this.breakthroughCooldown=6,this.note(`你压下了冲关的念头，继续温养。`),this.advance();let r=n.tier,i=Le(this.ctx,{hiddenAttempt:t,coreGradeInvest:this.ctx.flags.has(`结丹·全押`)?.85:.4});if(i.newTier>r){ut(this.ctx);let e=zt(n.path,i.newTier);this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`入${e}${i.hiddenAchieved?`（得隐藏境界）`:``}${i.newTier===3?` · ${i.goldenCoreGrade}品金丹`:``}`}),this.notices.push(`突破成功 —— ${e}。${i.hiddenAchieved?`而且你摸到了传说里的那一层。`:``}`),this.lastBreakthrough={ok:!0,name:e,hidden:i.hiddenAchieved},this.beats.push({year:Math.floor(this.ctx.year),tier:n.tier,kind:`milestone`,isMajor:!0,title:`入${e}`,text:`入${e}${i.hiddenAchieved?`，且踏足了世所罕闻的隐秘之境`:``}${i.newTier===3?`，结成${i.goldenCoreGrade}品金丹`:``}`})}else if(i.failure){if(this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`渡劫失败 · ${i.failure.name}`}),this.note(`突破失败 —— ${i.failure.outcome}`),i.failure.recoverable===!1||i.failure.branch)return this.failedBranch={name:i.failure.name,outcome:i.failure.outcome,branch:i.failure.branch},n.alive=!1,{kind:`gameover`,result:this.finalize()}}else this.note(`冲关未成，气机散了。所幸根基未损，还能再来。`);return this.advance()}signIn(){if(!this.ctx.systems.includes(`签到`))return{ok:!1,text:`未绑定签到系统`};let e=Math.floor(this.ctx.year);if(e<=this.signInYear)return{ok:!1,text:`今岁已签，明年再来`};this.signInYear=e;let t=this.ctx.actor,n=this.ctx.rng.pick([{text:`灵气灌顶 · 修为 +2%`,apply:()=>{t.sublevel=Math.min(1,t.sublevel+.02)}},{text:`残页功法一篇 · 功法 +0.02`,apply:()=>{t.factors.功法=Math.min(1.9,t.factors.功法+.02)}},{text:`下品法器一件 · 法宝 +0.02`,apply:()=>{t.factors.法宝=Math.min(1.75,t.factors.法宝+.02)}},{text:`疗伤玉露 · 状态 +0.06`,apply:()=>{t.factors.状态=Math.min(1.45,t.factors.状态+.06)}},{text:`静心符一道 · 道心 +1`,apply:()=>{t.道心=Math.min(100,t.道心+1)}},{text:`一点玄妙气机 · 气运 +1`,apply:()=>{t.气运=Math.min(100,t.气运+1)}}]);return n.apply(),t.僭越+=1.5,t.secrets.金手指=Math.min(100,t.secrets.金手指+1.5),this.note(`【签到系统】叮 —— 连续签到中。今日奖励：${n.text}。`),{ok:!0,text:n.text}}postTick(e){let{ctx:t}=this,n=t.actor,r=ot(t);r&&(this.note(r),t.rng.chance(.4)&&st(t));let i=ct(t);i&&(this.note(i.text),this.milestones.push({year:Math.floor(t.year),kind:`机缘`,text:`身世揭晓：${i.origin}`}));for(let{soul:e,fate:n}of nt(t))this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`${e.name} · ${n}`}),this.note(`${e.name} —— ${n}。`);if(!n.alive)return{kind:`gameover`,result:this.finalize()};ht(t),xt(t),n.锋芒=Se(n)*(.15+.85*(n.secrets.真实修为/100));let a=gt(t);if(a.length){this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`秘密败露：${a.join(`、`)}`}),this.note(`瞒不住了 —— 你的${a.join(`、`)}已是公开的秘密。`);for(let e of a)n.secrets[e]=70;n.名望-=10}for(let r of Ge(t,e)){if(r.kind===`foreshadow`||r.kind===`window`){this.note(`（${r.evtId.replace(/_/g,` `)}）`);continue}if(!r.lethal)continue;let e=we(t.rng,n,Se(n)+t.rng.range(.1,.9));if(e===`FAIL`||e===`CRIT_FAIL`){if(lt(t))this.note(`你本该死在那里。可你没有。`),this.milestones.push({year:Math.floor(t.year),kind:`机缘`,text:`死里逃生`});else{let e={id:`death_${r.karma.id}`,kind:`因果致死`,lethal:!0,karmaId:r.karma.id,description:`${Math.floor(t.year-r.karma.createdYear)} 年前的「${r.karma.type}」找上门 —— ${r.karma.target}`};return this.death=Ze(t,e),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:e.description}),{kind:`gameover`,result:this.finalize()}}}else this.note(`${r.karma.target}的旧账找上门来。你赢了这一场 —— 这一段因果，就此了结。`)}let o=Qe(t);return o?(this.death=Ze(t,o),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:o.description}),{kind:`gameover`,result:this.finalize()}):null}finalize(){if(this.finished)return this.finished;let{ctx:e}=this,t=e.actor;t.perfectionByTier[t.tier]||(t.perfectionByTier[t.tier]=Re(t,t.hiddenRealms.includes(t.tier))),this.curve.push(Dt(t,e.tick,e.year));let n=wt({actor:t,death:this.death,steppedDown:this.steppedDown,rootedAt:e.location,failedBranch:this.failedBranch});this.milestones.push({year:Math.floor(e.year),kind:`结局`,text:n.name});let r=At({actor:t,ledger:e.karmaLedger,milestones:this.milestones,curve:this.curve,flags:e.flags,death:this.death,ending:n,diedAtYear:e.year,seed:this.seed}),i=qt({actor:t,ledger:e.karmaLedger,ending:n,seed:this.seed,serialIndex:this.registry.steleCount+1,birthYear:this.birthYear,diedAtYear:e.year,goldFingers:[...e.systems,...t.souls.map(e=>e.name)],verdictShort:Be(ze(t))}),a=Tt(t,n,{noSystem:e.flags.has(`无系统`)});Qt(this.registry,{actor:t,ending:n,stele:i,place:e.location,signature:this.signature(),unfinished:r.unfinished,relics:this.relics(),daoFruit:a});for(let t of e.systems)this.registry.unlockedSystems.includes(t)||this.registry.unlockedSystems.push(t);let o=Wn({daoName:t.name,seed:this.seed,beats:this.beats,chronicle:r,stele:i,signature:this.signature()});return this.finished={ending:n,chronicle:r,stele:i,daoFruit:a,novel:o,novelChars:Gn(o)},this.finished}signature(){let e=this.ctx.flags;return e.has(`道·剑`)?`挡我者，斩。`:e.has(`道·丹`)?`我要救的人，一个都不能少。`:e.has(`道·苟`)?`谁都可以死，我不行。`:e.has(`道·杀`)?`这世道就是这样，我认。`:e.has(`无系统`)?`我什么都没有。所以我什么都不欠。`:e.has(`拒绝过系统`)?`那东西认的不是我，是「载体」。`:`后生，老夫观你骨骼清奇。`}relics(){let e=[],t=this.ctx.actor;return t.factors.法宝>1.1&&e.push(`一件养过手的法宝`),t.factors.功法>1.2&&e.push(`半部残缺功法`),t.tier>=3&&e.push(`一枚认过主的储物戒`),this.ctx.systems.length&&e.push(`一枚温热的青玉简`),t.goldenCoreGrade>=7&&e.push(`一颗${t.goldenCoreGrade}品金丹`),e}},Xn=`# 幕一 · 主干岔路
...
`,lr=`# 出身专属 · 东海浮岛（fudao）与绝灵谷（juelin）
...
`,ur=`# 十万大山开局包 —— 出身·nanjiang（南疆·魔修聚落）
...
systems:
  ...
  - id: 苟道
    ...
    unlock: "realmAtLeast(2)"
    grants: [choice.苟]
`,_r=Symbol.for(`yaml.alias`),vr=Symbol.for(`yaml.document`),yr=Symbol.for(`yaml.map`),br=Symbol.for(`yaml.pair`),xr=Symbol.for(`yaml.scalar`),Sr=Symbol.for(`yaml.seq`),Cr=Symbol.for(`yaml.node.type`),wr=e=>!!e&&typeof e==`object`&&e[Cr]===_r,Tr=e=>!!e&&typeof e==`object`&&e[Cr]===vr,Er=e=>!!e&&typeof e==`object`&&e[Cr]===yr,Dr=e=>!!e&&typeof e==`object`&&e[Cr]===br,A=e=>!!e&&typeof e==`object`&&e[Cr]===xr,Or=e=>!!e&&typeof e==`object`&&e[Cr]===Sr;function kr(e){if(e&&typeof e==`object`)switch(e[Cr]){case yr:case Sr:return!0}return!1}function j(e){if(e&&typeof e==`object`)switch(e[Cr]){case _r:case yr:case xr:case Sr:return!0}return!1}var Ar=e=>(A(e)||kr(e))&&!!e.anchor,jr=Symbol(`break visit`),Mr=Symbol(`skip children`),Nr=Symbol(`remove node`);function Pr(e,t){let n=Ir(t);Tr(e)?Fr(null,e.contents,n,Object.freeze([e]))===Nr&&(e.contents=null):Fr(null,e,n,Object.freeze([]))}Pr.BREAK=jr,Pr.SKIP=Mr,Pr.REMOVE=Nr;function Fr(e,t,n,r){let i=Lr(e,t,n,r);if(j(i)||Dr(i))return Rr(e,r,i),Fr(e,i,n,r);if(typeof i!=`symbol`){if(kr(t)){r=Object.freeze(r.concat(t));for(let e=0;e<t.items.length;++e){let i=Fr(e,t.items[e],n,r);if(typeof i==`number`)e=i-1;else if(i===jr)return jr;else i===Nr&&(t.items.splice(e,1),--e)}}else if(Dr(t)){r=Object.freeze(r.concat(t));let e=Fr(`key`,t.key,n,r);if(e===jr)return jr;e===Nr&&(t.key=null);let i=Fr(`value`,t.value,n,r);if(i===jr)return jr;i===Nr&&(t.value=null)}}return i}function Ir(e){return typeof e==`object`&&(e.Collection||e.Node||e.Value)?Object.assign({Alias:e.Node,Map:e.Node,Scalar:e.Node,Seq:e.Node},e.Value&&{Map:e.Value,Scalar:e.Value,Seq:e.Value},e.Collection&&{Map:e.Collection,Seq:e.Collection},e):e}function Lr(e,t,n,r){if(typeof n==`function`)return n(e,t,r);if(Er(t))return n.Map?.(e,t,r);if(Or(t))return n.Seq?.(e,t,r);if(Dr(t))return n.Pair?.(e,t,r);if(A(t))return n.Scalar?.(e,t,r);if(wr(t))return n.Alias?.(e,t,r)}function Rr(e,t,n){let r=t[t.length-1];if(kr(r))r.items[e]=n;else if(Dr(r))e===`key`?r.key=n:r.value=n;else if(Tr(r))r.contents=n;else{let e=wr(r)?`alias`:`scalar`;throw Error(`Cannot replace node with ${e} parent`)}}var zr={"!":`%21`,",":`%2C`,"[":`%5B`,"]":`%5D`,"{":`%7B`,"}":`%7D`},Br=e=>e.replace(/[!,[\]{}]/g,e=>zr[e]),Vr=class e{constructor(t,n){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},e.defaultYaml,t),this.tags=Object.assign({},e.defaultTags,n)}clone(){let t=new e(this.yaml,this.tags);return t.docStart=this.docStart,t}atDocument(){let t=new e(this.yaml,this.tags);switch(this.yaml.version){case`1.1`:this.atNextDocument=!0;break;case`1.2`:this.atNextDocument=!1,this.yaml={explicit:e.defaultYaml.explicit,version:`1.2`},this.tags=Object.assign({},e.defaultTags)}return t}add(t,n){this.atNextDocument&&=(this.yaml={explicit:e.defaultYaml.explicit,version:`1.1`},this.tags=Object.assign({},e.defaultTags),!1);let r=t.trim().split(/[ \t]+/),i=r.shift();switch(i){case`%TAG`:{if(r.length!==2&&(n(0,`%TAG directive should contain exactly two parts`),r.length<2))return!1;let[e,t]=r;return this.tags[e]=t,!0}case`%YAML`:{if(this.yaml.explicit=!0,r.length!==1)return n(0,`%YAML directive should contain exactly one part`),!1;let[e]=r;if(e===`1.1`||e===`1.2`)return this.yaml.version=e,!0;{let t=/^\d+\.\d+$/.test(e);return n(6,`Unsupported YAML version ${e}`,t),!1}}default:return n(0,`Unknown directive ${i}`,!0),!1}}tagName(e,t){if(e===`!`)return`!`;if(e[0]!==`!`)return t(`Not a valid tag: ${e}`),null;if(e[1]===`<`){let n=e.slice(2,-1);return n===`!`||n===`!!`?(t(`Verbatim tags aren't resolved, so ${e} is invalid.`),null):(e[e.length-1]!==`>`&&t(`Verbatim tags must end with a >`),n)}let[,n,r]=e.match(/^(.*!)([^!]*)$/s);r||t(`The ${e} tag has no suffix`);let i=this.tags[n];if(i)try{return i+decodeURIComponent(r)}catch(e){return t(String(e)),null}return n===`!`?e:(t(`Could not resolve tag: ${e}`),null)}tagString(e){for(let[t,n]of Object.entries(this.tags))if(e.startsWith(n))return t+Br(e.substring(n.length));return e[0]===`!`?e:`!<${e}>`}toString(e){let t=this.yaml.explicit?[`%YAML ${this.yaml.version||`1.2`}`]:[],n=Object.entries(this.tags),r;if(e&&n.length>0&&j(e.contents)){let t={};Pr(e.contents,(e,n)=>{j(n)&&n.tag&&(t[n.tag]=!0)}),r=Object.keys(t)}else r=[];for(let[i,a]of n)(i!==`!!`||a!==`tag:yaml.org,2002:`)&&(!e||r.some(e=>e.startsWith(a)))&&t.push(`%TAG ${i} ${a}`);return t.join(`
`)}};Vr.defaultYaml={explicit:!1,version:`1.2`},Vr.defaultTags={"!!":`tag:yaml.org,2002:`};function Hr(e){if(/[\x00-\x19\s,[\]{}]/.test(e)){let t=`Anchor must not contain whitespace or control characters: ${JSON.stringify(e)}`;throw Error(t)}return!0}function Ur(e){let t=new Set;return Pr(e,{Value(e,n){n.anchor&&t.add(n.anchor)}}),t}function Wr(e,t){for(let n=1;;++n){let r=`${e}${n}`;if(!t.has(r))return r}}function Gr(e,t){let n=[],r=new Map,i=null;return{onAnchor:r=>{n.push(r),i??=Ur(e);let a=Wr(t,i);return i.add(a),a},setAnchors:()=>{for(let e of n){let t=r.get(e);if(typeof t==`object`&&t.anchor&&(A(t.node)||kr(t.node)))t.node.anchor=t.anchor;else{let t=Error(`Failed to resolve repeated object (this should not happen)`);throw t.source=e,t}}},sourceObjects:r}}function Kr(e,t,n,r){if(r&&typeof r==`object`){if(Array.isArray(r))for(let t=0,n=r.length;t<n;++t){let n=r[t],i=Kr(e,r,String(t),n);i===void 0?delete r[t]:i!==n&&(r[t]=i)}else if(r instanceof Map)for(let t of Array.from(r.keys())){let n=r.get(t),i=Kr(e,r,t,n);i===void 0?r.delete(t):i!==n&&r.set(t,i)}else if(r instanceof Set)for(let t of Array.from(r)){let n=Kr(e,r,t,t);n===void 0?r.delete(t):n!==t&&(r.delete(t),r.add(n))}else for(let[t,n]of Object.entries(r)){let i=Kr(e,r,t,n);i===void 0?delete r[t]:i!==n&&(r[t]=i)}}return e.call(t,n,r)}function qr(e,t,n){if(Array.isArray(e))return e.map((e,t)=>qr(e,String(t),n));if(e&&typeof e.toJSON==`function`){if(!n||!Ar(e))return e.toJSON(t,n);let r={aliasCount:0,count:1,res:void 0};n.anchors.set(e,r),n.onCreate=e=>{r.res=e,delete n.onCreate};let i=e.toJSON(t,n);return n.onCreate&&n.onCreate(i),i}return typeof e==`bigint`&&!n?.keep?Number(e):e}var Jr=class{constructor(e){Object.defineProperty(this,Cr,{value:e})}clone(){let e=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(e.range=this.range.slice()),e}toJS(e,{mapAsMap:t,maxAliasCount:n,onAnchor:r,reviver:i}={}){if(!Tr(e))throw TypeError(`A document argument is required`);let a={anchors:new Map,doc:e,keep:!0,mapAsMap:t===!0,mapKeyWarned:!1,maxAliasCount:typeof n==`number`?n:100},o=qr(this,``,a);if(typeof r==`function`)for(let{count:e,res:t}of a.anchors.values())r(t,e);return typeof i==`function`?Kr(i,{"":o},``,o):o}},Yr=class extends Jr{constructor(e){super(_r),this.source=e,Object.defineProperty(this,"tag",{set(){throw Error(`Alias nodes cannot have tags`)}})}resolve(e,t){if(t?.maxAliasCount===0)throw ReferenceError(`Alias resolution is disabled`);let n;t?.aliasResolveCache?n=t.aliasResolveCache:(n=[],Pr(e,{Node:(e,t)=>{(wr(t)||Ar(t))&&n.push(t)}}),t&&(t.aliasResolveCache=n));let r;for(let e of n){if(e===this)break;e.anchor===this.source&&(r=e)}return r}toJSON(e,t){if(!t)return{source:this.source};let{anchors:n,doc:r,maxAliasCount:i}=t,a=this.resolve(r,t);if(!a){let e=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw ReferenceError(e)}let o=n.get(a);if(o||=(qr(a,null,t),n.get(a)),o?.res===void 0)throw ReferenceError(`This should not happen: Alias anchor was not resolved?`);if(i>=0&&(o.count+=1,o.aliasCount===0&&(o.aliasCount=Xr(r,a,n)),o.count*o.aliasCount>i))throw ReferenceError(`Excessive alias count indicates a resource exhaustion attack`);return o.res}toString(e,t,n){let r=`*${this.source}`;if(e){if(Hr(this.source),e.options.verifyAliasOrder&&!e.anchors.has(this.source)){let e=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw Error(e)}if(e.implicitKey)return`${r} `}return r}};function Xr(e,t,n){if(wr(t)){let r=t.resolve(e),i=n&&r&&n.get(r);return i?i.count*i.aliasCount:0}if(kr(t)){let r=0;for(let i of t.items){let t=Xr(e,i,n);t>r&&(r=t)}return r}if(Dr(t)){let r=Xr(e,t.key,n),i=Xr(e,t.value,n);return Math.max(r,i)}return 1}var Zr=e=>!e||typeof e!=`function`&&typeof e!=`object`,M=class extends Jr{constructor(e){super(xr),this.value=e}toJSON(e,t){return t?.keep?this.value:qr(this.value,e,t)}toString(){return String(this.value)}};M.BLOCK_FOLDED=`BLOCK_FOLDED`,M.BLOCK_LITERAL=`BLOCK_LITERAL`,M.PLAIN=`PLAIN`,M.QUOTE_DOUBLE=`QUOTE_DOUBLE`,M.QUOTE_SINGLE=`QUOTE_SINGLE`;var Qr=`tag:yaml.org,2002:`;function $r(e,t,n){if(t){let e=n.filter(e=>e.tag===t),r=e.find(e=>!e.format)??e[0];if(!r)throw Error(`Tag ${t} not found`);return r}return n.find(t=>t.identify?.(e)&&!t.format)}function ei(e,t,n){if(Tr(e)&&(e=e.contents),j(e))return e;if(Dr(e)){let t=n.schema[yr].createNode?.(n.schema,null,n);return t.items.push(e),t}(e instanceof String||e instanceof Number||e instanceof Boolean||typeof BigInt<`u`&&e instanceof BigInt)&&(e=e.valueOf());let{aliasDuplicateObjects:r,onAnchor:i,onTagObj:a,schema:o,sourceObjects:s}=n,c;if(r&&e&&typeof e==`object`){if(c=s.get(e),c)return c.anchor??(c.anchor=i(e)),new Yr(c.anchor);c={anchor:null,node:null},s.set(e,c)}t?.startsWith(`!!`)&&(t=Qr+t.slice(2));let l=$r(e,t,o.tags);if(!l){if(e&&typeof e.toJSON==`function`&&(e=e.toJSON()),!e||typeof e!=`object`){let t=new M(e);return c&&(c.node=t),t}l=e instanceof Map?o[yr]:Symbol.iterator in Object(e)?o[Sr]:o[yr]}a&&(a(l),delete n.onTagObj);let u=l?.createNode?l.createNode(n.schema,e,n):typeof l?.nodeClass?.from==`function`?l.nodeClass.from(n.schema,e,n):new M(e);return t?u.tag=t:l.default||(u.tag=l.tag),c&&(c.node=u),u}function ti(e,t,n){let r=n;for(let e=t.length-1;e>=0;--e){let n=t[e];if(typeof n==`number`&&Number.isInteger(n)&&n>=0){let e=[];e[n]=r,r=e}else r=new Map([[n,r]])}return ei(r,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw Error(`This should not happen, please report a bug.`)},schema:e,sourceObjects:new Map})}var ni=e=>e==null||typeof e==`object`&&!!e[Symbol.iterator]().next().done,ri=class extends Jr{constructor(e,t){super(e),Object.defineProperty(this,"schema",{value:t,configurable:!0,enumerable:!1,writable:!0})}clone(e){let t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return e&&(t.schema=e),t.items=t.items.map(t=>j(t)||Dr(t)?t.clone(e):t),this.range&&(t.range=this.range.slice()),t}addIn(e,t){if(ni(e))this.add(t);else{let[n,...r]=e,i=this.get(n,!0);if(kr(i))i.addIn(r,t);else if(i===void 0&&this.schema)this.set(n,ti(this.schema,r,t));else throw Error(`Expected YAML collection at ${n}. Remaining path: ${r}`)}}deleteIn(e){let[t,...n]=e;if(n.length===0)return this.delete(t);let r=this.get(t,!0);if(kr(r))return r.deleteIn(n);throw Error(`Expected YAML collection at ${t}. Remaining path: ${n}`)}getIn(e,t){let[n,...r]=e,i=this.get(n,!0);return r.length===0?!t&&A(i)?i.value:i:kr(i)?i.getIn(r,t):void 0}hasAllNullValues(e){return this.items.every(t=>{if(!Dr(t))return!1;let n=t.value;return n==null||e&&A(n)&&n.value==null&&!n.commentBefore&&!n.comment&&!n.tag})}hasIn(e){let[t,...n]=e;if(n.length===0)return this.has(t);let r=this.get(t,!0);return kr(r)?r.hasIn(n):!1}setIn(e,t){let[n,...r]=e;if(r.length===0)this.set(n,t);else{let e=this.get(n,!0);if(kr(e))e.setIn(r,t);else if(e===void 0&&this.schema)this.set(n,ti(this.schema,r,t));else throw Error(`Expected YAML collection at ${n}. Remaining path: ${r}`)}}},ii=e=>e.replace(/^(?!$)(?: $)?/gm,`#`);function ai(e,t){return/^\n+$/.test(e)?e.substring(1):t?e.replace(/^(?! *$)/gm,t):e}var oi=(e,t,n)=>e.endsWith(`
`)?ai(n,t):n.includes(`
`)?`
`+ai(n,t):(e.endsWith(` `)?``:` `)+n,si=`flow`,ci=`block`,li=`quoted`;function ui(e,t,n=`flow`,{indentAtStart:r,lineWidth:i=80,minContentWidth:a=20,onFold:o,onOverflow:s}={}){if(!i||i<0)return e;i<a&&(a=0);let c=Math.max(1+a,1+i-t.length);if(e.length<=c)return e;let l=[],u={},d=i-t.length;typeof r==`number`&&(r>i-Math.max(2,a)?l.push(0):d=i-r);let f,p,m=!1,h=-1,g=-1,_=-1;n===`block`&&(h=di(e,h,t.length),h!==-1&&(d=h+c));for(let r;r=e[h+=1];){if(n===`quoted`&&r===`\\`){switch(g=h,e[h+1]){case`x`:h+=3;break;case`u`:h+=5;break;case`U`:h+=9;break;default:h+=1}_=h}if(r===`
`)n===`block`&&(h=di(e,h,t.length)),d=h+t.length+c,f=void 0;else{if(r===` `&&p&&p!==` `&&p!==`
`&&p!==`	`){let t=e[h+1];t&&t!==` `&&t!==`
`&&t!==`	`&&(f=h)}if(h>=d){if(f)l.push(f),d=f+c,f=void 0;else if(n===`quoted`){for(;p===` `||p===`	`;)p=r,r=e[h+=1],m=!0;let t=h>_+1?h-2:g-1;if(u[t])return e;l.push(t),u[t]=!0,d=t+c,f=void 0}else m=!0}}p=r}if(m&&s&&s(),l.length===0)return e;o&&o();let v=e.slice(0,l[0]);for(let r=0;r<l.length;++r){let i=l[r],a=l[r+1]||e.length;i===0?v=`\n${t}${e.slice(0,a)}`:(n===`quoted`&&u[i]&&(v+=`${e[i]}\\`),v+=`\n${t}${e.slice(i+1,a)}`)}return v}function di(e,t,n){let r=t,i=t+1,a=e[i];for(;a===` `||a===`	`;)if(t<i+n)a=e[++t];else{do a=e[++t];while(a&&a!==`
`);r=t,i=t+1,a=e[i]}return r}var fi=(e,t)=>({indentAtStart:t?e.indent.length:e.indentAtStart,lineWidth:e.options.lineWidth,minContentWidth:e.options.minContentWidth}),pi=e=>/^(%|---|\.\.\.)/m.test(e);function mi(e,t,n){if(!t||t<0)return!1;let r=t-n,i=e.length;if(i<=r)return!1;for(let t=0,n=0;t<i;++t)if(e[t]===`
`){if(t-n>r)return!0;if(n=t+1,i-n<=r)return!1}return!0}function hi(e,t){let n=JSON.stringify(e);if(t.options.doubleQuotedAsJSON)return n;let{implicitKey:r}=t,i=t.options.doubleQuotedMinMultiLineLength,a=t.indent||(pi(e)?`  `:``),o=``,s=0;for(let e=0,t=n[e];t;t=n[++e])if(t===` `&&n[e+1]===`\\`&&n[e+2]===`n`&&(o+=n.slice(s,e)+`\\ `,e+=1,s=e,t=`\\`),t===`\\`)switch(n[e+1]){case`u`:{o+=n.slice(s,e);let t=n.substr(e+2,4);switch(t){case`0000`:o+=`\\0`;break;case`0007`:o+=`\\a`;break;case`000b`:o+=`\\v`;break;case`001b`:o+=`\\e`;break;case`0085`:o+=`\\N`;break;case`00a0`:o+=`\\_`;break;case`2028`:o+=`\\L`;break;case`2029`:o+=`\\P`;break;default:t.substr(0,2)===`00`?o+=`\\x`+t.substr(2):o+=n.substr(e,6)}e+=5,s=e+1}break;case`n`:if(r||n[e+2]===`"`||n.length<i)e+=1;else{for(o+=n.slice(s,e)+`

`;n[e+2]===`\\`&&n[e+3]===`n`&&n[e+4]!==`"`;)o+=`
`,e+=2;o+=a,n[e+2]===` `&&(o+=`\\`),e+=1,s=e+1}break;default:e+=1}return o=s?o+n.slice(s):n,r?o:ui(o,a,li,fi(t,!1))}function gi(e,t){if(t.options.singleQuote===!1||t.implicitKey&&e.includes(`
`)||/[ \t]\n|\n[ \t]/.test(e))return hi(e,t);let n=t.indent||(pi(e)?`  `:``),r=`'`+e.replace(/'/g,`''`).replace(/\n+/g,`$&\n${n}`)+`'`;return t.implicitKey?r:ui(r,n,si,fi(t,!1))}function _i(e,t){let{singleQuote:n}=t.options,r;if(n===!1)r=hi;else{let t=e.includes(`"`),i=e.includes(`'`);r=t&&!i?gi:i&&!t?hi:n?gi:hi}return r(e,t)}var vi;try{vi=RegExp(`(^|(?<!
))
+(?!
|$)`,`g`)}catch{vi=/\n+(?!\n|$)/g}function yi({comment:e,type:t,value:n},r,i,a){let{blockQuote:o,commentString:s,lineWidth:c}=r.options;if(!o||/\n[\t ]+$/.test(n))return _i(n,r);let l=r.indent||(r.forceBlockIndent||pi(n)?`  `:``),u=o===`literal`?!0:o===`folded`||t===M.BLOCK_FOLDED?!1:t===M.BLOCK_LITERAL||!mi(n,c,l.length);if(!n)return u?`|
`:`>
...
`&&(p=p.slice(0,-1)),p.replace(vi,`$&${l}`));let h=!1,g,_=-1;for(g=0;g<n.length;++g){let e=n[g];if(e===` `)h=!0;else if(e===`
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,`$1$2`).replace(/\n+/g,`$&${l}`),i=!1,a=fi(r,!0);o!==`folded`&&t!==M.BLOCK_FOLDED&&(a.onOverflow=()=>{i=!0});let s=ui(`${v}${e}${p}`,l,ci,a);if(!i)return`>${y}\n${l}${s}`}return n=n.replace(/\n+/g,`$&${l}`),`|${y}\n${l}${v}${n}${p}`}function bi(e,t,n,r){let{type:i,value:a}=e,{actualString:o,implicitKey:s,indent:c,indentStep:l,inFlow:u}=t;if(s&&a.includes(`
`)||u&&/[[\]{},]/.test(a))return _i(a,t);if(/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(a))return s||u||!a.includes(`
`)?_i(a,t):yi(e,t,n,r);if(!s&&!u&&i!==M.PLAIN&&a.includes(`
`))return yi(e,t,n,r);if(pi(a)){if(c===``)return t.forceBlockIndent=!0,yi(e,t,n,r);if(s&&c===l)return _i(a,t)}let d=a.replace(/\n+/g,`$&\n${c}`);if(o){let e=e=>e.default&&e.tag!==`tag:yaml.org,2002:str`&&e.test?.test(d),{compat:n,tags:r}=t.doc.schema;if(r.some(e)||n?.some(e))return _i(a,t)}return s?d:ui(d,c,si,fi(t,!1))}function xi(e,t,n,r){let{implicitKey:i,inFlow:a}=t,o=typeof e.value==`string`?e:Object.assign({},e,{value:String(e.value)}),{type:s}=e;s!==M.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value)&&(s=M.QUOTE_DOUBLE);let c=e=>{switch(e){case M.BLOCK_FOLDED:case M.BLOCK_LITERAL:return i||a?_i(o.value,t):yi(o,t,n,r);case M.QUOTE_DOUBLE:return hi(o.value,t);case M.QUOTE_SINGLE:return gi(o.value,t);case M.PLAIN:return bi(o,t,n,r);default:return null}},l=c(s);if(l===null){let{defaultKeyType:e,defaultStringType:n}=t.options,r=i&&e||n;if(l=c(r),l===null)throw Error(`Unsupported default string type ${r}`)}return l}function Si(e,t){let n=Object.assign({blockQuote:!0,commentString:ii,defaultKeyType:null,defaultStringType:`PLAIN`,directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:`false`,flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:`null`,simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:`true`,verifyAliasOrder:!0},e.schema.toStringOptions,t),r;switch(n.collectionStyle){case`block`:r=!1;break;case`flow`:r=!0;break;default:r=null}return{anchors:new Set,doc:e,flowCollectionPadding:n.flowCollectionPadding?` `:``,indent:``,indentStep:typeof n.indent==`number`?` `.repeat(n.indent):`  `,inFlow:r,options:n}}function Ci(e,t){if(t.tag){let n=e.filter(e=>e.tag===t.tag);if(n.length>0)return n.find(e=>e.format===t.format)??n[0]}let n,r;if(A(t)){r=t.value;let i=e.filter(e=>e.identify?.(r));if(i.length>1){let e=i.filter(e=>e.test);e.length>0&&(i=e)}n=i.find(e=>e.format===t.format)??i.find(e=>!e.format)}else r=t,n=e.find(e=>e.nodeClass&&r instanceof e.nodeClass);if(!n){let e=r?.constructor?.name??(r===null?`null`:typeof r);throw Error(`Tag not resolved for ${e} value`)}return n}function wi(e,t,{anchors:n,doc:r}){if(!r.directives)return``;let i=[],a=(A(e)||kr(e))&&e.anchor;a&&Hr(a)&&(n.add(a),i.push(`&${a}`));let o=e.tag??(t.default?null:t.tag);return o&&i.push(r.directives.tagString(o)),i.join(` `)}function Ti(e,t,n,r){if(Dr(e))return e.toString(t,n,r);if(wr(e)){if(t.doc.directives)return e.toString(t);if(t.resolvedAliases?.has(e))throw TypeError(`Cannot stringify circular structure without alias nodes`);t.resolvedAliases?t.resolvedAliases.add(e):t.resolvedAliases=new Set([e]),e=e.resolve(t.doc)}let i,a=j(e)?e:t.doc.createNode(e,{onTagObj:e=>i=e});i??=Ci(t.doc.schema.tags,a);let o=wi(a,i,t);o.length>0&&(t.indentAtStart=(t.indentAtStart??0)+o.length+1);let s=typeof i.stringify==`function`?i.stringify(a,t,n,r):A(a)?xi(a,t,n,r):a.toString(t,n,r);return o?A(a)||s[0]===`{`||s[0]===`[`?`${o} ${s}`:`${o}\n${t.indent}${s}`:s}function Ei({key:e,value:t},n,r,i){let{allNullValues:a,doc:o,indent:s,indentStep:c,options:{commentString:l,indentSeq:u,simpleKeys:d}}=n,f=j(e)&&e.comment||null;if(d){if(f)throw Error(`With simple keys, key nodes cannot have comments`);if(kr(e)||!j(e)&&typeof e==`object`)throw Error(`With simple keys, collection cannot be used as a key value`)}let p=!d&&(!e||f&&t==null&&!n.inFlow||kr(e)||(A(e)?e.type===M.BLOCK_FOLDED||e.type===M.BLOCK_LITERAL:typeof e==`object`));n=Object.assign({},n,{allNullValues:!1,implicitKey:!p&&(d||!a),indent:s+c});let m=!1,h=!1,g=Ti(e,n,()=>m=!0,()=>h=!0);if(!p&&!n.inFlow&&g.length>1024){if(d)throw Error(`With simple keys, single line scalar must not span more than 1024 characters`);p=!0}if(n.inFlow){if(a||t==null)return m&&r&&r(),g===``?`?`:p?`? ${g}`:g}else if(a&&!d||t==null&&p)return g=`? ${g}`,f&&!m?g+=oi(g,n.indent,l(f)):h&&i&&i(),g;m&&(f=null),p?(f&&(g+=oi(g,n.indent,l(f))),g=`? ${g}\n${s}:`):(g=`${g}:`,f&&(g+=oi(g,n.indent,l(f))));let _,v,y;j(t)?(_=!!t.spaceBefore,v=t.commentBefore,y=t.comment):(_=!1,v=null,y=null,t&&typeof t==`object`&&(t=o.createNode(t))),n.implicitKey=!1,!p&&!f&&A(t)&&(n.indentAtStart=g.length+1),h=!1,!u&&c.length>=2&&!n.inFlow&&!p&&Or(t)&&!t.flow&&!t.tag&&!t.anchor&&(n.indent=n.indent.substring(2));let b=!1,x=Ti(t,n,()=>b=!0,()=>h=!0),S=` `;if(f||_||v){if(S=_?`
`:``,v){let e=l(v);S+=`\n${ai(e,n.indent)}`}x===``&&!n.inFlow?S===`
`&&y&&(S=`

`):S+=`\n${n.indent}`}else if(!p&&kr(t)){let e=x[0],r=x.indexOf(`
...
`)&&(S=``);return g+=S+x,n.inFlow?b&&r&&r():y&&!b?g+=oi(g,n.indent,l(y)):h&&i&&i(),g}function Di(e,t){(e===`debug`||e===`warn`)&&console.warn(t)}var Oi=`<<`,ki={identify:e=>e===Oi||typeof e==`symbol`&&e.description===Oi,default:`key`,tag:`tag:yaml.org,2002:merge`,test:/^<<$/,resolve:()=>Object.assign(new M(Symbol(Oi)),{addToJSMap:ji}),stringify:()=>Oi},Ai=(e,t)=>(ki.identify(t)||A(t)&&(!t.type||t.type===M.PLAIN)&&ki.identify(t.value))&&e?.doc.schema.tags.some(e=>e.tag===ki.tag&&e.default);function ji(e,t,n){let r=Ni(e,n);if(Or(r))for(let n of r.items)Mi(e,t,n);else if(Array.isArray(r))for(let n of r)Mi(e,t,n);else Mi(e,t,r)}function Mi(e,t,n){let r=Ni(e,n);if(!Er(r))throw Error(`Merge sources must be maps or map aliases`);let i=r.toJSON(null,e,Map);for(let[e,n]of i)t instanceof Map?t.has(e)||t.set(e,n):t instanceof Set?t.add(e):Object.prototype.hasOwnProperty.call(t,e)||Object.defineProperty(t,e,{value:n,writable:!0,enumerable:!0,configurable:!0});return t}function Ni(e,t){return e&&wr(t)?t.resolve(e.doc,e):t}function Pi(e,t,{key:n,value:r}){if(j(n)&&n.addToJSMap)n.addToJSMap(e,t,r);else if(Ai(e,n))ji(e,t,r);else{let i=qr(n,``,e);if(t instanceof Map)t.set(i,qr(r,i,e));else if(t instanceof Set)t.add(i);else{let a=Fi(n,i,e),o=qr(r,a,e);a in t?Object.defineProperty(t,a,{value:o,writable:!0,enumerable:!0,configurable:!0}):t[a]=o}}return t}function Fi(e,t,n){if(t===null)return``;if(typeof t!=`object`)return String(t);if(j(e)&&n?.doc){let t=Si(n.doc,{});t.anchors=new Set;for(let e of n.anchors.keys())t.anchors.add(e.anchor);t.inFlow=!0,t.inStringifyKey=!0;let r=e.toString(t);if(!n.mapKeyWarned){let e=JSON.stringify(r);e.length>40&&(e=e.substring(0,36)+`..."`),Di(n.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${e}. Set mapAsMap: true to use object keys.`),n.mapKeyWarned=!0}return r}return JSON.stringify(t)}function Ii(e,t,n){return new Li(ei(e,void 0,n),ei(t,void 0,n))}var Li=class e{constructor(e,t=null){Object.defineProperty(this,Cr,{value:br}),this.key=e,this.value=t}clone(t){let{key:n,value:r}=this;return j(n)&&(n=n.clone(t)),j(r)&&(r=r.clone(t)),new e(n,r)}toJSON(e,t){return Pi(t,t?.mapAsMap?new Map:{},this)}toString(e,t,n){return e?.doc?Ei(this,e,t,n):JSON.stringify(this)}};function Ri(e,t,n){return(t.inFlow??e.flow?N:zi)(e,t,n)}function zi({comment:e,items:t},n,{blockItemPrefix:r,flowChars:i,itemIndent:a,onChompKeep:o,onComment:s}){let{indent:c,options:{commentString:l}}=n,u=Object.assign({},n,{indent:a,type:null}),d=!1,f=[];for(let e=0;e<t.length;++e){let i=t[e],o=null;if(j(i))!d&&i.spaceBefore&&f.push(``),P(n,f,i.commentBefore,d),i.comment&&(o=i.comment);else if(Dr(i)){let e=j(i.key)?i.key:null;e&&(!d&&e.spaceBefore&&f.push(``),P(n,f,e.commentBefore,d))}d=!1;let s=Ti(i,u,()=>o=null,()=>d=!0);o&&(s+=oi(s,a,l(o))),d&&o&&(d=!1),f.push(r+s)}let p;if(f.length===0)p=i.start+i.end;else{p=f[0];for(let e=1;e<f.length;++e){let t=f[e];p+=t?`\n${c}${t}`:`
`}}return e?(p+=`
`+ai(l(e),c),s&&s()):d&&o&&o(),p}function N({items:e},t,{flowChars:n,itemIndent:r}){let{indent:i,indentStep:a,flowCollectionPadding:o,options:{commentString:s}}=t;r+=a;let c=Object.assign({},t,{indent:r,inFlow:!0,type:null}),l=!1,u=0,d=[];for(let n=0;n<e.length;++n){let i=e[n],a=null;if(j(i))i.spaceBefore&&d.push(``),P(t,d,i.commentBefore,!1),i.comment&&(a=i.comment);else if(Dr(i)){let e=j(i.key)?i.key:null;e&&(e.spaceBefore&&d.push(``),P(t,d,e.commentBefore,!1),e.comment&&(l=!0));let n=j(i.value)?i.value:null;n?(n.comment&&(a=n.comment),n.commentBefore&&(l=!0)):i.value==null&&e?.comment&&(a=e.comment)}a&&(l=!0);let o=Ti(i,c,()=>a=null);l||=d.length>u||o.includes(`
`),n<e.length-1?o+=`,`:t.options.trailingComma&&(t.options.lineWidth>0&&(l||=d.reduce((e,t)=>e+t.length+2,2)+(o.length+2)>t.options.lineWidth),l&&(o+=`,`)),a&&(o+=oi(o,r,s(a))),d.push(o),u=d.length}let{start:f,end:p}=n;if(d.length===0)return f+p;if(!l){let e=d.reduce((e,t)=>e+t.length+2,2);l=t.options.lineWidth>0&&e>t.options.lineWidth}if(l){let e=f;for(let t of d)e+=t?`\n${a}${i}${t}`:`
`;return`${e}\n${i}${p}`}return`${f}${o}${d.join(` `)}${o}${p}`}function P({indent:e,options:{commentString:t}},n,r,i){if(r&&i&&(r=r.replace(/^\n+/,``)),r){let i=ai(t(r),e);n.push(i.trimStart())}}function Bi(e,t){let n=A(t)?t.value:t;for(let r of e)if(Dr(r)&&(r.key===t||r.key===n||A(r.key)&&r.key.value===n))return r}var F=class extends ri{static get tagName(){return`tag:yaml.org,2002:map`}constructor(e){super(yr,e),this.items=[]}static from(e,t,n){let{keepUndefined:r,replacer:i}=n,a=new this(e),o=(e,o)=>{if(typeof i==`function`)o=i.call(t,e,o);else if(Array.isArray(i)&&!i.includes(e))return;(o!==void 0||r)&&a.items.push(Ii(e,o,n))};if(t instanceof Map)for(let[e,n]of t)o(e,n);else if(t&&typeof t==`object`)for(let e of Object.keys(t))o(e,t[e]);return typeof e.sortMapEntries==`function`&&a.items.sort(e.sortMapEntries),a}add(e,t){let n;n=Dr(e)?e:!e||typeof e!=`object`||!(`key`in e)?new Li(e,e?.value):new Li(e.key,e.value);let r=Bi(this.items,n.key),i=this.schema?.sortMapEntries;if(r){if(!t)throw Error(`Key ${n.key} already set`);A(r.value)&&Zr(n.value)?r.value.value=n.value:r.value=n.value}else if(i){let e=this.items.findIndex(e=>i(n,e)<0);e===-1?this.items.push(n):this.items.splice(e,0,n)}else this.items.push(n)}delete(e){let t=Bi(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){let n=Bi(this.items,e)?.value;return(!t&&A(n)?n.value:n)??void 0}has(e){return!!Bi(this.items,e)}set(e,t){this.add(new Li(e,t),!0)}toJSON(e,t,n){let r=n?new n:t?.mapAsMap?new Map:{};t?.onCreate&&t.onCreate(r);for(let e of this.items)Pi(t,r,e);return r}toString(e,t,n){if(!e)return JSON.stringify(this);for(let e of this.items)if(!Dr(e))throw Error(`Map items must all be pairs; found ${JSON.stringify(e)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),Ri(this,e,{blockItemPrefix:``,flowChars:{start:`{`,end:`}`},itemIndent:e.indent||``,onChompKeep:n,onComment:t})}},Vi={collection:`map`,default:!0,nodeClass:F,tag:`tag:yaml.org,2002:map`,resolve(e,t){return Er(e)||t(`Expected a mapping for this tag`),e},createNode:(e,t,n)=>F.from(e,t,n)},Hi=class extends ri{static get tagName(){return`tag:yaml.org,2002:seq`}constructor(e){super(Sr,e),this.items=[]}add(e){this.items.push(e)}delete(e){let t=Ui(e);return typeof t==`number`&&this.items.splice(t,1).length>0}get(e,t){let n=Ui(e);if(typeof n!=`number`)return;let r=this.items[n];return!t&&A(r)?r.value:r}has(e){let t=Ui(e);return typeof t==`number`&&t<this.items.length}set(e,t){let n=Ui(e);if(typeof n!=`number`)throw Error(`Expected a valid index, not ${e}.`);let r=this.items[n];A(r)&&Zr(t)?r.value=t:this.items[n]=t}toJSON(e,t){let n=[];t?.onCreate&&t.onCreate(n);let r=0;for(let e of this.items)n.push(qr(e,String(r++),t));return n}toString(e,t,n){return e?Ri(this,e,{blockItemPrefix:`- `,flowChars:{start:`[`,end:`]`},itemIndent:(e.indent||``)+`  `,onChompKeep:n,onComment:t}):JSON.stringify(this)}static from(e,t,n){let{replacer:r}=n,i=new this(e);if(t&&Symbol.iterator in Object(t)){let e=0;for(let a of t){if(typeof r==`function`){let n=t instanceof Set?a:String(e++);a=r.call(t,n,a)}i.items.push(ei(a,void 0,n))}}return i}};function Ui(e){let t=A(e)?e.value:e;return t&&typeof t==`string`&&(t=Number(t)),typeof t==`number`&&Number.isInteger(t)&&t>=0?t:null}var Wi={collection:`seq`,default:!0,nodeClass:Hi,tag:`tag:yaml.org,2002:seq`,resolve(e,t){return Or(e)||t(`Expected a sequence for this tag`),e},createNode:(e,t,n)=>Hi.from(e,t,n)},Gi={identify:e=>typeof e==`string`,default:!0,tag:`tag:yaml.org,2002:str`,resolve:e=>e,stringify(e,t,n,r){return t=Object.assign({actualString:!0},t),xi(e,t,n,r)}},Ki={identify:e=>e==null,createNode:()=>new M(null),default:!0,tag:`tag:yaml.org,2002:null`,test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new M(null),stringify:({source:e},t)=>typeof e==`string`&&Ki.test.test(e)?e:t.options.nullStr},qi={identify:e=>typeof e==`boolean`,default:!0,tag:`tag:yaml.org,2002:bool`,test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:e=>new M(e[0]===`t`||e[0]===`T`),stringify({source:e,value:t},n){return e&&qi.test.test(e)&&t===(e[0]===`t`||e[0]===`T`)?e:t?n.options.trueStr:n.options.falseStr}};function Ji({format:e,minFractionDigits:t,tag:n,value:r}){if(typeof r==`bigint`)return String(r);let i=typeof r==`number`?r:Number(r);if(!isFinite(i))return isNaN(i)?`.nan`:i<0?`-.inf`:`.inf`;let a=Object.is(r,-0)?`-0`:JSON.stringify(r);if(!e&&t&&(!n||n===`tag:yaml.org,2002:float`)&&/^-?\d/.test(a)&&!a.includes(`e`)){let e=a.indexOf(`.`);e<0&&(e=a.length,a+=`.`);let n=t-(a.length-e-1);for(;n-->0;)a+=`0`}return a}var Yi={identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:e=>e.slice(-3).toLowerCase()===`nan`?NaN:e[0]===`-`?-1/0:1/0,stringify:Ji},Xi={identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,format:`EXP`,test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:e=>parseFloat(e),stringify(e){let t=Number(e.value);return isFinite(t)?t.toExponential():Ji(e)}},Zi={identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(e){let t=new M(parseFloat(e)),n=e.indexOf(`.`);return n!==-1&&e[e.length-1]===`0`&&(t.minFractionDigits=e.length-n-1),t},stringify:Ji},Qi=e=>typeof e==`bigint`||Number.isInteger(e),$i=(e,t,n,{intAsBigInt:r})=>r?BigInt(e):parseInt(e.substring(t),n);function ea(e,t,n){let{value:r}=e;return Qi(r)&&r>=0?n+r.toString(t):Ji(e)}var ta={identify:e=>Qi(e)&&e>=0,default:!0,tag:`tag:yaml.org,2002:int`,format:`OCT`,test:/^0o[0-7]+$/,resolve:(e,t,n)=>$i(e,2,8,n),stringify:e=>ea(e,8,`0o`)},na={identify:Qi,default:!0,tag:`tag:yaml.org,2002:int`,test:/^[-+]?[0-9]+$/,resolve:(e,t,n)=>$i(e,0,10,n),stringify:Ji},ra={identify:e=>Qi(e)&&e>=0,default:!0,tag:`tag:yaml.org,2002:int`,format:`HEX`,test:/^0x[0-9a-fA-F]+$/,resolve:(e,t,n)=>$i(e,2,16,n),stringify:e=>ea(e,16,`0x`)},ia=[Vi,Wi,Gi,Ki,qi,ta,na,ra,Yi,Xi,Zi];function aa(e){return typeof e==`bigint`||Number.isInteger(e)}var oa=({value:e})=>JSON.stringify(e),sa=[{identify:e=>typeof e==`string`,default:!0,tag:`tag:yaml.org,2002:str`,resolve:e=>e,stringify:oa},{identify:e=>e==null,createNode:()=>new M(null),default:!0,tag:`tag:yaml.org,2002:null`,test:/^null$/,resolve:()=>null,stringify:oa},{identify:e=>typeof e==`boolean`,default:!0,tag:`tag:yaml.org,2002:bool`,test:/^true$|^false$/,resolve:e=>e===`true`,stringify:oa},{identify:aa,default:!0,tag:`tag:yaml.org,2002:int`,test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(e,t,{intAsBigInt:n})=>n?BigInt(e):parseInt(e,10),stringify:({value:e})=>aa(e)?e.toString():JSON.stringify(e)},{identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:e=>parseFloat(e),stringify:oa}],ca=[Vi,Wi].concat(sa,{default:!0,tag:``,test:/^/,resolve(e,t){return t(`Unresolved plain scalar ${JSON.stringify(e)}`),e}}),la={identify:e=>e instanceof Uint8Array,default:!1,tag:`tag:yaml.org,2002:binary`,resolve(e,t){if(typeof atob==`function`){let t=atob(e.replace(/[\n\r]/g,``)),n=new Uint8Array(t.length);for(let e=0;e<t.length;++e)n[e]=t.charCodeAt(e);return n}return t(`This environment does not support reading binary tags; either Buffer or atob is required`),e},stringify({comment:e,type:t,value:n},r,i,a){if(!n)return``;let o=n,s;if(typeof btoa==`function`){let e=``;for(let t=0;t<o.length;++t)e+=String.fromCharCode(o[t]);s=btoa(e)}else throw Error(`This environment does not support writing binary tags; either Buffer or btoa is required`);if(t??=M.BLOCK_LITERAL,t!==M.QUOTE_DOUBLE){let e=Math.max(r.options.lineWidth-r.indent.length,r.options.minContentWidth),n=Math.ceil(s.length/e),i=Array(n);for(let t=0,r=0;t<n;++t,r+=e)i[t]=s.substr(r,e);s=i.join(t===M.BLOCK_LITERAL?`
`:` `)}return xi({comment:e,type:t,value:s},r,i,a)}};function ua(e,t){if(Or(e))for(let n=0;n<e.items.length;++n){let r=e.items[n];if(!Dr(r)){if(Er(r)){r.items.length>1&&t(`Each pair must have its own sequence indicator`);let e=r.items[0]||new Li(new M(null));if(r.commentBefore&&(e.key.commentBefore=e.key.commentBefore?`${r.commentBefore}\n${e.key.commentBefore}`:r.commentBefore),r.comment){let t=e.value??e.key;t.comment=t.comment?`${r.comment}\n${t.comment}`:r.comment}r=e}e.items[n]=Dr(r)?r:new Li(r)}}else t(`Expected a sequence for this tag`);return e}function I(e,t,n){let{replacer:r}=n,i=new Hi(e);i.tag=`tag:yaml.org,2002:pairs`;let a=0;if(t&&Symbol.iterator in Object(t))for(let e of t){typeof r==`function`&&(e=r.call(t,String(a++),e));let o,s;if(Array.isArray(e)){if(e.length===2)o=e[0],s=e[1];else throw TypeError(`Expected [key, value] tuple: ${e}`)}else if(e&&e instanceof Object){let t=Object.keys(e);if(t.length===1)o=t[0],s=e[o];else throw TypeError(`Expected tuple with one key, not ${t.length} keys`)}else o=e;i.items.push(Ii(o,s,n))}return i}var da={collection:`seq`,default:!1,tag:`tag:yaml.org,2002:pairs`,resolve:ua,createNode:I},fa=class e extends Hi{constructor(){super(),this.add=F.prototype.add.bind(this),this.delete=F.prototype.delete.bind(this),this.get=F.prototype.get.bind(this),this.has=F.prototype.has.bind(this),this.set=F.prototype.set.bind(this),this.tag=e.tag}toJSON(e,t){if(!t)return super.toJSON(e);let n=new Map;t?.onCreate&&t.onCreate(n);for(let e of this.items){let r,i;if(Dr(e)?(r=qr(e.key,``,t),i=qr(e.value,r,t)):r=qr(e,``,t),n.has(r))throw Error(`Ordered maps must not include duplicate keys`);n.set(r,i)}return n}static from(e,t,n){let r=I(e,t,n),i=new this;return i.items=r.items,i}};fa.tag=`tag:yaml.org,2002:omap`;var pa={collection:`seq`,identify:e=>e instanceof Map,nodeClass:fa,default:!1,tag:`tag:yaml.org,2002:omap`,resolve(e,t){let n=ua(e,t),r=[];for(let{key:e}of n.items)A(e)&&(r.includes(e.value)?t(`Ordered maps must not include duplicate keys: ${e.value}`):r.push(e.value));return Object.assign(new fa,n)},createNode:(e,t,n)=>fa.from(e,t,n)};function ma({value:e,source:t},n){return t&&(e?ha:ga).test.test(t)?t:e?n.options.trueStr:n.options.falseStr}var ha={identify:e=>e===!0,default:!0,tag:`tag:yaml.org,2002:bool`,test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new M(!0),stringify:ma},ga={identify:e=>e===!1,default:!0,tag:`tag:yaml.org,2002:bool`,test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new M(!1),stringify:ma},_a={identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:e=>e.slice(-3).toLowerCase()===`nan`?NaN:e[0]===`-`?-1/0:1/0,stringify:Ji},va={identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,format:`EXP`,test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:e=>parseFloat(e.replace(/_/g,``)),stringify(e){let t=Number(e.value);return isFinite(t)?t.toExponential():Ji(e)}},ya={identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(e){let t=new M(parseFloat(e.replace(/_/g,``))),n=e.indexOf(`.`);if(n!==-1){let r=e.substring(n+1).replace(/_/g,``);r[r.length-1]===`0`&&(t.minFractionDigits=r.length)}return t},stringify:Ji},ba=e=>typeof e==`bigint`||Number.isInteger(e);function xa(e,t,n,{intAsBigInt:r}){let i=e[0];if((i===`-`||i===`+`)&&(t+=1),e=e.substring(t).replace(/_/g,``),r){switch(n){case 2:e=`0b${e}`;break;case 8:e=`0o${e}`;break;case 16:e=`0x${e}`}let t=BigInt(e);return i===`-`?BigInt(-1)*t:t}let a=parseInt(e,n);return i===`-`?-1*a:a}function Sa(e,t,n){let{value:r}=e;if(ba(r)){let e=r.toString(t);return r<0?`-`+n+e.substr(1):n+e}return Ji(e)}var Ca={identify:ba,default:!0,tag:`tag:yaml.org,2002:int`,format:`BIN`,test:/^[-+]?0b[0-1_]+$/,resolve:(e,t,n)=>xa(e,2,2,n),stringify:e=>Sa(e,2,`0b`)},wa={identify:ba,default:!0,tag:`tag:yaml.org,2002:int`,format:`OCT`,test:/^[-+]?0[0-7_]+$/,resolve:(e,t,n)=>xa(e,1,8,n),stringify:e=>Sa(e,8,`0`)},Ta={identify:ba,default:!0,tag:`tag:yaml.org,2002:int`,test:/^[-+]?[0-9][0-9_]*$/,resolve:(e,t,n)=>xa(e,0,10,n),stringify:Ji},Ea={identify:ba,default:!0,tag:`tag:yaml.org,2002:int`,format:`HEX`,test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(e,t,n)=>xa(e,2,16,n),stringify:e=>Sa(e,16,`0x`)},Da=class e extends F{constructor(t){super(t),this.tag=e.tag}add(e){let t;t=Dr(e)?e:e&&typeof e==`object`&&`key`in e&&`value`in e&&e.value===null?new Li(e.key,null):new Li(e,null),Bi(this.items,t.key)||this.items.push(t)}get(e,t){let n=Bi(this.items,e);return!t&&Dr(n)?A(n.key)?n.key.value:n.key:n}set(e,t){if(typeof t!=`boolean`)throw Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);let n=Bi(this.items,e);n&&!t?this.items.splice(this.items.indexOf(n),1):!n&&t&&this.items.push(new Li(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,n){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,n);throw Error(`Set items must all have null values`)}static from(e,t,n){let{replacer:r}=n,i=new this(e);if(t&&Symbol.iterator in Object(t))for(let e of t)typeof r==`function`&&(e=r.call(t,e,e)),i.items.push(Ii(e,null,n));return i}};Da.tag=`tag:yaml.org,2002:set`;var Oa={collection:`map`,identify:e=>e instanceof Set,nodeClass:Da,default:!1,tag:`tag:yaml.org,2002:set`,createNode:(e,t,n)=>Da.from(e,t,n),resolve(e,t){if(Er(e)){if(e.hasAllNullValues(!0))return Object.assign(new Da,e);t(`Set items must all have null values`)}else t(`Expected a mapping for this tag`);return e}};function ka(e,t){let n=e[0],r=n===`-`||n===`+`?e.substring(1):e,i=e=>t?BigInt(e):Number(e),a=r.replace(/_/g,``).split(`:`).reduce((e,t)=>e*i(60)+i(t),i(0));return n===`-`?i(-1)*a:a}function Aa(e){let{value:t}=e,n=e=>e;if(typeof t==`bigint`)n=e=>BigInt(e);else if(isNaN(t)||!isFinite(t))return Ji(e);let r=``;t<0&&(r=`-`,t*=n(-1));let i=n(60),a=[t%i];return t<60?a.unshift(0):(t=(t-a[0])/i,a.unshift(t%i),t>=60&&(t=(t-a[0])/i,a.unshift(t))),r+a.map(e=>String(e).padStart(2,`0`)).join(`:`).replace(/000000\d*$/,``)}var ja={identify:e=>typeof e==`bigint`||Number.isInteger(e),default:!0,tag:`tag:yaml.org,2002:int`,format:`TIME`,test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(e,t,{intAsBigInt:n})=>ka(e,n),stringify:Aa},Ma={identify:e=>typeof e==`number`,default:!0,tag:`tag:yaml.org,2002:float`,format:`TIME`,test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:e=>ka(e,!1),stringify:Aa},Na={identify:e=>e instanceof Date,default:!0,tag:`tag:yaml.org,2002:timestamp`,test:RegExp(`^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$`),resolve(e){let t=e.match(Na.test);if(!t)throw Error(`!!timestamp expects a date, starting with yyyy-mm-dd`);let[,n,r,i,a,o,s]=t.map(Number),c=t[7]?Number((t[7]+`00`).substr(1,3)):0,l=Date.UTC(n,r-1,i,a||0,o||0,s||0,c),u=t[8];if(u&&u!==`Z`){let e=ka(u,!1);Math.abs(e)<30&&(e*=60),l-=6e4*e}return new Date(l)},stringify:({value:e})=>e?.toISOString().replace(/(T00:00:00)?\.000Z$/,``)??``},Pa=[Vi,Wi,Gi,Ki,ha,ga,Ca,wa,Ta,Ea,_a,va,ya,la,ki,pa,da,Oa,ja,Ma,Na],Fa=new Map([[`core`,ia],[`failsafe`,[Vi,Wi,Gi]],[`json`,ca],[`yaml11`,Pa],[`yaml-1.1`,Pa]]),Ia={binary:la,bool:qi,float:Zi,floatExp:Xi,floatNaN:Yi,floatTime:Ma,int:na,intHex:ra,intOct:ta,intTime:ja,map:Vi,merge:ki,null:Ki,omap:pa,pairs:da,seq:Wi,set:Oa,timestamp:Na},La={"tag:yaml.org,2002:binary":la,"tag:yaml.org,2002:merge":ki,"tag:yaml.org,2002:omap":pa,"tag:yaml.org,2002:pairs":da,"tag:yaml.org,2002:set":Oa,"tag:yaml.org,2002:timestamp":Na};function Ra(e,t,n){let r=Fa.get(t);if(r&&!e)return n&&!r.includes(ki)?r.concat(ki):r.slice();let i=r;if(!i){if(Array.isArray(e))i=[];else{let e=Array.from(Fa.keys()).filter(e=>e!==`yaml11`).map(e=>JSON.stringify(e)).join(`, `);throw Error(`Unknown schema "${t}"; use one of ${e} or define customTags array`)}}if(Array.isArray(e))for(let t of e)i=i.concat(t);else typeof e==`function`&&(i=e(i.slice()));return n&&(i=i.concat(ki)),i.reduce((e,t)=>{let n=typeof t==`string`?Ia[t]:t;if(!n){let e=JSON.stringify(t),n=Object.keys(Ia).map(e=>JSON.stringify(e)).join(`, `);throw Error(`Unknown custom tag ${e}; use one of ${n}`)}return e.includes(n)||e.push(n),e},[])}var za=(e,t)=>e.key<t.key?-1:+(e.key>t.key),Ba=class e{constructor({compat:e,customTags:t,merge:n,resolveKnownTags:r,schema:i,sortMapEntries:a,toStringDefaults:o}){this.compat=Array.isArray(e)?Ra(e,`compat`):e?Ra(null,e):null,this.name=typeof i==`string`&&i||`core`,this.knownTags=r?La:{},this.tags=Ra(t,this.name,n),this.toStringOptions=o??null,Object.defineProperty(this,yr,{value:Vi}),Object.defineProperty(this,xr,{value:Gi}),Object.defineProperty(this,Sr,{value:Wi}),this.sortMapEntries=typeof a==`function`?a:a===!0?za:null}clone(){let t=Object.create(e.prototype,Object.getOwnPropertyDescriptors(this));return t.tags=this.tags.slice(),t}};function Va(e,t){let n=[],r=t.directives===!0;if(t.directives!==!1&&e.directives){let t=e.directives.toString(e);t?(n.push(t),r=!0):e.directives.docStart&&(r=!0)}r&&n.push(`---`);let i=Si(e,t),{commentString:a}=i.options;if(e.commentBefore){n.length!==1&&n.unshift(``);let t=a(e.commentBefore);n.unshift(ai(t,``))}let o=!1,s=null;if(e.contents){if(j(e.contents)){if(e.contents.spaceBefore&&r&&n.push(``),e.contents.commentBefore){let t=a(e.contents.commentBefore);n.push(ai(t,``))}i.forceBlockIndent=!!e.comment,s=e.contents.comment}let t=s?void 0:()=>o=!0,c=Ti(e.contents,i,()=>s=null,t);s&&(c+=oi(c,``,a(s))),(c[0]===`|`||c[0]===`>`)&&n[n.length-1]===`---`?n[n.length-1]=`--- ${c}`:n.push(c)}else n.push(Ti(e.contents,i));if(e.directives?.docEnd){if(e.comment){let t=a(e.comment);t.includes(`
`)?(n.push(`...`),n.push(ai(t,``))):n.push(`... ${t}`)}else n.push(`...`)}else{let t=e.comment;t&&o&&(t=t.replace(/^\n+/,``)),t&&((!o||s)&&n[n.length-1]!==``&&n.push(``),n.push(ai(a(t),``)))}return n.join(`
`)+`
`}var Ha=class e{constructor(e,t,n){this.commentBefore=null,this.comment=null,this.errors=[],this.warnings=[],Object.defineProperty(this,Cr,{value:vr});let r=null;typeof t==`function`||Array.isArray(t)?r=t:n===void 0&&t&&(n=t,t=void 0);let i=Object.assign({intAsBigInt:!1,keepSourceTokens:!1,logLevel:`warn`,prettyErrors:!0,strict:!0,stringKeys:!1,uniqueKeys:!0,version:`1.2`},n);this.options=i;let{version:a}=i;n?._directives?(this.directives=n._directives.atDocument(),this.directives.yaml.explicit&&(a=this.directives.yaml.version)):this.directives=new Vr({version:a}),this.setSchema(a,n),this.contents=e===void 0?null:this.createNode(e,r,n)}clone(){let t=Object.create(e.prototype,{[Cr]:{value:vr}});return t.commentBefore=this.commentBefore,t.comment=this.comment,t.errors=this.errors.slice(),t.warnings=this.warnings.slice(),t.options=Object.assign({},this.options),this.directives&&(t.directives=this.directives.clone()),t.schema=this.schema.clone(),t.contents=j(this.contents)?this.contents.clone(t.schema):this.contents,this.range&&(t.range=this.range.slice()),t}add(e){Ua(this.contents)&&this.contents.add(e)}addIn(e,t){Ua(this.contents)&&this.contents.addIn(e,t)}createAlias(e,t){if(!e.anchor){let n=Ur(this);e.anchor=!t||n.has(t)?Wr(t||`a`,n):t}return new Yr(e.anchor)}createNode(e,t,n){let r;if(typeof t==`function`)e=t.call({"":e},``,e),r=t;else if(Array.isArray(t)){let e=t.filter(e=>typeof e==`number`||e instanceof String||e instanceof Number).map(String);e.length>0&&(t=t.concat(e)),r=t}else n===void 0&&t&&(n=t,t=void 0);let{aliasDuplicateObjects:i,anchorPrefix:a,flow:o,keepUndefined:s,onTagObj:c,tag:l}=n??{},{onAnchor:u,setAnchors:d,sourceObjects:f}=Gr(this,a||`a`),p={aliasDuplicateObjects:i??!0,keepUndefined:s??!1,onAnchor:u,onTagObj:c,replacer:r,schema:this.schema,sourceObjects:f},m=ei(e,l,p);return o&&kr(m)&&(m.flow=!0),d(),m}createPair(e,t,n={}){return new Li(this.createNode(e,null,n),this.createNode(t,null,n))}delete(e){return Ua(this.contents)?this.contents.delete(e):!1}deleteIn(e){return ni(e)?this.contents!=null&&(this.contents=null,!0):Ua(this.contents)?this.contents.deleteIn(e):!1}get(e,t){return kr(this.contents)?this.contents.get(e,t):void 0}getIn(e,t){return ni(e)?!t&&A(this.contents)?this.contents.value:this.contents:kr(this.contents)?this.contents.getIn(e,t):void 0}has(e){return kr(this.contents)?this.contents.has(e):!1}hasIn(e){return ni(e)?this.contents!==void 0:kr(this.contents)?this.contents.hasIn(e):!1}set(e,t){this.contents==null?this.contents=ti(this.schema,[e],t):Ua(this.contents)&&this.contents.set(e,t)}setIn(e,t){ni(e)?this.contents=t:this.contents==null?this.contents=ti(this.schema,Array.from(e),t):Ua(this.contents)&&this.contents.setIn(e,t)}setSchema(e,t={}){typeof e==`number`&&(e=String(e));let n;switch(e){case`1.1`:this.directives?this.directives.yaml.version=`1.1`:this.directives=new Vr({version:`1.1`}),n={resolveKnownTags:!1,schema:`yaml-1.1`};break;case`1.2`:case`next`:this.directives?this.directives.yaml.version=e:this.directives=new Vr({version:e}),n={resolveKnownTags:!0,schema:`core`};break;case null:this.directives&&delete this.directives,n=null;break;default:{let t=JSON.stringify(e);throw Error(`Expected '1.1', '1.2' or null as first argument, but found: ${t}`)}}if(t.schema instanceof Object)this.schema=t.schema;else if(n)this.schema=new Ba(Object.assign(n,t));else throw Error(`With a null YAML version, the { schema: Schema } option is required`)}toJS({json:e,jsonArg:t,mapAsMap:n,maxAliasCount:r,onAnchor:i,reviver:a}={}){let o={anchors:new Map,doc:this,keep:!e,mapAsMap:n===!0,mapKeyWarned:!1,maxAliasCount:typeof r==`number`?r:100},s=qr(this.contents,t??``,o);if(typeof i==`function`)for(let{count:e,res:t}of o.anchors.values())i(t,e);return typeof a==`function`?Kr(a,{"":s},``,s):s}toJSON(e,t){return this.toJS({json:!0,jsonArg:e,mapAsMap:!1,onAnchor:t})}toString(e={}){if(this.errors.length>0)throw Error(`Document with errors cannot be stringified`);if(`indent`in e&&(!Number.isInteger(e.indent)||Number(e.indent)<=0)){let t=JSON.stringify(e.indent);throw Error(`"indent" option must be a positive integer, not ${t}`)}return Va(this,e)}};function Ua(e){if(kr(e))return!0;throw Error(`Expected a YAML collection as document contents`)}var Wa=class extends Error{constructor(e,t,n,r){super(),this.name=e,this.code=n,this.message=r,this.pos=t}},Ga=class extends Wa{constructor(e,t,n){super(`YAMLParseError`,e,t,n)}},Ka=class extends Wa{constructor(e,t,n){super(`YAMLWarning`,e,t,n)}},qa=(e,t)=>n=>{if(n.pos[0]===-1)return;n.linePos=n.pos.map(e=>t.linePos(e));let{line:r,col:i}=n.linePos[0];n.message+=` at line ${r}, column ${i}`;let a=i-1,o=e.substring(t.lineStarts[r-1],t.lineStarts[r]).replace(/[\n\r]+$/,``);if(a>=60&&o.length>80){let e=Math.min(a-39,o.length-79);o=`…`+o.substring(e),a-=e-1}if(o.length>80&&(o=o.substring(0,79)+`…`),r>1&&/^ *$/.test(o.substring(0,a))){let n=e.substring(t.lineStarts[r-2],t.lineStarts[r-1]);n.length>80&&(n=n.substring(0,79)+`…
`),o=n+o}if(/[^ ]/.test(o)){let e=1,t=n.linePos[1];t?.line===r&&t.col>i&&(e=Math.max(1,Math.min(t.col-i,80-a)));let s=` `.repeat(a)+`^`.repeat(e);n.message+=`:\n\n${o}\n${s}\n`}};function Ja(e,{flow:t,indicator:n,next:r,offset:i,onError:a,parentIndent:o,startOnNewline:s}){let c=!1,l=s,u=s,d=``,f=``,p=!1,m=!1,h=null,g=null,_=null,v=null,y=null,b=null,x=null;for(let i of e)switch(m&&=(i.type!==`space`&&i.type!==`newline`&&i.type!==`comma`&&a(i.offset,`MISSING_CHAR`,`Tags and anchors must be separated from the next token by white space`),!1),h&&=(l&&i.type!==`comment`&&i.type!==`newline`&&a(h,`TAB_AS_INDENT`,`Tabs are not allowed as indentation`),null),i.type){case`space`:!t&&(n!==`doc-start`||r?.type!==`flow-collection`)&&i.source.includes(`	`)&&(h=i),u=!0;break;case`comment`:{u||a(i,`MISSING_CHAR`,`Comments must be separated from other tokens by white space characters`);let e=i.source.substring(1)||` `;d?d+=f+e:d=e,f=``,l=!1;break}case`newline`:l?d?d+=i.source:(!b||n!==`seq-item-ind`)&&(c=!0):f+=i.source,l=!0,p=!0,(g||_)&&(v=i),u=!0;break;case`anchor`:g&&a(i,`MULTIPLE_ANCHORS`,`A node can have at most one anchor`),i.source.endsWith(`:`)&&a(i.offset+i.source.length-1,`BAD_ALIAS`,`Anchor ending in : is ambiguous`,!0),g=i,x??=i.offset,l=!1,u=!1,m=!0;break;case`tag`:_&&a(i,`MULTIPLE_TAGS`,`A node can have at most one tag`),_=i,x??=i.offset,l=!1,u=!1,m=!0;break;case n:(g||_)&&a(i,`BAD_PROP_ORDER`,`Anchors and tags must be after the ${i.source} indicator`),b&&a(i,`UNEXPECTED_TOKEN`,`Unexpected ${i.source} in ${t??`collection`}`),b=i,l=n===`seq-item-ind`||n===`explicit-key-ind`,u=!1;break;case`comma`:if(t){y&&a(i,`UNEXPECTED_TOKEN`,`Unexpected , in ${t}`),y=i,l=!1,u=!1;break}default:a(i,`UNEXPECTED_TOKEN`,`Unexpected ${i.type} token`),l=!1,u=!1}let S=e[e.length-1],ee=S?S.offset+S.source.length:i;return m&&r&&r.type!==`space`&&r.type!==`newline`&&r.type!==`comma`&&(r.type!==`scalar`||r.source!==``)&&a(r.offset,`MISSING_CHAR`,`Tags and anchors must be separated from the next token by white space`),h&&(l&&h.indent<=o||r?.type===`block-map`||r?.type===`block-seq`)&&a(h,`TAB_AS_INDENT`,`Tabs are not allowed as indentation`),{comma:y,found:b,spaceBefore:c,comment:d,hasNewline:p,anchor:g,tag:_,newlineAfterProp:v,end:ee,start:x??ee}}function Ya(e){if(!e)return null;switch(e.type){case`alias`:case`scalar`:case`double-quoted-scalar`:case`single-quoted-scalar`:if(e.source.includes(`
`))return!0;if(e.end){for(let t of e.end)if(t.type===`newline`)return!0}return!1;case`flow-collection`:for(let t of e.items){for(let e of t.start)if(e.type===`newline`)return!0;if(t.sep){for(let e of t.sep)if(e.type===`newline`)return!0}if(Ya(t.key)||Ya(t.value))return!0}return!1;default:return!0}}function Xa(e,t,n){if(t?.type===`flow-collection`){let r=t.end[0];r.indent===e&&(r.source===`]`||r.source===`}`)&&Ya(t)&&n(r,`BAD_INDENT`,`Flow end indicator should be more indented than parent`,!0)}}function Za(e,t,n){let{uniqueKeys:r}=e.options;if(r===!1)return!1;let i=typeof r==`function`?r:(e,t)=>e===t||A(e)&&A(t)&&e.value===t.value;return t.some(e=>i(e.key,n))}var Qa=`All mapping items must start at the same column`;function $a({composeNode:e,composeEmptyNode:t},n,r,i,a){let o=new((a?.nodeClass)??F)(n.schema);n.atRoot&&=!1;let s=r.offset,c=null;for(let a of r.items){let{start:l,key:u,sep:d,value:f}=a,p=Ja(l,{indicator:`explicit-key-ind`,next:u??d?.[0],offset:s,onError:i,parentIndent:r.indent,startOnNewline:!0}),m=!p.found;if(m){if(u&&(u.type===`block-seq`?i(s,`BLOCK_AS_IMPLICIT_KEY`,`A block sequence may not be used as an implicit map key`):`indent`in u&&u.indent!==r.indent&&i(s,`BAD_INDENT`,Qa)),!p.anchor&&!p.tag&&!d){c=p.end,p.comment&&(o.comment?o.comment+=`
`+p.comment:o.comment=p.comment);continue}(p.newlineAfterProp||Ya(u))&&i(u??l[l.length-1],`MULTILINE_IMPLICIT_KEY`,`Implicit keys need to be on a single line`)}else p.found?.indent!==r.indent&&i(s,`BAD_INDENT`,Qa);n.atKey=!0;let h=p.end,g=u?e(n,u,p,i):t(n,h,l,null,p,i);n.schema.compat&&Xa(r.indent,u,i),n.atKey=!1,Za(n,o.items,g)&&i(h,`DUPLICATE_KEY`,`Map keys must be unique`);let _=Ja(d??[],{indicator:`map-value-ind`,next:f,offset:g.range[2],onError:i,parentIndent:r.indent,startOnNewline:!u||u.type===`block-scalar`});if(s=_.end,_.found){m&&(f?.type===`block-map`&&!_.hasNewline&&i(s,`BLOCK_AS_IMPLICIT_KEY`,`Nested mappings are not allowed in compact mappings`),n.options.strict&&p.start<_.found.offset-1024&&i(g.range,`KEY_OVER_1024_CHARS`,`The : indicator must be at most 1024 chars after the start of an implicit block mapping key`));let c=f?e(n,f,_,i):t(n,s,d,null,_,i);n.schema.compat&&Xa(r.indent,f,i),s=c.range[2];let l=new Li(g,c);n.options.keepSourceTokens&&(l.srcToken=a),o.items.push(l)}else{m&&i(g.range,`MISSING_CHAR`,`Implicit map keys need to be followed by map values`),_.comment&&(g.comment?g.comment+=`
`+_.comment:g.comment=_.comment);let e=new Li(g);n.options.keepSourceTokens&&(e.srcToken=a),o.items.push(e)}}return c&&c<s&&i(c,`IMPOSSIBLE`,`Map comment with trailing content`),o.range=[r.offset,s,c??s],o}function eo({composeNode:e,composeEmptyNode:t},n,r,i,a){let o=new((a?.nodeClass)??Hi)(n.schema);n.atRoot&&=!1,n.atKey&&=!1;let s=r.offset,c=null;for(let{start:a,value:l}of r.items){let u=Ja(a,{indicator:`seq-item-ind`,next:l,offset:s,onError:i,parentIndent:r.indent,startOnNewline:!0});if(!u.found){if(u.anchor||u.tag||l)l?.type===`block-seq`?i(u.end,`BAD_INDENT`,`All sequence items must start at the same column`):i(s,`MISSING_CHAR`,`Sequence item without - indicator`);else{c=u.end,u.comment&&(o.comment=u.comment);continue}}let d=l?e(n,l,u,i):t(n,u.end,a,null,u,i);n.schema.compat&&Xa(r.indent,l,i),s=d.range[2],o.items.push(d)}return o.range=[r.offset,s,c??s],o}function to(e,t,n,r){let i=``;if(e){let a=!1,o=``;for(let s of e){let{source:e,type:c}=s;switch(c){case`space`:a=!0;break;case`comment`:{n&&!a&&r(s,`MISSING_CHAR`,`Comments must be separated from other tokens by white space characters`);let t=e.substring(1)||` `;i?i+=o+t:i=t,o=``;break}case`newline`:i&&(o+=e),a=!0;break;default:r(s,`UNEXPECTED_TOKEN`,`Unexpected ${c} at node end`)}t+=e.length}}return{comment:i,offset:t}}var no=`Block collections are not allowed within flow collections`,ro=e=>e&&(e.type===`block-map`||e.type===`block-seq`);function io({composeNode:e,composeEmptyNode:t},n,r,i,a){let o=r.start.source===`{`,s=o?`flow map`:`flow sequence`,c=new((a?.nodeClass)??(o?F:Hi))(n.schema);c.flow=!0;let l=n.atRoot;l&&(n.atRoot=!1),n.atKey&&=!1;let u=r.offset+r.start.source.length;for(let a=0;a<r.items.length;++a){let l=r.items[a],{start:d,key:f,sep:p,value:m}=l,h=Ja(d,{flow:s,indicator:`explicit-key-ind`,next:f??p?.[0],offset:u,onError:i,parentIndent:r.indent,startOnNewline:!1});if(!h.found){if(!h.anchor&&!h.tag&&!p&&!m){a===0&&h.comma?i(h.comma,`UNEXPECTED_TOKEN`,`Unexpected , in ${s}`):a<r.items.length-1&&i(h.start,`UNEXPECTED_TOKEN`,`Unexpected empty item in ${s}`),h.comment&&(c.comment?c.comment+=`
`+h.comment:c.comment=h.comment),u=h.end;continue}!o&&n.options.strict&&Ya(f)&&i(f,`MULTILINE_IMPLICIT_KEY`,`Implicit keys of flow sequence pairs need to be on a single line`)}if(a===0)h.comma&&i(h.comma,`UNEXPECTED_TOKEN`,`Unexpected , in ${s}`);else if(h.comma||i(h.start,`MISSING_CHAR`,`Missing , between ${s} items`),h.comment){let e=``;loop:for(let t of d)switch(t.type){case`comma`:case`space`:break;case`comment`:e=t.source.substring(1);break loop;default:break loop}if(e){let t=c.items[c.items.length-1];Dr(t)&&(t=t.value??t.key),t.comment?t.comment+=`
`+e:t.comment=e,h.comment=h.comment.substring(e.length+1)}}if(!o&&!p&&!h.found){let r=m?e(n,m,h,i):t(n,h.end,p,null,h,i);c.items.push(r),u=r.range[2],ro(m)&&i(r.range,`BLOCK_IN_FLOW`,no)}else{n.atKey=!0;let a=h.end,g=f?e(n,f,h,i):t(n,a,d,null,h,i);ro(f)&&i(g.range,`BLOCK_IN_FLOW`,no),n.atKey=!1;let _=Ja(p??[],{flow:s,indicator:`map-value-ind`,next:m,offset:g.range[2],onError:i,parentIndent:r.indent,startOnNewline:!1});if(_.found){if(!o&&!h.found&&n.options.strict){if(p)for(let e of p){if(e===_.found)break;if(e.type===`newline`){i(e,`MULTILINE_IMPLICIT_KEY`,`Implicit keys of flow sequence pairs need to be on a single line`);break}}h.start<_.found.offset-1024&&i(_.found,`KEY_OVER_1024_CHARS`,`The : indicator must be at most 1024 chars after the start of an implicit flow sequence key`)}}else m&&(`source`in m&&m.source?.[0]===`:`?i(m,`MISSING_CHAR`,`Missing space after : in ${s}`):i(_.start,`MISSING_CHAR`,`Missing , or : between ${s} items`));let v=m?e(n,m,_,i):_.found?t(n,_.end,p,null,_,i):null;v?ro(m)&&i(v.range,`BLOCK_IN_FLOW`,no):_.comment&&(g.comment?g.comment+=`
`+_.comment:g.comment=_.comment);let y=new Li(g,v);if(n.options.keepSourceTokens&&(y.srcToken=l),o){let e=c;Za(n,e.items,g)&&i(a,`DUPLICATE_KEY`,`Map keys must be unique`),e.items.push(y)}else{let e=new F(n.schema);e.flow=!0,e.items.push(y);let t=(v??g).range;e.range=[g.range[0],t[1],t[2]],c.items.push(e)}u=v?v.range[2]:_.end}}let d=o?`}`:`]`,[f,...p]=r.end,m=u;if(f?.source===d)m=f.offset+f.source.length;else{let e=s[0].toUpperCase()+s.substring(1),t=l?`${e} must end with a ${d}`:`${e} in block collection must be sufficiently indented and end with a ${d}`;i(u,l?`MISSING_CHAR`:`BAD_INDENT`,t),f&&f.source.length!==1&&p.unshift(f)}if(p.length>0){let e=to(p,m,n.options.strict,i);e.comment&&(c.comment?c.comment+=`
`+e.comment:c.comment=e.comment),c.range=[r.offset,m,e.offset]}else c.range=[r.offset,m,m];return c}function ao(e,t,n,r,i,a){let o=n.type===`block-map`?$a(e,t,n,r,a):n.type===`block-seq`?eo(e,t,n,r,a):io(e,t,n,r,a),s=o.constructor;return i===`!`||i===s.tagName?(o.tag=s.tagName,o):(i&&(o.tag=i),o)}function oo(e,t,n,r,i){let a=r.tag,o=a?t.directives.tagName(a.source,e=>i(a,`TAG_RESOLVE_FAILED`,e)):null;if(n.type===`block-seq`){let{anchor:e,newlineAfterProp:t}=r,n=e&&a?e.offset>a.offset?e:a:e??a;n&&(!t||t.offset<n.offset)&&i(n,`MISSING_CHAR`,`Missing newline after block sequence props`)}let s=n.type===`block-map`?`map`:n.type===`block-seq`?`seq`:n.start.source===`{`?`map`:`seq`;if(!a||!o||o===`!`||o===F.tagName&&s===`map`||o===Hi.tagName&&s===`seq`)return ao(e,t,n,i,o);let c=t.schema.tags.find(e=>e.tag===o&&e.collection===s);if(!c){let r=t.schema.knownTags[o];if(r?.collection===s)t.schema.tags.push(Object.assign({},r,{default:!1})),c=r;else return r?i(a,`BAD_COLLECTION_TYPE`,`${r.tag} used for ${s} collection, but expects ${r.collection??`scalar`}`,!0):i(a,`TAG_RESOLVE_FAILED`,`Unresolved tag: ${o}`,!0),ao(e,t,n,i,o)}let l=ao(e,t,n,i,o,c),u=c.resolve?.(l,e=>i(a,`TAG_RESOLVE_FAILED`,e),t.options)??l,d=j(u)?u:new M(u);return d.range=l.range,d.tag=o,c?.format&&(d.format=c.format),d}function so(e,t,n){let r=t.offset,i=co(t,e.options.strict,n);if(!i)return{value:``,type:null,comment:``,range:[r,r,r]};let a=i.mode===`>`?M.BLOCK_FOLDED:M.BLOCK_LITERAL,o=t.source?lo(t.source):[],s=o.length;for(let e=o.length-1;e>=0;--e){let t=o[e][1];if(t===``||t===`\r`)s=e;else break}if(s===0){let e=i.chomp===`+`&&o.length>0?`
...
`;for(let e=u;e<s;++e){let[t,r]=o[e];l+=t.length+r.length+1;let s=r[r.length-1]===`\r`;if(s&&(r=r.slice(0,-1)),r&&t.length<c){let e=`Block scalar lines must not be less indented than their ${i.indent?`explicit indentation indicator`:`first line`}`;n(l-r.length-(s?2:1),`BAD_INDENT`,e),t=``}a===M.BLOCK_LITERAL?(d+=f+t.slice(c)+r,f=`
`):t.length>c||r[0]===`	`?(f===` `?f=`
`:!p&&f===`
`&&(f=`
...
`&&(d+=`
`);break;default:d+=`
`}let m=r+i.length+t.source.length;return{value:d,type:a,comment:i.comment,range:[r,m,m]}}function co({offset:e,props:t},n,r){if(t[0].type!==`block-scalar-header`)return r(t[0],`IMPOSSIBLE`,`Block scalar header not found`),null;let{source:i}=t[0],a=i[0],o=0,s=``,c=-1;for(let t=1;t<i.length;++t){let n=i[t];if(!s&&(n===`-`||n===`+`))s=n;else{let r=Number(n);!o&&r?o=r:c===-1&&(c=e+t)}}c!==-1&&r(c,`UNEXPECTED_TOKEN`,`Block scalar header includes extra characters: ${i}`);let l=!1,u=``,d=i.length;for(let e=1;e<t.length;++e){let i=t[e];switch(i.type){case`space`:l=!0;case`newline`:d+=i.source.length;break;case`comment`:n&&!l&&r(i,`MISSING_CHAR`,`Comments must be separated from other tokens by white space characters`),d+=i.source.length,u=i.source.substring(1);break;case`error`:r(i,`UNEXPECTED_TOKEN`,i.message),d+=i.source.length;break;default:{r(i,`UNEXPECTED_TOKEN`,`Unexpected token in block scalar header: ${i.type}`);let e=i.source;e&&typeof e==`string`&&(d+=e.length)}}}return{mode:a,indent:o,chomp:s,comment:u,length:d}}function lo(e){let t=e.split(/\n( *)/),n=t[0],r=n.match(/^( *)/),i=[r?.[1]?[r[1],n.slice(r[1].length)]:[``,n]];for(let e=1;e<t.length;e+=2)i.push([t[e],t[e+1]]);return i}function uo(e,t,n){let{offset:r,type:i,source:a,end:o}=e,s,c,l=(e,t,i)=>n(r+e,t,i);switch(i){case`scalar`:s=M.PLAIN,c=fo(a,l);break;case`single-quoted-scalar`:s=M.QUOTE_SINGLE,c=po(a,l);break;case`double-quoted-scalar`:s=M.QUOTE_DOUBLE,c=mo(a,l);break;default:return n(e,`UNEXPECTED_TOKEN`,`Expected a flow scalar value, but found: ${i}`),{value:``,type:null,comment:``,range:[r,r+a.length,r+a.length]}}let u=r+a.length,d=to(o,u,t,n);return{value:c,type:s,comment:d.comment,range:[r,u,d.offset]}}function fo(e,t){let n=``;switch(e[0]){case`	`:n=`a tab character`;break;case`,`:n=`flow indicator character ,`;break;case`%`:n=`directive indicator character %`;break;case`|`:case`>`:n=`block scalar indicator ${e[0]}`;break;case`@`:case"`":n=`reserved character ${e[0]}`}return n&&t(0,`BAD_SCALAR_START`,`Plain value cannot start with ${n}`),L(e)}function po(e,t){return(e[e.length-1]!==`'`||e.length===1)&&t(e.length,`MISSING_CHAR`,`Missing closing 'quote`),L(e.slice(1,-1)).replace(/''/g,`'`)}function L(e){let t,n;try{t=RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,`sy`),n=RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,`sy`)}catch{t=/(.*?)[ \t]*\r?\n/sy,n=/[ \t]*(.*?)[ \t]*\r?\n/sy}let r=t.exec(e);if(!r)return e;let i=r[1],a=` `,o=t.lastIndex;for(n.lastIndex=o;r=n.exec(e);)r[1]===``?a===`
`?i+=a:a=`
`:(i+=a+r[1],a=` `),o=n.lastIndex;let s=/[ \t]*(.*)/sy;return s.lastIndex=o,r=s.exec(e),i+a+(r?.[1]??``)}function mo(e,t){let n=``;for(let r=1;r<e.length-1;++r){let i=e[r];if(i!==`\r`||e[r+1]!==`
`){if(i===`
`){let{fold:t,offset:i}=ho(e,r);n+=t,r=i}else if(i===`\\`){let i=e[++r],a=R[i];if(a)n+=a;else if(i===`
`)for(i=e[r+1];i===` `||i===`	`;)i=e[++r+1];else if(i===`\r`&&e[r+1]===`
`)for(i=e[++r+1];i===` `||i===`	`;)i=e[++r+1];else if(i===`x`||i===`u`||i===`U`){let a=i===`x`?2:i===`u`?4:8;n+=z(e,r+1,a,t),r+=a}else{let i=e.substr(r-1,2);t(r-1,`BAD_DQ_ESCAPE`,`Invalid escape sequence ${i}`),n+=i}}else if(i===` `||i===`	`){let t=r,a=e[r+1];for(;a===` `||a===`	`;)a=e[++r+1];a!==`
`&&(a!==`\r`||e[r+2]!==`
`)&&(n+=r>t?e.slice(t,r+1):i)}else n+=i}}return(e[e.length-1]!==`"`||e.length===1)&&t(e.length,`MISSING_CHAR`,`Missing closing "quote`),n}function ho(e,t){let n=``,r=e[t+1];for(;(r===` `||r===`	`||r===`
`||r===`\r`)&&(r!==`\r`||e[t+2]===`
`);)r===`
`&&(n+=`
`),t+=1,r=e[t+1];return n||=` `,{fold:n,offset:t}}var R={0:`\0`,a:`\x07`,b:`\b`,e:`\x1B`,f:`\f`,n:`
`,r:`\r`,t:`	`,v:`\v`,N:``,_:`\xA0`,L:`\u2028`,P:`\u2029`," ":` `,'"':`"`,"/":`/`,"\\":`\\`,"	":`	`};function z(e,t,n,r){let i=e.substr(t,n),a=i.length===n&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;try{return String.fromCodePoint(a)}catch{let i=e.substr(t-2,n+2);return r(t-2,`BAD_DQ_ESCAPE`,`Invalid escape sequence ${i}`),i}}function go(e,t,n,r){let{value:i,type:a,comment:o,range:s}=t.type===`block-scalar`?so(e,t,r):uo(t,e.options.strict,r),c=n?e.directives.tagName(n.source,e=>r(n,`TAG_RESOLVE_FAILED`,e)):null,l;l=e.options.stringKeys&&e.atKey?e.schema[xr]:c?_o(e.schema,i,c,n,r):t.type===`scalar`?vo(e,i,t,r):e.schema[xr];let u;try{let a=l.resolve(i,e=>r(n??t,`TAG_RESOLVE_FAILED`,e),e.options);u=A(a)?a:new M(a)}catch(e){let a=e instanceof Error?e.message:String(e);r(n??t,`TAG_RESOLVE_FAILED`,a),u=new M(i)}return u.range=s,u.source=i,a&&(u.type=a),c&&(u.tag=c),l.format&&(u.format=l.format),o&&(u.comment=o),u}function _o(e,t,n,r,i){if(n===`!`)return e[xr];let a=[];for(let t of e.tags)if(!t.collection&&t.tag===n){if(t.default&&t.test)a.push(t);else return t}for(let e of a)if(e.test?.test(t))return e;let o=e.knownTags[n];return o&&!o.collection?(e.tags.push(Object.assign({},o,{default:!1,test:void 0})),o):(i(r,`TAG_RESOLVE_FAILED`,`Unresolved tag: ${n}`,n!==`tag:yaml.org,2002:str`),e[xr])}function vo({atKey:e,directives:t,schema:n},r,i,a){let o=n.tags.find(t=>(t.default===!0||e&&t.default===`key`)&&t.test?.test(r))||n[xr];if(n.compat){let e=n.compat.find(e=>e.default&&e.test?.test(r))??n[xr];o.tag!==e.tag&&a(i,`TAG_RESOLVE_FAILED`,`Value may be parsed as either ${t.tagString(o.tag)} or ${t.tagString(e.tag)}`,!0)}return o}function yo(e,t,n){if(t){n??=t.length;for(let r=n-1;r>=0;--r){let n=t[r];switch(n.type){case`space`:case`comment`:case`newline`:e-=n.source.length;continue}for(n=t[++r];n?.type===`space`;)e+=n.source.length,n=t[++r];break}}return e}var bo={composeNode:xo,composeEmptyNode:So};function xo(e,t,n,r){let i=e.atKey,{spaceBefore:a,comment:o,anchor:s,tag:c}=n,l,u=!0;switch(t.type){case`alias`:l=Co(e,t,r),(s||c)&&r(t,`ALIAS_PROPS`,`An alias node must not specify any properties`);break;case`scalar`:case`single-quoted-scalar`:case`double-quoted-scalar`:case`block-scalar`:l=go(e,t,c,r),s&&(l.anchor=s.source.substring(1));break;case`block-map`:case`block-seq`:case`flow-collection`:try{l=oo(bo,e,t,n,r),s&&(l.anchor=s.source.substring(1))}catch(e){r(t,`RESOURCE_EXHAUSTION`,e instanceof Error?e.message:String(e))}break;default:r(t,`UNEXPECTED_TOKEN`,t.type===`error`?t.message:`Unsupported token (type: ${t.type})`),u=!1}return l??=So(e,t.offset,void 0,null,n,r),s&&l.anchor===``&&r(s,`BAD_ALIAS`,`Anchor cannot be an empty string`),i&&e.options.stringKeys&&(!A(l)||typeof l.value!=`string`||l.tag&&l.tag!==`tag:yaml.org,2002:str`)&&r(c??t,`NON_STRING_KEY`,`With stringKeys, all keys must be strings`),a&&(l.spaceBefore=!0),o&&(t.type===`scalar`&&t.source===``?l.comment=o:l.commentBefore=o),e.options.keepSourceTokens&&u&&(l.srcToken=t),l}function So(e,t,n,r,{spaceBefore:i,comment:a,anchor:o,tag:s,end:c},l){let u=go(e,{type:`scalar`,offset:yo(t,n,r),indent:-1,source:``},s,l);return o&&(u.anchor=o.source.substring(1),u.anchor===``&&l(o,`BAD_ALIAS`,`Anchor cannot be an empty string`)),i&&(u.spaceBefore=!0),a&&(u.comment=a,u.range[2]=c),u}function Co({options:e},{offset:t,source:n,end:r},i){let a=new Yr(n.substring(1));a.source===``&&i(t,`BAD_ALIAS`,`Alias cannot be an empty string`),a.source.endsWith(`:`)&&i(t+n.length-1,`BAD_ALIAS`,`Alias ending in : is ambiguous`,!0);let o=t+n.length,s=to(r,o,e.strict,i);return a.range=[t,o,s.offset],s.comment&&(a.comment=s.comment),a}function B(e,t,{offset:n,start:r,value:i,end:a},o){let s=new Ha(void 0,Object.assign({_directives:t},e)),c={atKey:!1,atRoot:!0,directives:s.directives,options:s.options,schema:s.schema},l=Ja(r,{indicator:`doc-start`,next:i??a?.[0],offset:n,onError:o,parentIndent:0,startOnNewline:!0});l.found&&(s.directives.docStart=!0,i&&(i.type===`block-map`||i.type===`block-seq`)&&!l.hasNewline&&o(l.end,`MISSING_CHAR`,`Block collection cannot start on same line with directives-end marker`)),s.contents=i?xo(c,i,l,o):So(c,l.end,r,null,l,o);let u=s.contents.range[2],d=to(a,u,!1,o);return d.comment&&(s.comment=d.comment),s.range=[n,u,d.offset],s}function wo(e){if(typeof e==`number`)return[e,e+1];if(Array.isArray(e))return e.length===2?e:[e[0],e[1]];let{offset:t,source:n}=e;return[t,t+(typeof n==`string`?n.length:1)]}function To(e){let t=``,n=!1,r=!1;for(let i=0;i<e.length;++i){let a=e[i];switch(a[0]){case`#`:t+=(t===``?``:r?`

`:`
`)+(a.substring(1)||` `),n=!0,r=!1;break;case`%`:e[i+1]?.[0]!==`#`&&(i+=1),n=!1;break;default:n||(r=!0),n=!1}}return{comment:t,afterEmptyLine:r}}var Eo=class{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(e,t,n,r)=>{let i=wo(e);r?this.warnings.push(new Ka(i,t,n)):this.errors.push(new Ga(i,t,n))},this.directives=new Vr({version:e.version||`1.2`}),this.options=e}decorate(e,t){let{comment:n,afterEmptyLine:r}=To(this.prelude);if(n){let i=e.contents;if(t)e.comment=e.comment?`${e.comment}\n${n}`:n;else if(r||e.directives.docStart||!i)e.commentBefore=n;else if(kr(i)&&!i.flow&&i.items.length>0){let e=i.items[0];Dr(e)&&(e=e.key);let t=e.commentBefore;e.commentBefore=t?`${n}\n${t}`:n}else{let e=i.commentBefore;i.commentBefore=e?`${n}\n${e}`:n}}if(t){for(let t=0;t<this.errors.length;++t)e.errors.push(this.errors[t]);for(let t=0;t<this.warnings.length;++t)e.warnings.push(this.warnings[t])}else e.errors=this.errors,e.warnings=this.warnings;this.prelude=[],this.errors=[],this.warnings=[]}streamInfo(){return{comment:To(this.prelude).comment,directives:this.directives,errors:this.errors,warnings:this.warnings}}*compose(e,t=!1,n=-1){for(let t of e)yield*this.next(t);yield*this.end(t,n)}*next(e){switch(e.type){case`directive`:this.directives.add(e.source,(t,n,r)=>{let i=wo(e);i[0]+=t,this.onError(i,`BAD_DIRECTIVE`,n,r)}),this.prelude.push(e.source),this.atDirectives=!0;break;case`document`:{let t=B(this.options,this.directives,e,this.onError);this.atDirectives&&!t.directives.docStart&&this.onError(e,`MISSING_CHAR`,`Missing directives-end/doc-start indicator line`),this.decorate(t,!1),this.doc&&(yield this.doc),this.doc=t,this.atDirectives=!1;break}case`byte-order-mark`:case`space`:break;case`comment`:case`newline`:this.prelude.push(e.source);break;case`error`:{let t=e.source?`${e.message}: ${JSON.stringify(e.source)}`:e.message,n=new Ga(wo(e),`UNEXPECTED_TOKEN`,t);this.atDirectives||!this.doc?this.errors.push(n):this.doc.errors.push(n);break}case`doc-end`:{if(!this.doc){this.errors.push(new Ga(wo(e),`UNEXPECTED_TOKEN`,`Unexpected doc-end without preceding document`));break}this.doc.directives.docEnd=!0;let t=to(e.end,e.offset+e.source.length,this.doc.options.strict,this.onError);if(this.decorate(this.doc,!0),t.comment){let e=this.doc.comment;this.doc.comment=e?`${e}\n${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new Ga(wo(e),`UNEXPECTED_TOKEN`,`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let e=new Ha(void 0,Object.assign({_directives:this.directives},this.options));this.atDirectives&&this.onError(t,`MISSING_CHAR`,`Missing directives-end indicator line`),e.range=[0,t,t],this.decorate(e,!1),yield e}}},Do=Symbol(`break visit`),Oo=Symbol(`skip children`),ko=Symbol(`remove item`);function Ao(e,t){`type`in e&&e.type===`document`&&(e={start:e.start,value:e.value}),jo(Object.freeze([]),e,t)}Ao.BREAK=Do,Ao.SKIP=Oo,Ao.REMOVE=ko,Ao.itemAtPath=(e,t)=>{let n=e;for(let[e,r]of t){let t=n?.[e];if(t&&`items`in t)n=t.items[r];else return}return n},Ao.parentCollection=(e,t)=>{let n=Ao.itemAtPath(e,t.slice(0,-1)),r=t[t.length-1][0],i=n?.[r];if(i&&`items`in i)return i;throw Error(`Parent collection not found`)};function jo(e,t,n){let r=n(t,e);if(typeof r==`symbol`)return r;for(let i of[`key`,`value`]){let a=t[i];if(a&&`items`in a){for(let t=0;t<a.items.length;++t){let r=jo(Object.freeze(e.concat([[i,t]])),a.items[t],n);if(typeof r==`number`)t=r-1;else if(r===Do)return Do;else r===ko&&(a.items.splice(t,1),--t)}typeof r==`function`&&i===`key`&&(r=r(t,e))}}return typeof r==`function`?r(t,e):r}function Mo(e){switch(e){case`﻿`:return`byte-order-mark`;case``:return`doc-mode`;case``:return`flow-error-end`;case``:return`scalar`;case`---`:return`doc-start`;case`...`:return`doc-end`;case``:case`
`:case`\r
...
`:case`\r`:case`	`:return!0;default:return!1}}var No=new Set(`0123456789ABCDEFabcdef`),Po=new Set(`0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()`),Fo=new Set(`,[]{}`),Io=new Set(` ,[]{}
\r	`),Lo=e=>!e||Io.has(e),Ro=class{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer=``,this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!=`string`)throw TypeError(`source is not a string`);this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let n=this.next??`stream`;for(;n&&(t||this.hasChars(1));)n=yield*this.parseNext(n)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===` `||t===`	`;)t=this.buffer[++e];return!t||t===`#`||t===`
`||t===`\r`&&this.buffer[e+1]===`
...
`&&n>=this.pos&&n+1+t>i)e=n;else break}while(!0);return yield``,yield*this.pushToIndex(e+1,!0),yield*this.parseLineStart()}*parsePlainScalar(){let e=this.flowLevel>0,t=this.pos-1,n=this.pos-1,r;for(;r=this.buffer[++n];)if(r===`:`){let r=this.buffer[n+1];if(V(r)||e&&Fo.has(r))break;t=n}else if(V(r)){let i=this.buffer[n+1];if(r===`\r`&&(i===`
`?(n+=1,r=`
`,i=this.buffer[n+1]):t=n),i===`#`||e&&Fo.has(i))break;if(r===`
`){let e=this.continueScalar(n+1);if(e===-1)break;n=Math.max(n,e-2)}}else{if(e&&Fo.has(r))break;t=n}return!r&&!this.atEnd?this.setNext(`plain-scalar`):(yield``,yield*this.pushToIndex(t+1,!0),e?`flow`:`doc`)}*pushCount(e){return e>0?(yield this.buffer.substr(this.pos,e),this.pos+=e,e):0}*pushToIndex(e,t){let n=this.buffer.slice(this.pos,e);return n?(yield n,this.pos+=n.length,n.length):(t&&(yield``),0)}*pushIndicators(){let e=0;loop:for(;;){switch(this.charAt(0)){case`!`:e+=yield*this.pushTag(),e+=yield*this.pushSpaces(!0);continue loop;case`&`:e+=yield*this.pushUntil(Lo),e+=yield*this.pushSpaces(!0);continue loop;case`-`:case`?`:case`:`:{let t=this.flowLevel>0,n=this.charAt(1);if(V(n)||t&&Fo.has(n)){t?this.flowKey&&=!1:this.indentNext=this.indentValue+1,e+=yield*this.pushCount(1),e+=yield*this.pushSpaces(!0);continue loop}}}break loop}return e}*pushTag(){if(this.charAt(1)===`<`){let e=this.pos+2,t=this.buffer[e];for(;!V(t)&&t!==`>`;)t=this.buffer[++e];return yield*this.pushToIndex(t===`>`?e+1:e,!1)}{let e=this.pos+1,t=this.buffer[e];for(;t;)if(Po.has(t))t=this.buffer[++e];else if(t===`%`&&No.has(this.buffer[e+1])&&No.has(this.buffer[e+2]))t=this.buffer[e+=3];else break;return yield*this.pushToIndex(e,!1)}}*pushNewline(){let e=this.buffer[this.pos];return e===`
`?yield*this.pushCount(1):e===`\r`&&this.charAt(1)===`
`?yield*this.pushCount(2):0}*pushSpaces(e){let t=this.pos-1,n;do n=this.buffer[++t];while(n===` `||e&&n===`	`);let r=t-this.pos;return r>0&&(yield this.buffer.substr(this.pos,r),this.pos=t),r}*pushUntil(e){let t=this.pos,n=this.buffer[t];for(;!e(n);)n=this.buffer[++t];return yield*this.pushToIndex(t,!1)}},zo=class{constructor(){this.lineStarts=[],this.addNewLine=e=>this.lineStarts.push(e),this.linePos=e=>{let t=0,n=this.lineStarts.length;for(;t<n;){let r=t+n>>1;this.lineStarts[r]<e?t=r+1:n=r}if(this.lineStarts[t]===e)return{line:t+1,col:1};if(t===0)return{line:0,col:e};let r=this.lineStarts[t-1];return{line:t,col:e-r+1}}}};function Bo(e,t){for(let n=0;n<e.length;++n)if(e[n].type===t)return!0;return!1}function Vo(e){for(let t=0;t<e.length;++t)switch(e[t].type){case`space`:case`comment`:case`newline`:break;default:return t}return-1}function Ho(e){switch(e?.type){case`alias`:case`scalar`:case`single-quoted-scalar`:case`double-quoted-scalar`:case`flow-collection`:return!0;default:return!1}}function Uo(e){switch(e.type){case`document`:return e.start;case`block-map`:{let t=e.items[e.items.length-1];return t.sep??t.start}case`block-seq`:return e.items[e.items.length-1].start;default:return[]}}function Wo(e){if(e.length===0)return[];let t=e.length;loop:for(;--t>=0;)switch(e[t].type){case`doc-start`:case`explicit-key-ind`:case`map-value-ind`:case`seq-item-ind`:case`newline`:break loop}for(;e[++t]?.type===`space`;);return e.splice(t,e.length)}function Go(e,t){if(t.length<1e5)Array.prototype.push.apply(e,t);else for(let n=0;n<t.length;++n)e.push(t[n])}function Ko(e){if(e.start.type===`flow-seq-start`)for(let t of e.items)t.sep&&!t.value&&!Bo(t.start,`explicit-key-ind`)&&!Bo(t.sep,`map-value-ind`)&&(t.key&&(t.value=t.key),delete t.key,Ho(t.value)?t.value.end?Go(t.value.end,t.sep):t.value.end=t.sep:Go(t.start,t.sep),delete t.sep)}var qo=class{constructor(e){this.atNewLine=!0,this.atScalar=!1,this.indent=0,this.offset=0,this.onKeyLine=!1,this.stack=[],this.source=``,this.type=``,this.lexer=new Ro,this.onNewLine=e}*parse(e,t=!1){this.onNewLine&&this.offset===0&&this.onNewLine(0);for(let n of this.lexer.lex(e,t))yield*this.next(n);t||(yield*this.end())}*next(e){if(this.source=e,this.atScalar){this.atScalar=!1,yield*this.step(),this.offset+=e.length;return}let t=Mo(e);if(!t){let t=`Not a YAML token: ${e}`;yield*this.pop({type:`error`,offset:this.offset,message:t,source:e}),this.offset+=e.length}else if(t===`scalar`)this.atNewLine=!1,this.atScalar=!0,this.type=`scalar`;else{switch(this.type=t,yield*this.step(),t){case`newline`:this.atNewLine=!0,this.indent=0,this.onNewLine&&this.onNewLine(this.offset+e.length);break;case`space`:this.atNewLine&&e[0]===` `&&(this.indent+=e.length);break;case`explicit-key-ind`:case`map-value-ind`:case`seq-item-ind`:this.atNewLine&&(this.indent+=e.length);break;case`doc-mode`:case`flow-error-end`:return;default:this.atNewLine=!1}this.offset+=e.length}}*end(){for(;this.stack.length>0;)yield*this.pop()}get sourceToken(){return{type:this.type,offset:this.offset,indent:this.indent,source:this.source}}*step(){let e=this.peek(1);if(this.type===`doc-end`&&e?.type!==`doc-end`){for(;this.stack.length>0;)yield*this.pop();this.stack.push({type:`doc-end`,offset:this.offset,source:this.source});return}if(!e)return yield*this.stream();switch(e.type){case`document`:return yield*this.document(e);case`alias`:case`scalar`:case`single-quoted-scalar`:case`double-quoted-scalar`:return yield*this.scalar(e);case`block-scalar`:return yield*this.blockScalar(e);case`block-map`:return yield*this.blockMap(e);case`block-seq`:return yield*this.blockSequence(e);case`flow-collection`:return yield*this.flowCollection(e);case`doc-end`:return yield*this.documentEnd(e)}yield*this.pop()}peek(e){return this.stack[this.stack.length-e]}*pop(e){let t=e??this.stack.pop();if(!t)yield{type:`error`,offset:this.offset,source:``,message:`Tried to pop an empty stack`};else if(this.stack.length===0)yield t;else{let e=this.peek(1);switch(t.type===`block-scalar`?t.indent=`indent`in e?e.indent:0:t.type===`flow-collection`&&e.type===`document`&&(t.indent=0),t.type===`flow-collection`&&Ko(t),e.type){case`document`:e.value=t;break;case`block-scalar`:e.props.push(t);break;case`block-map`:{let n=e.items[e.items.length-1];if(n.value){e.items.push({start:[],key:t,sep:[]}),this.onKeyLine=!0;return}if(n.sep)n.value=t;else{Object.assign(n,{key:t,sep:[]}),this.onKeyLine=!n.explicitKey;return}break}case`block-seq`:{let n=e.items[e.items.length-1];n.value?e.items.push({start:[],value:t}):n.value=t;break}case`flow-collection`:{let n=e.items[e.items.length-1];!n||n.value?e.items.push({start:[],key:t,sep:[]}):n.sep?n.value=t:Object.assign(n,{key:t,sep:[]});return}default:yield*this.pop(),yield*this.pop(t)}if((e.type===`document`||e.type===`block-map`||e.type===`block-seq`)&&(t.type===`block-map`||t.type===`block-seq`)){let n=t.items[t.items.length-1];n&&!n.sep&&!n.value&&n.start.length>0&&Vo(n.start)===-1&&(t.indent===0||n.start.every(e=>e.type!==`comment`||e.indent<t.indent))&&(e.type===`document`?e.end=n.start:e.items.push({start:n.start}),t.items.splice(-1,1))}}}*stream(){switch(this.type){case`directive-line`:yield{type:`directive`,offset:this.offset,source:this.source};return;case`byte-order-mark`:case`space`:case`comment`:case`newline`:yield this.sourceToken;return;case`doc-mode`:case`doc-start`:{let e={type:`document`,offset:this.offset,start:[]};this.type===`doc-start`&&e.start.push(this.sourceToken),this.stack.push(e);return}}yield{type:`error`,offset:this.offset,message:`Unexpected ${this.type} token in YAML stream`,source:this.source}}*document(e){if(e.value)return yield*this.lineEnd(e);switch(this.type){case`doc-start`:Vo(e.start)===-1?e.start.push(this.sourceToken):(yield*this.pop(),yield*this.step());return;case`anchor`:case`tag`:case`space`:case`comment`:case`newline`:e.start.push(this.sourceToken);return}let t=this.startBlockValue(e);t?this.stack.push(t):yield{type:`error`,offset:this.offset,message:`Unexpected ${this.type} token in YAML document`,source:this.source}}*scalar(e){if(this.type===`map-value-ind`){let t=Wo(Uo(this.peek(2))),n;e.end?(n=e.end,n.push(this.sourceToken),delete e.end):n=[this.sourceToken];let r={type:`block-map`,offset:e.offset,indent:e.indent,items:[{start:t,key:e,sep:n}]};this.onKeyLine=!0,this.stack[this.stack.length-1]=r}else yield*this.lineEnd(e)}*blockScalar(e){switch(this.type){case`space`:case`comment`:case`newline`:e.props.push(this.sourceToken);return;case`scalar`:if(e.source=this.source,this.atNewLine=!0,this.indent=0,this.onNewLine){let e=this.source.indexOf(`
`)+1;for(;e!==0;)this.onNewLine(this.offset+e),e=this.source.indexOf(`
`,e)+1}yield*this.pop();break;default:yield*this.pop(),yield*this.step()}}*blockMap(e){let t=e.items[e.items.length-1];switch(this.type){case`newline`:if(this.onKeyLine=!1,t.value){let n=`end`in t.value?t.value.end:void 0;(Array.isArray(n)?n[n.length-1]:void 0)?.type===`comment`?n?.push(this.sourceToken):e.items.push({start:[this.sourceToken]})}else t.sep?t.sep.push(this.sourceToken):t.start.push(this.sourceToken);return;case`space`:case`comment`:if(t.value)e.items.push({start:[this.sourceToken]});else if(t.sep)t.sep.push(this.sourceToken);else{if(this.atIndentedComment(t.start,e.indent)){let n=e.items[e.items.length-2]?.value?.end;if(Array.isArray(n)){Go(n,t.start),n.push(this.sourceToken),e.items.pop();return}}t.start.push(this.sourceToken)}return}if(this.indent>=e.indent){let n=!this.onKeyLine&&this.indent===e.indent,r=n&&(t.sep||t.explicitKey)&&this.type!==`seq-item-ind`,i=[];if(r&&t.sep&&!t.value){let n=[];for(let r=0;r<t.sep.length;++r){let i=t.sep[r];switch(i.type){case`newline`:n.push(r);break;case`space`:break;case`comment`:i.indent>e.indent&&(n.length=0);break;default:n.length=0}}n.length>=2&&(i=t.sep.splice(n[1]))}switch(this.type){case`anchor`:case`tag`:r||t.value?(i.push(this.sourceToken),e.items.push({start:i}),this.onKeyLine=!0):t.sep?t.sep.push(this.sourceToken):t.start.push(this.sourceToken);return;case`explicit-key-ind`:!t.sep&&!t.explicitKey?(t.start.push(this.sourceToken),t.explicitKey=!0):r||t.value?(i.push(this.sourceToken),e.items.push({start:i,explicitKey:!0})):this.stack.push({type:`block-map`,offset:this.offset,indent:this.indent,items:[{start:[this.sourceToken],explicitKey:!0}]}),this.onKeyLine=!0;return;case`map-value-ind`:if(t.explicitKey){if(!t.sep){if(Bo(t.start,`newline`))Object.assign(t,{key:null,sep:[this.sourceToken]});else{let e=Wo(t.start);this.stack.push({type:`block-map`,offset:this.offset,indent:this.indent,items:[{start:e,key:null,sep:[this.sourceToken]}]})}}else if(t.value)e.items.push({start:[],key:null,sep:[this.sourceToken]});else if(Bo(t.sep,`map-value-ind`))this.stack.push({type:`block-map`,offset:this.offset,indent:this.indent,items:[{start:i,key:null,sep:[this.sourceToken]}]});else if(Ho(t.key)&&!Bo(t.sep,`newline`)){let e=Wo(t.start),n=t.key,r=t.sep;r.push(this.sourceToken),delete t.key,delete t.sep,this.stack.push({type:`block-map`,offset:this.offset,indent:this.indent,items:[{start:e,key:n,sep:r}]})}else i.length>0?t.sep=t.sep.concat(i,this.sourceToken):t.sep.push(this.sourceToken)}else t.sep?t.value||r?e.items.push({start:i,key:null,sep:[this.sourceToken]}):Bo(t.sep,`map-value-ind`)?this.stack.push({type:`block-map`,offset:this.offset,indent:this.indent,items:[{start:[],key:null,sep:[this.sourceToken]}]}):t.sep.push(this.sourceToken):Object.assign(t,{key:null,sep:[this.sourceToken]});this.onKeyLine=!0;return;case`alias`:case`scalar`:case`single-quoted-scalar`:case`double-quoted-scalar`:{let n=this.flowScalar(this.type);r||t.value?(e.items.push({start:i,key:n,sep:[]}),this.onKeyLine=!0):t.sep?this.stack.push(n):(Object.assign(t,{key:n,sep:[]}),this.onKeyLine=!0);return}default:{let r=this.startBlockValue(e);if(r){if(r.type===`block-seq`){if(!t.explicitKey&&t.sep&&!Bo(t.sep,`newline`)){yield*this.pop({type:`error`,offset:this.offset,message:`Unexpected block-seq-ind on same line with key`,source:this.source});return}}else n&&e.items.push({start:i});this.stack.push(r);return}}}}yield*this.pop(),yield*this.step()}*blockSequence(e){let t=e.items[e.items.length-1];switch(this.type){case`newline`:if(t.value){let n=`end`in t.value?t.value.end:void 0;(Array.isArray(n)?n[n.length-1]:void 0)?.type===`comment`?n?.push(this.sourceToken):e.items.push({start:[this.sourceToken]})}else t.start.push(this.sourceToken);return;case`space`:case`comment`:if(t.value)e.items.push({start:[this.sourceToken]});else{if(this.atIndentedComment(t.start,e.indent)){let n=e.items[e.items.length-2]?.value?.end;if(Array.isArray(n)){Go(n,t.start),n.push(this.sourceToken),e.items.pop();return}}t.start.push(this.sourceToken)}return;case`anchor`:case`tag`:if(t.value||this.indent<=e.indent)break;t.start.push(this.sourceToken);return;case`seq-item-ind`:if(this.indent!==e.indent)break;t.value||Bo(t.start,`seq-item-ind`)?e.items.push({start:[this.sourceToken]}):t.start.push(this.sourceToken);return}if(this.indent>e.indent){let t=this.startBlockValue(e);if(t){this.stack.push(t);return}}yield*this.pop(),yield*this.step()}*flowCollection(e){let t=e.items[e.items.length-1];if(this.type===`flow-error-end`){let e;do yield*this.pop(),e=this.peek(1);while(e?.type===`flow-collection`)}else if(e.end.length===0){switch(this.type){case`comma`:case`explicit-key-ind`:!t||t.sep?e.items.push({start:[this.sourceToken]}):t.start.push(this.sourceToken);return;case`map-value-ind`:!t||t.value?e.items.push({start:[],key:null,sep:[this.sourceToken]}):t.sep?t.sep.push(this.sourceToken):Object.assign(t,{key:null,sep:[this.sourceToken]});return;case`space`:case`comment`:case`newline`:case`anchor`:case`tag`:!t||t.value?e.items.push({start:[this.sourceToken]}):t.sep?t.sep.push(this.sourceToken):t.start.push(this.sourceToken);return;case`alias`:case`scalar`:case`single-quoted-scalar`:case`double-quoted-scalar`:{let n=this.flowScalar(this.type);!t||t.value?e.items.push({start:[],key:n,sep:[]}):t.sep?this.stack.push(n):Object.assign(t,{key:n,sep:[]});return}case`flow-map-end`:case`flow-seq-end`:e.end.push(this.sourceToken);return}let n=this.startBlockValue(e);n?this.stack.push(n):(yield*this.pop(),yield*this.step())}else{let t=this.peek(2);if(t.type===`block-map`&&(this.type===`map-value-ind`&&t.indent===e.indent||this.type===`newline`&&!t.items[t.items.length-1].sep))yield*this.pop(),yield*this.step();else if(this.type===`map-value-ind`&&t.type!==`flow-collection`){let n=Wo(Uo(t));Ko(e);let r=e.end.splice(1,e.end.length);r.push(this.sourceToken);let i={type:`block-map`,offset:e.offset,indent:e.indent,items:[{start:n,key:e,sep:r}]};this.onKeyLine=!0,this.stack[this.stack.length-1]=i}else yield*this.lineEnd(e)}}flowScalar(e){if(this.onNewLine){let e=this.source.indexOf(`
`)+1;for(;e!==0;)this.onNewLine(this.offset+e),e=this.source.indexOf(`
`,e)+1}return{type:e,offset:this.offset,indent:this.indent,source:this.source}}startBlockValue(e){switch(this.type){case`alias`:case`scalar`:case`single-quoted-scalar`:case`double-quoted-scalar`:return this.flowScalar(this.type);case`block-scalar-header`:return{type:`block-scalar`,offset:this.offset,indent:this.indent,props:[this.sourceToken],source:``};case`flow-map-start`:case`flow-seq-start`:return{type:`flow-collection`,offset:this.offset,indent:this.indent,start:this.sourceToken,items:[],end:[]};case`seq-item-ind`:return{type:`block-seq`,offset:this.offset,indent:this.indent,items:[{start:[this.sourceToken]}]};case`explicit-key-ind`:{this.onKeyLine=!0;let t=Wo(Uo(e));return t.push(this.sourceToken),{type:`block-map`,offset:this.offset,indent:this.indent,items:[{start:t,explicitKey:!0}]}}case`map-value-ind`:{this.onKeyLine=!0;let t=Wo(Uo(e));return{type:`block-map`,offset:this.offset,indent:this.indent,items:[{start:t,key:null,sep:[this.sourceToken]}]}}}return null}atIndentedComment(e,t){return this.type!==`comment`||this.indent<=t?!1:e.every(e=>e.type===`newline`||e.type===`space`)}*documentEnd(e){this.type!==`doc-mode`&&(e.end?e.end.push(this.sourceToken):e.end=[this.sourceToken],this.type===`newline`&&(yield*this.pop()))}*lineEnd(e){switch(this.type){case`comma`:case`doc-start`:case`doc-end`:case`flow-seq-end`:case`flow-map-end`:case`map-value-ind`:yield*this.pop(),yield*this.step();break;case`newline`:this.onKeyLine=!1;default:e.end?e.end.push(this.sourceToken):e.end=[this.sourceToken],this.type===`newline`&&(yield*this.pop())}}};function Jo(e){let t=e.prettyErrors!==!1;return{lineCounter:e.lineCounter||t&&new zo||null,prettyErrors:t}}function Yo(e,t={}){let{lineCounter:n,prettyErrors:r}=Jo(t),i=new qo(n?.addNewLine),a=new Eo(t),o=null;for(let t of a.compose(i.parse(e),!0,e.length))if(!o)o=t;else if(o.options.logLevel!==`silent`){o.errors.push(new Ga(t.range.slice(0,2),`MULTIPLE_DOCS`,`Source contains multiple documents; please use YAML.parseAllDocuments()`));break}return r&&n&&(o.errors.forEach(qa(e,n)),o.warnings.forEach(qa(e,n))),o}function Xo(e,t,n){let r;typeof t==`function`?r=t:n===void 0&&t&&typeof t==`object`&&(n=t);let i=Yo(e,n);if(!i)return null;if(i.warnings.forEach(e=>Di(i.options.logLevel,e)),i.errors.length>0){if(i.options.logLevel!==`silent`)throw i.errors[0];i.errors=[]}return i.toJS(Object.assign({reviver:r},n))}var Zo=class extends Error{};function Qo(){return{events:new Map,systems:new Map,souls:new Map,locations:new Map}}function $o(e){let t=Qo();for(let n of e){let e;try{e=Xo(n.text)}catch(e){throw new Zo(`${n.path} YAML 解析失败：${e.message}`)}if(!e||typeof e!=`object`)continue;let r=(e,t,r)=>{for(let i of e??[]){if(!i?.id)throw new Zo(`${n.path} 存在缺少 id 的${r}`);if(t.has(i.id))throw new Zo(`${n.path} ${r} id 重复：${i.id}`);t.set(i.id,i)}};r(e.events,t.events,`事件`),r(e.systems,t.systems,`系统`),r(e.souls,t.souls,`残魂`),r(e.locations,t.locations,`地点`)}return t}var es=Object.assign({"../../content/events/act1-core.yaml":Xn,"../../content/events/act1-daily.yaml":Zn,"../../content/events/act1-more.yaml":Qn,"../../content/events/act2-core.yaml":$n,"../../content/events/act2-daily.yaml":er,"../../content/events/act2-more.yaml":tr,"../../content/events/act3-core.yaml":nr,"../../content/events/act3-daily.yaml":rr,"../../content/events/act4-core.yaml":ir,"../../content/events/act4-daily.yaml":ar,"../../content/events/act5-core.yaml":or,"../../content/events/expose-crisis.yaml":sr,"../../content/events/origin-baigu.yaml":cr,"../../content/events/origin-fudao-juelin.yaml":lr,"../../content/events/origin-nanjiang.yaml":ur,"../../content/events/origin-wangxiang.yaml":dr,"../../content/events/souls-fate.yaml":fr,"../../content/events/stepdown-act1.yaml":pr,"../../content/souls/mvp.yaml":mr,"../../content/souls-extra/souls2.yaml":hr,"../../content/systems/mvp.yaml":gr}),ts=null;function ns(){return ts||(ts=$o(Object.entries(es).map(([e,t])=>({path:e,text:t})).sort((e,t)=>e.path.localeCompare(t.path))),ts)}function rs(){return{version:1,registry:Xt(),steles:[]}}function is(e){if(!e)return rs();try{let t=JSON.parse(e);return t.version!==1||!t.registry||!Array.isArray(t.steles)?rs():t}catch{return rs()}}function as(e){let t={};for(let n of e.steles)t[n.grade]=(t[n.grade]??0)+1;return t}var os=`cangfeng-save-v1`;function ss(){try{return is(localStorage.getItem(os))}catch{return rs()}}function cs(e){try{localStorage.setItem(os,JSON.stringify(e))}catch{}}var ls=`cangfeng-run-v1`;function us(e,t){try{localStorage.setItem(ls,JSON.stringify({snap:e,pov:t,savedAt:Date.now()}))}catch{}}function ds(){try{let e=localStorage.getItem(ls);if(!e)return null;let t=JSON.parse(e);return!t?.snap||t.snap.v!==1?null:t}catch{return null}}function fs(){localStorage.removeItem(ls)}var ps=`<svg viewBox="0 0 390 420" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,ms=`<svg viewBox="0 0 390 80" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,hs={tianshu:`<svg viewBox="0 0 240 110" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true">
  <defs>
...
</svg>`},gs={冲突:`<svg viewBox="0 0 390 90" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},_s=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),H=e(((e,t)=>{t.exports=_s()}))(),vs={你:`经典文字游戏视角`,我:`代入最深，像在写自己的回忆录`,他:`像在听说书人讲这段故事`};function ys(){return`世界-${Math.random().toString(36).slice(2,8)}`}function bs(e){let t=(0,l.useMemo)(()=>new URLSearchParams(location.search).get(`seed`)??``,[]),[n,r]=(0,l.useState)(``),[i,a]=(0,l.useState)(`你`),[o,s]=(0,l.useState)(`random`),[c,u]=(0,l.useState)(t),d=e.save.registry,f=(0,l.useMemo)(()=>[...$t(d,D.maxTier),...en(d),...nn(d),...tn(d)].slice(0,4),[d]);return(0,H.jsxs)(`div`,{className:`start fade-in`,children:[(0,H.jsx)(`h1`,{style:{fontSize:`1.4rem`,marginTop:4},children:`立 身`}),(0,H.jsx)(`div`,{className:`sub`,children:`此一世是谁、生在哪里、以何种视角经历 —— 都在此定`}),(()=>{let t=ds();if(!t)return null;let n=t.snap.actor,r=n.tier>=10?`飞升`:`位阶${n.tier}`;return(0,H.jsxs)(`div`,{className:`echoes`,style:{borderStyle:`solid`},children:[(0,H.jsx)(`div`,{className:`eh`,children:`尚有一局未了`}),(0,H.jsxs)(`div`,{className:`e`,children:[t.snap.name,` · `,r,` · 第 `,Math.floor(t.snap.year),` 年 · 种子 `,t.snap.seed]}),(0,H.jsx)(`button`,{className:`primary-btn`,style:{width:`100%`,marginTop:10},onClick:e.onResume,children:`续 前 缘`})]})})(),f.length>0&&(0,H.jsxs)(`div`,{className:`echoes`,children:[(0,H.jsx)(`div`,{className:`eh`,children:`这个世界里的前人`}),f.map(e=>(0,H.jsx)(`div`,{className:`e`,children:rn(e)},e.id))]}),(0,H.jsxs)(`div`,{className:`field`,children:[(0,H.jsx)(`label`,{children:`道号`}),(0,H.jsx)(`input`,{type:`text`,value:n,placeholder:`无名`,onChange:e=>r(e.target.value),maxLength:8})]}),(0,H.jsxs)(`div`,{className:`field`,children:[(0,H.jsx)(`label`,{children:`人称 —— 你以何种视角经历此生（成书文体随之而变）`}),(0,H.jsx)(`div`,{className:`radio-row`,children:[`你`,`我`,`他`].map(e=>(0,H.jsxs)(`div`,{className:`radio-card ${i===e?`on`:``}`,onClick:()=>a(e),children:[(0,H.jsx)(`div`,{className:`rt`,children:Nn[e]}),(0,H.jsx)(`div`,{className:`rd`,children:vs[e]})]},e))})]}),(0,H.jsxs)(`div`,{className:`field`,children:[(0,H.jsx)(`label`,{children:`出生地 —— 地脉决定灵根，灵根决定路`}),(0,H.jsxs)(`div`,{className:`bp-grid`,children:[(0,H.jsxs)(`div`,{className:`radio-card bp-card ${o===`random`?`on`:``}`,onClick:()=>s(`random`),children:[hs.random&&(0,H.jsx)(`div`,{className:`bp-art`,dangerouslySetInnerHTML:{__html:hs.random}}),(0,H.jsx)(`div`,{className:`rt`,children:`听天由命`}),(0,H.jsx)(`div`,{className:`rd`,children:`随缘投胎，各安天命`})]}),Ee.map(e=>(0,H.jsxs)(`div`,{className:`radio-card bp-card ${o===e.id?`on`:``}`,onClick:()=>s(e.id),children:[hs[e.id]&&(0,H.jsx)(`div`,{className:`bp-art`,dangerouslySetInnerHTML:{__html:hs[e.id]}}),(0,H.jsx)(`div`,{className:`rt`,children:e.name}),(0,H.jsxs)(`div`,{className:`rd`,children:[e.region,` · 灵气`,e.qiDensity,` · `,e.pathPool.join(`/`)]})]},e.id))]})]}),(0,H.jsxs)(`div`,{className:`field`,children:[(0,H.jsx)(`label`,{children:`世界种子（可留空随机；持他人种子可入同一世界）`}),(0,H.jsx)(`input`,{type:`text`,value:c,placeholder:ys(),onChange:e=>u(e.target.value)})]}),(0,H.jsx)(`button`,{className:`primary-btn`,onClick:()=>{e.onStart({seed:c.trim()||ys(),name:n.trim()||`无名`,pov:i,birthplace:o===`random`?void 0:Ee.find(e=>e.id===o)})},children:`入 世`}),(0,H.jsx)(`div`,{className:`row`,style:{justifyContent:`center`},children:(0,H.jsxs)(`button`,{className:`linklike`,onClick:e.onGallery,children:[`碑林（`,e.save.steles.length,`）`]})})]})}function xs(e){let t=(0,l.useMemo)(()=>ds(),[]);return(0,H.jsxs)(`div`,{className:`cover fade-in`,children:[(0,H.jsx)(`div`,{className:`cover-art`,dangerouslySetInnerHTML:{__html:ps}}),(0,H.jsxs)(`div`,{className:`cover-title`,children:[(0,H.jsx)(`h1`,{children:`藏锋录`}),(0,H.jsx)(`div`,{className:`cover-slogan`,children:`开挂即僭越 · 藏拙以保身`}),(0,H.jsx)(`div`,{className:`cover-sub`,children:`一场瞒过天道的修行`})]}),(0,H.jsxs)(`div`,{className:`cover-actions`,children:[t&&(0,H.jsxs)(`button`,{className:`primary-btn`,onClick:e.onResume,children:[`续 前 缘`,(0,H.jsxs)(`span`,{className:`cover-resume-sub`,children:[t.snap.name,` · 第 `,Math.floor(t.snap.year),` 年`]})]}),(0,H.jsx)(`button`,{className:t?`ghost-btn cover-enter`:`primary-btn`,onClick:e.onEnter,children:t?`另 开 一 世`:`入 世`}),(0,H.jsxs)(`button`,{className:`linklike`,onClick:e.onGallery,children:[`碑林（`,e.save.steles.length,`）`]})]}),(0,H.jsx)(`div`,{className:`cover-bottom`,dangerouslySetInnerHTML:{__html:ms}})]})}var Ss={CRIT_SUCCESS:{label:`大成`,cls:`s-crit`},SUCCESS:{label:`成`,cls:`s-ok`},FAIL:{label:`败`,cls:`s-fail`},CRIT_FAIL:{label:`大凶`,cls:`s-cfail`}},Cs=[{m:`打坐吐纳`,label:`稳修`,hint:`不快不慢，不出错`},{m:`悟道`,label:`悟道`,hint:`慢，但根基更纯，圆满度更高`},{m:`历练突破`,label:`历练`,hint:`快，有伤病之险`},{m:`丹药速成`,label:`服丹`,hint:`最快，但积丹毒（丹毒过深会锁死上限）`}];function ws(e){let t=Math.round(e*100);return t>=80?`八九成`:t>=60?`六七成`:t>=40?`四五成`:t>=20?`两三成`:`一线`}function Ts(e){let t=new Set(e??[]);return t.has(`岔路`)?`岔路`:t.has(`心魔`)||t.has(`道德`)?`心魔`:t.has(`冲突`)||t.has(`打脸`)||t.has(`战斗`)?`冲突`:t.has(`机缘`)?`机缘`:t.has(`秘境`)?`秘境`:t.has(`宗门`)||t.has(`站队`)?`宗门`:`山野`}function Es(e){let t=e.session.ctx.actor,n=[],r=t.lifespanYears-t.ageMonths/12;r<15&&n.push({text:`寿余${Math.max(0,r).toFixed(0)}`,cls:`hot`}),t.僭越>=51&&n.push({text:`僭越${Math.round(t.僭越)}`,cls:t.僭越>=101?`hot`:`warn`}),t.堕度>=46&&n.push({text:`堕度${Math.round(t.堕度)}`,cls:t.堕度>=76?`hot`:`warn`}),t.丹毒>=50&&n.push({text:`丹毒${Math.round(t.丹毒)}`,cls:t.丹毒>=80?`hot`:`warn`});let i=t.souls.find(e=>!e.dissipated&&e.possession>=60);return i&&n.push({text:`魂扰${Math.round(i.possession)}`,cls:i.possession>=85?`hot`:`warn`}),n.slice(0,2)}function Ds(e){let{session:t,pov:n,name:r}=e.game,i=e=>Pn(e,n,r),a=Fn(n,r),[o,s]=(0,l.useState)(null),[c,u]=(0,l.useState)(`event`),[d,f]=(0,l.useState)(null),[p,m]=(0,l.useState)(!1),[h,g]=(0,l.useState)(!1),[_,v]=(0,l.useState)(!1),[y,b]=(0,l.useState)(!1),[x,S]=(0,l.useState)(null),[ee,C]=(0,l.useState)(null),[,te]=(0,l.useState)(0),ne=(0,l.useRef)(0),re=(0,l.useRef)(!1),ie=(0,l.useRef)(null),ae=e=>{let n=t.beats.slice(ne.current);ne.current=t.beats.length,t.notices.length=0;let r=t.lastOutcome?Ss[t.lastOutcome]??null:null,i=[...t.lastDeltas];return t.lastOutcome=null,t.lastDeltas=[],{stamp:r,chips:i,beats:n,fromYear:e,toYear:Math.floor(t.ctx.year)}},oe=(r,i)=>{C(null),b(!1);let a=ae(i);if(r.kind===`gameover`){a.beats.length||a.stamp?(f(a),u(`between`),s(r)):e.onOver(r.result);return}s(r),a.beats.length||a.stamp||a.chips.length?(f(a),u(`between`)):u(`event`);let o=t.snapshot();o&&us(o,n)};(0,l.useEffect)(()=>{if(re.current)return;if(re.current=!0,t.beats.length>0){ne.current=t.beats.length;let n=t.currentPrompt();if(n){if(n.kind===`gameover`){e.onOver(n.result);return}s(n),u(`event`);return}}let n=Math.floor(t.ctx.year);oe(t.advance(),n)},[]),(0,l.useEffect)(()=>{window.scrollTo({top:0})},[c,o]);let se=e=>{if(!o||o.kind!==`event`)return;let n=Math.floor(t.ctx.year),r=t.choose(e);oe(r,n)},ce=e=>{if(!o||o.kind!==`event`||y)return;let t=o.choices[e];if(t){if(Jn(o.card,t)&&ee!==e){C(e);return}C(null),t.check?(b(!0),setTimeout(()=>se(e),520)):se(e)}},le=(e,n)=>{if(!o||o.kind!==`breakthrough`)return;let r=Math.floor(t.ctx.year),i=t.decideBreakthrough(e,n);t.lastBreakthrough&&e&&(S(t.lastBreakthrough),setTimeout(()=>S(null),2e3)),oe(i,r)},ue=()=>{if(o?.kind===`gameover`){e.onOver(o.result);return}u(`event`)},de=e=>{if(!e)return null;let t=gs[e];return t?(0,H.jsx)(`div`,{className:`card-art`,dangerouslySetInnerHTML:{__html:t}}):null},w=()=>{if(!d)return null;let e=d.toYear-d.fromYear;return(0,H.jsxs)(`div`,{className:`page-card`,ref:ie,children:[(0,H.jsxs)(`div`,{className:`between-head`,children:[(0,H.jsx)(`div`,{className:`year-mark`,children:e>1?`第 ${d.fromYear} — ${d.toYear} 年`:`第 ${d.toYear} 年`}),e>3&&(0,H.jsx)(`div`,{className:`passage`,children:Ln(e,t.ctx.actor.tier,a)??``})]}),(0,H.jsxs)(`div`,{className:`between-body`,children:[d.stamp&&(0,H.jsx)(`div`,{className:`stamp-row`,children:(0,H.jsx)(`span`,{className:`stamp ${d.stamp.cls}`,children:d.stamp.label})}),d.chips.length>0&&(0,H.jsx)(`div`,{className:`delta-chips`,children:d.chips.map((e,t)=>(0,H.jsx)(`span`,{className:`dchip d-${e.kind}`,children:e.text},t))}),d.beats.map((e,t)=>e.kind===`scene`?(0,H.jsxs)(`div`,{className:`mini-scene`,children:[e.title&&(0,H.jsxs)(`span`,{className:`mini-t`,children:[`【`,e.title,`】`]}),(0,H.jsxs)(`span`,{className:`mini-x`,children:[i(e.text).split(`
`)[0],`…`]})]},t):e.kind===`choice`?(0,H.jsx)(`div`,{className:`choice-line`,children:i(e.text)},t):e.kind===`outcome`?(0,H.jsx)(`div`,{className:`outcome`,children:i(e.text)},t):e.kind===`milestone`?(0,H.jsxs)(`div`,{className:`milestone`,children:[`◈ `,i(e.text)]},t):(0,H.jsx)(`div`,{className:`notice`,children:i(e.text)},t))]}),(0,H.jsx)(`div`,{className:`page-foot`,children:(0,H.jsx)(`button`,{className:`primary-btn`,onClick:ue,children:o?.kind===`gameover`?`盖 棺`:`继 续`})})]})},T=()=>{if(!o)return null;if(o.kind===`event`){let e=o.card.tags?.includes(`岔路`),t=i(o.text).split(`
`).filter(e=>e.trim()!==``),n=.1,r=Math.min(t.length*n+.2,1.3);return(0,H.jsxs)(`div`,{className:`page-card`,ref:ie,children:[de(Ts(o.card.tags)),(0,H.jsxs)(`div`,{className:`page-body`,children:[e&&(0,H.jsx)(`div`,{className:`fork-badge rv`,children:`岔 · 人生节点`}),(0,H.jsxs)(`div`,{className:`t rv`,children:[`【`,o.card.title,`】`]}),t.map((e,t)=>(0,H.jsx)(`p`,{className:`rv`,style:{animationDelay:`${Math.min(t*n,1.1)}s`},children:e},t))]}),(0,H.jsx)(`div`,{className:`page-foot`,children:y?(0,H.jsx)(`div`,{className:`roll`,children:`天 机 演 算`}):(0,H.jsx)(`div`,{className:`inline-choices rv`,style:{animationDelay:`${r}s`},children:o.choices.map((e,t)=>{if(ee===t){let n=qn(o.card,e);return(0,H.jsxs)(`div`,{className:`confirm-block`,children:[(0,H.jsx)(`div`,{className:`confirm-choice`,children:i(e.text)}),(0,H.jsx)(`div`,{className:`risk-tags`,children:n.map((e,t)=>(0,H.jsx)(`span`,{className:`risk-tag r-${e.level}`,children:e.text},t))}),(0,H.jsxs)(`div`,{className:`confirm-row`,children:[(0,H.jsx)(`button`,{className:`ghost-btn`,onClick:()=>C(null),children:`再想想`}),(0,H.jsx)(`button`,{className:`confirm-go`,onClick:()=>ce(t),children:`依此而行`})]})]},t)}return(0,H.jsxs)(`button`,{className:`choice-btn`,onClick:()=>ce(t),children:[(0,H.jsx)(`span`,{className:`idx`,children:t+1}),i(e.text),Jn(o.card,e)&&(0,H.jsx)(`span`,{className:`grave-mark`,children:`重`}),e.check&&(0,H.jsx)(`span`,{className:`check-mark`,children:`占`})]},t)})})})]},o.card.id)}if(o.kind!==`breakthrough`)return null;let e=t.ctx.actor;return(0,H.jsxs)(`div`,{className:`page-card`,ref:ie,children:[de(`命关`),(0,H.jsxs)(`div`,{className:`page-body`,children:[(0,H.jsx)(`div`,{className:`t rv`,children:`【命关】`}),(0,H.jsx)(`p`,{className:`rv`,style:{animationDelay:`0.1s`},children:i(`灵气已满，可冲击【${zt(t.ctx.actor.path,o.toTier)}】。\n你掂量了一下 —— 约莫${ws(o.estimate)}把握。`)})]}),(0,H.jsx)(`div`,{className:`page-foot`,children:(0,H.jsxs)(`div`,{className:`inline-choices rv`,style:{animationDelay:`0.4s`},children:[(0,H.jsxs)(`button`,{className:`choice-btn`,onClick:()=>le(!0,!1),children:[(0,H.jsx)(`span`,{className:`idx`,children:`1`}),`冲关`]}),(0,H.jsxs)(`button`,{className:`choice-btn`,onClick:()=>le(!0,!0),children:[(0,H.jsx)(`span`,{className:`idx`,children:`2`}),`稳中求进，兼冲隐藏之境`,e.道心>58?``:`（道心尚浅，凶险）`]}),(0,H.jsxs)(`button`,{className:`choice-btn`,onClick:()=>le(!1,!1),children:[(0,H.jsx)(`span`,{className:`idx`,children:`3`}),`再温养几年`]})]})})]},`bt-${t.ctx.tick}`)},E=t.ctx.actor,fe=zt(E.path,E.tier);return(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(`div`,{className:`topbar`,children:[(0,H.jsx)(`span`,{className:`tb-name`,onClick:()=>m(!0),children:r}),(0,H.jsxs)(`span`,{className:`tb-sub`,onClick:()=>m(!0),children:[fe,E.tier<10?` ${Math.round(E.sublevel*100)}%`:``,` · `,Math.floor(t.ctx.year),`年`]}),(0,H.jsx)(`span`,{className:`grow`}),Es(e.game).map((e,t)=>(0,H.jsx)(`span`,{className:`chip ${e.cls}`,children:e.text},t)),(0,H.jsx)(`button`,{className:`linklike`,onClick:()=>v(!0),children:`回顾`}),(0,H.jsx)(`button`,{className:`linklike`,onClick:()=>m(!0),children:`人物`}),(0,H.jsx)(`button`,{className:`linklike`,onClick:e.onQuit,children:`搁笔`})]}),(0,H.jsx)(`div`,{className:`realm-bar`,children:(0,H.jsx)(`i`,{style:{width:`${Math.round(E.sublevel*100)}%`}})}),c===`between`?w():T(),x&&(0,H.jsxs)(`div`,{className:`bt-overlay ${x.ok?`bt-ok`:`bt-fail`}`,onClick:()=>S(null),children:[(0,H.jsx)(`div`,{className:`bt-word`,children:x.ok?x.name:`劫`}),(0,H.jsx)(`div`,{className:`bt-sub`,children:x.ok?x.hidden?`且入隐秘之境`:`境界已成`:`未过 · ${x.name}`})]}),t.ctx.systems.includes(`签到`)&&(0,H.jsxs)(`button`,{className:`sys-pill`,onClick:()=>g(!0),children:[(0,H.jsx)(`span`,{className:`sys-dot`}),`系统`]}),h&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>g(!1)}),(0,H.jsxs)(`div`,{className:`sys-panel fade-in`,children:[(0,H.jsx)(`div`,{className:`sys-title`,children:`— 修 仙 辅 助 系 统 v1.0 —`}),(0,H.jsx)(`div`,{className:`sys-line`,children:`尊贵的宿主，欢迎回来！`}),(0,H.jsx)(`button`,{className:`sys-btn`,onClick:()=>{t.signIn(),ne.current=t.beats.length,t.notices.length=0,te(e=>e+1)},children:`今 日 签 到`}),t.beats.length>0&&t.beats[t.beats.length-1].text.includes(`签到`)&&(0,H.jsx)(`div`,{className:`sys-line sys-log`,children:t.beats[t.beats.length-1].text}),(0,H.jsx)(`div`,{className:`sys-line sys-fine`,children:`* 签到即留痕。系统提醒宿主：天机可循，慎用。`}),t.ctx.systems.filter(e=>e!==`签到`).map(e=>(0,H.jsxs)(`div`,{className:`sys-line sys-locked`,children:[`「`,e,`」模块 · 面板权限暂未开放`]},e)),(0,H.jsx)(`button`,{className:`linklike`,style:{marginTop:10},onClick:()=>g(!1),children:`关闭`})]})]}),_&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>v(!1)}),(0,H.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,H.jsxs)(`div`,{className:`sheet-head`,children:[(0,H.jsx)(`span`,{className:`sheet-title`,children:`回顾`}),(0,H.jsx)(`span`,{className:`sheet-sub`,children:`此生至今 · 亦即将来书上的正文`}),(0,H.jsx)(`button`,{className:`linklike`,onClick:()=>v(!1),children:`收起`})]}),(0,H.jsxs)(`div`,{className:`history-scroll`,children:[t.beats.map((e,t)=>e.kind===`scene`?(0,H.jsxs)(`div`,{className:`scene past`,style:{margin:`14px 0 4px`},children:[e.title&&(0,H.jsxs)(`div`,{className:`t`,children:[`【`,e.title,`】`]}),(0,H.jsx)(`div`,{className:`x`,children:i(e.text)})]},t):e.kind===`choice`?(0,H.jsx)(`div`,{className:`choice-line past`,children:i(e.text)},t):e.kind===`outcome`?(0,H.jsx)(`div`,{className:`outcome`,children:i(e.text)},t):e.kind===`milestone`?(0,H.jsxs)(`div`,{className:`milestone`,children:[`◈ `,i(e.text)]},t):(0,H.jsx)(`div`,{className:`notice`,children:i(e.text)},t)),t.beats.length===0&&(0,H.jsx)(`div`,{className:`notice`,children:`故事才刚要开始。`})]})]})]}),p&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>m(!1)}),(0,H.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,H.jsxs)(`div`,{className:`sheet-head`,children:[(0,H.jsx)(`span`,{className:`sheet-title`,children:r}),(0,H.jsxs)(`span`,{className:`sheet-sub`,children:[E.path,` · `,E.talent.root,` · `,E.originRevealed?`身负「${E.origin}」`:`身世未明`]}),(0,H.jsx)(`button`,{className:`linklike`,onClick:()=>m(!1),children:`收起`})]}),(0,H.jsxs)(`div`,{className:`kv`,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`境界`}),(0,H.jsxs)(`b`,{children:[fe,`（`,Math.round(E.sublevel*100),`%）`]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`寿元`}),(0,H.jsxs)(`b`,{children:[Math.floor(E.ageMonths/12),` / `,E.lifespanYears]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`道心`}),(0,H.jsx)(`b`,{children:Math.round(E.道心)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`气运`}),(0,H.jsx)(`b`,{children:Math.round(E.气运)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`功德`}),(0,H.jsx)(`b`,{children:Math.round(E.功德)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`业障`}),(0,H.jsx)(`b`,{children:Math.round(E.业障)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`僭越`}),(0,H.jsx)(`b`,{children:Math.round(E.僭越)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`堕度`}),(0,H.jsx)(`b`,{children:Math.round(E.堕度)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`丹毒`}),(0,H.jsx)(`b`,{children:Math.round(E.丹毒)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`名望`}),(0,H.jsx)(`b`,{children:Math.round(E.名望)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`悟性`}),(0,H.jsx)(`b`,{children:E.talent.悟性})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`根骨`}),(0,H.jsx)(`b`,{children:E.talent.根骨})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`神魂`}),(0,H.jsx)(`b`,{children:E.talent.神魂})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`纯度`}),(0,H.jsx)(`b`,{children:Math.round(E.talent.purity)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`真实战力`}),(0,H.jsx)(`b`,{children:Se(E).toFixed(2)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`i`,{children:`藏拙`}),(0,H.jsxs)(`b`,{children:[Math.round(Ce(E)*100),`%`]})]})]}),(t.ctx.systems.length>0||E.souls.some(e=>!e.dissipated))&&(0,H.jsxs)(`div`,{className:`sheet-sec`,children:[t.ctx.systems.length>0&&(0,H.jsxs)(`div`,{className:`sheet-line`,children:[`金手指：`,t.ctx.systems.join(`、`)]}),E.souls.filter(e=>!e.dissipated).map(e=>(0,H.jsxs)(`div`,{className:`sheet-line`,children:[`残魂 `,e.name,` —— 好感 `,Math.round(e.favor),` · 夺舍 `,Math.round(e.possession),`%`]},e.id))]}),(0,H.jsxs)(`div`,{className:`sheet-sec`,children:[(0,H.jsxs)(`div`,{className:`sheet-line`,children:[`未了因果：恶 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,`· 善 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity>0).length,t.ctx.knowers.length?` · 知情者 ${t.ctx.knowers.length} 人`:``]}),[`金手指`,`残魂`,`真实修为`,`杀过某人`,`身世`].filter(e=>E.secrets[e]>=25).map(e=>(0,H.jsxs)(`div`,{className:`sheet-line`,children:[`暴露 · `,e,`：`,Math.round(E.secrets[e])]},e))]}),(0,H.jsxs)(`div`,{className:`sheet-sec`,children:[(0,H.jsx)(`div`,{className:`sheet-line`,style:{marginBottom:8},children:`修行之姿`}),(0,H.jsx)(`div`,{className:`row`,children:Cs.map(e=>(0,H.jsx)(`button`,{className:`ghost-btn ${t.stance===e.m?`on`:``}`,onClick:()=>{t.stance=e.m,te(e=>e+1)},children:e.label},e.m))}),(0,H.jsx)(`div`,{className:`sheet-hint`,children:Cs.find(e=>e.m===t.stance)?.hint})]}),(0,H.jsxs)(`div`,{className:`sheet-sec`,children:[(0,H.jsx)(`div`,{className:`sheet-line`,style:{marginBottom:8},children:`问事之权`}),(0,H.jsxs)(`div`,{className:`row`,children:[(0,H.jsx)(`button`,{className:`ghost-btn ${t.autoResolveMinor?`on`:``}`,onClick:()=>{t.autoResolveMinor=!0,te(e=>e+1)},children:`大事亲断`}),(0,H.jsx)(`button`,{className:`ghost-btn ${t.autoResolveMinor?``:`on`}`,onClick:()=>{t.autoResolveMinor=!1,te(e=>e+1)},children:`事必躬亲`})]}),(0,H.jsx)(`div`,{className:`sheet-hint`,children:t.autoResolveMinor?`小事自行流转，只有影响走向的事才来问你`:`每一件事都亲自过目定夺`})]})]})]})]})}function Os(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ks(e){return Os(e).replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`).replace(/`([^`]+)`/g,`<code>$1</code>`)}function As(e){let t=[],n=!1,r=[],i=[],a=[],o=()=>{a.length&&(t.push(`<p>${a.map(ks).join(`
`)}</p>`),a=[])},s=()=>{i.length&&(t.push(`<blockquote>${i.map(ks).join(`
`)}</blockquote>`),i=[])};for(let c of e.split(`
`)){if(c.startsWith("```")){o(),s(),n&&(t.push(`<pre class="mono">${Os(r.join(`
`))}</pre>`),r.length=0),n=!n;continue}if(n){r.push(c);continue}if(c.startsWith(`### `)){o(),s(),t.push(`<h3>${ks(c.slice(4))}</h3>`);continue}if(c.startsWith(`## `)){o(),s(),t.push(`<h2>${ks(c.slice(3))}</h2>`);continue}if(c.startsWith(`# `)){o(),s(),t.push(`<h1>${ks(c.slice(2))}</h1>`);continue}if(c.trim()===`---`){o(),s(),t.push(`<hr/>`);continue}if(c.startsWith(`> `)||c===`>`){o(),i.push(c.replace(/^> ?/,``));continue}if(c.startsWith(`- `)){o(),s(),t.push(`<li>${ks(c.slice(2))}</li>`);continue}if(c.trim()===``){o(),s();continue}s(),a.push(c)}return o(),s(),n&&r.length&&t.push(`<pre class="mono">${Os(r.join(`
`))}</pre>`),t.join(`
`)}function js(e){let{game:t,result:n}=e,[r,i]=(0,l.useState)(`成书`),[a,o]=(0,l.useState)(t.pov===`我`?`我`:`他`),s=(0,l.useMemo)(()=>a===`他`?n.novel:Wn({daoName:t.name,seed:t.seed,beats:t.session.beats,chronicle:n.chronicle,stele:n.stele,signature:t.session.signature(),pov:`我`}),[a,t,n]);return(0,H.jsxs)(`div`,{className:`over fade-in`,children:[(0,H.jsxs)(`div`,{className:`ending-grade`,children:[n.stele.grade,` · `,n.stele.serial]}),(0,H.jsx)(`div`,{className:`ending-name`,children:n.ending.name}),(0,H.jsx)(`div`,{className:`ending-text`,children:n.ending.text}),(0,H.jsxs)(`div`,{className:`ending-text`,style:{marginTop:4},children:[`道果 +`,n.daoFruit,`（累计 `,e.save.registry.daoFruit,`）`]}),(0,H.jsx)(`div`,{className:`tabs`,children:[`成书`,`一生录`,`道碑`].map(e=>(0,H.jsx)(`button`,{className:`tab ${r===e?`on`:``}`,onClick:()=>i(e),children:e},e))}),r===`成书`&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(`div`,{className:`row`,children:[(0,H.jsx)(`button`,{className:`ghost-btn ${a===`他`?`on`:``}`,onClick:()=>o(`他`),children:`传记体`}),(0,H.jsx)(`button`,{className:`ghost-btn ${a===`我`?`on`:``}`,onClick:()=>o(`我`),children:`自述体`}),(0,H.jsx)(`span`,{className:`grow`}),(0,H.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{let e=new Blob([s],{type:`text/markdown;charset=utf-8`}),n=document.createElement(`a`);n.href=URL.createObjectURL(e),n.download=`藏锋录·${t.name}${a===`我`?`自述`:`卷`}.md`,n.click(),URL.revokeObjectURL(n.href)},children:`下载此书`})]}),(0,H.jsx)(`div`,{className:`book`,dangerouslySetInnerHTML:{__html:As(s)}})]}),r===`一生录`&&(0,H.jsx)(`pre`,{className:`mono`,children:It(n.chronicle)}),r===`道碑`&&(0,H.jsx)(`pre`,{className:`mono`,children:Yt(n.stele)}),(0,H.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:10},children:(0,H.jsx)(`button`,{className:`primary-btn`,style:{flex:1},onClick:e.onRestart,children:`再 入 轮 回`})}),(0,H.jsx)(`div`,{className:`row`,style:{justifyContent:`center`},children:(0,H.jsx)(`button`,{className:`linklike`,onClick:e.onGallery,children:`去碑林看看`})})]})}function Ms(e){let[t,n]=(0,l.useState)(null),r=[...e.save.steles].reverse(),i=as(e.save);return(0,H.jsxs)(`div`,{className:`gallery fade-in`,children:[(0,H.jsx)(`h2`,{children:`碑 林`}),(0,H.jsxs)(`div`,{className:`row`,style:{justifyContent:`center`,color:`var(--dim)`,fontSize:`0.85rem`},children:[Object.entries(i).map(([e,t])=>(0,H.jsxs)(`span`,{children:[e,`×`,t]},e)),r.length===0&&(0,H.jsx)(`span`,{children:`（空山无碑。去走一遭吧。）`})]}),r.map(e=>(0,H.jsxs)(`div`,{className:`stele-item`,onClick:()=>n(t===e.serial?null:e.serial),children:[(0,H.jsxs)(`div`,{className:`sh`,children:[(0,H.jsx)(`span`,{className:`grade`,children:e.grade}),(0,H.jsx)(`span`,{className:`nm`,children:e.daoName}),(0,H.jsxs)(`span`,{className:`meta`,children:[e.ending,` · `,e.finalRealm,` · 寿`,e.lifespan,`载 · 完满度`,e.perfection]}),(0,H.jsx)(`span`,{className:`meta`,children:`★`.repeat(e.rarity)})]}),t===e.serial&&(0,H.jsx)(`pre`,{className:`mono`,style:{marginTop:10},children:Yt(e)})]},e.serial)),(0,H.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:12},children:(0,H.jsx)(`button`,{className:`ghost-btn`,onClick:e.onBack,children:`回到入口`})})]})}function Ns(){let e=(0,l.useMemo)(()=>ns(),[]),[t]=(0,l.useState)(()=>ss()),[n,r]=(0,l.useState)(`cover`),[i,a]=(0,l.useState)(null),[o,s]=(0,l.useState)(null),c=n=>{fs();let i=new Yn({seed:n.seed,db:e,registry:t.registry,name:n.name,birthplace:n.birthplace});a({session:i,seed:n.seed,name:n.name,pov:n.pov,birthplace:n.birthplace}),s(null),r(`play`)},u=()=>{let n=ds();if(n)try{let i=new Yn({seed:n.snap.seed,db:e,registry:t.registry,restore:n.snap});a({session:i,seed:n.snap.seed,name:n.snap.name,pov:n.pov}),s(null),r(`play`)}catch{fs()}};return(0,H.jsxs)(`div`,{className:`shell`,children:[n===`cover`&&(0,H.jsx)(xs,{save:t,onEnter:()=>r(`start`),onResume:u,onGallery:()=>r(`gallery`)}),n===`start`&&(0,H.jsx)(bs,{save:t,onStart:c,onResume:u,onGallery:()=>r(`gallery`)}),n===`play`&&i&&(0,H.jsx)(Ds,{game:i,onOver:e=>{fs(),t.steles.push(e.stele),cs(t),s(e),r(`over`)},onQuit:()=>r(`start`)}),n===`over`&&i&&o&&(0,H.jsx)(js,{game:i,result:o,save:t,onRestart:()=>r(`start`),onGallery:()=>r(`gallery`)}),n===`gallery`&&(0,H.jsx)(Ms,{save:t,onBack:()=>r(`cover`)})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,H.jsx)(Ns,{}));
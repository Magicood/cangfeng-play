import{n as e,r as t,t as n}from"./vendor-CdTLCmMN.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var r=t(),i=e();function a(e){let t=1779033703^e.length;for(let n=0;n<e.length;n++)t=Math.imul(t^e.charCodeAt(n),3432918353),t=t<<13|t>>>19;return t=Math.imul(t^t>>>16,2246822507),t=Math.imul(t^t>>>13,3266489909),(t^=t>>>16)>>>0}var o=class e{state;seed;calls=0;constructor(e){this.seed=e,this.state=a(e)}next(){this.calls++,this.state=this.state+1831565813|0;let e=this.state;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}range(e,t){return e+this.next()*(t-e)}int(e,t){return Math.floor(this.range(e,t+1))}chance(e){return this.next()<e}pick(e){if(e.length===0)throw Error(`pick() 于空数组`);return e[Math.floor(this.next()*e.length)]}weighted(e,t){let n=t.reduce((e,t)=>e+t,0);if(n<=0)throw Error(`weighted() 权重和为 0`);let r=this.next()*n;for(let n=0;n<e.length;n++)if(r-=t[n]??0,r<=0)return e[n];return e[e.length-1]}gaussian(e=0,t=1){let n=1-this.next(),r=this.next();return e+t*Math.sqrt(-2*Math.log(n))*Math.cos(2*Math.PI*r)}fork(t){return new e(`${this.seed}:${t}:${this.calls}`)}snapshot(){return{seed:this.seed,state:this.state,calls:this.calls}}static restore(t){let n=new e(t.seed);return n.state=t.state,n.calls=t.calls,n}},s=e=>Math.log(e)/Math.log(8),c={1:100,2:200,3:500,4:1200,5:3e3,6:8e3,7:2e4,8:5e4,9:1e5},l={1:140,2:260,3:800,4:2e3,5:4500,6:12e3,7:3e4,8:7e4,9:1e5},u={1:6,2:12,3:24,4:120,5:300,6:1200,7:4800,8:12e3,9:12e3},d=[`正道`,`魔道`,`鬼道`,`妖修`,`佛道`,`儒道`,`武道`,`散修`],f={正道:{speed:1,power:1,note:`传承完整，天劫温和，但受制于人`},魔道:{speed:1.5,power:1.15,note:`战斗中吸纳煞气，长期不战会反噬`},鬼道:{speed:1.2,power:.95,note:`肉身非必需，神魂极强，畏阳畏佛`},妖修:{speed:1.3,power:1.25,note:`肉身极强，化形前不能用人类功法法宝`},佛道:{speed:.9,power:.75,note:`不吃灵根，心魔免疫，戒律削减选项`},儒道:{speed:1,power:.85,note:`言出法随，依附王朝气运`},武道:{speed:.7,power:.7,note:`凡人可修，根基天然纯净，前六阶落后`},散修:{speed:.85,power:1,note:`自由杂修，无人指点，领悟型瓶颈 +40%`}},p={graceTicks:3,damagePerTick:.04},m={tiers:[1,6],mult:.7},h={单灵根:3,异灵根:3,变异灵根:2.2,双灵根:1.8,三灵根:1.2,四灵根:.8,五灵根:.5,无灵根:0},g={单灵根:15,异灵根:40,变异灵根:8,双灵根:3,三灵根:0,四灵根:0,五灵根:0,无灵根:0},_=.7,ee=`极品`,v=e=>e>=10?2.1:.7+(e-1)*.15,y=e=>e>=10,b={打坐吐纳:{speed:1,perfection:0,risk:0,daoxin:.4},聚灵阵辅修:{speed:1.6,perfection:0,risk:0,costStones:20,daoxin:.2},洞天闭关:{speed:2.5,perfection:2,risk:0,blocksEvents:!0,daoxin:.15},悟道:{speed:.6,perfection:8,risk:0,needsInsight:!0,daoxin:2.2},历练突破:{speed:1.8,perfection:-6,risk:.08,daoxin:.8},丹药速成:{speed:3,perfection:-10,risk:.03,toxin:6,daoxin:-1},双修:{speed:2.2,perfection:3,risk:0,needsPartner:!0,daoxin:.5},吞噬夺取:{speed:5,perfection:-25,risk:.12,corruption:8,daoxin:-3},香火愿力:{speed:1.4,perfection:5,risk:.02,daoxin:1.2},献祭:{speed:4,perfection:-18,risk:.15,corruption:12,daoxin:-2},苦修锻体:{speed:.8,perfection:6,risk:.02,daoxin:1.5},借残魂指点:{speed:2,perfection:0,risk:0,possession:8,daoxin:-.2}},x={breakthroughPenaltyAt:30,breakthroughPenalty:.15,perfectionCapAt:60,perfectionCap:70,deathRiskAt:90,deathRiskPerTick:.05},S={功法:{min:.55,max:1.9},法宝:{min:.7,max:1.75},状态:{min:.4,max:1.45},灵宠:{min:.95,max:1.35},伙伴:{min:.9,max:1.4},道侣:{min:1,max:1.25},情报:{min:.85,max:1.3}},C={defaultScale:12,combatScale:.35,luckShift:.15,pClamp:[.02,.98],critBand:.05},te={sigmaBase:.02,sigmaLuckCoef:.25},w={tierCoef:[1,1.4,2,3,4.5,7],gain:{越阶战斗:3,强夺气运:8,读档回溯:5,逆天行为:20},decayBase:2,bands:[{at:0,difficulty:1,hunted:0,desc:`无事`},{at:21,difficulty:1.1,hunted:0,desc:`天气异常，修炼时心悸`},{at:51,difficulty:1.2,hunted:.05,desc:`天机阁开始推演你`},{at:101,difficulty:1.35,hunted:.12,desc:`天罚使者`},{at:201,difficulty:1.6,hunted:.2,desc:`天地压制，属性 −20%`},{at:351,difficulty:2,hunted:.3,desc:`无妄之灾`}],smiteAt:351,smiteChance:.08},ne=[{at:0,speed:1,power:1,mishap:0,death:0,threat:0,label:`守律`},{at:16,speed:1.3,power:1.1,mishap:.03,death:0,threat:.55,label:`☠死亡谷`},{at:46,speed:2,power:1.35,mishap:.07,death:0,threat:.75,label:`强邪`},{at:76,speed:3.2,power:1.7,mishap:.09,death:.02,threat:1,label:`邪极带`},{at:89,speed:4.5,power:2.1,mishap:.12,death:.05,threat:1.3,label:`失控临界`},{at:100,speed:0,power:0,mishap:0,death:1,threat:0,label:`入魔`}],re={transcendBand:[76,88],transcendDriftTolerance:40,reflectionTiers:[3,5,7],reflectionTarget:30,tribulationMult:2.2,inheritanceCutoffTier:6},T={base:45,hiddenRealmBonus:25,weights:{1:1,2:1.5,3:2.5,4:2,5:2,6:1.5,7:1.5,8:1.5,9:2},orthodox:{根基纯净:15,功法契合:10,道心一致:10,心魔残留:-20,捷径惩罚:-30},corrupt:{堕度稳定:20,意志强度:15,禁忌贯彻:10,失控每次:-12,被净化:-20}},ie={真仙:{perfection:95,transgression:50,needAllHidden:!0,needTier:9},堕仙:{perfection:90,corruptionBand:[76,88],needReflections:3,needTier:9},位面主宰:{perfection:80,transgression:200,needTier:9},地方大佬:{perfection:0,minTier:3},以凡证道:{perfection:95,path:`武道`,needTier:9}},ae={2:95,3:150,4:215,5:300,6:400,7:520,8:660,9:820,10:1150},oe={normal:{sublevelLoss:.35,daoxinLoss:4},critical:!0},se={2:{name:`道基劫`,outcome:`道基裂损，退回练气`,branch:null,recoverable:!0,perfectionLoss:20},3:{name:`结丹劫`,outcome:`金丹碎裂，退回筑基`,branch:null,recoverable:!0,gradeCapLoss:2},4:{name:`婴变劫`,outcome:`婴死体存`,branch:`守尸人`,recoverable:`partial`},5:{name:`神识劫`,outcome:`神识裂解，人格破碎`,branch:`痴儿`,recoverable:`partial`},6:{name:`虚空劫`,outcome:`被虚空吞噬`,branch:`虚空漂流`,recoverable:!0,cannotReturn:!0},7:{name:`融合劫`,outcome:`道体崩解，只余残魂`,branch:`残魂`,recoverable:`partial`},8:{name:`三灾九难`,outcome:`道消，执念缚于死地`,branch:`地缚灵`,recoverable:!1},9:{name:`九重天劫`,outcome:`形神俱灭`,branch:null,recoverable:!1}},E={minEventWeight:10,maxResolvePerTick:2,lethalMinForeshadow:2,lethalMinWindow:1,defaultMatureWindow:[30,120]},D={secrets:[`金手指`,`残魂`,`真实血脉`,`真实修为`,`杀过某人`,`身世`],witnessWeight:.5,publicUseWeight:1,overTierArtifact:15,revealAt:100},ce={faceSlapMultMax:2.5,decayBonusMax:1,resourcePenaltyMax:.45},O=[{id:`凡俗`,weight:550,reveal:`线索集齐`},{id:`上古血脉后裔`,weight:80,reveal:`血脉共鸣`},{id:`遗孤`,weight:60,reveal:`信物/仇家`},{id:`转世重修者`,weight:50,reveal:`顿悟闪回`},{id:`棋子`,weight:50,reveal:`发现机缘被安排`},{id:`气运之子`,weight:40,reveal:`首次死里逃生`},{id:`天煞孤星`,weight:40,reveal:`第三位亲近者身死`},{id:`容器`,weight:30,reveal:`夺舍者上门`},{id:`罪裔`,weight:30,reveal:`被追讨`},{id:`双生`,weight:20,reveal:`双生感应`},{id:`无名`,weight:10,reveal:`天机阁推演失败`},{id:`归来者`,weight:5,reveal:`见到上一局遗物`}],le={luckBonus:25,boonMult:1.8,deathExemptPerTier:1},ue={上古血脉后裔:.9,归来者:.7,罪裔:.6,容器:.55,转世重修者:.5,双生:.5,遗孤:.45,无名:.4,天煞孤星:.35,棋子:.3,气运之子:.2,凡俗:0},k={awakenCoef:.35,awakenResidual:.85,countBiasCoef:.5,countSuppressExp:2,purityCoef:18,statCoef:18,mutationMult:.4},A={threshold:.6,rate:.05,rootShift:2,purityMult:.4,statMult:.6},de=[{id:`胎中受损`,desc:`母亲怀你时渡劫失败，胎里带伤`,culprit:`当年逼她渡劫的人`,cureHint:`洗髓、上古药方`},{id:`血脉被夺`,desc:`有人取走了你的先天之气`,culprit:`取走先天之气的人`,cureHint:`找到取走的人，夺回`},{id:`双生分薄`,desc:`同胎的另一个拿走了大半`,culprit:`你的双生`,cureHint:`与双生者了断`},{id:`药石之祸`,desc:`幼时被人长期下药`,culprit:`常年下药的人`,cureHint:`清毒，并追责`},{id:`经脉封印`,desc:`有人封了你的经脉，为了把你藏起来`,culprit:`封印你的人`,cureHint:`解印，或找到封你的人`}],j={凡俗:[[`无关`,70],[`旁支`,18],[`子弟`,12]],上古血脉后裔:[[`子弟`,35],[`旁支`,30],[`无关`,20],[`仇家`,15]],归来者:[[`无关`,50],[`子弟`,25],[`旁支`,25]],罪裔:[[`仇家`,55],[`弃徒`,25],[`无关`,20]],容器:[[`质子`,35],[`子弟`,30],[`无关`,35]],转世重修者:[[`无关`,50],[`旁支`,25],[`子弟`,25]],双生:[[`子弟`,35],[`旁支`,30],[`无关`,35]],遗孤:[[`仇家`,45],[`无关`,35],[`旁支`,20]],无名:[[`无关`,60],[`弃徒`,20],[`仇家`,20]],天煞孤星:[[`无关`,55],[`弃徒`,30],[`旁支`,15]],棋子:[[`质子`,35],[`旁支`,30],[`子弟`,20],[`无关`,15]],气运之子:[[`无关`,60],[`子弟`,20],[`旁支`,20]]},M={罪裔:{weight:45,window:[45,110]},遗孤:{weight:45,window:[60,150]},名门:{weight:25,window:[15,60]},质子:{weight:20,window:[10,50]},容器:{weight:50,window:[90,200]},defect:{weight:25,window:[20,80]}},N={maxTier:18,guidanceByGap:[{gap:5,level:`全面指导`,speedBonus:1,canAct:!0},{gap:3,level:`有效指导`,speedBonus:.6,canAct:!1},{gap:1,level:`经验参考`,speedBonus:.25,canAct:!1},{gap:0,level:`只能陪伴`,speedBonus:0,canAct:!1},{gap:-1,level:`反向求教`,speedBonus:0,canAct:!1}],soulThreshold:40,possessionPerGuidance:8},fe={tierMult:[1,1.3,1.7,2.4,3.5,5],corruptMult:3,transcendMult:10,noSystemMult:8,difficultyMult:{凡人:.5,修士:1,天骄:1.5,逆天:2,天道:3}},pe={eventChance:.62},me=[`下品`,`中品`,`上品`,`极品`],P={下品:1,中品:100,上品:1e4,极品:1e6},he=[`下品`,`中品`,`上品`],ge=[{id:`粗布袋`,slots:6,minTier:1,price:0,holdsLiving:!1,searchable:!0,note:`出门就得取舍：带丹药还是带干粮`},{id:`储物袋`,slots:20,minTier:1,price:300,holdsLiving:!1,searchable:!0,note:`解放，但会被搜身 —— 被抓即身家全失`},{id:`大储物袋`,slots:40,minTier:2,price:3e3,holdsLiving:!1,searchable:!0,note:`装得下货，倒卖玩法从此开启`},{id:`储物戒`,slots:100,minTier:3,price:6e4,holdsLiving:!1,searchable:!1,note:`认主，搜不走 —— 于是敌人改砍手；死后掉落，可被抢`},{id:`芥子空间`,slots:300,minTier:4,price:9e5,holdsLiving:!0,searchable:!1,note:`可放活物：藏人、藏灵宠、偷运`},{id:`洞天`,slots:9999,minTier:5,price:0,holdsLiving:!0,searchable:!1,note:`可种植、有时间流速，进入经营玩法`}],_e=`粗布袋`;function ve(e){return ge.find(t=>t.id===e)??ge[0]}var F=(e,t,n)=>Math.min(n,Math.max(t,e)),I=e=>(e.气运-50)/100;function ye(e,t,n=0){let r=t.scale??C.defaultScale,i=F(1/(1+Math.exp(-(t.power-t.dc)/r))+n*C.luckShift+(t.bonus??0),C.pClamp[0],C.pClamp[1]),a=e.next(),o=C.critBand*(1+n),s=C.critBand*(1-n);return a<o?`CRIT_SUCCESS`:a>1-s?`CRIT_FAIL`:a<i?`SUCCESS`:`FAIL`}function L(e,t=0){let n=e.scale??C.defaultScale;return F(1/(1+Math.exp(-(e.power-e.dc)/n))+t*C.luckShift+(e.bonus??0),C.pClamp[0],C.pClamp[1])}function be(e,t,n){let r=F(n+.5,0,1),i=te.sigmaBase+te.sigmaLuckCoef*(1-r);return F(t+e.gaussian(0,i),0,1)}function xe(e){let t=ne[0];for(let n of ne)e>=n.at&&(t=n);return t}function Se(e){let t=w.bands[0];for(let n of w.bands)e>=n.at&&(t=n);return t}function Ce(e){let t=e.tier+e.sublevel;e.goldenCoreGrade>0&&(t+=s(v(e.goldenCoreGrade)));let n=f[e.path];t+=s(n.power),e.path===`武道`&&e.tier>=m.tiers[0]&&e.tier<=m.tiers[1]&&(t+=s(m.mult));for(let n of Object.keys(S))t+=s(e.factors[n]);return t+=s(xe(e.堕度).power),Se(e.僭越).at>=201&&(t+=s(.8)),t}function we(e){let t=Ce(e);return t<=0?0:F((t-e.锋芒)/t,0,1)}function Te(e,t,n,r=0){return ye(e,{power:Ce(t)+r,dc:n,scale:C.combatScale},I(t))}function Ee(){return{功法:.7,法宝:.75,状态:1,灵宠:.95,伙伴:.9,道侣:1,情报:.85}}var De=class extends Error{},Oe=[`凡品`,`灵品`,`宝品`,`仙品`,`秘藏`,`极品`],ke=e=>Oe[e-1]??`凡品`,Ae=[`下品`,`中品`,`上品`,`极品`],je={1:.7,2:1,3:1.35,4:1.8},Me={1:1.8,2:1,3:.8,4:.7},Ne=new Set([`丹毒`,`业障`,`僭越`,`堕度`,`暴露`]);function Pe(e,t){return Ne.has(e)||e.startsWith(`expose.`)?t>0:t<0}var Fe={1:.5,2:1,3:2.2,4:6},Ie={1:35,2:45,3:18,4:2},Le=e=>Ae[e-1];function Re(e){let t=Ae.indexOf(e);return t>=0?t+1:void 0}function R(e){return e.stone!==void 0||e.grade===6}function z(e){let t=e.quality;return t===1||t===3||t===4?t:2}function ze(e){let t=Ie[1]+Ie[2]+Ie[3]+Ie[4],n=e.next()*t;for(let e of[1,2,3])if(n-=Ie[e],n<0)return e;return 4}function B(e,t){if(R(e))return e.name;let n=t??2;return n===2?e.name:`${Le(n)}·${e.name}`}var Be=[`本命`,`主器`,`随身`];function Ve(e){return V(e)}function V(e){let t=e.equip!==void 0||e.container!==void 0,n=e.stackMax??(t?1:99);return{id:e.id,name:e.name,category:e.category,grade:e.grade,desc:e.desc,stackable:n>1,stackMax:n,slots:e.slots??1,value:e.value??1,use:e.use,consumable:e.consumable??(e.use!==void 0||e.container!==void 0),equip:e.equip,stone:e.stone,talisman:e.talisman,container:e.container}}var He=[V({id:`ls_xia`,name:`下品灵石`,category:`灵石`,grade:1,stone:`下品`,desc:`拇指大的一块，灵气糙而薄。市井里论块算，一百块换一枚中品。`,stackMax:999,value:P.下品}),V({id:`ls_zhong`,name:`中品灵石`,category:`灵石`,grade:2,stone:`中品`,desc:`成色透亮。掏出这个付账，摊主会多看你两眼。`,stackMax:999,value:P.中品}),V({id:`ls_shang`,name:`上品灵石`,category:`灵石`,grade:3,stone:`上品`,desc:`一枚可抵万块下品。当众拿出来，等于当众说「我值得抢」。`,stackMax:999,value:P.上品}),V({id:`ls_ji`,name:`极品灵石`,category:`灵石`,grade:6,stone:`极品`,desc:`灵气凝成了液，在石心里慢慢转。这种东西不从矿里出 —— 它是某个人拿命换来、又转手给了你的。谁给的，为什么给，你迟早要还。`,stackMax:999,value:P.极品}),V({id:`dan_bigu`,name:`辟谷丹`,category:`丹药`,grade:1,value:4,stackMax:30,desc:`一粒管十日不饥。味同嚼蜡，但省下的是命。`,use:[`道心 +1`]}),V({id:`dan_huiqi`,name:`回气丹`,category:`丹药`,grade:1,value:12,stackMax:30,desc:`入口一线暖流下丹田。散修行囊里最常见的东西。`,use:[`factors.状态 +0.04`,`丹毒 +1`]}),V({id:`dan_liaoshang`,name:`疗伤丹`,category:`丹药`,grade:1,value:20,stackMax:30,desc:`血止得快，疤留得丑。`,use:[`factors.状态 +0.06`,`丹毒 +2`]}),V({id:`dan_jiedu`,name:`解毒丹`,category:`丹药`,grade:2,value:60,stackMax:20,desc:`苦得人打颤。药王谷的方子，专拔积在经脉里的药渣。`,use:[`丹毒 -8`]}),V({id:`dan_ningshen`,name:`凝神丹`,category:`丹药`,grade:2,value:80,stackMax:20,desc:`服后神识清明半日，正好用来画符或者认人。`,use:[`神魂 +2`,`丹毒 +2`]}),V({id:`dan_juqi`,name:`聚气散`,category:`丹药`,grade:2,value:100,stackMax:20,desc:`把周遭灵气硬拽进经脉。快，但拽进来的东西不挑干净与否。`,use:[`sublevel +0.02`,`丹毒 +3`]}),V({id:`dan_xisui`,name:`洗髓丹`,category:`丹药`,grade:3,value:400,stackMax:10,desc:`连着三日排出黑汗，人像被剥了一层。根骨是真的换了。`,use:[`根骨 +3`,`丹毒 +4`]}),V({id:`dan_zhuji`,name:`筑基丹`,category:`丹药`,grade:3,value:800,stackMax:10,desc:`练气修士毕生所求的一粒。也是无数人被灭门的理由。`,use:[`sublevel +0.12`,`丹毒 +8`]}),V({id:`dan_jinyuan`,name:`金元丹`,category:`丹药`,grade:4,value:6e3,stackMax:5,desc:`丹成有纹。吃下去那一刻，天上像有什么东西低头看了你一眼。`,use:[`sublevel +0.2`,`丹毒 +12`,`僭越 +3`]}),V({id:`dan_jiuzhuan`,name:`九转还魂丹`,category:`丹药`,grade:5,value:12e4,stackMax:3,desc:`传说能从阎王手里抢人。传说而已 —— 但抢过。`,use:[`lifespan +30`,`factors.状态 +0.2`,`丹毒 +6`,`僭越 +8`]}),V({id:`dan_jia`,name:`不知名丹药`,category:`丹药`,grade:1,value:6,stackMax:20,desc:`瓶上没标签。黑市里二成二的货是这样的 —— 你敢吃吗？`,use:[`丹毒 +5`,`道心 -2`]}),V({id:`bao_tiejian`,name:`铁剑`,category:`法宝`,grade:1,value:30,desc:`开过锋的凡铁。它唯一的优点是从不认主，谁拿都好使。`,equip:{slot:`主器`,factors:{法宝:.05}}}),V({id:`bao_qingfeng`,name:`青锋剑`,category:`法宝`,grade:2,value:500,desc:`剑身有一道细纹，是上一任主人替它挡下的那一击。`,equip:{slot:`主器`,factors:{法宝:.12}}}),V({id:`bao_lingwen`,name:`灵纹飞剑`,category:`法宝`,grade:3,value:9e3,desc:`需以神识御使。第一次放出去，收回来时手会抖。`,equip:{slot:`主器`,factors:{法宝:.25},minTier:2}}),V({id:`bao_chixiao`,name:`赤霄宝剑`,category:`法宝`,grade:4,value:15e4,slots:2,desc:`出鞘一寸，三丈内草木自焦。带着它就别想再装作练气小修士。`,equip:{slot:`主器`,factors:{法宝:.4,状态:.05},minTier:3}}),V({id:`bao_yufu`,name:`护身玉符`,category:`法宝`,grade:1,value:60,desc:`家里给的。说是能挡一次灾 —— 挡不挡得住，谁也没回来说过。`,equip:{slot:`随身`,factors:{状态:.05}}}),V({id:`bao_xuangui`,name:`玄龟甲`,category:`法宝`,grade:2,value:900,desc:`贴身穿着沉，挨打时才知道值。`,equip:{slot:`随身`,factors:{状态:.1}}}),V({id:`bao_xunlong`,name:`寻龙盘`,category:`法宝`,grade:2,value:1200,desc:`针总往灵气浓的地方偏。摸金的人管它叫「良心」。`,equip:{slot:`随身`,factors:{情报:.12}}}),V({id:`bao_bihuo`,name:`避火罩`,category:`法宝`,grade:3,value:12e3,desc:`南离州的炼器师说，这东西最好用不上。`,equip:{slot:`随身`,factors:{状态:.16},minTier:2}}),V({id:`bao_qinglian`,name:`青莲灯`,category:`法宝`,grade:4,value:2e5,slots:2,desc:`本命之物，与神魂共生。它碎，你也碎 —— 所以敌人专打它。`,equip:{slot:`本命`,factors:{法宝:.2,功法:.08},minTier:3}}),V({id:`fu_zhuohuo`,name:`灼火符`,category:`符箓`,grade:1,value:25,stackMax:20,talisman:`黄阶`,desc:`一张纸换练气一击。贵是贵，可你打不过的时候它不贵。`,use:[`flag 符箓·黄阶`]}),V({id:`fu_liekong`,name:`裂空符`,category:`符箓`,grade:2,value:260,stackMax:20,talisman:`玄阶`,desc:`撕开的一瞬间有风声。那是别人替你修的筑基一击。`,use:[`flag 符箓·玄阶`]}),V({id:`fu_fentian`,name:`焚天符`,category:`符箓`,grade:3,value:4500,stackMax:10,talisman:`地阶`,desc:`妖血符墨画的。金丹一击封在纸里，纸比人贵。`,use:[`flag 符箓·地阶`]}),V({id:`fu_yinni`,name:`隐匿符`,category:`符箓`,grade:2,value:300,stackMax:20,desc:`行动不留痕。干完事，没人知道是你 —— 藏拙流的命脉。`,use:[`expose.真实修为 -10`,`expose.杀过某人 -5`]}),V({id:`fu_dunzou`,name:`遁走符`,category:`符箓`,grade:2,value:350,stackMax:20,desc:`打不过就跑。在这世道，能跑掉是极高的本事。`,use:[`flag 遁走符已用`]}),V({id:`fu_mihun`,name:`迷魂符`,category:`符箓`,grade:3,value:2e3,stackMax:10,desc:`抹掉目击者的一段记忆。不杀人，也能把嘴堵上。`,use:[`expose.杀过某人 -12`,`expose.真实血脉 -6`]}),V({id:`fu_tishen`,name:`替身符`,category:`符箓`,grade:4,value:3e4,stackMax:5,desc:`抵一次必死，还留下一具假尸 —— 「假死脱身」的第一件材料。`,use:[`flag 替身在身`]}),V({id:`cai_lingcao`,name:`灵草`,category:`材料`,grade:1,value:5,desc:`一把三文。丹方最下面那一行写的就是它。`}),V({id:`cai_fuzhi`,name:`符纸`,category:`材料`,grade:1,value:8,desc:`空白的。画坏一张，材料全废。`}),V({id:`cai_fumo`,name:`妖血符墨`,category:`材料`,grade:2,value:150,stackMax:20,desc:`腥气压不住。地阶以上的符，非它不可。`}),V({id:`cai_jingjin`,name:`精金`,category:`材料`,grade:3,value:1800,stackMax:20,desc:`西金州出的料。炼器师见了眼睛发直。`}),V({id:`cai_yaodan`,name:`妖丹`,category:`材料`,grade:3,value:2200,stackMax:20,desc:`从某只东西身体里挖出来的。还热着。`}),V({id:`cai_yaowang`,name:`千年药王`,category:`材料`,grade:4,value:4e4,stackMax:5,desc:`拔出来时根须像手一样收了一下。药王谷为这个死过人。`}),V({id:`gf_tuna`,name:`基础吐纳诀`,category:`功法`,grade:1,value:50,desc:`外门人手一本。写得笨，但没写错。`,use:[`factors.功法 +0.05`]}),V({id:`gf_qingmu`,name:`青木长生功`,category:`功法`,grade:2,value:1500,desc:`木属功法，修得慢，活得久。`,use:[`factors.功法 +0.12`,`悟性 +1`]}),V({id:`gf_liehuo`,name:`烈火焚天诀`,category:`功法`,grade:3,value:2e4,desc:`越练脾气越坏。契合不上的人练它，走火只是迟早。`,use:[`factors.功法 +0.22`,`道心 -2`]}),V({id:`gf_taishang`,name:`太上忘情篇·残卷`,category:`功法`,grade:4,value:26e4,desc:`后半部被人撕走了 —— 撕得很急。留下的这半部已经够改命。`,use:[`factors.功法 +0.35`,`道心 +5`,`僭越 +5`]}),V({id:`za_ganliang`,name:`干粮`,category:`杂物`,grade:1,value:1,stackMax:20,desc:`硬得硌牙。没辟谷之前，这就是命。`,use:[`道心 +1`]}),V({id:`za_yupei`,name:`旧玉佩`,category:`杂物`,grade:1,value:20,desc:`娘留下的。不值钱，但当了就再也赎不回来。`}),V({id:`za_quanpu`,name:`家传拳谱`,category:`杂物`,grade:1,value:15,desc:`纸都黄了，字歪歪扭扭，是自家人一笔笔抄的。`,use:[`根骨 +1`]}),V({id:`za_ditu`,name:`残破地图`,category:`杂物`,grade:1,value:30,desc:`半张，边角烧了。烧掉的那半才是要紧的。`,use:[`factors.情报 +0.03`]}),V({id:`za_shaodaozi`,name:`烧刀子`,category:`杂物`,grade:1,value:3,stackMax:10,desc:`凡人的酒。修士喝了没用，但有时候人要的就是没用的东西。`,use:[`道心 +1`]}),V({id:`za_chuwudai`,name:`储物袋`,category:`杂物`,grade:2,value:300,container:`储物袋`,desc:`内里三尺见方。从此不必在城门口丢东西了。`}),V({id:`za_dachuwudai`,name:`大储物袋`,category:`杂物`,grade:3,value:3e3,container:`大储物袋`,desc:`装得下一车货。倒卖这行的入场券。`}),V({id:`za_chuwujie`,name:`储物戒`,category:`杂物`,grade:4,value:6e4,container:`储物戒`,desc:`滴血认主，谁也搜不走 —— 所以他们改砍手。`}),V({id:`bao_taia`,name:`太阿·断`,category:`法宝`,grade:6,value:3e6,slots:2,desc:`断口齐得像被人一口咬下去。铸它的人姓什么已无人记得，只记得它斩过的最后一个是它自己的主人。握住的一刻，你听见有人在很远的地方叫了一声名字 —— 不是你的名字。`,equip:{slot:`本命`,factors:{法宝:.5,功法:.1},minTier:4}}),V({id:`bao_mengmei`,name:`蒙昧珠`,category:`法宝`,grade:6,value:15e5,desc:`珠子是灰的，照不出人影。天机阁推演了三百年也没推出它在哪 —— 因为它就是用来让人推不出的。带着它，天看不见你；可你也从此看不清自己的命。`,equip:{slot:`随身`,factors:{情报:.26,状态:.05},minTier:3}}),V({id:`bao_danying`,name:`炉中婴`,category:`法宝`,grade:6,value:2e6,desc:`开炉时它坐在丹里，像睡着了。它认你，跟着你，替你挡过一次刀 ——代价是每一年立春，它要喝一口血。你的血。`,equip:{slot:`随身`,factors:{灵宠:.3,状态:.08},minTier:3}}),V({id:`dan_zijin`,name:`九转紫金丹`,category:`丹药`,grade:6,value:26e5,stackMax:1,desc:`丹上九道纹，纹里有紫气游走。药王谷的老人说，这一炉三千年只成过两粒，另一粒是给天子送葬用的。吃下去，你会多活很久 —— 久到该死的人都死光了。`,use:[`lifespan +260`,`sublevel +0.25`,`道心 +6`,`丹毒 +20`,`僭越 +30`]}),V({id:`za_jiezihu`,name:`芥子壶`,category:`杂物`,grade:6,value:2e6,container:`芥子空间`,desc:`壶口三寸，壶里是一片天。前主人在里头养了三十年的东西还没死透 ——你搬进去之前，最好先把它请出来。`})],Ue=new Map;function We(e){if(e.equip&&e.stackMax!==1)throw new De(`可装备物品 '${e.id}' 不得堆叠`);if(e.container&&e.stackMax!==1)throw new De(`容器物品 '${e.id}' 不得堆叠`);Ue.set(e.id,e)}for(let e of He)We(e);function Ge(e){for(let t of e)We(t)}function H(e){return Ue.get(e)}function U(e){let t=Ue.get(e);if(!t)throw new De(`未知物品 id '${e}'`);return t}var Ke={下品:`ls_xia`,中品:`ls_zhong`,上品:`ls_shang`,极品:`ls_ji`};function qe(e){let t=H(e.defId);if(!t)return 0;let n=R(t)?1:Fe[z(e)];return t.value*e.qty*n}function Je(e=_e){return{container:e,stacks:[]}}function Ye(e){if(!e||typeof e!=`object`)return Je();let t=e,n=ge.some(e=>e.id===t.container)?t.container:_e,r=[],i=new Set;for(let e of Array.isArray(t.stacks)?t.stacks:[]){if(!e||typeof e!=`object`)continue;let t=H(String(e.defId));if(!t)continue;let n=Math.floor(Number(e.qty));if(!Number.isFinite(n)||n<=0)continue;let a={defId:t.id,qty:Math.min(n,t.stackMax)},o=e.quality;!R(t)&&(o===1||o===3||o===4)&&(a.quality=o);let s=e.equipped;s&&t.equip&&Be.includes(s)&&!i.has(s)&&(i.add(s),a.equipped=s,a.applied={...e.applied}),r.push(a)}return{container:n,stacks:r}}function W(e){let t=e.inventory;return(!t||typeof t!=`object`||!Array.isArray(t.stacks)||!ge.some(e=>e.id===t.container))&&(e.inventory=Ye(t)),e.inventory}function Xe(e){return ve(e.container).slots}function Ze(e){let t=0;for(let n of e.stacks)t+=H(n.defId)?.slots??1;return t}function Qe(e){return Math.max(0,Xe(e)-Ze(e))}function $e(e){let t=[];for(let n of e.stacks){let e=H(n.defId);e&&t.push({stack:n,def:e})}return t}function et(e,t){let n=0;for(let r of e.stacks)r.defId===t&&(n+=r.qty);return n}function tt(e,t){let n=0;for(let r of e.stacks)r.defId===t&&!r.equipped&&(n+=r.qty);return n}function nt(e,t,n=1,r={}){let i=U(t),a=R(i)?void 0:r.quality??(r.rng?ze(r.rng):2),o=Math.max(0,Math.floor(n)),s=o,c=0;for(let n of e.stacks){if(s<=0)break;if(n.defId!==t||n.equipped||z(n)!==(a??2))continue;let e=i.stackMax-n.qty;if(e<=0)continue;let r=Math.min(e,s);n.qty+=r,s-=r,c+=r}for(;s>0&&Qe(e)>=i.slots;){let n=Math.min(i.stackMax,s),r={defId:t,qty:n};a!==void 0&&a!==2&&(r.quality=a),e.stacks.push(r),s-=n,c+=n}return{requested:o,added:c,overflow:s,full:s>0,quality:a}}function rt(e,t,n=1){let r=Math.max(0,Math.floor(n)),i=0,a=e.stacks.filter(e=>e.defId===t&&!e.equipped).sort((e,t)=>z(e)-z(t));for(let e of a){if(r<=0)break;let t=Math.min(e.qty,r);e.qty-=t,r-=t,i+=t}return e.stacks=e.stacks.filter(e=>e.qty>0),i}function it(e){let t=null;for(let n of $e(e))n.stack.equipped||(!t||qe(n.stack)<qe(t.stack))&&(t=n);return t}function at(e,t){return t===2?[...e]:e.map(e=>{let n=e.trim().split(/\s+/);if(n.length!==2)return e;let r=n[1];if(!/^[+-]?\d+(\.\d+)?$/.test(r))return e;let i=Number(r),a=Pe(n[0],i)?Me[t]:je[t],o=Math.round(i*a*1e6)/1e6;return`${n[0]} ${o>=0?`+`:``}${o}`})}function ot(e,t){let n=W(e),r=U(t),i=n.stacks.filter(e=>e.defId===t&&!e.equipped).sort((e,t)=>z(e)-z(t))[0];if(!i)return{ok:!1,reason:`身上没有${r.name}`,effects:[],consumed:0};let a=R(r)?void 0:z(i);if(r.container){let i=ve(r.container),o=ve(n.container);return i.slots<=o.slots?{ok:!1,reason:`${o.id}比${i.id}还宽敞，换了是往回走`,effects:[],consumed:0}:e.tier<i.minTier?{ok:!1,reason:`神识撑不开${i.id}，还差些火候`,effects:[],consumed:0}:(rt(n,t,1),n.container=i.id,{ok:!0,effects:[],consumed:1,quality:a,note:`换用${i.id}，可装 ${i.slots} 格 —— ${i.note}`})}if(!r.use||r.use.length===0)return{ok:!1,reason:`${r.name}不能直接使用`,effects:[],consumed:0};let o=r.consumable?rt(n,t,1):0;return{ok:!0,effects:at(r.use,a??2),consumed:o,quality:a}}function st(e,t){let n=R(e)?2:z(t),r={};for(let t of Object.keys(e.equip?.factors??{})){let i=e.equip.factors[t]??0,a=Pe(t,i)?Me[n]:je[n];r[t]=Math.round(i*a*1e6)/1e6}return r}function ct(e,t,n){let r={};for(let i of Object.keys(t)){let a=(t[i]??0)*n,o=S[i],s=e.factors[i],c=F(s+a,o.min,o.max);e.factors[i]=c,r[i]=c-s}return r}function lt(e,t){let n=W(e),r=U(t);if(!r.equip)return{ok:!1,reason:`${r.name}不是能佩在身上的东西`};let i=n.stacks.filter(e=>e.defId===t&&!e.equipped).sort((e,t)=>z(t)-z(e))[0];if(!i)return{ok:!1,reason:`身上没有${r.name}`};let a=r.equip.slot,o,s=n.stacks.find(e=>e.equipped===a);s&&(ut(e,a),o=s.defId);let c=ct(e,st(r,i),1);return i.equipped=a,i.applied=c,{ok:!0,slot:a,replaced:o,applied:c,quality:R(r)?void 0:z(i),overTier:r.equip.minTier!==void 0&&e.tier<r.equip.minTier}}function ut(e,t){let n=W(e).stacks.find(e=>e.equipped===t);if(!n)return{ok:!1,reason:`${t}位上没有东西`};let r=H(n.defId);return ct(e,n.applied??(r?.equip?st(r,n):{}),-1),delete n.equipped,delete n.applied,{ok:!0,slot:t}}function dt(e,t){let n=W(e).stacks.find(e=>e.defId===t&&e.equipped);return n?ut(e,n.equipped):{ok:!1,reason:`这件东西没有装备在身上`}}function ft(e){let t={下品:0,中品:0,上品:0,极品:0};for(let n of me)t[n]=et(e,Ke[n]);return t}function pt(e){let t=0;for(let n of me)t+=et(e,Ke[n])*P[n];return t}function mt(e,t){let n=new Set(Object.values(Ke));e.stacks=e.stacks.filter(e=>!n.has(e.defId));for(let n of me){let r=t[n];for(;r>0;){let t=Math.min(999,r);e.stacks.push({defId:Ke[n],qty:t}),r-=t}}}function ht(e,t){let n=Math.max(0,Math.floor(t));if(n===0)return!0;let r=ft(e),i=pt(e);if(i<n)return!1;let a=i-n,o={下品:0,中品:0,上品:0,极品:0};o.极品=Math.min(r.极品,Math.floor(a/P.极品)),a-=o.极品*P.极品;for(let e of[...he].reverse()){if(e===`下品`){o.下品=a,a=0;break}let t=Math.floor(a/P[e]);o[e]=t,a-=t*P[e]}for(let e=1;e<he.length;e++){let t=he[e-1],n=he[e];if(o[n]<=0||o[t]<=0)continue;let r=o[n]*(P[n]/P[t])+o[t];r>999||(o[t]=r,o[n]=0)}return mt(e,o),!0}var gt=[{id:`tianshu`,desc:`九宗环拱的首善之城。规矩最多，路也最多。`,name:`天枢城`,region:`中州`,qiDensity:72,elementWeights:{土:.3,金:.2,木:.2,水:.15,火:.15},mutationPool:[`雷`],mutationRate:.06,pathPool:[`正道`,`儒道`,`武道`],factions:[`剑宗`,`丹宗`,`符箓派`,`阵宗`,`器宗`,`书院`]},{id:`yaowang`,desc:`满谷药香，丹修的摇篮 —— 也是药人的产地。`,name:`药王谷`,region:`东林州`,qiDensity:88,elementWeights:{木:.78,水:.12,土:.1},pathPool:[`正道`,`儒道`],factions:[`丹宗`]},{id:`huoshan`,desc:`地火昼夜不熄。炼器师的圣地，脾气和火一样。`,name:`火山邑`,region:`南离州`,qiDensity:80,elementWeights:{火:.82,土:.13,金:.05},mutationPool:[`火`],mutationRate:.1,pathPool:[`正道`,`魔道`],factions:[`器宗`,`血煞宗`]},{id:`jianzhong`,desc:`万剑埋骨之地。剑修视为圣地，旁人避之不及。`,name:`剑冢外围`,region:`西金州`,qiDensity:68,elementWeights:{金:.8,土:.12,火:.08},pathPool:[`正道`,`武道`],bonus:{根骨:10},factions:[`剑宗`,`外家`]},{id:`bingyuan`,desc:`极北苦寒。修出来的都硬，冻死的更多。`,name:`冰渊边`,region:`北溟州`,qiDensity:64,elementWeights:{水:.75,金:.15,土:.1},mutationPool:[`冰`],mutationRate:.18,pathPool:[`正道`,`鬼道`],factions:[`尸解道`,`阵宗`]},{id:`nanjiang`,desc:`瘴雨蛊虫，魔修与蛊寨杂处。强者才配有名字。`,name:`十万大山`,region:`南疆`,qiDensity:70,elementWeights:{木:.45,毒:.35,水:.2},mutationPool:[`毒`],mutationRate:.22,pathPool:[`魔道`,`妖修`],factions:[`噬魂殿`,`兽王山`]},{id:`wangxiang`,desc:`幽冥边上的河镇，家家做渡亡的营生。夜里别看对岸。`,name:`望乡镇`,region:`幽冥边界`,qiDensity:58,elementWeights:{水:.5,暗:.35,土:.15},mutationPool:[`暗`],mutationRate:.15,pathPool:[`鬼道`,`正道`],bonus:{神魂:25},factions:[`阴司`,`招魂幡`]},{id:`baigu`,desc:`北荒妖蛮部落。无宗门无月钱，爪牙就是道理。`,name:`白骨部`,region:`北荒`,qiDensity:40,elementWeights:{土:.4,火:.3,金:.3},pathPool:[`妖修`,`武道`],bonus:{根骨:40},factions:[`白骨部族`,`兽王山`]},{id:`fudao`,desc:`散修的天堂与坟场。什么都买得到 —— 包括你。`,name:`东海浮岛`,region:`东海`,qiDensity:66,elementWeights:{水:.55,风:.25,木:.2},mutationPool:[`风`],mutationRate:.1,pathPool:[`散修`],bonus:{气运:8},factions:[`坊市`,`游方`,`水族`]},{id:`juelin`,desc:`天下最穷的灵脉，修不了仙。所以这里的人只信拳头。`,name:`绝灵谷`,region:`中州边陲`,qiDensity:5,elementWeights:{土:1},pathPool:[`武道`,`散修`],hiddenBodyRate:3e-4,factions:[]}],_t={tianshu:[[`ls_zhong`,1],[`ls_xia`,20],[`bao_yufu`,1],[`za_ganliang`,3]],yaowang:[[`ls_xia`,15],[`dan_huiqi`,3],[`cai_lingcao`,6],[`za_ganliang`,2]],huoshan:[[`ls_xia`,18],[`bao_tiejian`,1],[`cai_jingjin`,1],[`za_ganliang`,2]],jianzhong:[[`ls_xia`,12],[`bao_tiejian`,1],[`za_quanpu`,1],[`za_ganliang`,2]],bingyuan:[[`ls_xia`,10],[`dan_liaoshang`,2],[`za_ganliang`,4]],nanjiang:[[`ls_xia`,8],[`dan_jiedu`,2],[`cai_fumo`,1],[`za_ganliang`,2]],wangxiang:[[`ls_xia`,10],[`cai_fuzhi`,5],[`za_yupei`,1],[`za_ganliang`,2]],baigu:[[`ls_xia`,4],[`za_quanpu`,1],[`za_ganliang`,5]],fudao:[[`ls_xia`,25],[`za_ditu`,1],[`dan_jia`,1],[`za_ganliang`,2]],juelin:[[`ls_xia`,3],[`za_quanpu`,1],[`za_ganliang`,2]]},vt=[[`ls_xia`,5],[`za_ganliang`,2]];function yt(e){let t=Je();for(let[n,r]of _t[e]??vt)nt(t,n,r);return t}function bt(e,t){return e===0?`无灵根`:t?`变异灵根`:[`单灵根`,`双灵根`,`三灵根`,`四灵根`,`五灵根`][e-1]??`五灵根`}function xt(e,t,n=0){let r=Math.min(1,.15+t.qiDensity/130+n*k.awakenCoef);n>0&&(r=1-(1-r)*(1-n*k.awakenResidual));let i=Math.round(n*k.statCoef);if(!e.chance(r)){let n=!!t.hiddenBodyRate&&e.chance(t.hiddenBodyRate/r);return{hiddenBody:n,talent:{root:`无灵根`,elements:[`无`],purity:n?100:0,悟性:F(e.int(35,75)+(t.bonus?.悟性??0)+i,1,100),根骨:F(e.int(35,70)+(t.bonus?.根骨??0)+i,1,100),神魂:F(e.int(35,70)+(t.bonus?.神魂??0)+i,1,100)}}}let a=F(t.qiDensity/100+n*k.countBiasCoef,0,1),o=(1-n)**k.countSuppressExp,s=[1,2,3,4,5],c=[2*a**3,12*a**2,30*a,32*o,24*o],l=e.weighted(s,c),u=Object.entries(t.elementWeights),d=[],f=[...u];for(let t=0;t<l&&f.length>0;t++){let t=f.map(([,t])=>t*.6+e.next()*.4),n=t.indexOf(Math.max(...t));d.push(f[n][0]),f.splice(n,1)}let p=!1;t.mutationPool&&t.mutationRate&&e.chance(t.mutationRate*(1+n*k.mutationMult))&&(d[0]=e.pick(t.mutationPool),p=!0);let m=F(40+t.qiDensity*.4+n*k.purityCoef+e.gaussian(0,6)-(l-1)*6,5,100);return{hiddenBody:!1,talent:{root:bt(l,p),elements:d,purity:m,悟性:F(e.int(30,80)+(t.bonus?.悟性??0)+i,1,100),根骨:F(e.int(30,75)+(t.bonus?.根骨??0)+i,1,100),神魂:F(e.int(30,75)+(t.bonus?.神魂??0)+i,1,100)}}}function St(e){return e.weighted(O.map(e=>e.id),O.map(e=>e.weight))}function Ct(e){switch(e.root){case`无灵根`:return 0;case`单灵根`:case`异灵根`:return 1;case`双灵根`:return 2;case`三灵根`:return 3;case`四灵根`:return 4;case`五灵根`:return 5;case`变异灵根`:return Math.max(1,e.elements.length)}}function wt(e){return e.root===`无灵根`||e.root===`四灵根`||e.root===`五灵根`}function Tt(e,t){if(t===`双生`)return`双生分薄`;let n=de.filter(e=>e.id!==`双生分薄`);return e.pick(n).id}function Et(e){let t=Ct(e);t>0&&(e.root=bt(Math.min(5,t+A.rootShift),!1)),e.purity=Math.min(e.purity,Math.max(5,Math.round(e.purity*A.purityMult))),e.悟性=Math.max(1,Math.round(e.悟性*A.statMult)),e.根骨=Math.max(1,Math.round(e.根骨*A.statMult)),e.神魂=Math.max(1,Math.round(e.神魂*A.statMult))}function Dt(e){return{...e,elements:[...e.elements]}}function Ot(e,t,n){return{id:e,preTalent:t,forced:n,resolved:!1,culprit:de.find(t=>t.id===e)?.culprit??`下手的那个人`}}function kt(e,t){return t>=A.threshold||e===`双生`}function At(e,t,n,r,i,a){if(a.hiddenBody)return;if(i){let t=Dt(a.talent);return Et(a.talent),Ot(Tt(e,n),t,!1)}if(r<A.threshold||!wt(a.talent))return;let o=Dt(a.talent);for(let n=0;n<4&&(o=xt(e,t,r).talent,wt(o));n++);return Ot(Tt(e,n),o,!0)}function jt(e,t,n){if(t.factions.length===0)return{faction:``,relation:`无关`};let r=j[n]??[[`无关`,1]],i=e.weighted(r.map(([e])=>e),r.map(([,e])=>e));return{faction:e.pick(t.factions),relation:i}}function Mt(e,t={}){let n=t.birthplace??e.pick(gt),r=St(e),i=ue[r]??0,a=kt(r,i)&&e.chance(A.rate),o=xt(e,n,i),s=At(e,n,r,i,a,o),l=jt(e,n,r),{talent:u,hiddenBody:d}=o,f=t.path??n.pathPool[0];u.root===`无灵根`&&!d&&f!==`武道`&&f!==`佛道`&&(f=n.pathPool.includes(`武道`)?`武道`:`佛道`);let p=50+(n.bonus?.气运??0)+(r===`气运之子`?le.luckBonus:0)+(r===`天煞孤星`?-10:0),m={id:`player`,name:t.name??`无名`,path:f,tier:1,sublevel:0,goldenCoreGrade:0,hiddenRealms:[],talent:u,origin:r,originRevealed:!1,originClues:0,bloodline:i,...s?{defect:s}:{},birthFaction:l,ageMonths:192,lifespanYears:c[1],alive:!0,气运:F(p+e.gaussian(0,8),0,100),道心:F(50+e.gaussian(0,10),0,100),功德:0,业障:0,僭越:g[u.root]??0,堕度:0,丹毒:0,名望:0,锋芒:1,secrets:{金手指:0,残魂:0,真实血脉:0,真实修为:0,杀过某人:0,身世:0},factors:Ee(),inventory:yt(n.id),perfectionByTier:{},goldFingerTier:t.goldFingerTier??-1,souls:[],deathExemptions:r===`气运之子`?le.deathExemptPerTier:0,tribulationAttempts:{}};for(let e of m.inventory.stacks){let t=H(e.defId);t?.equip&&!e.equipped&&lt(m,t.id)}return m}var Nt={正道:[`练气`,`筑基`,`金丹`,`元婴`,`化神`,`炼虚`,`合体`,`大乘`,`渡劫`],魔道:[`聚煞`,`魔基`,`魔丹`,`魔婴`,`化魔`,`炼狱`,`魔身`,`大魔`,`魔劫`],鬼道:[`凝魂`,`阴煞`,`鬼将`,`鬼王`,`幽冥`,`阴神`,`冥主`,`鬼帝`,`鬼仙劫`],妖修:[`开智`,`化形`,`妖丹`,`妖将`,`妖王`,`大妖`,`妖圣`,`妖帝`,`妖皇劫`],佛道:[`入门`,`沙弥`,`比丘`,`罗汉`,`菩萨`,`明王`,`尊者`,`古佛`,`涅槃`],儒道:[`开蒙`,`秀才`,`举人`,`进士`,`大儒`,`亚圣`,`文圣`,`至圣`,`立言`],武道:[`淬体`,`洗髓`,`罡气`,`化劲`,`抱丹`,`宗师`,`武圣`,`武神`,`破凡`],散修:[`练气`,`筑基`,`金丹`,`元婴`,`化神`,`炼虚`,`合体`,`大乘`,`渡劫`]},Pt={正道:`金丹`,魔道:`魔丹`,鬼道:`鬼将印`,妖修:`妖丹`,佛道:`舍利`,儒道:`文心`,武道:`丹劲`,散修:`金丹`};function Ft(e,t){return t>=10?`飞升`:(Nt[e]??Nt.正道)[t-1]??`位阶${t}`}function It(e,t){let n=Pt[e]??`金丹`;return!Number.isFinite(t)||t<=0?`未结${n}`:y(t)?`${ee}${n}`:`${n}${Math.min(Math.floor(t),9)}品`}function Lt(e){return!Number.isFinite(e)||e<=0?`未结`:y(e)?ee:`${Math.floor(e)}品`}var Rt=.95,zt=[{name:`前期`,at:0},{name:`中期`,at:.3},{name:`后期`,at:.65},{name:`大圆满`,at:Rt}];function Bt(e){let t=Number.isFinite(e)?e:0,n=0;for(let e=0;e<zt.length;e++)t>=zt[e].at&&(n=e);return n}function Vt(e){return zt[Bt(e)].name}function Ht(e,t,n){return t>=10?Ft(e,t):`${Ft(e,t)}${Vt(n)}`}function Ut(e){return(h[e.talent.root]??0)*(e.talent.purity/100)**_}function Wt(e){let t=ne[0];for(let n of ne)e>=n.at&&(t=n);return t}function Gt(e){return 100*1.55**(e-1)}function Kt(e,t){let n=e.actor,r=b[t],i=u[n.tier]??12,a=Bt(n.sublevel),o=(n.path===`佛道`||n.path===`武道`?1:Ut(n))*f[n.path].speed*r.speed*Wt(n.堕度).speed;Se(n.僭越).at>=201&&(o*=.8),n.path===`魔道`&&t!==`历练突破`&&(o*=1-p.damagePerTick);let s=o*i*.5;n.sublevel=F(n.sublevel+s/Gt(n.tier),0,1);let c=`toxin`in r?r.toxin:0;n.丹毒=F(n.丹毒+c,0,100),n.道心=F(n.道心+r.daoxin,0,100);let l=r.risk+Wt(n.堕度).mishap,d=e.rng.chance(l);d&&(n.sublevel=Math.max(0,n.sublevel-.15),n.道心=F(n.道心-5,0,100));let m=Bt(n.sublevel)>a?Ht(n.path,n.tier,n.sublevel):null;return{progress:s,mishap:d,toxinGained:c,ready:n.sublevel>=Rt,stageUp:m}}function qt(e){let t=ae[e.tier+1]??ae[9],n=e.goldFingerTier>=0?w.tierCoef[e.goldFingerTier]??1:1,r=e.堕度>=re.transcendBand[0]?re.tribulationMult:1,i=e.hiddenRealms.includes(8)?.7:1,a=1+(e.tribulationAttempts[e.tier]??0)*.15;return t*(1+e.僭越/100)*(1-F(e.功德,0,250)/300)*n*r*i*a}function Jt(e){return e.道心*1+e.talent.根骨*.5+e.talent.神魂*.5+e.talent.悟性*.3+Gt(e.tier)*.14+e.hiddenRealms.length*30+Math.max(0,Ce(e)-e.tier)*60+e.factors.状态*20+(e.丹毒>x.breakthroughPenaltyAt?-25:0)}function Yt(e,t={}){let n=e.actor,r=n.tier+1,i=Jt(n),a=qt(n);n.tribulationAttempts[n.tier]=(n.tribulationAttempts[n.tier]??0)+1;let o=ye(e.rng,{power:i,dc:a,scale:Math.max(20,a*.2)},I(n)),s=o===`SUCCESS`||o===`CRIT_SUCCESS`,u=n.goldenCoreGrade;if(s&&r===3){let r=3+(t.coreGradeInvest??0)*4+(n.talent.purity-50)/25+(n.道心-50)/30-n.丹毒/25+I(n)*2;u=F(Math.round(r+e.rng.gaussian(0,1.1)),1,9),o===`CRIT_SUCCESS`&&u===9&&n.talent.elements.length>=5&&(u=10)}let d=!1;if(s&&t.hiddenAttempt){let t=ye(e.rng,{power:n.道心+n.talent.悟性+(100-n.丹毒)+n.hiddenRealms.length*8+(n.perfectionByTier[n.tier-1]??60)*.35,dc:190+n.tier*18,scale:14},I(n));d=t===`SUCCESS`||t===`CRIT_SUCCESS`,d&&n.hiddenRealms.push(n.tier)}let f=Xt(n,d);if(n.perfectionByTier[n.tier]=f,!s){if(o!==`CRIT_FAIL`)return n.sublevel=Math.max(0,1-oe.normal.sublevelLoss),n.道心=F(n.道心-oe.normal.daoxinLoss,0,100),delete n.perfectionByTier[n.tier],{outcome:o,newTier:n.tier,hiddenAchieved:!1,goldenCoreGrade:u,perfection:f};let e=se[n.tier],t=e?{name:e.name,outcome:e.outcome,branch:`branch`in e?e.branch:null,recoverable:e.recoverable}:void 0;return t?.recoverable===!0&&n.tier>1?(--n.tier,n.sublevel=.5,`perfectionLoss`in e&&(n.perfectionByTier[n.tier]=F((n.perfectionByTier[n.tier]??T.base)-e.perfectionLoss,0,100))):n.sublevel=.7,{outcome:o,newTier:n.tier,hiddenAchieved:!1,goldenCoreGrade:u,failure:t,perfection:f}}return n.tier=r,n.sublevel=0,n.goldenCoreGrade=u,n.lifespanYears=(d?l[r]:c[r])??n.lifespanYears,n.僭越+=w.gain.越阶战斗*.5,{outcome:o,newTier:r,hiddenAchieved:d,goldenCoreGrade:u,perfection:f}}function Xt(e,t){let n=e.堕度>=46,r=T.base+(t?T.hiddenRealmBonus:0);if(n){let t=T.corrupt,n=e.堕度>=re.transcendBand[0]&&e.堕度<=re.transcendBand[1];r+=(n?1:.3)*t.堕度稳定,r+=F(e.道心/100,0,1)*t.意志强度,r+=F((e.堕度-45)/55,0,1)*t.禁忌贯彻}else{let t=T.orthodox;r+=F((100-e.丹毒)/100,0,1)*t.根基纯净,r+=F(e.factors.功法/1.9,0,1)*t.功法契合,r+=F(e.道心/100,0,1)*t.道心一致,r+=F(e.业障/100,0,1)*t.心魔残留,r+=F(e.堕度/45,0,1)*t.捷径惩罚}let i=e.丹毒>x.perfectionCapAt?x.perfectionCap:100;return F(r,0,i)}function Zt(e){let t=Object.entries(e.perfectionByTier);if(t.length===0)return 0;let n=0,r=0;for(let[e,i]of t){let t=Number(e),a=T.weights[t]??1;n+=a*Math.log(Math.max(i,.5)),r+=a}return Math.exp(n/r)}function Qt(e){return e>=95?`无瑕无垢，可期大道`:e>=88?`其基醇厚，几近圆满`:e>=80?`根基扎实，尚有余地`:e>=70?`其基醇厚，其行有瑕`:e>=58?`瑕瑜互见，前路难料`:e>=45?`根基已污，恐难登顶`:`道基溃烂，止步在即`}function $t(e){let t=e.actor;switch(t.origin){case`气运之子`:return!t.originRevealed&&e.rng.chance(.06)?`又一次恰好躲开。你开始觉得有点不对劲。`:null;case`天煞孤星`:return e.rng.chance(.04)?(e.flags.add(`孤星应验`),`你身边又少了一个人。这已经是第几个了？`):null;case`上古血脉后裔`:return t.tier>=3&&!t.originRevealed&&e.rng.chance(.08)?(t.originClues++,`血液里有什么东西在响应，像是隔着很厚的石头。`):null;case`转世重修者`:return e.rng.chance(.05)?(t.talent.悟性=F(t.talent.悟性+1,1,100),`一段不属于这一世的记忆闪过，快得抓不住。`):null;case`罪裔`:return t.业障+=.3,null;case`无名`:for(let e of Object.keys(t.secrets))t.secrets[e]=Math.max(0,t.secrets[e]-1);return null;case`容器`:return t.tier>=3&&e.rng.chance(.05)?(t.originClues++,`有人在打听你的生辰八字，问得很细。`):null;default:return null}}function en(e,t=1){e.actor.originClues+=t}function tn(e){let t=e.actor;return t.originRevealed||t.originClues<4?null:(t.originRevealed=!0,t.secrets.身世=F(t.secrets.身世+20,0,100),{origin:t.origin,text:an(t.origin)})}function nn(e){let t=e.actor;return t.deathExemptions<=0?!1:(t.deathExemptions--,t.originRevealed||(t.originRevealed=!0,t.originClues=4),!0)}function rn(e){e.actor.origin===`气运之子`&&(e.actor.deathExemptions=le.deathExemptPerTier)}function an(e){switch(e){case`凡俗`:return`查到最后，什么也没有。你父母是普通人，祖上也是。
...
「养得不错，」他说，「再等等。」`;case`遗孤`:return`那枚旧玉佩终于对上了。有人认出了它，脸色瞬间变了。`;case`双生`:return`你在千里之外受伤的那天，另一个人也在同一处疼。你们从未见过。`;case`罪裔`:return`族谱上那一页被撕掉了。撕掉的地方，纸背还留着压痕 —— 你能认出那几个字。`;case`无名`:return`天机阁推了三次，三次都是空白。掌事的手在抖：「你……是从哪儿来的？」`;case`归来者`:return`你在一具无名尸骸旁停下。它手上戴的储物戒，和你梦里那枚一模一样。`}}function on(e){let t=O.find(t=>t.id===e);if(!t)return 1;let n=O.reduce((e,t)=>e+t.weight,0);return Math.round(n/t.weight*10)/10}function sn(e,t){let n=e.actor,r=ln(t),i=r===0?.5:1-F(t.unusedWindows.length/r,0,1),a=F(n.道心/100,0,1),o=F((n.名望+100)/400,0,1);return F(i*.6+a*.25+o*.15,0,1)}function cn(e,t){let n=e.actor,r=sn(e,t),i=Ce(n)+.9-r*1.5+e.rng.range(-.2,.2),a=Te(e.rng,n,i),o=t.target,s=Math.floor(e.year-t.createdYear),c=`${s} 年前的「${t.type}」找上门 —— ${o}`;if(a===`CRIT_SUCCESS`)return t.resolved=!0,t.resolvedBy=`了结`,{kind:`反杀`,outcome:a,readiness:r,death:null,text:`${o}来了，带着${s}年的恨意。你早知道他会来 —— 所以这一场，你赢得干脆。`};if(a===`SUCCESS`)return t.resolved=!0,t.resolvedBy=`了结`,{kind:`挡下`,outcome:a,readiness:r,death:null,text:`${o}的旧账找上门来。你挡住了。这一段因果，就此了结。`};let l=r<.2;return a===`FAIL`&&!l?(n.factors.状态=F(n.factors.状态-.28,.1,3),n.lifespanYears=Math.max(0,n.lifespanYears-40),n.sublevel=F(n.sublevel-.25,0,1),n.道心=F(n.道心-8,0,100),t.resolved=!0,t.resolvedBy=`补偿`,{kind:`重伤`,outcome:a,readiness:r,death:null,text:`${o}到底还是找上了门。你没能全身而退 ——一身修为塌了小半，寿元也折了几十年。但你还站着，账也算清了。`}):nn(e)?(t.resolved=!0,t.resolvedBy=`化解`,{kind:`逃生`,outcome:a,readiness:r,death:null,text:`你本该死在那里。可你没有。你开始怀疑自己身上有什么不对劲。`}):(t.resolved=!0,{kind:`致死`,outcome:a,readiness:r,death:{id:`death_${t.id}`,kind:`因果致死`,lethal:!0,karmaId:t.id,description:c},text:`${o}找上门来。${l?`这些年的天象、传闻、脚下不认得的红泥，都在提醒你这一天会到 —— 你一次也没当回事。`:`你尽了力。可有些账，尽了力也还不上。`}`})}function ln(e){let t=0;for(let n of e.hooks)for(let e of n.foreshadow??[])e.window&&t++;return t}function un(e,t){let n=e.karmaLedger.filter(e=>!e.resolved&&e.weight>=10).sort((e,t)=>dn(t)-dn(e))[0];return n?(n.resolved=!0,n.resolvedBy=t,n.unusedWindows=[],n):null}function dn(e){return e.weight+(e.hooks.some(e=>e.lethal)?60:0)+(e.unusedWindows.length>0?40:0)-e.matureAt*.01}function fn(e,t){let n=0;for(let t of e){let e=Number(/^k_(\d+)_/.exec(t.id)?.[1]??NaN);Number.isFinite(e)&&e>n&&(n=e)}return`k_${n+1}_${t}`}function pn(e){for(let t of e.hooks){if(!t.lethal)continue;let n=t.foreshadow??[];if(n.length<E.lethalMinForeshadow)throw Error(`[铁律二] 因果钩子「${t.id}」标记 lethal 但只有 ${n.length} 条预警（需 ≥${E.lethalMinForeshadow}）。来源：${e.source}`);if(n.filter(e=>e.window).length<E.lethalMinWindow)throw Error(`[铁律二] 因果钩子「${t.id}」缺少可干预窗口（需 ≥${E.lethalMinWindow} 个 window:true）。来源：${e.source}`)}}function mn(e,t){pn(t);let n=t.matureWindow??[...E.defaultMatureWindow],r=e.year+e.rng.range(n[0],n[1]),i={id:fn(e.karmaLedger,t.type),type:t.type,source:t.source,actor:t.actor,target:t.target,weight:t.weight,polarity:t.polarity,createdYear:e.year,matureWindow:n,chainParent:t.chainParent??null,resolved:!1,hooks:t.hooks,matureAt:r,foreshadowsSent:[],unusedWindows:[]};return e.karmaLedger.push(i),i}function hn(e,t){let n=e.karmaLedger.find(e=>!e.resolved&&e.target===t.target&&e.type===t.type);return n?(n.weight+=t.weight,n):mn(e,t)}function gn(e,t){let n=[],r=0;for(let i of e.karmaLedger){if(i.resolved||i.weight<E.minEventWeight)continue;let a=_n(e,i);if(a){for(let r of a.foreshadow??[]){let o=i.matureAt+r.at;!i.foreshadowsSent.includes(r.evt)&&e.year>=o&&e.year-t<o+t&&(i.foreshadowsSent.push(r.evt),r.window&&i.unusedWindows.push(r.evt),n.push({kind:r.window?`window`:`foreshadow`,karma:i,hook:a,evtId:r.evt,lethal:!!a.lethal}))}if(e.year>=i.matureAt&&r<E.maxResolvePerTick){let o=i.foreshadowsSent.length;if(a.lethal&&o<E.lethalMinForeshadow){i.matureAt=e.year+Math.max(2,t);continue}r++,i.resolved=!0,n.push({kind:`mature`,karma:i,hook:a,evtId:a.id,lethal:!!a.lethal})}}}return n}function _n(e,t){if(t.hooks.length===0)return;let n=t.polarity<0?0:Math.min(t.hooks.length-1,1);return t.hooks[n]??t.hooks[0]}function vn(e,t){let n=new Map(e.map(e=>[e.id,e])),r=[],i=n.get(t),a=new Set;for(;i&&!a.has(i.id);)a.add(i.id),r.unshift(i),i=i.chainParent?n.get(i.chainParent):void 0;return r}function yn(e,t){e.resolved=!0,e.resolvedBy=t}function bn(e){return e.filter(e=>!e.resolved).sort((e,t)=>t.weight-e.weight)}function xn(e){return e.reduce((e,t)=>e+t.polarity*t.weight,0)}function Sn(e,t){return{id:e,lethal:!0,foreshadow:[{at:-8,evt:`${t}_传闻`},{at:-3,evt:`${t}_打听`},{at:-1,evt:`${t}_逼近`,window:!0}]}}var Cn=class extends Error{};function wn(e,t){let n=t.karmaId?vn(e.karmaLedger,t.karmaId):[];if(n.length===0&&t.kind!==`寿元`)throw new Cn(`[铁律三] 死因「${t.id}」(${t.kind}) 无因果链，无法向玩家解释。`);let r=n.flatMap(e=>e.foreshadowsSent);if(t.lethal&&t.kind!==`寿元`&&r.length<E.lethalMinForeshadow)throw new Cn(`[铁律二] 死因「${t.id}」只投放了 ${r.length} 条预警（需 ≥${E.lethalMinForeshadow}）。`);let i=n.flatMap(e=>e.unusedWindows);return e.actor.alive=!1,{cause:t,chain:n,warnings:r,missedWindows:i,atYear:Math.floor(e.year),atTier:e.actor.tier,atPath:e.actor.path}}function Tn(e){return e.actor.ageMonths/12<e.actor.lifespanYears?null:{id:`death_lifespan`,kind:`寿元`,lethal:!0,description:`寿元耗尽，坐化于第 ${Math.floor(e.year)} 年`}}function En(e){let t=e.actor.lifespanYears-e.actor.ageMonths/12;return t>10||t<=0?null:`寿元将尽，尚余 ${t.toFixed(1)} 年`}function Dn(e,t){let n=e.tier-t;for(let e of N.guidanceByGap)if(n>=e.gap)return{level:e.level,speedBonus:e.speedBonus,canAct:e.canAct,gap:n};return{level:N.guidanceByGap[N.guidanceByGap.length-1].level,speedBonus:0,canAct:!1,gap:n}}function On(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);if(!n)return null;let r=Dn(n,e.actor.tier);if(r.speedBonus<=0)return r;let i=N.possessionPerGuidance*(1+r.gap*.08)*(1-e.actor.道心/250);return n.possession=F(n.possession+i,0,100),n.favor=F(n.favor+1,-100,100),r}function kn(e){let t=[];for(let n of e.actor.souls)if(!n.dissipated){if(n.possession>=100){t.push({soul:n,fate:`夺舍成功`}),e.actor.alive=!1;continue}if(Math.max(0,n.tier-e.actor.tier)<=0&&e.rng.chance(.02)){n.dissipated=!0,t.push({soul:n,fate:`消散`});continue}n.favor=F(n.favor-.15,-100,100)}return t}function An(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);if(!n)return{ok:!1,text:`并无此魂`};let r=55+n.tier*4+n.possession*.3;return e.actor.道心<r?(n.possession=100,e.actor.alive=!1,{ok:!1,text:`你伸手去抓那缕残魂，却被它顺着手臂爬了进来。`}):(n.dissipated=!0,e.actor.factors.功法=F(e.actor.factors.功法+.25,.55,1.9),e.actor.业障+=25,e.actor.道心=F(e.actor.道心-12,0,100),{ok:!0,text:`你吞下了他。他毕生所学成了你的，连同他没来得及说完的那句话。`})}function jn(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);return n?n.favor<80?{ok:!1,text:`他还不信你。`}:(n.dissipated=!0,e.actor.功德+=40,e.actor.道心=F(e.actor.道心+8,0,100),{ok:!0,text:`他松开了。最后那点光散进风里，往下面去了。`}):{ok:!1,text:`并无此魂`}}function Mn(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);return n?n.favor<90?{ok:!1,text:`他还没打算把自己交出去。`}:(n.dissipated=!0,e.actor.talent.神魂=F(e.actor.talent.神魂+15,1,100),e.actor.factors.功法=F(e.actor.factors.功法+.18,.55,1.9),e.flags.add(`融合_${t}`),{ok:!0,text:`从此你分不清哪些念头是自己的，哪些是他的。他好像也不在意了。`}):{ok:!1,text:`并无此魂`}}function Nn(e){return!!e.defect&&!e.defect.resolved}function Pn(e){return e.birthFaction??{faction:``,relation:`无关`}}var Fn=`lineage`;function In(e){let t=e.actor,n=Pn(t);n.faction&&(e.flags.add(`出身势力·${n.faction}`),e.flags.add(`出身关系·${n.relation}`)),Nn(t)&&(e.flags.add(`血脉·有瑕`),e.flags.add(`瑕·${t.defect.id}`)),Nn(t)&&mn(e,{type:`夺取`,source:`${Fn}·defect`,actor:t.defect.culprit,target:t.defect.culprit,weight:M.defect.weight,polarity:-1,matureWindow:[...M.defect.window],hooks:[{id:`defect·旧影`,foreshadow:[{at:-4,evt:`瑕疵下手者·风声`}]}]});let r=[];switch(t.origin){case`罪裔`:r.push({type:`灭门`,target:`追讨旧账的人`,tag:`罪裔`,weight:M.罪裔.weight,window:M.罪裔.window,lethalPrefix:`罪裔旧账`});break;case`遗孤`:r.push({type:`灭门`,target:`灭门的仇家`,tag:`遗孤`,weight:M.遗孤.weight,window:M.遗孤.window,lethalPrefix:`灭门旧仇`});break;case`容器`:r.push({type:`夺取`,target:`等你长成的人`,tag:`容器`,weight:M.容器.weight,window:M.容器.window,lethalPrefix:`容器之约`});break;case`上古血脉后裔`:r.push({type:`立誓`,tag:`名门`,target:e.rng.pick([`家族的政敌`,`一桩联姻的旧诺`,`欠着的旧人情`]),weight:M.名门.weight,window:M.名门.window})}n.relation===`质子`&&n.faction&&r.push({type:`立誓`,target:`${n.faction}的质约`,tag:`质子`,weight:M.质子.weight,window:M.质子.window});for(let t of r)mn(e,{type:t.type,source:`${Fn}·${t.tag}`,actor:t.target,target:t.target,weight:t.weight,polarity:t.lethalPrefix?-1:0,matureWindow:[...t.window],hooks:t.lethalPrefix?[Sn(`${t.tag}·清算`,t.lethalPrefix)]:[{id:`${t.tag}·索取`,foreshadow:[{at:-3,evt:`${t.tag}旧账·来信`}]}]})}function Ln(e){let t=e.actor,n=t.defect;if(!n||n.resolved)return null;let r=t.talent.root;t.talent={...n.preTalent,elements:[...n.preTalent.elements]},t.僭越=F(t.僭越+(g[t.talent.root]??0)-(g[r]??0),0,1/0),n.resolved=!0,e.flags.delete(`血脉·有瑕`),e.flags.delete(`瑕·${n.id}`),e.flags.add(`血脉·已复`);let i=e.karmaLedger.find(e=>!e.resolved&&e.source===`${Fn}·defect`);return i&&yn(i,`了结`),{defect:n,text:`压在你根骨里的那点东西（${n.id}）散了。经脉里的淤塞一寸寸退开 —— 原来你本该是这样的资质。这笔账，也算到头了。`}}function Rn(e){let t=[];if(e.flags.delete(`瑕·解除`)){let n=Ln(e);n&&t.push(n.text)}return t}var zn=[`金手指`,`残魂`,`真实血脉`,`真实修为`,`杀过某人`,`身世`];function Bn(e,t,n,r){e.actor.secrets[t]=F(e.actor.secrets[t]+n,0,100),r&&!e.knowers.some(e=>e.npc===r&&e.secret===t)&&e.knowers.push({npc:r,secret:t,risk:F(n/20,.05,.9)})}function Vn(e){Bn(e,`真实修为`,D.overTierArtifact)}function Hn(e){let t=e.actor,n=Se(t.僭越),r=we(t);n.hunted>0&&(t.secrets.金手指=F(t.secrets.金手指+n.hunted*4,0,100),t.secrets.真实修为=F(t.secrets.真实修为+n.hunted*2,0,100));for(let n of e.knowers)e.rng.chance(n.risk*.06)&&(t.secrets[n.secret]=F(t.secrets[n.secret]+6,0,100));let i=.8+r*2.2;for(let e of zn)t.secrets[e]=Math.max(0,t.secrets[e]-i)}function Un(e){return zn.filter(t=>e.actor.secrets[t]>=D.revealAt)}function Wn(e,t){let n=e.knowers.filter(e=>e.npc===t).map(e=>e.secret);e.knowers=e.knowers.filter(e=>e.npc!==t);for(let t of n)e.actor.secrets[t]=Math.max(0,e.actor.secrets[t]-18);return e.actor.业障+=12+n.length*5,e.actor.道心=F(e.actor.道心-3,0,100),n}function Gn(e,t){let n=e.knowers.findIndex(e=>e.npc===t);if(n<0)return!1;let r=e.knowers[n];return e.actor.secrets[r.secret]=Math.max(0,e.actor.secrets[r.secret]-10),e.knowers.splice(n,1),e.actor.业障+=2,!0}function Kn(e){let t=e.actor;t.僭越=0,t.名望=0,t.锋芒=0;for(let e of zn)t.secrets[e]=0;e.knowers=[],t.factors.情报=.85,t.factors.伙伴=.9,t.factors.道侣=1,e.flags.add(`假死脱身`)}function qn(e){let t=we(e.actor);return{faceSlapMult:1+t*(ce.faceSlapMultMax-1),decayBonus:t*ce.decayBonusMax,resourcePenalty:t*ce.resourcePenaltyMax}}function Jn(e){let{decayBonus:t}=qn(e),n=1+F(e.actor.功德,0,300)/600;e.actor.僭越=Math.max(0,e.actor.僭越-w.decayBase*(1+t)*n)}var Yn=[[`练气`,1],[`筑基`,2],[`金丹`,3],[`元婴`,4],[`化神`,5],[`炼虚`,6],[`合体`,7],[`大乘`,8]];function Xn(e,t){if(t===`正道`||t===`散修`)return e;let n=e;for(let[e,r]of Yn){if(!n.includes(e))continue;let i=r===3&&/金丹(碎|裂|散|毁)/.test(n)?Pt[t]:Ft(t,r);n=n.split(e).join(i)}return n}var Zn={守尸人:{name:`婴死体存 · 守尸人`,grade:`凡碑`,mult:.8,text:`肉身还在，元婴没了。往后的日子靠药和阵撑着，等一个「借婴」的法子。`},痴儿:{name:`神识裂解 · 痴儿`,grade:`凡碑`,mult:.9,text:`修为还在，人不在了。你在山里走来走去，见谁都笑，谁的名字都想不起来。`},虚空漂流:{name:`虚空吞噬 · 漂流者`,grade:`灵碑`,mult:1.1,text:`虚空裂开的那一瞬间你没抓住任何东西。此后你还活着，只是再也回不去了。`},残魂:{name:`道体崩解 · 化为残魂`,grade:`玄碑`,mult:1.4,text:`肉身尽毁，只余一缕。你飘在原地，看着自己的洞府积灰 —— 你终于成了你当年遇到的那种东西。`},地缚灵:{name:`道消 · 地缚`,grade:`凡碑`,mult:.7,text:`执念缚在这片死地上。偶尔有人路过，你想说话，他们听不见。`}},Qn={药王谷:`药王谷谷主`,东海:`东海岛主`,中州:`一城之主`,山野:`山野散人`,宗门:`太上长老`,北荒:`妖蛮部落王`,西域:`佛国住持`,坊市:`坊市巨商`,剑冢:`剑冢守墓人`};function $n(e){let t=e.actor,n=Zt(t),r=ie;if(e.death&&e.death.cause.kind!==`寿元`){let n=e.death.cause.kind;return{id:`death_${n}`,name:`夭折 · ${n}`,tier:`夭折`,grade:`凡碑`,fruitMult:.3+t.tier*.08,text:e.death.cause.description}}if(e.failedBranch){let n=e.failedBranch.branch?Zn[e.failedBranch.branch]:void 0;return n?{id:`branch_${e.failedBranch.branch}`,name:Xn(n.name,t.path),tier:`夭折`,grade:n.grade,fruitMult:n.mult+t.tier*.1,text:Xn(n.text,t.path)}:{id:`tribulation_failed`,name:`${e.failedBranch.name} · ${Xn(e.failedBranch.outcome,t.path)}`,tier:`夭折`,grade:`凡碑`,fruitMult:.6+t.tier*.1,text:Xn(e.failedBranch.outcome,t.path)}}if(t.souls.some(e=>e.possession>=100))return{id:`possessed`,name:`被夺舍 · ${t.souls.find(e=>e.possession>=100).name}`,tier:`夭折`,grade:`凡碑`,fruitMult:.5,text:`你最后的念头是：他早就说过的。`};if(t.堕度>=100)return{id:`possessed_by_demon`,name:`入魔失控`,tier:`夭折`,grade:`血道碑`,fruitMult:1.2,text:`你还在，但那个「你」已经不在了。往后有人会用你的名字，做你不会做的事。`};if(t.tier>=10)return t.path===`武道`&&t.talent.root===`无灵根`&&n>=r.以凡证道.perfection?{id:`mortal_ascend`,name:`以凡证道`,tier:`隐藏`,grade:`无字碑`,fruitMult:fe.noSystemMult,text:`你从头到尾都是个凡人。然后你打赢了神仙。`}:n>=r.真仙.perfection&&t.僭越<r.真仙.transgression&&t.hiddenRealms.length>=9&&e.jieXian?{id:`true_immortal`,name:`真仙`,tier:`飞升`,grade:`道碑`,fruitMult:6,text:`云开，天梯落下。你回头看了一眼这座你活了千年的山，然后走了上去。`}:t.堕度>=re.transcendBand[0]&&t.堕度<=re.transcendBand[1]&&n>=r.堕仙.perfection&&(e.reflections??0)>=3?{id:`fallen_immortal`,name:`堕仙 · 魔祖证道`,tier:`飞升`,grade:`血道碑`,fruitMult:fe.transcendMult,text:`此道自我而始，亦自我而终。后来者，勿效。`}:{id:`ascend`,name:`飞升 · 上位面一员`,tier:`飞升`,grade:`天碑`,fruitMult:3,text:`天梯尽头是另一片天。你抬头，发现上面还有人在往上走。`};if(e.steppedDown){let r=Qn[e.rootedAt??`山野`]??`一方之主`,i=n>=80?`玄碑`:`灵碑`;return{id:`local_${e.rootedAt??`山野`}`,name:`偏安一隅 · ${r}`,tier:`偏安`,grade:i,fruitMult:1+t.tier*.15+n/100,text:`你在这里住了下来。后来有人问起你是谁，你说，就是个种药的。`}}return!e.death&&t.tier>=5&&t.功德>200&&t.僭越<20&&n>=85?{id:`seclusion`,name:`归隐`,tier:`隐藏`,grade:`无字碑`,fruitMult:4,text:`你把修为散了。散得干干净净，像从来没修过一样。`}:t.tier>=9?n>=r.位面主宰.perfection&&t.僭越<r.位面主宰.transgression?{id:`plane_sovereign`,name:`位面主宰`,tier:`主宰`,grade:`地碑`,fruitMult:2.2,text:`这一界之内，再无人能让你抬头。而你抬头时，看见的还是那层没破的天。`}:{id:`stuck_at_9`,name:`止步渡劫期`,tier:`主宰`,grade:`玄碑`,fruitMult:1.6,text:`你在渡劫期停了下来。天劫还在上面等着，你知道自己过不去。`}:t.tier>=5?{id:`elder_${t.tier}`,name:`一方尊长 · 老死于此界`,tier:`偏安`,grade:n>=80?`玄碑`:`灵碑`,fruitMult:.9+t.tier*.14+n/150,text:`你没能再往上走一步。但这一界之内，认得你名字的人已经不多了 —— 比你年长的都死光了。`}:t.tier>=3?{id:`mortal_end_${t.tier}`,name:`碌碌一生 · 尚有薄名`,tier:`偏安`,grade:`灵碑`,fruitMult:.6+t.tier*.12,text:`结了丹，也就到此为止了。山下的人还记得你，山上的人已经忘了。`}:{id:`mortal_end_${t.tier}`,name:`碌碌一生`,tier:`偏安`,grade:`凡碑`,fruitMult:.5+t.tier*.12,text:`没什么可说的。这样的人，这座山上每年都要埋掉几十个。`}}function er(e,t,n={}){let r=Zt(e),i=e.tier*10+r*.6,a=t.fruitMult;n.noSystem&&(a*=fe.noSystemMult/3),e.堕度>=46&&(a*=fe.corruptMult/2),e.goldFingerTier>=0&&(a*=fe.tierMult[e.goldFingerTier]??1),a*=fe.difficultyMult[n.difficulty??`修士`]??1;let o=e.锋芒>0?Math.max(0,1-e.锋芒/Math.max(e.tier,1)):1;return a*=1+o*.35,Math.round(i*a)}function tr(e){return e.tier>=ie.地方大佬.minTier&&e.alive}function nr(e,t,n){return{tick:t,year:Math.floor(n),tier:e.tier,道心:Math.round(e.道心),僭越:Math.round(e.僭越),堕度:Math.round(e.堕度),气运:Math.round(e.气运),名望:Math.round(e.名望),perfection:Math.round(Zt(e))}}function rr(e,t,n){let r=Math.max(1,Math.floor(n-t.createdYear)),i=t.resolved;if(t.polarity>0)return e.pick([`后来他活得不错，只是再没见过你。他跟人提起过一次，说当年有个人帮过他，可惜没问名字。`,`他记了你一辈子。临终前把这件事讲给了孙辈听，讲得添油加醋。`,`他后来也修出了点名堂。有人问他师承何处，他说，是一个只见过一面的人。`,`他没等到还这份人情的机会。你死的消息传到他那儿时，他沉默了很久。`]);if(t.polarity<0){if(i){let n=[`这笔账在第 ${Math.floor(t.createdYear)+Math.floor(r*.6)} 年了了。之后再没人提起。`,`他死在了你前面。死因与你无关，但也不能说全无关系。`,`你们最后一次见面时谁也没说话。这事就这么过去了。`];return e.pick(n)}let n=[`他等了你 ${r} 年，等到你死也没等来。这口气他带进了棺材。`,`他把这笔账留给了后人。你的名字被写在一张纸上，压在他家祠堂的供桌下面。`,`他后来做了和你一样的事，对另一个人。`,`他一直在找你。你死那年，他刚好走到离你三百里的地方。`];return e.pick(n)}return`此后各自行路，再无交集。`}function ir(e){switch(e.type){case`救助`:case`施恩`:return`你救过/帮过的人`;case`杀戮`:return`死在你手上的人`;case`背叛`:return`被你辜负的人`;case`夺取`:return`被你拿走过东西的人`;case`受辱`:return`欺负过你的人`;case`毁诺`:return`你食言过的人`;case`欺骗`:return`被你骗过的人`;case`传承`:return`把东西留给你的人`;case`放走`:return`你放过一马的人`;case`灭门`:return`被你灭门的人`;case`立誓`:return`你许过诺的人`}return`与你有过一段的人`}function ar(e){let{actor:t,ledger:n,death:r,ending:i}=e,a=new o(`${e.seed}:chronicle`),s=n.filter(e=>e.resolved),c=bn(n),l=new Set,u=[...n].sort((e,t)=>t.weight-e.weight).slice(0,12).map(t=>{let n=rr(a,t,e.diedAtYear);for(let r=0;r<3&&l.has(n);r++)n=rr(a,t,e.diedAtYear);return l.add(n),{name:t.target,relation:ir(t),whatYouDid:`第 ${Math.floor(t.createdYear)} 年 · ${t.type}（因果重 ${t.weight}）`,afterward:n}}),d=[...e.flags].filter(e=>e.startsWith(`道·`)||e.startsWith(`结丹·`)||[`无系统`,`得系统`,`拒绝过系统`,`假死脱身`,`手上有人命`,`已立威`].includes(e)),f=Zt(t);return{timeline:e.milestones,deathChain:r?or(r):null,missedWindows:r?.missedWindows??[],karmaResolved:s,karmaUnresolved:c,karmaNet:Math.round(xn(n)),people:u,curve:e.curve,forks:d,verdict:sr(t,n,i,e.diedAtYear),unfinished:c.slice(0,8).map(e=>`第 ${Math.floor(e.createdYear)} 年欠下的「${e.type}」—— ${e.target}（重 ${e.weight}）`),name:t.name,path:t.path,origin:t.origin,originRarity:on(t.origin),tier:t.tier,lifespan:Math.floor(t.ageMonths/12),perfection:Math.round(f*10)/10,concealment:Math.round(we(t)*100)/100,ending:i}}function or(e){return e.chain.map((e,t)=>`${t+1}. 第 ${Math.floor(e.createdYear)} 年 · ${e.type} · ${e.target}（重 ${e.weight}）`).join(`
`)}function sr(e,t,n,r){let i=Zt(e),a=t.filter(e=>e.type===`杀戮`).length,o=t.filter(e=>e.type===`救助`||e.type===`施恩`).length,s=t.filter(e=>e.type===`毁诺`).length,c=t.filter(e=>e.type===`立誓`).length,l=e.origin===`凡俗`?`生于微末，无所凭恃`:e.originRevealed?`身负「${e.origin}」之命`:`生而不知其所以生`,u=e.souls.length>0?`得残魂而起`:n.tier===`隐藏`&&n.id===`mortal_ascend`?`不假外物`:`独行至此`,d=we(e)>.6?`一世藏锋，未尝显名`:e.名望>200?`声名赫赫，四海皆闻`:`半明半晦，不为人知`,f=i>=95?`无瑕无垢`:i>=80?`其行有瑕，其志不移`:i>=60?`瑕瑜互见`:`根基已污`,p=[];a&&p.push(`杀${ur(a)}人`),o&&p.push(`救${ur(o)}人`),s&&p.push(`负${ur(s)}诺`),c&&p.push(`践${ur(c)}誓`);let m=cr(e,n,i);return[`${l}，${u}，${d}。`,`${f}。${p.length?p.join(`，`)+`。`:``}`,`寿${ur(Math.floor(e.ageMonths/12))}载，终于${Math.floor(r)}年。`,`——「${m}」`].join(`
`)}function cr(e,t,n){return t.id===`true_immortal`?`道无捷径，唯诚而已。`:t.id===`fallen_immortal`?`此道自我而始，亦自我而终。`:t.id===`mortal_ascend`?`凡骨亦可撼天，只是无人肯信。`:t.id===`seclusion`?`知其可为而不为，是为大智。`:t.tier===`夭折`&&e.tier<=2?`此山每年埋人数十，其名多不可考。`:t.tier===`夭折`?`知其不可为而为之，是为道心；知其不可留而留之，是为执念。`:t.tier===`偏安`?`止于所当止，亦是一种圆满。`:n<60?`路是自己选的，账也是自己欠的。`:`行至水穷，坐看云起。`}var lr=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function ur(e){return e<10?lr[e]:e<20?`十${e%10?lr[e%10]:``}`:e<100?`${lr[Math.floor(e/10)]}十${e%10?lr[e%10]:``}`:e<1e4?String(e):`${Math.floor(e/1e4)}万${e%1e4?String(e%1e4):``}`}function dr(e){let t=[],n=e=>{t.push(``,`── ${e} ──`)};t.push(`═`.repeat(66)),t.push(`《一生录》 · ${e.name}`),t.push(`═`.repeat(66)),t.push(`${e.path} · 位阶 ${e.tier} · 寿 ${e.lifespan} 载`),t.push(`身世「${e.origin}」（约 ${e.originRarity} 局一见）· 道途完满度 ${e.perfection}「${Qt(e.perfection)}」`),t.push(`藏拙 ${e.concealment} · 因果净极性 ${e.karmaNet}`),t.push(``),t.push(`【${e.ending.name}】${e.ending.text}`),n(`① 生平`);for(let n of e.timeline.slice(0,24))t.push(`  ${String(n.year).padStart(5)}年  ${n.text}`);if(e.timeline.length>24&&t.push(`  …另有 ${e.timeline.length-24} 条`),e.deathChain&&(n(`② 死因链`),t.push(e.deathChain),e.missedWindows.length)){t.push(``,`  你本可以在这些时刻改变结局：`);for(let n of e.missedWindows)t.push(`  · ${n}`)}n(`③ 因果`),t.push(`  已了结 ${e.karmaResolved.length} 条 · 未了结 ${e.karmaUnresolved.length} 条`),n(`④ 人物志`);for(let n of e.people.slice(0,6))t.push(`  【${n.name}】${n.relation}`),t.push(`    ${n.whatYouDid}`),t.push(`    ${n.afterward}`),t.push(``);if(e.forks.length&&(n(`⑥ 岔路`),t.push(`  ${e.forks.join(` · `)}`)),n(`⑦ 判词`),t.push(e.verdict.split(`
`).map(e=>`  ${e}`).join(`
`)),e.unfinished.length){n(`⑧ 未竟之事`);for(let n of e.unfinished)t.push(`  · ${n}`);t.push(``,`  （这些会跟着你，进入下一局。）`)}return t.push(``),t.join(`
`)}function fr(e){return e.tier===3&&e.goldenCoreGrade>0?It(e.path,e.goldenCoreGrade):e.tier>=10?Ft(e.path,e.tier):Ht(e.path,e.tier,e.sublevel)}var pr=`甲乙丙丁戊己庚辛壬癸`,mr=`子丑寅卯辰巳午未申酉戌亥`,hr=[`零`,`壹`,`贰`,`叁`,`肆`,`伍`,`陆`,`柒`,`捌`,`玖`];function gr(e){return`${pr[e%10]}${mr[e%12]}·${String(e).split(``).map(e=>hr[Number(e)]).join(``)}`}function _r(e,t){let n=Math.max(1,Math.floor(e.createdYear-t+16)),r=n<100?`${n}岁`:`${Math.floor(e.createdYear)}年`,i=e.target;switch(e.type){case`杀戮`:return`${r}，杀${i}${e.weight>45?`，血溅五步`:``}。`;case`救助`:return`${r}，救${i}于危难。`;case`施恩`:return`${r}，施恩于${i}，未求报。`;case`背叛`:return`${r}，负${i}。`;case`夺取`:return`${r}，取${i}之物，其人不甘。`;case`受辱`:return`${r}，为${i}所辱，未即报。`;case`毁诺`:return`${r}，毁与${i}之约。`;case`欺骗`:return`${r}，绐${i}。`;case`传承`:return`${r}，得${i}之遗泽。`;case`放走`:return`${r}，纵${i}去。`;case`立誓`:return`${r}，与${i}立誓。`;case`灭门`:return`${r}，屠${i}满门。`}}function vr(e){let{actor:t,ledger:n,ending:r}=e,i=[...n].sort((e,t)=>t.weight-e.weight).slice(0,5).sort((e,t)=>e.createdYear-t.createdYear).map(t=>_r(t,e.birthYear)),a=[`生${t.path===`武道`?`而无灵根`:`具${t.talent.root}`}，${t.origin===`凡俗`?`无所凭恃`:t.originRevealed?`身负「${t.origin}」`:`来历不明`}。`,...i];a.length<6&&a.push(`终，${r.name}。`);let o=Zt(t),s=yr(r.grade)+ +(o>=95);return{serial:gr(e.serialIndex),seed:e.seed,grade:r.grade,ending:r.name,daoName:t.name,finalRealm:fr(t),perfection:Math.round(o*10)/10,verdictShort:e.verdictShort,lifespan:Math.floor(t.ageMonths/12),inscription:a,marks:{僭越:Math.round(t.僭越),因果:Math.round(n.reduce((e,t)=>e+t.polarity*t.weight,0)),功德:Math.round(t.功德),业障:Math.round(t.业障),藏拙:Math.round(we(t)*100)/100,堕度:Math.round(t.堕度)},goldFingers:e.goldFingers,rarity:s,createdAtYear:Math.floor(e.diedAtYear)}}function yr(e){switch(e){case`凡碑`:return 1;case`灵碑`:return 2;case`玄碑`:return 3;case`地碑`:return 4;case`天碑`:return 4;case`血道碑`:return 5;case`道碑`:return 5;case`无字碑`:return 5}}function br(e){let t=[];t.push(`┌`+`─`.repeat(60)+`┐`);let n=(e=``)=>{t.push(`│ `+e.padEnd(58)+` │`)};n(`${e.grade}  ${`★`.repeat(e.rarity)}`),n(`编号 ${e.serial}`),n(),n(`【${e.ending}】`),n(`${e.daoName} · ${e.finalRealm}`),n(`寿 ${e.lifespan} 载 · 完满度 ${e.perfection}`),n(`「${e.verdictShort}」`),n();for(let t of e.inscription)n(t);return n(),n(`僭越 ${e.marks.僭越} · 因果 ${e.marks.因果} · 功德 ${e.marks.功德}`),n(`业障 ${e.marks.业障} · 藏拙 ${e.marks.藏拙} · 堕度 ${e.marks.堕度}`),n(`金手指：${e.goldFingers.length?e.goldFingers.join(`、`):`无`}`),n(),n(`世界种子 ${e.seed}`),t.push(`└`+`─`.repeat(60)+`┘`),t.join(`
`)}function xr(){return{version:1,entries:[],steleCount:0,daoFruit:0,unlockedSystems:[]}}function Sr(e){switch(e.tier){case`飞升`:return`飞升`;case`主宰`:return e.id===`plane_sovereign`?`主宰`:null;case`夭折`:return e.id===`possessed_by_demon`?`魔头`:`尸骸`;case`偏安`:return e.id.startsWith(`local_`)?`传承`:null;case`隐藏`:return e.id===`seclusion`?`隐世`:`飞升`}}function Cr(e,t){e.steleCount++,e.daoFruit+=t.daoFruit;let n=Sr(t.ending);if(!n)return null;let r={kind:n,id:t.stele.serial,daoName:t.actor.name,path:t.actor.path,tier:t.actor.tier,realm:t.stele.finalRealm,inscription:t.stele.inscription,signature:t.signature,place:t.place,relics:t.relics,unfinished:t.unfinished,seed:t.stele.seed,atYear:t.stele.createdAtYear,steleGrade:t.stele.grade};return e.entries.push(r),r}function wr(e,t){return e.entries.filter(e=>(e.kind===`飞升`||e.kind===`隐世`)&&e.tier<=t)}function Tr(e){return e.entries.filter(e=>e.kind===`魔头`||e.kind===`主宰`)}function Er(e){return e.entries.filter(e=>e.kind===`尸骸`&&e.relics.length>0)}function Dr(e){return e.entries.filter(e=>e.kind===`传承`)}function Or(e){switch(e.kind){case`飞升`:return`一缕残魂自称「${e.daoName}」，说他当年也是从这座山走出去的。\n  「${e.signature}」`;case`主宰`:return`${e.place}的主宰之位上坐着「${e.daoName}」，${e.realm}。已在位 ${e.atYear} 年。`;case`魔头`:return`魔头「${e.daoName}」盘踞${e.place}，用的是一套你莫名眼熟的功法。\n  「${e.signature}」`;case`传承`:return`${e.place}有一处旧洞府，主人姓名已不可考，只留下几个字：「${e.signature}」`;case`尸骸`:return`${e.place}的乱石堆里有一具枯骨，手上戴着一枚储物戒。\n  戒中有：${e.relics.join(`、`)}`;case`隐世`:return`据说${e.place}深处住着一位散功的老者，从不见客。`}}var kr=[{m:`打坐吐纳`,label:`稳修`,hint:`不快不慢，不出错`},{m:`悟道`,label:`悟道`,hint:`慢，但根基更纯，圆满度更高`},{m:`历练突破`,label:`历练`,hint:`快，有伤病之险`},{m:`丹药速成`,label:`服丹`,hint:`最快，但积丹毒（丹毒过深会锁死上限）`}],Ar=`打坐吐纳`,jr=kr.map(e=>e.label);function Mr(e){return kr.find(t=>t.label===e)?.m}function Nr(e){let t=e??`打坐吐纳`;return kr.find(e=>e.m===t)?.label??t}function Pr(e,t){return e.talent.悟性>=60||t.has(`有所悟`)}function Fr(e){return $e(e).filter(e=>e.def.category===`丹药`&&e.def.consumable&&(e.def.use?.length??0)>0&&!e.stack.equipped).sort((e,t)=>e.def.value-t.def.value||(e.def.id<t.def.id?-1:1))[0]?.def.id??null}var Ir=[`&&`,`||`,`>=`,`<=`,`==`,`!=`,`>`,`<`,`!`,`+`,`-`,`*`,`/`],Lr=class extends Error{};function Rr(e){let t=[],n=0;for(;n<e.length;){let r=e[n];if(/\s/.test(r)){n++;continue}if(r===`(`){t.push({kind:`lparen`,value:r,pos:n++});continue}if(r===`)`){t.push({kind:`rparen`,value:r,pos:n++});continue}if(r===`,`){t.push({kind:`comma`,value:r,pos:n++});continue}if(r===`'`||r===`"`){let i=r,a=n+1,o=``;for(;a<e.length&&e[a]!==i;)o+=e[a++];if(a>=e.length)throw new Lr(`字符串未闭合 @${n}: ${e}`);t.push({kind:`str`,value:o,pos:n}),n=a+1;continue}if(/[0-9]/.test(r)){let r=``;for(;n<e.length&&/[0-9.]/.test(e[n]);)r+=e[n++];t.push({kind:`num`,value:r,pos:n});continue}let i=Ir.find(t=>e.startsWith(t,n));if(i){t.push({kind:`op`,value:i,pos:n}),n+=i.length;continue}if(/[\p{L}_]/u.test(r)){let r=``;for(;n<e.length&&/[\p{L}\p{N}_.]/u.test(e[n]);)r+=e[n++];t.push({kind:`ident`,value:r,pos:n});continue}throw new Lr(`无法识别的字符 '${r}' @${n}: ${e}`)}return t.push({kind:`eof`,value:``,pos:n}),t}var zr=class{toks;i=0;constructor(e){this.toks=Rr(e)}peek(){return this.toks[this.i]}next(){return this.toks[this.i++]}eat(e,t){let n=this.peek();if(n.kind!==e||t!==void 0&&n.value!==t)throw new Lr(`期望 ${t??e}，实际 '${n.value}' @${n.pos}`);return this.next()}parse(){let e=this.or();return this.eat(`eof`),e}or(){let e=this.and();for(;this.peek().value===`||`;)this.next(),e={t:`bin`,op:`||`,a:e,b:this.and()};return e}and(){let e=this.cmp();for(;this.peek().value===`&&`;)this.next(),e={t:`bin`,op:`&&`,a:e,b:this.cmp()};return e}cmp(){let e=this.add();for(;[`>`,`>=`,`<`,`<=`,`==`,`!=`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.add()};return e}add(){let e=this.mul();for(;[`+`,`-`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.mul()};return e}mul(){let e=this.unary();for(;[`*`,`/`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.unary()};return e}unary(){return[`!`,`-`].includes(this.peek().value)?{t:`un`,op:this.next().value,a:this.unary()}:this.primary()}primary(){let e=this.peek();if(e.kind===`lparen`){this.next();let e=this.or();return this.eat(`rparen`),e}if(e.kind===`num`)return this.next(),{t:`lit`,v:Number(e.value)};if(e.kind===`str`)return this.next(),{t:`lit`,v:e.value};if(e.kind===`ident`){if(this.next(),e.value===`true`)return{t:`lit`,v:!0};if(e.value===`false`)return{t:`lit`,v:!1};if(e.value===`null`)return{t:`lit`,v:null};if(this.peek().kind===`lparen`){this.next();let t=[];if(this.peek().kind!==`rparen`)for(t.push(this.or());this.peek().kind===`comma`;)this.next(),t.push(this.or());return this.eat(`rparen`),{t:`call`,name:e.value,args:t}}return{t:`path`,p:e.value}}throw new Lr(`意外的记号 '${e.value}' @${e.pos}`)}};function Br(e){return e!==null&&e!==!1&&e!==0&&e!==``}function Vr(e,t){switch(e.t){case`lit`:return e.v;case`path`:return t.get(e.p);case`call`:return t.call(e.name,e.args.map(e=>Vr(e,t)));case`un`:{let n=Vr(e.a,t);return e.op===`!`?!Br(n):-(Number(n)||0)}case`bin`:{if(e.op===`&&`)return Br(Vr(e.a,t))?Br(Vr(e.b,t)):!1;if(e.op===`||`)return Br(Vr(e.a,t))?!0:Br(Vr(e.b,t));let n=Vr(e.a,t),r=Vr(e.b,t);switch(e.op){case`==`:return n===r;case`!=`:return n!==r;case`>`:return Number(n)>Number(r);case`>=`:return Number(n)>=Number(r);case`<`:return Number(n)<Number(r);case`<=`:return Number(n)<=Number(r);case`+`:return typeof n==`string`||typeof r==`string`?String(n)+String(r):Number(n)+Number(r);case`-`:return Number(n)-Number(r);case`*`:return Number(n)*Number(r);case`/`:return Number(r)===0?0:Number(n)/Number(r);default:throw new Lr(`未知运算符 ${e.op}`)}}}}var Hr=new Map;function Ur(e){let t=Hr.get(e);if(t)return t;let n=new zr(e).parse();return Hr.set(e,n),n}function Wr(e,t){return Vr(Ur(e),t)}function Gr(e,t){return!e||e==="default"||Br(Wr(e,t))}var Kr=new Map,qr=0;function Jr(e){Kr.clear();for(let t of e)Kr.set(t.id,t);qr++}function Yr(e){return Kr.get(e)}function Xr(){return[...Kr.values()]}function Zr(){return qr}function Qr(e,t){let n=(e.sect?Kr.get(e.sect):void 0)?.growth?.[t];return typeof n==`number`&&Number.isFinite(n)&&n>0?n:1}function $r(e){let t={id:e.id,affinity:e.affinity??{},taboos:e.taboos??[],signatures:e.signatures??[]};return e.methods&&(t.methods=[...e.methods]),e.methodsAdd&&(t.methodsAdd=[...e.methodsAdd]),t}Object.keys(S);var ei={中州官道:`中州`};for(let e of gt)ei[e.name]=e.region;[...new Set(Object.values(ei))];function ti(e){let t=ei[e.location];if(t)return t;let n=[...e.flags].find(e=>e.startsWith(`出身·`))?.slice(3);return gt.find(e=>e.id===n)?.region??``}var ni={tier:e=>e.actor.tier,sublevel:e=>e.actor.sublevel,path:e=>e.actor.path,goldenCoreGrade:e=>e.actor.goldenCoreGrade,hiddenRealmCount:e=>e.actor.hiddenRealms.length,道心:e=>e.actor.道心,气运:e=>e.actor.气运,功德:e=>e.actor.功德,业障:e=>e.actor.业障,僭越:e=>e.actor.僭越,堕度:e=>e.actor.堕度,丹毒:e=>e.actor.丹毒,名望:e=>e.actor.名望,锋芒:e=>e.actor.锋芒,藏拙:e=>we(e.actor),"talent.root":e=>e.actor.talent.root,"talent.purity":e=>e.actor.talent.purity,"talent.悟性":e=>e.actor.talent.悟性,"talent.根骨":e=>e.actor.talent.根骨,"talent.神魂":e=>e.actor.talent.神魂,"factors.功法":e=>e.actor.factors.功法,"factors.法宝":e=>e.actor.factors.法宝,"factors.状态":e=>e.actor.factors.状态,"factors.灵宠":e=>e.actor.factors.灵宠,"factors.伙伴":e=>e.actor.factors.伙伴,"factors.道侣":e=>e.actor.factors.道侣,"factors.情报":e=>e.actor.factors.情报,"expose.金手指":e=>e.actor.secrets.金手指,"expose.残魂":e=>e.actor.secrets.残魂,"expose.真实修为":e=>e.actor.secrets.真实修为,"expose.身世":e=>e.actor.secrets.身世,"expose.杀过某人":e=>e.actor.secrets.杀过某人,origin:e=>e.actor.origin,originRevealed:e=>e.actor.originRevealed,originClues:e=>e.actor.originClues,year:e=>Math.floor(e.year),tick:e=>e.tick,age:e=>Math.floor(e.actor.ageMonths/12),lifespanLeft:e=>e.actor.lifespanYears-e.actor.ageMonths/12,location:e=>e.location,effectiveTier:e=>Ce(e.actor),daoPerfection:e=>Zt(e.actor),knowerCount:e=>e.knowers.length,maxExpose:e=>Math.max(...Object.values(e.actor.secrets))},ri={hasSystem:(e,[t])=>e.systems.includes(String(t)),hasAnySystem:e=>e.systems.length>0,hasSoul:(e,[t])=>e.actor.souls.some(e=>e.id===t&&!e.dissipated),soulFavor:(e,[t])=>e.actor.souls.find(e=>e.id===t)?.favor??0,soulPossession:(e,[t])=>e.actor.souls.find(e=>e.id===t)?.possession??0,flag:(e,[t])=>e.flags.has(String(t)),karmaWith:(e,[t])=>e.karmaLedger.filter(e=>!e.resolved&&e.target===t).reduce((e,t)=>e+t.polarity*t.weight,0),unresolvedEvil:e=>e.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,seen:(e,[t])=>e.eventHistory.has(String(t)),seenCount:(e,[t])=>e.eventCounts.get(String(t))??0,realmAtLeast:(e,[t])=>e.actor.tier>=Number(t),stage:e=>Vt(e.actor.sublevel),stance:e=>Nr(e.stance),knows:(e,[t])=>e.knowers.some(e=>e.npc===t),sect:e=>e.actor.sect??``,sectName:e=>e.actor.sect?Yr(e.actor.sect)?.name??``:``,region:e=>ti(e),faction:e=>e.actor.birthFaction?.faction??``,factionRelation:e=>e.actor.birthFaction?.relation??`无关`,openWindows:e=>e.karmaLedger.reduce((e,t)=>e+(!t.resolved&&t.hooks.some(e=>e.lethal)?t.unusedWindows.length:0),0),heaviestKarma:e=>e.karmaLedger.reduce((e,t)=>t.resolved?e:Math.max(e,t.weight),0),has:(e,[t,n])=>et(W(e.actor),String(t))>=(n===void 0?1:Number(n)),stones:e=>pt(W(e.actor)),bagFree:e=>Qe(W(e.actor)),equipped:(e,[t])=>$e(W(e.actor)).some(e=>e.stack.defId===String(t)&&!!e.stack.equipped),chance:(e,[t])=>e.rng.next()<Number(t),min:(e,t)=>Math.min(...t.map(Number)),max:(e,t)=>Math.max(...t.map(Number))};function ii(e){return{get(t){let n=ni[t];if(!n)throw new Lr(`未知的字段 '${t}'（不在 scope.ts 白名单内）`);return n(e)},call(t,n){let r=ri[t];if(!r)throw new Lr(`未知的函数 '${t}()'（不在 scope.ts 白名单内）`);return r(e,n)}}}Object.keys(ni),Object.keys(ri);var ai=[`凡品`,`灵品`,`宝品`,`仙品`,`秘藏`,`极品`],oi={凡品:620,灵品:280,宝品:82,仙品:16,秘藏:2,极品:.1},G={minTier:3,minLuck:45,luckCoef:8};function si(e,t=0){let n=F((e-50)/50,-1,1)+t;return{凡品:oi.凡品*(1-n*.45),灵品:oi.灵品*(1+n*.1),宝品:oi.宝品*(1+n*.85),仙品:oi.仙品*(1+n*1.9),秘藏:oi.秘藏*(1+n*3.2),极品:Math.max(0,oi.极品*(1+n*G.luckCoef))}}var ci={threshold:10,softStep:.09};function li(){return{pity:{},count:{},seenSecret:!1,supremeTaken:!1}}function ui(e,t){let n=W(e),r=[];if(t.stones&&t.stones>0){let e=pt(n);e<t.stones&&r.push({kind:`stones`,label:`下品灵石`,need:t.stones,have:e,text:`尚缺 ${t.stones-e} 块下品灵石`})}for(let[e,i]of t.consume??[]){let t=U(e),a=tt(n,e);a<i&&r.push({kind:`item`,label:t.name,need:i,have:a,text:`尚缺${t.name} ${i-a} 份`})}for(let e of t.hold??[]){let t=e.qty??1,i=e.anyOf.reduce((e,t)=>e+et(n,t),0);if(i<t){let n=e.anyOf.map(e=>U(e).name).join(`、`);r.push({kind:`hold`,label:e.label,need:t,have:i,text:`没有${e.label}（${n} 任一即可）`})}}return r}function di(e,t){let n=ui(e,t);if(n.length)return n;let r=W(e);t.stones&&t.stones>0&&ht(r,t.stones);for(let[e,n]of t.consume??[])rt(r,e,n);return[]}function fi(e){let t=[];e.stones&&t.push(`${e.stones} 下品灵石`);for(let[n,r]of e.consume??[])t.push(`${U(n).name}×${r}`);for(let n of e.hold??[])t.push(`须带${n.label}`);for(let n of e.effects??[])t.push(n);return t.join(` · `)||`无`}function pi(e,t,n){let r=[];return n.supremeTaken&&r.push(`此生已得过一件独一无二之物，天不予二`),e.tier<G.minTier&&r.push(`修为未至（须${G.minTier}阶以上）`),e.气运<G.minLuck&&r.push(`气运不足（须 ${G.minLuck} 以上）`),n.seenSecret||r.push(`尚未亲见过一件秘藏`),t.prizes.极品?.length||r.push(`${t.name}里没有这样的东西`),{ok:r.length===0,reasons:r}}function mi(e,t,n,r){let i=si(e.气运,r),a=pi(e,t,n).ok?ai:ai.filter(e=>e!==`极品`);return{list:a,weights:a.map(e=>e===`极品`?i.极品:Math.max(.01,i[e]))}}function hi(e,t,n,r){let i=r.pity[n.id]??0,a=(r.count[n.id]??0)+1;r.count[n.id]=a;let o=i*ci.softStep+(n.luckBonus??0),s=i>=ci.threshold,c;if(s){let n=si(t.气运,o);c=e.weighted([`宝品`,`仙品`,`秘藏`],[n.宝品,n.仙品,n.秘藏])}else{let{list:i,weights:a}=mi(t,n,r,o);c=e.weighted(i,a)}let l=n.prizes[c],u=ai.indexOf(c);for(;(!l||l.length===0)&&u>0;)u--,c=ai[u],l=n.prizes[c];if(!l||l.length===0)throw Error(`奖池「${n.id}」没有任何奖品`);let d=e.pick(l);return c===`秘藏`&&(r.seenSecret=!0),c===`极品`&&(r.supremeTaken=!0,r.seenSecret=!0),r.pity[n.id]=c===`凡品`||c===`灵品`?i+1:0,{prize:d,rarity:c,byPity:s,pityAfter:r.pity[n.id],count:a}}function gi(e,t,n){let{list:r,weights:i}=mi(e,t,n,(n.pity[t.id]??0)*ci.softStep+(t.luckBonus??0)),a=i.reduce((e,t)=>e+t,0),o={};for(let e of ai)o[e]=0;return r.forEach((e,t)=>{o[e]=(i[t]??0)/a}),o}function _i(e,t){return Math.max(0,ci.threshold-(t.pity[e.id]??0))}function K(e,t,n,r){return{id:e,rarity:`凡品`,name:t,desc:n,effects:r}}function vi(e){for(let t of Object.keys(e))for(let n of e[t])n.rarity=t;return e}var yi={stones:10,effects:[`僭越 +1.5`]},bi={consume:[[`za_ganliang`,2]],hold:[{label:`护身之物`,anyOf:[`bao_yufu`,`bao_xuangui`,`bao_bihuo`,`fu_tishen`,`bao_qinglian`]},{label:`摸金的行当`,anyOf:[`bao_xunlong`,`za_ditu`,`fu_yinni`]}],effects:[`业障 +3`,`factors.状态 -0.05`,`僭越 +2`]};function xi(e){return{stones:e.has(`丹炉`)?0:40,consume:[[`cai_lingcao`,3]],effects:[`丹毒 +1`,`sublevel -0.004`]}}var Si=[{id:`oracle`,name:`问天签`,costLabel:fi(yi),prizes:vi({凡品:[K(`o_kong`,`空签`,`签筒晃了半晌，落出一支无字的。卦师摊手：「天机不予。」`,[`道心 +1`]),K(`o_xiaocai`,`小财`,`「近日有小得。」三日后你在旧衣夹层里摸出四块灵石。`,[`give ls_xia 4`]),K(`o_pingan`,`平安签`,`「无事。」——这年头，无事就是好事。`,[`道心 +2`]),K(`o_zaqi`,`杂气`,`一缕说不清来路的灵气钻进经脉，不痛不痒。`,[`sublevel +0.008`])],灵品:[K(`o_zhiyin`,`指引`,`卦师在残图上圈了个方位：「往那边走，三日内。」图归你了。`,[`give za_ditu 1`]),K(`o_dingshen`,`定神`,`一句偈语落进心里，心浮气躁忽然平了。`,[`道心 +5`]),K(`o_qiyun`,`转运`,`「你近来该顺一顺了。」他把签折断，扔进火里。`,[`气运 +3`]),K(`o_canfang`,`残方`,`半张丹方，字迹被水泡过 —— 他顺手抓了几株对得上的草给你。`,[`give cai_lingcao 3`,`悟性 +1`])],宝品:[K(`o_jinjue`,`进境`,`一句话点破你卡了半年的关窍。`,[`sublevel +0.06`,`悟性 +2`]),K(`o_baoqi`,`宝器缘`,`「西市第三家当铺，去问死当的架子。」你去了，青锋剑就挂在那儿。`,[`give bao_qingfeng 1`]),K(`o_guiren`,`贵人`,`他给了你一个名字。那人后来帮了你一次大忙。`,[`factors.情报 +0.1`,`名望 +8`]),K(`o_bimo`,`护身`,`「去城南铁铺报我的名字。」那副玄龟甲他压了三年没卖出去。`,[`give bao_xuangui 1`])],仙品:[K(`o_tianji`,`窥天机`,`卦师脸色变了。他说的每一个字，往后十年都应验了。`,[`气运 +8`,`factors.情报 +0.15`,`僭越 +6`]),K(`o_gufa`,`古法`,`签上浮出一段古文，他照着抄了一本给你 —— 早已失传的行气法。`,[`give gf_qingmu 1`,`悟性 +2`]),K(`o_yuanshou`,`延寿`,`「你本该短命的。」他叹了口气，「现在不是了。」`,[`lifespan +12`])],秘藏:[K(`o_daoyun`,`道韵`,`那一瞬你听见了什么。醒来时，天光已亮，而你的道基变了。`,[`sublevel +0.15`,`道心 +10`,`悟性 +5`,`气运 +5`,`僭越 +12`])],极品:[K(`o_ji_wuzi`,`无字签`,`签筒底下压着一支从未有人抽出过的黑签。卦师看了很久，说：「这不是我给你的。」他咬破手指在签上写了个字，人就老了二十岁 —— 他把自己剩下的命数，换成了你的。`,[`气运 +14`,`道心 +8`,`悟性 +4`,`lifespan +120`,`业障 +30`,`僭越 +55`,`expose.身世 +10`,`flag 极品·无字签·欠卦师一条命`]),K(`o_ji_mengmei`,`蒙昧珠`,`「有人要我把这个交给你。」灰扑扑的一颗珠子，照不出人影。天机阁推演了三百年没找到它 —— 因为它生来就是让人推不出的。带着它，天看不见你；可你也从此看不清自己的命。`,[`give bao_mengmei 1`,`expose.真实修为 -25`,`expose.金手指 -20`,`expose.身世 -15`,`僭越 +35`,`气运 -6`,`flag 极品·蒙昧珠·天机阁索珠`])]})},{id:`relic`,name:`探古藏`,costLabel:fi(bi),luckBonus:.18,prizes:vi({凡品:[K(`r_kutu`,`枯土`,`挖开是一层灰。除了呛鼻子，什么也没有。`,[`factors.状态 -0.03`]),K(`r_suipian`,`碎片`,`一块认不出是什么的碎瓷，握在手里凉得反常。`,[`业障 +1`]),K(`r_jiugu`,`旧骨`,`一副蜷着的骸骨，手指还扣在石壁上。`,[`道心 -2`,`业障 +2`])],灵品:[K(`r_lingshi`,`灵石囊`,`一只烂了半边的储物袋，里面还剩十几块下品灵石。`,[`give ls_xia 15`]),K(`r_canjuan`,`残卷`,`半部吐纳诀，后面被人撕走了 —— 撕得很急。`,[`give gf_tuna 1`]),K(`r_yuping`,`玉瓶`,`瓶塞是蜡封的，里头两粒回气丹居然没化。`,[`give dan_huiqi 2`])],宝品:[K(`r_faqi`,`古法器`,`一柄制式古拙的飞剑，灵纹至今未断。`,[`give bao_lingwen 1`]),K(`r_zhenpan`,`阵盘`,`一只寻龙盘，针还活着，往灵气浓处偏。`,[`give bao_xunlong 1`]),K(`r_yiyan`,`遗言`,`石壁上刻着一段话。你看完，很久没说话。`,[`道心 +8`,`originClues +1`])],仙品:[K(`r_chuancheng`,`传承玉`,`玉里封着一段影像：一个人在演一门焚天的功法，从头到尾，一遍。`,[`give gf_liehuo 1`,`悟性 +3`,`expose.真实修为 +6`]),K(`r_bmqi`,`本命残器`,`前主人的本命青莲灯。它还认得主人的死法。`,[`give bao_qinglian 1`,`业障 +10`,`expose.真实修为 +8`])],秘藏:[K(`r_jinqi`,`禁器`,`赤霄宝剑。你不该拿的。但你拿了。`,[`give bao_chixiao 1`,`业障 +25`,`僭越 +20`,`expose.真实修为 +15`])],极品:[K(`r_ji_taia`,`太阿·断`,`棺里没有尸首，只有半柄剑，断口齐得像被一口咬下去。你握住的一刻，听见很远的地方有人叫了一声名字 —— 不是你的名字，是它上一任主人的。它斩过的最后一个人，就是那个人。`,[`give bao_taia 1`,`factors.功法 +0.05`,`lifespan -60`,`业障 +45`,`僭越 +40`,`expose.真实修为 +30`,`名望 +25`,`flag 极品·太阿·前主人的仇家仍在`]),K(`r_ji_jiezi`,`芥子壶`,`壶口三寸，探进神识却是一片天。壶里有座荒了三十年的园子，园子中央坐着一个人形的东西，背对着你 —— 前主人「养」的。它听见你进来了。`,[`give za_jiezihu 1`,`业障 +25`,`僭越 +25`,`道心 -6`,`flag 极品·芥子壶·园中人未死透`])]})},{id:`alchemy`,name:`开炉`,costLabel:fi(xi(new Set)),prizes:vi({凡品:[K(`a_zhalu`,`炸炉`,`砰的一声。你从灰里爬出来，眉毛少了半边。`,[`factors.状态 -0.08`,`道心 -1`]),K(`a_feidan`,`废丹`,`成了，但是黑的。闻着像糊掉的药渣 —— 敢不敢吃是你的事。`,[`give dan_jia 1`]),K(`a_cidan`,`次丹`,`勉强能吃。药性冲，但确实是丹。`,[`give dan_huiqi 1`])],灵品:[K(`a_juqi`,`聚气散`,`成色一般，好在够用。`,[`give dan_juqi 1`]),K(`a_liaoshang`,`疗伤丹`,`一炉出了两粒，收口比预想的干净。`,[`give dan_liaoshang 2`]),K(`a_ningshen`,`凝神丹`,`开盖时满室清苦气。用来画符或者认人正好。`,[`give dan_ningshen 1`])],宝品:[K(`a_zhuji`,`筑基丹`,`丹成三转，纹路清晰。这一炉值了。`,[`give dan_zhuji 1`]),K(`a_xisui`,`洗髓丹`,`丹色青白。传闻服下三日排黑汗，根骨是真换。`,[`give dan_xisui 1`]),K(`a_qingdu`,`解毒丹`,`两粒解毒丹 —— 专拔积在经脉里的药渣。`,[`give dan_jiedu 2`])],仙品:[K(`a_jinyuan`,`金元丹`,`丹成有纹。开炉那一刻，天上像有什么东西低头看了你一眼。`,[`give dan_jinyuan 1`,`僭越 +3`]),K(`a_jiuzhuan`,`九转还魂`,`丹上有九道纹。老一辈说，这种丹能从阎王手里抢人。`,[`give dan_jiuzhuan 1`])],秘藏:[K(`a_zaohua`,`造化一炉`,`开炉那日天有异象。丹成之时，满室药香三日不散 —— 而且是一炉双成。`,[`give dan_jiuzhuan 1`,`give dan_xisui 2`,`悟性 +3`,`气运 +5`,`僭越 +10`])],极品:[K(`a_ji_zijin`,`九转紫金丹`,`丹上九道纹，纹里有紫气自己在走。药王谷的老人说这一炉三千年只成过两粒，另一粒是给天子送葬用的。药香飘了三日，方圆百里但凡有鼻子的都闻见了。`,[`give dan_zijin 1`,`僭越 +30`,`业障 +10`,`expose.真实修为 +25`,`名望 +30`,`flag 极品·紫金丹·药香引客`]),K(`a_ji_danying`,`炉中婴`,`丹没成，成了别的。开盖时它坐在炉底，像睡着了，睁眼先看的是你。它认你 —— 而认主这件事，从来是双向的。`,[`give bao_danying 1`,`神魂 +4`,`lifespan -40`,`道心 -8`,`业障 +20`,`僭越 +25`,`flag 极品·炉中婴·立春索血`])]})}],Ci={oracle:{cond:e=>e>=1,cost:()=>yi,hint:`坊市街口的卦摊，一卦十块下品灵石。问得多了，天也会烦。`},relic:{cond:e=>e>=2,cost:()=>bi,hint:`荒山野岭的旧坟古洞。带够口粮、护身与摸金的行当再进去 —— 前人的东西好拿，前人的账也跟着来。`},alchemy:{cond:e=>e>=2,cost:e=>xi(e),hint:`自己开炉。药材真烧、炉子真要有 —— 没有自家炉子，就得掏钱借人家的丹房。`}},wi={在册:`开局·在册`,白身:`开局·白身`},Ti=`宗门弟子`,Ei={子弟:.9,旁支:.6,质子:.9,仇家:0,弃徒:0,无关:0},Di=null,Oi=-1;function ki(e){if(Di===null||Oi!==Zr()){Di=new Map;for(let e of Xr())Di.set(e.name,e.id);Oi=Zr()}return Di.get(e)}function Ai(e){let t=e.birthFaction?.faction;if(!t)return;let n=ki(t);if(n===void 0)return;let r=Yr(n);if(r&&r.path!==`散修`&&r.path===e.path)return n}function ji(e,t,n){if(n&&n.factions.length===0)return{standing:`白身`};let r=Ai(t);if(r===void 0)return{standing:`白身`};let i=Ei[t.birthFaction?.relation??`无关`]??0;return i<=0||!e.chance(i)?{standing:`白身`}:{standing:`在册`,sect:r}}function Mi(e,t){e.flags.add(wi[t.standing]),t.sect&&(e.actor.sect=t.sect,e.flags.add(`门派·${t.sect}`)),Ni(e)}function Ni(e){e.actor.sect||e.flags.has(`已建宗`)?e.flags.add(Ti):e.flags.delete(Ti)}function Pi(e){return!!e.actor.sect||e.flags.has(`已建宗`)}function Fi(e){return e.flags.has(wi.白身)?!0:!e.flags.has(wi.在册)&&!e.actor.sect}function Ii(e){!e.flags.has(wi.在册)&&!e.flags.has(wi.白身)&&e.flags.add(e.actor.sect?wi.在册:wi.白身),Ni(e)}var q=class extends Error{},Li={道心:{get:e=>e.actor.道心,set:(e,t)=>{e.actor.道心=F(t,0,100)}},气运:{get:e=>e.actor.气运,set:(e,t)=>{e.actor.气运=F(t,0,100)}},功德:{get:e=>e.actor.功德,set:(e,t)=>{e.actor.功德=Math.max(0,t)}},业障:{get:e=>e.actor.业障,set:(e,t)=>{e.actor.业障=Math.max(0,t)}},僭越:{get:e=>e.actor.僭越,set:(e,t)=>{e.actor.僭越=Math.max(0,t)}},堕度:{get:e=>e.actor.堕度,set:(e,t)=>{e.actor.堕度=F(t,0,100)}},丹毒:{get:e=>e.actor.丹毒,set:(e,t)=>{e.actor.丹毒=F(t,0,100)}},名望:{get:e=>e.actor.名望,set:(e,t)=>{e.actor.名望=F(t,-100,1e3)}},锋芒:{get:e=>e.actor.锋芒,set:(e,t)=>{e.actor.锋芒=Math.max(0,t)}},sublevel:{get:e=>e.actor.sublevel,set:(e,t)=>{e.actor.sublevel=F(t,0,1)}},lifespan:{get:e=>e.actor.lifespanYears,set:(e,t)=>{e.actor.lifespanYears=Math.max(0,t)}},age:{get:e=>e.actor.ageMonths/12,set:(e,t)=>{e.actor.ageMonths=Math.max(0,t*12)}},originClues:{get:e=>e.actor.originClues,set:(e,t)=>{e.actor.originClues=Math.max(0,Math.floor(t))}},悟性:{get:e=>e.actor.talent.悟性,set:(e,t)=>{e.actor.talent.悟性=F(t,1,100)}},根骨:{get:e=>e.actor.talent.根骨,set:(e,t)=>{e.actor.talent.根骨=F(t,1,100)}},神魂:{get:e=>e.actor.talent.神魂,set:(e,t)=>{e.actor.talent.神魂=F(t,1,100)}},纯度:{get:e=>e.actor.talent.purity,set:(e,t)=>{e.actor.talent.purity=F(t,5,100)}}};for(let e of Object.keys(S))Li[`factors.${e}`]={get:t=>t.actor.factors[e],set:(t,n)=>{t.actor.factors[e]=F(n,S[e].min,S[e].max)}};for(let e of[`金手指`,`残魂`,`真实血脉`,`真实修为`,`杀过某人`,`身世`])Li[`expose.${e}`]={get:t=>t.actor.secrets[e],set:(t,n)=>{t.actor.secrets[e]=F(n,0,100)}};function J(e,t){let n=e.itemNotices??=[];n.push(t),n.length>64&&n.splice(0,n.length-64)}function Ri(e,t){if(e===void 0)return 1;let n=Number(e);if(!Number.isFinite(n)||!Number.isInteger(n)||n<=0)throw new q(`数量必须是正整数 '${e}'：${t}`);return n}function zi(e,t){let n,r;for(let i of e.slice(2)){let e=Re(i);if(e!==void 0){if(r!==void 0)throw new q(`成色只能写一个：${t}`);r=e;continue}if(!/^[+-]?\d+$/.test(i))throw new q(`give 的参数 '${i}' 既不是数量也不是成色（成色须为 ${Ae.join(`/`)}）：${t}`);if(n!==void 0)throw new q(`数量只能写一个：${t}`);n=Ri(i,t)}return{qty:n??1,quality:r}}function Bi(e,t,n,r){Y(n[1],r);let i=U(n[1]),a=W(e.actor);switch(t){case`give`:{let{qty:t,quality:o}=zi(n,r);if(o!==void 0&&R(i))throw new q(`'${i.name}' 不参与成色（灵石与独一件恒为本名）：${r}`);let s=nt(a,i.id,t,{quality:o,rng:e.rng});if(s.added>0&&J(e,`得${B(i,s.quality)}×${s.added}`),s.overflow>0){e.flags.add(`背包已满`);let t=it(a),n=t?`（最不值钱的是${t.def.name}，丢掉可腾一格）`:``;J(e,`${B(i,s.quality)}×${s.overflow} 没处放，只能留在原地 —— ${a.container}统共 ${Xe(a)} 格，已经装满${n}`)}else e.flags.delete(`背包已满`);return}case`take`:{let t=Ri(n[2],r);if(i.stone){let n=t*P[i.stone];ht(a,n)?J(e,`付了${n} 下品灵石`):J(e,`掏不出 ${n} 下品灵石（囊中只有 ${pt(a)}）`);return}let o=rt(a,i.id,t);o>0&&J(e,`失${i.name}×${o}`),o<t&&J(e,`${i.name}不够拿（要 ${t}，只有 ${o}；装备在身上的不算）`);return}case`useItem`:{let t=ot(e.actor,i.id);if(!t.ok){J(e,t.reason??`用不了${i.name}`);return}J(e,t.note??`用了${B(i,t.quality)}`);for(let n of t.effects)Vi(e,n);return}case`equip`:{let t=lt(e.actor,i.id);if(!t.ok){J(e,t.reason??`佩不上${i.name}`);return}let n=t.replaced?`，换下${H(t.replaced)?.name??t.replaced}`:``;J(e,`佩上${B(i,t.quality)}（${t.slot}位${n}）`),t.overTier&&(Vn(e),J(e,`${i.name}远超你此刻的境界 —— 拿出来用，等于自报家门`));return}case`unequip`:{let t=dt(e.actor,i.id);J(e,t.ok?`卸下${i.name}`:t.reason??`${i.name}不在身上`);return}}}function Vi(e,t){let n=t.trim();if(!n)return;let r=n.split(/\s+/),i=r[0];switch(i){case`flag`:Y(r[1],n),e.flags.add(r[1]),r[1]===`已建宗`&&Ni(e);return;case`unflag`:Y(r[1],n),e.flags.delete(r[1]),r[1]===`已建宗`&&Ni(e);return;case`move`:Y(r[1],n),e.location=r[1];return;case`set.path`:{Y(r[1],n);let t=r[1];if(!d.includes(t))throw new q(`未知的道途 '${t}'（须为八道途之一）：${n}`);e.actor.path=t;return}case`set.stance`:{Y(r[1],n);let t=Mr(r[1]);if(t===void 0)throw new q(`未知的修行之姿 '${r[1]}'（须为 ${jr.join(`/`)}）：${n}`);e.stance=t;return}case`bind.system`:{Y(r[1],n);let t=r[1];e.systems.includes(t)||e.systems.push(t);return}case`bind.soul`:{Y(r[1],n);let t=r[1];e.actor.souls.some(e=>e.id===t)||e.actor.souls.push({id:t,name:t,tier:Math.min(Number(r[2]??9),N.maxTier),favor:0,possession:0,dissipated:!1});return}case`devourSoul`:{Y(r[1],n);let t=An(e,r[1]);e.flags.add(t.ok?`吞魂成功_${r[1]}`:`吞魂失败_${r[1]}`);return}case`reincarnateSoul`:Y(r[1],n),jn(e,r[1]).ok&&e.flags.add(`送归转世_${r[1]}`);return;case`mergeSoul`:Y(r[1],n),Mn(e,r[1]).ok&&e.flags.add(`融合共生_${r[1]}`);return;case`witness`:{Y(r[1],n),Y(r[2],n);let t=r[2];if(!zn.includes(t))throw new q(`未知的秘密类型 '${r[2]}'：${n}`);Bn(e,t,8,r[1]);return}case`silence`:Y(r[1],n),Wn(e,r[1]);return;case`eraseMemory`:Y(r[1],n),Gn(e,r[1]);return;case`fakeDeath`:Kn(e);return;case`stepDown`:e.flags.add(`止步`);return;case`join.sect`:Y(r[1],n),Hi(e,r[1]);return;case`leave.sect`:Ui(e,`离派`);return;case`expel.sect`:Ui(e,`逐出`);return;case`settle`:{Y(r[1],n);let t=r[1];if(!Ki.includes(t))throw new q(`未知的了结方式 '${t}'：${n}`);let i=un(e,t);i&&e.flags.add(`已结·${i.type}`);return}case`give`:case`take`:case`useItem`:case`equip`:case`unequip`:Bi(e,i,r,n);return;case`draw`:{Y(r[1],n);let t=Si.find(e=>e.id===r[1]);if(!t)throw new q(`未知的奖池 '${r[1]}'：${n}`);let i=e.gacha??={pity:{},count:{}},a=hi(e.rng,e.actor,t,i);for(let t of a.prize.effects)Vi(e,t);e.flags.add(`机缘·${a.rarity}`),e.lastPrize=`${a.rarity}·${a.prize.name} —— ${a.prize.desc}`;return}}if(i.startsWith(`soul.`)){let t=i.split(`.`);if(t.length!==3)throw new q(`残魂效果格式应为 soul.<id>.<favor|possession>：${n}`);let[,a,o]=t,s=e.actor.souls.find(e=>e.id===a);if(!s)return;let c=Gi(r[1],n);if(o===`favor`)s.favor=F(s.favor+c,-100,100);else if(o===`possession`)s.possession=F(s.possession+c,0,100);else throw new q(`残魂无此字段 '${o}'：${n}`);return}let a=Li[i];if(!a)throw new q(`未知的效果目标 '${i}'（不在 effects.ts 白名单内）：${n}`);let o=r[1];if(o===void 0)throw new q(`缺少数值：${n}`);if(o.startsWith(`=`))a.set(e,Number(o.slice(1)));else{let t=Gi(o,n);if(t>0&&i.startsWith(`factors.`)){let n=Qr(e.actor,i.slice(8));n!==1&&(t=Math.round(t*n*1e6)/1e6)}a.set(e,a.get(e)+t)}}function Hi(e,t){let n=Yr(t);if(!n)throw new q(`未知的门派 id '${t}'（不在 content/sects 白名单内）：join.sect ${t}`);if(e.actor.sect===t||(e.actor.sect&&Ui(e,`离派`),e.actor.sect=t,e.flags.add(`门派·${t}`),e.flags.delete(`宗门·已除名`),e.flags.delete(`宗门·已离山`),e.flags.delete(`叛出宗门`),Ni(e),e.flags.has(`入派·${t}`)))return;e.flags.add(`入派·${t}`);let r=n.endowment;if(r){for(let t of r.items??[])Vi(e,`give ${t}`);typeof r.stones==`number`&&r.stones>0&&Vi(e,`give ls_xia ${Math.floor(r.stones)}`);for(let[t,n]of Object.entries(r.factors??{})){let r=Li[`factors.${t}`];r&&typeof n==`number`&&Number.isFinite(n)&&r.set(e,r.get(e)+n)}}}function Ui(e,t){let n=e.actor.sect;n&&(delete e.actor.sect,e.flags.delete(`门派·${n}`),e.flags.add(`${t}·${n}`),t===`离派`?e.flags.add(`宗门·已离山`):e.flags.add(`宗门·已除名`),Ni(e))}function Wi(e,t){for(let n of t??[])Vi(e,n)}function Y(e,t){if(!e)throw new q(`缺少参数：${t}`)}function Gi(e,t){if(e===void 0)throw new q(`缺少数值：${t}`);let n=Number(e);if(Number.isNaN(n))throw new q(`数值无法解析 '${e}'：${t}`);return n}var Ki=[`了结`,`补偿`,`化解`,`剪断`,`转嫁`],qi=[`flag`,`unflag`,`move`,`bind.system`,`bind.soul`,`devourSoul`,`reincarnateSoul`,`mergeSoul`,`silence`,`eraseMemory`,`draw`,`settle`,`join.sect`,`set.path`,`set.stance`],Ji=[`fakeDeath`,`stepDown`,`leave.sect`,`expel.sect`],Yi=[`give`,`take`,`useItem`,`equip`,`unequip`];[...Object.keys(Li),...qi,...Ji,...Yi];var Xi=[`宗门`,`市井`,`荒野`,`秘境`],Zi={same:2.5,other:.4,dwellMin:4,dwellMax:8,thinPool:6,legacyDwell:6},Qi={tianshu:`市井`,yaowang:`市井`,huoshan:`市井`,wangxiang:`市井`,fudao:`市井`,jianzhong:`荒野`,bingyuan:`荒野`,nanjiang:`荒野`,baigu:`荒野`,juelin:`荒野`},$i={外门:`宗门`,中州官道:`荒野`};for(let e of gt)$i[e.name]=Qi[e.id]??`市井`;function ea(e){return $i[e]??null}function ta(e){return e.has(`宗门弟子`)?`弟子`:`散修`}var na={弟子:{宗门:3,市井:1,荒野:1,秘境:.3},散修:{宗门:.3,市井:2.5,荒野:2,秘境:.5}};function ra(e,t){return e.has(`宗门弟子`)?`宗门`:ea(t)??Qi[[...e].find(e=>e.startsWith(`出身·`))?.slice(3)??``]??`市井`}function ia(e,t,n){return{setting:t,dwellLeft:e.int(Zi.dwellMin,Zi.dwellMax),loc:n}}function aa(e,t){return{setting:ra(e,t),dwellLeft:Zi.legacyDwell,loc:t}}function oa(e,t,n){t.shift={from:t.setting,to:n},t.setting=n,t.dwellLeft=e.rng.int(Zi.dwellMin,Zi.dwellMax)}function sa(e){let t=e.scene;if(t){if(t.loc!==e.location){t.loc=e.location;let n=ea(e.location);if(n&&n!==t.setting){oa(e,t,n);return}}if(t.dwellLeft<=0){let n=na[ta(e.flags)],r=Xi.filter(e=>e!==t.setting);oa(e,t,e.rng.weighted(r,r.map(e=>n[e])))}}}function ca(e,t){if(!e)return!1;let n=0;for(let r of t)r.setting===e.setting&&n++;return n<Zi.thinPool}function la(e,t,n){return!e||n||!t.setting?1:t.setting===e.setting?Zi.same:Zi.other}var ua=class extends Error{},da={termMin:.05,termMax:8,min:.1,max:6};function fa(e,t){let n=1;for(let r of t.tags??[]){let t=e.affinity[r];if(t!==void 0){if(t===0)return 0;n*=t}}return Math.min(da.max,Math.max(da.min,n))}var pa=/^(karma|effect|text):(.+)$/;function ma(e){let t=e.trim().split(/\s+/).filter(Boolean);if(t.length===0)throw new ua(`forbids 不能为空`);return t.map(e=>{let t=pa.exec(e);if(!t)throw new ua(`forbids 词项 '${e}' 不合法（须为 karma:/effect:/text: 开头）`);let n=t[1],r=t[2],i;n===`effect`&&(r.endsWith(`+`)||r.endsWith(`-`))&&(i=r.slice(-1),r=r.slice(0,-1));let a=r.split(`,`).map(e=>e.trim()).filter(Boolean);if(a.length===0)throw new ua(`forbids 词项 '${e}' 没有内容`);if(n===`effect`&&a.length!==1)throw new ua(`effect: 词项只接受一个目标（'${e}'）—— 多个目标写成多个词项`);return i?{kind:n,values:a,sign:i}:{kind:n,values:a}})}function ha(e){return[e.then,e.onCritSuccess,e.onSuccess,e.onFail,e.onCritFail]}function ga(e){let t=[],n=e=>{e&&e!==`none`&&t.push(e.type)};n(e.karma);for(let t of ha(e))n(t?.karma);return t}function _a(e){let t=[...e.effects??[]];for(let n of ha(e))t.push(...n?.effects??[]);return t}function va(e,t){switch(e.kind){case`karma`:{let n=ga(t);return e.values.some(e=>n.includes(e))}case`text`:return e.values.some(e=>t.text.includes(e));case`effect`:{let n=e.values[0];return _a(t).some(t=>{let r=t.trim().split(/\s+/);if(r[0]!==n)return!1;if(!e.sign)return!0;let i=r[1]??``;return e.sign===`+`?i.startsWith(`+`):i.startsWith(`-`)})}}}var ya=new Map;function ba(e,t){if(t.injectedBy)return null;for(let n of e.taboos){let e=ya.get(n.forbids);if(e||(e=ma(n.forbids),ya.set(n.forbids,e)),e.some(e=>va(e,t)))return n}return null}function xa(e,t){let n=t.tags??[];return!(!e.onTags?.some(e=>n.includes(e))||e.notTags?.some(e=>n.includes(e)))}var Sa=Object.keys(b);function Ca(e,...t){let n={id:e.id,affinity:{...e.affinity},taboos:[...e.taboos],signatures:[...e.signatures]};e.methods&&(n.methods=[...e.methods]);for(let e of t){n.id=`${n.id}·${e.id}`;for(let[t,r]of Object.entries(e.affinity)){let e=n.affinity[t];n.affinity[t]=r===0||e===0?0:(e??1)*r}if(n.taboos.push(...e.taboos),n.signatures.push(...e.signatures),e.methods){let t=new Set(e.methods);n.methods=(n.methods??Sa).filter(e=>t.has(e))}if(e.methodsAdd?.length){let t=new Set([...n.methods??Sa,...e.methodsAdd]);n.methods=Sa.filter(e=>t.has(e))}}return n}var wa=new Map;function Ta(e){let t=Ea[e.actor.path],n=e.actor.sect;if(!n)return t;let r=Yr(n);if(!r)return t;let i=`${e.actor.path}|${n}`,a=Zr(),o=wa.get(i);if(o&&o.v===a)return o.mod;let s=Ca(t,$r(r));return wa.set(i,{v:a,mod:s}),s}var Ea={正道:{id:`正道`,affinity:{宗门:1.6,同门:1.6,师承:1.5,任务:1.4,道德:1.25,人情:1.2,怪谈:.7,乱葬岗:.5,黑市:.4},taboos:[{rule:`不堕邪途`,forbids:`effect:堕度+ effect:devourSoul`,breakable:!0,penalty:[`道心 -6`,`名望 -10`]}],signatures:[{text:`亮出师门名帖`,onTags:[`冲突`,`对峙`,`敲诈`],require:`名望 >= 10`,karma:`none`,then:{text:`你不急不缓报上山门与师承。对面把你上下打量一遍，火气先矮了三分——名帖未必压得住事，但压得住场面。`,effects:[`名望 +2`]}},{text:`按门规办事`,onTags:[`道德`,`抉择`,`人际`],require:`道心 >= 40`,karma:`none`,then:{text:`规矩是死的，可正因为死，才没人能拿它做人情。你把门规一条条摆出来，事情反而简单了。`,effects:[`道心 +2`,`名望 +1`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`苦修锻体`,`借残魂指点`]},魔道:{id:`魔道`,affinity:{冲突:1.7,战争:1.6,对峙:1.5,危机:1.35,黑市:2,掠夺:1.8,暴露:1.2,道德:.6,宗门:.7,人情:.75},taboos:[],signatures:[{text:`一不做二不休，杀了夺了`,onTags:[`冲突`,`对峙`,`交易`],karma:{type:`杀戮`,target:`拦路之人`,weight:5,hooks:[{id:`sig_mo_shaduo`}]},check:{actor:`effectiveTier * 12 + 锋芒 * 2`,dc:`tier * 12 + 10`,scale:12},onSuccess:{text:`手起，事了。你把还温着的储物袋掂了掂，转身走进夜里——魔道的账，从来是这么算的。`,effects:[`业障 +8`,`堕度 +5`,`锋芒 +2`]},onFail:{text:`对方比看上去硬得多。你挨了一记，退进暗处，杀意露了个干净——这笔账记下了，两边都记下了。`,effects:[`factors.状态 -0.2`,`expose.真实修为 +6`]}},{text:`放出一缕煞气`,onTags:[`人际`,`市井`,`敲诈`,`对峙`],karma:`none`,then:{text:`你什么都没说，只把压着的那缕煞气松开半分。屋里霎时静了，有人后颈的汗毛立了起来。`,effects:[`锋芒 +1`,`expose.真实修为 +3`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`吞噬夺取`,`献祭`,`借残魂指点`]},鬼道:{id:`鬼道`,affinity:{怪谈:1.9,身后事:1.8,乱葬岗:2,残魂:1.5,因果:1.3,秘境:1.2,市井:.7,生计:.8,江湖:.85},taboos:[],signatures:[{text:`问问死人`,onTags:[`怪谈`,`身后事`,`因果`,`危机`],require:`talent.神魂 >= 30`,karma:`none`,then:{text:`你朝无人处偏了偏头，用只有亡者听得见的调子问了一句。回话的声音很轻，可死人不说谎。`,effects:[`factors.情报 +0.04`,`僭越 +1`]}},{text:`散一点阴气开路`,onTags:[`秘境`,`探索`,`危机`],karma:`none`,then:{text:`阴气贴着地皮漫出去，活物退避，机关噤声。你踩着那条被让出来的路往里走，只是身上又凉了几分。`,effects:[`factors.情报 +0.02`,`factors.状态 -0.03`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`吞噬夺取`,`献祭`,`借残魂指点`]},妖修:{id:`妖修`,affinity:{秘境:1.8,游历:1.7,奇遇:1.5,怪谈:1.35,机缘:1.2,宗门:.5,市井:.7,经营:.6,权柄:.6},taboos:[],signatures:[{text:`露半分真形`,onTags:[`冲突`,`对峙`,`危机`],karma:`none`,then:{text:`你由着那点压不住的东西从眼底透出来——瞳孔竖了一线，指节的轮廓变了变。对面看清了，也就懂了。`,effects:[`锋芒 +2`,`expose.真实血脉 +6`]}},{text:`托山野同类打听`,onTags:[`情报`,`江湖`,`游历`,`秘境`],karma:`none`,then:{text:`入夜你吹了个极轻的唿哨。天亮前，檐上的雀、墙根的鼠把各自见过的事凑成了一整件。`,effects:[`factors.情报 +0.05`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`双修`,`吞噬夺取`,`苦修锻体`,`借残魂指点`]},佛道:{id:`佛道`,affinity:{道德:1.7,因果:1.7,心魔:1.6,凡人:1.6,人间:1.5,道心:1.4,身后事:1.3,对峙:.7,冲突:.55,战争:.45,掠夺:.4,黑市:0},taboos:[{rule:`不杀生`,forbids:`karma:杀戮,灭门`,breakable:!0,penalty:[`道心 -10`,`业障 +15`]},{rule:`不妄语`,forbids:`karma:欺骗`,breakable:!0,penalty:[`道心 -5`,`业障 +6`]},{rule:`不噬魂`,forbids:`effect:devourSoul`,penalty:[`道心 -20`,`业障 +30`]}],signatures:[{text:`合十，诵一段往生咒`,onTags:[`身后事`,`怪谈`,`道德`],karma:`none`,then:{text:`你合十垂目，一字一句把咒诵完。风还是那阵风，可有什么东西松开了——地上的、以及你心里的。`,effects:[`功德 +2`,`道心 +2`]}},{text:`问他一句因果`,onTags:[`因果`,`抉择`,`人际`],require:`道心 >= 30`,karma:`none`,then:{text:`「这件事再往前数，因在何处？」你问得很轻。对方愣住，顺着这句话往回想，脸色一点点变了。`,effects:[`factors.情报 +0.03`,`功德 +1`]}}],methods:[`打坐吐纳`,`洞天闭关`,`悟道`,`历练突破`,`香火愿力`,`苦修锻体`]},儒道:{id:`儒道`,affinity:{权柄:1.8,名声:1.7,人际:1.5,势力:1.4,经营:1.35,人间:1.3,任务:1.2,怪谈:.7,秘境:.8,乱葬岗:.5},taboos:[{rule:`一诺千金`,forbids:`karma:毁诺`,breakable:!0,penalty:[`名望 -15`,`道心 -8`]}],signatures:[{text:`讲道理（言出法随）`,onTags:[`冲突`,`对峙`,`人际`,`权柄`],require:`名望 >= 15`,karma:`none`,check:{actor:`名望 * 0.6 + talent.悟性 * 0.6`,dc:`55`,scale:10},onSuccess:{text:`你一条一条讲下去，声气不高，字字却像钉进案上。说到末一句，满场没人接得上话——理在你这边，天地都听见了。`,effects:[`名望 +4`,`flag 言出法随`]},onFail:{text:`道理是好道理，只是对面不吃这一套。你话音未落就被人嗤笑着打断，脸上多少挂不住。`,effects:[`名望 -3`]}},{text:`秉笔直书`,onTags:[`因果`,`名声`,`权柄`,`道德`],karma:`none`,then:{text:`你研墨提笔，把这件事的来龙去脉一字不易地记下来。写的人多了会走样，但你这一笔，往后是查得到的。`,effects:[`名望 +2`,`factors.情报 +0.03`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`香火愿力`,`借残魂指点`]},武道:{id:`武道`,affinity:{武道:2.2,江湖:1.9,冲突:1.5,对峙:1.5,市井:1.25,生计:1.25,人情:1.2,丹道:.6,残魂:.7,心魔:.8},taboos:[],signatures:[{text:`以拳会友`,onTags:[`江湖`,`武道`,`冲突`,`市井`],karma:`none`,check:{actor:`talent.根骨 + 锋芒 * 4`,dc:`55`,scale:10},onSuccess:{text:`三招过后你收拳而立，对方甩了甩发麻的手腕，反倒笑了：「好拳。走，喝酒去。」武人的交情，就是这么打出来的。`,effects:[`名望 +3`,`factors.伙伴 +0.03`]},onFail:{text:`你接了他一记，虎口发麻，退了半步。输是输了，抱拳认下便是——江湖上输过的拳，比赢过的更记得住人。`,effects:[`factors.状态 -0.1`]}},{text:`递上一坛酒`,onTags:[`江湖`,`人际`,`人情`],karma:`none`,then:{text:`你把酒坛往桌上一放，拍开泥封。有些话喝到一半自然就说了，有些交情喝完这坛就算数了。`,effects:[`factors.伙伴 +0.04`]}}],methods:[`打坐吐纳`,`洞天闭关`,`悟道`,`历练突破`,`双修`,`苦修锻体`,`借残魂指点`]},散修:{id:`散修`,affinity:{坊市:1.8,交易:1.6,买卖:1.6,市井:1.5,奇遇:1.5,生计:1.4,机缘:1.35,游历:1.3,宗门:.35,同门:.4,师承:.4},taboos:[],signatures:[{text:`装成路过的野修`,onTags:[`危机`,`对峙`,`暴露`],karma:`none`,then:{text:`你把气息压到近乎凡人，眼神放空三分，活脱一个赶路赶得灰头土脸的散修。没人多看你第二眼——散修最大的本事，就是不起眼。`,effects:[`expose.真实修为 -3`]}},{text:`讨价还价`,onTags:[`交易`,`坊市`,`买卖`,`市井`],karma:`none`,check:{actor:`talent.悟性 + 名望 * 0.2`,dc:`45`,scale:10},onSuccess:{text:`你挑出货品三处不起眼的毛病，句句在行。摊主盯了你半晌，骂骂咧咧让了价——散修的每一枚灵石，都是这么抠出来的。`,effects:[`give ls_xia 10`]},onFail:{text:`摊主眼皮都没抬：「爱要不要。」你捏着钱袋站了片刻，终究没占到便宜。`,effects:[]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`吞噬夺取`,`献祭`,`苦修锻体`,`借残魂指点`]}},Da=`凡俗`,Oa=1,ka=10,Aa={境界:{kind:`境界`,offset:0,abs:null},下境:{kind:`境界`,offset:1,abs:null},上境:{kind:`境界`,offset:-1,abs:null},境界·期:{kind:`境界期`,offset:0,abs:null},结丹物:{kind:`结丹物`,offset:0,abs:null},道统:{kind:`道统`,offset:0,abs:null}};function ja(e){let t=Aa[e];if(t)return t;let n=/^境界([+\-=])(\d{1,2})$/.exec(e);if(!n)return null;let r=Number(n[2]);return n[1]===`=`?r>=Oa&&r<=ka?{kind:`境界`,offset:0,abs:r}:null:r<1||r>9?null:{kind:`境界`,offset:n[1]===`+`?r:-r,abs:null}}function Ma(e,t){return t<Oa?Da:Ft(e,Math.min(t,ka))}function Na(e,t,n,r=0){return e.kind===`道统`?t:e.kind===`结丹物`?Pt[t]??Pt.正道:e.kind===`境界期`?n<Oa?Da:Ht(t,n,r):Ma(t,e.abs??n+e.offset)}function Pa(e,t,n,r=0){return e.includes(`〔`)?e.replace(/〔([^〕〔]*)〕/g,(e,i)=>{let a=ja(i);return a?Na(a,t,n,r):e}):e}function Fa(e,t){return Pa(t,e.actor.path,e.actor.tier,e.actor.sublevel)}function Ia(e,t,n,r){if(t.location&&t.location!==r||t.mutexGroup&&e.flags.has(`互斥·${t.mutexGroup}`))return!1;let i=e.eventHistory.get(t.id);return i!==void 0&&(t.once||t.cooldown&&e.tick-i<t.cooldown)?!1:Gr(t.cond,n)}function La(e,t,n={}){let r=ii(e),i=Ta(e),a=n.location??e.location,o=[];for(let s of t.events.values())n.excludeTags?.length&&s.tags?.some(e=>n.excludeTags.includes(e))||fa(i,s)!==0&&Ia(e,s,r,a)&&o.push(s);return o}var Ra={window:80,floor:.06,countDecay:.2,countFloor:.02};function za(e,t){let n=e.eventCounts.get(t.id)??0;if(n===0)return 1;let r=e.eventHistory.get(t.id),i=r===void 0?Ra.window:e.tick-r,a=Math.min(1,Math.max(0,i/Ra.window));return(Ra.floor+(1-Ra.floor)*a)*Math.max(Ra.countFloor,Ra.countDecay**n)}function Ba(e,t,n={}){let r=Wa(e,t,n);if(r)return r;sa(e);let i=La(e,t,n);if(i.length===0)return null;let a=I(e.actor),o=Ta(e),s=e.scene,c=ca(s,i),l=i.map(t=>{let r=Math.max(.01,t.weight*(1+a*.25))*fa(o,t)*la(s,t,c);return n.noRepeatSuppression?r:r*za(e,t)}),u=e.rng.weighted(i,l);return s&&s.dwellLeft--,u}var Va={defaultAfter:[2,6],defaultPatience:12,maxQueue:16};function Ha(e,t,n){let r=e.sequels??=[];if(r.some(e=>e.event===n.event)||r.length>=Va.maxQueue)return!1;let[i,a]=n.after??Va.defaultAfter,o=Math.max(1,Math.floor(i)),s=Math.max(o,Math.floor(a)),c=e.tick+e.rng.int(o,s),l=Math.max(1,Math.floor(n.patience??Va.defaultPatience)),u={event:n.event,from:t,dueTick:c,expireTick:c+l};return n.cond&&(u.cond=n.cond),r.push(u),!0}function Ua(e,t,n,r){if(n)for(let i of Array.isArray(n)?n:[n])i?.event&&Ha(e,t,i)&&r.push(i.event)}function Wa(e,t,n={}){let r=e.sequels;if(!r||r.length===0)return null;for(let n=r.length-1;n>=0;n--){let i=r[n];(!t.events.has(i.event)||e.tick>i.expireTick)&&r.splice(n,1)}let i=ii(e),a=n.location??e.location,o=r.map((e,t)=>({s:e,i:t})).sort((e,t)=>e.s.dueTick-t.s.dueTick||e.i-t.i);for(let{s:n}of o){if(e.tick<n.dueTick)continue;let o=t.events.get(n.event);if(Ia(e,o,i,a)&&!(n.cond&&!Gr(n.cond,i)))return r.splice(r.indexOf(n),1),o}return null}function Ga(e,t){if(typeof t.text==`string`)return Fa(e,t.text);if(t.text.length===0)return``;let n=e.eventCounts.get(t.id)??0;return Fa(e,t.text[n%t.text.length])}var Ka=`〖破戒·`;function qa(e,t){return{...e,text:`${Ka}${t.rule}〗${e.text}`,tabooBreak:{rule:t.rule,penalty:t.penalty}}}function Ja(e,t){let n=ii(e),r=Ta(e),i=[],a=[];for(let e of t.choices){if(!Gr(e.require,n))continue;let t=ba(r,e);t?t.breakable?i.push(qa(e,t)):a.push({c:e,t}):i.push(e)}for(let e of r.signatures){if(!xa(e,t)||!Gr(e.require,n))continue;let{onTags:a,notTags:o,...s}=e;i.push({...s,injectedBy:r.id})}if(i.length===0)for(let{c:e,t}of a)i.push(qa(e,t));return i.map(t=>t.text.includes(`〔`)?{...t,text:Fa(e,t.text)}:t)}function Ya(e,t,n){return!n||n===`none`?null:hn(e,{type:n.type,source:t.id,actor:`player`,target:n.target,weight:n.weight,polarity:n.polarity??-1,matureWindow:n.matureWindow,hooks:n.hooks}).id}function Xa(e,t,n,r){if(!n)return{text:``,goto:null,karma:null};Wi(e,n.effects);let i=Ya(e,t,n.karma);return Ua(e,t.id,n.sequel,r),{text:n.text?Fa(e,n.text):``,goto:n.goto??null,karma:i}}function Za(e,t,n){e.eventHistory.set(t.id,e.tick),e.eventCounts.set(t.id,(e.eventCounts.get(t.id)??0)+1),t.mutexGroup&&e.flags.add(`互斥·${t.mutexGroup}`),n.tabooBreak&&(e.flags.add(`破戒·${n.tabooBreak.rule}`),Wi(e,n.tabooBreak.penalty));let r=Ya(e,t,n.karma),i=[];if(!n.check){Wi(e,n.effects);let a=Xa(e,t,n.then,i);return Ua(e,t.id,n.sequel,i),{outcome:null,text:a.text,goto:a.goto,karmaCreated:a.karma??r,planted:i}}Wi(e,n.effects);let a=ii(e),o=Number(Wr(n.check.actor,a)),s=Number(Wr(n.check.dc,a)),c=ye(e.rng,{power:o,dc:s,scale:n.check.scale,bonus:n.check.bonus},I(e.actor)),l=Xa(e,t,c===`CRIT_SUCCESS`?n.onCritSuccess??n.onSuccess:c===`SUCCESS`?n.onSuccess:c===`FAIL`?n.onFail:n.onCritFail??n.onFail,i);return Ua(e,t.id,n.sequel,i),{outcome:c,text:l.text,goto:l.goto,karmaCreated:l.karma??r,planted:i}}function Qa(e,t,n){if(!n)return null;let r=t.events.get(n);return!r||r.once&&e.eventHistory.has(r.id)?null:r}var $a={你:`亲历（你）`,我:`自述（我）`,他:`说书（道号）`};function eo(e,t,n=`他`){return t===`你`?e:e.split(`
...
`)}var to=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function X(e){if(e<10)return to[e];if(e<20)return`十${e%10?to[e%10]:``}`;if(e<100)return`${to[Math.floor(e/10)]}十${e%10?to[e%10]:``}`;if(e<1e3){let t=e%100;return`${to[Math.floor(e/100)]}百${t===0?``:t<10?`零${to[t]}`:X(t)}`}return String(e)}function no(e,t,n){if(e<2)return null;let r=Math.floor(e);return r<4?[`转过年去，又是一年。`,`两三年一晃而过。`,`此后两年，山中无事。`][r%3]:r<12?`此后${X(r)}年，无事。`:r<50?`一晃，便是${X(r)}年。`:t>=4?`这一坐，便是${X(r)}年。出关那日，${n}认得的凡人，坟头草都换了几茬。`:`${X(r)}年过去了。山下已经换了人间。`}var ro=new Set([`危机`,`冲突`,`战争`,`渡劫`,`心魔`,`怪谈`,`长期敌对`,`打脸`]),io=new Set([`日常`,`市井`,`人情`,`人间`,`江湖`,`修行`,`修炼`]);function ao(e){return e.some(e=>ro.has(e))?`tight`:e.some(e=>io.has(e))?`loose`:`neutral`}var oo=[`话音未落——`,`这事没完。`,`一波未平，一波又起。`,`事情赶着事情来。`],so=[`不过数日。`,`转过月来。`,`一晃，月余。`],co=e=>[`不过数日，你已到了${e}。`,`一路晓行夜宿，你到了${e}。`,`你离了旧处，落脚${e}。`],lo=[`转过年去。`,`一晃两年。`,`第二年上，诸事平平。`],uo=(e,t)=>[`第二年开春你离了${e}，一路到了${t}。`,`这两年你换了地方，如今落脚在${t}。`,`转过年去，你已在${t}住下。`];function fo(e,t,n){let r=[`此后${X(t)}年，无事。`,`一晃，便是${X(t)}年。`];return t>=12&&r.push(`${X(t)}年过去了。山下已经换了人间。`),t>=12&&n>=4&&r.push(`这一坐，便是${X(t)}年。出关那日，你认得的凡人，坟头草都换了几茬。`),e.pick(r)}var po=e=>[`再动身时，你已在${e}。`,`出来走动这一趟，你到了${e}。`],mo=[`这一日，祸事寻上门来。`,`麻烦找上门来，没有一点先兆。`,`这天夜里，有人寻到了你的门前。`],ho=[`日子照旧过。这天，有桩事寻到你面前。`,`这天，来了个不速之客。`],go=[`这天，有件事找到你头上。`,`又有一桩事，寻上门来。`],_o=[`这天夜里——`,`偏在这时，出了事。`,`变故来得没有一点声响。`],vo=[`闲事一桩，却也躲不开。`,`日子照旧过。这天，眼前起了点小波澜。`],yo=[`这天，出了件事。`,`这一日，眼前起了桩事。`,`该来的，总会来。`],bo=(e,t)=>t?[`你把手头的事一一了结，往${e}投师去。`,`收拾了行装，你往${e}拜山去。`]:[`你把手头的事一一了结，往${e}去。`,`收拾了行装，你径直往${e}去。`,`这一日，你动身往${e}去。`],xo=[`主意既定，这一日，你去办那件盘算已久的事。`,`这天，你把手头的事撂下，专程赴那一桩去。`,`心里那点念头搁了许久，这天，你终于动了身。`],So=[`你把手头的事一一了结，收拾行装，投师去。`,`这一日，你打定了拜师的主意，动身去了。`],Co=new Set([`拜山`,`入门考核`]),wo={"宗门→市井·弟子":[`这日你告了假，下山去。`,`山上的事撂下几日不妨。你换了身布衣，下山入市。`],"宗门→市井":[`你辞了山门里的住处，往人烟稠处去。`],"荒野→市井":[`风餐露宿的日子过够了。你寻了处人烟落脚，先吃上一顿热的。`,`出了山野见着炊烟，你脚步不由得快了几分。`],"秘境→市井":[`从那处非常之地脱身出来，你径直寻了人间烟火，好稳一稳心神。`],"宗门→荒野·弟子":[`宗门的事告一段落，你出了山门，拣人烟稀处行去。`,`你领了外出历练的差事，背上行囊出了山门。`],"宗门→荒野":[`你离了山门，重新上路。`],"市井→荒野":[`城里的事了了。你出了城门，前头是长长的山道。`,`你结了店钱，把行囊背上 —— 又是晓行夜宿的日子。`],"秘境→荒野":[`离了那处秘地，眼前又是荒岭长路。`],"市井→宗门·弟子":[`盘缠见底，你回了山上。`,`外头的日子过完了，你回山销假。`],"市井→宗门":[`你与山门中人有了往来，这一日随他们上了山，权且住下。`],"荒野→宗门·弟子":[`在外奔波了这些时日，你回了山门。蒲团还是原来那只。`,`你风尘仆仆地回山复命。`],"荒野→宗门":[`路过一处山门，你被留了下来，小住些时日。`],"秘境→宗门·弟子":[`从秘地出来，你回山复命。`],"秘境→宗门":[`从秘地出来，你寻了熟识的山门落脚。`],"宗门→秘境·弟子":[`你领了探察的差事，出山门往那处秘地去。`],"宗门→秘境":[`你得了一处秘地的消息，动身寻了过去。`],"市井→秘境":[`坊间得来的那点消息终究按捺不住，你收拾行装，往那处秘地寻去。`],"荒野→秘境":[`山行途中你察觉此地有异，索性循着那点异样深入进去。`]},To=[`你换了个地方，也换了种过法。`];function Eo(e,t){let n=`${t.from}→${t.to}`,r=(t.disciple?wo[`${n}·弟子`]:void 0)??wo[n]??To;return e.pick(r)}var Do=e=>[`落脚在${e}。`,`这一程的尽头是${e}。`],Oo=[`丹田里那点东西，再也压不住了。`,`气机满盈，关口就在眼前。`,`这一夜，周天转到极处——关口到了。`];function ko(e,t){if(t.chained)return e.pick(oo);let n=t.from!==t.to,r=Math.floor(Math.max(0,t.gapYears)),i=t.premise===`起意`&&t.nextKind===`event`,a;t.sceneShift?(a=Eo(e,t.sceneShift),n&&!i&&(a+=e.pick(Do(t.to)))):i?a=t.gapYears<1?e.pick(so):r<=3?e.pick(lo):fo(e,r,t.tier):t.gapYears<1?a=n?e.pick(co(t.to)):e.pick(so):r<=3?a=n?e.pick(uo(t.from,t.to)):e.pick(lo):(a=fo(e,r,t.tier),n&&(a+=e.pick(po(t.to))));let o=ao(t.nextTags),s=t.premise===`上门`,c=t.nextTags.some(e=>Co.has(e)),l=t.nextKind===`breakthrough`?e.pick(Oo):i?n?e.pick(bo(t.to,c)):e.pick(c?So:xo):o===`tight`?e.pick(s?mo:_o):o===`loose`?e.pick(s?ho:vo):e.pick(s?go:yo);return`${a}${l}`}function Ao(e,t){return eo(e,`他`,t)}var jo=3;function Mo(e){let t=[],n={title:`起于微末`,beats:[]};for(let r of e){let e=r.isMajor&&(r.kind===`scene`||r.kind===`milestone`);e&&n.beats.length>=jo?(t.push(n),n={title:r.title??r.text.slice(0,12),beats:[r]}):(e&&n.beats.length<jo&&r.title&&(n.title=n.beats.length===0?r.title??n.title:`${n.title} · ${r.title}`),n.beats.push(r))}return n.beats.length&&t.push(n),t}function No(e,t,n){let r=e.text.trim();if(!r)return null;switch(e.kind){case`scene`:return eo(r,t,n);case`choice`:return r.startsWith(`「`)?r.replace(/^「【[^】]*】/,`「`):`—— ${eo(r,t,t===`我`?`我`:`他`)}`;case`outcome`:case`notice`:return eo(r,t,t===`我`?`我`:`他`);case`transition`:return eo(r,t,n);case`milestone`:return`是年，${eo(r,t,n)}${/[。！？」]$/.test(r)?``:`。`}`}}function Po(e){let t=new Set,n=[],r=!1;for(let i=0;i<e.length;i++){let a=e[i];if(a.kind===`transition`){let o=e[i+1];if(o&&o.kind===`scene`&&o.evId&&t.has(o.evId)&&!o.isMajor)continue;r=!1,n.push(a);continue}if(a.kind===`scene`){if(a.evId&&t.has(a.evId)&&!a.isMajor){r=!0;continue}a.evId&&t.add(a.evId),r=!1,n.push(a);continue}(a.kind===`choice`||a.kind===`outcome`)&&r||((a.kind===`milestone`||a.kind===`notice`)&&(r=!1),n.push(a))}return n}function Fo(e){let{daoName:t,chronicle:n,stele:r}=e,i=e.pov??`他`,a=[];a.push(`# 藏锋录 · ${t}${i===`我`?`自述`:`卷`}`),a.push(``),a.push(`> ${e.signature}`),a.push(`>`),a.push(`> —— ${t}${n.origin!==`凡俗`&&n.ending.tier!==`夭折`?`，${n.origin}`:``}，寿${X(n.lifespan)}载`),a.push(``);let o=Mo(Po(e.beats)),s=null,c=null,l=i===`我`?`我`:t;if(o.forEach((e,n)=>{a.push(`## 第${X(n+1)}回 · ${e.title}`),a.push(``);for(let n of e.beats){if(s!==null&&n.kind===`scene`&&c!==`transition`){let e=no(n.year-s,n.tier,l);e&&(a.push(e),a.push(``))}let e=No(n,i,t);e&&(a.push(e),a.push(``)),s=n.year,c=n.kind}}),a.push(`## 终 · ${n.ending.name}`),a.push(``),i===`我`&&(a.push(`*（自述至此而止。以下数页为后人所补。）*`),a.push(``)),a.push(Ao(n.ending.text,t)),a.push(``),n.deathChain){a.push(`后来有人翻起这段公案，把前因后果排了出来：`),a.push(``);for(let e of n.deathChain.split(`
...
`))a.push(`> ${e}`);if(a.push(``),n.people.length){a.push(`### 书中诸人，后来`),a.push(``);for(let e of n.people.slice(0,8))a.push(`**${e.name}**（${Ao(e.relation,t)}）`),a.push(``),a.push(Ao(e.afterward,t)),a.push(``)}if(n.unfinished.length){a.push(`### 未了之事`),a.push(``);for(let e of n.unfinished)a.push(`- ${e}`);a.push(``),a.push(`（这些账没有随他入土。它们还在世上走动，等下一个人。）`),a.push(``)}return a.push(`### 碑拓`),a.push(``),a.push("```"),a.push(br(r)),a.push("```"),a.push(``),a.push(`*此书由一局真实的推演自动写成。世界种子 \`${e.seed}\` —— 持此种子者，可入同一世界，另写一卷。*`),a.push(``),a.join(`
`)}function Io(e){return e.replace(/[#>*`\-\s]/g,``).length}function Lo(e){return[...e.effects??[],...e.onCritSuccess?.effects??[],...e.onSuccess?.effects??[],...e.onFail?.effects??[],...e.onCritFail?.effects??[]]}function Ro(e,t){let n=[],r=new Set,i=(e,t)=>{r.has(e)||(r.add(e),n.push({text:e,level:t}))};e.tags?.includes(`岔路`)&&i(`人生岔路 · 落子无悔`,`grave`);let a=t.karma;a&&a!==`none`&&(a.hooks?.some(e=>e.lethal)?i(`或招杀身之祸`,`grave`):a.weight>=40&&i(`结下重因果`,`warn`));for(let e of Lo(t)){let t=e.trim();t.startsWith(`fakeDeath`)?i(`假死脱身 · 尽弃身份人脉`,`grave`):t.startsWith(`stepDown`)?i(`就此止步 · 不再求进`,`grave`):t.startsWith(`devourSoul`)?i(`反吞残魂 · 败则身死`,`grave`):t.startsWith(`mergeSoul`)?i(`魂魄相融 · 不可分离`,`grave`):t.startsWith(`silence`)?i(`灭口 · 业障加身`,`grave`):t.startsWith(`bind.soul`)&&i(`引魂入体 · 祸福难料`,`warn`);let n=/^堕度 \+(\d+(?:\.\d+)?)/.exec(t);n&&Number(n[1])>=8&&i(`堕入邪道`,`grave`),n=/^lifespan -(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=5&&i(`折寿${n[1]}载`,`grave`),n=/^僭越 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=8&&i(`僭越大增 · 天道侧目`,`warn`),n=/^业障 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=20&&i(`业障深重`,`warn`),n=/^expose\.[^ ]+ \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=15&&i(`大损隐秘`,`warn`)}return n}function zo(e,t){return Ro(e,t).some(e=>e.level===`grave`)}function Bo(e,t){let n={player:[],auto:[],loose:[],transition:null,nextScene:null},r=new Map,i=[];for(let t of e){if(t.episodeId==null){n.loose.push(t);continue}let e=r.get(t.episodeId);if(e)e.beats.push(t);else{let e={episodeId:t.episodeId,auto:!!t.auto,beats:[t]};r.set(t.episodeId,e),i.push(e)}}for(let e of i){let t=e.beats.length===1?e.beats[0]:null;if(t?.kind===`transition`){n.transition&&n.loose.push(n.transition),n.transition=t;continue}(e.auto?n.auto:n.player).push(e)}let a=n.player[n.player.length-1];return t&&a&&a.beats.every(e=>e.kind===`scene`)&&a.beats[0].evId===t&&(n.nextScene=a,n.player.pop()),n}var Vo={外门:{monthly:2,dutyEvery:3,patience:5,duty:`劈柴挑水，兼扫丹房`},内门:{monthly:10,dutyEvery:4,patience:6,duty:`守山门，轮值三班`},真传:{monthly:30,dutyEvery:5,patience:6,duty:`代师授业，兼查外门功课`},执事:{monthly:60,dutyEvery:5,patience:7,duty:`押粮、点卯、断门内的官司`},长老:{monthly:140,dutyEvery:6,patience:8,duty:`坐镇一堂，议事时须到`},掌门:{monthly:180,dutyEvery:7,patience:8,duty:`山门岁供进账，也轮到你发别人的俸`}},Ho=[`外门`,`内门`,`真传`,`执事`,`长老`],Z={paidMonthsCap:24,payEveryMonths:12,dutyCost:.004,meritMin:-60,meritMax:60,suspendAt:3,suspendTicks:4,dismissAt:6,arrearsMonthsCap:36,backPayMonths:36},Uo={1:10,2:80,3:500,4:2500,5:9e3,6:2e4,7:4e4,8:7e4,9:12e4};function Wo(){return{merit:0,promotions:0,accruedMonths:0,arrears:0,dutyLeft:0,missed:0,suspended:0,paidTotal:0}}var Go=class e{ctx;db;registry;seed;maxTicks;birthYear=16;milestones=[];curve=[];notices=[];beats=[];pendingEvent=null;pendingBreakthrough=null;chainDepth=0;episodeSeq=1;currentEpisode=0;pageYear;pageLocation;breakthroughCooldown=0;death=null;steppedDown=!1;failedBranch=null;finished=null;lastTags=[];get stance(){return this.ctx.stance??`打坐吐纳`}set stance(e){this.ctx.stance=e}lastOutcome=null;lastDeltas=[];lastBreakthrough=null;signInYear=-1;stipend=Wo();lastRank=null;get gacha(){return this.ctx.gacha}set gacha(e){this.ctx.gacha=e}autoResolveMinor=!0;flushItemNotices(){let e=this.ctx.itemNotices;if(!(!e||e.length===0)){for(let t of e)this.note(t);e.length=0}}upkeepStance(){let{ctx:e}=this,t=this.stance,n=b[t];if(`needsInsight`in n&&!Pr(e.actor,e.flags))return this.stanceFallbackNote(`姿·无悟已述`,`心中无所悟，枯坐也参不出道。你回到蒲团上，从吐纳做起。`),Ar;if(`toxin`in n){let t=Fr(W(e.actor));if(!t)return this.stanceFallbackNote(`姿·丹尽已述`,`丹尽了。你回到蒲团上，从吐纳做起。`),Ar;let n=ot(e.actor,t);if(n.ok)for(let t of n.effects)Vi(e,t)}return t}stanceFallbackNote(e,t){this.ctx.flags.has(e)||(this.ctx.flags.add(e),this.note(t))}noticeOnly(e){this.notices.push(e),this.notices.length>64&&this.notices.splice(0,this.notices.length-64)}note(e,t=`notice`){this.notices.push(e),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:t,text:e})}newEpisode(){return this.episodeSeq++}pushTransition(e,t,n=!1,r){let i=this.ctx.scene,a=!n&&i?.shift?i.shift:void 0;a&&i&&delete i.shift;let o=ko(this.ctx.rng,{gapYears:this.ctx.year-this.pageYear,from:this.pageLocation,to:this.ctx.location,nextTags:e,tier:this.ctx.actor.tier,nextKind:t,chained:n,premise:r,sceneShift:a?{...a,disciple:Pi(this.ctx)}:void 0});this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`transition`,text:o,episodeId:this.newEpisode()}),this.pageYear=this.ctx.year,this.pageLocation=this.ctx.location}constructor(e){let t=new o(e.seed);if(this.seed=e.seed,this.db=e.db,this.registry=e.registry,this.maxTicks=e.maxTicks??500,e.restore){let t=structuredClone(e.restore);if(t.pendingEventId&&!e.db.events.has(t.pendingEventId))throw Error(`快照中的事件「${t.pendingEventId}」已不存在（内容已更新）`);this.ctx={rng:o.restore(t.rng),year:t.year,tick:t.tick,actor:t.actor,karmaLedger:t.karmaLedger,log:[],flags:new Set(t.flags),systems:t.systems,eventHistory:new Map(t.eventHistory),eventCounts:new Map(t.eventCounts),sequels:t.sequels??[],location:t.location,knowers:t.knowers,gacha:t.gacha??li()},Ii(this.ctx),this.ctx.scene=t.scene??aa(this.ctx.flags,this.ctx.location),this.milestones.push(...t.milestones),this.curve.push(...t.curve),this.beats.push(...t.beats),this.notices.push(...t.notices),this.pendingEvent=t.pendingEventId?e.db.events.get(t.pendingEventId):null,this.pendingBreakthrough=t.pendingBreakthrough??null,this.chainDepth=t.chainDepth,this.breakthroughCooldown=t.breakthroughCooldown,this.lastTags=t.lastTags,this.stance=t.stance??`打坐吐纳`,this.signInYear=t.signInYear??-1,this.autoResolveMinor=!0,this.stipend=t.stipend??Wo(),this.episodeSeq=t.episodeSeq??t.beats.reduce((e,t)=>Math.max(e,t.episodeId??0),0)+1,this.currentEpisode=t.currentEpisode??0,this.pageYear=t.pageYear??t.year,this.pageLocation=t.pageLocation??t.location,this.lastRank=t.lastRank===void 0?this.sectRank():t.lastRank,this.backfillKit(t);return}let n=e.birthplace??t.pick(gt),r=Mt(t,{birthplace:n,name:e.name??`无名`});this.ctx={rng:t,year:this.birthYear,tick:0,actor:r,karmaLedger:[],log:[],flags:new Set,systems:[],eventHistory:new Map,eventCounts:new Map,sequels:[],location:n.name,knowers:[],gacha:li()},this.pageYear=this.birthYear,this.pageLocation=n.name,this.ctx.flags.add(`出身·${n.id}`),this.ctx.flags.add(`道统·${r.path}`),Mi(this.ctx,ji(t,r,n));let i=r.sect?Yr(r.sect)?.name??r.sect:``;this.milestones.push({year:this.birthYear,kind:`出生`,text:i?`生于${n.name}，${r.talent.root}；自幼挂在${i}名下`:`生于${n.name}，${r.talent.root}`}),this.ctx.scene=ia(t,ra(this.ctx.flags,this.ctx.location),this.ctx.location),In(this.ctx);let a=e.db.events.get(`evt_prologue_${n.id}`);a&&(this.pendingEvent=a,this.currentEpisode=this.newEpisode(),this.beats.push({year:this.birthYear,tier:1,kind:`scene`,text:Ga(this.ctx,a),evId:a.id,title:a.title,isMajor:!0,episodeId:this.currentEpisode}))}snapshot(){return this.finished||!this.ctx.actor.alive?null:structuredClone({v:1,seed:this.seed,name:this.ctx.actor.name,rng:this.ctx.rng.snapshot(),year:this.ctx.year,tick:this.ctx.tick,actor:this.ctx.actor,karmaLedger:this.ctx.karmaLedger,flags:[...this.ctx.flags],systems:this.ctx.systems,eventHistory:[...this.ctx.eventHistory.entries()],eventCounts:[...this.ctx.eventCounts.entries()],sequels:this.ctx.sequels??[],location:this.ctx.location,knowers:this.ctx.knowers,scene:this.ctx.scene,milestones:this.milestones,curve:this.curve,beats:this.beats,notices:[...this.notices],pendingEventId:this.pendingEvent?.id??null,pendingBreakthrough:this.pendingBreakthrough,chainDepth:this.chainDepth,breakthroughCooldown:this.breakthroughCooldown,lastTags:this.lastTags,stance:this.stance,signInYear:this.signInYear,autoResolve:this.autoResolveMinor,gacha:this.gacha,stipend:this.stipend,itemsEra:1,episodeSeq:this.episodeSeq,currentEpisode:this.currentEpisode,pageYear:this.pageYear,pageLocation:this.pageLocation,lastRank:this.lastRank})}currentPrompt(){return this.finished?{kind:`gameover`,result:this.finished}:this.pendingBreakthrough?{kind:`breakthrough`,...this.pendingBreakthrough}:this.pendingEvent?{kind:`event`,card:this.pendingEvent,text:Ga(this.ctx,this.pendingEvent),choices:Ja(this.ctx,this.pendingEvent)}:null}gatherPage(e){let t=Math.max(0,Math.min(e,this.beats.length));return{page:Bo(this.beats.slice(t),this.pendingEvent?.id??null),cursor:this.beats.length}}advance(){if(this.finished)return{kind:`gameover`,result:this.finished};if(this.pendingEvent){let e=this.currentPrompt();if(e)return e}if(this.pendingBreakthrough)return{kind:`breakthrough`,...this.pendingBreakthrough};let{ctx:e}=this,t=e.actor;for(;t.alive&&e.tick<this.maxTicks;){e.tick++;let n=u[t.tier]??12,r=n/12;e.year+=r,t.ageMonths+=n;let i=Kt(e,this.upkeepStance());i.mishap&&this.note(`修炼时气息岔了一下，胸口发闷 —— 走火的前兆。`),i.stageUp&&this.note(`水到渠成，已入${i.stageUp}。`,`milestone`);for(let n of t.souls){if(n.dissipated||n.favor<=-20||n.possession>=90)continue;let r=Dn(n,t.tier);r.speedBonus>0&&e.rng.chance(.25)&&(On(e,n.id),t.sublevel=Math.min(1,t.sublevel+.012*r.speedBonus))}let a=En(e);a&&this.note(a);let o=e.rng.chance(pe.eventChance)?Ba(e,this.db,{excludeTags:this.lastTags}):null;if(o){this.lastTags=o.tags?.slice(0,1)??[];let n=Ja(e,o);if(!this.autoResolveMinor||n.length===0||this.isMajor(o,n)){this.pendingEvent=o,this.chainDepth=0,this.pushTransition(o.tags??[],`event`,!1,o.premise),this.currentEpisode=this.newEpisode();let r=Ga(e,o);return this.beats.push({year:Math.floor(e.year),tier:t.tier,kind:`scene`,text:r,evId:o.id,title:o.title,isMajor:o.tags?.includes(`主干`)||o.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:o,text:r,choices:n}}let r=this.autoResolve(o,n);if(r)return r;if(!t.alive)return{kind:`gameover`,result:this.finalize()}}else this.lastTags=[];let s=this.postTick(r);if(s)return s;if(i.ready&&t.tier<10&&this.breakthroughCooldown<=0){let n=L({power:Jt(t),dc:qt(t),scale:Math.max(20,qt(t)*.2)},I(t)),r=be(e.rng,n,I(t));return this.pushTransition([],`breakthrough`),this.pendingBreakthrough={toTier:t.tier+1,estimate:r},{kind:`breakthrough`,toTier:t.tier+1,estimate:r}}this.breakthroughCooldown>0&&this.breakthroughCooldown--,e.tick%4==0&&this.curve.push(nr(t,e.tick,e.year))}return{kind:`gameover`,result:this.finalize()}}static MAJOR_TAGS=new Set([`主干`,`岔路`,`道德`,`抉择`,`打脸`,`止步`,`结丹`,`定道`,`系统`,`心魔`]);isMajor(t,n){return!!(t.once||t.tags?.some(t=>e.MAJOR_TAGS.has(t))||n.some(e=>!!e.require)||n.some(e=>zo(t,e))||n.some(e=>e.karma!==`none`&&typeof e.karma==`object`&&e.karma.weight>=30))}autoResolve(e,t){let{ctx:n}=this,r=e,i=t,a=0;for(;r&&a++<5;){let e=this.newEpisode(),t=Ga(n,r);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:t,evId:r.id,title:r.title,episodeId:e,auto:!0});let o=i.filter(e=>!zo(r,e)),s=o.length?o:i,c=s.map((e,t)=>1/(t+1)+.3),l=n.rng.weighted(s,c);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`choice`,text:l.text,episodeId:e,auto:!0});let u=Za(n,r,l);if(this.flushItemNotices(),u.text&&this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`outcome`,text:u.text,episodeId:e,auto:!0}),r=Qa(n,this.db,u.goto),!r||(i=Ja(n,r),i.length===0))break;if(this.isMajor(r,i)){this.pendingEvent=r,this.chainDepth=a,this.pushTransition(r.tags??[],`event`,!0,r.premise),this.currentEpisode=this.newEpisode();let e=Ga(n,r);return this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:e,evId:r.id,title:r.title,isMajor:r.tags?.includes(`主干`)||r.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:r,text:e,choices:i}}}return null}captureStats(){let e=this.ctx.actor;return{修为:e.sublevel*100,道心:e.道心,气运:e.气运,功德:e.功德,业障:e.业障,僭越:e.僭越,堕度:e.堕度,丹毒:e.丹毒,名望:e.名望,悟性:e.talent.悟性,根骨:e.talent.根骨,神魂:e.talent.神魂,寿元:e.lifespanYears,功法:e.factors.功法,法宝:e.factors.法宝,状态:e.factors.状态,灵宠:e.factors.灵宠,伙伴:e.factors.伙伴,道侣:e.factors.道侣,情报:e.factors.情报,暴露:Math.max(...Object.values(e.secrets))}}static WARN_KEYS=new Set([`业障`,`僭越`,`堕度`,`丹毒`,`暴露`]);static FACTOR_KEYS=new Set([`功法`,`法宝`,`状态`,`灵宠`,`伙伴`,`道侣`,`情报`]);diffStats(t){let n=this.captureStats(),r=[];for(let i of Object.keys(t)){let a=(n[i]??0)-(t[i]??0),o=e.FACTOR_KEYS.has(i);if(Math.abs(a)<(o?.015:.5))continue;let s=e.WARN_KEYS.has(i)?a>0?`warn`:`good`:a>0?`good`:`bad`,c=o?a>0?`+${a.toFixed(2)}`:a.toFixed(2):i===`修为`?`${a>0?`+`:``}${a.toFixed(1)}%`:`${a>0?`+`:``}${Math.round(a)}`;r.push({key:i,delta:a,kind:s,text:`${i} ${c}`})}return r}choose(e){let t=this.pendingEvent;if(!t)throw Error(`当前没有待处理的事件`);let n=Ja(this.ctx,t),r=n[e];if(!r)throw Error(`选项 ${e} 不存在（共 ${n.length} 项）`);this.currentEpisode||=this.newEpisode(),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`choice`,text:r.text,episodeId:this.currentEpisode});let i=this.captureStats(),a=Za(this.ctx,t,r);if(this.lastOutcome=a.outcome,this.lastDeltas=this.diffStats(i),this.flushItemNotices(),a.karmaCreated){let e=this.ctx.karmaLedger.find(e=>e.id===a.karmaCreated);e&&this.lastDeltas.push({key:`因果`,delta:e.polarity,kind:e.polarity>0?`good`:e.polarity<0?`warn`:`bad`,text:`因果 · ${e.type}`})}if(a.text&&(this.notices.push(a.text),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`outcome`,text:a.text,episodeId:this.currentEpisode})),(t.tags?.includes(`岔路`)||t.tags?.includes(`主干`))&&this.milestones.push({year:Math.floor(this.ctx.year),kind:`岔路`,text:`【${t.title}】`}),a.goto&&this.chainDepth<4){let e=Qa(this.ctx,this.db,a.goto);if(e){this.chainDepth++,this.pendingEvent=e;let t=Ja(this.ctx,e);if(t.length>0){this.pushTransition(e.tags??[],`event`,!0,e.premise),this.currentEpisode=this.newEpisode();let n=Ga(this.ctx,e);return this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`scene`,text:n,evId:e.id,title:e.title,isMajor:e.tags?.includes(`主干`)||e.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:e,text:n,choices:t}}}}if(this.pendingEvent=null,this.currentEpisode=0,!this.ctx.actor.alive)return{kind:`gameover`,result:this.finalize()};if(this.ctx.flags.has(`止步`)&&tr(this.ctx.actor))return this.steppedDown=!0,this.milestones.push({year:Math.floor(this.ctx.year),kind:`结局`,text:`止步 —— 不再求进`}),{kind:`gameover`,result:this.finalize()};let o=u[this.ctx.actor.tier]??12;return this.postTick(o/12)||this.advance()}decideBreakthrough(e,t=!1){let n=this.ctx.actor;if(this.pendingBreakthrough=null,this.lastBreakthrough=null,!e)return this.breakthroughCooldown=6,this.note(`你压下了冲关的念头，继续温养。`),this.advance();let r=n.tier,i=Yt(this.ctx,{hiddenAttempt:t,coreGradeInvest:this.ctx.flags.has(`结丹·全押`)?.85:.4});if(i.newTier>r){rn(this.ctx);let e=Ft(n.path,i.newTier),t=i.newTier===3?Pt[n.path]===e?Lt(i.goldenCoreGrade):It(n.path,i.goldenCoreGrade):``;this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`入${e}${i.hiddenAchieved?`（得隐藏境界）`:``}${t?` · ${t}`:``}`}),this.notices.push(`突破成功 —— ${e}。${i.hiddenAchieved?`而且你摸到了传说里的那一层。`:``}`),this.lastBreakthrough={ok:!0,name:e,hidden:i.hiddenAchieved},this.beats.push({year:Math.floor(this.ctx.year),tier:n.tier,kind:`milestone`,isMajor:!0,title:`入${e}`,text:`入${e}${i.hiddenAchieved?`，且踏足了世所罕闻的隐秘之境`:``}${t?`，结成${t}`:``}`})}else if(i.failure){this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`渡劫失败 · ${i.failure.name}`});let e=Xn(i.failure.outcome,n.path);if(this.note(`突破失败 —— ${e}`),i.failure.recoverable===!1||i.failure.branch)return this.failedBranch={name:i.failure.name,outcome:e,branch:i.failure.branch},n.alive=!1,{kind:`gameover`,result:this.finalize()}}else this.note(`冲关未成，气机散了。所幸根基未损，还能再来。`);return this.advance()}signIn(){if(!this.ctx.systems.includes(`签到`))return{ok:!1,text:`未绑定签到系统`};let e=Math.floor(this.ctx.year);if(e<=this.signInYear)return{ok:!1,text:`今岁已签，明年再来`};this.signInYear=e;let t=this.ctx.actor,n=this.ctx.rng.pick([{text:`灵气灌顶 · 修为 +2%`,apply:()=>{t.sublevel=Math.min(1,t.sublevel+.02)}},{text:`残页功法一篇 · 功法 +0.02`,apply:()=>{t.factors.功法=Math.min(1.9,t.factors.功法+.02)}},{text:`下品法器一件 · 法宝 +0.02`,apply:()=>{t.factors.法宝=Math.min(1.75,t.factors.法宝+.02)}},{text:`疗伤玉露 · 状态 +0.06`,apply:()=>{t.factors.状态=Math.min(1.45,t.factors.状态+.06)}},{text:`静心符一道 · 道心 +1`,apply:()=>{t.道心=Math.min(100,t.道心+1)}},{text:`一点玄妙气机 · 气运 +1`,apply:()=>{t.气运=Math.min(100,t.气运+1)}}]);return n.apply(),t.僭越+=1.5,t.secrets.金手指=Math.min(100,t.secrets.金手指+1.5),this.note(`【签到系统】叮 —— 连续签到中。今日奖励：${n.text}。`),{ok:!0,text:n.text}}systemDef(e){return this.db.systems.get(e)}availablePools(){return Si.filter(e=>Ci[e.id]?.cond(this.ctx.actor.tier,this.ctx.flags)??!0)}poolCost(e){return Ci[e]?.cost(this.ctx.flags)??null}poolInfo(e){let t=Si.find(t=>t.id===e),n=Ci[e];if(!t)return null;let r=n?.cost(this.ctx.flags)??{},i=n?ui(this.ctx.actor,r):[];return{odds:gi(this.ctx.actor,t,this.gacha),pityLeft:_i(t,this.gacha),count:this.gacha.count[e]??0,costText:fi(r),affordable:i.length===0,missing:i,hint:n?.hint??``}}tryDrawFrom(e){let t=Si.find(t=>t.id===e),n=Ci[e];if(!t||!n)return{ok:!1,missing:[],reason:`没有「${e}」这座签筒`};if(!n.cond(this.ctx.actor.tier,this.ctx.flags)){let e={kind:`locked`,label:t.name,need:0,have:0,text:`${t.name}尚未对你开放`};return{ok:!1,missing:[e],reason:e.text}}let r=n.cost(this.ctx.flags),i=di(this.ctx.actor,r);if(i.length)return{ok:!1,missing:i,reason:`代价不足 —— ${i.map(e=>e.text).join(`；`)}`};let a=this.captureStats();Wi(this.ctx,[...r.effects??[]]);let o=hi(this.ctx.rng,this.ctx.actor,t,this.gacha);Wi(this.ctx,o.prize.effects),this.lastDeltas=this.diffStats(a);let s=o.rarity===`秘藏`?`★`:o.rarity===`仙品`?`☆`:``;return this.note(`【${t.name}】${s}${o.rarity}·${o.prize.name} —— ${o.prize.desc}`),this.flushItemNotices(),o.byPity&&this.note(`（连番落空之后，天道似乎补了你一次。）`),{ok:!0,result:o,missing:[]}}drawFrom(e){return this.tryDrawFrom(e).result??null}inventory(){return W(this.ctx.actor)}bag(){return $e(this.inventory())}bagSlots(){let e=this.inventory();return{used:Ze(e),total:Xe(e),free:Qe(e),container:e.container}}stones(){return pt(this.inventory())}useItem(e){let t=this.captureStats(),n=H(e)?.name??e,r=ot(this.ctx.actor,e);if(!r.ok)return{ok:!1,text:r.reason??`用不了${n}`};for(let e of r.effects)Vi(this.ctx,e);this.lastDeltas=this.diffStats(t);let i=r.note??`用掉了${n}`;return this.note(i),this.flushItemNotices(),{ok:!0,text:i}}equipItem(e){let t=this.captureStats(),n=H(e)?.name??e,r=lt(this.ctx.actor,e);if(!r.ok)return{ok:!1,text:r.reason??`佩不上${n}`};r.overTier&&Vn(this.ctx),this.lastDeltas=this.diffStats(t);let i=`佩上${n}（${r.slot}位）${r.overTier?` —— 越阶用宝，藏不住了`:``}`;return this.note(i),this.flushItemNotices(),{ok:!0,text:i}}unequipItem(e){let t=this.captureStats(),n=H(e)?.name??e,r=dt(this.ctx.actor,e);return r.ok?(this.lastDeltas=this.diffStats(t),this.flushItemNotices(),{ok:!0,text:`卸下${n}（${r.slot}位）`}):{ok:!1,text:r.reason??`${n}没佩在身上`}}sectStatus(){let e=this.sectRank();return{rank:e,monthly:e?Math.round(this.monthlyStipend(e)*10)/10:0,merit:this.stipend.merit,onDuty:this.stipend.dutyLeft>0,suspended:this.stipend.suspended>0,missed:this.stipend.missed,paidTotal:this.stipend.paidTotal,arrears:this.stipend.arrears}}clearSect(e){let t=this.ctx.actor.sect;t&&(delete this.ctx.actor.sect,this.ctx.flags.delete(`门派·${t}`),this.ctx.flags.add(`${e}·${t}`)),Ni(this.ctx)}lastSectOnRecord(){let e=null;for(let t of this.ctx.flags)(t.startsWith(`离派·`)||t.startsWith(`逐出·`))&&(e=t.slice(3));return e&&Yr(e)?e:Fi(this.ctx)?null:Ai(this.ctx.actor)??null}sectRank(){let e=this.ctx.flags;if(e.has(`已建宗`))return`掌门`;if(!e.has(`宗门弟子`)||e.has(`叛出宗门`)||e.has(`叛出山门`)||e.has(`宗门·已除名`)||e.has(`宗门·已离山`))return null;let t=this.ctx.actor.tier,n=t>=5?4:t>=4?3:t>=3?2:+(t>=2);return e.has(`位列长老`)&&(n=Math.max(n,4)),(e.has(`掌刑堂`)||e.has(`兼任丹房执事`))&&(n=Math.max(n,3)),e.has(`得见一式真传`)&&(n=Math.max(n,2)),e.has(`师承已定`)&&(n=Math.max(n,1)),n=F(n+this.stipend.promotions,0,Ho.length-1),Ho[n]}monthlyStipend(e){let t=F(1+this.ctx.actor.名望/500,.8,1.35),n=F(1+this.stipend.merit/180,.7,1.3);return Vo[e].monthly*this.sectPayScale()*t*n}sectPayScale(){let e=this.ctx.actor.sect,t=e?Yr(e)?.endowment?.stipend:void 0;return typeof t==`number`&&t>0?t/Vo.外门.monthly:1}grantStones(e){let t=this.inventory(),n=Math.floor(Math.max(0,e));if(n<=0)return 0;let r=ft(t),i=0;for(let e of[`下品`,`中品`,`上品`])r[e]<=0||(i+=r[e]*P[e],rt(t,Ke[e],r[e]));let a=i+n,o=0;for(let e of[`上品`,`中品`,`下品`]){if(a<=0)break;let n=P[e],r=Math.floor(a/n);if(r<=0)continue;let i=nt(t,Ke[e],r);o+=i.added*n,a-=i.added*n}return Math.max(0,o-i)}consumeSectMarks(){let e=this.ctx.flags,t=this.stipend,n=()=>{t.dutyLeft=0,e.delete(`宗门·当值`)},r=e=>{t.merit=F(t.merit+e,Z.meritMin,Z.meritMax)};if(e.delete(`宗门·当值·已了`)&&(n(),r(8),t.missed=Math.max(0,t.missed-1),this.ctx.actor.sublevel=Math.max(0,this.ctx.actor.sublevel-Z.dutyCost)),e.delete(`宗门·当值·推了`)&&(n(),r(-10),t.missed++),e.delete(`宗门·记功`)&&r(6),e.delete(`宗门·记过`)&&r(-8),e.delete(`宗门·晋阶`)&&(t.promotions=Math.min(2,t.promotions+1)),e.delete(`宗门·降等`)&&(t.promotions=Math.max(-4,t.promotions-1)),e.delete(`宗门·请辞`)&&(this.clearSect(`离派`),e.add(`宗门·已离山`),n(),t.accruedMonths=0,this.note(`你把腰牌还了。执事堂的册子上划掉一个名字，笔都没抬一下 —— 从此没人管你，也没人给你发钱。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`岔路`,text:`自请离山，从此散修`})),e.delete(`宗门·复籍`)){let n=this.lastSectOnRecord();n?(this.ctx.actor.sect=n,e.add(`门派·${n}`),e.delete(`宗门·已除名`),e.delete(`宗门·已离山`),e.delete(`叛出宗门`),e.delete(`宗门·停俸`),t.missed=0,t.suspended=0,t.merit=0,t.accruedMonths=0,this.note(`腰牌重新发回你手上，还是旧的那一块，边角被人摩得发亮。俸禄从这个月起照发。`)):(e.delete(`宗门·已离山`),e.delete(`宗门·已除名`),this.note(`执事堂翻了半日旧册，没找着你那一行。「早年的簿子烧过一批。」他说。这事只好作罢。`)),Ni(this.ctx)}t.missed>=Z.dismissAt?this.dismiss():t.missed>=Z.suspendAt&&t.suspended===0&&(t.suspended=Z.suspendTicks,t.accruedMonths=0,e.add(`宗门·停俸`),this.note(`执事堂把你的名字从发俸的册子上暂时划了出去 —— 「什么时候出满了工，什么时候再说。」`))}dismiss(){let e=this.stipend,t=this.ctx.flags;e.missed=2,e.suspended=0,t.delete(`宗门·停俸`);let n=this.sectRank();if(n!==`掌门`&&n!==null){if(n!==`外门`){e.promotions=Math.max(-4,e.promotions-1),this.note(`执事堂当众念了你的名字：误工太多，免去${n}之职，退回下一等再看。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`因果`,text:`免职 · 自${n}退下`});return}this.clearSect(`逐出`),t.add(`宗门·已除名`),e.dutyLeft=0,t.delete(`宗门·当值`),e.accruedMonths=0,this.note(`你的名字从外门册子上被墨笔涂掉了。腰牌收回，山门以内不必再来 —— 俸禄自然也没有了。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`因果`,text:`除名 · 逐出山门`})}}tickDuty(e){let t=this.stipend,n=this.ctx.flags;if(t.dutyLeft>0){if(t.dutyLeft--,t.dutyLeft>0)return;n.delete(`宗门·当值`),t.merit=F(t.merit+2,Z.meritMin,Z.meritMax),this.ctx.actor.sublevel=Math.max(0,this.ctx.actor.sublevel-Z.dutyCost),this.noticeOnly(`这一档差事你按部就班地当完了，无事可记 —— 只是那些时辰没能用来打坐。`);return}this.ctx.tick%Vo[e].dutyEvery===0&&(t.dutyLeft=Vo[e].patience,n.add(`宗门·当值`),this.noticeOnly(`【当值】排班簿上写了你的名字：${Vo[e].duty}。`))}tickStipend(e){let t=this.stipend,n=this.ctx.flags;this.consumeSectMarks();let r=this.sectRank();if(r!==this.lastRank&&(r&&this.lastRank?this.note(`执事堂改了你的名牌 —— 自今日起，你是${r}。`):r&&this.note(`你的名字进了${r}的册子。往后每月有俸，也每月有差事。`),this.lastRank=r),!r){t.dutyLeft=0,t.accruedMonths=0,n.delete(`宗门·当值`),n.delete(`宗门·停俸`);for(let e of Ho)n.delete(`身份·${e}`);n.delete(`身份·掌门`),n.delete(`宗门·在册`);return}n.add(`宗门·在册`);for(let e of Ho)e!==r&&n.delete(`身份·${e}`);if(r!==`掌门`&&n.delete(`身份·掌门`),n.add(`身份·${r}`),t.suspended>0&&(t.suspended--,t.suspended===0&&(n.delete(`宗门·停俸`),this.note(`名字又写回了发俸的册子上。经手的执事没抬头：「下不为例。」`))),this.tickDuty(r),t.suspended>0||(t.accruedMonths+=Math.min(e,Z.paidMonthsCap),t.accruedMonths<Z.payEveryMonths))return;let i=t.accruedMonths;t.accruedMonths=0;let a=this.monthlyStipend(r),o=Math.floor(a*i)+t.arrears;if(o<=0)return;let s=this.grantStones(o);if(t.paidTotal+=s,t.arrears=Math.min(o-s,Math.floor(a*Z.arrearsMonthsCap)),s>0){let e=Math.round(i/12);this.noticeOnly(`【俸禄】领了${e<=1?`这一年`:`这${e}年`}的例俸，共 ${s} 块下品灵石之数。`)}t.arrears>0&&this.noticeOnly(`行囊塞不下，余下的先记在执事堂的账上 —— 腾出手了再来支。`)}backfillKit(e){if(e.itemsEra===1)return;let t=W(this.ctx.actor);if(t.stacks.length>0)return;let n=_t[[...this.ctx.flags].find(e=>e.startsWith(`出身·`))?.slice(3)??gt.find(e=>e.name===this.ctx.location)?.id??``]??vt,r=[];for(let[e,i]of n){let n=nt(t,e,i);n.added>0&&r.push(`${H(e)?.name??e}×${n.added}`)}for(let e of[...t.stacks]){let t=H(e.defId);t?.equip&&!e.equipped&&lt(this.ctx.actor,t.id)}let i=this.sectRank(),a=Uo[this.ctx.actor.tier]??0,o=i?Math.floor(this.monthlyStipend(i)*Z.backPayMonths):0,s=this.grantStones(a+o);s>0&&(this.stipend.paidTotal+=o>0?Math.min(s,o):0,r.push(`折合下品灵石 ${s}`)),this.note(`【行囊补记】你解下包袱才发现，这些年随身的东西一件都不在 —— 不是被人偷了，是先前记账的人漏了你这一囊：${r.join(`、`)}${i?`（其中含${i}的欠俸 ${o} 块）`:``}。旧存档开局时物品尚未入册，这一份是补给你的。`)}postTick(e){let{ctx:t}=this,n=t.actor;this.tickStipend(Math.round(e*12));for(let e of Rn(t))this.note(e);let r=$t(t);r&&(this.note(r),t.rng.chance(.4)&&en(t));let i=tn(t);i&&(this.note(i.text),this.milestones.push({year:Math.floor(t.year),kind:`机缘`,text:`身世揭晓：${i.origin}`}));for(let{soul:e,fate:n}of kn(t))this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`${e.name} · ${n}`}),this.note(`${e.name} —— ${n}。`);if(!n.alive)return{kind:`gameover`,result:this.finalize()};Hn(t),Jn(t),n.锋芒=Ce(n)*(.15+.85*(n.secrets.真实修为/100));let a=Un(t);if(a.length){this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`秘密败露：${a.join(`、`)}`}),this.note(`瞒不住了 —— 你的${a.join(`、`)}已是公开的秘密。`);for(let e of a)n.secrets[e]=70;n.名望-=10}for(let n of gn(t,e)){if(n.kind===`foreshadow`||n.kind===`window`){this.note(`（${n.evtId.replace(/_/g,` `)}）`);continue}if(!n.lethal)continue;let e=cn(t,n.karma);if(this.note(e.text),e.death)return this.death=wn(t,e.death),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:e.death.description}),{kind:`gameover`,result:this.finalize()};this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`${n.karma.target}的旧账 —— ${e.kind}`})}let o=Tn(t);return o?(this.death=wn(t,o),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:o.description}),{kind:`gameover`,result:this.finalize()}):null}finalize(){if(this.finished)return this.finished;let{ctx:e}=this,t=e.actor;t.perfectionByTier[t.tier]||(t.perfectionByTier[t.tier]=Xt(t,t.hiddenRealms.includes(t.tier))),this.curve.push(nr(t,e.tick,e.year));let n=$n({actor:t,death:this.death,steppedDown:this.steppedDown,rootedAt:e.location,failedBranch:this.failedBranch});this.milestones.push({year:Math.floor(e.year),kind:`结局`,text:n.name});let r=ar({actor:t,ledger:e.karmaLedger,milestones:this.milestones,curve:this.curve,flags:e.flags,death:this.death,ending:n,diedAtYear:e.year,seed:this.seed}),i=vr({actor:t,ledger:e.karmaLedger,ending:n,seed:this.seed,serialIndex:this.registry.steleCount+1,birthYear:this.birthYear,diedAtYear:e.year,goldFingers:[...e.systems,...t.souls.map(e=>e.name)],verdictShort:Qt(Zt(t))}),a=er(t,n,{noSystem:e.flags.has(`无系统`)});Cr(this.registry,{actor:t,ending:n,stele:i,place:e.location,signature:this.signature(),unfinished:r.unfinished,relics:this.relics(),daoFruit:a});for(let t of e.systems)this.registry.unlockedSystems.includes(t)||this.registry.unlockedSystems.push(t);let o=Fo({daoName:t.name,seed:this.seed,beats:this.beats,chronicle:r,stele:i,signature:this.signature()});return this.finished={ending:n,chronicle:r,stele:i,daoFruit:a,novel:o,novelChars:Io(o)},this.finished}signature(){let e=this.ctx.flags;return e.has(`道·剑`)?`挡我者，斩。`:e.has(`道·丹`)?`我要救的人，一个都不能少。`:e.has(`道·苟`)?`谁都可以死，我不行。`:e.has(`道·杀`)?`这世道就是这样，我认。`:e.has(`无系统`)?`我什么都没有。所以我什么都不欠。`:e.has(`拒绝过系统`)?`那东西认的不是我，是「载体」。`:`后生，老夫观你骨骼清奇。`}relics(){let e=[],t=this.ctx.actor;return t.factors.法宝>1.1&&e.push(`一件养过手的法宝`),t.factors.功法>1.2&&e.push(`半部残缺功法`),t.tier>=3&&e.push(`一枚认过主的储物戒`),this.ctx.systems.length&&e.push(`一枚温热的青玉简`),t.goldenCoreGrade>=7&&e.push(`一颗${It(t.path,t.goldenCoreGrade)}`),e}},Ko=class extends Error{};function qo(){return{events:new Map,systems:new Map,souls:new Map,locations:new Map,items:new Map,sects:new Map,voices:new Map}}function Jo(e,t,n){if(!n||typeof n!=`object`)return;let r=n,i=(e,n,r)=>{for(let i of e??[]){if(!i?.id)throw new Ko(`${t} 存在缺少 id 的${r}`);if(n.has(i.id))throw new Ko(`${t} ${r} id 重复：${i.id}`);n.set(i.id,i)}};i(r.events,e.events,`事件`),i(r.systems,e.systems,`系统`),i(r.souls,e.souls,`残魂`),i(r.locations,e.locations,`地点`),i(r.sects,e.sects,`门派`),i(r.voices,e.voices,`声音档`);for(let n of r.items??[]){if(!n?.id)throw new Ko(`${t} 存在缺少 id 的物品`);if(e.items.has(n.id))throw new Ko(`${t} 物品 id 重复：${n.id}`);try{e.items.set(n.id,Ve(n))}catch(e){throw new Ko(`${t} 物品 '${n.id}' 不合法：${e.message}`)}}}function Yo(e){let t=qo();for(let{path:n,doc:r}of e)Jo(t,n,r);return t}var Q={status:`loading`,done:0,total:0,db:null,error:null},Xo=new Set;function Zo(){for(let e of Xo)e(Q)}function Qo(e){Q={...Q,...e},Zo()}function $o(){return Q}function es(e){return Xo.add(e),e(Q),()=>void Xo.delete(e)}var ts=new Map,ns=new Map,rs=new Map,is=null,as=null;function os(){let e=0;for(let t of ts.values())e+=t;Qo({done:Q.total>0&&e>Q.total?Q.total:e})}function ss(e){return e instanceof Error?e.message:String(e)}async function cs(e){let t=`${e}content/manifest.json`,n;try{n=await fetch(t)}catch(e){throw Error(`取不到内容清单（${ss(e)}）`)}if(!n.ok)throw Error(`取不到内容清单（HTTP ${n.status}）`);let r=await n.json();if(!Array.isArray(r.chunks)||r.chunks.length===0)throw Error(`内容清单为空`);return r}async function ls(e,t){let n=`${e}content/${t.file}`,r;try{r=await fetch(n)}catch(e){throw Error(`「${t.label}」下载失败（${ss(e)}）`)}if(!r.ok)throw Error(`「${t.label}」下载失败（HTTP ${r.status}）`);let i,a=r.body;if(!a)i=await r.text(),ts.set(t.file,t.bytes),os();else{let e=a.getReader(),n=[],r=0;for(;;){let{done:i,value:a}=await e.read();if(i)break;a&&(n.push(a),r+=a.byteLength,ts.set(t.file,r),os())}let o=new Uint8Array(r),s=0;for(let e of n)o.set(e,s),s+=e.byteLength;i=new TextDecoder().decode(o)}let o=JSON.parse(i);if(o.id!==t.id)throw Error(`分片 ${t.file} 内容对不上（${o.id} ≠ ${t.id}）`);return ts.set(t.file,t.bytes),os(),o.docs}async function us(){let e=`/cangfeng-play/`;is??=await cs(e);let t=is;Q.total!==t.totalBytes&&Qo({total:t.totalBytes});let n=Yo((await Promise.all(t.chunks.map(t=>{let n=ns.get(t.file);if(n)return Promise.resolve(n);let r=rs.get(t.file);return r||(r=ls(e,t).then(e=>(ns.set(t.file,e),rs.delete(t.file),e)),r.catch(()=>{rs.delete(t.file),ts.delete(t.file),os()}),rs.set(t.file,r)),r}))).flat());return Ge(n.items.values()),Jr(n.sects.values()),n}function ds(){return Q.db?Promise.resolve(Q.db):(as??=us().then(e=>(as=null,Qo({status:`ready`,db:e,error:null,done:Q.total}),e),e=>{throw as=null,Qo({status:`error`,error:ss(e)}),e}),as)}function fs(){Q.db||(Qo({status:`loading`,error:null}),ds().catch(()=>{}))}ds().catch(()=>{});function ps(){return{version:1,registry:xr(),steles:[]}}function ms(e){if(!e)return ps();try{let t=JSON.parse(e);return t.version!==1||!t.registry||!Array.isArray(t.steles)?ps():t}catch{return ps()}}function hs(e){let t={};for(let n of e.steles)t[n.grade]=(t[n.grade]??0)+1;return t}var gs=`cangfeng-save-v1`;function _s(){try{return ms(localStorage.getItem(gs))}catch{return ps()}}function vs(e){try{localStorage.setItem(gs,JSON.stringify(e))}catch{}}var ys=`cangfeng-run-v1`;function bs(e,t){try{localStorage.setItem(ys,JSON.stringify({snap:e,pov:t,savedAt:Date.now()}))}catch{}}function xs(e){let t=e?.snap;return!t||t.v!==1||!t.actor||typeof t.actor!=`object`||!t.rng||typeof t.rng.state!=`number`||!Array.isArray(t.flags)||!Array.isArray(t.beats)?!1:typeof t.seed==`string`&&typeof t.tick==`number`}function Ss(){try{let e=localStorage.getItem(ys);if(!e)return null;let t=JSON.parse(e);return xs(t)?t:null}catch{return null}}function Cs(){localStorage.removeItem(ys)}var ws=`<svg viewBox="0 0 390 420" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,Ts=`<svg viewBox="0 0 390 80" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,Es={tianshu:`<svg viewBox="0 0 240 110" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true">
  <defs>
...
</svg>`},Ds={冲突:`<svg viewBox="0 0 390 90" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},Hs={evt_diyitiao_renming:`<svg viewBox="0 0 390 240" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},Us={...Vs,...Hs},Ws={cheap:{title:e=>`— ${e.split(``).join(` `)} v1.0 —`,greet:`尊贵的宿主，欢迎回来！`,act:`今 日 签 到`,fine:`* 签到即留痕。系统提醒宿主：天机可循，慎用。`},data:{title:e=>`[ ${e} ]`,greet:`模块就绪。数据流同步完成。`,act:`执 行`,fine:`// 每次调用都会在天机中留下一条记录`},ink:{title:e=>`${e}`,greet:`心念微动，那物应了一声。`,act:`运 转`,fine:`用之有度。器不欺主，主亦不当欺器。`},terminal:{title:e=>`root@heaven:~# ${e}`,greet:`> 权限校验通过。当前身份：临时执法者（编号待定）`,act:`EXEC`,fine:`# 所有操作计入天规日志，由下一任天道审计`},meta:{title:e=>`${e}`,greet:`……你确定这是游戏的一部分吗？`,act:`继 续`,fine:`（这段文字不应该出现在这里。）`}};function Gs(e){let[t,n]=(0,r.useState)(0),i=e.systems[t];if(!i)return(0,$.jsx)($.Fragment,{});let a=Ws[i.skin]??Ws.data,o=i.id===`签到`,s=e.session.beats,c=s.length>0?s[s.length-1].text:``,l=c.includes(i.name)||c.includes(i.id);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sys-panel skin-${i.skin} fade-in`,children:[e.systems.length>1&&(0,$.jsx)(`div`,{className:`sys-switch`,children:e.systems.map((e,r)=>(0,$.jsx)(`button`,{className:`sys-chip ${r===t?`on`:``}`,onClick:()=>n(r),children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`sys-title`,children:a.title(i.name)}),(0,$.jsx)(`div`,{className:`sys-line`,children:a.greet}),(0,$.jsx)(`div`,{className:`sys-line sys-desc`,children:i.desc}),o&&(0,$.jsx)(`button`,{className:`sys-btn`,onClick:e.onAct,children:a.act}),l&&(0,$.jsx)(`div`,{className:`sys-line sys-log`,children:c}),(0,$.jsxs)(`div`,{className:`sys-line sys-cost`,children:[`代价：`,i.cost]}),(0,$.jsx)(`div`,{className:`sys-line sys-fine`,children:a.fine}),(0,$.jsx)(`button`,{className:`linklike`,style:{marginTop:10},onClick:e.onClose,children:`关闭`})]})]})}var Ks=[`法宝`,`符箓`,`丹药`,`功法`,`材料`,`杂物`,`灵石`],qs=`零一二三四五六七八九`,Js=[``,`十`,`百`,`千`];function Ys(e){if(!Number.isFinite(e)||e<0||e===0)return`零`;if(e>999)return String(e);let t=String(e),n=``,r=!1;for(let e=0;e<t.length;e++){let i=Number(t[e]),a=t.length-e-1;if(i===0){r=!0;continue}r&&n&&(n+=`零`),r=!1,(i!==1||a!==1||e!==0)&&(n+=qs[i]),n+=Js[a]}return n}function Xs(e){return e>=1e5?`${Math.floor(e/1e4)}万`:e>=1e4?`${(e/1e4).toFixed(1)}万`:String(e)}function Zs(e){return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,`,`)}function Qs(e){let{session:t}=e,n=e.transform,[i,a]=(0,r.useState)(`全部`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),[,f]=(0,r.useState)(0),p=t.bag(),m=t.bagSlots(),h=t.stones(),g=t.inventory(),_=ft(g),ee=t.ctx.actor.tier,v=ve(g.container),y=m.free===0?it(g):null,b=e=>`${e.def.id}|${z(e.stack)}`,x=o?p.find(e=>b(e)===o)??p.find(e=>e.def.id===o.split(`|`)[0])??null:null,S=()=>{e.onAct(),f(e=>e+1)},C=(e,n)=>{l({ok:e.ok,text:e.text}),S(),e.ok&&!t.bag().some(e=>e.def.id===n)&&s(null)},te=(e,n)=>{let r=t.inventory().container,i=t.useItem(e);if(C(i,e),i.ok&&n){let e=t.inventory().container;if(e!==r){let t=ve(e);d({name:t.id,note:t.note}),setTimeout(()=>d(null),2200)}}},w=new Map;for(let e of p)w.set(e.def.category,(w.get(e.def.category)??0)+1);let ne=Ks.filter(e=>w.has(e)),re=i===`全部`?p:p.filter(e=>e.def.category===i),T=i===`全部`?Math.min(m.free,12):0,ie=i===`全部`?m.free-T:0,ae=e=>p.find(t=>t.stack.equipped===e),oe=c?(0,$.jsx)(`div`,{className:`bag-msg ${c.ok?`good`:`bad`}`,children:n(c.text)}):null;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay bag-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sheet bag-sheet fade-in`,role:`dialog`,"aria-label":`行囊`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`行囊`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:v.id}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onClose,children:`收起`})]}),(0,$.jsxs)(`div`,{className:`bag-cap`,children:[(0,$.jsxs)(`div`,{className:`bag-cap-line`,children:[(0,$.jsxs)(`b`,{children:[Ys(m.total),`格`]}),(0,$.jsxs)(`span`,{children:[`，`,m.used===0?`空着`:`已满${Ys(m.used)}`]}),(0,$.jsx)(`i`,{className:m.free===0?`full`:``,children:m.free===0?`再装不下了`:`余 ${Ys(m.free)} 格`})]}),(0,$.jsx)(`div`,{className:`bag-bar`,children:(0,$.jsx)(`i`,{className:m.free===0?`full`:``,style:{width:`${Math.min(100,Math.round(m.used/Math.max(1,m.total)*100))}%`}})}),(0,$.jsx)(`div`,{className:`bag-note`,children:v.note}),y&&(0,$.jsxs)(`div`,{className:`bag-warn`,children:[`装满了。最不值钱的是`,(0,$.jsx)(`b`,{children:B(y.def,z(y.stack))}),`（约值 `,Zs(Math.round(qe(y.stack))),` 下品）—— 要腾地方，先舍它。`]})]}),(0,$.jsxs)(`div`,{className:`bag-purse`,children:[(0,$.jsxs)(`span`,{className:`bp-sum`,children:[`⟡ `,Zs(h),` `,(0,$.jsx)(`i`,{children:`折下品`})]}),(0,$.jsxs)(`span`,{className:`bp-split`,children:[he.map(e=>_[e]>0?(0,$.jsxs)(`em`,{children:[e,` `,_[e]]},e):null),h===0&&(0,$.jsx)(`em`,{className:`none`,children:`身无分文`})]})]}),_.极品>0&&(0,$.jsxs)(`div`,{className:`bag-jstone`,children:[(0,$.jsx)(`span`,{className:`bj-mark`,children:`✦`}),(0,$.jsxs)(`span`,{className:`bj-t`,children:[`极品灵石 `,(0,$.jsxs)(`b`,{children:[`×`,_.极品]})]}),(0,$.jsx)(`span`,{className:`bj-x`,children:`这不是钱。市面上没有摊主找得开 —— 付账时它不会被拆开， 除非低阶灵石实在凑不出，才会有一枚被迫破开。`})]}),(0,$.jsx)(`div`,{className:`bag-ladder`,children:ge.map(e=>(0,$.jsx)(`span`,{className:`bl-step ${e.id===v.id?`on`:e.slots<v.slots?`past`:``}`,title:`${e.slots} 格 · ${e.note}`,children:e.id},e.id))}),(0,$.jsx)(`div`,{className:`bag-slots-row`,children:Be.map(e=>{let t=ae(e);return(0,$.jsxs)(`button`,{className:`eq-slot ${t?`on`:``}`,onClick:()=>t&&s(b(t)),disabled:!t,children:[(0,$.jsx)(`i`,{children:e}),(0,$.jsx)(`b`,{className:t?`r-${t.def.grade-1}`:``,children:t?B(t.def,z(t.stack)):`空`})]},e)})}),!x&&oe,ne.length>1&&(0,$.jsxs)(`div`,{className:`bag-tabs`,children:[(0,$.jsxs)(`button`,{className:`bag-tab ${i===`全部`?`on`:``}`,onClick:()=>a(`全部`),children:[`全部 `,p.length]}),ne.map(e=>(0,$.jsxs)(`button`,{className:`bag-tab ${i===e?`on`:``}`,onClick:()=>a(e),children:[e,` `,w.get(e)]},e))]}),(0,$.jsxs)(`div`,{className:`bag-grid`,children:[re.map((e,t)=>{let n=z(e.stack),r=!R(e.def)&&n!==2;return(0,$.jsxs)(`button`,{className:`bag-slot r-${e.def.grade-1} ${e.stack.equipped?`on`:``}`,style:e.def.slots>1?{gridColumn:`span 2`}:void 0,onClick:()=>{s(b(e)),l(null)},children:[(0,$.jsx)(`span`,{className:`bs-name`,children:e.def.name}),(0,$.jsxs)(`span`,{className:`bs-foot`,children:[(0,$.jsx)(`i`,{className:`bs-grade${e.def.grade>=6?` top`:``}`,children:ke(e.def.grade)}),r&&(0,$.jsx)(`i`,{className:`bs-q q${n}`,children:Le(n)}),e.stack.qty>1&&(0,$.jsxs)(`i`,{className:`bs-qty`,children:[`×`,e.stack.qty]})]}),e.stack.equipped&&(0,$.jsx)(`span`,{className:`bs-eq`,children:`佩`}),e.def.slots>1&&(0,$.jsxs)(`span`,{className:`bs-big`,children:[`占`,Ys(e.def.slots),`格`]})]},`${e.def.id}-${t}`)}),Array.from({length:T},(e,t)=>(0,$.jsx)(`span`,{className:`bag-slot empty`,"aria-hidden":`true`},`e${t}`))]}),re.length===0&&(0,$.jsx)(`div`,{className:`bag-empty`,children:i===`全部`?`空空如也。修士的第一件家当，多半是别人不要的。`:`没有${i}。`}),ie>0&&(0,$.jsxs)(`div`,{className:`bag-note`,style:{textAlign:`center`,marginTop:8},children:[`另余 `,ie,` 格`]})]}),x&&(()=>{let e=x.def,r=z(x.stack),i=!!x.stack.equipped,a=e.container?ve(e.container):null,o=a?a.slots<=v.slots?`${v.id}比${a.id}还宽敞，换了是往回走`:ee<a.minTier?`神识撑不开${a.id} —— 须得${a.minTier}阶以上`:null:null,c=e.equip?.minTier!=null&&ee<e.equip.minTier,u=!!a||!!e.use&&e.use.length>0;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay detail-overlay`,onClick:()=>{s(null),l(null)}}),(0,$.jsxs)(`div`,{className:`bag-detail fade-in`,role:`dialog`,"aria-label":e.name,children:[(0,$.jsxs)(`div`,{className:`bd-head`,children:[(0,$.jsx)(`span`,{className:`bd-name r-${e.grade-1}`,children:B(e,r)}),(0,$.jsxs)(`span`,{className:`bd-tag${e.grade>=6?` top`:``}`,children:[ke(e.grade),` · `,e.category]}),i&&(0,$.jsxs)(`span`,{className:`bd-worn`,children:[`佩于`,x.stack.equipped]})]}),(0,$.jsx)(`div`,{className:`bd-desc`,children:n(e.desc)}),e.grade>=6&&(0,$.jsxs)(`div`,{className:`bd-uniq`,children:[(0,$.jsx)(`span`,{className:`bu-mark`,children:`✦`}),e.stone?`不是钱。没有摊主找得开 —— 除非低阶灵石实在凑不出，付账时它不会被拆开。`:`世上只此一件。它不会有第二件，前主人的账也一并转到了你身上。`]}),(0,$.jsxs)(`div`,{className:`bd-meta`,children:[(0,$.jsxs)(`span`,{children:[`占 `,Ys(e.slots),` 格`]}),(0,$.jsxs)(`span`,{children:[`值 `,Zs(Math.round(e.value*(R(e)?1:Fe[r]))),` 下品`]}),x.stack.qty>1&&(0,$.jsxs)(`span`,{children:[`身上 `,x.stack.qty,` 件`]}),e.talisman&&(0,$.jsxs)(`span`,{children:[e.talisman,`符`]})]}),e.equip&&(0,$.jsxs)(`div`,{className:`bd-equip`,children:[(0,$.jsx)(`b`,{children:e.equip.slot}),Object.entries(e.equip.factors).map(([e,t])=>(0,$.jsxs)(`span`,{className:`bd-fac`,children:[e,` +`,t.toFixed(2)]},e))]}),c&&!i&&(0,$.jsx)(`div`,{className:`bd-warn`,children:`越阶用宝：佩得上，但压不住 —— 明眼人一看便知你身后有人（真实修为暴露）。`}),a&&!o&&(0,$.jsxs)(`div`,{className:`bd-hint`,children:[`换用之后可装 `,a.slots,` 格。`,a.note]}),o&&(0,$.jsx)(`div`,{className:`bd-warn`,children:o}),!u&&!e.equip&&!(e.grade>=6&&e.stone)&&(0,$.jsx)(`div`,{className:`bd-hint`,children:e.stone?`钱不必手动动它 —— 付账时自会拆开找零。`:`用不上。但总有人要，也总有人认得。`}),oe,(0,$.jsxs)(`div`,{className:`bd-acts`,children:[e.equip&&(i?(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>C(t.unequipItem(e.id),e.id),children:`卸 下`}):(0,$.jsx)(`button`,{className:`primary-btn slim`,onClick:()=>C(t.equipItem(e.id),e.id),children:`佩 上`})),u&&(0,$.jsx)(`button`,{className:`primary-btn slim`,disabled:!!o,onClick:()=>te(e.id,!!a),children:a?`换 用`:e.category===`丹药`?`服 下`:`用 掉`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{s(null),l(null)},children:`收 起`})]})]})]})})(),u&&(0,$.jsxs)(`div`,{className:`bag-flash`,onClick:()=>d(null),children:[(0,$.jsx)(`div`,{className:`bf-word`,children:u.name}),(0,$.jsx)(`div`,{className:`bf-sub`,children:u.note})]})]})}var $s=`modulepreload`,ec=function(e){return`/cangfeng-play/`+e},tc={},nc=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=ec(t,n),t=s(t),t in tc)return;tc[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:$s,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},rc={oracle:`坊市街口的卦摊。几个铜板一卦 —— 问得多了，天也会烦。`,relic:`荒山野岭的旧坟古洞。前人的东西好拿，前人的账也跟着来。`,alchemy:`自己开炉。费材料费时间，但炉子是自己的。`},ic={CRIT_SUCCESS:{label:`大成`,cls:`s-crit`},SUCCESS:{label:`成`,cls:`s-ok`},FAIL:{label:`败`,cls:`s-fail`},CRIT_FAIL:{label:`大凶`,cls:`s-cfail`}};function ac(e){if(!(e>0))return`—`;let t=e*100;return t>=1?`${t.toFixed(1)}%`:t>=.1?`${t.toFixed(2)}%`:`${t.toFixed(4)}%`}function oc(e){let t=Math.round(e*100);return t>=80?`八九成`:t>=60?`六七成`:t>=40?`四五成`:t>=20?`两三成`:`一线`}function sc(e){let t=e.session.ctx.actor,n=[],r=t.lifespanYears-t.ageMonths/12;r<15&&n.push({text:`寿余${Math.max(0,r).toFixed(0)}`,cls:`hot`}),t.僭越>=51&&n.push({text:`僭越${Math.round(t.僭越)}`,cls:t.僭越>=101?`hot`:`warn`}),t.堕度>=46&&n.push({text:`堕度${Math.round(t.堕度)}`,cls:t.堕度>=76?`hot`:`warn`}),t.丹毒>=50&&n.push({text:`丹毒${Math.round(t.丹毒)}`,cls:t.丹毒>=80?`hot`:`warn`});let i=t.souls.find(e=>!e.dissipated&&e.possession>=60);return i&&n.push({text:`魂扰${Math.round(i.possession)}`,cls:i.possession>=85?`hot`:`warn`}),n.slice(0,2)}var cc=`cangfeng-audio-v1`,lc=`cangfeng-voice-detail-v1`,uc=[`仅对白`,`对白与承接`,`全读`],dc=`对白与承接`,fc={仅对白:`只念有人开口的话，最快`,对白与承接:`对白 + 关键动作与后果，推荐`,全读:`连铺陈也念，最慢`};function pc(e,t,n){try{let r=globalThis.localStorage?.getItem(e);return t.includes(r)?r:n}catch{return n}}function mc(e,t){try{globalThis.localStorage?.setItem(e,t)}catch{}}var hc={name:`旁白`,sex:`不明`,age:`中年`,temper:`平`};function gc(e){return e.page.player.length>0||e.page.auto.length>0||e.page.loose.length>0||e.page.transition!==null||e.stamp!==null||e.chips.length>0}function _c(e){let{session:t,pov:n,name:i}=e.game,a=e=>eo(e,n,i),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(`event`),[u,d]=(0,r.useState)(null),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(!1),[g,_]=(0,r.useState)(!1),[ee,v]=(0,r.useState)(!1),[b,x]=(0,r.useState)(null),[S,C]=(0,r.useState)(null),[te,w]=(0,r.useState)(!1),[ne,re]=(0,r.useState)(!1),[T,ie]=(0,r.useState)(null),[ae,oe]=(0,r.useState)([]),[se,E]=(0,r.useState)(`oracle`),[D,ce]=(0,r.useState)(!1),[O,le]=(0,r.useState)(null),[,ue]=(0,r.useState)(0),k=(0,r.useRef)(0),A=(0,r.useRef)(!1),de=(0,r.useRef)(null),[j,M]=(0,r.useState)(()=>pc(cc,[`0`,`1`],`0`)===`1`),[N,fe]=(0,r.useState)(()=>pc(lc,uc,dc)),[pe,me]=(0,r.useState)(!1),[P,he]=(0,r.useState)(null),[ge,_e]=(0,r.useState)(1),[ve,F]=(0,r.useState)(.45),[I,ye]=(0,r.useState)(null),L=(0,r.useRef)(null),[be,xe]=(0,r.useState)(0),Se=(0,r.useRef)(0),Te=(0,r.useRef)(j),Ee=(0,r.useRef)(!1),De=async()=>{if(!(L.current||Ee.current)){Ee.current=!0,me(!0);try{let[e,n]=await Promise.all([nc(()=>import(`./audio-CkUdVKSX.js`),[]),nc(()=>import(`./speech--sAzsIK5.js`),[])]),r=[...$o().db?.voices.values()??[]],i=await e.createAudioEngine();if(!Te.current){i.dispose();return}i.setSetting(t.ctx.scene?.setting??null),L.current={engine:i,extract:n.extractSpeech,index:n.buildVoiceIndex(r),names:r.flatMap(e=>[e.name,...e.aliases??[]])},he(i.capability),_e(i.getRate()),F(i.getAmbientVolume()),xe(e=>e+1)}catch{L.current=null,Te.current=!1,M(!1),mc(cc,`0`)}finally{Ee.current=!1,me(!1)}}},Oe=()=>{Se.current++,L.current?.engine.dispose(),L.current=null,he(null),ye(null)},ke=()=>{if(pe)return;let e=!j;if(Te.current=e,M(e),mc(cc,e?`1`:`0`),!e){Oe();return}try{let e=window.speechSynthesis;if(e&&typeof SpeechSynthesisUtterance==`function`){let t=new SpeechSynthesisUtterance(` `);t.volume=0,e.speak(t)}}catch{}De()};(0,r.useEffect)(()=>{if(!j||L.current)return;let e=()=>{De()};return window.addEventListener(`pointerdown`,e,{once:!0}),()=>window.removeEventListener(`pointerdown`,e)},[j]),(0,r.useEffect)(()=>()=>{Te.current=!1,Oe()},[]);let Ae=()=>{Se.current++,L.current?.engine.stopSpeaking(),ye(null)},je=e=>{if(e.speaker===null)return{text:e.text,profile:{...hc},volume:.92};if(e.speaker===`你`)return{text:e.text,profile:{name:i,sex:`不明`,age:`青年`,temper:`平`}};let t=L.current.index.get(e.speaker);return{text:e.text,profile:{name:e.speaker,sex:t.gender,age:t.age,temper:t.temper}}},Me=()=>c===`between`?u?u.page.player.flatMap(e=>e.beats.filter(e=>e.kind!==`scene`)).map((e,t)=>({key:`pb-${t}`,text:a(e.text),source:e.kind===`choice`?`选项`:`承接`})):[]:o?.kind===`event`?a(o.text).split(`
`).filter(e=>e.trim()!==``).map((e,t)=>({key:`ev-${t}`,text:e,source:`正文`})):o?.kind===`breakthrough`?[{key:`bt-0`,text:Le(o),source:`承接`}]:[],Ne=e=>{let t=L.current;if(!t)return;let n=++Se.current,r=[],i=[];for(let n of e)for(let e of t.extract(n.text,{detail:N,names:t.names,source:n.source}))r.push(je(e)),i.push(n.key);if(r.length===0){Ae();return}ye(i[0]??null),t.engine.speak(r,{onSegment:e=>{Se.current===n&&ye(i[e+1]??null)},onDone:()=>{Se.current===n&&ye(null)}})};(0,r.useEffect)(()=>{if(!(!j||!L.current))return Ne(Me()),()=>{Ae()}},[j,be,N,c,o,u]);let Pe=t.ctx.scene?.setting??null;(0,r.useEffect)(()=>{L.current?.engine.setSetting(Pe)},[Pe,be]);let Fe=e=>I===e?` spk-on`:``,Ie=I===null?void 0:Ae,Le=e=>a(`修为已至大圆满，气机满盈，可冲击【${Ft(t.ctx.actor.path,e.toTier)}】。\n你掂量了一下 —— 约莫${oc(e.estimate)}把握。`),Re=e=>{let n=t.gatherPage(k.current);k.current=n.cursor,t.notices.length=0;let r=t.lastOutcome?ic[t.lastOutcome]??null:null,i=[...t.lastDeltas];return t.lastOutcome=null,t.lastDeltas=[],{stamp:r,chips:i,page:n.page,fromYear:e,toYear:Math.floor(t.ctx.year)}},R=(r,i)=>{C(null),v(!1);let a=Re(i);if(r.kind===`gameover`){gc(a)?(d(a),l(`between`),s(r)):e.onOver(r.result);return}s(r),gc(a)?(d(a),l(`between`)):l(`event`);let o=t.snapshot();o&&bs(o,n)};(0,r.useEffect)(()=>{if(A.current)return;if(A.current=!0,t.beats.length>0){k.current=t.beats.length;let n=t.currentPrompt();if(n){if(n.kind===`gameover`){e.onOver(n.result);return}s(n),l(`event`);return}}let n=Math.floor(t.ctx.year);R(t.advance(),n)},[]),(0,r.useEffect)(()=>{window.scrollTo({top:0})},[c,o]);let z=e=>{if(!o||o.kind!==`event`)return;let n=Math.floor(t.ctx.year),r=t.choose(e);R(r,n)},ze=e=>{if(!o||o.kind!==`event`||ee)return;let t=o.choices[e];if(t){if(zo(o.card,t)&&S!==e){C(e);return}C(null),t.check?(v(!0),setTimeout(()=>z(e),520)):z(e)}},B=(e,n)=>{if(!o||o.kind!==`breakthrough`)return;let r=Math.floor(t.ctx.year),i=t.decideBreakthrough(e,n);t.lastBreakthrough&&e&&(x(t.lastBreakthrough),setTimeout(()=>x(null),2e3)),R(i,r)},Be=()=>{if(o?.kind===`gameover`){e.onOver(o.result);return}l(`event`)},Ve=(e,t)=>{if(!e)return null;let n=e===`命关`?Ds.命关:Us[e];return n?(0,$.jsx)(`div`,{className:`card-art scene-art`,dangerouslySetInnerHTML:{__html:n}},e):(0,$.jsx)(`div`,{className:`card-orn`,dangerouslySetInnerHTML:{__html:Bs(t)}},`orn-${e}`)},V=(e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`mini-scene`,children:[e.title&&(0,$.jsxs)(`span`,{className:`mini-t`,children:[`【`,e.title,`】`]}),(0,$.jsxs)(`span`,{className:`mini-x`,children:[a(e.text).split(`
...
`).filter(e=>e.trim()!==``);return t.length>1?`${t[0]}…`:t[0]??``},Ue=e=>{let t=e.beats.find(e=>e.kind===`scene`),n=e.beats.find(e=>e.kind===`choice`),r=e.beats.find(e=>e.kind===`outcome`);return(0,$.jsxs)(`div`,{className:`years-unit`,children:[t&&(0,$.jsxs)(`div`,{className:`yu-scene`,children:[t.title&&(0,$.jsxs)(`span`,{className:`yu-t`,children:[`【`,t.title,`】`]}),(0,$.jsx)(`span`,{children:He(t.text)})]}),n&&(0,$.jsxs)(`div`,{className:`yu-choice`,children:[`——`,a(n.text)]}),r&&(0,$.jsx)(`div`,{className:`yu-outcome`,children:He(r.text)})]},e.episodeId)},We=()=>{if(!u)return null;let{page:e}=u,t=u.toYear-u.fromYear,n=e.player.flatMap(e=>e.beats.filter(e=>e.kind!==`scene`));return(0,$.jsxs)(`div`,{className:`page-card`,ref:de,onClick:Ie,children:[(0,$.jsx)(`div`,{className:`between-head`,children:(0,$.jsx)(`div`,{className:`year-mark`,children:t>1?`第 ${u.fromYear} — ${u.toYear} 年`:`第 ${u.toYear} 年`})}),(0,$.jsxs)(`div`,{className:`between-body`,children:[(u.stamp||u.chips.length>0||n.length>0)&&(0,$.jsxs)(`section`,{className:`res-player`,children:[u.stamp&&(0,$.jsx)(`div`,{className:`stamp-row`,children:(0,$.jsx)(`span`,{className:`stamp ${u.stamp.cls}`,children:u.stamp.label})}),u.chips.length>0&&(0,$.jsx)(`div`,{className:`delta-chips`,children:u.chips.map((e,t)=>(0,$.jsx)(`span`,{className:`dchip d-${e.kind}`,children:e.text},t))}),n.map((e,t)=>e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line${Fe(`pb-${t}`)}`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome${Fe(`pb-${t}`)}`,children:a(e.text)},t):V(e,t))]}),e.loose.map(V),e.auto.length>0&&(0,$.jsxs)(`section`,{className:`years-sec`,children:[(0,$.jsx)(`div`,{className:`years-head`,children:`这些年里`}),e.auto.map(Ue)]})]}),e.transition&&(0,$.jsx)(`div`,{className:`passage trans`,children:a(e.transition.text)}),(0,$.jsx)(`div`,{className:`page-foot`,children:(0,$.jsx)(`button`,{className:`primary-btn`,onClick:Be,children:o?.kind===`gameover`?`盖 棺`:`继 续`})})]})},Ge=()=>{if(!o)return null;if(o.kind===`event`){let e=o.card.tags?.includes(`岔路`),t=a(o.text).split(`
`).filter(e=>e.trim()!==``),n=.1,r=Math.min(t.length*n+.2,1.3);return(0,$.jsxs)(`div`,{className:`page-card`,ref:de,onClick:Ie,children:[Ve(o.card.id,o.card.tags),(0,$.jsxs)(`div`,{className:`page-body`,children:[e&&(0,$.jsx)(`div`,{className:`fork-badge rv`,children:`岔 · 人生节点`}),(0,$.jsxs)(`div`,{className:`t rv`,children:[`【`,o.card.title,`】`]}),t.map((e,t)=>(0,$.jsx)(`p`,{className:`rv${Fe(`ev-${t}`)}`,style:{animationDelay:`${Math.min(t*n,1.1)}s`},children:e},t))]}),(0,$.jsx)(`div`,{className:`page-foot`,children:ee?(0,$.jsx)(`div`,{className:`roll`,children:`天 机 演 算`}):(0,$.jsx)(`div`,{className:`inline-choices rv`,style:{animationDelay:`${r}s`},children:o.choices.map((e,t)=>{if(S===t){let n=Ro(o.card,e);return(0,$.jsxs)(`div`,{className:`confirm-block`,children:[(0,$.jsx)(`div`,{className:`confirm-choice`,children:a(e.text)}),(0,$.jsx)(`div`,{className:`risk-tags`,children:n.map((e,t)=>(0,$.jsx)(`span`,{className:`risk-tag r-${e.level}`,children:e.text},t))}),(0,$.jsxs)(`div`,{className:`confirm-row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>C(null),children:`再想想`}),(0,$.jsx)(`button`,{className:`confirm-go`,onClick:()=>ze(t),children:`依此而行`})]})]},t)}return(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>ze(t),children:[(0,$.jsx)(`span`,{className:`idx`,children:t+1}),a(e.text),zo(o.card,e)&&(0,$.jsx)(`span`,{className:`grave-mark`,children:`重`}),e.check&&(0,$.jsx)(`span`,{className:`check-mark`,children:`占`})]},t)})})})]},o.card.id)}if(o.kind!==`breakthrough`)return null;let e=t.ctx.actor;return(0,$.jsxs)(`div`,{className:`page-card`,ref:de,onClick:Ie,children:[Ve(`命关`),(0,$.jsxs)(`div`,{className:`page-body`,children:[(0,$.jsx)(`div`,{className:`t rv`,children:`【命关】`}),(0,$.jsx)(`p`,{className:`rv${Fe(`bt-0`)}`,style:{animationDelay:`0.1s`},children:Le(o)})]}),(0,$.jsx)(`div`,{className:`page-foot`,children:(0,$.jsxs)(`div`,{className:`inline-choices rv`,style:{animationDelay:`0.4s`},children:[(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>B(!0,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`1`}),`冲关`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>B(!0,!0),children:[(0,$.jsx)(`span`,{className:`idx`,children:`2`}),`稳中求进，兼冲隐藏之境`,e.道心>58?``:`（道心尚浅，凶险）`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>B(!1,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`3`}),`再温养几年`]})]})})]},`bt-${t.ctx.tick}`)},U=t.ctx.actor,Ke=Ft(U.path,U.tier),qe=Ht(U.path,U.tier,U.sublevel);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`topbar`,children:[(0,$.jsx)(`button`,{className:`tb-name`,onClick:()=>p(!0),children:i}),(0,$.jsxs)(`button`,{className:`tb-sub`,onClick:()=>p(!0),children:[qe,U.tier<10?` ${Math.round(U.sublevel*100)}%`:``,` · `,Math.floor(t.ctx.year),`年`]}),(0,$.jsx)(`span`,{className:`grow`}),sc(e.game).map((e,t)=>(0,$.jsx)(`span`,{className:`chip ${e.cls}`,children:e.text},t)),(()=>{let e=t.bagSlots(),n=e.free===0;return(0,$.jsxs)(`button`,{className:`tb-bag ${n?`full`:``}`,onClick:()=>re(!0),"aria-label":`行囊，${t.stones()} 下品灵石，${e.used} 之 ${e.total} 格`,title:n?`${e.container} 已满`:e.container,children:[(0,$.jsxs)(`span`,{className:`tbb-stone`,children:[`⟡`,Xs(t.stones())]}),(0,$.jsxs)(`span`,{className:`tbb-slot`,children:[e.used,`/`,e.total]})]})})(),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>_(!0),children:`回顾`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onQuit,children:`搁笔`})]}),(0,$.jsx)(`div`,{className:`realm-bar`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(U.sublevel*100)}%`}})}),c===`between`?We():Ge(),b&&(0,$.jsxs)(`div`,{className:`bt-overlay ${b.ok?`bt-ok`:`bt-fail`}`,onClick:()=>x(null),children:[(0,$.jsx)(`div`,{className:`bt-word`,children:b.ok?b.name:`劫`}),(0,$.jsx)(`div`,{className:`bt-sub`,children:b.ok?b.hidden?`且入隐秘之境`:`境界已成`:`未过 · ${b.name}`}),b.ok&&U.goldenCoreGrade>0&&U.tier===3&&(0,$.jsx)(`div`,{className:`bt-core ${y(U.goldenCoreGrade)?`top`:``}`,children:It(U.path,U.goldenCoreGrade)})]}),t.availablePools().length===0?null:(0,$.jsx)(`button`,{className:`oracle-pill`,onClick:()=>{w(!0),le(null),ie(null),oe([])},children:`✦ 机缘`}),te&&(()=>{let e=t.availablePools(),r=e.find(e=>e.id===se)??e[0],i=t.poolInfo(r.id),o=()=>{if(D)return;ie(null);let e=t.poolInfo(r.id);if(e&&!e.affordable){ie(e.missing.map(e=>e.text).join(`；`));return}ce(!0),le(null),setTimeout(()=>{let e=t.tryDrawFrom(r.id);oe(t.notices.slice(1)),k.current=t.beats.length,t.notices.length=0,le(e.result??null),e.ok||ie(e.reason??`这一卦求不得`),ce(!1),ue(e=>e+1);let i=t.snapshot();i&&bs(i,n)},900)},s=(O?.prize.effects??[]).map(e=>/^give\s+(\S+)/.exec(e)?.[1]).filter(e=>!!e).map(e=>H(e)).find(e=>e?.equip&&t.bag().some(t=>t.def.id===e.id&&!t.stack.equipped));return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>!D&&w(!1)}),(0,$.jsxs)(`div`,{className:`oracle-panel fade-in`,children:[(0,$.jsx)(`div`,{className:`oracle-tabs`,children:e.map(e=>(0,$.jsx)(`button`,{className:`oracle-tab ${e.id===r.id?`on`:``}`,onClick:()=>{E(e.id),le(null),ie(null),oe([])},children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`oracle-stage`,children:D?(0,$.jsx)(`div`,{className:`oracle-shake`,children:`签 筒 摇 动`}):O?(0,$.jsxs)(`div`,{className:`oracle-prize r-${ai.indexOf(O.rarity)}`,children:[(0,$.jsx)(`div`,{className:`op-rarity`,children:O.rarity===`极品`?`✦ 极 品 ✦`:O.rarity}),(0,$.jsx)(`div`,{className:`op-name`,children:O.prize.name}),(0,$.jsx)(`div`,{className:`op-desc`,children:a(O.prize.desc)}),O.rarity===`极品`&&(0,$.jsx)(`div`,{className:`op-uniq`,children:`此物世上只此一件。你拿了它，就不会再有第二件。`}),O.byPity&&(0,$.jsx)(`div`,{className:`op-pity`,children:`连番落空之后，天道补了你一次`})]}):(0,$.jsx)(`div`,{className:`oracle-idle`,children:rc[r.id]??``})}),ae.length>0&&!D&&(0,$.jsx)(`div`,{className:`oracle-notes`,children:ae.map((e,t)=>(0,$.jsx)(`div`,{className:`on-line`,children:a(e)},t))}),s&&!D&&(0,$.jsxs)(`button`,{className:`oracle-wear`,onClick:()=>{let e=t.equipItem(s.id);oe(t=>[...t,e.text]),k.current=t.beats.length,t.notices.length=0,ue(e=>e+1);let r=t.snapshot();r&&bs(r,n)},children:[`即刻佩上「`,s.name,`」（`,s.equip?.slot,`）`]}),i&&(()=>{let e=pi(U,r,t.gacha),n=i.odds.极品,a=t.gacha,o=(r.prizes.极品?.length??0)>0,s=U.tier>=G.minTier,c=U.气运>=G.minLuck,l=Ft(U.path,G.minTier),u=[{ok:s,text:s?`修为已至【${l}】`:`修为须至【${l}】—— 今为【${Ke}】`},{ok:c,text:c?`气运 ${Math.round(U.气运)}，已过 ${G.minLuck} 这道坎`:`气运须过 ${G.minLuck} —— 今为 ${Math.round(U.气运)}`},{ok:!!a.seenSecret,text:a.seenSecret?`本局已亲见过一件秘藏`:`本局须亲见过一件秘藏 —— 没见过的东西，天不会先给你`}];a.supremeTaken&&u.push({ok:!1,text:`此生已得过一件独一无二之物 —— 天不予二`}),o||u.push({ok:!1,text:`${r.name}里本就没有这样的东西`});let d=!e.ok&&u.every(e=>e.ok)?e.reasons:[],f=Math.max(0,ci.threshold-i.pityLeft);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`odds-bar`,children:ai.map((e,t)=>e===`极品`?n>0?(0,$.jsx)(`div`,{className:`odds-seg r-5 hair`,title:`极品 ${ac(n)}`},e):null:(0,$.jsx)(`div`,{className:`odds-seg r-${t}`,style:{flex:Math.max(.02,i.odds[e])},title:`${e} ${ac(i.odds[e])}`},e))}),(0,$.jsx)(`div`,{className:`odds-legend`,children:ai.map((e,t)=>(0,$.jsxs)(`span`,{className:`ol r-${t}${e===`极品`&&n<=0?` off`:``}`,children:[e,` `,ac(i.odds[e])]},e))}),(0,$.jsxs)(`div`,{className:`supreme-box ${e.ok?`open`:``}`,children:[(0,$.jsxs)(`div`,{className:`sb-head`,children:[(0,$.jsx)(`span`,{className:`sb-mark`,children:`✦`}),(0,$.jsx)(`span`,{className:`sb-t`,children:`极品`}),(0,$.jsx)(`span`,{className:`sb-x`,children:e.ok?`此刻确在筒里 · ${ac(n)}`:`此刻不在筒里 —— 摇多少次都不会出`})]}),(0,$.jsxs)(`div`,{className:`sb-list`,children:[u.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li ${e.ok?`yes`:`no`}`,children:[(0,$.jsx)(`i`,{children:e.ok?`✓`:`✗`}),e.text]},t)),d.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li no`,children:[(0,$.jsx)(`i`,{children:`✗`}),e]},`f${t}`))]}),(0,$.jsx)(`div`,{className:`sb-fine`,children:`世上只此一件，一局只出一件。`})]}),(0,$.jsxs)(`div`,{className:`pity-row`,children:[(0,$.jsx)(`div`,{className:`pity-bar`,"aria-hidden":`true`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(f/ci.threshold*100)}%`}})}),(0,$.jsxs)(`div`,{className:`pity-t`,children:[i.pityLeft>0?`再 ${i.pityLeft} 次落空，必得【宝品】以上`:`时来运转已满 —— 下一次必得【宝品】以上`,(0,$.jsxs)(`em`,{children:[`保底只保到宝品／仙品／秘藏这三档。`,(0,$.jsx)(`b`,{children:`极品不在保底之列`}),` —— 攒出来的东西不叫意外。`]})]})]}),(0,$.jsxs)(`div`,{className:`oracle-meta`,children:[`气运 `,Math.round(U.气运),` · 已求 `,i.count,` 次`]})]})})(),(0,$.jsxs)(`div`,{className:`oracle-cost ${i&&!i.affordable?`lack`:``}`,children:[`代价：`,i?.costText??r.costLabel]}),(0,$.jsxs)(`div`,{className:`oracle-purse`,children:[`囊中 ⟡ `,Xs(t.stones()),` 下品 · 余 `,t.bagSlots().free,` 格`]}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:i.missing.map((e,t)=>(0,$.jsx)(`div`,{className:`om-line`,children:e.text},t))}),T&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:(0,$.jsx)(`div`,{className:`om-line`,children:T})}),(0,$.jsx)(`button`,{className:`oracle-btn`,disabled:D||!!i&&!i.affordable,onClick:o,children:D?`……`:i&&!i.affordable?`付 不 起`:`求 一 次`}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-fine`,children:`先去挣够了再来 —— 这里从没有免费的运气。`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>!D&&w(!1),children:`收手`})]})]})})(),t.ctx.systems.length>0&&(0,$.jsxs)(`button`,{className:`sys-pill`,onClick:()=>h(!0),children:[(0,$.jsx)(`span`,{className:`sys-dot`}),`系统`]}),m&&(()=>{let n=t.ctx.systems.map(t=>e.game.session.systemDef(t)).filter(e=>!!e);return n.length===0?null:(0,$.jsx)(Gs,{session:t,systems:n,onClose:()=>h(!1),onAct:()=>{t.signIn(),k.current=t.beats.length,t.notices.length=0,ue(e=>e+1)}})})(),ne&&(0,$.jsx)(Qs,{session:t,transform:a,onClose:()=>re(!1),onAct:()=>{k.current=t.beats.length,t.notices.length=0,ue(e=>e+1);let e=t.snapshot();e&&bs(e,n)}}),g&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>_(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`回顾`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:`此生至今 · 亦即将来书上的正文`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>_(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`history-scroll`,children:[t.beats.map((e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`scene past`,style:{margin:`14px 0 4px`},children:[e.title&&(0,$.jsxs)(`div`,{className:`t`,children:[`【`,e.title,`】`]}),(0,$.jsx)(`div`,{className:`x`,children:a(e.text)})]},t):e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line past`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome`,children:a(e.text)},t):e.kind===`milestone`?(0,$.jsxs)(`div`,{className:`milestone`,children:[`◈ `,a(e.text)]},t):e.kind===`transition`?(0,$.jsx)(`div`,{className:`passage`,children:a(e.text)},t):(0,$.jsx)(`div`,{className:`notice`,children:a(e.text)},t)),t.beats.length===0&&(0,$.jsx)(`div`,{className:`notice`,children:`故事才刚要开始。`})]})]})]}),f&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>p(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:i}),(0,$.jsxs)(`span`,{className:`sheet-sub`,children:[U.path,U.sect?` · ${Yr(U.sect)?.name??U.sect}`:``,` · `,U.talent.root,` · `,U.originRevealed?`身负「${U.origin}」`:`身世未明`]}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>p(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`kv`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`境界`}),(0,$.jsxs)(`b`,{children:[qe,`（`,Math.round(U.sublevel*100),`%）`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`近来修行`}),(0,$.jsx)(`b`,{children:Nr(t.stance)})]}),U.goldenCoreGrade>0&&(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`结丹`}),(0,$.jsx)(`b`,{className:y(U.goldenCoreGrade)?`core-top`:``,children:It(U.path,U.goldenCoreGrade)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`寿元`}),(0,$.jsxs)(`b`,{children:[Math.floor(U.ageMonths/12),` / `,U.lifespanYears]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`道心`}),(0,$.jsx)(`b`,{children:Math.round(U.道心)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`气运`}),(0,$.jsx)(`b`,{children:Math.round(U.气运)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`功德`}),(0,$.jsx)(`b`,{children:Math.round(U.功德)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`业障`}),(0,$.jsx)(`b`,{children:Math.round(U.业障)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`僭越`}),(0,$.jsx)(`b`,{children:Math.round(U.僭越)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`堕度`}),(0,$.jsx)(`b`,{children:Math.round(U.堕度)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`丹毒`}),(0,$.jsx)(`b`,{children:Math.round(U.丹毒)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`名望`}),(0,$.jsx)(`b`,{children:Math.round(U.名望)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`悟性`}),(0,$.jsx)(`b`,{children:U.talent.悟性})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`根骨`}),(0,$.jsx)(`b`,{children:U.talent.根骨})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`神魂`}),(0,$.jsx)(`b`,{children:U.talent.神魂})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`纯度`}),(0,$.jsx)(`b`,{children:Math.round(U.talent.purity)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`真实战力`}),(0,$.jsx)(`b`,{children:Ce(U).toFixed(2)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`藏拙`}),(0,$.jsxs)(`b`,{children:[Math.round(we(U)*100),`%`]})]})]}),(t.ctx.systems.length>0||U.souls.some(e=>!e.dissipated))&&(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[t.ctx.systems.length>0&&(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`金手指：`,t.ctx.systems.join(`、`)]}),U.souls.filter(e=>!e.dissipated).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`残魂 `,e.name,` —— 好感 `,Math.round(e.favor),` · 夺舍 `,Math.round(e.possession),`%`]},e.id))]}),(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`未了因果：恶 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,`· 善 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity>0).length,t.ctx.knowers.length?` · 知情者 ${t.ctx.knowers.length} 人`:``]}),[`金手指`,`残魂`,`真实修为`,`杀过某人`,`身世`].filter(e=>U.secrets[e]>=25).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`暴露 · `,e,`：`,Math.round(U.secrets[e])]},e))]}),(0,$.jsxs)(`div`,{className:`sheet-sec voice-sec`,children:[(0,$.jsx)(`div`,{className:`vs-head`,children:`声`}),(0,$.jsxs)(`div`,{className:`vs-row`,children:[(0,$.jsxs)(`div`,{className:`vs-main`,children:[(0,$.jsx)(`div`,{className:`vs-name`,children:`朗读与环境音`}),(0,$.jsx)(`div`,{className:`vs-note`,children:pe?`正在备嗓…`:j?`念对白与关键句，背景按当下的场景配环境音`:`默认关着。开了会念出声 —— 手机请先调好音量`})]}),(0,$.jsx)(`button`,{type:`button`,role:`switch`,"aria-checked":j,"aria-label":`朗读与环境音`,className:`vs-switch${j?` on`:``}`,disabled:pe,onClick:ke,children:(0,$.jsx)(`i`,{})})]}),!j&&(0,$.jsx)(`div`,{className:`sheet-hint`,children:`iPhone / iPad 上，声音必须由你亲手点一下才允许响 —— 上面这个开关就是那一下，打开之后本局都不必再点。`}),j&&P&&!P.speech&&(0,$.jsx)(`div`,{className:`vs-warn`,children:`本机不支持朗读（浏览器没给 speechSynthesis），只有环境音。`}),j&&P?.speech&&!P.chinese&&(0,$.jsx)(`div`,{className:`vs-warn`,children:`本机没有中文音色，会用默认嗓子念，可能读不准 —— 不是 bug。`}),j&&P&&!P.webAudio&&(0,$.jsx)(`div`,{className:`vs-warn`,children:`本机不支持 Web Audio，没有环境音，朗读照常。`}),j&&be>0&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`vs-detail`,children:[(0,$.jsx)(`div`,{className:`vs-sub`,children:`念多少`}),(0,$.jsx)(`div`,{className:`vs-chips`,children:uc.map(e=>(0,$.jsx)(`button`,{type:`button`,className:`vs-chip${N===e?` on`:``}`,"aria-pressed":N===e,onClick:()=>{fe(e),mc(lc,e)},children:e},e))}),(0,$.jsx)(`div`,{className:`vs-note`,children:fc[N]})]}),(0,$.jsxs)(`label`,{className:`vs-slider`,children:[(0,$.jsx)(`span`,{className:`vs-sub`,children:`语速`}),(0,$.jsx)(`input`,{type:`range`,min:.6,max:2,step:.05,value:ge,onChange:e=>{let t=Number(e.target.value);_e(t),L.current?.engine.setRate(t)}}),(0,$.jsxs)(`b`,{children:[ge.toFixed(2),`×`]})]}),(0,$.jsxs)(`label`,{className:`vs-slider`,children:[(0,$.jsx)(`span`,{className:`vs-sub`,children:`环境音`}),(0,$.jsx)(`input`,{type:`range`,min:0,max:1,step:.05,value:ve,onChange:e=>{let t=Number(e.target.value);F(t),L.current?.engine.setAmbientVolume(t)}}),(0,$.jsx)(`b`,{children:Math.round(ve*100)})]}),(0,$.jsx)(`div`,{className:`sheet-hint`,children:`翻页会自动停上一段；正在念的那一句左边有一道细金线，点画面任意处即停。`})]})]})]})]})]})}function vc(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function yc(e){return vc(e).replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`).replace(/`([^`]+)`/g,`<code>$1</code>`)}function bc(e){let t=[],n=!1,r=[],i=[],a=[],o=()=>{a.length&&(t.push(`<p>${a.map(yc).join(`
`)}</p>`),a=[])},s=()=>{i.length&&(t.push(`<blockquote>${i.map(yc).join(`
`)}</blockquote>`),i=[])};for(let c of e.split(`
`)){if(c.startsWith("```")){o(),s(),n&&(t.push(`<pre class="mono">${vc(r.join(`
`))}</pre>`),r.length=0),n=!n;continue}if(n){r.push(c);continue}if(c.startsWith(`### `)){o(),s(),t.push(`<h3>${yc(c.slice(4))}</h3>`);continue}if(c.startsWith(`## `)){o(),s(),t.push(`<h2>${yc(c.slice(3))}</h2>`);continue}if(c.startsWith(`# `)){o(),s(),t.push(`<h1>${yc(c.slice(2))}</h1>`);continue}if(c.trim()===`---`){o(),s(),t.push(`<hr/>`);continue}if(c.startsWith(`> `)||c===`>`){o(),i.push(c.replace(/^> ?/,``));continue}if(c.startsWith(`- `)){o(),s(),t.push(`<li>${yc(c.slice(2))}</li>`);continue}if(c.trim()===``){o(),s();continue}s(),a.push(c)}return o(),s(),n&&r.length&&t.push(`<pre class="mono">${vc(r.join(`
`))}</pre>`),t.join(`
`)}function xc(e){let{game:t,result:n}=e,[i,a]=(0,r.useState)(`成书`),[o,s]=(0,r.useState)(t.pov===`我`?`我`:`他`),c=(0,r.useMemo)(()=>o===`他`?n.novel:Fo({daoName:t.name,seed:t.seed,beats:t.session.beats,chronicle:n.chronicle,stele:n.stele,signature:t.session.signature(),pov:`我`}),[o,t,n]);return(0,$.jsxs)(`div`,{className:`over fade-in`,children:[(0,$.jsxs)(`div`,{className:`ending-grade`,children:[n.stele.grade,` · `,n.stele.serial]}),(0,$.jsx)(`div`,{className:`ending-name`,children:n.ending.name}),(0,$.jsx)(`div`,{className:`ending-text`,children:n.ending.text}),(0,$.jsxs)(`div`,{className:`ending-text`,style:{marginTop:4},children:[`道果 +`,n.daoFruit,`（累计 `,e.save.registry.daoFruit,`）`]}),(0,$.jsx)(`div`,{className:`tabs`,children:[`成书`,`一生录`,`道碑`].map(e=>(0,$.jsx)(`button`,{className:`tab ${i===e?`on`:``}`,onClick:()=>a(e),children:e},e))}),i===`成书`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn ${o===`他`?`on`:``}`,onClick:()=>s(`他`),children:`传记体`}),(0,$.jsx)(`button`,{className:`ghost-btn ${o===`我`?`on`:``}`,onClick:()=>s(`我`),children:`自述体`}),(0,$.jsx)(`span`,{className:`grow`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{let e=new Blob([c],{type:`text/markdown;charset=utf-8`}),n=document.createElement(`a`);n.href=URL.createObjectURL(e),n.download=`藏锋录·${t.name}${o===`我`?`自述`:`卷`}.md`,n.click(),URL.revokeObjectURL(n.href)},children:`下载此书`})]}),(0,$.jsx)(`div`,{className:`book`,dangerouslySetInnerHTML:{__html:bc(c)}})]}),i===`一生录`&&(0,$.jsx)(`pre`,{className:`mono`,children:dr(n.chronicle)}),i===`道碑`&&(0,$.jsx)(`pre`,{className:`mono`,children:br(n.stele)}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:10},children:(0,$.jsx)(`button`,{className:`primary-btn`,style:{flex:1},onClick:e.onRestart,children:`再 入 轮 回`})}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`},children:(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onGallery,children:`去碑林看看`})})]})}function Sc(e){let[t,n]=(0,r.useState)(null),i=[...e.save.steles].reverse(),a=hs(e.save);return(0,$.jsxs)(`div`,{className:`gallery fade-in`,children:[(0,$.jsx)(`h2`,{children:`碑 林`}),(0,$.jsxs)(`div`,{className:`row`,style:{justifyContent:`center`,color:`var(--dim)`,fontSize:`0.85rem`},children:[Object.entries(a).map(([e,t])=>(0,$.jsxs)(`span`,{children:[e,`×`,t]},e)),i.length===0&&(0,$.jsx)(`span`,{children:`（空山无碑。去走一遭吧。）`})]}),i.map(e=>(0,$.jsxs)(`div`,{className:`stele-item`,onClick:()=>n(t===e.serial?null:e.serial),children:[(0,$.jsxs)(`div`,{className:`sh`,children:[(0,$.jsx)(`span`,{className:`grade`,children:e.grade}),(0,$.jsx)(`span`,{className:`nm`,children:e.daoName}),(0,$.jsxs)(`span`,{className:`meta`,children:[e.ending,` · `,e.finalRealm,` · 寿`,e.lifespan,`载 · 完满度`,e.perfection]}),(0,$.jsx)(`span`,{className:`meta`,children:`★`.repeat(e.rarity)})]}),t===e.serial&&(0,$.jsx)(`pre`,{className:`mono`,style:{marginTop:10},children:br(e)})]},e.serial)),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:12},children:(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:e.onBack,children:`回到入口`})})]})}function Cc(){let[e,t]=(0,r.useState)($o);return(0,r.useEffect)(()=>es(t),[]),e}function wc({load:e}){let t=e.total>0?e.done/e.total:0;return e.status===`error`?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Ns,{progress:t,label:`香火中断`}),(0,$.jsx)(`div`,{style:{position:`fixed`,inset:0,zIndex:61,pointerEvents:`none`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`flex-end`,paddingBottom:`14vh`},children:(0,$.jsxs)(`div`,{style:{pointerEvents:`auto`,maxWidth:`20rem`,textAlign:`center`},children:[(0,$.jsx)(`div`,{style:{fontSize:`.78rem`,opacity:.75,lineHeight:1.6},children:e.error}),(0,$.jsx)(`button`,{className:`primary-btn`,onClick:fs,children:`重 燃`})]})})]}):(0,$.jsx)(Ns,{progress:t})}function Tc(){let e=Cc(),t=e.db,[n]=(0,r.useState)(()=>_s()),[i,a]=(0,r.useState)(`cover`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),f=(e,t)=>{Cs();let r=new Go({seed:t.seed,db:e,registry:n.registry,name:t.name,birthplace:t.birthplace});l({session:r,seed:t.seed,name:t.name,pov:t.pov,birthplace:t.birthplace}),d(null),a(`play`)},p=e=>{let t=Ss();if(t)try{let r=new Go({seed:t.snap.seed,db:e,registry:n.registry,restore:t.snap});l({session:r,seed:t.snap.seed,name:t.snap.name,pov:t.pov}),d(null),a(`play`)}catch{Cs()}},m=e=>{t?f(t,e):s({kind:`start`,cfg:e})},h=()=>{t?p(t):s({kind:`resume`})};return(0,r.useEffect)(()=>{!t||!o||(s(null),o.kind===`start`?f(t,o.cfg):p(t))},[t,o]),e.total<=0&&!t?(0,$.jsx)(wc,{load:e}):(0,$.jsxs)(`div`,{className:`shell`,children:[i===`cover`&&(0,$.jsx)(Ps,{save:n,onEnter:()=>a(`start`),onResume:h,onGallery:()=>a(`gallery`)}),i===`start`&&(0,$.jsx)(As,{save:n,onStart:m,onResume:h,onGallery:()=>a(`gallery`)}),i===`play`&&c&&(0,$.jsx)(_c,{game:c,onOver:e=>{Cs(),n.steles.push(e.stele),vs(n),d(e),a(`over`)},onQuit:()=>a(`start`)}),i===`over`&&c&&u&&(0,$.jsx)(xc,{game:c,result:u,save:n,onRestart:()=>a(`start`),onGallery:()=>a(`gallery`)}),i===`gallery`&&(0,$.jsx)(Sc,{save:n,onBack:()=>a(`cover`)}),o&&(0,$.jsx)(wc,{load:e})]})}(0,i.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(Tc,{}));
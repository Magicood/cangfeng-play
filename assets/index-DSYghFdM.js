...
`)}var wa=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function X(e){if(e<10)return wa[e];if(e<20)return`十${e%10?wa[e%10]:``}`;if(e<100)return`${wa[Math.floor(e/10)]}十${e%10?wa[e%10]:``}`;if(e<1e3){let t=e%100;return`${wa[Math.floor(e/100)]}百${t===0?``:t<10?`零${wa[t]}`:X(t)}`}return String(e)}function Ta(e,t,n){if(e<2)return null;let r=Math.floor(e);return r<4?[`转过年去，又是一年。`,`两三年一晃而过。`,`此后两年，山中无事。`][r%3]:r<12?`此后${X(r)}年，无事。`:r<50?`一晃，便是${X(r)}年。`:t>=4?`这一坐，便是${X(r)}年。出关那日，${n}认得的凡人，坟头草都换了几茬。`:`${X(r)}年过去了。山下已经换了人间。`}var Ea=new Set([`危机`,`冲突`,`战争`,`渡劫`,`心魔`,`怪谈`,`长期敌对`,`打脸`]),Da=new Set([`日常`,`市井`,`人情`,`人间`,`江湖`,`修行`,`修炼`]);function Oa(e){return e.some(e=>Ea.has(e))?`tight`:e.some(e=>Da.has(e))?`loose`:`neutral`}var ka=[`话音未落——`,`这事没完。`,`一波未平，一波又起。`,`事情赶着事情来。`],Aa=[`不过数日。`,`转过月来。`,`一晃，月余。`],ja=e=>[`不过数日，你已到了${e}。`,`一路晓行夜宿，你到了${e}。`,`你离了旧处，落脚${e}。`],Ma=[`转过年去。`,`一晃两年。`,`第二年上，诸事平平。`],Na=(e,t)=>[`第二年开春你离了${e}，一路到了${t}。`,`这两年你换了地方，如今落脚在${t}。`,`转过年去，你已在${t}住下。`];function Pa(e,t,n){let r=[`此后${X(t)}年，无事。`,`一晃，便是${X(t)}年。`];return t>=12&&r.push(`${X(t)}年过去了。山下已经换了人间。`),t>=12&&n>=4&&r.push(`这一坐，便是${X(t)}年。出关那日，你认得的凡人，坟头草都换了几茬。`),e.pick(r)}var Fa=e=>[`再动身时，你已在${e}。`,`出来走动这一趟，你到了${e}。`],Ia=[`这一日，祸事寻上门来。`,`麻烦找上门来，没有一点先兆。`,`这天夜里，有人寻到了你的门前。`],La=[`日子照旧过。这天，有桩事寻到你面前。`,`这天，来了个不速之客。`],Ra=[`这天，有件事找到你头上。`,`又有一桩事，寻上门来。`],za=[`这天夜里——`,`偏在这时，出了事。`,`变故来得没有一点声响。`],Ba=[`闲事一桩，却也躲不开。`,`日子照旧过。这天，眼前起了点小波澜。`],Va=[`这天，出了件事。`,`这一日，眼前起了桩事。`,`该来的，总会来。`],Ha=(e,t)=>t?[`你把手头的事一一了结，往${e}投师去。`,`收拾了行装，你往${e}拜山去。`]:[`你把手头的事一一了结，往${e}去。`,`收拾了行装，你径直往${e}去。`,`这一日，你动身往${e}去。`],Ua=[`主意既定，这一日，你去办那件盘算已久的事。`,`这天，你把手头的事撂下，专程赴那一桩去。`,`心里那点念头搁了许久，这天，你终于动了身。`],Wa=[`你把手头的事一一了结，收拾行装，投师去。`,`这一日，你打定了拜师的主意，动身去了。`],Ga=new Set([`拜山`,`入门考核`]),Ka=[`丹田里那点东西，再也压不住了。`,`气机满盈，关口就在眼前。`,`这一夜，周天转到极处——关口到了。`];function qa(e,t){if(t.chained)return e.pick(ka);let n=t.from!==t.to,r=Math.floor(Math.max(0,t.gapYears)),i=t.premise===`起意`&&t.nextKind===`event`,a;i?a=t.gapYears<1?e.pick(Aa):r<=3?e.pick(Ma):Pa(e,r,t.tier):t.gapYears<1?a=n?e.pick(ja(t.to)):e.pick(Aa):r<=3?a=n?e.pick(Na(t.from,t.to)):e.pick(Ma):(a=Pa(e,r,t.tier),n&&(a+=e.pick(Fa(t.to))));let o=Oa(t.nextTags),s=t.premise===`上门`,c=t.nextTags.some(e=>Ga.has(e)),l=t.nextKind===`breakthrough`?e.pick(Ka):i?n?e.pick(Ha(t.to,c)):e.pick(c?Wa:Ua):o===`tight`?e.pick(s?Ia:za):o===`loose`?e.pick(s?La:Ba):e.pick(s?Ra:Va);return`${a}${l}`}function Ja(e,t){return Ca(e,`他`,t)}var Ya=3;function Xa(e){let t=[],n={title:`起于微末`,beats:[]};for(let r of e){let e=r.isMajor&&(r.kind===`scene`||r.kind===`milestone`);e&&n.beats.length>=Ya?(t.push(n),n={title:r.title??r.text.slice(0,12),beats:[r]}):(e&&n.beats.length<Ya&&r.title&&(n.title=n.beats.length===0?r.title??n.title:`${n.title} · ${r.title}`),n.beats.push(r))}return n.beats.length&&t.push(n),t}function Za(e,t,n){let r=e.text.trim();if(!r)return null;switch(e.kind){case`scene`:return Ca(r,t,n);case`choice`:return r.startsWith(`「`)?r.replace(/^「【[^】]*】/,`「`):`—— ${Ca(r,t,t===`我`?`我`:`他`)}`;case`outcome`:case`notice`:return Ca(r,t,t===`我`?`我`:`他`);case`transition`:return Ca(r,t,n);case`milestone`:return`是年，${Ca(r,t,n)}${/[。！？」]$/.test(r)?``:`。`}`}}function Qa(e){let t=new Set,n=[],r=!1;for(let i=0;i<e.length;i++){let a=e[i];if(a.kind===`transition`){let o=e[i+1];if(o&&o.kind===`scene`&&o.evId&&t.has(o.evId)&&!o.isMajor)continue;r=!1,n.push(a);continue}if(a.kind===`scene`){if(a.evId&&t.has(a.evId)&&!a.isMajor){r=!0;continue}a.evId&&t.add(a.evId),r=!1,n.push(a);continue}(a.kind===`choice`||a.kind===`outcome`)&&r||((a.kind===`milestone`||a.kind===`notice`)&&(r=!1),n.push(a))}return n}function $a(e){let{daoName:t,chronicle:n,stele:r}=e,i=e.pov??`他`,a=[];a.push(`# 藏锋录 · ${t}${i===`我`?`自述`:`卷`}`),a.push(``),a.push(`> ${e.signature}`),a.push(`>`),a.push(`> —— ${t}${n.origin!==`凡俗`&&n.ending.tier!==`夭折`?`，${n.origin}`:``}，寿${X(n.lifespan)}载`),a.push(``);let o=Xa(Qa(e.beats)),s=null,c=null,l=i===`我`?`我`:t;if(o.forEach((e,n)=>{a.push(`## 第${X(n+1)}回 · ${e.title}`),a.push(``);for(let n of e.beats){if(s!==null&&n.kind===`scene`&&c!==`transition`){let e=Ta(n.year-s,n.tier,l);e&&(a.push(e),a.push(``))}let e=Za(n,i,t);e&&(a.push(e),a.push(``)),s=n.year,c=n.kind}}),a.push(`## 终 · ${n.ending.name}`),a.push(``),i===`我`&&(a.push(`*（自述至此而止。以下数页为后人所补。）*`),a.push(``)),a.push(Ja(n.ending.text,t)),a.push(``),n.deathChain){a.push(`后来有人翻起这段公案，把前因后果排了出来：`),a.push(``);for(let e of n.deathChain.split(`
...
</svg>`,Wo=`<svg viewBox="0 0 390 80" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,Go={tianshu:`<svg viewBox="0 0 240 110" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true">
  <defs>
...
</svg>`},Ko={冲突:`<svg viewBox="0 0 390 90" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},ss={evt_diyitiao_renming:`<svg viewBox="0 0 390 240" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},cs={...os,...ss},ls={cheap:{title:e=>`— ${e.split(``).join(` `)} v1.0 —`,greet:`尊贵的宿主，欢迎回来！`,act:`今 日 签 到`,fine:`* 签到即留痕。系统提醒宿主：天机可循，慎用。`},data:{title:e=>`[ ${e} ]`,greet:`模块就绪。数据流同步完成。`,act:`执 行`,fine:`// 每次调用都会在天机中留下一条记录`},ink:{title:e=>`${e}`,greet:`心念微动，那物应了一声。`,act:`运 转`,fine:`用之有度。器不欺主，主亦不当欺器。`},terminal:{title:e=>`root@heaven:~# ${e}`,greet:`> 权限校验通过。当前身份：临时执法者（编号待定）`,act:`EXEC`,fine:`# 所有操作计入天规日志，由下一任天道审计`},meta:{title:e=>`${e}`,greet:`……你确定这是游戏的一部分吗？`,act:`继 续`,fine:`（这段文字不应该出现在这里。）`}};function us(e){let[t,n]=(0,r.useState)(0),i=e.systems[t];if(!i)return(0,$.jsx)($.Fragment,{});let a=ls[i.skin]??ls.data,o=i.id===`签到`,s=e.session.beats,c=s.length>0?s[s.length-1].text:``,l=c.includes(i.name)||c.includes(i.id);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sys-panel skin-${i.skin} fade-in`,children:[e.systems.length>1&&(0,$.jsx)(`div`,{className:`sys-switch`,children:e.systems.map((e,r)=>(0,$.jsx)(`button`,{className:`sys-chip ${r===t?`on`:``}`,onClick:()=>n(r),children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`sys-title`,children:a.title(i.name)}),(0,$.jsx)(`div`,{className:`sys-line`,children:a.greet}),(0,$.jsx)(`div`,{className:`sys-line sys-desc`,children:i.desc}),o&&(0,$.jsx)(`button`,{className:`sys-btn`,onClick:e.onAct,children:a.act}),l&&(0,$.jsx)(`div`,{className:`sys-line sys-log`,children:c}),(0,$.jsxs)(`div`,{className:`sys-line sys-cost`,children:[`代价：`,i.cost]}),(0,$.jsx)(`div`,{className:`sys-line sys-fine`,children:a.fine}),(0,$.jsx)(`button`,{className:`linklike`,style:{marginTop:10},onClick:e.onClose,children:`关闭`})]})]})}var ds=[`法宝`,`符箓`,`丹药`,`功法`,`材料`,`杂物`,`灵石`],fs=`零一二三四五六七八九`,ps=[``,`十`,`百`,`千`];function ms(e){if(!Number.isFinite(e)||e<0||e===0)return`零`;if(e>999)return String(e);let t=String(e),n=``,r=!1;for(let e=0;e<t.length;e++){let i=Number(t[e]),a=t.length-e-1;if(i===0){r=!0;continue}r&&n&&(n+=`零`),r=!1,(i!==1||a!==1||e!==0)&&(n+=fs[i]),n+=ps[a]}return n}function hs(e){return e>=1e5?`${Math.floor(e/1e4)}万`:e>=1e4?`${(e/1e4).toFixed(1)}万`:String(e)}function gs(e){return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,`,`)}function _s(e){let{session:t}=e,n=e.transform,[i,a]=(0,r.useState)(`全部`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),[,f]=(0,r.useState)(0),p=t.bag(),m=t.bagSlots(),h=t.stones(),g=t.inventory(),_=mt(g),ee=t.ctx.actor.tier,v=_e(g.container),y=m.free===0?ot(g):null,b=e=>`${e.def.id}|${z(e.stack)}`,x=o?p.find(e=>b(e)===o)??p.find(e=>e.def.id===o.split(`|`)[0])??null:null,S=()=>{e.onAct(),f(e=>e+1)},C=(e,n)=>{l({ok:e.ok,text:e.text}),S(),e.ok&&!t.bag().some(e=>e.def.id===n)&&s(null)},te=(e,n)=>{let r=t.inventory().container,i=t.useItem(e);if(C(i,e),i.ok&&n){let e=t.inventory().container;if(e!==r){let t=_e(e);d({name:t.id,note:t.note}),setTimeout(()=>d(null),2200)}}},w=new Map;for(let e of p)w.set(e.def.category,(w.get(e.def.category)??0)+1);let ne=ds.filter(e=>w.has(e)),T=i===`全部`?p:p.filter(e=>e.def.category===i),E=i===`全部`?Math.min(m.free,12):0,D=i===`全部`?m.free-E:0,re=e=>p.find(t=>t.stack.equipped===e),O=c?(0,$.jsx)(`div`,{className:`bag-msg ${c.ok?`good`:`bad`}`,children:n(c.text)}):null;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay bag-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sheet bag-sheet fade-in`,role:`dialog`,"aria-label":`行囊`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`行囊`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:v.id}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onClose,children:`收起`})]}),(0,$.jsxs)(`div`,{className:`bag-cap`,children:[(0,$.jsxs)(`div`,{className:`bag-cap-line`,children:[(0,$.jsxs)(`b`,{children:[ms(m.total),`格`]}),(0,$.jsxs)(`span`,{children:[`，`,m.used===0?`空着`:`已满${ms(m.used)}`]}),(0,$.jsx)(`i`,{className:m.free===0?`full`:``,children:m.free===0?`再装不下了`:`余 ${ms(m.free)} 格`})]}),(0,$.jsx)(`div`,{className:`bag-bar`,children:(0,$.jsx)(`i`,{className:m.free===0?`full`:``,style:{width:`${Math.min(100,Math.round(m.used/Math.max(1,m.total)*100))}%`}})}),(0,$.jsx)(`div`,{className:`bag-note`,children:v.note}),y&&(0,$.jsxs)(`div`,{className:`bag-warn`,children:[`装满了。最不值钱的是`,(0,$.jsx)(`b`,{children:Be(y.def,z(y.stack))}),`（约值 `,gs(Math.round(Ye(y.stack))),` 下品）—— 要腾地方，先舍它。`]})]}),(0,$.jsxs)(`div`,{className:`bag-purse`,children:[(0,$.jsxs)(`span`,{className:`bp-sum`,children:[`⟡ `,gs(h),` `,(0,$.jsx)(`i`,{children:`折下品`})]}),(0,$.jsxs)(`span`,{className:`bp-split`,children:[me.map(e=>_[e]>0?(0,$.jsxs)(`em`,{children:[e,` `,_[e]]},e):null),h===0&&(0,$.jsx)(`em`,{className:`none`,children:`身无分文`})]})]}),_.极品>0&&(0,$.jsxs)(`div`,{className:`bag-jstone`,children:[(0,$.jsx)(`span`,{className:`bj-mark`,children:`✦`}),(0,$.jsxs)(`span`,{className:`bj-t`,children:[`极品灵石 `,(0,$.jsxs)(`b`,{children:[`×`,_.极品]})]}),(0,$.jsx)(`span`,{className:`bj-x`,children:`这不是钱。市面上没有摊主找得开 —— 付账时它不会被拆开， 除非低阶灵石实在凑不出，才会有一枚被迫破开。`})]}),(0,$.jsx)(`div`,{className:`bag-ladder`,children:he.map(e=>(0,$.jsx)(`span`,{className:`bl-step ${e.id===v.id?`on`:e.slots<v.slots?`past`:``}`,title:`${e.slots} 格 · ${e.note}`,children:e.id},e.id))}),(0,$.jsx)(`div`,{className:`bag-slots-row`,children:Ve.map(e=>{let t=re(e);return(0,$.jsxs)(`button`,{className:`eq-slot ${t?`on`:``}`,onClick:()=>t&&s(b(t)),disabled:!t,children:[(0,$.jsx)(`i`,{children:e}),(0,$.jsx)(`b`,{className:t?`r-${t.def.grade-1}`:``,children:t?Be(t.def,z(t.stack)):`空`})]},e)})}),!x&&O,ne.length>1&&(0,$.jsxs)(`div`,{className:`bag-tabs`,children:[(0,$.jsxs)(`button`,{className:`bag-tab ${i===`全部`?`on`:``}`,onClick:()=>a(`全部`),children:[`全部 `,p.length]}),ne.map(e=>(0,$.jsxs)(`button`,{className:`bag-tab ${i===e?`on`:``}`,onClick:()=>a(e),children:[e,` `,w.get(e)]},e))]}),(0,$.jsxs)(`div`,{className:`bag-grid`,children:[T.map((e,t)=>{let n=z(e.stack),r=!R(e.def)&&n!==2;return(0,$.jsxs)(`button`,{className:`bag-slot r-${e.def.grade-1} ${e.stack.equipped?`on`:``}`,style:e.def.slots>1?{gridColumn:`span 2`}:void 0,onClick:()=>{s(b(e)),l(null)},children:[(0,$.jsx)(`span`,{className:`bs-name`,children:e.def.name}),(0,$.jsxs)(`span`,{className:`bs-foot`,children:[(0,$.jsx)(`i`,{className:`bs-grade${e.def.grade>=6?` top`:``}`,children:ke(e.def.grade)}),r&&(0,$.jsx)(`i`,{className:`bs-q q${n}`,children:Le(n)}),e.stack.qty>1&&(0,$.jsxs)(`i`,{className:`bs-qty`,children:[`×`,e.stack.qty]})]}),e.stack.equipped&&(0,$.jsx)(`span`,{className:`bs-eq`,children:`佩`}),e.def.slots>1&&(0,$.jsxs)(`span`,{className:`bs-big`,children:[`占`,ms(e.def.slots),`格`]})]},`${e.def.id}-${t}`)}),Array.from({length:E},(e,t)=>(0,$.jsx)(`span`,{className:`bag-slot empty`,"aria-hidden":`true`},`e${t}`))]}),T.length===0&&(0,$.jsx)(`div`,{className:`bag-empty`,children:i===`全部`?`空空如也。修士的第一件家当，多半是别人不要的。`:`没有${i}。`}),D>0&&(0,$.jsxs)(`div`,{className:`bag-note`,style:{textAlign:`center`,marginTop:8},children:[`另余 `,D,` 格`]})]}),x&&(()=>{let e=x.def,r=z(x.stack),i=!!x.stack.equipped,a=e.container?_e(e.container):null,o=a?a.slots<=v.slots?`${v.id}比${a.id}还宽敞，换了是往回走`:ee<a.minTier?`神识撑不开${a.id} —— 须得${a.minTier}阶以上`:null:null,c=e.equip?.minTier!=null&&ee<e.equip.minTier,u=!!a||!!e.use&&e.use.length>0;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay detail-overlay`,onClick:()=>{s(null),l(null)}}),(0,$.jsxs)(`div`,{className:`bag-detail fade-in`,role:`dialog`,"aria-label":e.name,children:[(0,$.jsxs)(`div`,{className:`bd-head`,children:[(0,$.jsx)(`span`,{className:`bd-name r-${e.grade-1}`,children:Be(e,r)}),(0,$.jsxs)(`span`,{className:`bd-tag${e.grade>=6?` top`:``}`,children:[ke(e.grade),` · `,e.category]}),i&&(0,$.jsxs)(`span`,{className:`bd-worn`,children:[`佩于`,x.stack.equipped]})]}),(0,$.jsx)(`div`,{className:`bd-desc`,children:n(e.desc)}),e.grade>=6&&(0,$.jsxs)(`div`,{className:`bd-uniq`,children:[(0,$.jsx)(`span`,{className:`bu-mark`,children:`✦`}),e.stone?`不是钱。没有摊主找得开 —— 除非低阶灵石实在凑不出，付账时它不会被拆开。`:`世上只此一件。它不会有第二件，前主人的账也一并转到了你身上。`]}),(0,$.jsxs)(`div`,{className:`bd-meta`,children:[(0,$.jsxs)(`span`,{children:[`占 `,ms(e.slots),` 格`]}),(0,$.jsxs)(`span`,{children:[`值 `,gs(Math.round(e.value*(R(e)?1:Fe[r]))),` 下品`]}),x.stack.qty>1&&(0,$.jsxs)(`span`,{children:[`身上 `,x.stack.qty,` 件`]}),e.talisman&&(0,$.jsxs)(`span`,{children:[e.talisman,`符`]})]}),e.equip&&(0,$.jsxs)(`div`,{className:`bd-equip`,children:[(0,$.jsx)(`b`,{children:e.equip.slot}),Object.entries(e.equip.factors).map(([e,t])=>(0,$.jsxs)(`span`,{className:`bd-fac`,children:[e,` +`,t.toFixed(2)]},e))]}),c&&!i&&(0,$.jsx)(`div`,{className:`bd-warn`,children:`越阶用宝：佩得上，但压不住 —— 明眼人一看便知你身后有人（真实修为暴露）。`}),a&&!o&&(0,$.jsxs)(`div`,{className:`bd-hint`,children:[`换用之后可装 `,a.slots,` 格。`,a.note]}),o&&(0,$.jsx)(`div`,{className:`bd-warn`,children:o}),!u&&!e.equip&&!(e.grade>=6&&e.stone)&&(0,$.jsx)(`div`,{className:`bd-hint`,children:e.stone?`钱不必手动动它 —— 付账时自会拆开找零。`:`用不上。但总有人要，也总有人认得。`}),O,(0,$.jsxs)(`div`,{className:`bd-acts`,children:[e.equip&&(i?(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>C(t.unequipItem(e.id),e.id),children:`卸 下`}):(0,$.jsx)(`button`,{className:`primary-btn slim`,onClick:()=>C(t.equipItem(e.id),e.id),children:`佩 上`})),u&&(0,$.jsx)(`button`,{className:`primary-btn slim`,disabled:!!o,onClick:()=>te(e.id,!!a),children:a?`换 用`:e.category===`丹药`?`服 下`:`用 掉`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{s(null),l(null)},children:`收 起`})]})]})]})})(),u&&(0,$.jsxs)(`div`,{className:`bag-flash`,onClick:()=>d(null),children:[(0,$.jsx)(`div`,{className:`bf-word`,children:u.name}),(0,$.jsx)(`div`,{className:`bf-sub`,children:u.note})]})]})}var vs={oracle:`坊市街口的卦摊。几个铜板一卦 —— 问得多了，天也会烦。`,relic:`荒山野岭的旧坟古洞。前人的东西好拿，前人的账也跟着来。`,alchemy:`自己开炉。费材料费时间，但炉子是自己的。`},ys={CRIT_SUCCESS:{label:`大成`,cls:`s-crit`},SUCCESS:{label:`成`,cls:`s-ok`},FAIL:{label:`败`,cls:`s-fail`},CRIT_FAIL:{label:`大凶`,cls:`s-cfail`}};function bs(e){if(!(e>0))return`—`;let t=e*100;return t>=1?`${t.toFixed(1)}%`:t>=.1?`${t.toFixed(2)}%`:`${t.toFixed(4)}%`}function xs(e){let t=Math.round(e*100);return t>=80?`八九成`:t>=60?`六七成`:t>=40?`四五成`:t>=20?`两三成`:`一线`}function Ss(e){let t=e.session.ctx.actor,n=[],r=t.lifespanYears-t.ageMonths/12;r<15&&n.push({text:`寿余${Math.max(0,r).toFixed(0)}`,cls:`hot`}),t.僭越>=51&&n.push({text:`僭越${Math.round(t.僭越)}`,cls:t.僭越>=101?`hot`:`warn`}),t.堕度>=46&&n.push({text:`堕度${Math.round(t.堕度)}`,cls:t.堕度>=76?`hot`:`warn`}),t.丹毒>=50&&n.push({text:`丹毒${Math.round(t.丹毒)}`,cls:t.丹毒>=80?`hot`:`warn`});let i=t.souls.find(e=>!e.dissipated&&e.possession>=60);return i&&n.push({text:`魂扰${Math.round(i.possession)}`,cls:i.possession>=85?`hot`:`warn`}),n.slice(0,2)}function Cs(e){return e.page.player.length>0||e.page.auto.length>0||e.page.loose.length>0||e.page.transition!==null||e.stamp!==null||e.chips.length>0}function ws(e){let{session:t,pov:n,name:i}=e.game,a=e=>Ca(e,n,i),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(`event`),[u,d]=(0,r.useState)(null),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(!1),[g,_]=(0,r.useState)(!1),[ee,v]=(0,r.useState)(!1),[b,x]=(0,r.useState)(null),[S,C]=(0,r.useState)(null),[te,w]=(0,r.useState)(!1),[ne,T]=(0,r.useState)(!1),[E,D]=(0,r.useState)(null),[re,O]=(0,r.useState)([]),[ie,k]=(0,r.useState)(`oracle`),[A,ae]=(0,r.useState)(!1),[j,oe]=(0,r.useState)(null),[,se]=(0,r.useState)(0),M=(0,r.useRef)(0),N=(0,r.useRef)(!1),ce=(0,r.useRef)(null),le=e=>{let n=t.gatherPage(M.current);M.current=n.cursor,t.notices.length=0;let r=t.lastOutcome?ys[t.lastOutcome]??null:null,i=[...t.lastDeltas];return t.lastOutcome=null,t.lastDeltas=[],{stamp:r,chips:i,page:n.page,fromYear:e,toYear:Math.floor(t.ctx.year)}},P=(r,i)=>{C(null),v(!1);let a=le(i);if(r.kind===`gameover`){Cs(a)?(d(a),l(`between`),s(r)):e.onOver(r.result);return}s(r),Cs(a)?(d(a),l(`between`)):l(`event`);let o=t.snapshot();o&&zo(o,n)};(0,r.useEffect)(()=>{if(N.current)return;if(N.current=!0,t.beats.length>0){M.current=t.beats.length;let n=t.currentPrompt();if(n){if(n.kind===`gameover`){e.onOver(n.result);return}s(n),l(`event`);return}}let n=Math.floor(t.ctx.year);P(t.advance(),n)},[]),(0,r.useEffect)(()=>{window.scrollTo({top:0})},[c,o]);let ue=e=>{if(!o||o.kind!==`event`)return;let n=Math.floor(t.ctx.year),r=t.choose(e);P(r,n)},de=e=>{if(!o||o.kind!==`event`||ee)return;let t=o.choices[e];if(t){if(ro(o.card,t)&&S!==e){C(e);return}C(null),t.check?(v(!0),setTimeout(()=>ue(e),520)):ue(e)}},fe=(e,n)=>{if(!o||o.kind!==`breakthrough`)return;let r=Math.floor(t.ctx.year),i=t.decideBreakthrough(e,n);t.lastBreakthrough&&e&&(x(t.lastBreakthrough),setTimeout(()=>x(null),2e3)),P(i,r)},pe=()=>{if(o?.kind===`gameover`){e.onOver(o.result);return}l(`event`)},F=(e,t)=>{if(!e)return null;let n=e===`命关`?Ko.命关:cs[e];return n?(0,$.jsx)(`div`,{className:`card-art scene-art`,dangerouslySetInnerHTML:{__html:n}},e):(0,$.jsx)(`div`,{className:`card-orn`,dangerouslySetInnerHTML:{__html:as(t)}},`orn-${e}`)},me=(e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`mini-scene`,children:[e.title&&(0,$.jsxs)(`span`,{className:`mini-t`,children:[`【`,e.title,`】`]}),(0,$.jsxs)(`span`,{className:`mini-x`,children:[a(e.text).split(`
...
`).filter(e=>e.trim()!==``),n=.1,r=Math.min(t.length*n+.2,1.3);return(0,$.jsxs)(`div`,{className:`page-card`,ref:ce,children:[F(o.card.id,o.card.tags),(0,$.jsxs)(`div`,{className:`page-body`,children:[e&&(0,$.jsx)(`div`,{className:`fork-badge rv`,children:`岔 · 人生节点`}),(0,$.jsxs)(`div`,{className:`t rv`,children:[`【`,o.card.title,`】`]}),t.map((e,t)=>(0,$.jsx)(`p`,{className:`rv`,style:{animationDelay:`${Math.min(t*n,1.1)}s`},children:e},t))]}),(0,$.jsx)(`div`,{className:`page-foot`,children:ee?(0,$.jsx)(`div`,{className:`roll`,children:`天 机 演 算`}):(0,$.jsx)(`div`,{className:`inline-choices rv`,style:{animationDelay:`${r}s`},children:o.choices.map((e,t)=>{if(S===t){let n=no(o.card,e);return(0,$.jsxs)(`div`,{className:`confirm-block`,children:[(0,$.jsx)(`div`,{className:`confirm-choice`,children:a(e.text)}),(0,$.jsx)(`div`,{className:`risk-tags`,children:n.map((e,t)=>(0,$.jsx)(`span`,{className:`risk-tag r-${e.level}`,children:e.text},t))}),(0,$.jsxs)(`div`,{className:`confirm-row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>C(null),children:`再想想`}),(0,$.jsx)(`button`,{className:`confirm-go`,onClick:()=>de(t),children:`依此而行`})]})]},t)}return(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>de(t),children:[(0,$.jsx)(`span`,{className:`idx`,children:t+1}),a(e.text),ro(o.card,e)&&(0,$.jsx)(`span`,{className:`grave-mark`,children:`重`}),e.check&&(0,$.jsx)(`span`,{className:`check-mark`,children:`占`})]},t)})})})]},o.card.id)}if(o.kind!==`breakthrough`)return null;let e=t.ctx.actor;return(0,$.jsxs)(`div`,{className:`page-card`,ref:ce,children:[F(`命关`),(0,$.jsxs)(`div`,{className:`page-body`,children:[(0,$.jsx)(`div`,{className:`t rv`,children:`【命关】`}),(0,$.jsx)(`p`,{className:`rv`,style:{animationDelay:`0.1s`},children:a(`修为已至大圆满，气机满盈，可冲击【${U(t.ctx.actor.path,o.toTier)}】。\n你掂量了一下 —— 约莫${xs(o.estimate)}把握。`)})]}),(0,$.jsx)(`div`,{className:`page-foot`,children:(0,$.jsxs)(`div`,{className:`inline-choices rv`,style:{animationDelay:`0.4s`},children:[(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>fe(!0,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`1`}),`冲关`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>fe(!0,!0),children:[(0,$.jsx)(`span`,{className:`idx`,children:`2`}),`稳中求进，兼冲隐藏之境`,e.道心>58?``:`（道心尚浅，凶险）`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>fe(!1,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`3`}),`再温养几年`]})]})})]},`bt-${t.ctx.tick}`)},L=t.ctx.actor,ve=U(L.path,L.tier),ye=Ut(L.path,L.tier,L.sublevel);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`topbar`,children:[(0,$.jsx)(`button`,{className:`tb-name`,onClick:()=>p(!0),children:i}),(0,$.jsxs)(`button`,{className:`tb-sub`,onClick:()=>p(!0),children:[ye,L.tier<10?` ${Math.round(L.sublevel*100)}%`:``,` · `,Math.floor(t.ctx.year),`年`]}),(0,$.jsx)(`span`,{className:`grow`}),Ss(e.game).map((e,t)=>(0,$.jsx)(`span`,{className:`chip ${e.cls}`,children:e.text},t)),(()=>{let e=t.bagSlots(),n=e.free===0;return(0,$.jsxs)(`button`,{className:`tb-bag ${n?`full`:``}`,onClick:()=>T(!0),"aria-label":`行囊，${t.stones()} 下品灵石，${e.used} 之 ${e.total} 格`,title:n?`${e.container} 已满`:e.container,children:[(0,$.jsxs)(`span`,{className:`tbb-stone`,children:[`⟡`,hs(t.stones())]}),(0,$.jsxs)(`span`,{className:`tbb-slot`,children:[e.used,`/`,e.total]})]})})(),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>_(!0),children:`回顾`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onQuit,children:`搁笔`})]}),(0,$.jsx)(`div`,{className:`realm-bar`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(L.sublevel*100)}%`}})}),c===`between`?_e():I(),b&&(0,$.jsxs)(`div`,{className:`bt-overlay ${b.ok?`bt-ok`:`bt-fail`}`,onClick:()=>x(null),children:[(0,$.jsx)(`div`,{className:`bt-word`,children:b.ok?b.name:`劫`}),(0,$.jsx)(`div`,{className:`bt-sub`,children:b.ok?b.hidden?`且入隐秘之境`:`境界已成`:`未过 · ${b.name}`}),b.ok&&L.goldenCoreGrade>0&&L.tier===3&&(0,$.jsx)(`div`,{className:`bt-core ${y(L.goldenCoreGrade)?`top`:``}`,children:Lt(L.path,L.goldenCoreGrade)})]}),t.availablePools().length===0?null:(0,$.jsx)(`button`,{className:`oracle-pill`,onClick:()=>{w(!0),oe(null),D(null),O([])},children:`✦ 机缘`}),te&&(()=>{let e=t.availablePools(),r=e.find(e=>e.id===ie)??e[0],i=t.poolInfo(r.id),o=()=>{if(A)return;D(null);let e=t.poolInfo(r.id);if(e&&!e.affordable){D(e.missing.map(e=>e.text).join(`；`));return}ae(!0),oe(null),setTimeout(()=>{let e=t.tryDrawFrom(r.id);O(t.notices.slice(1)),M.current=t.beats.length,t.notices.length=0,oe(e.result??null),e.ok||D(e.reason??`这一卦求不得`),ae(!1),se(e=>e+1);let i=t.snapshot();i&&zo(i,n)},900)},s=(j?.prize.effects??[]).map(e=>/^give\s+(\S+)/.exec(e)?.[1]).filter(e=>!!e).map(e=>V(e)).find(e=>e?.equip&&t.bag().some(t=>t.def.id===e.id&&!t.stack.equipped));return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>!A&&w(!1)}),(0,$.jsxs)(`div`,{className:`oracle-panel fade-in`,children:[(0,$.jsx)(`div`,{className:`oracle-tabs`,children:e.map(e=>(0,$.jsx)(`button`,{className:`oracle-tab ${e.id===r.id?`on`:``}`,onClick:()=>{k(e.id),oe(null),D(null),O([])},children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`oracle-stage`,children:A?(0,$.jsx)(`div`,{className:`oracle-shake`,children:`签 筒 摇 动`}):j?(0,$.jsxs)(`div`,{className:`oracle-prize r-${ni.indexOf(j.rarity)}`,children:[(0,$.jsx)(`div`,{className:`op-rarity`,children:j.rarity===`极品`?`✦ 极 品 ✦`:j.rarity}),(0,$.jsx)(`div`,{className:`op-name`,children:j.prize.name}),(0,$.jsx)(`div`,{className:`op-desc`,children:a(j.prize.desc)}),j.rarity===`极品`&&(0,$.jsx)(`div`,{className:`op-uniq`,children:`此物世上只此一件。你拿了它，就不会再有第二件。`}),j.byPity&&(0,$.jsx)(`div`,{className:`op-pity`,children:`连番落空之后，天道补了你一次`})]}):(0,$.jsx)(`div`,{className:`oracle-idle`,children:vs[r.id]??``})}),re.length>0&&!A&&(0,$.jsx)(`div`,{className:`oracle-notes`,children:re.map((e,t)=>(0,$.jsx)(`div`,{className:`on-line`,children:a(e)},t))}),s&&!A&&(0,$.jsxs)(`button`,{className:`oracle-wear`,onClick:()=>{let e=t.equipItem(s.id);O(t=>[...t,e.text]),M.current=t.beats.length,t.notices.length=0,se(e=>e+1);let r=t.snapshot();r&&zo(r,n)},children:[`即刻佩上「`,s.name,`」（`,s.equip?.slot,`）`]}),i&&(()=>{let e=ui(L,r,t.gacha),n=i.odds.极品,a=t.gacha,o=(r.prizes.极品?.length??0)>0,s=L.tier>=G.minTier,c=L.气运>=G.minLuck,l=U(L.path,G.minTier),u=[{ok:s,text:s?`修为已至【${l}】`:`修为须至【${l}】—— 今为【${ve}】`},{ok:c,text:c?`气运 ${Math.round(L.气运)}，已过 ${G.minLuck} 这道坎`:`气运须过 ${G.minLuck} —— 今为 ${Math.round(L.气运)}`},{ok:!!a.seenSecret,text:a.seenSecret?`本局已亲见过一件秘藏`:`本局须亲见过一件秘藏 —— 没见过的东西，天不会先给你`}];a.supremeTaken&&u.push({ok:!1,text:`此生已得过一件独一无二之物 —— 天不予二`}),o||u.push({ok:!1,text:`${r.name}里本就没有这样的东西`});let d=!e.ok&&u.every(e=>e.ok)?e.reasons:[],f=Math.max(0,ai.threshold-i.pityLeft);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`odds-bar`,children:ni.map((e,t)=>e===`极品`?n>0?(0,$.jsx)(`div`,{className:`odds-seg r-5 hair`,title:`极品 ${bs(n)}`},e):null:(0,$.jsx)(`div`,{className:`odds-seg r-${t}`,style:{flex:Math.max(.02,i.odds[e])},title:`${e} ${bs(i.odds[e])}`},e))}),(0,$.jsx)(`div`,{className:`odds-legend`,children:ni.map((e,t)=>(0,$.jsxs)(`span`,{className:`ol r-${t}${e===`极品`&&n<=0?` off`:``}`,children:[e,` `,bs(i.odds[e])]},e))}),(0,$.jsxs)(`div`,{className:`supreme-box ${e.ok?`open`:``}`,children:[(0,$.jsxs)(`div`,{className:`sb-head`,children:[(0,$.jsx)(`span`,{className:`sb-mark`,children:`✦`}),(0,$.jsx)(`span`,{className:`sb-t`,children:`极品`}),(0,$.jsx)(`span`,{className:`sb-x`,children:e.ok?`此刻确在筒里 · ${bs(n)}`:`此刻不在筒里 —— 摇多少次都不会出`})]}),(0,$.jsxs)(`div`,{className:`sb-list`,children:[u.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li ${e.ok?`yes`:`no`}`,children:[(0,$.jsx)(`i`,{children:e.ok?`✓`:`✗`}),e.text]},t)),d.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li no`,children:[(0,$.jsx)(`i`,{children:`✗`}),e]},`f${t}`))]}),(0,$.jsx)(`div`,{className:`sb-fine`,children:`世上只此一件，一局只出一件。`})]}),(0,$.jsxs)(`div`,{className:`pity-row`,children:[(0,$.jsx)(`div`,{className:`pity-bar`,"aria-hidden":`true`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(f/ai.threshold*100)}%`}})}),(0,$.jsxs)(`div`,{className:`pity-t`,children:[i.pityLeft>0?`再 ${i.pityLeft} 次落空，必得【宝品】以上`:`时来运转已满 —— 下一次必得【宝品】以上`,(0,$.jsxs)(`em`,{children:[`保底只保到宝品／仙品／秘藏这三档。`,(0,$.jsx)(`b`,{children:`极品不在保底之列`}),` —— 攒出来的东西不叫意外。`]})]})]}),(0,$.jsxs)(`div`,{className:`oracle-meta`,children:[`气运 `,Math.round(L.气运),` · 已求 `,i.count,` 次`]})]})})(),(0,$.jsxs)(`div`,{className:`oracle-cost ${i&&!i.affordable?`lack`:``}`,children:[`代价：`,i?.costText??r.costLabel]}),(0,$.jsxs)(`div`,{className:`oracle-purse`,children:[`囊中 ⟡ `,hs(t.stones()),` 下品 · 余 `,t.bagSlots().free,` 格`]}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:i.missing.map((e,t)=>(0,$.jsx)(`div`,{className:`om-line`,children:e.text},t))}),E&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:(0,$.jsx)(`div`,{className:`om-line`,children:E})}),(0,$.jsx)(`button`,{className:`oracle-btn`,disabled:A||!!i&&!i.affordable,onClick:o,children:A?`……`:i&&!i.affordable?`付 不 起`:`求 一 次`}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-fine`,children:`先去挣够了再来 —— 这里从没有免费的运气。`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>!A&&w(!1),children:`收手`})]})]})})(),t.ctx.systems.length>0&&(0,$.jsxs)(`button`,{className:`sys-pill`,onClick:()=>h(!0),children:[(0,$.jsx)(`span`,{className:`sys-dot`}),`系统`]}),m&&(()=>{let n=t.ctx.systems.map(t=>e.game.session.systemDef(t)).filter(e=>!!e);return n.length===0?null:(0,$.jsx)(us,{session:t,systems:n,onClose:()=>h(!1),onAct:()=>{t.signIn(),M.current=t.beats.length,t.notices.length=0,se(e=>e+1)}})})(),ne&&(0,$.jsx)(_s,{session:t,transform:a,onClose:()=>T(!1),onAct:()=>{M.current=t.beats.length,t.notices.length=0,se(e=>e+1);let e=t.snapshot();e&&zo(e,n)}}),g&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>_(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`回顾`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:`此生至今 · 亦即将来书上的正文`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>_(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`history-scroll`,children:[t.beats.map((e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`scene past`,style:{margin:`14px 0 4px`},children:[e.title&&(0,$.jsxs)(`div`,{className:`t`,children:[`【`,e.title,`】`]}),(0,$.jsx)(`div`,{className:`x`,children:a(e.text)})]},t):e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line past`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome`,children:a(e.text)},t):e.kind===`milestone`?(0,$.jsxs)(`div`,{className:`milestone`,children:[`◈ `,a(e.text)]},t):e.kind===`transition`?(0,$.jsx)(`div`,{className:`passage`,children:a(e.text)},t):(0,$.jsx)(`div`,{className:`notice`,children:a(e.text)},t)),t.beats.length===0&&(0,$.jsx)(`div`,{className:`notice`,children:`故事才刚要开始。`})]})]})]}),f&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>p(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:i}),(0,$.jsxs)(`span`,{className:`sheet-sub`,children:[L.path,L.sect?` · ${Yr(L.sect)?.name??L.sect}`:``,` · `,L.talent.root,` · `,L.originRevealed?`身负「${L.origin}」`:`身世未明`]}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>p(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`kv`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`境界`}),(0,$.jsxs)(`b`,{children:[ye,`（`,Math.round(L.sublevel*100),`%）`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`近来修行`}),(0,$.jsx)(`b`,{children:Pr(t.stance)})]}),L.goldenCoreGrade>0&&(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`结丹`}),(0,$.jsx)(`b`,{className:y(L.goldenCoreGrade)?`core-top`:``,children:Lt(L.path,L.goldenCoreGrade)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`寿元`}),(0,$.jsxs)(`b`,{children:[Math.floor(L.ageMonths/12),` / `,L.lifespanYears]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`道心`}),(0,$.jsx)(`b`,{children:Math.round(L.道心)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`气运`}),(0,$.jsx)(`b`,{children:Math.round(L.气运)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`功德`}),(0,$.jsx)(`b`,{children:Math.round(L.功德)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`业障`}),(0,$.jsx)(`b`,{children:Math.round(L.业障)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`僭越`}),(0,$.jsx)(`b`,{children:Math.round(L.僭越)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`堕度`}),(0,$.jsx)(`b`,{children:Math.round(L.堕度)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`丹毒`}),(0,$.jsx)(`b`,{children:Math.round(L.丹毒)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`名望`}),(0,$.jsx)(`b`,{children:Math.round(L.名望)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`悟性`}),(0,$.jsx)(`b`,{children:L.talent.悟性})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`根骨`}),(0,$.jsx)(`b`,{children:L.talent.根骨})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`神魂`}),(0,$.jsx)(`b`,{children:L.talent.神魂})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`纯度`}),(0,$.jsx)(`b`,{children:Math.round(L.talent.purity)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`真实战力`}),(0,$.jsx)(`b`,{children:Ce(L).toFixed(2)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`藏拙`}),(0,$.jsxs)(`b`,{children:[Math.round(we(L)*100),`%`]})]})]}),(t.ctx.systems.length>0||L.souls.some(e=>!e.dissipated))&&(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[t.ctx.systems.length>0&&(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`金手指：`,t.ctx.systems.join(`、`)]}),L.souls.filter(e=>!e.dissipated).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`残魂 `,e.name,` —— 好感 `,Math.round(e.favor),` · 夺舍 `,Math.round(e.possession),`%`]},e.id))]}),(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`未了因果：恶 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,`· 善 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity>0).length,t.ctx.knowers.length?` · 知情者 ${t.ctx.knowers.length} 人`:``]}),[`金手指`,`残魂`,`真实修为`,`杀过某人`,`身世`].filter(e=>L.secrets[e]>=25).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`暴露 · `,e,`：`,Math.round(L.secrets[e])]},e))]})]})]})]})}function Ts(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Es(e){return Ts(e).replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`).replace(/`([^`]+)`/g,`<code>$1</code>`)}function Ds(e){let t=[],n=!1,r=[],i=[],a=[],o=()=>{a.length&&(t.push(`<p>${a.map(Es).join(`
`)}</p>`),a=[])},s=()=>{i.length&&(t.push(`<blockquote>${i.map(Es).join(`
`)}</blockquote>`),i=[])};for(let c of e.split(`
`)){if(c.startsWith("```")){o(),s(),n&&(t.push(`<pre class="mono">${Ts(r.join(`
`))}</pre>`),r.length=0),n=!n;continue}if(n){r.push(c);continue}if(c.startsWith(`### `)){o(),s(),t.push(`<h3>${Es(c.slice(4))}</h3>`);continue}if(c.startsWith(`## `)){o(),s(),t.push(`<h2>${Es(c.slice(3))}</h2>`);continue}if(c.startsWith(`# `)){o(),s(),t.push(`<h1>${Es(c.slice(2))}</h1>`);continue}if(c.trim()===`---`){o(),s(),t.push(`<hr/>`);continue}if(c.startsWith(`> `)||c===`>`){o(),i.push(c.replace(/^> ?/,``));continue}if(c.startsWith(`- `)){o(),s(),t.push(`<li>${Es(c.slice(2))}</li>`);continue}if(c.trim()===``){o(),s();continue}s(),a.push(c)}return o(),s(),n&&r.length&&t.push(`<pre class="mono">${Ts(r.join(`
`))}</pre>`),t.join(`
`)}function Os(e){let{game:t,result:n}=e,[i,a]=(0,r.useState)(`成书`),[o,s]=(0,r.useState)(t.pov===`我`?`我`:`他`),c=(0,r.useMemo)(()=>o===`他`?n.novel:$a({daoName:t.name,seed:t.seed,beats:t.session.beats,chronicle:n.chronicle,stele:n.stele,signature:t.session.signature(),pov:`我`}),[o,t,n]);return(0,$.jsxs)(`div`,{className:`over fade-in`,children:[(0,$.jsxs)(`div`,{className:`ending-grade`,children:[n.stele.grade,` · `,n.stele.serial]}),(0,$.jsx)(`div`,{className:`ending-name`,children:n.ending.name}),(0,$.jsx)(`div`,{className:`ending-text`,children:n.ending.text}),(0,$.jsxs)(`div`,{className:`ending-text`,style:{marginTop:4},children:[`道果 +`,n.daoFruit,`（累计 `,e.save.registry.daoFruit,`）`]}),(0,$.jsx)(`div`,{className:`tabs`,children:[`成书`,`一生录`,`道碑`].map(e=>(0,$.jsx)(`button`,{className:`tab ${i===e?`on`:``}`,onClick:()=>a(e),children:e},e))}),i===`成书`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn ${o===`他`?`on`:``}`,onClick:()=>s(`他`),children:`传记体`}),(0,$.jsx)(`button`,{className:`ghost-btn ${o===`我`?`on`:``}`,onClick:()=>s(`我`),children:`自述体`}),(0,$.jsx)(`span`,{className:`grow`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{let e=new Blob([c],{type:`text/markdown;charset=utf-8`}),n=document.createElement(`a`);n.href=URL.createObjectURL(e),n.download=`藏锋录·${t.name}${o===`我`?`自述`:`卷`}.md`,n.click(),URL.revokeObjectURL(n.href)},children:`下载此书`})]}),(0,$.jsx)(`div`,{className:`book`,dangerouslySetInnerHTML:{__html:Ds(c)}})]}),i===`一生录`&&(0,$.jsx)(`pre`,{className:`mono`,children:fr(n.chronicle)}),i===`道碑`&&(0,$.jsx)(`pre`,{className:`mono`,children:xr(n.stele)}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:10},children:(0,$.jsx)(`button`,{className:`primary-btn`,style:{flex:1},onClick:e.onRestart,children:`再 入 轮 回`})}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`},children:(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onGallery,children:`去碑林看看`})})]})}function ks(e){let[t,n]=(0,r.useState)(null),i=[...e.save.steles].reverse(),a=Po(e.save);return(0,$.jsxs)(`div`,{className:`gallery fade-in`,children:[(0,$.jsx)(`h2`,{children:`碑 林`}),(0,$.jsxs)(`div`,{className:`row`,style:{justifyContent:`center`,color:`var(--dim)`,fontSize:`0.85rem`},children:[Object.entries(a).map(([e,t])=>(0,$.jsxs)(`span`,{children:[e,`×`,t]},e)),i.length===0&&(0,$.jsx)(`span`,{children:`（空山无碑。去走一遭吧。）`})]}),i.map(e=>(0,$.jsxs)(`div`,{className:`stele-item`,onClick:()=>n(t===e.serial?null:e.serial),children:[(0,$.jsxs)(`div`,{className:`sh`,children:[(0,$.jsx)(`span`,{className:`grade`,children:e.grade}),(0,$.jsx)(`span`,{className:`nm`,children:e.daoName}),(0,$.jsxs)(`span`,{className:`meta`,children:[e.ending,` · `,e.finalRealm,` · 寿`,e.lifespan,`载 · 完满度`,e.perfection]}),(0,$.jsx)(`span`,{className:`meta`,children:`★`.repeat(e.rarity)})]}),t===e.serial&&(0,$.jsx)(`pre`,{className:`mono`,style:{marginTop:10},children:xr(e)})]},e.serial)),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:12},children:(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:e.onBack,children:`回到入口`})})]})}function As(){let[e,t]=(0,r.useState)(vo);return(0,r.useEffect)(()=>yo(t),[]),e}function js({load:e}){let t=e.total>0?e.done/e.total:0;return e.status===`error`?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Qo,{progress:t,label:`香火中断`}),(0,$.jsx)(`div`,{style:{position:`fixed`,inset:0,zIndex:61,pointerEvents:`none`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`flex-end`,paddingBottom:`14vh`},children:(0,$.jsxs)(`div`,{style:{pointerEvents:`auto`,maxWidth:`20rem`,textAlign:`center`},children:[(0,$.jsx)(`div`,{style:{fontSize:`.78rem`,opacity:.75,lineHeight:1.6},children:e.error}),(0,$.jsx)(`button`,{className:`primary-btn`,onClick:jo,children:`重 燃`})]})})]}):(0,$.jsx)(Qo,{progress:t})}function Ms(){let e=As(),t=e.db,[n]=(0,r.useState)(()=>Io()),[i,a]=(0,r.useState)(`cover`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),f=(e,t)=>{Ho();let r=new lo({seed:t.seed,db:e,registry:n.registry,name:t.name,birthplace:t.birthplace});l({session:r,seed:t.seed,name:t.name,pov:t.pov,birthplace:t.birthplace}),d(null),a(`play`)},p=e=>{let t=Vo();if(t)try{let r=new lo({seed:t.snap.seed,db:e,registry:n.registry,restore:t.snap});l({session:r,seed:t.snap.seed,name:t.snap.name,pov:t.pov}),d(null),a(`play`)}catch{Ho()}},m=e=>{t?f(t,e):s({kind:`start`,cfg:e})},h=()=>{t?p(t):s({kind:`resume`})};return(0,r.useEffect)(()=>{!t||!o||(s(null),o.kind===`start`?f(t,o.cfg):p(t))},[t,o]),e.total<=0&&!t?(0,$.jsx)(js,{load:e}):(0,$.jsxs)(`div`,{className:`shell`,children:[i===`cover`&&(0,$.jsx)($o,{save:n,onEnter:()=>a(`start`),onResume:h,onGallery:()=>a(`gallery`)}),i===`start`&&(0,$.jsx)(Yo,{save:n,onStart:m,onResume:h,onGallery:()=>a(`gallery`)}),i===`play`&&c&&(0,$.jsx)(ws,{game:c,onOver:e=>{Ho(),n.steles.push(e.stele),Lo(n),d(e),a(`over`)},onQuit:()=>a(`start`)}),i===`over`&&c&&u&&(0,$.jsx)(Os,{game:c,result:u,save:n,onRestart:()=>a(`start`),onGallery:()=>a(`gallery`)}),i===`gallery`&&(0,$.jsx)(ks,{save:n,onBack:()=>a(`cover`)}),o&&(0,$.jsx)(js,{load:e})]})}(0,i.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(Ms,{}));
...
`)}var ia=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function X(e){if(e<10)return ia[e];if(e<20)return`十${e%10?ia[e%10]:``}`;if(e<100)return`${ia[Math.floor(e/10)]}十${e%10?ia[e%10]:``}`;if(e<1e3){let t=e%100;return`${ia[Math.floor(e/100)]}百${t===0?``:t<10?`零${ia[t]}`:X(t)}`}return String(e)}function aa(e,t,n){if(e<2)return null;let r=Math.floor(e);return r<4?[`转过年去，又是一年。`,`两三年一晃而过。`,`此后两年，山中无事。`][r%3]:r<12?`此后${X(r)}年，无事。`:r<50?`一晃，便是${X(r)}年。`:t>=4?`这一坐，便是${X(r)}年。出关那日，${n}认得的凡人，坟头草都换了几茬。`:`${X(r)}年过去了。山下已经换了人间。`}var oa=new Set([`危机`,`冲突`,`战争`,`渡劫`,`心魔`,`怪谈`,`长期敌对`,`打脸`]),sa=new Set([`日常`,`市井`,`人情`,`人间`,`江湖`,`修行`,`修炼`]);function ca(e){return e.some(e=>oa.has(e))?`tight`:e.some(e=>sa.has(e))?`loose`:`neutral`}var la=[`话音未落——`,`这事没完。`,`一波未平，一波又起。`,`事情赶着事情来。`],ua=[`不过数日。`,`转过月来。`,`一晃，月余。`],da=e=>[`不过数日，你已到了${e}。`,`一路晓行夜宿，你到了${e}。`,`你离了旧处，落脚${e}。`],fa=[`转过年去。`,`一晃两年。`,`第二年上，诸事平平。`],pa=(e,t)=>[`第二年开春你离了${e}，一路到了${t}。`,`这两年你换了地方，如今落脚在${t}。`,`转过年去，你已在${t}住下。`];function ma(e,t,n){let r=[`此后${X(t)}年，无事。`,`一晃，便是${X(t)}年。`];return t>=12&&r.push(`${X(t)}年过去了。山下已经换了人间。`),t>=12&&n>=4&&r.push(`这一坐，便是${X(t)}年。出关那日，你认得的凡人，坟头草都换了几茬。`),e.pick(r)}var ha=e=>[`再动身时，你已在${e}。`,`出来走动这一趟，你到了${e}。`],ga=[`这天夜里——`,`偏在这时，出了事。`,`变故来得没有一点声响。`,`这一日，祸事寻上门来。`],_a=[`日子照旧过。这天，有桩事寻到你面前。`,`这天，来了个不速之客。`,`闲事一桩，却也躲不开。`],va=[`这天，有件事找到你头上。`,`又有一桩事，寻上门来。`,`该来的，总会来。`],ya=[`丹田里那点东西，再也压不住了。`,`气机满盈，关口就在眼前。`,`这一夜，周天转到极处——关口到了。`];function ba(e,t){if(t.chained)return e.pick(la);let n=t.from!==t.to,r=Math.floor(Math.max(0,t.gapYears)),i;t.gapYears<1?i=n?e.pick(da(t.to)):e.pick(ua):r<=3?i=n?e.pick(pa(t.from,t.to)):e.pick(fa):(i=ma(e,r,t.tier),n&&(i+=e.pick(ha(t.to))));let a=ca(t.nextTags),o=t.nextKind===`breakthrough`?e.pick(ya):a===`tight`?e.pick(ga):a===`loose`?e.pick(_a):e.pick(va);return`${i}${o}`}function xa(e,t){return ra(e,`他`,t)}var Sa=3;function Ca(e){let t=[],n={title:`起于微末`,beats:[]};for(let r of e){let e=r.isMajor&&(r.kind===`scene`||r.kind===`milestone`);e&&n.beats.length>=Sa?(t.push(n),n={title:r.title??r.text.slice(0,12),beats:[r]}):(e&&n.beats.length<Sa&&r.title&&(n.title=n.beats.length===0?r.title??n.title:`${n.title} · ${r.title}`),n.beats.push(r))}return n.beats.length&&t.push(n),t}function wa(e,t,n){let r=e.text.trim();if(!r)return null;switch(e.kind){case`scene`:return ra(r,t,n);case`choice`:return r.startsWith(`「`)?r.replace(/^「【[^】]*】/,`「`):`—— ${ra(r,t,t===`我`?`我`:`他`)}`;case`outcome`:case`notice`:return ra(r,t,t===`我`?`我`:`他`);case`transition`:return ra(r,t,n);case`milestone`:return`是年，${ra(r,t,n)}${/[。！？」]$/.test(r)?``:`。`}`}}function Ta(e){let t=new Set,n=[],r=!1;for(let i=0;i<e.length;i++){let a=e[i];if(a.kind===`transition`){let o=e[i+1];if(o&&o.kind===`scene`&&o.evId&&t.has(o.evId)&&!o.isMajor)continue;r=!1,n.push(a);continue}if(a.kind===`scene`){if(a.evId&&t.has(a.evId)&&!a.isMajor){r=!0;continue}a.evId&&t.add(a.evId),r=!1,n.push(a);continue}(a.kind===`choice`||a.kind===`outcome`)&&r||((a.kind===`milestone`||a.kind===`notice`)&&(r=!1),n.push(a))}return n}function Ea(e){let{daoName:t,chronicle:n,stele:r}=e,i=e.pov??`他`,a=[];a.push(`# 藏锋录 · ${t}${i===`我`?`自述`:`卷`}`),a.push(``),a.push(`> ${e.signature}`),a.push(`>`),a.push(`> —— ${t}${n.origin!==`凡俗`&&n.ending.tier!==`夭折`?`，${n.origin}`:``}，寿${X(n.lifespan)}载`),a.push(``);let o=Ca(Ta(e.beats)),s=null,c=null,l=i===`我`?`我`:t;if(o.forEach((e,n)=>{a.push(`## 第${X(n+1)}回 · ${e.title}`),a.push(``);for(let n of e.beats){if(s!==null&&n.kind===`scene`&&c!==`transition`){let e=aa(n.year-s,n.tier,l);e&&(a.push(e),a.push(``))}let e=wa(n,i,t);e&&(a.push(e),a.push(``)),s=n.year,c=n.kind}}),a.push(`## 终 · ${n.ending.name}`),a.push(``),i===`我`&&(a.push(`*（自述至此而止。以下数页为后人所补。）*`),a.push(``)),a.push(xa(n.ending.text,t)),a.push(``),n.deathChain){a.push(`后来有人翻起这段公案，把前因后果排了出来：`),a.push(``);for(let e of n.deathChain.split(`
...
`))a.push(`> ${e}`);if(a.push(``),n.people.length){a.push(`### 书中诸人，后来`),a.push(``);for(let e of n.people.slice(0,8))a.push(`**${e.name}**（${xa(e.relation,t)}）`),a.push(``),a.push(xa(e.afterward,t)),a.push(``)}if(n.unfinished.length){a.push(`### 未了之事`),a.push(``);for(let e of n.unfinished)a.push(`- ${e}`);a.push(``),a.push(`（这些账没有随他入土。它们还在世上走动，等下一个人。）`),a.push(``)}return a.push(`### 碑拓`),a.push(``),a.push("```"),a.push(br(r)),a.push("```"),a.push(``),a.push(`*此书由一局真实的推演自动写成。世界种子 \`${e.seed}\` —— 持此种子者，可入同一世界，另写一卷。*`),a.push(``),a.join(`
`)}function Da(e){return e.replace(/[#>*`\-\s]/g,``).length}function Oa(e){return[...e.effects??[],...e.onCritSuccess?.effects??[],...e.onSuccess?.effects??[],...e.onFail?.effects??[],...e.onCritFail?.effects??[]]}function ka(e,t){let n=[],r=new Set,i=(e,t)=>{r.has(e)||(r.add(e),n.push({text:e,level:t}))};e.tags?.includes(`岔路`)&&i(`人生岔路 · 落子无悔`,`grave`);let a=t.karma;a&&a!==`none`&&(a.hooks?.some(e=>e.lethal)?i(`或招杀身之祸`,`grave`):a.weight>=40&&i(`结下重因果`,`warn`));for(let e of Oa(t)){let t=e.trim();t.startsWith(`fakeDeath`)?i(`假死脱身 · 尽弃身份人脉`,`grave`):t.startsWith(`stepDown`)?i(`就此止步 · 不再求进`,`grave`):t.startsWith(`devourSoul`)?i(`反吞残魂 · 败则身死`,`grave`):t.startsWith(`mergeSoul`)?i(`魂魄相融 · 不可分离`,`grave`):t.startsWith(`silence`)?i(`灭口 · 业障加身`,`grave`):t.startsWith(`bind.soul`)&&i(`引魂入体 · 祸福难料`,`warn`);let n=/^堕度 \+(\d+(?:\.\d+)?)/.exec(t);n&&Number(n[1])>=8&&i(`堕入邪道`,`grave`),n=/^lifespan -(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=5&&i(`折寿${n[1]}载`,`grave`),n=/^僭越 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=8&&i(`僭越大增 · 天道侧目`,`warn`),n=/^业障 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=20&&i(`业障深重`,`warn`),n=/^expose\.[^ ]+ \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=15&&i(`大损隐秘`,`warn`)}return n}function Aa(e,t){return ka(e,t).some(e=>e.level===`grave`)}function ja(e,t){let n={player:[],auto:[],loose:[],transition:null,nextScene:null},r=new Map,i=[];for(let t of e){if(t.episodeId==null){n.loose.push(t);continue}let e=r.get(t.episodeId);if(e)e.beats.push(t);else{let e={episodeId:t.episodeId,auto:!!t.auto,beats:[t]};r.set(t.episodeId,e),i.push(e)}}for(let e of i){let t=e.beats.length===1?e.beats[0]:null;if(t?.kind===`transition`){n.transition&&n.loose.push(n.transition),n.transition=t;continue}(e.auto?n.auto:n.player).push(e)}let a=n.player[n.player.length-1];return t&&a&&a.beats.every(e=>e.kind===`scene`)&&a.beats[0].evId===t&&(n.nextScene=a,n.player.pop()),n}var Ma={外门:{monthly:2,dutyEvery:3,patience:5,duty:`劈柴挑水，兼扫丹房`},内门:{monthly:10,dutyEvery:4,patience:6,duty:`守山门，轮值三班`},真传:{monthly:30,dutyEvery:5,patience:6,duty:`代师授业，兼查外门功课`},执事:{monthly:60,dutyEvery:5,patience:7,duty:`押粮、点卯、断门内的官司`},长老:{monthly:140,dutyEvery:6,patience:8,duty:`坐镇一堂，议事时须到`},掌门:{monthly:180,dutyEvery:7,patience:8,duty:`山门岁供进账，也轮到你发别人的俸`}},Na=[`外门`,`内门`,`真传`,`执事`,`长老`],Z={paidMonthsCap:24,payEveryMonths:12,dutyCost:.004,meritMin:-60,meritMax:60,suspendAt:3,suspendTicks:4,dismissAt:6,arrearsMonthsCap:36,backPayMonths:36},Pa={1:10,2:80,3:500,4:2500,5:9e3,6:2e4,7:4e4,8:7e4,9:12e4};function Fa(){return{merit:0,promotions:0,accruedMonths:0,arrears:0,dutyLeft:0,missed:0,suspended:0,paidTotal:0}}var Ia=class e{ctx;db;registry;seed;maxTicks;birthYear=16;milestones=[];curve=[];notices=[];beats=[];pendingEvent=null;pendingBreakthrough=null;chainDepth=0;episodeSeq=1;currentEpisode=0;pageYear;pageLocation;breakthroughCooldown=0;death=null;steppedDown=!1;failedBranch=null;finished=null;lastTags=[];stance=`打坐吐纳`;lastOutcome=null;lastDeltas=[];lastBreakthrough=null;signInYear=-1;stipend=Fa();lastRank=null;get gacha(){return this.ctx.gacha}set gacha(e){this.ctx.gacha=e}autoResolveMinor=!0;flushItemNotices(){let e=this.ctx.itemNotices;if(!(!e||e.length===0)){for(let t of e)this.note(t);e.length=0}}noticeOnly(e){this.notices.push(e),this.notices.length>64&&this.notices.splice(0,this.notices.length-64)}note(e,t=`notice`){this.notices.push(e),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:t,text:e})}newEpisode(){return this.episodeSeq++}pushTransition(e,t,n=!1){let r=ba(this.ctx.rng,{gapYears:this.ctx.year-this.pageYear,from:this.pageLocation,to:this.ctx.location,nextTags:e,tier:this.ctx.actor.tier,nextKind:t,chained:n});this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`transition`,text:r,episodeId:this.newEpisode()}),this.pageYear=this.ctx.year,this.pageLocation=this.ctx.location}constructor(e){let t=new o(e.seed);if(this.seed=e.seed,this.db=e.db,this.registry=e.registry,this.maxTicks=e.maxTicks??500,e.restore){let t=structuredClone(e.restore);if(t.pendingEventId&&!e.db.events.has(t.pendingEventId))throw Error(`快照中的事件「${t.pendingEventId}」已不存在（内容已更新）`);this.ctx={rng:o.restore(t.rng),year:t.year,tick:t.tick,actor:t.actor,karmaLedger:t.karmaLedger,log:[],flags:new Set(t.flags),systems:t.systems,eventHistory:new Map(t.eventHistory),eventCounts:new Map(t.eventCounts),sequels:t.sequels??[],location:t.location,knowers:t.knowers,gacha:t.gacha??Gr()},this.milestones.push(...t.milestones),this.curve.push(...t.curve),this.beats.push(...t.beats),this.notices.push(...t.notices),this.pendingEvent=t.pendingEventId?e.db.events.get(t.pendingEventId):null,this.pendingBreakthrough=t.pendingBreakthrough??null,this.chainDepth=t.chainDepth,this.breakthroughCooldown=t.breakthroughCooldown,this.lastTags=t.lastTags,this.stance=t.stance,this.signInYear=t.signInYear??-1,this.autoResolveMinor=!0,this.stipend=t.stipend??Fa(),this.episodeSeq=t.episodeSeq??t.beats.reduce((e,t)=>Math.max(e,t.episodeId??0),0)+1,this.currentEpisode=t.currentEpisode??0,this.pageYear=t.pageYear??t.year,this.pageLocation=t.pageLocation??t.location,this.lastRank=this.sectRank(),this.backfillKit(t);return}let n=e.birthplace??t.pick(_t),r=Nt(t,{birthplace:n,name:e.name??`无名`});this.ctx={rng:t,year:this.birthYear,tick:0,actor:r,karmaLedger:[],log:[],flags:new Set,systems:[],eventHistory:new Map,eventCounts:new Map,sequels:[],location:n.name,knowers:[],gacha:Gr()},this.pageYear=this.birthYear,this.pageLocation=n.name,this.milestones.push({year:this.birthYear,kind:`出生`,text:`生于${n.name}，${r.talent.root}`}),this.ctx.flags.add(`出身·${n.id}`),this.ctx.flags.add(`道统·${r.path}`),(r.path===`正道`||r.path===`儒道`)&&this.ctx.flags.add(`宗门弟子`),In(this.ctx);let i=e.db.events.get(`evt_prologue_${n.id}`);i&&(this.pendingEvent=i,this.currentEpisode=this.newEpisode(),this.beats.push({year:this.birthYear,tier:1,kind:`scene`,text:Yi(this.ctx,i),evId:i.id,title:i.title,isMajor:!0,episodeId:this.currentEpisode}))}snapshot(){return this.finished||!this.ctx.actor.alive?null:structuredClone({v:1,seed:this.seed,name:this.ctx.actor.name,rng:this.ctx.rng.snapshot(),year:this.ctx.year,tick:this.ctx.tick,actor:this.ctx.actor,karmaLedger:this.ctx.karmaLedger,flags:[...this.ctx.flags],systems:this.ctx.systems,eventHistory:[...this.ctx.eventHistory.entries()],eventCounts:[...this.ctx.eventCounts.entries()],sequels:this.ctx.sequels??[],location:this.ctx.location,knowers:this.ctx.knowers,milestones:this.milestones,curve:this.curve,beats:this.beats,notices:[...this.notices],pendingEventId:this.pendingEvent?.id??null,pendingBreakthrough:this.pendingBreakthrough,chainDepth:this.chainDepth,breakthroughCooldown:this.breakthroughCooldown,lastTags:this.lastTags,stance:this.stance,signInYear:this.signInYear,autoResolve:this.autoResolveMinor,gacha:this.gacha,stipend:this.stipend,itemsEra:1,episodeSeq:this.episodeSeq,currentEpisode:this.currentEpisode,pageYear:this.pageYear,pageLocation:this.pageLocation})}currentPrompt(){return this.finished?{kind:`gameover`,result:this.finished}:this.pendingBreakthrough?{kind:`breakthrough`,...this.pendingBreakthrough}:this.pendingEvent?{kind:`event`,card:this.pendingEvent,text:Yi(this.ctx,this.pendingEvent),choices:Qi(this.ctx,this.pendingEvent)}:null}gatherPage(e){let t=Math.max(0,Math.min(e,this.beats.length));return{page:ja(this.beats.slice(t),this.pendingEvent?.id??null),cursor:this.beats.length}}advance(){if(this.finished)return{kind:`gameover`,result:this.finished};if(this.pendingEvent){let e=this.currentPrompt();if(e)return e}if(this.pendingBreakthrough)return{kind:`breakthrough`,...this.pendingBreakthrough};let{ctx:e}=this,t=e.actor;for(;t.alive&&e.tick<this.maxTicks;){e.tick++;let n=u[t.tier]??12,r=n/12;e.year+=r,t.ageMonths+=n;let i=Kt(e,this.stance);i.mishap&&this.note(`修炼时气息岔了一下，胸口发闷 —— 走火的前兆。`),i.stageUp&&this.note(`水到渠成，已入${i.stageUp}。`,`milestone`);for(let n of t.souls){if(n.dissipated||n.favor<=-20||n.possession>=90)continue;let r=Dn(n,t.tier);r.speedBonus>0&&e.rng.chance(.25)&&(On(e,n.id),t.sublevel=Math.min(1,t.sublevel+.012*r.speedBonus))}let a=En(e);a&&this.note(a);let o=e.rng.chance(fe.eventChance)?Wi(e,this.db,{excludeTags:this.lastTags}):null;if(o){this.lastTags=o.tags?.slice(0,1)??[];let n=Qi(e,o);if(!this.autoResolveMinor||n.length===0||this.isMajor(o,n)){this.pendingEvent=o,this.chainDepth=0,this.pushTransition(o.tags??[],`event`),this.currentEpisode=this.newEpisode();let r=Yi(e,o);return this.beats.push({year:Math.floor(e.year),tier:t.tier,kind:`scene`,text:r,evId:o.id,title:o.title,isMajor:o.tags?.includes(`主干`)||o.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:o,text:r,choices:n}}let r=this.autoResolve(o,n);if(r)return r;if(!t.alive)return{kind:`gameover`,result:this.finalize()}}else this.lastTags=[];let s=this.postTick(r);if(s)return s;if(i.ready&&t.tier<10&&this.breakthroughCooldown<=0){let n=ve({power:Jt(t),dc:qt(t),scale:Math.max(20,qt(t)*.2)},I(t)),r=ye(e.rng,n,I(t));return this.pushTransition([],`breakthrough`),this.pendingBreakthrough={toTier:t.tier+1,estimate:r},{kind:`breakthrough`,toTier:t.tier+1,estimate:r}}this.breakthroughCooldown>0&&this.breakthroughCooldown--,e.tick%4==0&&this.curve.push(nr(t,e.tick,e.year))}return{kind:`gameover`,result:this.finalize()}}static MAJOR_TAGS=new Set([`主干`,`岔路`,`道德`,`抉择`,`打脸`,`止步`,`结丹`,`定道`,`系统`,`心魔`]);isMajor(t,n){return!!(t.once||t.tags?.some(t=>e.MAJOR_TAGS.has(t))||n.some(e=>!!e.require)||n.some(e=>Aa(t,e))||n.some(e=>e.karma!==`none`&&typeof e.karma==`object`&&e.karma.weight>=30))}autoResolve(e,t){let{ctx:n}=this,r=e,i=t,a=0;for(;r&&a++<5;){let e=this.newEpisode(),t=Yi(n,r);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:t,evId:r.id,title:r.title,episodeId:e,auto:!0});let o=i.filter(e=>!Aa(r,e)),s=o.length?o:i,c=s.map((e,t)=>1/(t+1)+.3),l=n.rng.weighted(s,c);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`choice`,text:l.text,episodeId:e,auto:!0});let u=ta(n,r,l);if(this.flushItemNotices(),u.text&&this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`outcome`,text:u.text,episodeId:e,auto:!0}),r=u.goto?this.db.events.get(u.goto)??null:null,!r||(i=Qi(n,r),i.length===0))break;if(this.isMajor(r,i)){this.pendingEvent=r,this.chainDepth=a,this.pushTransition(r.tags??[],`event`,!0),this.currentEpisode=this.newEpisode();let e=Yi(n,r);return this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:e,evId:r.id,title:r.title,isMajor:r.tags?.includes(`主干`)||r.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:r,text:e,choices:i}}}return null}captureStats(){let e=this.ctx.actor;return{修为:e.sublevel*100,道心:e.道心,气运:e.气运,功德:e.功德,业障:e.业障,僭越:e.僭越,堕度:e.堕度,丹毒:e.丹毒,名望:e.名望,悟性:e.talent.悟性,根骨:e.talent.根骨,神魂:e.talent.神魂,寿元:e.lifespanYears,功法:e.factors.功法,法宝:e.factors.法宝,状态:e.factors.状态,灵宠:e.factors.灵宠,伙伴:e.factors.伙伴,道侣:e.factors.道侣,情报:e.factors.情报,暴露:Math.max(...Object.values(e.secrets))}}static WARN_KEYS=new Set([`业障`,`僭越`,`堕度`,`丹毒`,`暴露`]);static FACTOR_KEYS=new Set([`功法`,`法宝`,`状态`,`灵宠`,`伙伴`,`道侣`,`情报`]);diffStats(t){let n=this.captureStats(),r=[];for(let i of Object.keys(t)){let a=(n[i]??0)-(t[i]??0),o=e.FACTOR_KEYS.has(i);if(Math.abs(a)<(o?.015:.5))continue;let s=e.WARN_KEYS.has(i)?a>0?`warn`:`good`:a>0?`good`:`bad`,c=o?a>0?`+${a.toFixed(2)}`:a.toFixed(2):i===`修为`?`${a>0?`+`:``}${a.toFixed(1)}%`:`${a>0?`+`:``}${Math.round(a)}`;r.push({key:i,delta:a,kind:s,text:`${i} ${c}`})}return r}choose(e){let t=this.pendingEvent;if(!t)throw Error(`当前没有待处理的事件`);let n=Qi(this.ctx,t),r=n[e];if(!r)throw Error(`选项 ${e} 不存在（共 ${n.length} 项）`);this.currentEpisode||=this.newEpisode(),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`choice`,text:r.text,episodeId:this.currentEpisode});let i=this.captureStats(),a=ta(this.ctx,t,r);if(this.lastOutcome=a.outcome,this.lastDeltas=this.diffStats(i),this.flushItemNotices(),a.karmaCreated){let e=this.ctx.karmaLedger.find(e=>e.id===a.karmaCreated);e&&this.lastDeltas.push({key:`因果`,delta:e.polarity,kind:e.polarity>0?`good`:e.polarity<0?`warn`:`bad`,text:`因果 · ${e.type}`})}if(a.text&&(this.notices.push(a.text),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`outcome`,text:a.text,episodeId:this.currentEpisode})),(t.tags?.includes(`岔路`)||t.tags?.includes(`主干`))&&this.milestones.push({year:Math.floor(this.ctx.year),kind:`岔路`,text:`【${t.title}】`}),a.goto&&this.chainDepth<4){let e=this.db.events.get(a.goto);if(e){this.chainDepth++,this.pendingEvent=e;let t=Qi(this.ctx,e);if(t.length>0){this.pushTransition(e.tags??[],`event`,!0),this.currentEpisode=this.newEpisode();let n=Yi(this.ctx,e);return this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`scene`,text:n,evId:e.id,title:e.title,isMajor:e.tags?.includes(`主干`)||e.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:e,text:n,choices:t}}}}if(this.pendingEvent=null,this.currentEpisode=0,!this.ctx.actor.alive)return{kind:`gameover`,result:this.finalize()};if(this.ctx.flags.has(`止步`)&&tr(this.ctx.actor))return this.steppedDown=!0,this.milestones.push({year:Math.floor(this.ctx.year),kind:`结局`,text:`止步 —— 不再求进`}),{kind:`gameover`,result:this.finalize()};let o=u[this.ctx.actor.tier]??12;return this.postTick(o/12)||this.advance()}decideBreakthrough(e,t=!1){let n=this.ctx.actor;if(this.pendingBreakthrough=null,this.lastBreakthrough=null,!e)return this.breakthroughCooldown=6,this.note(`你压下了冲关的念头，继续温养。`),this.advance();let r=n.tier,i=Yt(this.ctx,{hiddenAttempt:t,coreGradeInvest:this.ctx.flags.has(`结丹·全押`)?.85:.4});if(i.newTier>r){rn(this.ctx);let e=U(n.path,i.newTier),t=i.newTier===3?Ft[n.path]===e?Lt(i.goldenCoreGrade):It(n.path,i.goldenCoreGrade):``;this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`入${e}${i.hiddenAchieved?`（得隐藏境界）`:``}${t?` · ${t}`:``}`}),this.notices.push(`突破成功 —— ${e}。${i.hiddenAchieved?`而且你摸到了传说里的那一层。`:``}`),this.lastBreakthrough={ok:!0,name:e,hidden:i.hiddenAchieved},this.beats.push({year:Math.floor(this.ctx.year),tier:n.tier,kind:`milestone`,isMajor:!0,title:`入${e}`,text:`入${e}${i.hiddenAchieved?`，且踏足了世所罕闻的隐秘之境`:``}${t?`，结成${t}`:``}`})}else if(i.failure){this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`渡劫失败 · ${i.failure.name}`});let e=Xn(i.failure.outcome,n.path);if(this.note(`突破失败 —— ${e}`),i.failure.recoverable===!1||i.failure.branch)return this.failedBranch={name:i.failure.name,outcome:e,branch:i.failure.branch},n.alive=!1,{kind:`gameover`,result:this.finalize()}}else this.note(`冲关未成，气机散了。所幸根基未损，还能再来。`);return this.advance()}signIn(){if(!this.ctx.systems.includes(`签到`))return{ok:!1,text:`未绑定签到系统`};let e=Math.floor(this.ctx.year);if(e<=this.signInYear)return{ok:!1,text:`今岁已签，明年再来`};this.signInYear=e;let t=this.ctx.actor,n=this.ctx.rng.pick([{text:`灵气灌顶 · 修为 +2%`,apply:()=>{t.sublevel=Math.min(1,t.sublevel+.02)}},{text:`残页功法一篇 · 功法 +0.02`,apply:()=>{t.factors.功法=Math.min(1.9,t.factors.功法+.02)}},{text:`下品法器一件 · 法宝 +0.02`,apply:()=>{t.factors.法宝=Math.min(1.75,t.factors.法宝+.02)}},{text:`疗伤玉露 · 状态 +0.06`,apply:()=>{t.factors.状态=Math.min(1.45,t.factors.状态+.06)}},{text:`静心符一道 · 道心 +1`,apply:()=>{t.道心=Math.min(100,t.道心+1)}},{text:`一点玄妙气机 · 气运 +1`,apply:()=>{t.气运=Math.min(100,t.气运+1)}}]);return n.apply(),t.僭越+=1.5,t.secrets.金手指=Math.min(100,t.secrets.金手指+1.5),this.note(`【签到系统】叮 —— 连续签到中。今日奖励：${n.text}。`),{ok:!0,text:n.text}}systemDef(e){return this.db.systems.get(e)}availablePools(){return ii.filter(e=>ai[e.id]?.cond(this.ctx.actor.tier,this.ctx.flags)??!0)}poolCost(e){return ai[e]?.cost(this.ctx.flags)??null}poolInfo(e){let t=ii.find(t=>t.id===e),n=ai[e];if(!t)return null;let r=n?.cost(this.ctx.flags)??{},i=n?Kr(this.ctx.actor,r):[];return{odds:Qr(this.ctx.actor,t,this.gacha),pityLeft:$r(t,this.gacha),count:this.gacha.count[e]??0,costText:Jr(r),affordable:i.length===0,missing:i,hint:n?.hint??``}}tryDrawFrom(e){let t=ii.find(t=>t.id===e),n=ai[e];if(!t||!n)return{ok:!1,missing:[],reason:`没有「${e}」这座签筒`};if(!n.cond(this.ctx.actor.tier,this.ctx.flags)){let e={kind:`locked`,label:t.name,need:0,have:0,text:`${t.name}尚未对你开放`};return{ok:!1,missing:[e],reason:e.text}}let r=n.cost(this.ctx.flags),i=qr(this.ctx.actor,r);if(i.length)return{ok:!1,missing:i,reason:`代价不足 —— ${i.map(e=>e.text).join(`；`)}`};let a=this.captureStats();di(this.ctx,[...r.effects??[]]);let o=Zr(this.ctx.rng,this.ctx.actor,t,this.gacha);di(this.ctx,o.prize.effects),this.lastDeltas=this.diffStats(a);let s=o.rarity===`秘藏`?`★`:o.rarity===`仙品`?`☆`:``;return this.note(`【${t.name}】${s}${o.rarity}·${o.prize.name} —— ${o.prize.desc}`),this.flushItemNotices(),o.byPity&&this.note(`（连番落空之后，天道似乎补了你一次。）`),{ok:!0,result:o,missing:[]}}drawFrom(e){return this.tryDrawFrom(e).result??null}inventory(){return H(this.ctx.actor)}bag(){return et(this.inventory())}bagSlots(){let e=this.inventory();return{used:Qe(e),total:Ze(e),free:$e(e),container:e.container}}stones(){return mt(this.inventory())}useItem(e){let t=this.captureStats(),n=V(e)?.name??e,r=st(this.ctx.actor,e);if(!r.ok)return{ok:!1,text:r.reason??`用不了${n}`};for(let e of r.effects)ui(this.ctx,e);this.lastDeltas=this.diffStats(t);let i=r.note??`用掉了${n}`;return this.note(i),this.flushItemNotices(),{ok:!0,text:i}}equipItem(e){let t=this.captureStats(),n=V(e)?.name??e,r=ut(this.ctx.actor,e);if(!r.ok)return{ok:!1,text:r.reason??`佩不上${n}`};r.overTier&&Vn(this.ctx),this.lastDeltas=this.diffStats(t);let i=`佩上${n}（${r.slot}位）${r.overTier?` —— 越阶用宝，藏不住了`:``}`;return this.note(i),this.flushItemNotices(),{ok:!0,text:i}}unequipItem(e){let t=this.captureStats(),n=V(e)?.name??e,r=ft(this.ctx.actor,e);return r.ok?(this.lastDeltas=this.diffStats(t),this.flushItemNotices(),{ok:!0,text:`卸下${n}（${r.slot}位）`}):{ok:!1,text:r.reason??`${n}没佩在身上`}}sectStatus(){let e=this.sectRank();return{rank:e,monthly:e?Math.round(this.monthlyStipend(e)*10)/10:0,merit:this.stipend.merit,onDuty:this.stipend.dutyLeft>0,suspended:this.stipend.suspended>0,missed:this.stipend.missed,paidTotal:this.stipend.paidTotal,arrears:this.stipend.arrears}}sectRank(){let e=this.ctx.flags;if(e.has(`已建宗`))return`掌门`;if(!e.has(`宗门弟子`)||e.has(`叛出宗门`)||e.has(`叛出山门`)||e.has(`宗门·已除名`)||e.has(`宗门·已离山`))return null;let t=this.ctx.actor.tier,n=t>=5?4:t>=4?3:t>=3?2:+(t>=2);return e.has(`位列长老`)&&(n=Math.max(n,4)),(e.has(`掌刑堂`)||e.has(`兼任丹房执事`))&&(n=Math.max(n,3)),e.has(`得见一式真传`)&&(n=Math.max(n,2)),e.has(`师承已定`)&&(n=Math.max(n,1)),n=F(n+this.stipend.promotions,0,Na.length-1),Na[n]}monthlyStipend(e){let t=F(1+this.ctx.actor.名望/500,.8,1.35),n=F(1+this.stipend.merit/180,.7,1.3);return Ma[e].monthly*t*n}grantStones(e){let t=this.inventory(),n=Math.floor(Math.max(0,e));if(n<=0)return 0;let r=pt(t),i=0;for(let e of[`下品`,`中品`,`上品`])r[e]<=0||(i+=r[e]*P[e],it(t,qe[e],r[e]));let a=i+n,o=0;for(let e of[`上品`,`中品`,`下品`]){if(a<=0)break;let n=P[e],r=Math.floor(a/n);if(r<=0)continue;let i=rt(t,qe[e],r);o+=i.added*n,a-=i.added*n}return Math.max(0,o-i)}consumeSectMarks(){let e=this.ctx.flags,t=this.stipend,n=()=>{t.dutyLeft=0,e.delete(`宗门·当值`)},r=e=>{t.merit=F(t.merit+e,Z.meritMin,Z.meritMax)};e.delete(`宗门·当值·已了`)&&(n(),r(8),t.missed=Math.max(0,t.missed-1),this.ctx.actor.sublevel=Math.max(0,this.ctx.actor.sublevel-Z.dutyCost)),e.delete(`宗门·当值·推了`)&&(n(),r(-10),t.missed++),e.delete(`宗门·记功`)&&r(6),e.delete(`宗门·记过`)&&r(-8),e.delete(`宗门·晋阶`)&&(t.promotions=Math.min(2,t.promotions+1)),e.delete(`宗门·降等`)&&(t.promotions=Math.max(-4,t.promotions-1)),e.delete(`宗门·请辞`)&&(e.add(`宗门·已离山`),n(),t.accruedMonths=0,this.note(`你把腰牌还了。执事堂的册子上划掉一个名字，笔都没抬一下 —— 从此没人管你，也没人给你发钱。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`岔路`,text:`自请离山，从此散修`})),e.delete(`宗门·复籍`)&&(e.add(`宗门弟子`),e.delete(`宗门·已除名`),e.delete(`宗门·已离山`),e.delete(`宗门·停俸`),t.missed=0,t.suspended=0,t.merit=0,t.accruedMonths=0,this.note(`腰牌重新发回你手上，还是旧的那一块，边角被人摩得发亮。俸禄从这个月起照发。`)),t.missed>=Z.dismissAt?this.dismiss():t.missed>=Z.suspendAt&&t.suspended===0&&(t.suspended=Z.suspendTicks,t.accruedMonths=0,e.add(`宗门·停俸`),this.note(`执事堂把你的名字从发俸的册子上暂时划了出去 —— 「什么时候出满了工，什么时候再说。」`))}dismiss(){let e=this.stipend,t=this.ctx.flags;e.missed=2,e.suspended=0,t.delete(`宗门·停俸`);let n=this.sectRank();if(n!==`掌门`&&n!==null){if(n!==`外门`){e.promotions=Math.max(-4,e.promotions-1),this.note(`执事堂当众念了你的名字：误工太多，免去${n}之职，退回下一等再看。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`因果`,text:`免职 · 自${n}退下`});return}t.delete(`宗门弟子`),t.add(`宗门·已除名`),e.dutyLeft=0,t.delete(`宗门·当值`),e.accruedMonths=0,this.note(`你的名字从外门册子上被墨笔涂掉了。腰牌收回，山门以内不必再来 —— 俸禄自然也没有了。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`因果`,text:`除名 · 逐出山门`})}}tickDuty(e){let t=this.stipend,n=this.ctx.flags;if(t.dutyLeft>0){if(t.dutyLeft--,t.dutyLeft>0)return;n.delete(`宗门·当值`),t.merit=F(t.merit+2,Z.meritMin,Z.meritMax),this.ctx.actor.sublevel=Math.max(0,this.ctx.actor.sublevel-Z.dutyCost),this.noticeOnly(`这一档差事你按部就班地当完了，无事可记 —— 只是那些时辰没能用来打坐。`);return}this.ctx.tick%Ma[e].dutyEvery===0&&(t.dutyLeft=Ma[e].patience,n.add(`宗门·当值`),this.noticeOnly(`【当值】排班簿上写了你的名字：${Ma[e].duty}。`))}tickStipend(e){let t=this.stipend,n=this.ctx.flags;this.consumeSectMarks();let r=this.sectRank();if(r!==this.lastRank&&(r&&this.lastRank?this.note(`执事堂改了你的名牌 —— 自今日起，你是${r}。`):r&&this.note(`你的名字进了${r}的册子。往后每月有俸，也每月有差事。`),this.lastRank=r),!r){t.dutyLeft=0,t.accruedMonths=0,n.delete(`宗门·当值`),n.delete(`宗门·停俸`);for(let e of Na)n.delete(`身份·${e}`);n.delete(`身份·掌门`),n.delete(`宗门·在册`);return}n.add(`宗门·在册`);for(let e of Na)e!==r&&n.delete(`身份·${e}`);if(r!==`掌门`&&n.delete(`身份·掌门`),n.add(`身份·${r}`),t.suspended>0&&(t.suspended--,t.suspended===0&&(n.delete(`宗门·停俸`),this.note(`名字又写回了发俸的册子上。经手的执事没抬头：「下不为例。」`))),this.tickDuty(r),t.suspended>0||(t.accruedMonths+=Math.min(e,Z.paidMonthsCap),t.accruedMonths<Z.payEveryMonths))return;let i=t.accruedMonths;t.accruedMonths=0;let a=this.monthlyStipend(r),o=Math.floor(a*i)+t.arrears;if(o<=0)return;let s=this.grantStones(o);if(t.paidTotal+=s,t.arrears=Math.min(o-s,Math.floor(a*Z.arrearsMonthsCap)),s>0){let e=Math.round(i/12);this.noticeOnly(`【俸禄】领了${e<=1?`这一年`:`这${e}年`}的例俸，共 ${s} 块下品灵石之数。`)}t.arrears>0&&this.noticeOnly(`行囊塞不下，余下的先记在执事堂的账上 —— 腾出手了再来支。`)}backfillKit(e){if(e.itemsEra===1)return;let t=H(this.ctx.actor);if(t.stacks.length>0)return;let n=vt[[...this.ctx.flags].find(e=>e.startsWith(`出身·`))?.slice(3)??_t.find(e=>e.name===this.ctx.location)?.id??``]??yt,r=[];for(let[e,i]of n){let n=rt(t,e,i);n.added>0&&r.push(`${V(e)?.name??e}×${n.added}`)}for(let e of[...t.stacks]){let t=V(e.defId);t?.equip&&!e.equipped&&ut(this.ctx.actor,t.id)}let i=this.sectRank(),a=Pa[this.ctx.actor.tier]??0,o=i?Math.floor(this.monthlyStipend(i)*Z.backPayMonths):0,s=this.grantStones(a+o);s>0&&(this.stipend.paidTotal+=o>0?Math.min(s,o):0,r.push(`折合下品灵石 ${s}`)),this.note(`【行囊补记】你解下包袱才发现，这些年随身的东西一件都不在 —— 不是被人偷了，是先前记账的人漏了你这一囊：${r.join(`、`)}${i?`（其中含${i}的欠俸 ${o} 块）`:``}。旧存档开局时物品尚未入册，这一份是补给你的。`)}postTick(e){let{ctx:t}=this,n=t.actor;this.tickStipend(Math.round(e*12));for(let e of Rn(t))this.note(e);let r=$t(t);r&&(this.note(r),t.rng.chance(.4)&&en(t));let i=tn(t);i&&(this.note(i.text),this.milestones.push({year:Math.floor(t.year),kind:`机缘`,text:`身世揭晓：${i.origin}`}));for(let{soul:e,fate:n}of kn(t))this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`${e.name} · ${n}`}),this.note(`${e.name} —— ${n}。`);if(!n.alive)return{kind:`gameover`,result:this.finalize()};Hn(t),Jn(t),n.锋芒=Se(n)*(.15+.85*(n.secrets.真实修为/100));let a=Un(t);if(a.length){this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`秘密败露：${a.join(`、`)}`}),this.note(`瞒不住了 —— 你的${a.join(`、`)}已是公开的秘密。`);for(let e of a)n.secrets[e]=70;n.名望-=10}for(let n of gn(t,e)){if(n.kind===`foreshadow`||n.kind===`window`){this.note(`（${n.evtId.replace(/_/g,` `)}）`);continue}if(!n.lethal)continue;let e=cn(t,n.karma);if(this.note(e.text),e.death)return this.death=wn(t,e.death),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:e.death.description}),{kind:`gameover`,result:this.finalize()};this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`${n.karma.target}的旧账 —— ${e.kind}`})}let o=Tn(t);return o?(this.death=wn(t,o),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:o.description}),{kind:`gameover`,result:this.finalize()}):null}finalize(){if(this.finished)return this.finished;let{ctx:e}=this,t=e.actor;t.perfectionByTier[t.tier]||(t.perfectionByTier[t.tier]=Xt(t,t.hiddenRealms.includes(t.tier))),this.curve.push(nr(t,e.tick,e.year));let n=$n({actor:t,death:this.death,steppedDown:this.steppedDown,rootedAt:e.location,failedBranch:this.failedBranch});this.milestones.push({year:Math.floor(e.year),kind:`结局`,text:n.name});let r=ar({actor:t,ledger:e.karmaLedger,milestones:this.milestones,curve:this.curve,flags:e.flags,death:this.death,ending:n,diedAtYear:e.year,seed:this.seed}),i=vr({actor:t,ledger:e.karmaLedger,ending:n,seed:this.seed,serialIndex:this.registry.steleCount+1,birthYear:this.birthYear,diedAtYear:e.year,goldFingers:[...e.systems,...t.souls.map(e=>e.name)],verdictShort:Qt(Zt(t))}),a=er(t,n,{noSystem:e.flags.has(`无系统`)});Cr(this.registry,{actor:t,ending:n,stele:i,place:e.location,signature:this.signature(),unfinished:r.unfinished,relics:this.relics(),daoFruit:a});for(let t of e.systems)this.registry.unlockedSystems.includes(t)||this.registry.unlockedSystems.push(t);let o=Ea({daoName:t.name,seed:this.seed,beats:this.beats,chronicle:r,stele:i,signature:this.signature()});return this.finished={ending:n,chronicle:r,stele:i,daoFruit:a,novel:o,novelChars:Da(o)},this.finished}signature(){let e=this.ctx.flags;return e.has(`道·剑`)?`挡我者，斩。`:e.has(`道·丹`)?`我要救的人，一个都不能少。`:e.has(`道·苟`)?`谁都可以死，我不行。`:e.has(`道·杀`)?`这世道就是这样，我认。`:e.has(`无系统`)?`我什么都没有。所以我什么都不欠。`:e.has(`拒绝过系统`)?`那东西认的不是我，是「载体」。`:`后生，老夫观你骨骼清奇。`}relics(){let e=[],t=this.ctx.actor;return t.factors.法宝>1.1&&e.push(`一件养过手的法宝`),t.factors.功法>1.2&&e.push(`半部残缺功法`),t.tier>=3&&e.push(`一枚认过主的储物戒`),this.ctx.systems.length&&e.push(`一枚温热的青玉简`),t.goldenCoreGrade>=7&&e.push(`一颗${It(t.path,t.goldenCoreGrade)}`),e}},La=class extends Error{};function Ra(){return{events:new Map,systems:new Map,souls:new Map,locations:new Map,items:new Map}}function za(e,t,n){if(!n||typeof n!=`object`)return;let r=n,i=(e,n,r)=>{for(let i of e??[]){if(!i?.id)throw new La(`${t} 存在缺少 id 的${r}`);if(n.has(i.id))throw new La(`${t} ${r} id 重复：${i.id}`);n.set(i.id,i)}};i(r.events,e.events,`事件`),i(r.systems,e.systems,`系统`),i(r.souls,e.souls,`残魂`),i(r.locations,e.locations,`地点`);for(let n of r.items??[]){if(!n?.id)throw new La(`${t} 存在缺少 id 的物品`);if(e.items.has(n.id))throw new La(`${t} 物品 id 重复：${n.id}`);try{e.items.set(n.id,Ve(n))}catch(e){throw new La(`${t} 物品 '${n.id}' 不合法：${e.message}`)}}}function Ba(e){let t=Ra();for(let{path:n,doc:r}of e)za(t,n,r);return t}var Q={status:`loading`,done:0,total:0,db:null,error:null},Va=new Set;function Ha(){for(let e of Va)e(Q)}function Ua(e){Q={...Q,...e},Ha()}function Wa(){return Q}function Ga(e){return Va.add(e),e(Q),()=>void Va.delete(e)}var Ka=new Map,qa=new Map,Ja=new Map,Ya=null,Xa=null;function Za(){let e=0;for(let t of Ka.values())e+=t;Ua({done:Q.total>0&&e>Q.total?Q.total:e})}function Qa(e){return e instanceof Error?e.message:String(e)}async function $a(e){let t=`${e}content/manifest.json`,n;try{n=await fetch(t)}catch(e){throw Error(`取不到内容清单（${Qa(e)}）`)}if(!n.ok)throw Error(`取不到内容清单（HTTP ${n.status}）`);let r=await n.json();if(!Array.isArray(r.chunks)||r.chunks.length===0)throw Error(`内容清单为空`);return r}async function eo(e,t){let n=`${e}content/${t.file}`,r;try{r=await fetch(n)}catch(e){throw Error(`「${t.label}」下载失败（${Qa(e)}）`)}if(!r.ok)throw Error(`「${t.label}」下载失败（HTTP ${r.status}）`);let i,a=r.body;if(!a)i=await r.text(),Ka.set(t.file,t.bytes),Za();else{let e=a.getReader(),n=[],r=0;for(;;){let{done:i,value:a}=await e.read();if(i)break;a&&(n.push(a),r+=a.byteLength,Ka.set(t.file,r),Za())}let o=new Uint8Array(r),s=0;for(let e of n)o.set(e,s),s+=e.byteLength;i=new TextDecoder().decode(o)}let o=JSON.parse(i);if(o.id!==t.id)throw Error(`分片 ${t.file} 内容对不上（${o.id} ≠ ${t.id}）`);return Ka.set(t.file,t.bytes),Za(),o.docs}async function to(){let e=`/cangfeng-play/`;Ya??=await $a(e);let t=Ya;Q.total!==t.totalBytes&&Ua({total:t.totalBytes});let n=Ba((await Promise.all(t.chunks.map(t=>{let n=qa.get(t.file);if(n)return Promise.resolve(n);let r=Ja.get(t.file);return r||(r=eo(e,t).then(e=>(qa.set(t.file,e),Ja.delete(t.file),e)),r.catch(()=>{Ja.delete(t.file),Ka.delete(t.file),Za()}),Ja.set(t.file,r)),r}))).flat());return Ge(n.items.values()),n}function no(){return Q.db?Promise.resolve(Q.db):(Xa??=to().then(e=>(Xa=null,Ua({status:`ready`,db:e,error:null,done:Q.total}),e),e=>{throw Xa=null,Ua({status:`error`,error:Qa(e)}),e}),Xa)}function ro(){Q.db||(Ua({status:`loading`,error:null}),no().catch(()=>{}))}no().catch(()=>{});function io(){return{version:1,registry:xr(),steles:[]}}function ao(e){if(!e)return io();try{let t=JSON.parse(e);return t.version!==1||!t.registry||!Array.isArray(t.steles)?io():t}catch{return io()}}function oo(e){let t={};for(let n of e.steles)t[n.grade]=(t[n.grade]??0)+1;return t}var so=`cangfeng-save-v1`;function co(){try{return ao(localStorage.getItem(so))}catch{return io()}}function lo(e){try{localStorage.setItem(so,JSON.stringify(e))}catch{}}var uo=`cangfeng-run-v1`;function fo(e,t){try{localStorage.setItem(uo,JSON.stringify({snap:e,pov:t,savedAt:Date.now()}))}catch{}}function po(e){let t=e?.snap;return!t||t.v!==1||!t.actor||typeof t.actor!=`object`||!t.rng||typeof t.rng.state!=`number`||!Array.isArray(t.flags)||!Array.isArray(t.beats)?!1:typeof t.seed==`string`&&typeof t.tick==`number`}function mo(){try{let e=localStorage.getItem(uo);if(!e)return null;let t=JSON.parse(e);return po(t)?t:null}catch{return null}}function ho(){localStorage.removeItem(uo)}var go=`<svg viewBox="0 0 390 420" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,_o=`<svg viewBox="0 0 390 80" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,vo={tianshu:`<svg viewBox="0 0 240 110" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true">
  <defs>
...
</svg>`},yo={冲突:`<svg viewBox="0 0 390 90" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},Po={evt_diyitiao_renming:`<svg viewBox="0 0 390 240" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},Fo={...No,...Po},Io={cheap:{title:e=>`— ${e.split(``).join(` `)} v1.0 —`,greet:`尊贵的宿主，欢迎回来！`,act:`今 日 签 到`,fine:`* 签到即留痕。系统提醒宿主：天机可循，慎用。`},data:{title:e=>`[ ${e} ]`,greet:`模块就绪。数据流同步完成。`,act:`执 行`,fine:`// 每次调用都会在天机中留下一条记录`},ink:{title:e=>`${e}`,greet:`心念微动，那物应了一声。`,act:`运 转`,fine:`用之有度。器不欺主，主亦不当欺器。`},terminal:{title:e=>`root@heaven:~# ${e}`,greet:`> 权限校验通过。当前身份：临时执法者（编号待定）`,act:`EXEC`,fine:`# 所有操作计入天规日志，由下一任天道审计`},meta:{title:e=>`${e}`,greet:`……你确定这是游戏的一部分吗？`,act:`继 续`,fine:`（这段文字不应该出现在这里。）`}};function Lo(e){let[t,n]=(0,r.useState)(0),i=e.systems[t];if(!i)return(0,$.jsx)($.Fragment,{});let a=Io[i.skin]??Io.data,o=i.id===`签到`,s=e.session.beats,c=s.length>0?s[s.length-1].text:``,l=c.includes(i.name)||c.includes(i.id);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sys-panel skin-${i.skin} fade-in`,children:[e.systems.length>1&&(0,$.jsx)(`div`,{className:`sys-switch`,children:e.systems.map((e,r)=>(0,$.jsx)(`button`,{className:`sys-chip ${r===t?`on`:``}`,onClick:()=>n(r),children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`sys-title`,children:a.title(i.name)}),(0,$.jsx)(`div`,{className:`sys-line`,children:a.greet}),(0,$.jsx)(`div`,{className:`sys-line sys-desc`,children:i.desc}),o&&(0,$.jsx)(`button`,{className:`sys-btn`,onClick:e.onAct,children:a.act}),l&&(0,$.jsx)(`div`,{className:`sys-line sys-log`,children:c}),(0,$.jsxs)(`div`,{className:`sys-line sys-cost`,children:[`代价：`,i.cost]}),(0,$.jsx)(`div`,{className:`sys-line sys-fine`,children:a.fine}),(0,$.jsx)(`button`,{className:`linklike`,style:{marginTop:10},onClick:e.onClose,children:`关闭`})]})]})}var Ro=[`法宝`,`符箓`,`丹药`,`功法`,`材料`,`杂物`,`灵石`],zo=`零一二三四五六七八九`,Bo=[``,`十`,`百`,`千`];function Vo(e){if(!Number.isFinite(e)||e<0||e===0)return`零`;if(e>999)return String(e);let t=String(e),n=``,r=!1;for(let e=0;e<t.length;e++){let i=Number(t[e]),a=t.length-e-1;if(i===0){r=!0;continue}r&&n&&(n+=`零`),r=!1,(i!==1||a!==1||e!==0)&&(n+=zo[i]),n+=Bo[a]}return n}function Ho(e){return e>=1e5?`${Math.floor(e/1e4)}万`:e>=1e4?`${(e/1e4).toFixed(1)}万`:String(e)}function Uo(e){return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,`,`)}function Wo(e){let{session:t}=e,n=e.transform,[i,a]=(0,r.useState)(`全部`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),[,f]=(0,r.useState)(0),p=t.bag(),m=t.bagSlots(),h=t.stones(),ee=t.inventory(),g=pt(ee),te=t.ctx.actor.tier,_=_e(ee.container),v=m.free===0?at(ee):null,y=e=>`${e.def.id}|${z(e.stack)}`,b=o?p.find(e=>y(e)===o)??p.find(e=>e.def.id===o.split(`|`)[0])??null:null,x=()=>{e.onAct(),f(e=>e+1)},S=(e,n)=>{l({ok:e.ok,text:e.text}),x(),e.ok&&!t.bag().some(e=>e.def.id===n)&&s(null)},C=(e,n)=>{let r=t.inventory().container,i=t.useItem(e);if(S(i,e),i.ok&&n){let e=t.inventory().container;if(e!==r){let t=_e(e);d({name:t.id,note:t.note}),setTimeout(()=>d(null),2200)}}},w=new Map;for(let e of p)w.set(e.def.category,(w.get(e.def.category)??0)+1);let T=Ro.filter(e=>w.has(e)),E=i===`全部`?p:p.filter(e=>e.def.category===i),ne=i===`全部`?Math.min(m.free,12):0,re=i===`全部`?m.free-ne:0,ie=e=>p.find(t=>t.stack.equipped===e),ae=c?(0,$.jsx)(`div`,{className:`bag-msg ${c.ok?`good`:`bad`}`,children:n(c.text)}):null;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay bag-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sheet bag-sheet fade-in`,role:`dialog`,"aria-label":`行囊`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`行囊`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:_.id}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onClose,children:`收起`})]}),(0,$.jsxs)(`div`,{className:`bag-cap`,children:[(0,$.jsxs)(`div`,{className:`bag-cap-line`,children:[(0,$.jsxs)(`b`,{children:[Vo(m.total),`格`]}),(0,$.jsxs)(`span`,{children:[`，`,m.used===0?`空着`:`已满${Vo(m.used)}`]}),(0,$.jsx)(`i`,{className:m.free===0?`full`:``,children:m.free===0?`再装不下了`:`余 ${Vo(m.free)} 格`})]}),(0,$.jsx)(`div`,{className:`bag-bar`,children:(0,$.jsx)(`i`,{className:m.free===0?`full`:``,style:{width:`${Math.min(100,Math.round(m.used/Math.max(1,m.total)*100))}%`}})}),(0,$.jsx)(`div`,{className:`bag-note`,children:_.note}),v&&(0,$.jsxs)(`div`,{className:`bag-warn`,children:[`装满了。最不值钱的是`,(0,$.jsx)(`b`,{children:ze(v.def,z(v.stack))}),`（约值 `,Uo(Math.round(Je(v.stack))),` 下品）—— 要腾地方，先舍它。`]})]}),(0,$.jsxs)(`div`,{className:`bag-purse`,children:[(0,$.jsxs)(`span`,{className:`bp-sum`,children:[`⟡ `,Uo(h),` `,(0,$.jsx)(`i`,{children:`折下品`})]}),(0,$.jsxs)(`span`,{className:`bp-split`,children:[me.map(e=>g[e]>0?(0,$.jsxs)(`em`,{children:[e,` `,g[e]]},e):null),h===0&&(0,$.jsx)(`em`,{className:`none`,children:`身无分文`})]})]}),g.极品>0&&(0,$.jsxs)(`div`,{className:`bag-jstone`,children:[(0,$.jsx)(`span`,{className:`bj-mark`,children:`✦`}),(0,$.jsxs)(`span`,{className:`bj-t`,children:[`极品灵石 `,(0,$.jsxs)(`b`,{children:[`×`,g.极品]})]}),(0,$.jsx)(`span`,{className:`bj-x`,children:`这不是钱。市面上没有摊主找得开 —— 付账时它不会被拆开， 除非低阶灵石实在凑不出，才会有一枚被迫破开。`})]}),(0,$.jsx)(`div`,{className:`bag-ladder`,children:he.map(e=>(0,$.jsx)(`span`,{className:`bl-step ${e.id===_.id?`on`:e.slots<_.slots?`past`:``}`,title:`${e.slots} 格 · ${e.note}`,children:e.id},e.id))}),(0,$.jsx)(`div`,{className:`bag-slots-row`,children:Be.map(e=>{let t=ie(e);return(0,$.jsxs)(`button`,{className:`eq-slot ${t?`on`:``}`,onClick:()=>t&&s(y(t)),disabled:!t,children:[(0,$.jsx)(`i`,{children:e}),(0,$.jsx)(`b`,{className:t?`r-${t.def.grade-1}`:``,children:t?ze(t.def,z(t.stack)):`空`})]},e)})}),!b&&ae,T.length>1&&(0,$.jsxs)(`div`,{className:`bag-tabs`,children:[(0,$.jsxs)(`button`,{className:`bag-tab ${i===`全部`?`on`:``}`,onClick:()=>a(`全部`),children:[`全部 `,p.length]}),T.map(e=>(0,$.jsxs)(`button`,{className:`bag-tab ${i===e?`on`:``}`,onClick:()=>a(e),children:[e,` `,w.get(e)]},e))]}),(0,$.jsxs)(`div`,{className:`bag-grid`,children:[E.map((e,t)=>{let n=z(e.stack),r=!R(e.def)&&n!==2;return(0,$.jsxs)(`button`,{className:`bag-slot r-${e.def.grade-1} ${e.stack.equipped?`on`:``}`,style:e.def.slots>1?{gridColumn:`span 2`}:void 0,onClick:()=>{s(y(e)),l(null)},children:[(0,$.jsx)(`span`,{className:`bs-name`,children:e.def.name}),(0,$.jsxs)(`span`,{className:`bs-foot`,children:[(0,$.jsx)(`i`,{className:`bs-grade${e.def.grade>=6?` top`:``}`,children:Oe(e.def.grade)}),r&&(0,$.jsx)(`i`,{className:`bs-q q${n}`,children:Ie(n)}),e.stack.qty>1&&(0,$.jsxs)(`i`,{className:`bs-qty`,children:[`×`,e.stack.qty]})]}),e.stack.equipped&&(0,$.jsx)(`span`,{className:`bs-eq`,children:`佩`}),e.def.slots>1&&(0,$.jsxs)(`span`,{className:`bs-big`,children:[`占`,Vo(e.def.slots),`格`]})]},`${e.def.id}-${t}`)}),Array.from({length:ne},(e,t)=>(0,$.jsx)(`span`,{className:`bag-slot empty`,"aria-hidden":`true`},`e${t}`))]}),E.length===0&&(0,$.jsx)(`div`,{className:`bag-empty`,children:i===`全部`?`空空如也。修士的第一件家当，多半是别人不要的。`:`没有${i}。`}),re>0&&(0,$.jsxs)(`div`,{className:`bag-note`,style:{textAlign:`center`,marginTop:8},children:[`另余 `,re,` 格`]})]}),b&&(()=>{let e=b.def,r=z(b.stack),i=!!b.stack.equipped,a=e.container?_e(e.container):null,o=a?a.slots<=_.slots?`${_.id}比${a.id}还宽敞，换了是往回走`:te<a.minTier?`神识撑不开${a.id} —— 须得${a.minTier}阶以上`:null:null,c=e.equip?.minTier!=null&&te<e.equip.minTier,u=!!a||!!e.use&&e.use.length>0;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay detail-overlay`,onClick:()=>{s(null),l(null)}}),(0,$.jsxs)(`div`,{className:`bag-detail fade-in`,role:`dialog`,"aria-label":e.name,children:[(0,$.jsxs)(`div`,{className:`bd-head`,children:[(0,$.jsx)(`span`,{className:`bd-name r-${e.grade-1}`,children:ze(e,r)}),(0,$.jsxs)(`span`,{className:`bd-tag${e.grade>=6?` top`:``}`,children:[Oe(e.grade),` · `,e.category]}),i&&(0,$.jsxs)(`span`,{className:`bd-worn`,children:[`佩于`,b.stack.equipped]})]}),(0,$.jsx)(`div`,{className:`bd-desc`,children:n(e.desc)}),e.grade>=6&&(0,$.jsxs)(`div`,{className:`bd-uniq`,children:[(0,$.jsx)(`span`,{className:`bu-mark`,children:`✦`}),e.stone?`不是钱。没有摊主找得开 —— 除非低阶灵石实在凑不出，付账时它不会被拆开。`:`世上只此一件。它不会有第二件，前主人的账也一并转到了你身上。`]}),(0,$.jsxs)(`div`,{className:`bd-meta`,children:[(0,$.jsxs)(`span`,{children:[`占 `,Vo(e.slots),` 格`]}),(0,$.jsxs)(`span`,{children:[`值 `,Uo(Math.round(e.value*(R(e)?1:Pe[r]))),` 下品`]}),b.stack.qty>1&&(0,$.jsxs)(`span`,{children:[`身上 `,b.stack.qty,` 件`]}),e.talisman&&(0,$.jsxs)(`span`,{children:[e.talisman,`符`]})]}),e.equip&&(0,$.jsxs)(`div`,{className:`bd-equip`,children:[(0,$.jsx)(`b`,{children:e.equip.slot}),Object.entries(e.equip.factors).map(([e,t])=>(0,$.jsxs)(`span`,{className:`bd-fac`,children:[e,` +`,t.toFixed(2)]},e))]}),c&&!i&&(0,$.jsx)(`div`,{className:`bd-warn`,children:`越阶用宝：佩得上，但压不住 —— 明眼人一看便知你身后有人（真实修为暴露）。`}),a&&!o&&(0,$.jsxs)(`div`,{className:`bd-hint`,children:[`换用之后可装 `,a.slots,` 格。`,a.note]}),o&&(0,$.jsx)(`div`,{className:`bd-warn`,children:o}),!u&&!e.equip&&!(e.grade>=6&&e.stone)&&(0,$.jsx)(`div`,{className:`bd-hint`,children:e.stone?`钱不必手动动它 —— 付账时自会拆开找零。`:`用不上。但总有人要，也总有人认得。`}),ae,(0,$.jsxs)(`div`,{className:`bd-acts`,children:[e.equip&&(i?(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>S(t.unequipItem(e.id),e.id),children:`卸 下`}):(0,$.jsx)(`button`,{className:`primary-btn slim`,onClick:()=>S(t.equipItem(e.id),e.id),children:`佩 上`})),u&&(0,$.jsx)(`button`,{className:`primary-btn slim`,disabled:!!o,onClick:()=>C(e.id,!!a),children:a?`换 用`:e.category===`丹药`?`服 下`:`用 掉`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{s(null),l(null)},children:`收 起`})]})]})]})})(),u&&(0,$.jsxs)(`div`,{className:`bag-flash`,onClick:()=>d(null),children:[(0,$.jsx)(`div`,{className:`bf-word`,children:u.name}),(0,$.jsx)(`div`,{className:`bf-sub`,children:u.note})]})]})}var Go={oracle:`坊市街口的卦摊。几个铜板一卦 —— 问得多了，天也会烦。`,relic:`荒山野岭的旧坟古洞。前人的东西好拿，前人的账也跟着来。`,alchemy:`自己开炉。费材料费时间，但炉子是自己的。`},Ko={CRIT_SUCCESS:{label:`大成`,cls:`s-crit`},SUCCESS:{label:`成`,cls:`s-ok`},FAIL:{label:`败`,cls:`s-fail`},CRIT_FAIL:{label:`大凶`,cls:`s-cfail`}},qo=[{m:`打坐吐纳`,label:`稳修`,hint:`不快不慢，不出错`},{m:`悟道`,label:`悟道`,hint:`慢，但根基更纯，圆满度更高`},{m:`历练突破`,label:`历练`,hint:`快，有伤病之险`},{m:`丹药速成`,label:`服丹`,hint:`最快，但积丹毒（丹毒过深会锁死上限）`}];function Jo(e){if(!(e>0))return`—`;let t=e*100;return t>=1?`${t.toFixed(1)}%`:t>=.1?`${t.toFixed(2)}%`:`${t.toFixed(4)}%`}function Yo(e){let t=Math.round(e*100);return t>=80?`八九成`:t>=60?`六七成`:t>=40?`四五成`:t>=20?`两三成`:`一线`}function Xo(e){let t=e.session.ctx.actor,n=[],r=t.lifespanYears-t.ageMonths/12;r<15&&n.push({text:`寿余${Math.max(0,r).toFixed(0)}`,cls:`hot`}),t.僭越>=51&&n.push({text:`僭越${Math.round(t.僭越)}`,cls:t.僭越>=101?`hot`:`warn`}),t.堕度>=46&&n.push({text:`堕度${Math.round(t.堕度)}`,cls:t.堕度>=76?`hot`:`warn`}),t.丹毒>=50&&n.push({text:`丹毒${Math.round(t.丹毒)}`,cls:t.丹毒>=80?`hot`:`warn`});let i=t.souls.find(e=>!e.dissipated&&e.possession>=60);return i&&n.push({text:`魂扰${Math.round(i.possession)}`,cls:i.possession>=85?`hot`:`warn`}),n.slice(0,2)}function Zo(e){return e.page.player.length>0||e.page.auto.length>0||e.page.loose.length>0||e.page.transition!==null||e.stamp!==null||e.chips.length>0}function Qo(e){let{session:t,pov:n,name:i}=e.game,a=e=>ra(e,n,i),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(`event`),[u,d]=(0,r.useState)(null),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(!1),[ee,g]=(0,r.useState)(!1),[te,v]=(0,r.useState)(!1),[y,b]=(0,r.useState)(null),[x,S]=(0,r.useState)(null),[C,w]=(0,r.useState)(!1),[T,E]=(0,r.useState)(!1),[ne,re]=(0,r.useState)(null),[ie,ae]=(0,r.useState)([]),[D,oe]=(0,r.useState)(`oracle`),[O,se]=(0,r.useState)(!1),[k,ce]=(0,r.useState)(null),[,A]=(0,r.useState)(0),j=(0,r.useRef)(0),le=(0,r.useRef)(!1),ue=(0,r.useRef)(null),M=e=>{let n=t.gatherPage(j.current);j.current=n.cursor,t.notices.length=0;let r=t.lastOutcome?Ko[t.lastOutcome]??null:null,i=[...t.lastDeltas];return t.lastOutcome=null,t.lastDeltas=[],{stamp:r,chips:i,page:n.page,fromYear:e,toYear:Math.floor(t.ctx.year)}},N=(r,i)=>{S(null),v(!1);let a=M(i);if(r.kind===`gameover`){Zo(a)?(d(a),l(`between`),s(r)):e.onOver(r.result);return}s(r),Zo(a)?(d(a),l(`between`)):l(`event`);let o=t.snapshot();o&&fo(o,n)};(0,r.useEffect)(()=>{if(le.current)return;if(le.current=!0,t.beats.length>0){j.current=t.beats.length;let n=t.currentPrompt();if(n){if(n.kind===`gameover`){e.onOver(n.result);return}s(n),l(`event`);return}}let n=Math.floor(t.ctx.year);N(t.advance(),n)},[]),(0,r.useEffect)(()=>{window.scrollTo({top:0})},[c,o]);let de=e=>{if(!o||o.kind!==`event`)return;let n=Math.floor(t.ctx.year),r=t.choose(e);N(r,n)},fe=e=>{if(!o||o.kind!==`event`||te)return;let t=o.choices[e];if(t){if(Aa(o.card,t)&&x!==e){S(e);return}S(null),t.check?(v(!0),setTimeout(()=>de(e),520)):de(e)}},pe=(e,n)=>{if(!o||o.kind!==`breakthrough`)return;let r=Math.floor(t.ctx.year),i=t.decideBreakthrough(e,n);t.lastBreakthrough&&e&&(b(t.lastBreakthrough),setTimeout(()=>b(null),2e3)),N(i,r)},P=()=>{if(o?.kind===`gameover`){e.onOver(o.result);return}l(`event`)},me=(e,t)=>{if(!e)return null;let n=e===`命关`?yo.命关:Fo[e];return n?(0,$.jsx)(`div`,{className:`card-art scene-art`,dangerouslySetInnerHTML:{__html:n}},e):(0,$.jsx)(`div`,{className:`card-orn`,dangerouslySetInnerHTML:{__html:Mo(t)}},`orn-${e}`)},he=(e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`mini-scene`,children:[e.title&&(0,$.jsxs)(`span`,{className:`mini-t`,children:[`【`,e.title,`】`]}),(0,$.jsxs)(`span`,{className:`mini-x`,children:[a(e.text).split(`
...
`).filter(e=>e.trim()!==``);return t.length>1?`${t[0]}…`:t[0]??``},_e=e=>{let t=e.beats.find(e=>e.kind===`scene`),n=e.beats.find(e=>e.kind===`choice`),r=e.beats.find(e=>e.kind===`outcome`);return(0,$.jsxs)(`div`,{className:`years-unit`,children:[t&&(0,$.jsxs)(`div`,{className:`yu-scene`,children:[t.title&&(0,$.jsxs)(`span`,{className:`yu-t`,children:[`【`,t.title,`】`]}),(0,$.jsx)(`span`,{children:ge(t.text)})]}),n&&(0,$.jsxs)(`div`,{className:`yu-choice`,children:[`——`,a(n.text)]}),r&&(0,$.jsx)(`div`,{className:`yu-outcome`,children:ge(r.text)})]},e.episodeId)},F=()=>{if(!u)return null;let{page:e}=u,t=u.toYear-u.fromYear,n=e.player.flatMap(e=>e.beats.filter(e=>e.kind!==`scene`));return(0,$.jsxs)(`div`,{className:`page-card`,ref:ue,children:[(0,$.jsx)(`div`,{className:`between-head`,children:(0,$.jsx)(`div`,{className:`year-mark`,children:t>1?`第 ${u.fromYear} — ${u.toYear} 年`:`第 ${u.toYear} 年`})}),(0,$.jsxs)(`div`,{className:`between-body`,children:[(u.stamp||u.chips.length>0||n.length>0)&&(0,$.jsxs)(`section`,{className:`res-player`,children:[u.stamp&&(0,$.jsx)(`div`,{className:`stamp-row`,children:(0,$.jsx)(`span`,{className:`stamp ${u.stamp.cls}`,children:u.stamp.label})}),u.chips.length>0&&(0,$.jsx)(`div`,{className:`delta-chips`,children:u.chips.map((e,t)=>(0,$.jsx)(`span`,{className:`dchip d-${e.kind}`,children:e.text},t))}),n.map((e,t)=>e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome`,children:a(e.text)},t):he(e,t))]}),e.loose.map(he),e.auto.length>0&&(0,$.jsxs)(`section`,{className:`years-sec`,children:[(0,$.jsx)(`div`,{className:`years-head`,children:`这些年里`}),e.auto.map(_e)]})]}),e.transition&&(0,$.jsx)(`div`,{className:`passage trans`,children:a(e.transition.text)}),(0,$.jsx)(`div`,{className:`page-foot`,children:(0,$.jsx)(`button`,{className:`primary-btn`,onClick:P,children:o?.kind===`gameover`?`盖 棺`:`继 续`})})]})},I=()=>{if(!o)return null;if(o.kind===`event`){let e=o.card.tags?.includes(`岔路`),t=a(o.text).split(`
`).filter(e=>e.trim()!==``),n=.1,r=Math.min(t.length*n+.2,1.3);return(0,$.jsxs)(`div`,{className:`page-card`,ref:ue,children:[me(o.card.id,o.card.tags),(0,$.jsxs)(`div`,{className:`page-body`,children:[e&&(0,$.jsx)(`div`,{className:`fork-badge rv`,children:`岔 · 人生节点`}),(0,$.jsxs)(`div`,{className:`t rv`,children:[`【`,o.card.title,`】`]}),t.map((e,t)=>(0,$.jsx)(`p`,{className:`rv`,style:{animationDelay:`${Math.min(t*n,1.1)}s`},children:e},t))]}),(0,$.jsx)(`div`,{className:`page-foot`,children:te?(0,$.jsx)(`div`,{className:`roll`,children:`天 机 演 算`}):(0,$.jsx)(`div`,{className:`inline-choices rv`,style:{animationDelay:`${r}s`},children:o.choices.map((e,t)=>{if(x===t){let n=ka(o.card,e);return(0,$.jsxs)(`div`,{className:`confirm-block`,children:[(0,$.jsx)(`div`,{className:`confirm-choice`,children:a(e.text)}),(0,$.jsx)(`div`,{className:`risk-tags`,children:n.map((e,t)=>(0,$.jsx)(`span`,{className:`risk-tag r-${e.level}`,children:e.text},t))}),(0,$.jsxs)(`div`,{className:`confirm-row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>S(null),children:`再想想`}),(0,$.jsx)(`button`,{className:`confirm-go`,onClick:()=>fe(t),children:`依此而行`})]})]},t)}return(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>fe(t),children:[(0,$.jsx)(`span`,{className:`idx`,children:t+1}),a(e.text),Aa(o.card,e)&&(0,$.jsx)(`span`,{className:`grave-mark`,children:`重`}),e.check&&(0,$.jsx)(`span`,{className:`check-mark`,children:`占`})]},t)})})})]},o.card.id)}if(o.kind!==`breakthrough`)return null;let e=t.ctx.actor;return(0,$.jsxs)(`div`,{className:`page-card`,ref:ue,children:[me(`命关`),(0,$.jsxs)(`div`,{className:`page-body`,children:[(0,$.jsx)(`div`,{className:`t rv`,children:`【命关】`}),(0,$.jsx)(`p`,{className:`rv`,style:{animationDelay:`0.1s`},children:a(`修为已至大圆满，气机满盈，可冲击【${U(t.ctx.actor.path,o.toTier)}】。\n你掂量了一下 —— 约莫${Yo(o.estimate)}把握。`)})]}),(0,$.jsx)(`div`,{className:`page-foot`,children:(0,$.jsxs)(`div`,{className:`inline-choices rv`,style:{animationDelay:`0.4s`},children:[(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>pe(!0,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`1`}),`冲关`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>pe(!0,!0),children:[(0,$.jsx)(`span`,{className:`idx`,children:`2`}),`稳中求进，兼冲隐藏之境`,e.道心>58?``:`（道心尚浅，凶险）`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>pe(!1,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`3`}),`再温养几年`]})]})})]},`bt-${t.ctx.tick}`)},L=t.ctx.actor,ve=U(L.path,L.tier),ye=Ht(L.path,L.tier,L.sublevel);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`topbar`,children:[(0,$.jsx)(`button`,{className:`tb-name`,onClick:()=>p(!0),children:i}),(0,$.jsxs)(`button`,{className:`tb-sub`,onClick:()=>p(!0),children:[ye,L.tier<10?` ${Math.round(L.sublevel*100)}%`:``,` · `,Math.floor(t.ctx.year),`年`]}),(0,$.jsx)(`span`,{className:`grow`}),Xo(e.game).map((e,t)=>(0,$.jsx)(`span`,{className:`chip ${e.cls}`,children:e.text},t)),(()=>{let e=t.bagSlots(),n=e.free===0;return(0,$.jsxs)(`button`,{className:`tb-bag ${n?`full`:``}`,onClick:()=>E(!0),"aria-label":`行囊，${t.stones()} 下品灵石，${e.used} 之 ${e.total} 格`,title:n?`${e.container} 已满`:e.container,children:[(0,$.jsxs)(`span`,{className:`tbb-stone`,children:[`⟡`,Ho(t.stones())]}),(0,$.jsxs)(`span`,{className:`tbb-slot`,children:[e.used,`/`,e.total]})]})})(),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>g(!0),children:`回顾`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onQuit,children:`搁笔`})]}),(0,$.jsx)(`div`,{className:`realm-bar`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(L.sublevel*100)}%`}})}),c===`between`?F():I(),y&&(0,$.jsxs)(`div`,{className:`bt-overlay ${y.ok?`bt-ok`:`bt-fail`}`,onClick:()=>b(null),children:[(0,$.jsx)(`div`,{className:`bt-word`,children:y.ok?y.name:`劫`}),(0,$.jsx)(`div`,{className:`bt-sub`,children:y.ok?y.hidden?`且入隐秘之境`:`境界已成`:`未过 · ${y.name}`}),y.ok&&L.goldenCoreGrade>0&&L.tier===3&&(0,$.jsx)(`div`,{className:`bt-core ${_(L.goldenCoreGrade)?`top`:``}`,children:It(L.path,L.goldenCoreGrade)})]}),t.availablePools().length===0?null:(0,$.jsx)(`button`,{className:`oracle-pill`,onClick:()=>{w(!0),ce(null),re(null),ae([])},children:`✦ 机缘`}),C&&(()=>{let e=t.availablePools(),r=e.find(e=>e.id===D)??e[0],i=t.poolInfo(r.id),o=()=>{if(O)return;re(null);let e=t.poolInfo(r.id);if(e&&!e.affordable){re(e.missing.map(e=>e.text).join(`；`));return}se(!0),ce(null),setTimeout(()=>{let e=t.tryDrawFrom(r.id);ae(t.notices.slice(1)),j.current=t.beats.length,t.notices.length=0,ce(e.result??null),e.ok||re(e.reason??`这一卦求不得`),se(!1),A(e=>e+1);let i=t.snapshot();i&&fo(i,n)},900)},s=(k?.prize.effects??[]).map(e=>/^give\s+(\S+)/.exec(e)?.[1]).filter(e=>!!e).map(e=>V(e)).find(e=>e?.equip&&t.bag().some(t=>t.def.id===e.id&&!t.stack.equipped));return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>!O&&w(!1)}),(0,$.jsxs)(`div`,{className:`oracle-panel fade-in`,children:[(0,$.jsx)(`div`,{className:`oracle-tabs`,children:e.map(e=>(0,$.jsx)(`button`,{className:`oracle-tab ${e.id===r.id?`on`:``}`,onClick:()=>{oe(e.id),ce(null),re(null),ae([])},children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`oracle-stage`,children:O?(0,$.jsx)(`div`,{className:`oracle-shake`,children:`签 筒 摇 动`}):k?(0,$.jsxs)(`div`,{className:`oracle-prize r-${Vr.indexOf(k.rarity)}`,children:[(0,$.jsx)(`div`,{className:`op-rarity`,children:k.rarity===`极品`?`✦ 极 品 ✦`:k.rarity}),(0,$.jsx)(`div`,{className:`op-name`,children:k.prize.name}),(0,$.jsx)(`div`,{className:`op-desc`,children:a(k.prize.desc)}),k.rarity===`极品`&&(0,$.jsx)(`div`,{className:`op-uniq`,children:`此物世上只此一件。你拿了它，就不会再有第二件。`}),k.byPity&&(0,$.jsx)(`div`,{className:`op-pity`,children:`连番落空之后，天道补了你一次`})]}):(0,$.jsx)(`div`,{className:`oracle-idle`,children:Go[r.id]??``})}),ie.length>0&&!O&&(0,$.jsx)(`div`,{className:`oracle-notes`,children:ie.map((e,t)=>(0,$.jsx)(`div`,{className:`on-line`,children:a(e)},t))}),s&&!O&&(0,$.jsxs)(`button`,{className:`oracle-wear`,onClick:()=>{let e=t.equipItem(s.id);ae(t=>[...t,e.text]),j.current=t.beats.length,t.notices.length=0,A(e=>e+1);let r=t.snapshot();r&&fo(r,n)},children:[`即刻佩上「`,s.name,`」（`,s.equip?.slot,`）`]}),i&&(()=>{let e=Yr(L,r,t.gacha),n=i.odds.极品,a=t.gacha,o=(r.prizes.极品?.length??0)>0,s=L.tier>=G.minTier,c=L.气运>=G.minLuck,l=U(L.path,G.minTier),u=[{ok:s,text:s?`修为已至【${l}】`:`修为须至【${l}】—— 今为【${ve}】`},{ok:c,text:c?`气运 ${Math.round(L.气运)}，已过 ${G.minLuck} 这道坎`:`气运须过 ${G.minLuck} —— 今为 ${Math.round(L.气运)}`},{ok:!!a.seenSecret,text:a.seenSecret?`本局已亲见过一件秘藏`:`本局须亲见过一件秘藏 —— 没见过的东西，天不会先给你`}];a.supremeTaken&&u.push({ok:!1,text:`此生已得过一件独一无二之物 —— 天不予二`}),o||u.push({ok:!1,text:`${r.name}里本就没有这样的东西`});let d=!e.ok&&u.every(e=>e.ok)?e.reasons:[],f=Math.max(0,Wr.threshold-i.pityLeft);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`odds-bar`,children:Vr.map((e,t)=>e===`极品`?n>0?(0,$.jsx)(`div`,{className:`odds-seg r-5 hair`,title:`极品 ${Jo(n)}`},e):null:(0,$.jsx)(`div`,{className:`odds-seg r-${t}`,style:{flex:Math.max(.02,i.odds[e])},title:`${e} ${Jo(i.odds[e])}`},e))}),(0,$.jsx)(`div`,{className:`odds-legend`,children:Vr.map((e,t)=>(0,$.jsxs)(`span`,{className:`ol r-${t}${e===`极品`&&n<=0?` off`:``}`,children:[e,` `,Jo(i.odds[e])]},e))}),(0,$.jsxs)(`div`,{className:`supreme-box ${e.ok?`open`:``}`,children:[(0,$.jsxs)(`div`,{className:`sb-head`,children:[(0,$.jsx)(`span`,{className:`sb-mark`,children:`✦`}),(0,$.jsx)(`span`,{className:`sb-t`,children:`极品`}),(0,$.jsx)(`span`,{className:`sb-x`,children:e.ok?`此刻确在筒里 · ${Jo(n)}`:`此刻不在筒里 —— 摇多少次都不会出`})]}),(0,$.jsxs)(`div`,{className:`sb-list`,children:[u.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li ${e.ok?`yes`:`no`}`,children:[(0,$.jsx)(`i`,{children:e.ok?`✓`:`✗`}),e.text]},t)),d.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li no`,children:[(0,$.jsx)(`i`,{children:`✗`}),e]},`f${t}`))]}),(0,$.jsx)(`div`,{className:`sb-fine`,children:`世上只此一件，一局只出一件。`})]}),(0,$.jsxs)(`div`,{className:`pity-row`,children:[(0,$.jsx)(`div`,{className:`pity-bar`,"aria-hidden":`true`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(f/Wr.threshold*100)}%`}})}),(0,$.jsxs)(`div`,{className:`pity-t`,children:[i.pityLeft>0?`再 ${i.pityLeft} 次落空，必得【宝品】以上`:`时来运转已满 —— 下一次必得【宝品】以上`,(0,$.jsxs)(`em`,{children:[`保底只保到宝品／仙品／秘藏这三档。`,(0,$.jsx)(`b`,{children:`极品不在保底之列`}),` —— 攒出来的东西不叫意外。`]})]})]}),(0,$.jsxs)(`div`,{className:`oracle-meta`,children:[`气运 `,Math.round(L.气运),` · 已求 `,i.count,` 次`]})]})})(),(0,$.jsxs)(`div`,{className:`oracle-cost ${i&&!i.affordable?`lack`:``}`,children:[`代价：`,i?.costText??r.costLabel]}),(0,$.jsxs)(`div`,{className:`oracle-purse`,children:[`囊中 ⟡ `,Ho(t.stones()),` 下品 · 余 `,t.bagSlots().free,` 格`]}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:i.missing.map((e,t)=>(0,$.jsx)(`div`,{className:`om-line`,children:e.text},t))}),ne&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:(0,$.jsx)(`div`,{className:`om-line`,children:ne})}),(0,$.jsx)(`button`,{className:`oracle-btn`,disabled:O||!!i&&!i.affordable,onClick:o,children:O?`……`:i&&!i.affordable?`付 不 起`:`求 一 次`}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-fine`,children:`先去挣够了再来 —— 这里从没有免费的运气。`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>!O&&w(!1),children:`收手`})]})]})})(),t.ctx.systems.length>0&&(0,$.jsxs)(`button`,{className:`sys-pill`,onClick:()=>h(!0),children:[(0,$.jsx)(`span`,{className:`sys-dot`}),`系统`]}),m&&(()=>{let n=t.ctx.systems.map(t=>e.game.session.systemDef(t)).filter(e=>!!e);return n.length===0?null:(0,$.jsx)(Lo,{session:t,systems:n,onClose:()=>h(!1),onAct:()=>{t.signIn(),j.current=t.beats.length,t.notices.length=0,A(e=>e+1)}})})(),T&&(0,$.jsx)(Wo,{session:t,transform:a,onClose:()=>E(!1),onAct:()=>{j.current=t.beats.length,t.notices.length=0,A(e=>e+1);let e=t.snapshot();e&&fo(e,n)}}),ee&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>g(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`回顾`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:`此生至今 · 亦即将来书上的正文`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>g(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`history-scroll`,children:[t.beats.map((e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`scene past`,style:{margin:`14px 0 4px`},children:[e.title&&(0,$.jsxs)(`div`,{className:`t`,children:[`【`,e.title,`】`]}),(0,$.jsx)(`div`,{className:`x`,children:a(e.text)})]},t):e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line past`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome`,children:a(e.text)},t):e.kind===`milestone`?(0,$.jsxs)(`div`,{className:`milestone`,children:[`◈ `,a(e.text)]},t):e.kind===`transition`?(0,$.jsx)(`div`,{className:`passage`,children:a(e.text)},t):(0,$.jsx)(`div`,{className:`notice`,children:a(e.text)},t)),t.beats.length===0&&(0,$.jsx)(`div`,{className:`notice`,children:`故事才刚要开始。`})]})]})]}),f&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>p(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:i}),(0,$.jsxs)(`span`,{className:`sheet-sub`,children:[L.path,` · `,L.talent.root,` · `,L.originRevealed?`身负「${L.origin}」`:`身世未明`]}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>p(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`kv`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`境界`}),(0,$.jsxs)(`b`,{children:[ye,`（`,Math.round(L.sublevel*100),`%）`]})]}),L.goldenCoreGrade>0&&(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`结丹`}),(0,$.jsx)(`b`,{className:_(L.goldenCoreGrade)?`core-top`:``,children:It(L.path,L.goldenCoreGrade)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`寿元`}),(0,$.jsxs)(`b`,{children:[Math.floor(L.ageMonths/12),` / `,L.lifespanYears]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`道心`}),(0,$.jsx)(`b`,{children:Math.round(L.道心)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`气运`}),(0,$.jsx)(`b`,{children:Math.round(L.气运)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`功德`}),(0,$.jsx)(`b`,{children:Math.round(L.功德)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`业障`}),(0,$.jsx)(`b`,{children:Math.round(L.业障)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`僭越`}),(0,$.jsx)(`b`,{children:Math.round(L.僭越)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`堕度`}),(0,$.jsx)(`b`,{children:Math.round(L.堕度)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`丹毒`}),(0,$.jsx)(`b`,{children:Math.round(L.丹毒)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`名望`}),(0,$.jsx)(`b`,{children:Math.round(L.名望)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`悟性`}),(0,$.jsx)(`b`,{children:L.talent.悟性})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`根骨`}),(0,$.jsx)(`b`,{children:L.talent.根骨})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`神魂`}),(0,$.jsx)(`b`,{children:L.talent.神魂})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`纯度`}),(0,$.jsx)(`b`,{children:Math.round(L.talent.purity)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`真实战力`}),(0,$.jsx)(`b`,{children:Se(L).toFixed(2)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`藏拙`}),(0,$.jsxs)(`b`,{children:[Math.round(Ce(L)*100),`%`]})]})]}),(t.ctx.systems.length>0||L.souls.some(e=>!e.dissipated))&&(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[t.ctx.systems.length>0&&(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`金手指：`,t.ctx.systems.join(`、`)]}),L.souls.filter(e=>!e.dissipated).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`残魂 `,e.name,` —— 好感 `,Math.round(e.favor),` · 夺舍 `,Math.round(e.possession),`%`]},e.id))]}),(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`未了因果：恶 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,`· 善 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity>0).length,t.ctx.knowers.length?` · 知情者 ${t.ctx.knowers.length} 人`:``]}),[`金手指`,`残魂`,`真实修为`,`杀过某人`,`身世`].filter(e=>L.secrets[e]>=25).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`暴露 · `,e,`：`,Math.round(L.secrets[e])]},e))]}),(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[(0,$.jsx)(`div`,{className:`sheet-line`,style:{marginBottom:8},children:`修行之姿`}),(0,$.jsx)(`div`,{className:`row`,children:qo.map(e=>(0,$.jsx)(`button`,{className:`ghost-btn ${t.stance===e.m?`on`:``}`,onClick:()=>{t.stance=e.m,A(e=>e+1)},children:e.label},e.m))}),(0,$.jsx)(`div`,{className:`sheet-hint`,children:qo.find(e=>e.m===t.stance)?.hint})]})]})]})]})}function $o(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function es(e){return $o(e).replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`).replace(/`([^`]+)`/g,`<code>$1</code>`)}function ts(e){let t=[],n=!1,r=[],i=[],a=[],o=()=>{a.length&&(t.push(`<p>${a.map(es).join(`
`)}</p>`),a=[])},s=()=>{i.length&&(t.push(`<blockquote>${i.map(es).join(`
`)}</blockquote>`),i=[])};for(let c of e.split(`
`)){if(c.startsWith("```")){o(),s(),n&&(t.push(`<pre class="mono">${$o(r.join(`
`))}</pre>`),r.length=0),n=!n;continue}if(n){r.push(c);continue}if(c.startsWith(`### `)){o(),s(),t.push(`<h3>${es(c.slice(4))}</h3>`);continue}if(c.startsWith(`## `)){o(),s(),t.push(`<h2>${es(c.slice(3))}</h2>`);continue}if(c.startsWith(`# `)){o(),s(),t.push(`<h1>${es(c.slice(2))}</h1>`);continue}if(c.trim()===`---`){o(),s(),t.push(`<hr/>`);continue}if(c.startsWith(`> `)||c===`>`){o(),i.push(c.replace(/^> ?/,``));continue}if(c.startsWith(`- `)){o(),s(),t.push(`<li>${es(c.slice(2))}</li>`);continue}if(c.trim()===``){o(),s();continue}s(),a.push(c)}return o(),s(),n&&r.length&&t.push(`<pre class="mono">${$o(r.join(`
`))}</pre>`),t.join(`
`)}function ns(e){let{game:t,result:n}=e,[i,a]=(0,r.useState)(`成书`),[o,s]=(0,r.useState)(t.pov===`我`?`我`:`他`),c=(0,r.useMemo)(()=>o===`他`?n.novel:Ea({daoName:t.name,seed:t.seed,beats:t.session.beats,chronicle:n.chronicle,stele:n.stele,signature:t.session.signature(),pov:`我`}),[o,t,n]);return(0,$.jsxs)(`div`,{className:`over fade-in`,children:[(0,$.jsxs)(`div`,{className:`ending-grade`,children:[n.stele.grade,` · `,n.stele.serial]}),(0,$.jsx)(`div`,{className:`ending-name`,children:n.ending.name}),(0,$.jsx)(`div`,{className:`ending-text`,children:n.ending.text}),(0,$.jsxs)(`div`,{className:`ending-text`,style:{marginTop:4},children:[`道果 +`,n.daoFruit,`（累计 `,e.save.registry.daoFruit,`）`]}),(0,$.jsx)(`div`,{className:`tabs`,children:[`成书`,`一生录`,`道碑`].map(e=>(0,$.jsx)(`button`,{className:`tab ${i===e?`on`:``}`,onClick:()=>a(e),children:e},e))}),i===`成书`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn ${o===`他`?`on`:``}`,onClick:()=>s(`他`),children:`传记体`}),(0,$.jsx)(`button`,{className:`ghost-btn ${o===`我`?`on`:``}`,onClick:()=>s(`我`),children:`自述体`}),(0,$.jsx)(`span`,{className:`grow`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{let e=new Blob([c],{type:`text/markdown;charset=utf-8`}),n=document.createElement(`a`);n.href=URL.createObjectURL(e),n.download=`藏锋录·${t.name}${o===`我`?`自述`:`卷`}.md`,n.click(),URL.revokeObjectURL(n.href)},children:`下载此书`})]}),(0,$.jsx)(`div`,{className:`book`,dangerouslySetInnerHTML:{__html:ts(c)}})]}),i===`一生录`&&(0,$.jsx)(`pre`,{className:`mono`,children:dr(n.chronicle)}),i===`道碑`&&(0,$.jsx)(`pre`,{className:`mono`,children:br(n.stele)}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:10},children:(0,$.jsx)(`button`,{className:`primary-btn`,style:{flex:1},onClick:e.onRestart,children:`再 入 轮 回`})}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`},children:(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onGallery,children:`去碑林看看`})})]})}function rs(e){let[t,n]=(0,r.useState)(null),i=[...e.save.steles].reverse(),a=oo(e.save);return(0,$.jsxs)(`div`,{className:`gallery fade-in`,children:[(0,$.jsx)(`h2`,{children:`碑 林`}),(0,$.jsxs)(`div`,{className:`row`,style:{justifyContent:`center`,color:`var(--dim)`,fontSize:`0.85rem`},children:[Object.entries(a).map(([e,t])=>(0,$.jsxs)(`span`,{children:[e,`×`,t]},e)),i.length===0&&(0,$.jsx)(`span`,{children:`（空山无碑。去走一遭吧。）`})]}),i.map(e=>(0,$.jsxs)(`div`,{className:`stele-item`,onClick:()=>n(t===e.serial?null:e.serial),children:[(0,$.jsxs)(`div`,{className:`sh`,children:[(0,$.jsx)(`span`,{className:`grade`,children:e.grade}),(0,$.jsx)(`span`,{className:`nm`,children:e.daoName}),(0,$.jsxs)(`span`,{className:`meta`,children:[e.ending,` · `,e.finalRealm,` · 寿`,e.lifespan,`载 · 完满度`,e.perfection]}),(0,$.jsx)(`span`,{className:`meta`,children:`★`.repeat(e.rarity)})]}),t===e.serial&&(0,$.jsx)(`pre`,{className:`mono`,style:{marginTop:10},children:br(e)})]},e.serial)),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:12},children:(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:e.onBack,children:`回到入口`})})]})}function is(){let[e,t]=(0,r.useState)(Wa);return(0,r.useEffect)(()=>Ga(t),[]),e}function as({load:e}){let t=e.total>0?e.done/e.total:0;return e.status===`error`?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(To,{progress:t,label:`香火中断`}),(0,$.jsx)(`div`,{style:{position:`fixed`,inset:0,zIndex:61,pointerEvents:`none`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`flex-end`,paddingBottom:`14vh`},children:(0,$.jsxs)(`div`,{style:{pointerEvents:`auto`,maxWidth:`20rem`,textAlign:`center`},children:[(0,$.jsx)(`div`,{style:{fontSize:`.78rem`,opacity:.75,lineHeight:1.6},children:e.error}),(0,$.jsx)(`button`,{className:`primary-btn`,onClick:ro,children:`重 燃`})]})})]}):(0,$.jsx)(To,{progress:t})}function os(){let e=is(),t=e.db,[n]=(0,r.useState)(()=>co()),[i,a]=(0,r.useState)(`cover`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),f=(e,t)=>{ho();let r=new Ia({seed:t.seed,db:e,registry:n.registry,name:t.name,birthplace:t.birthplace});l({session:r,seed:t.seed,name:t.name,pov:t.pov,birthplace:t.birthplace}),d(null),a(`play`)},p=e=>{let t=mo();if(t)try{let r=new Ia({seed:t.snap.seed,db:e,registry:n.registry,restore:t.snap});l({session:r,seed:t.snap.seed,name:t.snap.name,pov:t.pov}),d(null),a(`play`)}catch{ho()}},m=e=>{t?f(t,e):s({kind:`start`,cfg:e})},h=()=>{t?p(t):s({kind:`resume`})};return(0,r.useEffect)(()=>{!t||!o||(s(null),o.kind===`start`?f(t,o.cfg):p(t))},[t,o]),e.total<=0&&!t?(0,$.jsx)(as,{load:e}):(0,$.jsxs)(`div`,{className:`shell`,children:[i===`cover`&&(0,$.jsx)(Eo,{save:n,onEnter:()=>a(`start`),onResume:h,onGallery:()=>a(`gallery`)}),i===`start`&&(0,$.jsx)(So,{save:n,onStart:m,onResume:h,onGallery:()=>a(`gallery`)}),i===`play`&&c&&(0,$.jsx)(Qo,{game:c,onOver:e=>{ho(),n.steles.push(e.stele),lo(n),d(e),a(`over`)},onQuit:()=>a(`start`)}),i===`over`&&c&&u&&(0,$.jsx)(ns,{game:c,result:u,save:n,onRestart:()=>a(`start`),onGallery:()=>a(`gallery`)}),i===`gallery`&&(0,$.jsx)(rs,{save:n,onBack:()=>a(`cover`)}),o&&(0,$.jsx)(as,{load:e})]})}(0,i.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(os,{}));
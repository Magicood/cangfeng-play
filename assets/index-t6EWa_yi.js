...
「养得不错，」他说，「再等等。」`;case`遗孤`:return`那枚旧玉佩终于对上了。有人认出了它，脸色瞬间变了。`;case`双生`:return`你在千里之外受伤的那天，另一个人也在同一处疼。你们从未见过。`;case`罪裔`:return`族谱上那一页被撕掉了。撕掉的地方，纸背还留着压痕 —— 你能认出那几个字。`;case`无名`:return`天机阁推了三次，三次都是空白。掌事的手在抖：「你……是从哪儿来的？」`;case`归来者`:return`你在一具无名尸骸旁停下。它手上戴的储物戒，和你梦里那枚一模一样。`}}function cn(e){let t=A.find(t=>t.id===e);if(!t)return 1;let n=A.reduce((e,t)=>e+t.weight,0);return Math.round(n/t.weight*10)/10}function ln(e,t){let n=e.actor,r=dn(t),i=r===0?.5:1-F(t.unusedWindows.length/r,0,1),a=F(n.道心/100,0,1),o=F((n.名望+100)/400,0,1);return F(i*.6+a*.25+o*.15,0,1)}function un(e,t){let n=e.actor,r=ln(e,t),i=we(n)+.9-r*1.5+e.rng.range(-.2,.2),a=Ee(e.rng,n,i),o=t.target,s=Math.floor(e.year-t.createdYear),c=`${s} 年前的「${t.type}」找上门 —— ${o}`;if(a===`CRIT_SUCCESS`)return t.resolved=!0,t.resolvedBy=`了结`,{kind:`反杀`,outcome:a,readiness:r,death:null,text:`${o}来了，带着${s}年的恨意。你早知道他会来 —— 所以这一场，你赢得干脆。`};if(a===`SUCCESS`)return t.resolved=!0,t.resolvedBy=`了结`,{kind:`挡下`,outcome:a,readiness:r,death:null,text:`${o}的旧账找上门来。你挡住了。这一段因果，就此了结。`};let l=r<.2;return a===`FAIL`&&!l?(n.factors.状态=F(n.factors.状态-.28,.1,3),n.lifespanYears=Math.max(0,n.lifespanYears-40),n.sublevel=F(n.sublevel-.25,0,1),n.道心=F(n.道心-8,0,100),t.resolved=!0,t.resolvedBy=`补偿`,{kind:`重伤`,outcome:a,readiness:r,death:null,text:`${o}到底还是找上了门。你没能全身而退 ——一身修为塌了小半，寿元也折了几十年。但你还站着，账也算清了。`}):an(e)?(t.resolved=!0,t.resolvedBy=`化解`,{kind:`逃生`,outcome:a,readiness:r,death:null,text:`你本该死在那里。可你没有。你开始怀疑自己身上有什么不对劲。`}):(t.resolved=!0,{kind:`致死`,outcome:a,readiness:r,death:{id:`death_${t.id}`,kind:`因果致死`,lethal:!0,karmaId:t.id,description:c},text:`${o}找上门来。${l?`这些年的天象、传闻、脚下不认得的红泥，都在提醒你这一天会到 —— 你一次也没当回事。`:`你尽了力。可有些账，尽了力也还不上。`}`})}function dn(e){let t=0;for(let n of e.hooks)for(let e of n.foreshadow??[])e.window&&t++;return t}function fn(e,t){let n=e.karmaLedger.filter(e=>!e.resolved&&e.weight>=10).sort((e,t)=>pn(t)-pn(e))[0];return n?(n.resolved=!0,n.resolvedBy=t,n.unusedWindows=[],n):null}function pn(e){return e.weight+(e.hooks.some(e=>e.lethal)?60:0)+(e.unusedWindows.length>0?40:0)-e.matureAt*.01}function mn(e,t){let n=0;for(let t of e){let e=Number(/^k_(\d+)_/.exec(t.id)?.[1]??NaN);Number.isFinite(e)&&e>n&&(n=e)}return`k_${n+1}_${t}`}function hn(e){for(let t of e.hooks){if(!t.lethal)continue;let n=t.foreshadow??[];if(n.length<O.lethalMinForeshadow)throw Error(`[铁律二] 因果钩子「${t.id}」标记 lethal 但只有 ${n.length} 条预警（需 ≥${O.lethalMinForeshadow}）。来源：${e.source}`);if(n.filter(e=>e.window).length<O.lethalMinWindow)throw Error(`[铁律二] 因果钩子「${t.id}」缺少可干预窗口（需 ≥${O.lethalMinWindow} 个 window:true）。来源：${e.source}`)}}function gn(e,t){hn(t);let n=t.matureWindow??[...O.defaultMatureWindow],r=e.year+e.rng.range(n[0],n[1]),i={id:mn(e.karmaLedger,t.type),type:t.type,source:t.source,actor:t.actor,target:t.target,weight:t.weight,polarity:t.polarity,createdYear:e.year,matureWindow:n,chainParent:t.chainParent??null,resolved:!1,hooks:t.hooks,matureAt:r,foreshadowsSent:[],unusedWindows:[]};return e.karmaLedger.push(i),i}function _n(e,t){let n=e.karmaLedger.find(e=>!e.resolved&&e.target===t.target&&e.type===t.type);return n?(n.weight+=t.weight,n):gn(e,t)}function vn(e,t){let n=[],r=0;for(let i of e.karmaLedger){if(i.resolved||i.weight<O.minEventWeight)continue;let a=yn(e,i);if(a){for(let r of a.foreshadow??[]){let o=i.matureAt+r.at;!i.foreshadowsSent.includes(r.evt)&&e.year>=o&&e.year-t<o+t&&(i.foreshadowsSent.push(r.evt),r.window&&i.unusedWindows.push(r.evt),n.push({kind:r.window?`window`:`foreshadow`,karma:i,hook:a,evtId:r.evt,lethal:!!a.lethal}))}if(e.year>=i.matureAt&&r<O.maxResolvePerTick){let o=i.foreshadowsSent.length;if(a.lethal&&o<O.lethalMinForeshadow){i.matureAt=e.year+Math.max(2,t);continue}r++,i.resolved=!0,n.push({kind:`mature`,karma:i,hook:a,evtId:a.id,lethal:!!a.lethal})}}}return n}function yn(e,t){if(t.hooks.length===0)return;let n=t.polarity<0?0:Math.min(t.hooks.length-1,1);return t.hooks[n]??t.hooks[0]}function bn(e,t){let n=new Map(e.map(e=>[e.id,e])),r=[],i=n.get(t),a=new Set;for(;i&&!a.has(i.id);)a.add(i.id),r.unshift(i),i=i.chainParent?n.get(i.chainParent):void 0;return r}function xn(e,t){e.resolved=!0,e.resolvedBy=t}function Sn(e){return e.filter(e=>!e.resolved).sort((e,t)=>t.weight-e.weight)}function Cn(e){return e.reduce((e,t)=>e+t.polarity*t.weight,0)}function wn(e,t){return{id:e,lethal:!0,foreshadow:[{at:-8,evt:`${t}_传闻`},{at:-3,evt:`${t}_打听`},{at:-1,evt:`${t}_逼近`,window:!0}]}}var Tn=class extends Error{};function En(e,t){let n=t.karmaId?bn(e.karmaLedger,t.karmaId):[];if(n.length===0&&t.kind!==`寿元`)throw new Tn(`[铁律三] 死因「${t.id}」(${t.kind}) 无因果链，无法向玩家解释。`);let r=n.flatMap(e=>e.foreshadowsSent);if(t.lethal&&t.kind!==`寿元`&&r.length<O.lethalMinForeshadow)throw new Tn(`[铁律二] 死因「${t.id}」只投放了 ${r.length} 条预警（需 ≥${O.lethalMinForeshadow}）。`);let i=n.flatMap(e=>e.unusedWindows);return e.actor.alive=!1,{cause:t,chain:n,warnings:r,missedWindows:i,atYear:Math.floor(e.year),atTier:e.actor.tier,atPath:e.actor.path}}function Dn(e){return e.actor.ageMonths/12<e.actor.lifespanYears?null:{id:`death_lifespan`,kind:`寿元`,lethal:!0,description:`寿元耗尽，坐化于第 ${Math.floor(e.year)} 年`}}function On(e){let t=e.actor.lifespanYears-e.actor.ageMonths/12;return t>10||t<=0?null:`寿元将尽，尚余 ${t.toFixed(1)} 年`}function kn(e,t){let n=e.tier-t;for(let e of de.guidanceByGap)if(n>=e.gap)return{level:e.level,speedBonus:e.speedBonus,canAct:e.canAct,gap:n};return{level:de.guidanceByGap[de.guidanceByGap.length-1].level,speedBonus:0,canAct:!1,gap:n}}function An(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);if(!n)return null;let r=kn(n,e.actor.tier);if(r.speedBonus<=0)return r;let i=de.possessionPerGuidance*(1+r.gap*.08)*(1-e.actor.道心/250);return n.possession=F(n.possession+i,0,100),n.favor=F(n.favor+1,-100,100),r}function jn(e){let t=[];for(let n of e.actor.souls)if(!n.dissipated){if(n.possession>=100){t.push({soul:n,fate:`夺舍成功`}),e.actor.alive=!1;continue}if(Math.max(0,n.tier-e.actor.tier)<=0&&e.rng.chance(.02)){n.dissipated=!0,t.push({soul:n,fate:`消散`});continue}n.favor=F(n.favor-.15,-100,100)}return t}function Mn(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);if(!n)return{ok:!1,text:`并无此魂`};let r=55+n.tier*4+n.possession*.3;return e.actor.道心<r?(n.possession=100,e.actor.alive=!1,{ok:!1,text:`你伸手去抓那缕残魂，却被它顺着手臂爬了进来。`}):(n.dissipated=!0,e.actor.factors.功法=F(e.actor.factors.功法+.25,.55,1.9),e.actor.业障+=25,e.actor.道心=F(e.actor.道心-12,0,100),{ok:!0,text:`你吞下了他。他毕生所学成了你的，连同他没来得及说完的那句话。`})}function Nn(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);return n?n.favor<80?{ok:!1,text:`他还不信你。`}:(n.dissipated=!0,e.actor.功德+=40,e.actor.道心=F(e.actor.道心+8,0,100),{ok:!0,text:`他松开了。最后那点光散进风里，往下面去了。`}):{ok:!1,text:`并无此魂`}}function Pn(e,t){let n=e.actor.souls.find(e=>e.id===t&&!e.dissipated);return n?n.favor<90?{ok:!1,text:`他还没打算把自己交出去。`}:(n.dissipated=!0,e.actor.talent.神魂=F(e.actor.talent.神魂+15,1,100),e.actor.factors.功法=F(e.actor.factors.功法+.18,.55,1.9),e.flags.add(`融合_${t}`),{ok:!0,text:`从此你分不清哪些念头是自己的，哪些是他的。他好像也不在意了。`}):{ok:!1,text:`并无此魂`}}function Fn(e){return!!e.defect&&!e.defect.resolved}function In(e){return e.birthFaction??{faction:``,relation:`无关`}}var Ln=`lineage`;function Rn(e){let t=e.actor,n=In(t);n.faction&&(e.flags.add(`出身势力·${n.faction}`),e.flags.add(`出身关系·${n.relation}`)),Fn(t)&&(e.flags.add(`血脉·有瑕`),e.flags.add(`瑕·${t.defect.id}`)),Fn(t)&&gn(e,{type:`夺取`,source:`${Ln}·defect`,actor:t.defect.culprit,target:t.defect.culprit,weight:N.defect.weight,polarity:-1,matureWindow:[...N.defect.window],hooks:[{id:`defect·旧影`,foreshadow:[{at:-4,evt:`瑕疵下手者·风声`}]}]});let r=[];switch(t.origin){case`罪裔`:r.push({type:`灭门`,target:`追讨旧账的人`,tag:`罪裔`,weight:N.罪裔.weight,window:N.罪裔.window,lethalPrefix:`罪裔旧账`});break;case`遗孤`:r.push({type:`灭门`,target:`灭门的仇家`,tag:`遗孤`,weight:N.遗孤.weight,window:N.遗孤.window,lethalPrefix:`灭门旧仇`});break;case`容器`:r.push({type:`夺取`,target:`等你长成的人`,tag:`容器`,weight:N.容器.weight,window:N.容器.window,lethalPrefix:`容器之约`});break;case`上古血脉后裔`:r.push({type:`立誓`,tag:`名门`,target:e.rng.pick([`家族的政敌`,`一桩联姻的旧诺`,`欠着的旧人情`]),weight:N.名门.weight,window:N.名门.window})}n.relation===`质子`&&n.faction&&r.push({type:`立誓`,target:`${n.faction}的质约`,tag:`质子`,weight:N.质子.weight,window:N.质子.window});for(let t of r)gn(e,{type:t.type,source:`${Ln}·${t.tag}`,actor:t.target,target:t.target,weight:t.weight,polarity:t.lethalPrefix?-1:0,matureWindow:[...t.window],hooks:t.lethalPrefix?[wn(`${t.tag}·清算`,t.lethalPrefix)]:[{id:`${t.tag}·索取`,foreshadow:[{at:-3,evt:`${t.tag}旧账·来信`}]}]})}function zn(e){let t=e.actor,n=t.defect;if(!n||n.resolved)return null;let r=t.talent.root;t.talent={...n.preTalent,elements:[...n.preTalent.elements]},t.僭越=F(t.僭越+(g[t.talent.root]??0)-(g[r]??0),0,1/0),n.resolved=!0,e.flags.delete(`血脉·有瑕`),e.flags.delete(`瑕·${n.id}`),e.flags.add(`血脉·已复`);let i=e.karmaLedger.find(e=>!e.resolved&&e.source===`${Ln}·defect`);return i&&xn(i,`了结`),{defect:n,text:`压在你根骨里的那点东西（${n.id}）散了。经脉里的淤塞一寸寸退开 —— 原来你本该是这样的资质。这笔账，也算到头了。`}}function Bn(e){let t=[];if(e.flags.delete(`瑕·解除`)){let n=zn(e);n&&t.push(n.text)}return t}var Vn=[`金手指`,`残魂`,`真实血脉`,`真实修为`,`杀过某人`,`身世`];function Hn(e,t,n,r){e.actor.secrets[t]=F(e.actor.secrets[t]+n,0,100),r&&!e.knowers.some(e=>e.npc===r&&e.secret===t)&&e.knowers.push({npc:r,secret:t,risk:F(n/20,.05,.9)})}function Un(e){Hn(e,`真实修为`,k.overTierArtifact)}function Wn(e){let t=e.actor,n=Ce(t.僭越),r=Te(t);n.hunted>0&&(t.secrets.金手指=F(t.secrets.金手指+n.hunted*4,0,100),t.secrets.真实修为=F(t.secrets.真实修为+n.hunted*2,0,100));for(let n of e.knowers)e.rng.chance(n.risk*.06)&&(t.secrets[n.secret]=F(t.secrets[n.secret]+6,0,100));let i=.8+r*2.2;for(let e of Vn)t.secrets[e]=Math.max(0,t.secrets[e]-i)}function Gn(e){return Vn.filter(t=>e.actor.secrets[t]>=k.revealAt)}function Kn(e,t){let n=e.knowers.filter(e=>e.npc===t).map(e=>e.secret);e.knowers=e.knowers.filter(e=>e.npc!==t);for(let t of n)e.actor.secrets[t]=Math.max(0,e.actor.secrets[t]-18);return e.actor.业障+=12+n.length*5,e.actor.道心=F(e.actor.道心-3,0,100),n}function qn(e,t){let n=e.knowers.findIndex(e=>e.npc===t);if(n<0)return!1;let r=e.knowers[n];return e.actor.secrets[r.secret]=Math.max(0,e.actor.secrets[r.secret]-10),e.knowers.splice(n,1),e.actor.业障+=2,!0}function Jn(e){let t=e.actor;t.僭越=0,t.名望=0,t.锋芒=0;for(let e of Vn)t.secrets[e]=0;e.knowers=[],t.factors.情报=.85,t.factors.伙伴=.9,t.factors.道侣=1,e.flags.add(`假死脱身`)}function Yn(e){let t=Te(e.actor);return{faceSlapMult:1+t*(oe.faceSlapMultMax-1),decayBonus:t*oe.decayBonusMax,resourcePenalty:t*oe.resourcePenaltyMax}}function Xn(e){let{decayBonus:t}=Yn(e),n=1+F(e.actor.功德,0,300)/600;e.actor.僭越=Math.max(0,e.actor.僭越-w.decayBase*(1+t)*n)}var Zn=[[`练气`,1],[`筑基`,2],[`金丹`,3],[`元婴`,4],[`化神`,5],[`炼虚`,6],[`合体`,7],[`大乘`,8]];function Qn(e,t){if(t===`正道`||t===`散修`)return e;let n=e;for(let[e,r]of Zn){if(!n.includes(e))continue;let i=r===3&&/金丹(碎|裂|散|毁)/.test(n)?Lt[t]:H(t,r);n=n.split(e).join(i)}return n}var $n={守尸人:{name:`婴死体存 · 守尸人`,grade:`凡碑`,mult:.8,text:`肉身还在，元婴没了。往后的日子靠药和阵撑着，等一个「借婴」的法子。`},痴儿:{name:`神识裂解 · 痴儿`,grade:`凡碑`,mult:.9,text:`修为还在，人不在了。你在山里走来走去，见谁都笑，谁的名字都想不起来。`},虚空漂流:{name:`虚空吞噬 · 漂流者`,grade:`灵碑`,mult:1.1,text:`虚空裂开的那一瞬间你没抓住任何东西。此后你还活着，只是再也回不去了。`},残魂:{name:`道体崩解 · 化为残魂`,grade:`玄碑`,mult:1.4,text:`肉身尽毁，只余一缕。你飘在原地，看着自己的洞府积灰 —— 你终于成了你当年遇到的那种东西。`},地缚灵:{name:`道消 · 地缚`,grade:`凡碑`,mult:.7,text:`执念缚在这片死地上。偶尔有人路过，你想说话，他们听不见。`}},er={药王谷:`药王谷谷主`,东海:`东海岛主`,中州:`一城之主`,山野:`山野散人`,宗门:`太上长老`,北荒:`妖蛮部落王`,西域:`佛国住持`,坊市:`坊市巨商`,剑冢:`剑冢守墓人`};function tr(e){let t=e.actor,n=$t(t),r=D;if(e.death&&e.death.cause.kind!==`寿元`){let n=e.death.cause.kind;return{id:`death_${n}`,name:`夭折 · ${n}`,tier:`夭折`,grade:`凡碑`,fruitMult:.3+t.tier*.08,text:e.death.cause.description}}if(e.failedBranch){let n=e.failedBranch.branch?$n[e.failedBranch.branch]:void 0;return n?{id:`branch_${e.failedBranch.branch}`,name:Qn(n.name,t.path),tier:`夭折`,grade:n.grade,fruitMult:n.mult+t.tier*.1,text:Qn(n.text,t.path)}:{id:`tribulation_failed`,name:`${e.failedBranch.name} · ${Qn(e.failedBranch.outcome,t.path)}`,tier:`夭折`,grade:`凡碑`,fruitMult:.6+t.tier*.1,text:Qn(e.failedBranch.outcome,t.path)}}if(t.souls.some(e=>e.possession>=100))return{id:`possessed`,name:`被夺舍 · ${t.souls.find(e=>e.possession>=100).name}`,tier:`夭折`,grade:`凡碑`,fruitMult:.5,text:`你最后的念头是：他早就说过的。`};if(t.堕度>=100)return{id:`possessed_by_demon`,name:`入魔失控`,tier:`夭折`,grade:`血道碑`,fruitMult:1.2,text:`你还在，但那个「你」已经不在了。往后有人会用你的名字，做你不会做的事。`};if(t.tier>=10)return t.path===`武道`&&t.talent.root===`无灵根`&&n>=r.以凡证道.perfection?{id:`mortal_ascend`,name:`以凡证道`,tier:`隐藏`,grade:`无字碑`,fruitMult:fe.noSystemMult,text:`你从头到尾都是个凡人。然后你打赢了神仙。`}:n>=r.真仙.perfection&&t.僭越<r.真仙.transgression&&t.hiddenRealms.length>=9&&e.jieXian?{id:`true_immortal`,name:`真仙`,tier:`飞升`,grade:`道碑`,fruitMult:6,text:`云开，天梯落下。你回头看了一眼这座你活了千年的山，然后走了上去。`}:t.堕度>=T.transcendBand[0]&&t.堕度<=T.transcendBand[1]&&n>=r.堕仙.perfection&&(e.reflections??0)>=3?{id:`fallen_immortal`,name:`堕仙 · 魔祖证道`,tier:`飞升`,grade:`血道碑`,fruitMult:fe.transcendMult,text:`此道自我而始，亦自我而终。后来者，勿效。`}:{id:`ascend`,name:`飞升 · 上位面一员`,tier:`飞升`,grade:`天碑`,fruitMult:3,text:`天梯尽头是另一片天。你抬头，发现上面还有人在往上走。`};if(e.steppedDown){let r=er[e.rootedAt??`山野`]??`一方之主`,i=n>=80?`玄碑`:`灵碑`;return{id:`local_${e.rootedAt??`山野`}`,name:`偏安一隅 · ${r}`,tier:`偏安`,grade:i,fruitMult:1+t.tier*.15+n/100,text:`你在这里住了下来。后来有人问起你是谁，你说，就是个种药的。`}}return!e.death&&t.tier>=5&&t.功德>200&&t.僭越<20&&n>=85?{id:`seclusion`,name:`归隐`,tier:`隐藏`,grade:`无字碑`,fruitMult:4,text:`你把修为散了。散得干干净净，像从来没修过一样。`}:t.tier>=9?n>=r.位面主宰.perfection&&t.僭越<r.位面主宰.transgression?{id:`plane_sovereign`,name:`位面主宰`,tier:`主宰`,grade:`地碑`,fruitMult:2.2,text:`这一界之内，再无人能让你抬头。而你抬头时，看见的还是那层没破的天。`}:{id:`stuck_at_9`,name:`止步渡劫期`,tier:`主宰`,grade:`玄碑`,fruitMult:1.6,text:`你在渡劫期停了下来。天劫还在上面等着，你知道自己过不去。`}:t.tier>=5?{id:`elder_${t.tier}`,name:`一方尊长 · 老死于此界`,tier:`偏安`,grade:n>=80?`玄碑`:`灵碑`,fruitMult:.9+t.tier*.14+n/150,text:`你没能再往上走一步。但这一界之内，认得你名字的人已经不多了 —— 比你年长的都死光了。`}:t.tier>=3?{id:`mortal_end_${t.tier}`,name:`碌碌一生 · 尚有薄名`,tier:`偏安`,grade:`灵碑`,fruitMult:.6+t.tier*.12,text:`结了丹，也就到此为止了。山下的人还记得你，山上的人已经忘了。`}:{id:`mortal_end_${t.tier}`,name:`碌碌一生`,tier:`偏安`,grade:`凡碑`,fruitMult:.5+t.tier*.12,text:`没什么可说的。这样的人，这座山上每年都要埋掉几十个。`}}function nr(e,t,n={}){let r=$t(e),i=e.tier*10+r*.6,a=t.fruitMult;n.noSystem&&(a*=fe.noSystemMult/3),e.堕度>=46&&(a*=fe.corruptMult/2),e.goldFingerTier>=0&&(a*=fe.tierMult[e.goldFingerTier]??1),a*=fe.difficultyMult[n.difficulty??`修士`]??1;let o=e.锋芒>0?Math.max(0,1-e.锋芒/Math.max(e.tier,1)):1;return a*=1+o*.35,Math.round(i*a)}function rr(e){return e.tier>=D.地方大佬.minTier&&e.alive}function ir(e,t,n){return{tick:t,year:Math.floor(n),tier:e.tier,道心:Math.round(e.道心),僭越:Math.round(e.僭越),堕度:Math.round(e.堕度),气运:Math.round(e.气运),名望:Math.round(e.名望),perfection:Math.round($t(e))}}function ar(e,t,n){let r=Math.max(1,Math.floor(n-t.createdYear)),i=t.resolved;if(t.polarity>0)return e.pick([`后来他活得不错，只是再没见过你。他跟人提起过一次，说当年有个人帮过他，可惜没问名字。`,`他记了你一辈子。临终前把这件事讲给了孙辈听，讲得添油加醋。`,`他后来也修出了点名堂。有人问他师承何处，他说，是一个只见过一面的人。`,`他没等到还这份人情的机会。你死的消息传到他那儿时，他沉默了很久。`]);if(t.polarity<0){if(i){let n=[`这笔账在第 ${Math.floor(t.createdYear)+Math.floor(r*.6)} 年了了。之后再没人提起。`,`他死在了你前面。死因与你无关，但也不能说全无关系。`,`你们最后一次见面时谁也没说话。这事就这么过去了。`];return e.pick(n)}let n=[`他等了你 ${r} 年，等到你死也没等来。这口气他带进了棺材。`,`他把这笔账留给了后人。你的名字被写在一张纸上，压在他家祠堂的供桌下面。`,`他后来做了和你一样的事，对另一个人。`,`他一直在找你。你死那年，他刚好走到离你三百里的地方。`];return e.pick(n)}return`此后各自行路，再无交集。`}function or(e){switch(e.type){case`救助`:case`施恩`:return`你救过/帮过的人`;case`杀戮`:return`死在你手上的人`;case`背叛`:return`被你辜负的人`;case`夺取`:return`被你拿走过东西的人`;case`受辱`:return`欺负过你的人`;case`毁诺`:return`你食言过的人`;case`欺骗`:return`被你骗过的人`;case`传承`:return`把东西留给你的人`;case`放走`:return`你放过一马的人`;case`灭门`:return`被你灭门的人`;case`立誓`:return`你许过诺的人`}}function sr(e){let{actor:t,ledger:n,death:r,ending:i}=e,a=new o(`${e.seed}:chronicle`),s=n.filter(e=>e.resolved),c=Sn(n),l=new Set,u=[...n].sort((e,t)=>t.weight-e.weight).slice(0,12).map(t=>{let n=ar(a,t,e.diedAtYear);for(let r=0;r<3&&l.has(n);r++)n=ar(a,t,e.diedAtYear);return l.add(n),{name:t.target,relation:or(t),whatYouDid:`第 ${Math.floor(t.createdYear)} 年 · ${t.type}（因果重 ${t.weight}）`,afterward:n}}),d=[...e.flags].filter(e=>e.startsWith(`道·`)||e.startsWith(`结丹·`)||[`无系统`,`得系统`,`拒绝过系统`,`假死脱身`,`手上有人命`,`已立威`].includes(e)),f=$t(t);return{timeline:e.milestones,deathChain:r?cr(r):null,missedWindows:r?.missedWindows??[],karmaResolved:s,karmaUnresolved:c,karmaNet:Math.round(Cn(n)),people:u,curve:e.curve,forks:d,verdict:lr(t,n,i,e.diedAtYear),unfinished:c.slice(0,8).map(e=>`第 ${Math.floor(e.createdYear)} 年欠下的「${e.type}」—— ${e.target}（重 ${e.weight}）`),name:t.name,path:t.path,origin:t.origin,originRarity:cn(t.origin),tier:t.tier,lifespan:Math.floor(t.ageMonths/12),perfection:Math.round(f*10)/10,concealment:Math.round(Te(t)*100)/100,ending:i}}function cr(e){return e.chain.map((e,t)=>`${t+1}. 第 ${Math.floor(e.createdYear)} 年 · ${e.type} · ${e.target}（重 ${e.weight}）`).join(`
`)}function lr(e,t,n,r){let i=$t(e),a=t.filter(e=>e.type===`杀戮`).length,o=t.filter(e=>e.type===`救助`||e.type===`施恩`).length,s=t.filter(e=>e.type===`毁诺`).length,c=t.filter(e=>e.type===`立誓`).length,l=e.origin===`凡俗`?`生于微末，无所凭恃`:e.originRevealed?`身负「${e.origin}」之命`:`生而不知其所以生`,u=e.souls.length>0?`得残魂而起`:n.tier===`隐藏`&&n.id===`mortal_ascend`?`不假外物`:`独行至此`,d=Te(e)>.6?`一世藏锋，未尝显名`:e.名望>200?`声名赫赫，四海皆闻`:`半明半晦，不为人知`,f=i>=95?`无瑕无垢`:i>=80?`其行有瑕，其志不移`:i>=60?`瑕瑜互见`:`根基已污`,p=[];a&&p.push(`杀${fr(a)}人`),o&&p.push(`救${fr(o)}人`),s&&p.push(`负${fr(s)}诺`),c&&p.push(`践${fr(c)}誓`);let m=ur(e,n,i);return[`${l}，${u}，${d}。`,`${f}。${p.length?p.join(`，`)+`。`:``}`,`寿${fr(Math.floor(e.ageMonths/12))}载，终于${Math.floor(r)}年。`,`——「${m}」`].join(`
`)}function ur(e,t,n){return t.id===`true_immortal`?`道无捷径，唯诚而已。`:t.id===`fallen_immortal`?`此道自我而始，亦自我而终。`:t.id===`mortal_ascend`?`凡骨亦可撼天，只是无人肯信。`:t.id===`seclusion`?`知其可为而不为，是为大智。`:t.tier===`夭折`&&e.tier<=2?`此山每年埋人数十，其名多不可考。`:t.tier===`夭折`?`知其不可为而为之，是为道心；知其不可留而留之，是为执念。`:t.tier===`偏安`?`止于所当止，亦是一种圆满。`:n<60?`路是自己选的，账也是自己欠的。`:`行至水穷，坐看云起。`}var dr=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function fr(e){return e<10?dr[e]:e<20?`十${e%10?dr[e%10]:``}`:e<100?`${dr[Math.floor(e/10)]}十${e%10?dr[e%10]:``}`:e<1e4?String(e):`${Math.floor(e/1e4)}万${e%1e4?String(e%1e4):``}`}function pr(e){let t=[],n=e=>{t.push(``,`── ${e} ──`)};t.push(`═`.repeat(66)),t.push(`《一生录》 · ${e.name}`),t.push(`═`.repeat(66)),t.push(`${e.path} · 位阶 ${e.tier} · 寿 ${e.lifespan} 载`),t.push(`身世「${e.origin}」（约 ${e.originRarity} 局一见）· 道途完满度 ${e.perfection}「${en(e.perfection)}」`),t.push(`藏拙 ${e.concealment} · 因果净极性 ${e.karmaNet}`),t.push(``),t.push(`【${e.ending.name}】${e.ending.text}`),n(`① 生平`);for(let n of e.timeline.slice(0,24))t.push(`  ${String(n.year).padStart(5)}年  ${n.text}`);if(e.timeline.length>24&&t.push(`  …另有 ${e.timeline.length-24} 条`),e.deathChain&&(n(`② 死因链`),t.push(e.deathChain),e.missedWindows.length)){t.push(``,`  你本可以在这些时刻改变结局：`);for(let n of e.missedWindows)t.push(`  · ${n}`)}n(`③ 因果`),t.push(`  已了结 ${e.karmaResolved.length} 条 · 未了结 ${e.karmaUnresolved.length} 条`),n(`④ 人物志`);for(let n of e.people.slice(0,6))t.push(`  【${n.name}】${n.relation}`),t.push(`    ${n.whatYouDid}`),t.push(`    ${n.afterward}`),t.push(``);if(e.forks.length&&(n(`⑥ 岔路`),t.push(`  ${e.forks.join(` · `)}`)),n(`⑦ 判词`),t.push(e.verdict.split(`
`).map(e=>`  ${e}`).join(`
`)),e.unfinished.length){n(`⑧ 未竟之事`);for(let n of e.unfinished)t.push(`  · ${n}`);t.push(``,`  （这些会跟着你，进入下一局。）`)}return t.push(``),t.join(`
`)}function mr(e){return e.tier===3&&e.goldenCoreGrade>0?Rt(e.path,e.goldenCoreGrade):e.tier>=10?H(e.path,e.tier):Wt(e.path,e.tier,e.sublevel)}var hr=`甲乙丙丁戊己庚辛壬癸`,gr=`子丑寅卯辰巳午未申酉戌亥`,_r=[`零`,`壹`,`贰`,`叁`,`肆`,`伍`,`陆`,`柒`,`捌`,`玖`];function vr(e){return`${hr[e%10]}${gr[e%12]}·${String(e).split(``).map(e=>_r[Number(e)]).join(``)}`}function yr(e,t){let n=Math.max(1,Math.floor(e.createdYear-t+16)),r=n<100?`${n}岁`:`${Math.floor(e.createdYear)}年`,i=e.target;switch(e.type){case`杀戮`:return`${r}，杀${i}${e.weight>45?`，血溅五步`:``}。`;case`救助`:return`${r}，救${i}于危难。`;case`施恩`:return`${r}，施恩于${i}，未求报。`;case`背叛`:return`${r}，负${i}。`;case`夺取`:return`${r}，取${i}之物，其人不甘。`;case`受辱`:return`${r}，为${i}所辱，未即报。`;case`毁诺`:return`${r}，毁与${i}之约。`;case`欺骗`:return`${r}，绐${i}。`;case`传承`:return`${r}，得${i}之遗泽。`;case`放走`:return`${r}，纵${i}去。`;case`立誓`:return`${r}，与${i}立誓。`;case`灭门`:return`${r}，屠${i}满门。`}}function br(e){let{actor:t,ledger:n,ending:r}=e,i=[...n].sort((e,t)=>t.weight-e.weight).slice(0,5).sort((e,t)=>e.createdYear-t.createdYear).map(t=>yr(t,e.birthYear)),a=[`生${t.path===`武道`?`而无灵根`:`具${t.talent.root}`}，${t.origin===`凡俗`?`无所凭恃`:t.originRevealed?`身负「${t.origin}」`:`来历不明`}。`,...i];a.length<6&&a.push(`终，${r.name}。`);let o=$t(t),s=xr(r.grade)+ +(o>=95);return{serial:vr(e.serialIndex),seed:e.seed,grade:r.grade,ending:r.name,daoName:t.name,finalRealm:mr(t),perfection:Math.round(o*10)/10,verdictShort:e.verdictShort,lifespan:Math.floor(t.ageMonths/12),inscription:a,marks:{僭越:Math.round(t.僭越),因果:Math.round(n.reduce((e,t)=>e+t.polarity*t.weight,0)),功德:Math.round(t.功德),业障:Math.round(t.业障),藏拙:Math.round(Te(t)*100)/100,堕度:Math.round(t.堕度)},goldFingers:e.goldFingers,rarity:s,createdAtYear:Math.floor(e.diedAtYear)}}function xr(e){switch(e){case`凡碑`:return 1;case`灵碑`:return 2;case`玄碑`:return 3;case`地碑`:return 4;case`天碑`:return 4;case`血道碑`:return 5;case`道碑`:return 5;case`无字碑`:return 5}}function Sr(e){let t=[];t.push(`┌`+`─`.repeat(60)+`┐`);let n=(e=``)=>{t.push(`│ `+e.padEnd(58)+` │`)};n(`${e.grade}  ${`★`.repeat(e.rarity)}`),n(`编号 ${e.serial}`),n(),n(`【${e.ending}】`),n(`${e.daoName} · ${e.finalRealm}`),n(`寿 ${e.lifespan} 载 · 完满度 ${e.perfection}`),n(`「${e.verdictShort}」`),n();for(let t of e.inscription)n(t);return n(),n(`僭越 ${e.marks.僭越} · 因果 ${e.marks.因果} · 功德 ${e.marks.功德}`),n(`业障 ${e.marks.业障} · 藏拙 ${e.marks.藏拙} · 堕度 ${e.marks.堕度}`),n(`金手指：${e.goldFingers.length?e.goldFingers.join(`、`):`无`}`),n(),n(`世界种子 ${e.seed}`),t.push(`└`+`─`.repeat(60)+`┘`),t.join(`
`)}function Cr(){return{version:1,entries:[],steleCount:0,daoFruit:0,unlockedSystems:[]}}function wr(e){switch(e.tier){case`飞升`:return`飞升`;case`主宰`:return e.id===`plane_sovereign`?`主宰`:null;case`夭折`:return e.id===`possessed_by_demon`?`魔头`:`尸骸`;case`偏安`:return e.id.startsWith(`local_`)?`传承`:null;case`隐藏`:return e.id===`seclusion`?`隐世`:`飞升`}}function Tr(e,t){e.steleCount++,e.daoFruit+=t.daoFruit;let n=wr(t.ending);if(!n)return null;let r={kind:n,id:t.stele.serial,daoName:t.actor.name,path:t.actor.path,tier:t.actor.tier,realm:t.stele.finalRealm,inscription:t.stele.inscription,signature:t.signature,place:t.place,relics:t.relics,unfinished:t.unfinished,seed:t.stele.seed,atYear:t.stele.createdAtYear,steleGrade:t.stele.grade};return e.entries.push(r),r}function Er(e,t){return e.entries.filter(e=>(e.kind===`飞升`||e.kind===`隐世`)&&e.tier<=t)}function Dr(e){return e.entries.filter(e=>e.kind===`魔头`||e.kind===`主宰`)}function Or(e){return e.entries.filter(e=>e.kind===`尸骸`&&e.relics.length>0)}function kr(e){return e.entries.filter(e=>e.kind===`传承`)}function Ar(e){switch(e.kind){case`飞升`:return`一缕残魂自称「${e.daoName}」，说他当年也是从这座山走出去的。\n  「${e.signature}」`;case`主宰`:return`${e.place}的主宰之位上坐着「${e.daoName}」，${e.realm}。已在位 ${e.atYear} 年。`;case`魔头`:return`魔头「${e.daoName}」盘踞${e.place}，用的是一套你莫名眼熟的功法。\n  「${e.signature}」`;case`传承`:return`${e.place}有一处旧洞府，主人姓名已不可考，只留下几个字：「${e.signature}」`;case`尸骸`:return`${e.place}的乱石堆里有一具枯骨，手上戴着一枚储物戒。\n  戒中有：${e.relics.join(`、`)}`;case`隐世`:return`据说${e.place}深处住着一位散功的老者，从不见客。`}}var jr=[{m:`打坐吐纳`,label:`稳修`,hint:`不快不慢，不出错`},{m:`悟道`,label:`悟道`,hint:`慢，但根基更纯，圆满度更高`},{m:`历练突破`,label:`历练`,hint:`快，有伤病之险`},{m:`丹药速成`,label:`服丹`,hint:`最快，但积丹毒（丹毒过深会锁死上限）`}],Mr=`打坐吐纳`,Nr=jr.map(e=>e.label);function Pr(e){return jr.find(t=>t.label===e)?.m}function Fr(e){let t=e??`打坐吐纳`;return jr.find(e=>e.m===t)?.label??t}function Ir(e,t){return e.talent.悟性>=60||t.has(`有所悟`)}function Lr(e){return nt(e).filter(e=>e.def.category===`丹药`&&e.def.consumable&&(e.def.use?.length??0)>0&&!e.stack.equipped).sort((e,t)=>e.def.value-t.def.value||(e.def.id<t.def.id?-1:1))[0]?.def.id??null}var Rr=[`&&`,`||`,`>=`,`<=`,`==`,`!=`,`>`,`<`,`!`,`+`,`-`,`*`,`/`],zr=class extends Error{};function Br(e){let t=[],n=0;for(;n<e.length;){let r=e[n];if(/\s/.test(r)){n++;continue}if(r===`(`){t.push({kind:`lparen`,value:r,pos:n++});continue}if(r===`)`){t.push({kind:`rparen`,value:r,pos:n++});continue}if(r===`,`){t.push({kind:`comma`,value:r,pos:n++});continue}if(r===`'`||r===`"`){let i=r,a=n+1,o=``;for(;a<e.length&&e[a]!==i;)o+=e[a++];if(a>=e.length)throw new zr(`字符串未闭合 @${n}: ${e}`);t.push({kind:`str`,value:o,pos:n}),n=a+1;continue}if(/[0-9]/.test(r)){let r=``;for(;n<e.length&&/[0-9.]/.test(e[n]);)r+=e[n++];t.push({kind:`num`,value:r,pos:n});continue}let i=Rr.find(t=>e.startsWith(t,n));if(i){t.push({kind:`op`,value:i,pos:n}),n+=i.length;continue}if(/[\p{L}_]/u.test(r)){let r=``;for(;n<e.length&&/[\p{L}\p{N}_.]/u.test(e[n]);)r+=e[n++];t.push({kind:`ident`,value:r,pos:n});continue}throw new zr(`无法识别的字符 '${r}' @${n}: ${e}`)}return t.push({kind:`eof`,value:``,pos:n}),t}var Vr=class{toks;i=0;constructor(e){this.toks=Br(e)}peek(){return this.toks[this.i]}next(){return this.toks[this.i++]}eat(e,t){let n=this.peek();if(n.kind!==e||t!==void 0&&n.value!==t)throw new zr(`期望 ${t??e}，实际 '${n.value}' @${n.pos}`);return this.next()}parse(){let e=this.or();return this.eat(`eof`),e}or(){let e=this.and();for(;this.peek().value===`||`;)this.next(),e={t:`bin`,op:`||`,a:e,b:this.and()};return e}and(){let e=this.cmp();for(;this.peek().value===`&&`;)this.next(),e={t:`bin`,op:`&&`,a:e,b:this.cmp()};return e}cmp(){let e=this.add();for(;[`>`,`>=`,`<`,`<=`,`==`,`!=`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.add()};return e}add(){let e=this.mul();for(;[`+`,`-`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.mul()};return e}mul(){let e=this.unary();for(;[`*`,`/`].includes(this.peek().value);)e={t:`bin`,op:this.next().value,a:e,b:this.unary()};return e}unary(){return[`!`,`-`].includes(this.peek().value)?{t:`un`,op:this.next().value,a:this.unary()}:this.primary()}primary(){let e=this.peek();if(e.kind===`lparen`){this.next();let e=this.or();return this.eat(`rparen`),e}if(e.kind===`num`)return this.next(),{t:`lit`,v:Number(e.value)};if(e.kind===`str`)return this.next(),{t:`lit`,v:e.value};if(e.kind===`ident`){if(this.next(),e.value===`true`)return{t:`lit`,v:!0};if(e.value===`false`)return{t:`lit`,v:!1};if(e.value===`null`)return{t:`lit`,v:null};if(this.peek().kind===`lparen`){this.next();let t=[];if(this.peek().kind!==`rparen`)for(t.push(this.or());this.peek().kind===`comma`;)this.next(),t.push(this.or());return this.eat(`rparen`),{t:`call`,name:e.value,args:t}}return{t:`path`,p:e.value}}throw new zr(`意外的记号 '${e.value}' @${e.pos}`)}};function Hr(e){return e!==null&&e!==!1&&e!==0&&e!==``}function U(e,t){switch(e.t){case`lit`:return e.v;case`path`:return t.get(e.p);case`call`:return t.call(e.name,e.args.map(e=>U(e,t)));case`un`:{let n=U(e.a,t);return e.op===`!`?!Hr(n):-(Number(n)||0)}case`bin`:{if(e.op===`&&`)return Hr(U(e.a,t))?Hr(U(e.b,t)):!1;if(e.op===`||`)return Hr(U(e.a,t))?!0:Hr(U(e.b,t));let n=U(e.a,t),r=U(e.b,t);switch(e.op){case`==`:return n===r;case`!=`:return n!==r;case`>`:return Number(n)>Number(r);case`>=`:return Number(n)>=Number(r);case`<`:return Number(n)<Number(r);case`<=`:return Number(n)<=Number(r);case`+`:return typeof n==`string`||typeof r==`string`?String(n)+String(r):Number(n)+Number(r);case`-`:return Number(n)-Number(r);case`*`:return Number(n)*Number(r);case`/`:return Number(r)===0?0:Number(n)/Number(r);default:throw new zr(`未知运算符 ${e.op}`)}}}}var Ur=new Map;function Wr(e){let t=Ur.get(e);if(t)return t;let n=new Vr(e).parse();return Ur.set(e,n),n}function Gr(e,t){return U(Wr(e),t)}function Kr(e,t){return!e||e==="default"||Hr(Gr(e,t))}var qr=new Map,Jr=0;function Yr(e){qr.clear();for(let t of e)qr.set(t.id,t);Jr++}function Xr(e){return qr.get(e)}function Zr(){return Jr}function Qr(e,t){let n=(e.sect?qr.get(e.sect):void 0)?.growth?.[t];return typeof n==`number`&&Number.isFinite(n)&&n>0?n:1}function $r(e){let t={id:e.id,affinity:e.affinity??{},taboos:e.taboos??[],signatures:e.signatures??[]};return e.methods&&(t.methods=[...e.methods]),e.methodsAdd&&(t.methodsAdd=[...e.methodsAdd]),t}Object.keys(S);var ei={中州官道:`中州`};for(let e of yt)ei[e.name]=e.region;[...new Set(Object.values(ei))];function ti(e){let t=ei[e.location];if(t)return t;let n=[...e.flags].find(e=>e.startsWith(`出身·`))?.slice(3);return yt.find(e=>e.id===n)?.region??``}var ni={tier:e=>e.actor.tier,sublevel:e=>e.actor.sublevel,path:e=>e.actor.path,goldenCoreGrade:e=>e.actor.goldenCoreGrade,hiddenRealmCount:e=>e.actor.hiddenRealms.length,道心:e=>e.actor.道心,气运:e=>e.actor.气运,功德:e=>e.actor.功德,业障:e=>e.actor.业障,僭越:e=>e.actor.僭越,堕度:e=>e.actor.堕度,丹毒:e=>e.actor.丹毒,名望:e=>e.actor.名望,锋芒:e=>e.actor.锋芒,藏拙:e=>Te(e.actor),"talent.root":e=>e.actor.talent.root,"talent.purity":e=>e.actor.talent.purity,"talent.悟性":e=>e.actor.talent.悟性,"talent.根骨":e=>e.actor.talent.根骨,"talent.神魂":e=>e.actor.talent.神魂,"factors.功法":e=>e.actor.factors.功法,"factors.法宝":e=>e.actor.factors.法宝,"factors.状态":e=>e.actor.factors.状态,"factors.灵宠":e=>e.actor.factors.灵宠,"factors.伙伴":e=>e.actor.factors.伙伴,"factors.道侣":e=>e.actor.factors.道侣,"factors.情报":e=>e.actor.factors.情报,"expose.金手指":e=>e.actor.secrets.金手指,"expose.残魂":e=>e.actor.secrets.残魂,"expose.真实修为":e=>e.actor.secrets.真实修为,"expose.身世":e=>e.actor.secrets.身世,"expose.杀过某人":e=>e.actor.secrets.杀过某人,origin:e=>e.actor.origin,originRevealed:e=>e.actor.originRevealed,originClues:e=>e.actor.originClues,year:e=>Math.floor(e.year),tick:e=>e.tick,age:e=>Math.floor(e.actor.ageMonths/12),lifespanLeft:e=>e.actor.lifespanYears-e.actor.ageMonths/12,location:e=>e.location,effectiveTier:e=>we(e.actor),daoPerfection:e=>$t(e.actor),knowerCount:e=>e.knowers.length,maxExpose:e=>Math.max(...Object.values(e.actor.secrets))},ri={hasSystem:(e,[t])=>e.systems.includes(String(t)),hasAnySystem:e=>e.systems.length>0,hasSoul:(e,[t])=>e.actor.souls.some(e=>e.id===t&&!e.dissipated),soulFavor:(e,[t])=>e.actor.souls.find(e=>e.id===t)?.favor??0,soulPossession:(e,[t])=>e.actor.souls.find(e=>e.id===t)?.possession??0,flag:(e,[t])=>e.flags.has(String(t)),karmaWith:(e,[t])=>e.karmaLedger.filter(e=>!e.resolved&&e.target===t).reduce((e,t)=>e+t.polarity*t.weight,0),unresolvedEvil:e=>e.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,seen:(e,[t])=>e.eventHistory.has(String(t)),seenCount:(e,[t])=>e.eventCounts.get(String(t))??0,realmAtLeast:(e,[t])=>e.actor.tier>=Number(t),stage:e=>Ut(e.actor.sublevel),stance:e=>Fr(e.stance),knows:(e,[t])=>e.knowers.some(e=>e.npc===t),sect:e=>e.actor.sect??``,sectName:e=>e.actor.sect?Xr(e.actor.sect)?.name??``:``,region:e=>ti(e),faction:e=>e.actor.birthFaction?.faction??``,factionRelation:e=>e.actor.birthFaction?.relation??`无关`,openWindows:e=>e.karmaLedger.reduce((e,t)=>e+(!t.resolved&&t.hooks.some(e=>e.lethal)?t.unusedWindows.length:0),0),heaviestKarma:e=>e.karmaLedger.reduce((e,t)=>t.resolved?e:Math.max(e,t.weight),0),has:(e,[t,n])=>rt(V(e.actor),String(t))>=(n===void 0?1:Number(n)),stones:e=>gt(V(e.actor)),bagFree:e=>tt(V(e.actor)),equipped:(e,[t])=>nt(V(e.actor)).some(e=>e.stack.defId===String(t)&&!!e.stack.equipped),chance:(e,[t])=>e.rng.next()<Number(t),min:(e,t)=>Math.min(...t.map(Number)),max:(e,t)=>Math.max(...t.map(Number))};function ii(e){return{get(t){let n=ni[t];if(!n)throw new zr(`未知的字段 '${t}'（不在 scope.ts 白名单内）`);return n(e)},call(t,n){let r=ri[t];if(!r)throw new zr(`未知的函数 '${t}()'（不在 scope.ts 白名单内）`);return r(e,n)}}}Object.keys(ni),Object.keys(ri);var ai=[`凡品`,`灵品`,`宝品`,`仙品`,`秘藏`,`极品`],oi={凡品:620,灵品:280,宝品:82,仙品:16,秘藏:2,极品:.1},W={minTier:3,minLuck:45,luckCoef:8};function si(e,t=0){let n=F((e-50)/50,-1,1)+t;return{凡品:oi.凡品*(1-n*.45),灵品:oi.灵品*(1+n*.1),宝品:oi.宝品*(1+n*.85),仙品:oi.仙品*(1+n*1.9),秘藏:oi.秘藏*(1+n*3.2),极品:Math.max(0,oi.极品*(1+n*W.luckCoef))}}var ci={threshold:10,softStep:.09};function li(){return{pity:{},count:{},seenSecret:!1,supremeTaken:!1}}function ui(e,t){let n=V(e),r=[];if(t.stones&&t.stones>0){let e=gt(n);e<t.stones&&r.push({kind:`stones`,label:`下品灵石`,need:t.stones,have:e,text:`尚缺 ${t.stones-e} 块下品灵石`})}for(let[e,i]of t.consume??[]){let t=Je(e),a=it(n,e);a<i&&r.push({kind:`item`,label:t.name,need:i,have:a,text:`尚缺${t.name} ${i-a} 份`})}for(let e of t.hold??[]){let t=e.qty??1,i=e.anyOf.reduce((e,t)=>e+rt(n,t),0);if(i<t){let n=e.anyOf.map(e=>Je(e).name).join(`、`);r.push({kind:`hold`,label:e.label,need:t,have:i,text:`没有${e.label}（${n} 任一即可）`})}}return r}function di(e,t){let n=ui(e,t);if(n.length)return n;let r=V(e);t.stones&&t.stones>0&&vt(r,t.stones);for(let[e,n]of t.consume??[])ot(r,e,n);return[]}function fi(e){let t=[];e.stones&&t.push(`${e.stones} 下品灵石`);for(let[n,r]of e.consume??[])t.push(`${Je(n).name}×${r}`);for(let n of e.hold??[])t.push(`须带${n.label}`);for(let n of e.effects??[])t.push(n);return t.join(` · `)||`无`}function pi(e,t,n){let r=[];return n.supremeTaken&&r.push(`此生已得过一件独一无二之物，天不予二`),e.tier<W.minTier&&r.push(`修为未至（须${W.minTier}阶以上）`),e.气运<W.minLuck&&r.push(`气运不足（须 ${W.minLuck} 以上）`),n.seenSecret||r.push(`尚未亲见过一件秘藏`),t.prizes.极品?.length||r.push(`${t.name}里没有这样的东西`),{ok:r.length===0,reasons:r}}function mi(e,t,n,r){let i=si(e.气运,r),a=pi(e,t,n).ok?ai:ai.filter(e=>e!==`极品`);return{list:a,weights:a.map(e=>e===`极品`?i.极品:Math.max(.01,i[e]))}}function hi(e,t,n,r){let i=r.pity[n.id]??0,a=(r.count[n.id]??0)+1;r.count[n.id]=a;let o=i*ci.softStep+(n.luckBonus??0),s=i>=ci.threshold,c;if(s){let n=si(t.气运,o);c=e.weighted([`宝品`,`仙品`,`秘藏`],[n.宝品,n.仙品,n.秘藏])}else{let{list:i,weights:a}=mi(t,n,r,o);c=e.weighted(i,a)}let l=n.prizes[c],u=ai.indexOf(c);for(;(!l||l.length===0)&&u>0;)u--,c=ai[u],l=n.prizes[c];if(!l||l.length===0)throw Error(`奖池「${n.id}」没有任何奖品`);let d=e.pick(l);return c===`秘藏`&&(r.seenSecret=!0),c===`极品`&&(r.supremeTaken=!0,r.seenSecret=!0),r.pity[n.id]=c===`凡品`||c===`灵品`?i+1:0,{prize:d,rarity:c,byPity:s,pityAfter:r.pity[n.id],count:a}}function gi(e,t,n){let{list:r,weights:i}=mi(e,t,n,(n.pity[t.id]??0)*ci.softStep+(t.luckBonus??0)),a=i.reduce((e,t)=>e+t,0),o={};for(let e of ai)o[e]=0;return r.forEach((e,t)=>{o[e]=(i[t]??0)/a}),o}function _i(e,t){return Math.max(0,ci.threshold-(t.pity[e.id]??0))}function G(e,t,n,r){return{id:e,rarity:`凡品`,name:t,desc:n,effects:r}}function vi(e){for(let t of Object.keys(e))for(let n of e[t])n.rarity=t;return e}var yi={stones:10,effects:[`僭越 +1.5`]},bi={consume:[[`za_ganliang`,2]],hold:[{label:`护身之物`,anyOf:[`bao_yufu`,`bao_xuangui`,`bao_bihuo`,`fu_tishen`,`bao_qinglian`]},{label:`摸金的行当`,anyOf:[`bao_xunlong`,`za_ditu`,`fu_yinni`]}],effects:[`业障 +3`,`factors.状态 -0.05`,`僭越 +2`]};function xi(e){return{stones:e.has(`丹炉`)?0:40,consume:[[`cai_lingcao`,3]],effects:[`丹毒 +1`,`sublevel -0.004`]}}var Si=[{id:`oracle`,name:`问天签`,costLabel:fi(yi),prizes:vi({凡品:[G(`o_kong`,`空签`,`签筒晃了半晌，落出一支无字的。卦师摊手：「天机不予。」`,[`道心 +1`]),G(`o_xiaocai`,`小财`,`「近日有小得。」三日后你在旧衣夹层里摸出四块灵石。`,[`give ls_xia 4`]),G(`o_pingan`,`平安签`,`「无事。」——这年头，无事就是好事。`,[`道心 +2`]),G(`o_zaqi`,`杂气`,`一缕说不清来路的灵气钻进经脉，不痛不痒。`,[`sublevel +0.008`])],灵品:[G(`o_zhiyin`,`指引`,`卦师在残图上圈了个方位：「往那边走，三日内。」图归你了。`,[`give za_ditu 1`]),G(`o_dingshen`,`定神`,`一句偈语落进心里，心浮气躁忽然平了。`,[`道心 +5`]),G(`o_qiyun`,`转运`,`「你近来该顺一顺了。」他把签折断，扔进火里。`,[`气运 +3`]),G(`o_canfang`,`残方`,`半张丹方，字迹被水泡过 —— 他顺手抓了几株对得上的草给你。`,[`give cai_lingcao 3`,`悟性 +1`])],宝品:[G(`o_jinjue`,`进境`,`一句话点破你卡了半年的关窍。`,[`sublevel +0.06`,`悟性 +2`]),G(`o_baoqi`,`宝器缘`,`「西市第三家当铺，去问死当的架子。」你去了，青锋剑就挂在那儿。`,[`give bao_qingfeng 1`]),G(`o_guiren`,`贵人`,`他给了你一个名字。那人后来帮了你一次大忙。`,[`factors.情报 +0.1`,`名望 +8`]),G(`o_bimo`,`护身`,`「去城南铁铺报我的名字。」那副玄龟甲他压了三年没卖出去。`,[`give bao_xuangui 1`])],仙品:[G(`o_tianji`,`窥天机`,`卦师脸色变了。他说的每一个字，往后十年都应验了。`,[`气运 +8`,`factors.情报 +0.15`,`僭越 +6`]),G(`o_gufa`,`古法`,`签上浮出一段古文，他照着抄了一本给你 —— 早已失传的行气法。`,[`give gf_qingmu 1`,`悟性 +2`]),G(`o_yuanshou`,`延寿`,`「你本该短命的。」他叹了口气，「现在不是了。」`,[`lifespan +12`])],秘藏:[G(`o_daoyun`,`道韵`,`那一瞬你听见了什么。醒来时，天光已亮，而你的道基变了。`,[`sublevel +0.15`,`道心 +10`,`悟性 +5`,`气运 +5`,`僭越 +12`])],极品:[G(`o_ji_wuzi`,`无字签`,`签筒底下压着一支从未有人抽出过的黑签。卦师看了很久，说：「这不是我给你的。」他咬破手指在签上写了个字，人就老了二十岁 —— 他把自己剩下的命数，换成了你的。`,[`气运 +14`,`道心 +8`,`悟性 +4`,`lifespan +120`,`业障 +30`,`僭越 +55`,`expose.身世 +10`,`flag 极品·无字签·欠卦师一条命`]),G(`o_ji_mengmei`,`蒙昧珠`,`「有人要我把这个交给你。」灰扑扑的一颗珠子，照不出人影。天机阁推演了三百年没找到它 —— 因为它生来就是让人推不出的。带着它，天看不见你；可你也从此看不清自己的命。`,[`give bao_mengmei 1`,`expose.真实修为 -25`,`expose.金手指 -20`,`expose.身世 -15`,`僭越 +35`,`气运 -6`,`flag 极品·蒙昧珠·天机阁索珠`])]})},{id:`relic`,name:`探古藏`,costLabel:fi(bi),luckBonus:.18,prizes:vi({凡品:[G(`r_kutu`,`枯土`,`挖开是一层灰。除了呛鼻子，什么也没有。`,[`factors.状态 -0.03`]),G(`r_suipian`,`碎片`,`一块认不出是什么的碎瓷，握在手里凉得反常。`,[`业障 +1`]),G(`r_jiugu`,`旧骨`,`一副蜷着的骸骨，手指还扣在石壁上。`,[`道心 -2`,`业障 +2`])],灵品:[G(`r_lingshi`,`灵石囊`,`一只烂了半边的储物袋，里面还剩十几块下品灵石。`,[`give ls_xia 15`]),G(`r_canjuan`,`残卷`,`半部吐纳诀，后面被人撕走了 —— 撕得很急。`,[`give gf_tuna 1`]),G(`r_yuping`,`玉瓶`,`瓶塞是蜡封的，里头两粒回气丹居然没化。`,[`give dan_huiqi 2`])],宝品:[G(`r_faqi`,`古法器`,`一柄制式古拙的飞剑，灵纹至今未断。`,[`give bao_lingwen 1`]),G(`r_zhenpan`,`阵盘`,`一只寻龙盘，针还活着，往灵气浓处偏。`,[`give bao_xunlong 1`]),G(`r_yiyan`,`遗言`,`石壁上刻着一段话。你看完，很久没说话。`,[`道心 +8`,`originClues +1`])],仙品:[G(`r_chuancheng`,`传承玉`,`玉里封着一段影像：一个人在演一门焚天的功法，从头到尾，一遍。`,[`give gf_liehuo 1`,`悟性 +3`,`expose.真实修为 +6`]),G(`r_bmqi`,`本命残器`,`前主人的本命青莲灯。它还认得主人的死法。`,[`give bao_qinglian 1`,`业障 +10`,`expose.真实修为 +8`])],秘藏:[G(`r_jinqi`,`禁器`,`赤霄宝剑。你不该拿的。但你拿了。`,[`give bao_chixiao 1`,`业障 +25`,`僭越 +20`,`expose.真实修为 +15`])],极品:[G(`r_ji_taia`,`太阿·断`,`棺里没有尸首，只有半柄剑，断口齐得像被一口咬下去。你握住的一刻，听见很远的地方有人叫了一声名字 —— 不是你的名字，是它上一任主人的。它斩过的最后一个人，就是那个人。`,[`give bao_taia 1`,`factors.功法 +0.05`,`lifespan -60`,`业障 +45`,`僭越 +40`,`expose.真实修为 +30`,`名望 +25`,`flag 极品·太阿·前主人的仇家仍在`]),G(`r_ji_jiezi`,`芥子壶`,`壶口三寸，探进神识却是一片天。壶里有座荒了三十年的园子，园子中央坐着一个人形的东西，背对着你 —— 前主人「养」的。它听见你进来了。`,[`give za_jiezihu 1`,`业障 +25`,`僭越 +25`,`道心 -6`,`flag 极品·芥子壶·园中人未死透`])]})},{id:`alchemy`,name:`开炉`,costLabel:fi(xi(new Set)),prizes:vi({凡品:[G(`a_zhalu`,`炸炉`,`砰的一声。你从灰里爬出来，眉毛少了半边。`,[`factors.状态 -0.08`,`道心 -1`]),G(`a_feidan`,`废丹`,`成了，但是黑的。闻着像糊掉的药渣 —— 敢不敢吃是你的事。`,[`give dan_jia 1`]),G(`a_cidan`,`次丹`,`勉强能吃。药性冲，但确实是丹。`,[`give dan_huiqi 1`])],灵品:[G(`a_juqi`,`聚气散`,`成色一般，好在够用。`,[`give dan_juqi 1`]),G(`a_liaoshang`,`疗伤丹`,`一炉出了两粒，收口比预想的干净。`,[`give dan_liaoshang 2`]),G(`a_ningshen`,`凝神丹`,`开盖时满室清苦气。用来画符或者认人正好。`,[`give dan_ningshen 1`])],宝品:[G(`a_zhuji`,`筑基丹`,`丹成三转，纹路清晰。这一炉值了。`,[`give dan_zhuji 1`]),G(`a_xisui`,`洗髓丹`,`丹色青白。传闻服下三日排黑汗，根骨是真换。`,[`give dan_xisui 1`]),G(`a_qingdu`,`解毒丹`,`两粒解毒丹 —— 专拔积在经脉里的药渣。`,[`give dan_jiedu 2`])],仙品:[G(`a_jinyuan`,`金元丹`,`丹成有纹。开炉那一刻，天上像有什么东西低头看了你一眼。`,[`give dan_jinyuan 1`,`僭越 +3`]),G(`a_jiuzhuan`,`九转还魂`,`丹上有九道纹。老一辈说，这种丹能从阎王手里抢人。`,[`give dan_jiuzhuan 1`])],秘藏:[G(`a_zaohua`,`造化一炉`,`开炉那日天有异象。丹成之时，满室药香三日不散 —— 而且是一炉双成。`,[`give dan_jiuzhuan 1`,`give dan_xisui 2`,`悟性 +3`,`气运 +5`,`僭越 +10`])],极品:[G(`a_ji_zijin`,`九转紫金丹`,`丹上九道纹，纹里有紫气自己在走。药王谷的老人说这一炉三千年只成过两粒，另一粒是给天子送葬用的。药香飘了三日，方圆百里但凡有鼻子的都闻见了。`,[`give dan_zijin 1`,`僭越 +30`,`业障 +10`,`expose.真实修为 +25`,`名望 +30`,`flag 极品·紫金丹·药香引客`]),G(`a_ji_danying`,`炉中婴`,`丹没成，成了别的。开盖时它坐在炉底，像睡着了，睁眼先看的是你。它认你 —— 而认主这件事，从来是双向的。`,[`give bao_danying 1`,`神魂 +4`,`lifespan -40`,`道心 -8`,`业障 +20`,`僭越 +25`,`flag 极品·炉中婴·立春索血`])]})}],Ci={oracle:{cond:e=>e>=1,cost:()=>yi,hint:`坊市街口的卦摊，一卦十块下品灵石。问得多了，天也会烦。`},relic:{cond:e=>e>=2,cost:()=>bi,hint:`荒山野岭的旧坟古洞。带够口粮、护身与摸金的行当再进去 —— 前人的东西好拿，前人的账也跟着来。`},alchemy:{cond:e=>e>=2,cost:e=>xi(e),hint:`自己开炉。药材真烧、炉子真要有 —— 没有自家炉子，就得掏钱借人家的丹房。`}},K=class extends Error{},wi={道心:{get:e=>e.actor.道心,set:(e,t)=>{e.actor.道心=F(t,0,100)}},气运:{get:e=>e.actor.气运,set:(e,t)=>{e.actor.气运=F(t,0,100)}},功德:{get:e=>e.actor.功德,set:(e,t)=>{e.actor.功德=Math.max(0,t)}},业障:{get:e=>e.actor.业障,set:(e,t)=>{e.actor.业障=Math.max(0,t)}},僭越:{get:e=>e.actor.僭越,set:(e,t)=>{e.actor.僭越=Math.max(0,t)}},堕度:{get:e=>e.actor.堕度,set:(e,t)=>{e.actor.堕度=F(t,0,100)}},丹毒:{get:e=>e.actor.丹毒,set:(e,t)=>{e.actor.丹毒=F(t,0,100)}},名望:{get:e=>e.actor.名望,set:(e,t)=>{e.actor.名望=F(t,-100,1e3)}},锋芒:{get:e=>e.actor.锋芒,set:(e,t)=>{e.actor.锋芒=Math.max(0,t)}},sublevel:{get:e=>e.actor.sublevel,set:(e,t)=>{e.actor.sublevel=F(t,0,1)}},lifespan:{get:e=>e.actor.lifespanYears,set:(e,t)=>{e.actor.lifespanYears=Math.max(0,t)}},age:{get:e=>e.actor.ageMonths/12,set:(e,t)=>{e.actor.ageMonths=Math.max(0,t*12)}},originClues:{get:e=>e.actor.originClues,set:(e,t)=>{e.actor.originClues=Math.max(0,Math.floor(t))}},悟性:{get:e=>e.actor.talent.悟性,set:(e,t)=>{e.actor.talent.悟性=F(t,1,100)}},根骨:{get:e=>e.actor.talent.根骨,set:(e,t)=>{e.actor.talent.根骨=F(t,1,100)}},神魂:{get:e=>e.actor.talent.神魂,set:(e,t)=>{e.actor.talent.神魂=F(t,1,100)}},纯度:{get:e=>e.actor.talent.purity,set:(e,t)=>{e.actor.talent.purity=F(t,5,100)}}};for(let e of Object.keys(S))wi[`factors.${e}`]={get:t=>t.actor.factors[e],set:(t,n)=>{t.actor.factors[e]=F(n,S[e].min,S[e].max)}};for(let e of[`金手指`,`残魂`,`真实血脉`,`真实修为`,`杀过某人`,`身世`])wi[`expose.${e}`]={get:t=>t.actor.secrets[e],set:(t,n)=>{t.actor.secrets[e]=F(n,0,100)}};function q(e,t){let n=e.itemNotices??=[];n.push(t),n.length>64&&n.splice(0,n.length-64)}function Ti(e,t){if(e===void 0)return 1;let n=Number(e);if(!Number.isFinite(n)||!Number.isInteger(n)||n<=0)throw new K(`数量必须是正整数 '${e}'：${t}`);return n}function Ei(e,t){let n,r;for(let i of e.slice(2)){let e=ze(i);if(e!==void 0){if(r!==void 0)throw new K(`成色只能写一个：${t}`);r=e;continue}if(!/^[+-]?\d+$/.test(i))throw new K(`give 的参数 '${i}' 既不是数量也不是成色（成色须为 ${je.join(`/`)}）：${t}`);if(n!==void 0)throw new K(`数量只能写一个：${t}`);n=Ti(i,t)}return{qty:n??1,quality:r}}function Di(e,t,n,r){J(n[1],r);let i=Je(n[1]),a=V(e.actor);switch(t){case`give`:{let{qty:t,quality:o}=Ei(n,r);if(o!==void 0&&L(i))throw new K(`'${i.name}' 不参与成色（灵石与独一件恒为本名）：${r}`);let s=at(a,i.id,t,{quality:o,rng:e.rng});if(s.added>0&&q(e,`得${Ve(i,s.quality)}×${s.added}`),s.overflow>0){e.flags.add(`背包已满`);let t=st(a),n=t?`（最不值钱的是${t.def.name}，丢掉可腾一格）`:``;q(e,`${Ve(i,s.quality)}×${s.overflow} 没处放，只能留在原地 —— ${a.container}统共 ${$e(a)} 格，已经装满${n}`)}else e.flags.delete(`背包已满`);return}case`take`:{let t=Ti(n[2],r);if(i.stone){let n=t*P[i.stone];vt(a,n)?q(e,`付了${n} 下品灵石`):q(e,`掏不出 ${n} 下品灵石（囊中只有 ${gt(a)}）`);return}let o=ot(a,i.id,t);o>0&&q(e,`失${i.name}×${o}`),o<t&&q(e,`${i.name}不够拿（要 ${t}，只有 ${o}；装备在身上的不算）`);return}case`useItem`:{let t=lt(e.actor,i.id);if(!t.ok){q(e,t.reason??`用不了${i.name}`);return}q(e,t.note??`用了${Ve(i,t.quality)}`);for(let n of t.effects)Oi(e,n);return}case`equip`:{let t=ft(e.actor,i.id);if(!t.ok){q(e,t.reason??`佩不上${i.name}`);return}let n=t.replaced?`，换下${B(t.replaced)?.name??t.replaced}`:``;q(e,`佩上${Ve(i,t.quality)}（${t.slot}位${n}）`),t.overTier&&(Un(e),q(e,`${i.name}远超你此刻的境界 —— 拿出来用，等于自报家门`));return}case`unequip`:{let t=mt(e.actor,i.id);q(e,t.ok?`卸下${i.name}`:t.reason??`${i.name}不在身上`);return}}}function Oi(e,t){let n=t.trim();if(!n)return;let r=n.split(/\s+/),i=r[0];switch(i){case`flag`:J(r[1],n),e.flags.add(r[1]);return;case`unflag`:J(r[1],n),e.flags.delete(r[1]);return;case`move`:J(r[1],n),e.location=r[1];return;case`set.path`:{J(r[1],n);let t=r[1];if(!d.includes(t))throw new K(`未知的道途 '${t}'（须为八道途之一）：${n}`);e.actor.path=t;return}case`set.stance`:{J(r[1],n);let t=Pr(r[1]);if(t===void 0)throw new K(`未知的修行之姿 '${r[1]}'（须为 ${Nr.join(`/`)}）：${n}`);e.stance=t;return}case`bind.system`:{J(r[1],n);let t=r[1];e.systems.includes(t)||e.systems.push(t);return}case`bind.soul`:{J(r[1],n);let t=r[1];e.actor.souls.some(e=>e.id===t)||e.actor.souls.push({id:t,name:t,tier:Math.min(Number(r[2]??9),de.maxTier),favor:0,possession:0,dissipated:!1});return}case`devourSoul`:{J(r[1],n);let t=Mn(e,r[1]);e.flags.add(t.ok?`吞魂成功_${r[1]}`:`吞魂失败_${r[1]}`);return}case`reincarnateSoul`:J(r[1],n),Nn(e,r[1]).ok&&e.flags.add(`送归转世_${r[1]}`);return;case`mergeSoul`:J(r[1],n),Pn(e,r[1]).ok&&e.flags.add(`融合共生_${r[1]}`);return;case`witness`:{J(r[1],n),J(r[2],n);let t=r[2];if(!Vn.includes(t))throw new K(`未知的秘密类型 '${r[2]}'：${n}`);Hn(e,t,8,r[1]);return}case`silence`:J(r[1],n),Kn(e,r[1]);return;case`eraseMemory`:J(r[1],n),qn(e,r[1]);return;case`fakeDeath`:Jn(e);return;case`stepDown`:e.flags.add(`止步`);return;case`join.sect`:J(r[1],n),ki(e,r[1]);return;case`leave.sect`:Ai(e,`离派`);return;case`expel.sect`:Ai(e,`逐出`);return;case`settle`:{J(r[1],n);let t=r[1];if(!Ni.includes(t))throw new K(`未知的了结方式 '${t}'：${n}`);let i=fn(e,t);i&&e.flags.add(`已结·${i.type}`);return}case`give`:case`take`:case`useItem`:case`equip`:case`unequip`:Di(e,i,r,n);return;case`draw`:{J(r[1],n);let t=Si.find(e=>e.id===r[1]);if(!t)throw new K(`未知的奖池 '${r[1]}'：${n}`);let i=e.gacha??={pity:{},count:{}},a=hi(e.rng,e.actor,t,i);for(let t of a.prize.effects)Oi(e,t);e.flags.add(`机缘·${a.rarity}`),e.lastPrize=`${a.rarity}·${a.prize.name} —— ${a.prize.desc}`;return}}if(i.startsWith(`soul.`)){let t=i.split(`.`);if(t.length!==3)throw new K(`残魂效果格式应为 soul.<id>.<favor|possession>：${n}`);let[,a,o]=t,s=e.actor.souls.find(e=>e.id===a);if(!s)return;let c=Mi(r[1],n);if(o===`favor`)s.favor=F(s.favor+c,-100,100);else if(o===`possession`)s.possession=F(s.possession+c,0,100);else throw new K(`残魂无此字段 '${o}'：${n}`);return}let a=wi[i];if(!a)throw new K(`未知的效果目标 '${i}'（不在 effects.ts 白名单内）：${n}`);let o=r[1];if(o===void 0)throw new K(`缺少数值：${n}`);if(o.startsWith(`=`))a.set(e,Number(o.slice(1)));else{let t=Mi(o,n);if(t>0&&i.startsWith(`factors.`)){let n=Qr(e.actor,i.slice(8));n!==1&&(t=Math.round(t*n*1e6)/1e6)}a.set(e,a.get(e)+t)}}function ki(e,t){let n=Xr(t);if(!n)throw new K(`未知的门派 id '${t}'（不在 content/sects 白名单内）：join.sect ${t}`);if(e.actor.sect===t||(e.actor.sect&&Ai(e,`离派`),e.actor.sect=t,e.flags.add(`门派·${t}`),e.flags.add(`宗门弟子`),e.flags.delete(`宗门·已除名`),e.flags.delete(`宗门·已离山`),e.flags.delete(`叛出宗门`),e.flags.has(`入派·${t}`)))return;e.flags.add(`入派·${t}`);let r=n.endowment;if(r){for(let t of r.items??[])Oi(e,`give ${t}`);typeof r.stones==`number`&&r.stones>0&&Oi(e,`give ls_xia ${Math.floor(r.stones)}`);for(let[t,n]of Object.entries(r.factors??{})){let r=wi[`factors.${t}`];r&&typeof n==`number`&&Number.isFinite(n)&&r.set(e,r.get(e)+n)}}}function Ai(e,t){let n=e.actor.sect;n&&(delete e.actor.sect,e.flags.delete(`门派·${n}`),e.flags.add(`${t}·${n}`),t===`离派`?e.flags.add(`宗门·已离山`):(e.flags.delete(`宗门弟子`),e.flags.add(`宗门·已除名`)))}function ji(e,t){for(let n of t??[])Oi(e,n)}function J(e,t){if(!e)throw new K(`缺少参数：${t}`)}function Mi(e,t){if(e===void 0)throw new K(`缺少数值：${t}`);let n=Number(e);if(Number.isNaN(n))throw new K(`数值无法解析 '${e}'：${t}`);return n}var Ni=[`了结`,`补偿`,`化解`,`剪断`,`转嫁`],Pi=[`flag`,`unflag`,`move`,`bind.system`,`bind.soul`,`devourSoul`,`reincarnateSoul`,`mergeSoul`,`silence`,`eraseMemory`,`draw`,`settle`,`join.sect`,`set.path`,`set.stance`],Fi=[`fakeDeath`,`stepDown`,`leave.sect`,`expel.sect`],Ii=[`give`,`take`,`useItem`,`equip`,`unequip`];[...Object.keys(wi),...Pi,...Fi,...Ii];var Li=[`宗门`,`市井`,`荒野`,`秘境`],Y={same:2.5,other:.4,dwellMin:4,dwellMax:8,thinPool:6,legacyDwell:6},Ri={tianshu:`市井`,yaowang:`市井`,huoshan:`市井`,wangxiang:`市井`,fudao:`市井`,jianzhong:`荒野`,bingyuan:`荒野`,nanjiang:`荒野`,baigu:`荒野`,juelin:`荒野`},zi={外门:`宗门`,中州官道:`荒野`};for(let e of yt)zi[e.name]=Ri[e.id]??`市井`;function Bi(e){return zi[e]??null}function Vi(e){return e.has(`宗门弟子`)?`弟子`:`散修`}var Hi={弟子:{宗门:3,市井:1,荒野:1,秘境:.3},散修:{宗门:.3,市井:2.5,荒野:2,秘境:.5}};function Ui(e,t){return e.has(`宗门弟子`)?`宗门`:Bi(t)??Ri[[...e].find(e=>e.startsWith(`出身·`))?.slice(3)??``]??`市井`}function Wi(e,t,n){return{setting:t,dwellLeft:e.int(Y.dwellMin,Y.dwellMax),loc:n}}function Gi(e,t){return{setting:Ui(e,t),dwellLeft:Y.legacyDwell,loc:t}}function Ki(e,t,n){t.shift={from:t.setting,to:n},t.setting=n,t.dwellLeft=e.rng.int(Y.dwellMin,Y.dwellMax)}function qi(e){let t=e.scene;if(t){if(t.loc!==e.location){t.loc=e.location;let n=Bi(e.location);if(n&&n!==t.setting){Ki(e,t,n);return}}if(t.dwellLeft<=0){let n=Hi[Vi(e.flags)],r=Li.filter(e=>e!==t.setting);Ki(e,t,e.rng.weighted(r,r.map(e=>n[e])))}}}function Ji(e,t){if(!e)return!1;let n=0;for(let r of t)r.setting===e.setting&&n++;return n<Y.thinPool}function Yi(e,t,n){return!e||n||!t.setting?1:t.setting===e.setting?Y.same:Y.other}var Xi=class extends Error{},Zi={termMin:.05,termMax:8,min:.1,max:6};function Qi(e,t){let n=1;for(let r of t.tags??[]){let t=e.affinity[r];if(t!==void 0){if(t===0)return 0;n*=t}}return Math.min(Zi.max,Math.max(Zi.min,n))}var $i=/^(karma|effect|text):(.+)$/;function ea(e){let t=e.trim().split(/\s+/).filter(Boolean);if(t.length===0)throw new Xi(`forbids 不能为空`);return t.map(e=>{let t=$i.exec(e);if(!t)throw new Xi(`forbids 词项 '${e}' 不合法（须为 karma:/effect:/text: 开头）`);let n=t[1],r=t[2],i;n===`effect`&&(r.endsWith(`+`)||r.endsWith(`-`))&&(i=r.slice(-1),r=r.slice(0,-1));let a=r.split(`,`).map(e=>e.trim()).filter(Boolean);if(a.length===0)throw new Xi(`forbids 词项 '${e}' 没有内容`);if(n===`effect`&&a.length!==1)throw new Xi(`effect: 词项只接受一个目标（'${e}'）—— 多个目标写成多个词项`);return i?{kind:n,values:a,sign:i}:{kind:n,values:a}})}function ta(e){return[e.then,e.onCritSuccess,e.onSuccess,e.onFail,e.onCritFail]}function na(e){let t=[],n=e=>{e&&e!==`none`&&t.push(e.type)};n(e.karma);for(let t of ta(e))n(t?.karma);return t}function ra(e){let t=[...e.effects??[]];for(let n of ta(e))t.push(...n?.effects??[]);return t}function ia(e,t){switch(e.kind){case`karma`:{let n=na(t);return e.values.some(e=>n.includes(e))}case`text`:return e.values.some(e=>t.text.includes(e));case`effect`:{let n=e.values[0];return ra(t).some(t=>{let r=t.trim().split(/\s+/);if(r[0]!==n)return!1;if(!e.sign)return!0;let i=r[1]??``;return e.sign===`+`?i.startsWith(`+`):i.startsWith(`-`)})}}}var aa=new Map;function oa(e,t){if(t.injectedBy)return null;for(let n of e.taboos){let e=aa.get(n.forbids);if(e||(e=ea(n.forbids),aa.set(n.forbids,e)),e.some(e=>ia(e,t)))return n}return null}function sa(e,t){let n=t.tags??[];return!(!e.onTags?.some(e=>n.includes(e))||e.notTags?.some(e=>n.includes(e)))}var ca=Object.keys(b);function la(e,...t){let n={id:e.id,affinity:{...e.affinity},taboos:[...e.taboos],signatures:[...e.signatures]};e.methods&&(n.methods=[...e.methods]);for(let e of t){n.id=`${n.id}·${e.id}`;for(let[t,r]of Object.entries(e.affinity)){let e=n.affinity[t];n.affinity[t]=r===0||e===0?0:(e??1)*r}if(n.taboos.push(...e.taboos),n.signatures.push(...e.signatures),e.methods){let t=new Set(e.methods);n.methods=(n.methods??ca).filter(e=>t.has(e))}if(e.methodsAdd?.length){let t=new Set([...n.methods??ca,...e.methodsAdd]);n.methods=ca.filter(e=>t.has(e))}}return n}var ua=new Map;function da(e){let t=fa[e.actor.path],n=e.actor.sect;if(!n)return t;let r=Xr(n);if(!r)return t;let i=`${e.actor.path}|${n}`,a=Zr(),o=ua.get(i);if(o&&o.v===a)return o.mod;let s=la(t,$r(r));return ua.set(i,{v:a,mod:s}),s}var fa={正道:{id:`正道`,affinity:{宗门:1.6,同门:1.6,师承:1.5,任务:1.4,道德:1.25,人情:1.2,怪谈:.7,乱葬岗:.5,黑市:.4},taboos:[{rule:`不堕邪途`,forbids:`effect:堕度+ effect:devourSoul`,breakable:!0,penalty:[`道心 -6`,`名望 -10`]}],signatures:[{text:`亮出师门名帖`,onTags:[`冲突`,`对峙`,`敲诈`],require:`名望 >= 10`,karma:`none`,then:{text:`你不急不缓报上山门与师承。对面把你上下打量一遍，火气先矮了三分——名帖未必压得住事，但压得住场面。`,effects:[`名望 +2`]}},{text:`按门规办事`,onTags:[`道德`,`抉择`,`人际`],require:`道心 >= 40`,karma:`none`,then:{text:`规矩是死的，可正因为死，才没人能拿它做人情。你把门规一条条摆出来，事情反而简单了。`,effects:[`道心 +2`,`名望 +1`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`苦修锻体`,`借残魂指点`]},魔道:{id:`魔道`,affinity:{冲突:1.7,战争:1.6,对峙:1.5,危机:1.35,黑市:2,掠夺:1.8,暴露:1.2,道德:.6,宗门:.7,人情:.75},taboos:[],signatures:[{text:`一不做二不休，杀了夺了`,onTags:[`冲突`,`对峙`,`交易`],karma:{type:`杀戮`,target:`拦路之人`,weight:5,hooks:[{id:`sig_mo_shaduo`}]},check:{actor:`effectiveTier * 12 + 锋芒 * 2`,dc:`tier * 12 + 10`,scale:12},onSuccess:{text:`手起，事了。你把还温着的储物袋掂了掂，转身走进夜里——魔道的账，从来是这么算的。`,effects:[`业障 +8`,`堕度 +5`,`锋芒 +2`]},onFail:{text:`对方比看上去硬得多。你挨了一记，退进暗处，杀意露了个干净——这笔账记下了，两边都记下了。`,effects:[`factors.状态 -0.2`,`expose.真实修为 +6`]}},{text:`放出一缕煞气`,onTags:[`人际`,`市井`,`敲诈`,`对峙`],karma:`none`,then:{text:`你什么都没说，只把压着的那缕煞气松开半分。屋里霎时静了，有人后颈的汗毛立了起来。`,effects:[`锋芒 +1`,`expose.真实修为 +3`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`吞噬夺取`,`献祭`,`借残魂指点`]},鬼道:{id:`鬼道`,affinity:{怪谈:1.9,身后事:1.8,乱葬岗:2,残魂:1.5,因果:1.3,秘境:1.2,市井:.7,生计:.8,江湖:.85},taboos:[],signatures:[{text:`问问死人`,onTags:[`怪谈`,`身后事`,`因果`,`危机`],require:`talent.神魂 >= 30`,karma:`none`,then:{text:`你朝无人处偏了偏头，用只有亡者听得见的调子问了一句。回话的声音很轻，可死人不说谎。`,effects:[`factors.情报 +0.04`,`僭越 +1`]}},{text:`散一点阴气开路`,onTags:[`秘境`,`探索`,`危机`],karma:`none`,then:{text:`阴气贴着地皮漫出去，活物退避，机关噤声。你踩着那条被让出来的路往里走，只是身上又凉了几分。`,effects:[`factors.情报 +0.02`,`factors.状态 -0.03`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`吞噬夺取`,`献祭`,`借残魂指点`]},妖修:{id:`妖修`,affinity:{秘境:1.8,游历:1.7,奇遇:1.5,怪谈:1.35,机缘:1.2,宗门:.5,市井:.7,经营:.6,权柄:.6},taboos:[],signatures:[{text:`露半分真形`,onTags:[`冲突`,`对峙`,`危机`],karma:`none`,then:{text:`你由着那点压不住的东西从眼底透出来——瞳孔竖了一线，指节的轮廓变了变。对面看清了，也就懂了。`,effects:[`锋芒 +2`,`expose.真实血脉 +6`]}},{text:`托山野同类打听`,onTags:[`情报`,`江湖`,`游历`,`秘境`],karma:`none`,then:{text:`入夜你吹了个极轻的唿哨。天亮前，檐上的雀、墙根的鼠把各自见过的事凑成了一整件。`,effects:[`factors.情报 +0.05`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`双修`,`吞噬夺取`,`苦修锻体`,`借残魂指点`]},佛道:{id:`佛道`,affinity:{道德:1.7,因果:1.7,心魔:1.6,凡人:1.6,人间:1.5,道心:1.4,身后事:1.3,对峙:.7,冲突:.55,战争:.45,掠夺:.4,黑市:0},taboos:[{rule:`不杀生`,forbids:`karma:杀戮,灭门`,breakable:!0,penalty:[`道心 -10`,`业障 +15`]},{rule:`不妄语`,forbids:`karma:欺骗`,breakable:!0,penalty:[`道心 -5`,`业障 +6`]},{rule:`不噬魂`,forbids:`effect:devourSoul`,penalty:[`道心 -20`,`业障 +30`]}],signatures:[{text:`合十，诵一段往生咒`,onTags:[`身后事`,`怪谈`,`道德`],karma:`none`,then:{text:`你合十垂目，一字一句把咒诵完。风还是那阵风，可有什么东西松开了——地上的、以及你心里的。`,effects:[`功德 +2`,`道心 +2`]}},{text:`问他一句因果`,onTags:[`因果`,`抉择`,`人际`],require:`道心 >= 30`,karma:`none`,then:{text:`「这件事再往前数，因在何处？」你问得很轻。对方愣住，顺着这句话往回想，脸色一点点变了。`,effects:[`factors.情报 +0.03`,`功德 +1`]}}],methods:[`打坐吐纳`,`洞天闭关`,`悟道`,`历练突破`,`香火愿力`,`苦修锻体`]},儒道:{id:`儒道`,affinity:{权柄:1.8,名声:1.7,人际:1.5,势力:1.4,经营:1.35,人间:1.3,任务:1.2,怪谈:.7,秘境:.8,乱葬岗:.5},taboos:[{rule:`一诺千金`,forbids:`karma:毁诺`,breakable:!0,penalty:[`名望 -15`,`道心 -8`]}],signatures:[{text:`讲道理（言出法随）`,onTags:[`冲突`,`对峙`,`人际`,`权柄`],require:`名望 >= 15`,karma:`none`,check:{actor:`名望 * 0.6 + talent.悟性 * 0.6`,dc:`55`,scale:10},onSuccess:{text:`你一条一条讲下去，声气不高，字字却像钉进案上。说到末一句，满场没人接得上话——理在你这边，天地都听见了。`,effects:[`名望 +4`,`flag 言出法随`]},onFail:{text:`道理是好道理，只是对面不吃这一套。你话音未落就被人嗤笑着打断，脸上多少挂不住。`,effects:[`名望 -3`]}},{text:`秉笔直书`,onTags:[`因果`,`名声`,`权柄`,`道德`],karma:`none`,then:{text:`你研墨提笔，把这件事的来龙去脉一字不易地记下来。写的人多了会走样，但你这一笔，往后是查得到的。`,effects:[`名望 +2`,`factors.情报 +0.03`]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`香火愿力`,`借残魂指点`]},武道:{id:`武道`,affinity:{武道:2.2,江湖:1.9,冲突:1.5,对峙:1.5,市井:1.25,生计:1.25,人情:1.2,丹道:.6,残魂:.7,心魔:.8},taboos:[],signatures:[{text:`以拳会友`,onTags:[`江湖`,`武道`,`冲突`,`市井`],karma:`none`,check:{actor:`talent.根骨 + 锋芒 * 4`,dc:`55`,scale:10},onSuccess:{text:`三招过后你收拳而立，对方甩了甩发麻的手腕，反倒笑了：「好拳。走，喝酒去。」武人的交情，就是这么打出来的。`,effects:[`名望 +3`,`factors.伙伴 +0.03`]},onFail:{text:`你接了他一记，虎口发麻，退了半步。输是输了，抱拳认下便是——江湖上输过的拳，比赢过的更记得住人。`,effects:[`factors.状态 -0.1`]}},{text:`递上一坛酒`,onTags:[`江湖`,`人际`,`人情`],karma:`none`,then:{text:`你把酒坛往桌上一放，拍开泥封。有些话喝到一半自然就说了，有些交情喝完这坛就算数了。`,effects:[`factors.伙伴 +0.04`]}}],methods:[`打坐吐纳`,`洞天闭关`,`悟道`,`历练突破`,`双修`,`苦修锻体`,`借残魂指点`]},散修:{id:`散修`,affinity:{坊市:1.8,交易:1.6,买卖:1.6,市井:1.5,奇遇:1.5,生计:1.4,机缘:1.35,游历:1.3,宗门:.35,同门:.4,师承:.4},taboos:[],signatures:[{text:`装成路过的野修`,onTags:[`危机`,`对峙`,`暴露`],karma:`none`,then:{text:`你把气息压到近乎凡人，眼神放空三分，活脱一个赶路赶得灰头土脸的散修。没人多看你第二眼——散修最大的本事，就是不起眼。`,effects:[`expose.真实修为 -3`]}},{text:`讨价还价`,onTags:[`交易`,`坊市`,`买卖`,`市井`],karma:`none`,check:{actor:`talent.悟性 + 名望 * 0.2`,dc:`45`,scale:10},onSuccess:{text:`你挑出货品三处不起眼的毛病，句句在行。摊主盯了你半晌，骂骂咧咧让了价——散修的每一枚灵石，都是这么抠出来的。`,effects:[`give ls_xia 10`]},onFail:{text:`摊主眼皮都没抬：「爱要不要。」你捏着钱袋站了片刻，终究没占到便宜。`,effects:[]}}],methods:[`打坐吐纳`,`聚灵阵辅修`,`洞天闭关`,`悟道`,`历练突破`,`丹药速成`,`双修`,`吞噬夺取`,`献祭`,`苦修锻体`,`借残魂指点`]}},pa=`凡俗`,ma=1,ha=10,ga={境界:{kind:`境界`,offset:0,abs:null},下境:{kind:`境界`,offset:1,abs:null},上境:{kind:`境界`,offset:-1,abs:null},境界·期:{kind:`境界期`,offset:0,abs:null},结丹物:{kind:`结丹物`,offset:0,abs:null},道统:{kind:`道统`,offset:0,abs:null}};function _a(e){let t=ga[e];if(t)return t;let n=/^境界([+\-=])(\d{1,2})$/.exec(e);if(!n)return null;let r=Number(n[2]);return n[1]===`=`?r>=ma&&r<=ha?{kind:`境界`,offset:0,abs:r}:null:r<1||r>9?null:{kind:`境界`,offset:n[1]===`+`?r:-r,abs:null}}function va(e,t){return t<ma?pa:H(e,Math.min(t,ha))}function ya(e,t,n,r=0){return e.kind===`道统`?t:e.kind===`结丹物`?Lt[t]??Lt.正道:e.kind===`境界期`?n<ma?pa:Wt(t,n,r):va(t,e.abs??n+e.offset)}function ba(e,t,n,r=0){return e.includes(`〔`)?e.replace(/〔([^〕〔]*)〕/g,(e,i)=>{let a=_a(i);return a?ya(a,t,n,r):e}):e}function xa(e,t){return ba(t,e.actor.path,e.actor.tier,e.actor.sublevel)}function Sa(e,t,n,r){if(t.location&&t.location!==r||t.mutexGroup&&e.flags.has(`互斥·${t.mutexGroup}`))return!1;let i=e.eventHistory.get(t.id);return i!==void 0&&(t.once||t.cooldown&&e.tick-i<t.cooldown)?!1:Kr(t.cond,n)}function Ca(e,t,n={}){let r=ii(e),i=da(e),a=n.location??e.location,o=[];for(let s of t.events.values())n.excludeTags?.length&&s.tags?.some(e=>n.excludeTags.includes(e))||Qi(i,s)!==0&&Sa(e,s,r,a)&&o.push(s);return o}var wa={window:80,floor:.06,countDecay:.2,countFloor:.02};function Ta(e,t){let n=e.eventCounts.get(t.id)??0;if(n===0)return 1;let r=e.eventHistory.get(t.id),i=r===void 0?wa.window:e.tick-r,a=Math.min(1,Math.max(0,i/wa.window));return(wa.floor+(1-wa.floor)*a)*Math.max(wa.countFloor,wa.countDecay**n)}function Ea(e,t,n={}){let r=Aa(e,t,n);if(r)return r;qi(e);let i=Ca(e,t,n);if(i.length===0)return null;let a=I(e.actor),o=da(e),s=e.scene,c=Ji(s,i),l=i.map(t=>{let r=Math.max(.01,t.weight*(1+a*.25))*Qi(o,t)*Yi(s,t,c);return n.noRepeatSuppression?r:r*Ta(e,t)}),u=e.rng.weighted(i,l);return s&&s.dwellLeft--,u}var Da={defaultAfter:[2,6],defaultPatience:12,maxQueue:16};function Oa(e,t,n){let r=e.sequels??=[];if(r.some(e=>e.event===n.event)||r.length>=Da.maxQueue)return!1;let[i,a]=n.after??Da.defaultAfter,o=Math.max(1,Math.floor(i)),s=Math.max(o,Math.floor(a)),c=e.tick+e.rng.int(o,s),l=Math.max(1,Math.floor(n.patience??Da.defaultPatience)),u={event:n.event,from:t,dueTick:c,expireTick:c+l};return n.cond&&(u.cond=n.cond),r.push(u),!0}function ka(e,t,n,r){if(n)for(let i of Array.isArray(n)?n:[n])i?.event&&Oa(e,t,i)&&r.push(i.event)}function Aa(e,t,n={}){let r=e.sequels;if(!r||r.length===0)return null;for(let n=r.length-1;n>=0;n--){let i=r[n];(!t.events.has(i.event)||e.tick>i.expireTick)&&r.splice(n,1)}let i=ii(e),a=n.location??e.location,o=r.map((e,t)=>({s:e,i:t})).sort((e,t)=>e.s.dueTick-t.s.dueTick||e.i-t.i);for(let{s:n}of o){if(e.tick<n.dueTick)continue;let o=t.events.get(n.event);if(Sa(e,o,i,a)&&!(n.cond&&!Kr(n.cond,i)))return r.splice(r.indexOf(n),1),o}return null}function ja(e,t){if(typeof t.text==`string`)return xa(e,t.text);if(t.text.length===0)return``;let n=e.eventCounts.get(t.id)??0;return xa(e,t.text[n%t.text.length])}var Ma=`〖破戒·`;function Na(e,t){return{...e,text:`${Ma}${t.rule}〗${e.text}`,tabooBreak:{rule:t.rule,penalty:t.penalty}}}function Pa(e,t){let n=ii(e),r=da(e),i=[],a=[];for(let e of t.choices){if(!Kr(e.require,n))continue;let t=oa(r,e);t?t.breakable?i.push(Na(e,t)):a.push({c:e,t}):i.push(e)}for(let e of r.signatures){if(!sa(e,t)||!Kr(e.require,n))continue;let{onTags:a,notTags:o,...s}=e;i.push({...s,injectedBy:r.id})}if(i.length===0)for(let{c:e,t}of a)i.push(Na(e,t));return i.map(t=>t.text.includes(`〔`)?{...t,text:xa(e,t.text)}:t)}function Fa(e,t,n){return!n||n===`none`?null:_n(e,{type:n.type,source:t.id,actor:`player`,target:n.target,weight:n.weight,polarity:n.polarity??-1,matureWindow:n.matureWindow,hooks:n.hooks}).id}function Ia(e,t,n,r){if(!n)return{text:``,goto:null,karma:null};ji(e,n.effects);let i=Fa(e,t,n.karma);return ka(e,t.id,n.sequel,r),{text:n.text?xa(e,n.text):``,goto:n.goto??null,karma:i}}function La(e,t,n){e.eventHistory.set(t.id,e.tick),e.eventCounts.set(t.id,(e.eventCounts.get(t.id)??0)+1),t.mutexGroup&&e.flags.add(`互斥·${t.mutexGroup}`),n.tabooBreak&&(e.flags.add(`破戒·${n.tabooBreak.rule}`),ji(e,n.tabooBreak.penalty));let r=Fa(e,t,n.karma),i=[];if(!n.check){ji(e,n.effects);let a=Ia(e,t,n.then,i);return ka(e,t.id,n.sequel,i),{outcome:null,text:a.text,goto:a.goto,karmaCreated:a.karma??r,planted:i}}ji(e,n.effects);let a=ii(e),o=Number(Gr(n.check.actor,a)),s=Number(Gr(n.check.dc,a)),c=ye(e.rng,{power:o,dc:s,scale:n.check.scale,bonus:n.check.bonus},I(e.actor)),l=Ia(e,t,c===`CRIT_SUCCESS`?n.onCritSuccess??n.onSuccess:c===`SUCCESS`?n.onSuccess:c===`FAIL`?n.onFail:n.onCritFail??n.onFail,i);return ka(e,t.id,n.sequel,i),{outcome:c,text:l.text,goto:l.goto,karmaCreated:l.karma??r,planted:i}}var Ra={你:`亲历（你）`,我:`自述（我）`,他:`说书（道号）`};function za(e,t,n=`他`){return t===`你`?e:e.split(`
...
`)}var Ba=[`零`,`一`,`二`,`三`,`四`,`五`,`六`,`七`,`八`,`九`];function X(e){if(e<10)return Ba[e];if(e<20)return`十${e%10?Ba[e%10]:``}`;if(e<100)return`${Ba[Math.floor(e/10)]}十${e%10?Ba[e%10]:``}`;if(e<1e3){let t=e%100;return`${Ba[Math.floor(e/100)]}百${t===0?``:t<10?`零${Ba[t]}`:X(t)}`}return String(e)}function Va(e,t,n){if(e<2)return null;let r=Math.floor(e);return r<4?[`转过年去，又是一年。`,`两三年一晃而过。`,`此后两年，山中无事。`][r%3]:r<12?`此后${X(r)}年，无事。`:r<50?`一晃，便是${X(r)}年。`:t>=4?`这一坐，便是${X(r)}年。出关那日，${n}认得的凡人，坟头草都换了几茬。`:`${X(r)}年过去了。山下已经换了人间。`}var Ha=new Set([`危机`,`冲突`,`战争`,`渡劫`,`心魔`,`怪谈`,`长期敌对`,`打脸`]),Ua=new Set([`日常`,`市井`,`人情`,`人间`,`江湖`,`修行`,`修炼`]);function Wa(e){return e.some(e=>Ha.has(e))?`tight`:e.some(e=>Ua.has(e))?`loose`:`neutral`}var Ga=[`话音未落——`,`这事没完。`,`一波未平，一波又起。`,`事情赶着事情来。`],Ka=[`不过数日。`,`转过月来。`,`一晃，月余。`],qa=e=>[`不过数日，你已到了${e}。`,`一路晓行夜宿，你到了${e}。`,`你离了旧处，落脚${e}。`],Ja=[`转过年去。`,`一晃两年。`,`第二年上，诸事平平。`],Ya=(e,t)=>[`第二年开春你离了${e}，一路到了${t}。`,`这两年你换了地方，如今落脚在${t}。`,`转过年去，你已在${t}住下。`];function Xa(e,t,n){let r=[`此后${X(t)}年，无事。`,`一晃，便是${X(t)}年。`];return t>=12&&r.push(`${X(t)}年过去了。山下已经换了人间。`),t>=12&&n>=4&&r.push(`这一坐，便是${X(t)}年。出关那日，你认得的凡人，坟头草都换了几茬。`),e.pick(r)}var Za=e=>[`再动身时，你已在${e}。`,`出来走动这一趟，你到了${e}。`],Qa=[`这一日，祸事寻上门来。`,`麻烦找上门来，没有一点先兆。`,`这天夜里，有人寻到了你的门前。`],$a=[`日子照旧过。这天，有桩事寻到你面前。`,`这天，来了个不速之客。`],eo=[`这天，有件事找到你头上。`,`又有一桩事，寻上门来。`],to=[`这天夜里——`,`偏在这时，出了事。`,`变故来得没有一点声响。`],no=[`闲事一桩，却也躲不开。`,`日子照旧过。这天，眼前起了点小波澜。`],ro=[`这天，出了件事。`,`这一日，眼前起了桩事。`,`该来的，总会来。`],io=(e,t)=>t?[`你把手头的事一一了结，往${e}投师去。`,`收拾了行装，你往${e}拜山去。`]:[`你把手头的事一一了结，往${e}去。`,`收拾了行装，你径直往${e}去。`,`这一日，你动身往${e}去。`],ao=[`主意既定，这一日，你去办那件盘算已久的事。`,`这天，你把手头的事撂下，专程赴那一桩去。`,`心里那点念头搁了许久，这天，你终于动了身。`],oo=[`你把手头的事一一了结，收拾行装，投师去。`,`这一日，你打定了拜师的主意，动身去了。`],so=new Set([`拜山`,`入门考核`]),co={"宗门→市井·弟子":[`这日你告了假，下山去。`,`山上的事撂下几日不妨。你换了身布衣，下山入市。`],"宗门→市井":[`你辞了山门里的住处，往人烟稠处去。`],"荒野→市井":[`风餐露宿的日子过够了。你寻了处人烟落脚，先吃上一顿热的。`,`出了山野见着炊烟，你脚步不由得快了几分。`],"秘境→市井":[`从那处非常之地脱身出来，你径直寻了人间烟火，好稳一稳心神。`],"宗门→荒野·弟子":[`宗门的事告一段落，你出了山门，拣人烟稀处行去。`,`你领了外出历练的差事，背上行囊出了山门。`],"宗门→荒野":[`你离了山门，重新上路。`],"市井→荒野":[`城里的事了了。你出了城门，前头是长长的山道。`,`你结了店钱，把行囊背上 —— 又是晓行夜宿的日子。`],"秘境→荒野":[`离了那处秘地，眼前又是荒岭长路。`],"市井→宗门·弟子":[`盘缠见底，你回了山上。`,`外头的日子过完了，你回山销假。`],"市井→宗门":[`你与山门中人有了往来，这一日随他们上了山，权且住下。`],"荒野→宗门·弟子":[`在外奔波了这些时日，你回了山门。蒲团还是原来那只。`,`你风尘仆仆地回山复命。`],"荒野→宗门":[`路过一处山门，你被留了下来，小住些时日。`],"秘境→宗门·弟子":[`从秘地出来，你回山复命。`],"秘境→宗门":[`从秘地出来，你寻了熟识的山门落脚。`],"宗门→秘境·弟子":[`你领了探察的差事，出山门往那处秘地去。`],"宗门→秘境":[`你得了一处秘地的消息，动身寻了过去。`],"市井→秘境":[`坊间得来的那点消息终究按捺不住，你收拾行装，往那处秘地寻去。`],"荒野→秘境":[`山行途中你察觉此地有异，索性循着那点异样深入进去。`]},lo=[`你换了个地方，也换了种过法。`];function uo(e,t){let n=`${t.from}→${t.to}`,r=(t.disciple?co[`${n}·弟子`]:void 0)??co[n]??lo;return e.pick(r)}var fo=e=>[`落脚在${e}。`,`这一程的尽头是${e}。`],po=[`丹田里那点东西，再也压不住了。`,`气机满盈，关口就在眼前。`,`这一夜，周天转到极处——关口到了。`];function mo(e,t){if(t.chained)return e.pick(Ga);let n=t.from!==t.to,r=Math.floor(Math.max(0,t.gapYears)),i=t.premise===`起意`&&t.nextKind===`event`,a;t.sceneShift?(a=uo(e,t.sceneShift),n&&!i&&(a+=e.pick(fo(t.to)))):i?a=t.gapYears<1?e.pick(Ka):r<=3?e.pick(Ja):Xa(e,r,t.tier):t.gapYears<1?a=n?e.pick(qa(t.to)):e.pick(Ka):r<=3?a=n?e.pick(Ya(t.from,t.to)):e.pick(Ja):(a=Xa(e,r,t.tier),n&&(a+=e.pick(Za(t.to))));let o=Wa(t.nextTags),s=t.premise===`上门`,c=t.nextTags.some(e=>so.has(e)),l=t.nextKind===`breakthrough`?e.pick(po):i?n?e.pick(io(t.to,c)):e.pick(c?oo:ao):o===`tight`?e.pick(s?Qa:to):o===`loose`?e.pick(s?$a:no):e.pick(s?eo:ro);return`${a}${l}`}function ho(e,t){return za(e,`他`,t)}var go=3;function _o(e){let t=[],n={title:`起于微末`,beats:[]};for(let r of e){let e=r.isMajor&&(r.kind===`scene`||r.kind===`milestone`);e&&n.beats.length>=go?(t.push(n),n={title:r.title??r.text.slice(0,12),beats:[r]}):(e&&n.beats.length<go&&r.title&&(n.title=n.beats.length===0?r.title??n.title:`${n.title} · ${r.title}`),n.beats.push(r))}return n.beats.length&&t.push(n),t}function vo(e,t,n){let r=e.text.trim();if(!r)return null;switch(e.kind){case`scene`:return za(r,t,n);case`choice`:return r.startsWith(`「`)?r.replace(/^「【[^】]*】/,`「`):`—— ${za(r,t,t===`我`?`我`:`他`)}`;case`outcome`:case`notice`:return za(r,t,t===`我`?`我`:`他`);case`transition`:return za(r,t,n);case`milestone`:return`是年，${za(r,t,n)}${/[。！？」]$/.test(r)?``:`。`}`}}function yo(e){let t=new Set,n=[],r=!1;for(let i=0;i<e.length;i++){let a=e[i];if(a.kind===`transition`){let o=e[i+1];if(o&&o.kind===`scene`&&o.evId&&t.has(o.evId)&&!o.isMajor)continue;r=!1,n.push(a);continue}if(a.kind===`scene`){if(a.evId&&t.has(a.evId)&&!a.isMajor){r=!0;continue}a.evId&&t.add(a.evId),r=!1,n.push(a);continue}(a.kind===`choice`||a.kind===`outcome`)&&r||((a.kind===`milestone`||a.kind===`notice`)&&(r=!1),n.push(a))}return n}function bo(e){let{daoName:t,chronicle:n,stele:r}=e,i=e.pov??`他`,a=[];a.push(`# 藏锋录 · ${t}${i===`我`?`自述`:`卷`}`),a.push(``),a.push(`> ${e.signature}`),a.push(`>`),a.push(`> —— ${t}${n.origin!==`凡俗`&&n.ending.tier!==`夭折`?`，${n.origin}`:``}，寿${X(n.lifespan)}载`),a.push(``);let o=_o(yo(e.beats)),s=null,c=null,l=i===`我`?`我`:t;if(o.forEach((e,n)=>{a.push(`## 第${X(n+1)}回 · ${e.title}`),a.push(``);for(let n of e.beats){if(s!==null&&n.kind===`scene`&&c!==`transition`){let e=Va(n.year-s,n.tier,l);e&&(a.push(e),a.push(``))}let e=vo(n,i,t);e&&(a.push(e),a.push(``)),s=n.year,c=n.kind}}),a.push(`## 终 · ${n.ending.name}`),a.push(``),i===`我`&&(a.push(`*（自述至此而止。以下数页为后人所补。）*`),a.push(``)),a.push(ho(n.ending.text,t)),a.push(``),n.deathChain){a.push(`后来有人翻起这段公案，把前因后果排了出来：`),a.push(``);for(let e of n.deathChain.split(`
...
`))a.push(`> ${e}`);if(a.push(``),n.people.length){a.push(`### 书中诸人，后来`),a.push(``);for(let e of n.people.slice(0,8))a.push(`**${e.name}**（${ho(e.relation,t)}）`),a.push(``),a.push(ho(e.afterward,t)),a.push(``)}if(n.unfinished.length){a.push(`### 未了之事`),a.push(``);for(let e of n.unfinished)a.push(`- ${e}`);a.push(``),a.push(`（这些账没有随他入土。它们还在世上走动，等下一个人。）`),a.push(``)}return a.push(`### 碑拓`),a.push(``),a.push("```"),a.push(Sr(r)),a.push("```"),a.push(``),a.push(`*此书由一局真实的推演自动写成。世界种子 \`${e.seed}\` —— 持此种子者，可入同一世界，另写一卷。*`),a.push(``),a.join(`
`)}function xo(e){return e.replace(/[#>*`\-\s]/g,``).length}function So(e){return[...e.effects??[],...e.onCritSuccess?.effects??[],...e.onSuccess?.effects??[],...e.onFail?.effects??[],...e.onCritFail?.effects??[]]}function Co(e,t){let n=[],r=new Set,i=(e,t)=>{r.has(e)||(r.add(e),n.push({text:e,level:t}))};e.tags?.includes(`岔路`)&&i(`人生岔路 · 落子无悔`,`grave`);let a=t.karma;a&&a!==`none`&&(a.hooks?.some(e=>e.lethal)?i(`或招杀身之祸`,`grave`):a.weight>=40&&i(`结下重因果`,`warn`));for(let e of So(t)){let t=e.trim();t.startsWith(`fakeDeath`)?i(`假死脱身 · 尽弃身份人脉`,`grave`):t.startsWith(`stepDown`)?i(`就此止步 · 不再求进`,`grave`):t.startsWith(`devourSoul`)?i(`反吞残魂 · 败则身死`,`grave`):t.startsWith(`mergeSoul`)?i(`魂魄相融 · 不可分离`,`grave`):t.startsWith(`silence`)?i(`灭口 · 业障加身`,`grave`):t.startsWith(`bind.soul`)&&i(`引魂入体 · 祸福难料`,`warn`);let n=/^堕度 \+(\d+(?:\.\d+)?)/.exec(t);n&&Number(n[1])>=8&&i(`堕入邪道`,`grave`),n=/^lifespan -(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=5&&i(`折寿${n[1]}载`,`grave`),n=/^僭越 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=8&&i(`僭越大增 · 天道侧目`,`warn`),n=/^业障 \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=20&&i(`业障深重`,`warn`),n=/^expose\.[^ ]+ \+(\d+(?:\.\d+)?)/.exec(t),n&&Number(n[1])>=15&&i(`大损隐秘`,`warn`)}return n}function wo(e,t){return Co(e,t).some(e=>e.level===`grave`)}function To(e,t){let n={player:[],auto:[],loose:[],transition:null,nextScene:null},r=new Map,i=[];for(let t of e){if(t.episodeId==null){n.loose.push(t);continue}let e=r.get(t.episodeId);if(e)e.beats.push(t);else{let e={episodeId:t.episodeId,auto:!!t.auto,beats:[t]};r.set(t.episodeId,e),i.push(e)}}for(let e of i){let t=e.beats.length===1?e.beats[0]:null;if(t?.kind===`transition`){n.transition&&n.loose.push(n.transition),n.transition=t;continue}(e.auto?n.auto:n.player).push(e)}let a=n.player[n.player.length-1];return t&&a&&a.beats.every(e=>e.kind===`scene`)&&a.beats[0].evId===t&&(n.nextScene=a,n.player.pop()),n}var Eo={外门:{monthly:2,dutyEvery:3,patience:5,duty:`劈柴挑水，兼扫丹房`},内门:{monthly:10,dutyEvery:4,patience:6,duty:`守山门，轮值三班`},真传:{monthly:30,dutyEvery:5,patience:6,duty:`代师授业，兼查外门功课`},执事:{monthly:60,dutyEvery:5,patience:7,duty:`押粮、点卯、断门内的官司`},长老:{monthly:140,dutyEvery:6,patience:8,duty:`坐镇一堂，议事时须到`},掌门:{monthly:180,dutyEvery:7,patience:8,duty:`山门岁供进账，也轮到你发别人的俸`}},Do=[`外门`,`内门`,`真传`,`执事`,`长老`],Z={paidMonthsCap:24,payEveryMonths:12,dutyCost:.004,meritMin:-60,meritMax:60,suspendAt:3,suspendTicks:4,dismissAt:6,arrearsMonthsCap:36,backPayMonths:36},Oo={1:10,2:80,3:500,4:2500,5:9e3,6:2e4,7:4e4,8:7e4,9:12e4};function ko(){return{merit:0,promotions:0,accruedMonths:0,arrears:0,dutyLeft:0,missed:0,suspended:0,paidTotal:0}}var Ao=class e{ctx;db;registry;seed;maxTicks;birthYear=16;milestones=[];curve=[];notices=[];beats=[];pendingEvent=null;pendingBreakthrough=null;chainDepth=0;episodeSeq=1;currentEpisode=0;pageYear;pageLocation;breakthroughCooldown=0;death=null;steppedDown=!1;failedBranch=null;finished=null;lastTags=[];get stance(){return this.ctx.stance??`打坐吐纳`}set stance(e){this.ctx.stance=e}lastOutcome=null;lastDeltas=[];lastBreakthrough=null;signInYear=-1;stipend=ko();lastRank=null;get gacha(){return this.ctx.gacha}set gacha(e){this.ctx.gacha=e}autoResolveMinor=!0;flushItemNotices(){let e=this.ctx.itemNotices;if(!(!e||e.length===0)){for(let t of e)this.note(t);e.length=0}}upkeepStance(){let{ctx:e}=this,t=this.stance,n=b[t];if(`needsInsight`in n&&!Ir(e.actor,e.flags))return this.stanceFallbackNote(`姿·无悟已述`,`心中无所悟，枯坐也参不出道。你回到蒲团上，从吐纳做起。`),Mr;if(`toxin`in n){let t=Lr(V(e.actor));if(!t)return this.stanceFallbackNote(`姿·丹尽已述`,`丹尽了。你回到蒲团上，从吐纳做起。`),Mr;let n=lt(e.actor,t);if(n.ok)for(let t of n.effects)Oi(e,t)}return t}stanceFallbackNote(e,t){this.ctx.flags.has(e)||(this.ctx.flags.add(e),this.note(t))}noticeOnly(e){this.notices.push(e),this.notices.length>64&&this.notices.splice(0,this.notices.length-64)}note(e,t=`notice`){this.notices.push(e),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:t,text:e})}newEpisode(){return this.episodeSeq++}pushTransition(e,t,n=!1,r){let i=this.ctx.scene,a=!n&&i?.shift?i.shift:void 0;a&&i&&delete i.shift;let o=mo(this.ctx.rng,{gapYears:this.ctx.year-this.pageYear,from:this.pageLocation,to:this.ctx.location,nextTags:e,tier:this.ctx.actor.tier,nextKind:t,chained:n,premise:r,sceneShift:a?{...a,disciple:this.ctx.flags.has(`宗门弟子`)}:void 0});this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`transition`,text:o,episodeId:this.newEpisode()}),this.pageYear=this.ctx.year,this.pageLocation=this.ctx.location}constructor(e){let t=new o(e.seed);if(this.seed=e.seed,this.db=e.db,this.registry=e.registry,this.maxTicks=e.maxTicks??500,e.restore){let t=structuredClone(e.restore);if(t.pendingEventId&&!e.db.events.has(t.pendingEventId))throw Error(`快照中的事件「${t.pendingEventId}」已不存在（内容已更新）`);this.ctx={rng:o.restore(t.rng),year:t.year,tick:t.tick,actor:t.actor,karmaLedger:t.karmaLedger,log:[],flags:new Set(t.flags),systems:t.systems,eventHistory:new Map(t.eventHistory),eventCounts:new Map(t.eventCounts),sequels:t.sequels??[],location:t.location,knowers:t.knowers,gacha:t.gacha??li(),scene:t.scene??Gi(new Set(t.flags),t.location)},this.milestones.push(...t.milestones),this.curve.push(...t.curve),this.beats.push(...t.beats),this.notices.push(...t.notices),this.pendingEvent=t.pendingEventId?e.db.events.get(t.pendingEventId):null,this.pendingBreakthrough=t.pendingBreakthrough??null,this.chainDepth=t.chainDepth,this.breakthroughCooldown=t.breakthroughCooldown,this.lastTags=t.lastTags,this.stance=t.stance??`打坐吐纳`,this.signInYear=t.signInYear??-1,this.autoResolveMinor=!0,this.stipend=t.stipend??ko(),this.episodeSeq=t.episodeSeq??t.beats.reduce((e,t)=>Math.max(e,t.episodeId??0),0)+1,this.currentEpisode=t.currentEpisode??0,this.pageYear=t.pageYear??t.year,this.pageLocation=t.pageLocation??t.location,this.lastRank=t.lastRank===void 0?this.sectRank():t.lastRank,this.backfillKit(t);return}let n=e.birthplace??t.pick(yt),r=Ft(t,{birthplace:n,name:e.name??`无名`});this.ctx={rng:t,year:this.birthYear,tick:0,actor:r,karmaLedger:[],log:[],flags:new Set,systems:[],eventHistory:new Map,eventCounts:new Map,sequels:[],location:n.name,knowers:[],gacha:li()},this.pageYear=this.birthYear,this.pageLocation=n.name,this.milestones.push({year:this.birthYear,kind:`出生`,text:`生于${n.name}，${r.talent.root}`}),this.ctx.flags.add(`出身·${n.id}`),this.ctx.flags.add(`道统·${r.path}`),(r.path===`正道`||r.path===`儒道`)&&this.ctx.flags.add(`宗门弟子`),this.ctx.scene=Wi(t,Ui(this.ctx.flags,this.ctx.location),this.ctx.location),Rn(this.ctx);let i=e.db.events.get(`evt_prologue_${n.id}`);i&&(this.pendingEvent=i,this.currentEpisode=this.newEpisode(),this.beats.push({year:this.birthYear,tier:1,kind:`scene`,text:ja(this.ctx,i),evId:i.id,title:i.title,isMajor:!0,episodeId:this.currentEpisode}))}snapshot(){return this.finished||!this.ctx.actor.alive?null:structuredClone({v:1,seed:this.seed,name:this.ctx.actor.name,rng:this.ctx.rng.snapshot(),year:this.ctx.year,tick:this.ctx.tick,actor:this.ctx.actor,karmaLedger:this.ctx.karmaLedger,flags:[...this.ctx.flags],systems:this.ctx.systems,eventHistory:[...this.ctx.eventHistory.entries()],eventCounts:[...this.ctx.eventCounts.entries()],sequels:this.ctx.sequels??[],location:this.ctx.location,knowers:this.ctx.knowers,scene:this.ctx.scene,milestones:this.milestones,curve:this.curve,beats:this.beats,notices:[...this.notices],pendingEventId:this.pendingEvent?.id??null,pendingBreakthrough:this.pendingBreakthrough,chainDepth:this.chainDepth,breakthroughCooldown:this.breakthroughCooldown,lastTags:this.lastTags,stance:this.stance,signInYear:this.signInYear,autoResolve:this.autoResolveMinor,gacha:this.gacha,stipend:this.stipend,itemsEra:1,episodeSeq:this.episodeSeq,currentEpisode:this.currentEpisode,pageYear:this.pageYear,pageLocation:this.pageLocation,lastRank:this.lastRank})}currentPrompt(){return this.finished?{kind:`gameover`,result:this.finished}:this.pendingBreakthrough?{kind:`breakthrough`,...this.pendingBreakthrough}:this.pendingEvent?{kind:`event`,card:this.pendingEvent,text:ja(this.ctx,this.pendingEvent),choices:Pa(this.ctx,this.pendingEvent)}:null}gatherPage(e){let t=Math.max(0,Math.min(e,this.beats.length));return{page:To(this.beats.slice(t),this.pendingEvent?.id??null),cursor:this.beats.length}}advance(){if(this.finished)return{kind:`gameover`,result:this.finished};if(this.pendingEvent){let e=this.currentPrompt();if(e)return e}if(this.pendingBreakthrough)return{kind:`breakthrough`,...this.pendingBreakthrough};let{ctx:e}=this,t=e.actor;for(;t.alive&&e.tick<this.maxTicks;){e.tick++;let n=u[t.tier]??12,r=n/12;e.year+=r,t.ageMonths+=n;let i=Jt(e,this.upkeepStance());i.mishap&&this.note(`修炼时气息岔了一下，胸口发闷 —— 走火的前兆。`),i.stageUp&&this.note(`水到渠成，已入${i.stageUp}。`,`milestone`);for(let n of t.souls){if(n.dissipated||n.favor<=-20||n.possession>=90)continue;let r=kn(n,t.tier);r.speedBonus>0&&e.rng.chance(.25)&&(An(e,n.id),t.sublevel=Math.min(1,t.sublevel+.012*r.speedBonus))}let a=On(e);a&&this.note(a);let o=e.rng.chance(pe.eventChance)?Ea(e,this.db,{excludeTags:this.lastTags}):null;if(o){this.lastTags=o.tags?.slice(0,1)??[];let n=Pa(e,o);if(!this.autoResolveMinor||n.length===0||this.isMajor(o,n)){this.pendingEvent=o,this.chainDepth=0,this.pushTransition(o.tags??[],`event`,!1,o.premise),this.currentEpisode=this.newEpisode();let r=ja(e,o);return this.beats.push({year:Math.floor(e.year),tier:t.tier,kind:`scene`,text:r,evId:o.id,title:o.title,isMajor:o.tags?.includes(`主干`)||o.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:o,text:r,choices:n}}let r=this.autoResolve(o,n);if(r)return r;if(!t.alive)return{kind:`gameover`,result:this.finalize()}}else this.lastTags=[];let s=this.postTick(r);if(s)return s;if(i.ready&&t.tier<10&&this.breakthroughCooldown<=0){let n=be({power:Xt(t),dc:Yt(t),scale:Math.max(20,Yt(t)*.2)},I(t)),r=xe(e.rng,n,I(t));return this.pushTransition([],`breakthrough`),this.pendingBreakthrough={toTier:t.tier+1,estimate:r},{kind:`breakthrough`,toTier:t.tier+1,estimate:r}}this.breakthroughCooldown>0&&this.breakthroughCooldown--,e.tick%4==0&&this.curve.push(ir(t,e.tick,e.year))}return{kind:`gameover`,result:this.finalize()}}static MAJOR_TAGS=new Set([`主干`,`岔路`,`道德`,`抉择`,`打脸`,`止步`,`结丹`,`定道`,`系统`,`心魔`]);isMajor(t,n){return!!(t.once||t.tags?.some(t=>e.MAJOR_TAGS.has(t))||n.some(e=>!!e.require)||n.some(e=>wo(t,e))||n.some(e=>e.karma!==`none`&&typeof e.karma==`object`&&e.karma.weight>=30))}autoResolve(e,t){let{ctx:n}=this,r=e,i=t,a=0;for(;r&&a++<5;){let e=this.newEpisode(),t=ja(n,r);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:t,evId:r.id,title:r.title,episodeId:e,auto:!0});let o=i.filter(e=>!wo(r,e)),s=o.length?o:i,c=s.map((e,t)=>1/(t+1)+.3),l=n.rng.weighted(s,c);this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`choice`,text:l.text,episodeId:e,auto:!0});let u=La(n,r,l);if(this.flushItemNotices(),u.text&&this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`outcome`,text:u.text,episodeId:e,auto:!0}),r=u.goto?this.db.events.get(u.goto)??null:null,!r||(i=Pa(n,r),i.length===0))break;if(this.isMajor(r,i)){this.pendingEvent=r,this.chainDepth=a,this.pushTransition(r.tags??[],`event`,!0,r.premise),this.currentEpisode=this.newEpisode();let e=ja(n,r);return this.beats.push({year:Math.floor(n.year),tier:n.actor.tier,kind:`scene`,text:e,evId:r.id,title:r.title,isMajor:r.tags?.includes(`主干`)||r.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:r,text:e,choices:i}}}return null}captureStats(){let e=this.ctx.actor;return{修为:e.sublevel*100,道心:e.道心,气运:e.气运,功德:e.功德,业障:e.业障,僭越:e.僭越,堕度:e.堕度,丹毒:e.丹毒,名望:e.名望,悟性:e.talent.悟性,根骨:e.talent.根骨,神魂:e.talent.神魂,寿元:e.lifespanYears,功法:e.factors.功法,法宝:e.factors.法宝,状态:e.factors.状态,灵宠:e.factors.灵宠,伙伴:e.factors.伙伴,道侣:e.factors.道侣,情报:e.factors.情报,暴露:Math.max(...Object.values(e.secrets))}}static WARN_KEYS=new Set([`业障`,`僭越`,`堕度`,`丹毒`,`暴露`]);static FACTOR_KEYS=new Set([`功法`,`法宝`,`状态`,`灵宠`,`伙伴`,`道侣`,`情报`]);diffStats(t){let n=this.captureStats(),r=[];for(let i of Object.keys(t)){let a=(n[i]??0)-(t[i]??0),o=e.FACTOR_KEYS.has(i);if(Math.abs(a)<(o?.015:.5))continue;let s=e.WARN_KEYS.has(i)?a>0?`warn`:`good`:a>0?`good`:`bad`,c=o?a>0?`+${a.toFixed(2)}`:a.toFixed(2):i===`修为`?`${a>0?`+`:``}${a.toFixed(1)}%`:`${a>0?`+`:``}${Math.round(a)}`;r.push({key:i,delta:a,kind:s,text:`${i} ${c}`})}return r}choose(e){let t=this.pendingEvent;if(!t)throw Error(`当前没有待处理的事件`);let n=Pa(this.ctx,t),r=n[e];if(!r)throw Error(`选项 ${e} 不存在（共 ${n.length} 项）`);this.currentEpisode||=this.newEpisode(),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`choice`,text:r.text,episodeId:this.currentEpisode});let i=this.captureStats(),a=La(this.ctx,t,r);if(this.lastOutcome=a.outcome,this.lastDeltas=this.diffStats(i),this.flushItemNotices(),a.karmaCreated){let e=this.ctx.karmaLedger.find(e=>e.id===a.karmaCreated);e&&this.lastDeltas.push({key:`因果`,delta:e.polarity,kind:e.polarity>0?`good`:e.polarity<0?`warn`:`bad`,text:`因果 · ${e.type}`})}if(a.text&&(this.notices.push(a.text),this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`outcome`,text:a.text,episodeId:this.currentEpisode})),(t.tags?.includes(`岔路`)||t.tags?.includes(`主干`))&&this.milestones.push({year:Math.floor(this.ctx.year),kind:`岔路`,text:`【${t.title}】`}),a.goto&&this.chainDepth<4){let e=this.db.events.get(a.goto);if(e){this.chainDepth++,this.pendingEvent=e;let t=Pa(this.ctx,e);if(t.length>0){this.pushTransition(e.tags??[],`event`,!0,e.premise),this.currentEpisode=this.newEpisode();let n=ja(this.ctx,e);return this.beats.push({year:Math.floor(this.ctx.year),tier:this.ctx.actor.tier,kind:`scene`,text:n,evId:e.id,title:e.title,isMajor:e.tags?.includes(`主干`)||e.tags?.includes(`岔路`),episodeId:this.currentEpisode}),{kind:`event`,card:e,text:n,choices:t}}}}if(this.pendingEvent=null,this.currentEpisode=0,!this.ctx.actor.alive)return{kind:`gameover`,result:this.finalize()};if(this.ctx.flags.has(`止步`)&&rr(this.ctx.actor))return this.steppedDown=!0,this.milestones.push({year:Math.floor(this.ctx.year),kind:`结局`,text:`止步 —— 不再求进`}),{kind:`gameover`,result:this.finalize()};let o=u[this.ctx.actor.tier]??12;return this.postTick(o/12)||this.advance()}decideBreakthrough(e,t=!1){let n=this.ctx.actor;if(this.pendingBreakthrough=null,this.lastBreakthrough=null,!e)return this.breakthroughCooldown=6,this.note(`你压下了冲关的念头，继续温养。`),this.advance();let r=n.tier,i=Zt(this.ctx,{hiddenAttempt:t,coreGradeInvest:this.ctx.flags.has(`结丹·全押`)?.85:.4});if(i.newTier>r){on(this.ctx);let e=H(n.path,i.newTier),t=i.newTier===3?Lt[n.path]===e?zt(i.goldenCoreGrade):Rt(n.path,i.goldenCoreGrade):``;this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`入${e}${i.hiddenAchieved?`（得隐藏境界）`:``}${t?` · ${t}`:``}`}),this.notices.push(`突破成功 —— ${e}。${i.hiddenAchieved?`而且你摸到了传说里的那一层。`:``}`),this.lastBreakthrough={ok:!0,name:e,hidden:i.hiddenAchieved},this.beats.push({year:Math.floor(this.ctx.year),tier:n.tier,kind:`milestone`,isMajor:!0,title:`入${e}`,text:`入${e}${i.hiddenAchieved?`，且踏足了世所罕闻的隐秘之境`:``}${t?`，结成${t}`:``}`})}else if(i.failure){this.milestones.push({year:Math.floor(this.ctx.year),kind:`突破`,text:`渡劫失败 · ${i.failure.name}`});let e=Qn(i.failure.outcome,n.path);if(this.note(`突破失败 —— ${e}`),i.failure.recoverable===!1||i.failure.branch)return this.failedBranch={name:i.failure.name,outcome:e,branch:i.failure.branch},n.alive=!1,{kind:`gameover`,result:this.finalize()}}else this.note(`冲关未成，气机散了。所幸根基未损，还能再来。`);return this.advance()}signIn(){if(!this.ctx.systems.includes(`签到`))return{ok:!1,text:`未绑定签到系统`};let e=Math.floor(this.ctx.year);if(e<=this.signInYear)return{ok:!1,text:`今岁已签，明年再来`};this.signInYear=e;let t=this.ctx.actor,n=this.ctx.rng.pick([{text:`灵气灌顶 · 修为 +2%`,apply:()=>{t.sublevel=Math.min(1,t.sublevel+.02)}},{text:`残页功法一篇 · 功法 +0.02`,apply:()=>{t.factors.功法=Math.min(1.9,t.factors.功法+.02)}},{text:`下品法器一件 · 法宝 +0.02`,apply:()=>{t.factors.法宝=Math.min(1.75,t.factors.法宝+.02)}},{text:`疗伤玉露 · 状态 +0.06`,apply:()=>{t.factors.状态=Math.min(1.45,t.factors.状态+.06)}},{text:`静心符一道 · 道心 +1`,apply:()=>{t.道心=Math.min(100,t.道心+1)}},{text:`一点玄妙气机 · 气运 +1`,apply:()=>{t.气运=Math.min(100,t.气运+1)}}]);return n.apply(),t.僭越+=1.5,t.secrets.金手指=Math.min(100,t.secrets.金手指+1.5),this.note(`【签到系统】叮 —— 连续签到中。今日奖励：${n.text}。`),{ok:!0,text:n.text}}systemDef(e){return this.db.systems.get(e)}availablePools(){return Si.filter(e=>Ci[e.id]?.cond(this.ctx.actor.tier,this.ctx.flags)??!0)}poolCost(e){return Ci[e]?.cost(this.ctx.flags)??null}poolInfo(e){let t=Si.find(t=>t.id===e),n=Ci[e];if(!t)return null;let r=n?.cost(this.ctx.flags)??{},i=n?ui(this.ctx.actor,r):[];return{odds:gi(this.ctx.actor,t,this.gacha),pityLeft:_i(t,this.gacha),count:this.gacha.count[e]??0,costText:fi(r),affordable:i.length===0,missing:i,hint:n?.hint??``}}tryDrawFrom(e){let t=Si.find(t=>t.id===e),n=Ci[e];if(!t||!n)return{ok:!1,missing:[],reason:`没有「${e}」这座签筒`};if(!n.cond(this.ctx.actor.tier,this.ctx.flags)){let e={kind:`locked`,label:t.name,need:0,have:0,text:`${t.name}尚未对你开放`};return{ok:!1,missing:[e],reason:e.text}}let r=n.cost(this.ctx.flags),i=di(this.ctx.actor,r);if(i.length)return{ok:!1,missing:i,reason:`代价不足 —— ${i.map(e=>e.text).join(`；`)}`};let a=this.captureStats();ji(this.ctx,[...r.effects??[]]);let o=hi(this.ctx.rng,this.ctx.actor,t,this.gacha);ji(this.ctx,o.prize.effects),this.lastDeltas=this.diffStats(a);let s=o.rarity===`秘藏`?`★`:o.rarity===`仙品`?`☆`:``;return this.note(`【${t.name}】${s}${o.rarity}·${o.prize.name} —— ${o.prize.desc}`),this.flushItemNotices(),o.byPity&&this.note(`（连番落空之后，天道似乎补了你一次。）`),{ok:!0,result:o,missing:[]}}drawFrom(e){return this.tryDrawFrom(e).result??null}inventory(){return V(this.ctx.actor)}bag(){return nt(this.inventory())}bagSlots(){let e=this.inventory();return{used:et(e),total:$e(e),free:tt(e),container:e.container}}stones(){return gt(this.inventory())}useItem(e){let t=this.captureStats(),n=B(e)?.name??e,r=lt(this.ctx.actor,e);if(!r.ok)return{ok:!1,text:r.reason??`用不了${n}`};for(let e of r.effects)Oi(this.ctx,e);this.lastDeltas=this.diffStats(t);let i=r.note??`用掉了${n}`;return this.note(i),this.flushItemNotices(),{ok:!0,text:i}}equipItem(e){let t=this.captureStats(),n=B(e)?.name??e,r=ft(this.ctx.actor,e);if(!r.ok)return{ok:!1,text:r.reason??`佩不上${n}`};r.overTier&&Un(this.ctx),this.lastDeltas=this.diffStats(t);let i=`佩上${n}（${r.slot}位）${r.overTier?` —— 越阶用宝，藏不住了`:``}`;return this.note(i),this.flushItemNotices(),{ok:!0,text:i}}unequipItem(e){let t=this.captureStats(),n=B(e)?.name??e,r=mt(this.ctx.actor,e);return r.ok?(this.lastDeltas=this.diffStats(t),this.flushItemNotices(),{ok:!0,text:`卸下${n}（${r.slot}位）`}):{ok:!1,text:r.reason??`${n}没佩在身上`}}sectStatus(){let e=this.sectRank();return{rank:e,monthly:e?Math.round(this.monthlyStipend(e)*10)/10:0,merit:this.stipend.merit,onDuty:this.stipend.dutyLeft>0,suspended:this.stipend.suspended>0,missed:this.stipend.missed,paidTotal:this.stipend.paidTotal,arrears:this.stipend.arrears}}sectRank(){let e=this.ctx.flags;if(e.has(`已建宗`))return`掌门`;if(!e.has(`宗门弟子`)||e.has(`叛出宗门`)||e.has(`叛出山门`)||e.has(`宗门·已除名`)||e.has(`宗门·已离山`))return null;let t=this.ctx.actor.tier,n=t>=5?4:t>=4?3:t>=3?2:+(t>=2);return e.has(`位列长老`)&&(n=Math.max(n,4)),(e.has(`掌刑堂`)||e.has(`兼任丹房执事`))&&(n=Math.max(n,3)),e.has(`得见一式真传`)&&(n=Math.max(n,2)),e.has(`师承已定`)&&(n=Math.max(n,1)),n=F(n+this.stipend.promotions,0,Do.length-1),Do[n]}monthlyStipend(e){let t=F(1+this.ctx.actor.名望/500,.8,1.35),n=F(1+this.stipend.merit/180,.7,1.3);return Eo[e].monthly*this.sectPayScale()*t*n}sectPayScale(){let e=this.ctx.actor.sect,t=e?Xr(e)?.endowment?.stipend:void 0;return typeof t==`number`&&t>0?t/Eo.外门.monthly:1}grantStones(e){let t=this.inventory(),n=Math.floor(Math.max(0,e));if(n<=0)return 0;let r=ht(t),i=0;for(let e of[`下品`,`中品`,`上品`])r[e]<=0||(i+=r[e]*P[e],ot(t,Ye[e],r[e]));let a=i+n,o=0;for(let e of[`上品`,`中品`,`下品`]){if(a<=0)break;let n=P[e],r=Math.floor(a/n);if(r<=0)continue;let i=at(t,Ye[e],r);o+=i.added*n,a-=i.added*n}return Math.max(0,o-i)}consumeSectMarks(){let e=this.ctx.flags,t=this.stipend,n=()=>{t.dutyLeft=0,e.delete(`宗门·当值`)},r=e=>{t.merit=F(t.merit+e,Z.meritMin,Z.meritMax)};e.delete(`宗门·当值·已了`)&&(n(),r(8),t.missed=Math.max(0,t.missed-1),this.ctx.actor.sublevel=Math.max(0,this.ctx.actor.sublevel-Z.dutyCost)),e.delete(`宗门·当值·推了`)&&(n(),r(-10),t.missed++),e.delete(`宗门·记功`)&&r(6),e.delete(`宗门·记过`)&&r(-8),e.delete(`宗门·晋阶`)&&(t.promotions=Math.min(2,t.promotions+1)),e.delete(`宗门·降等`)&&(t.promotions=Math.max(-4,t.promotions-1)),e.delete(`宗门·请辞`)&&(e.add(`宗门·已离山`),n(),t.accruedMonths=0,this.note(`你把腰牌还了。执事堂的册子上划掉一个名字，笔都没抬一下 —— 从此没人管你，也没人给你发钱。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`岔路`,text:`自请离山，从此散修`})),e.delete(`宗门·复籍`)&&(e.add(`宗门弟子`),e.delete(`宗门·已除名`),e.delete(`宗门·已离山`),e.delete(`宗门·停俸`),t.missed=0,t.suspended=0,t.merit=0,t.accruedMonths=0,this.note(`腰牌重新发回你手上，还是旧的那一块，边角被人摩得发亮。俸禄从这个月起照发。`)),t.missed>=Z.dismissAt?this.dismiss():t.missed>=Z.suspendAt&&t.suspended===0&&(t.suspended=Z.suspendTicks,t.accruedMonths=0,e.add(`宗门·停俸`),this.note(`执事堂把你的名字从发俸的册子上暂时划了出去 —— 「什么时候出满了工，什么时候再说。」`))}dismiss(){let e=this.stipend,t=this.ctx.flags;e.missed=2,e.suspended=0,t.delete(`宗门·停俸`);let n=this.sectRank();if(n!==`掌门`&&n!==null){if(n!==`外门`){e.promotions=Math.max(-4,e.promotions-1),this.note(`执事堂当众念了你的名字：误工太多，免去${n}之职，退回下一等再看。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`因果`,text:`免职 · 自${n}退下`});return}t.delete(`宗门弟子`),t.add(`宗门·已除名`),e.dutyLeft=0,t.delete(`宗门·当值`),e.accruedMonths=0,this.note(`你的名字从外门册子上被墨笔涂掉了。腰牌收回，山门以内不必再来 —— 俸禄自然也没有了。`),this.milestones.push({year:Math.floor(this.ctx.year),kind:`因果`,text:`除名 · 逐出山门`})}}tickDuty(e){let t=this.stipend,n=this.ctx.flags;if(t.dutyLeft>0){if(t.dutyLeft--,t.dutyLeft>0)return;n.delete(`宗门·当值`),t.merit=F(t.merit+2,Z.meritMin,Z.meritMax),this.ctx.actor.sublevel=Math.max(0,this.ctx.actor.sublevel-Z.dutyCost),this.noticeOnly(`这一档差事你按部就班地当完了，无事可记 —— 只是那些时辰没能用来打坐。`);return}this.ctx.tick%Eo[e].dutyEvery===0&&(t.dutyLeft=Eo[e].patience,n.add(`宗门·当值`),this.noticeOnly(`【当值】排班簿上写了你的名字：${Eo[e].duty}。`))}tickStipend(e){let t=this.stipend,n=this.ctx.flags;this.consumeSectMarks();let r=this.sectRank();if(r!==this.lastRank&&(r&&this.lastRank?this.note(`执事堂改了你的名牌 —— 自今日起，你是${r}。`):r&&this.note(`你的名字进了${r}的册子。往后每月有俸，也每月有差事。`),this.lastRank=r),!r){t.dutyLeft=0,t.accruedMonths=0,n.delete(`宗门·当值`),n.delete(`宗门·停俸`);for(let e of Do)n.delete(`身份·${e}`);n.delete(`身份·掌门`),n.delete(`宗门·在册`);return}n.add(`宗门·在册`);for(let e of Do)e!==r&&n.delete(`身份·${e}`);if(r!==`掌门`&&n.delete(`身份·掌门`),n.add(`身份·${r}`),t.suspended>0&&(t.suspended--,t.suspended===0&&(n.delete(`宗门·停俸`),this.note(`名字又写回了发俸的册子上。经手的执事没抬头：「下不为例。」`))),this.tickDuty(r),t.suspended>0||(t.accruedMonths+=Math.min(e,Z.paidMonthsCap),t.accruedMonths<Z.payEveryMonths))return;let i=t.accruedMonths;t.accruedMonths=0;let a=this.monthlyStipend(r),o=Math.floor(a*i)+t.arrears;if(o<=0)return;let s=this.grantStones(o);if(t.paidTotal+=s,t.arrears=Math.min(o-s,Math.floor(a*Z.arrearsMonthsCap)),s>0){let e=Math.round(i/12);this.noticeOnly(`【俸禄】领了${e<=1?`这一年`:`这${e}年`}的例俸，共 ${s} 块下品灵石之数。`)}t.arrears>0&&this.noticeOnly(`行囊塞不下，余下的先记在执事堂的账上 —— 腾出手了再来支。`)}backfillKit(e){if(e.itemsEra===1)return;let t=V(this.ctx.actor);if(t.stacks.length>0)return;let n=bt[[...this.ctx.flags].find(e=>e.startsWith(`出身·`))?.slice(3)??yt.find(e=>e.name===this.ctx.location)?.id??``]??xt,r=[];for(let[e,i]of n){let n=at(t,e,i);n.added>0&&r.push(`${B(e)?.name??e}×${n.added}`)}for(let e of[...t.stacks]){let t=B(e.defId);t?.equip&&!e.equipped&&ft(this.ctx.actor,t.id)}let i=this.sectRank(),a=Oo[this.ctx.actor.tier]??0,o=i?Math.floor(this.monthlyStipend(i)*Z.backPayMonths):0,s=this.grantStones(a+o);s>0&&(this.stipend.paidTotal+=o>0?Math.min(s,o):0,r.push(`折合下品灵石 ${s}`)),this.note(`【行囊补记】你解下包袱才发现，这些年随身的东西一件都不在 —— 不是被人偷了，是先前记账的人漏了你这一囊：${r.join(`、`)}${i?`（其中含${i}的欠俸 ${o} 块）`:``}。旧存档开局时物品尚未入册，这一份是补给你的。`)}postTick(e){let{ctx:t}=this,n=t.actor;this.tickStipend(Math.round(e*12));for(let e of Bn(t))this.note(e);let r=tn(t);r&&(this.note(r),t.rng.chance(.4)&&nn(t));let i=rn(t);i&&(this.note(i.text),this.milestones.push({year:Math.floor(t.year),kind:`机缘`,text:`身世揭晓：${i.origin}`}));for(let{soul:e,fate:n}of jn(t))this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`${e.name} · ${n}`}),this.note(`${e.name} —— ${n}。`);if(!n.alive)return{kind:`gameover`,result:this.finalize()};Wn(t),Xn(t),n.锋芒=we(n)*(.15+.85*(n.secrets.真实修为/100));let a=Gn(t);if(a.length){this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`秘密败露：${a.join(`、`)}`}),this.note(`瞒不住了 —— 你的${a.join(`、`)}已是公开的秘密。`);for(let e of a)n.secrets[e]=70;n.名望-=10}for(let n of vn(t,e)){if(n.kind===`foreshadow`||n.kind===`window`){this.note(`（${n.evtId.replace(/_/g,` `)}）`);continue}if(!n.lethal)continue;let e=un(t,n.karma);if(this.note(e.text),e.death)return this.death=En(t,e.death),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:e.death.description}),{kind:`gameover`,result:this.finalize()};this.milestones.push({year:Math.floor(t.year),kind:`因果`,text:`${n.karma.target}的旧账 —— ${e.kind}`})}let o=Dn(t);return o?(this.death=En(t,o),this.milestones.push({year:Math.floor(t.year),kind:`死亡`,text:o.description}),{kind:`gameover`,result:this.finalize()}):null}finalize(){if(this.finished)return this.finished;let{ctx:e}=this,t=e.actor;t.perfectionByTier[t.tier]||(t.perfectionByTier[t.tier]=Qt(t,t.hiddenRealms.includes(t.tier))),this.curve.push(ir(t,e.tick,e.year));let n=tr({actor:t,death:this.death,steppedDown:this.steppedDown,rootedAt:e.location,failedBranch:this.failedBranch});this.milestones.push({year:Math.floor(e.year),kind:`结局`,text:n.name});let r=sr({actor:t,ledger:e.karmaLedger,milestones:this.milestones,curve:this.curve,flags:e.flags,death:this.death,ending:n,diedAtYear:e.year,seed:this.seed}),i=br({actor:t,ledger:e.karmaLedger,ending:n,seed:this.seed,serialIndex:this.registry.steleCount+1,birthYear:this.birthYear,diedAtYear:e.year,goldFingers:[...e.systems,...t.souls.map(e=>e.name)],verdictShort:en($t(t))}),a=nr(t,n,{noSystem:e.flags.has(`无系统`)});Tr(this.registry,{actor:t,ending:n,stele:i,place:e.location,signature:this.signature(),unfinished:r.unfinished,relics:this.relics(),daoFruit:a});for(let t of e.systems)this.registry.unlockedSystems.includes(t)||this.registry.unlockedSystems.push(t);let o=bo({daoName:t.name,seed:this.seed,beats:this.beats,chronicle:r,stele:i,signature:this.signature()});return this.finished={ending:n,chronicle:r,stele:i,daoFruit:a,novel:o,novelChars:xo(o)},this.finished}signature(){let e=this.ctx.flags;return e.has(`道·剑`)?`挡我者，斩。`:e.has(`道·丹`)?`我要救的人，一个都不能少。`:e.has(`道·苟`)?`谁都可以死，我不行。`:e.has(`道·杀`)?`这世道就是这样，我认。`:e.has(`无系统`)?`我什么都没有。所以我什么都不欠。`:e.has(`拒绝过系统`)?`那东西认的不是我，是「载体」。`:`后生，老夫观你骨骼清奇。`}relics(){let e=[],t=this.ctx.actor;return t.factors.法宝>1.1&&e.push(`一件养过手的法宝`),t.factors.功法>1.2&&e.push(`半部残缺功法`),t.tier>=3&&e.push(`一枚认过主的储物戒`),this.ctx.systems.length&&e.push(`一枚温热的青玉简`),t.goldenCoreGrade>=7&&e.push(`一颗${Rt(t.path,t.goldenCoreGrade)}`),e}},jo=class extends Error{};function Mo(){return{events:new Map,systems:new Map,souls:new Map,locations:new Map,items:new Map,sects:new Map}}function No(e,t,n){if(!n||typeof n!=`object`)return;let r=n,i=(e,n,r)=>{for(let i of e??[]){if(!i?.id)throw new jo(`${t} 存在缺少 id 的${r}`);if(n.has(i.id))throw new jo(`${t} ${r} id 重复：${i.id}`);n.set(i.id,i)}};i(r.events,e.events,`事件`),i(r.systems,e.systems,`系统`),i(r.souls,e.souls,`残魂`),i(r.locations,e.locations,`地点`),i(r.sects,e.sects,`门派`);for(let n of r.items??[]){if(!n?.id)throw new jo(`${t} 存在缺少 id 的物品`);if(e.items.has(n.id))throw new jo(`${t} 物品 id 重复：${n.id}`);try{e.items.set(n.id,Ue(n))}catch(e){throw new jo(`${t} 物品 '${n.id}' 不合法：${e.message}`)}}}function Po(e){let t=Mo();for(let{path:n,doc:r}of e)No(t,n,r);return t}var Q={status:`loading`,done:0,total:0,db:null,error:null},Fo=new Set;function Io(){for(let e of Fo)e(Q)}function Lo(e){Q={...Q,...e},Io()}function Ro(){return Q}function zo(e){return Fo.add(e),e(Q),()=>void Fo.delete(e)}var Bo=new Map,Vo=new Map,Ho=new Map,Uo=null,Wo=null;function Go(){let e=0;for(let t of Bo.values())e+=t;Lo({done:Q.total>0&&e>Q.total?Q.total:e})}function Ko(e){return e instanceof Error?e.message:String(e)}async function qo(e){let t=`${e}content/manifest.json`,n;try{n=await fetch(t)}catch(e){throw Error(`取不到内容清单（${Ko(e)}）`)}if(!n.ok)throw Error(`取不到内容清单（HTTP ${n.status}）`);let r=await n.json();if(!Array.isArray(r.chunks)||r.chunks.length===0)throw Error(`内容清单为空`);return r}async function Jo(e,t){let n=`${e}content/${t.file}`,r;try{r=await fetch(n)}catch(e){throw Error(`「${t.label}」下载失败（${Ko(e)}）`)}if(!r.ok)throw Error(`「${t.label}」下载失败（HTTP ${r.status}）`);let i,a=r.body;if(!a)i=await r.text(),Bo.set(t.file,t.bytes),Go();else{let e=a.getReader(),n=[],r=0;for(;;){let{done:i,value:a}=await e.read();if(i)break;a&&(n.push(a),r+=a.byteLength,Bo.set(t.file,r),Go())}let o=new Uint8Array(r),s=0;for(let e of n)o.set(e,s),s+=e.byteLength;i=new TextDecoder().decode(o)}let o=JSON.parse(i);if(o.id!==t.id)throw Error(`分片 ${t.file} 内容对不上（${o.id} ≠ ${t.id}）`);return Bo.set(t.file,t.bytes),Go(),o.docs}async function Yo(){let e=`/cangfeng-play/`;Uo??=await qo(e);let t=Uo;Q.total!==t.totalBytes&&Lo({total:t.totalBytes});let n=Po((await Promise.all(t.chunks.map(t=>{let n=Vo.get(t.file);if(n)return Promise.resolve(n);let r=Ho.get(t.file);return r||(r=Jo(e,t).then(e=>(Vo.set(t.file,e),Ho.delete(t.file),e)),r.catch(()=>{Ho.delete(t.file),Bo.delete(t.file),Go()}),Ho.set(t.file,r)),r}))).flat());return qe(n.items.values()),Yr(n.sects.values()),n}function Xo(){return Q.db?Promise.resolve(Q.db):(Wo??=Yo().then(e=>(Wo=null,Lo({status:`ready`,db:e,error:null,done:Q.total}),e),e=>{throw Wo=null,Lo({status:`error`,error:Ko(e)}),e}),Wo)}function Zo(){Q.db||(Lo({status:`loading`,error:null}),Xo().catch(()=>{}))}Xo().catch(()=>{});function Qo(){return{version:1,registry:Cr(),steles:[]}}function $o(e){if(!e)return Qo();try{let t=JSON.parse(e);return t.version!==1||!t.registry||!Array.isArray(t.steles)?Qo():t}catch{return Qo()}}function es(e){let t={};for(let n of e.steles)t[n.grade]=(t[n.grade]??0)+1;return t}var ts=`cangfeng-save-v1`;function ns(){try{return $o(localStorage.getItem(ts))}catch{return Qo()}}function rs(e){try{localStorage.setItem(ts,JSON.stringify(e))}catch{}}var is=`cangfeng-run-v1`;function as(e,t){try{localStorage.setItem(is,JSON.stringify({snap:e,pov:t,savedAt:Date.now()}))}catch{}}function os(e){let t=e?.snap;return!t||t.v!==1||!t.actor||typeof t.actor!=`object`||!t.rng||typeof t.rng.state!=`number`||!Array.isArray(t.flags)||!Array.isArray(t.beats)?!1:typeof t.seed==`string`&&typeof t.tick==`number`}function ss(){try{let e=localStorage.getItem(is);if(!e)return null;let t=JSON.parse(e);return os(t)?t:null}catch{return null}}function cs(){localStorage.removeItem(is)}var ls=`<svg viewBox="0 0 390 420" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,us=`<svg viewBox="0 0 390 80" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`,ds={tianshu:`<svg viewBox="0 0 240 110" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true">
  <defs>
...
</svg>`},fs={冲突:`<svg viewBox="0 0 390 90" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},Ds={evt_diyitiao_renming:`<svg viewBox="0 0 390 240" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
  <defs>
...
</svg>`},Os={...Es,...Ds},ks={cheap:{title:e=>`— ${e.split(``).join(` `)} v1.0 —`,greet:`尊贵的宿主，欢迎回来！`,act:`今 日 签 到`,fine:`* 签到即留痕。系统提醒宿主：天机可循，慎用。`},data:{title:e=>`[ ${e} ]`,greet:`模块就绪。数据流同步完成。`,act:`执 行`,fine:`// 每次调用都会在天机中留下一条记录`},ink:{title:e=>`${e}`,greet:`心念微动，那物应了一声。`,act:`运 转`,fine:`用之有度。器不欺主，主亦不当欺器。`},terminal:{title:e=>`root@heaven:~# ${e}`,greet:`> 权限校验通过。当前身份：临时执法者（编号待定）`,act:`EXEC`,fine:`# 所有操作计入天规日志，由下一任天道审计`},meta:{title:e=>`${e}`,greet:`……你确定这是游戏的一部分吗？`,act:`继 续`,fine:`（这段文字不应该出现在这里。）`}};function As(e){let[t,n]=(0,r.useState)(0),i=e.systems[t];if(!i)return(0,$.jsx)($.Fragment,{});let a=ks[i.skin]??ks.data,o=i.id===`签到`,s=e.session.beats,c=s.length>0?s[s.length-1].text:``,l=c.includes(i.name)||c.includes(i.id);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sys-panel skin-${i.skin} fade-in`,children:[e.systems.length>1&&(0,$.jsx)(`div`,{className:`sys-switch`,children:e.systems.map((e,r)=>(0,$.jsx)(`button`,{className:`sys-chip ${r===t?`on`:``}`,onClick:()=>n(r),children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`sys-title`,children:a.title(i.name)}),(0,$.jsx)(`div`,{className:`sys-line`,children:a.greet}),(0,$.jsx)(`div`,{className:`sys-line sys-desc`,children:i.desc}),o&&(0,$.jsx)(`button`,{className:`sys-btn`,onClick:e.onAct,children:a.act}),l&&(0,$.jsx)(`div`,{className:`sys-line sys-log`,children:c}),(0,$.jsxs)(`div`,{className:`sys-line sys-cost`,children:[`代价：`,i.cost]}),(0,$.jsx)(`div`,{className:`sys-line sys-fine`,children:a.fine}),(0,$.jsx)(`button`,{className:`linklike`,style:{marginTop:10},onClick:e.onClose,children:`关闭`})]})]})}var js=[`法宝`,`符箓`,`丹药`,`功法`,`材料`,`杂物`,`灵石`],Ms=`零一二三四五六七八九`,Ns=[``,`十`,`百`,`千`];function Ps(e){if(!Number.isFinite(e)||e<0||e===0)return`零`;if(e>999)return String(e);let t=String(e),n=``,r=!1;for(let e=0;e<t.length;e++){let i=Number(t[e]),a=t.length-e-1;if(i===0){r=!0;continue}r&&n&&(n+=`零`),r=!1,(i!==1||a!==1||e!==0)&&(n+=Ms[i]),n+=Ns[a]}return n}function Fs(e){return e>=1e5?`${Math.floor(e/1e4)}万`:e>=1e4?`${(e/1e4).toFixed(1)}万`:String(e)}function Is(e){return String(e).replace(/\B(?=(\d{3})+(?!\d))/g,`,`)}function Ls(e){let{session:t}=e,n=e.transform,[i,a]=(0,r.useState)(`全部`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),[,f]=(0,r.useState)(0),p=t.bag(),m=t.bagSlots(),h=t.stones(),g=t.inventory(),_=ht(g),ee=t.ctx.actor.tier,v=ve(g.container),y=m.free===0?st(g):null,b=e=>`${e.def.id}|${R(e.stack)}`,x=o?p.find(e=>b(e)===o)??p.find(e=>e.def.id===o.split(`|`)[0])??null:null,S=()=>{e.onAct(),f(e=>e+1)},C=(e,n)=>{l({ok:e.ok,text:e.text}),S(),e.ok&&!t.bag().some(e=>e.def.id===n)&&s(null)},te=(e,n)=>{let r=t.inventory().container,i=t.useItem(e);if(C(i,e),i.ok&&n){let e=t.inventory().container;if(e!==r){let t=ve(e);d({name:t.id,note:t.note}),setTimeout(()=>d(null),2200)}}},w=new Map;for(let e of p)w.set(e.def.category,(w.get(e.def.category)??0)+1);let ne=js.filter(e=>w.has(e)),T=i===`全部`?p:p.filter(e=>e.def.category===i),E=i===`全部`?Math.min(m.free,12):0,D=i===`全部`?m.free-E:0,re=e=>p.find(t=>t.stack.equipped===e),ie=c?(0,$.jsx)(`div`,{className:`bag-msg ${c.ok?`good`:`bad`}`,children:n(c.text)}):null;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay bag-overlay`,onClick:e.onClose}),(0,$.jsxs)(`div`,{className:`sheet bag-sheet fade-in`,role:`dialog`,"aria-label":`行囊`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`行囊`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:v.id}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onClose,children:`收起`})]}),(0,$.jsxs)(`div`,{className:`bag-cap`,children:[(0,$.jsxs)(`div`,{className:`bag-cap-line`,children:[(0,$.jsxs)(`b`,{children:[Ps(m.total),`格`]}),(0,$.jsxs)(`span`,{children:[`，`,m.used===0?`空着`:`已满${Ps(m.used)}`]}),(0,$.jsx)(`i`,{className:m.free===0?`full`:``,children:m.free===0?`再装不下了`:`余 ${Ps(m.free)} 格`})]}),(0,$.jsx)(`div`,{className:`bag-bar`,children:(0,$.jsx)(`i`,{className:m.free===0?`full`:``,style:{width:`${Math.min(100,Math.round(m.used/Math.max(1,m.total)*100))}%`}})}),(0,$.jsx)(`div`,{className:`bag-note`,children:v.note}),y&&(0,$.jsxs)(`div`,{className:`bag-warn`,children:[`装满了。最不值钱的是`,(0,$.jsx)(`b`,{children:Ve(y.def,R(y.stack))}),`（约值 `,Is(Math.round(Xe(y.stack))),` 下品）—— 要腾地方，先舍它。`]})]}),(0,$.jsxs)(`div`,{className:`bag-purse`,children:[(0,$.jsxs)(`span`,{className:`bp-sum`,children:[`⟡ `,Is(h),` `,(0,$.jsx)(`i`,{children:`折下品`})]}),(0,$.jsxs)(`span`,{className:`bp-split`,children:[he.map(e=>_[e]>0?(0,$.jsxs)(`em`,{children:[e,` `,_[e]]},e):null),h===0&&(0,$.jsx)(`em`,{className:`none`,children:`身无分文`})]})]}),_.极品>0&&(0,$.jsxs)(`div`,{className:`bag-jstone`,children:[(0,$.jsx)(`span`,{className:`bj-mark`,children:`✦`}),(0,$.jsxs)(`span`,{className:`bj-t`,children:[`极品灵石 `,(0,$.jsxs)(`b`,{children:[`×`,_.极品]})]}),(0,$.jsx)(`span`,{className:`bj-x`,children:`这不是钱。市面上没有摊主找得开 —— 付账时它不会被拆开， 除非低阶灵石实在凑不出，才会有一枚被迫破开。`})]}),(0,$.jsx)(`div`,{className:`bag-ladder`,children:ge.map(e=>(0,$.jsx)(`span`,{className:`bl-step ${e.id===v.id?`on`:e.slots<v.slots?`past`:``}`,title:`${e.slots} 格 · ${e.note}`,children:e.id},e.id))}),(0,$.jsx)(`div`,{className:`bag-slots-row`,children:He.map(e=>{let t=re(e);return(0,$.jsxs)(`button`,{className:`eq-slot ${t?`on`:``}`,onClick:()=>t&&s(b(t)),disabled:!t,children:[(0,$.jsx)(`i`,{children:e}),(0,$.jsx)(`b`,{className:t?`r-${t.def.grade-1}`:``,children:t?Ve(t.def,R(t.stack)):`空`})]},e)})}),!x&&ie,ne.length>1&&(0,$.jsxs)(`div`,{className:`bag-tabs`,children:[(0,$.jsxs)(`button`,{className:`bag-tab ${i===`全部`?`on`:``}`,onClick:()=>a(`全部`),children:[`全部 `,p.length]}),ne.map(e=>(0,$.jsxs)(`button`,{className:`bag-tab ${i===e?`on`:``}`,onClick:()=>a(e),children:[e,` `,w.get(e)]},e))]}),(0,$.jsxs)(`div`,{className:`bag-grid`,children:[T.map((e,t)=>{let n=R(e.stack),r=!L(e.def)&&n!==2;return(0,$.jsxs)(`button`,{className:`bag-slot r-${e.def.grade-1} ${e.stack.equipped?`on`:``}`,style:e.def.slots>1?{gridColumn:`span 2`}:void 0,onClick:()=>{s(b(e)),l(null)},children:[(0,$.jsx)(`span`,{className:`bs-name`,children:e.def.name}),(0,$.jsxs)(`span`,{className:`bs-foot`,children:[(0,$.jsx)(`i`,{className:`bs-grade${e.def.grade>=6?` top`:``}`,children:Ae(e.def.grade)}),r&&(0,$.jsx)(`i`,{className:`bs-q q${n}`,children:Re(n)}),e.stack.qty>1&&(0,$.jsxs)(`i`,{className:`bs-qty`,children:[`×`,e.stack.qty]})]}),e.stack.equipped&&(0,$.jsx)(`span`,{className:`bs-eq`,children:`佩`}),e.def.slots>1&&(0,$.jsxs)(`span`,{className:`bs-big`,children:[`占`,Ps(e.def.slots),`格`]})]},`${e.def.id}-${t}`)}),Array.from({length:E},(e,t)=>(0,$.jsx)(`span`,{className:`bag-slot empty`,"aria-hidden":`true`},`e${t}`))]}),T.length===0&&(0,$.jsx)(`div`,{className:`bag-empty`,children:i===`全部`?`空空如也。修士的第一件家当，多半是别人不要的。`:`没有${i}。`}),D>0&&(0,$.jsxs)(`div`,{className:`bag-note`,style:{textAlign:`center`,marginTop:8},children:[`另余 `,D,` 格`]})]}),x&&(()=>{let e=x.def,r=R(x.stack),i=!!x.stack.equipped,a=e.container?ve(e.container):null,o=a?a.slots<=v.slots?`${v.id}比${a.id}还宽敞，换了是往回走`:ee<a.minTier?`神识撑不开${a.id} —— 须得${a.minTier}阶以上`:null:null,c=e.equip?.minTier!=null&&ee<e.equip.minTier,u=!!a||!!e.use&&e.use.length>0;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay detail-overlay`,onClick:()=>{s(null),l(null)}}),(0,$.jsxs)(`div`,{className:`bag-detail fade-in`,role:`dialog`,"aria-label":e.name,children:[(0,$.jsxs)(`div`,{className:`bd-head`,children:[(0,$.jsx)(`span`,{className:`bd-name r-${e.grade-1}`,children:Ve(e,r)}),(0,$.jsxs)(`span`,{className:`bd-tag${e.grade>=6?` top`:``}`,children:[Ae(e.grade),` · `,e.category]}),i&&(0,$.jsxs)(`span`,{className:`bd-worn`,children:[`佩于`,x.stack.equipped]})]}),(0,$.jsx)(`div`,{className:`bd-desc`,children:n(e.desc)}),e.grade>=6&&(0,$.jsxs)(`div`,{className:`bd-uniq`,children:[(0,$.jsx)(`span`,{className:`bu-mark`,children:`✦`}),e.stone?`不是钱。没有摊主找得开 —— 除非低阶灵石实在凑不出，付账时它不会被拆开。`:`世上只此一件。它不会有第二件，前主人的账也一并转到了你身上。`]}),(0,$.jsxs)(`div`,{className:`bd-meta`,children:[(0,$.jsxs)(`span`,{children:[`占 `,Ps(e.slots),` 格`]}),(0,$.jsxs)(`span`,{children:[`值 `,Is(Math.round(e.value*(L(e)?1:Ie[r]))),` 下品`]}),x.stack.qty>1&&(0,$.jsxs)(`span`,{children:[`身上 `,x.stack.qty,` 件`]}),e.talisman&&(0,$.jsxs)(`span`,{children:[e.talisman,`符`]})]}),e.equip&&(0,$.jsxs)(`div`,{className:`bd-equip`,children:[(0,$.jsx)(`b`,{children:e.equip.slot}),Object.entries(e.equip.factors).map(([e,t])=>(0,$.jsxs)(`span`,{className:`bd-fac`,children:[e,` +`,t.toFixed(2)]},e))]}),c&&!i&&(0,$.jsx)(`div`,{className:`bd-warn`,children:`越阶用宝：佩得上，但压不住 —— 明眼人一看便知你身后有人（真实修为暴露）。`}),a&&!o&&(0,$.jsxs)(`div`,{className:`bd-hint`,children:[`换用之后可装 `,a.slots,` 格。`,a.note]}),o&&(0,$.jsx)(`div`,{className:`bd-warn`,children:o}),!u&&!e.equip&&!(e.grade>=6&&e.stone)&&(0,$.jsx)(`div`,{className:`bd-hint`,children:e.stone?`钱不必手动动它 —— 付账时自会拆开找零。`:`用不上。但总有人要，也总有人认得。`}),ie,(0,$.jsxs)(`div`,{className:`bd-acts`,children:[e.equip&&(i?(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>C(t.unequipItem(e.id),e.id),children:`卸 下`}):(0,$.jsx)(`button`,{className:`primary-btn slim`,onClick:()=>C(t.equipItem(e.id),e.id),children:`佩 上`})),u&&(0,$.jsx)(`button`,{className:`primary-btn slim`,disabled:!!o,onClick:()=>te(e.id,!!a),children:a?`换 用`:e.category===`丹药`?`服 下`:`用 掉`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{s(null),l(null)},children:`收 起`})]})]})]})})(),u&&(0,$.jsxs)(`div`,{className:`bag-flash`,onClick:()=>d(null),children:[(0,$.jsx)(`div`,{className:`bf-word`,children:u.name}),(0,$.jsx)(`div`,{className:`bf-sub`,children:u.note})]})]})}var Rs={oracle:`坊市街口的卦摊。几个铜板一卦 —— 问得多了，天也会烦。`,relic:`荒山野岭的旧坟古洞。前人的东西好拿，前人的账也跟着来。`,alchemy:`自己开炉。费材料费时间，但炉子是自己的。`},zs={CRIT_SUCCESS:{label:`大成`,cls:`s-crit`},SUCCESS:{label:`成`,cls:`s-ok`},FAIL:{label:`败`,cls:`s-fail`},CRIT_FAIL:{label:`大凶`,cls:`s-cfail`}};function Bs(e){if(!(e>0))return`—`;let t=e*100;return t>=1?`${t.toFixed(1)}%`:t>=.1?`${t.toFixed(2)}%`:`${t.toFixed(4)}%`}function Vs(e){let t=Math.round(e*100);return t>=80?`八九成`:t>=60?`六七成`:t>=40?`四五成`:t>=20?`两三成`:`一线`}function Hs(e){let t=e.session.ctx.actor,n=[],r=t.lifespanYears-t.ageMonths/12;r<15&&n.push({text:`寿余${Math.max(0,r).toFixed(0)}`,cls:`hot`}),t.僭越>=51&&n.push({text:`僭越${Math.round(t.僭越)}`,cls:t.僭越>=101?`hot`:`warn`}),t.堕度>=46&&n.push({text:`堕度${Math.round(t.堕度)}`,cls:t.堕度>=76?`hot`:`warn`}),t.丹毒>=50&&n.push({text:`丹毒${Math.round(t.丹毒)}`,cls:t.丹毒>=80?`hot`:`warn`});let i=t.souls.find(e=>!e.dissipated&&e.possession>=60);return i&&n.push({text:`魂扰${Math.round(i.possession)}`,cls:i.possession>=85?`hot`:`warn`}),n.slice(0,2)}function Us(e){return e.page.player.length>0||e.page.auto.length>0||e.page.loose.length>0||e.page.transition!==null||e.stamp!==null||e.chips.length>0}function Ws(e){let{session:t,pov:n,name:i}=e.game,a=e=>za(e,n,i),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(`event`),[u,d]=(0,r.useState)(null),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(!1),[g,_]=(0,r.useState)(!1),[ee,v]=(0,r.useState)(!1),[b,x]=(0,r.useState)(null),[S,C]=(0,r.useState)(null),[te,w]=(0,r.useState)(!1),[ne,T]=(0,r.useState)(!1),[E,D]=(0,r.useState)(null),[re,ie]=(0,r.useState)([]),[ae,O]=(0,r.useState)(`oracle`),[k,oe]=(0,r.useState)(!1),[A,se]=(0,r.useState)(null),[,ce]=(0,r.useState)(0),j=(0,r.useRef)(0),M=(0,r.useRef)(!1),le=(0,r.useRef)(null),ue=e=>{let n=t.gatherPage(j.current);j.current=n.cursor,t.notices.length=0;let r=t.lastOutcome?zs[t.lastOutcome]??null:null,i=[...t.lastDeltas];return t.lastOutcome=null,t.lastDeltas=[],{stamp:r,chips:i,page:n.page,fromYear:e,toYear:Math.floor(t.ctx.year)}},N=(r,i)=>{C(null),v(!1);let a=ue(i);if(r.kind===`gameover`){Us(a)?(d(a),l(`between`),s(r)):e.onOver(r.result);return}s(r),Us(a)?(d(a),l(`between`)):l(`event`);let o=t.snapshot();o&&as(o,n)};(0,r.useEffect)(()=>{if(M.current)return;if(M.current=!0,t.beats.length>0){j.current=t.beats.length;let n=t.currentPrompt();if(n){if(n.kind===`gameover`){e.onOver(n.result);return}s(n),l(`event`);return}}let n=Math.floor(t.ctx.year);N(t.advance(),n)},[]),(0,r.useEffect)(()=>{window.scrollTo({top:0})},[c,o]);let de=e=>{if(!o||o.kind!==`event`)return;let n=Math.floor(t.ctx.year),r=t.choose(e);N(r,n)},fe=e=>{if(!o||o.kind!==`event`||ee)return;let t=o.choices[e];if(t){if(wo(o.card,t)&&S!==e){C(e);return}C(null),t.check?(v(!0),setTimeout(()=>de(e),520)):de(e)}},pe=(e,n)=>{if(!o||o.kind!==`breakthrough`)return;let r=Math.floor(t.ctx.year),i=t.decideBreakthrough(e,n);t.lastBreakthrough&&e&&(x(t.lastBreakthrough),setTimeout(()=>x(null),2e3)),N(i,r)},me=()=>{if(o?.kind===`gameover`){e.onOver(o.result);return}l(`event`)},P=(e,t)=>{if(!e)return null;let n=e===`命关`?fs.命关:Os[e];return n?(0,$.jsx)(`div`,{className:`card-art scene-art`,dangerouslySetInnerHTML:{__html:n}},e):(0,$.jsx)(`div`,{className:`card-orn`,dangerouslySetInnerHTML:{__html:Ts(t)}},`orn-${e}`)},he=(e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`mini-scene`,children:[e.title&&(0,$.jsxs)(`span`,{className:`mini-t`,children:[`【`,e.title,`】`]}),(0,$.jsxs)(`span`,{className:`mini-x`,children:[a(e.text).split(`
`)[0],`…`]})]},t):e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome`,children:a(e.text)},t):e.kind===`milestone`?(0,$.jsxs)(`div`,{className:`milestone`,children:[`◈ `,a(e.text)]},t):e.kind===`transition`?(0,$.jsx)(`div`,{className:`passage`,children:a(e.text)},t):(0,$.jsx)(`div`,{className:`notice`,children:a(e.text)},t),ge=e=>{let t=a(e).split(`
`).filter(e=>e.trim()!==``);return t.length>1?`${t[0]}…`:t[0]??``},_e=e=>{let t=e.beats.find(e=>e.kind===`scene`),n=e.beats.find(e=>e.kind===`choice`),r=e.beats.find(e=>e.kind===`outcome`);return(0,$.jsxs)(`div`,{className:`years-unit`,children:[t&&(0,$.jsxs)(`div`,{className:`yu-scene`,children:[t.title&&(0,$.jsxs)(`span`,{className:`yu-t`,children:[`【`,t.title,`】`]}),(0,$.jsx)(`span`,{children:ge(t.text)})]}),n&&(0,$.jsxs)(`div`,{className:`yu-choice`,children:[`——`,a(n.text)]}),r&&(0,$.jsx)(`div`,{className:`yu-outcome`,children:ge(r.text)})]},e.episodeId)},ve=()=>{if(!u)return null;let{page:e}=u,t=u.toYear-u.fromYear,n=e.player.flatMap(e=>e.beats.filter(e=>e.kind!==`scene`));return(0,$.jsxs)(`div`,{className:`page-card`,ref:le,children:[(0,$.jsx)(`div`,{className:`between-head`,children:(0,$.jsx)(`div`,{className:`year-mark`,children:t>1?`第 ${u.fromYear} — ${u.toYear} 年`:`第 ${u.toYear} 年`})}),(0,$.jsxs)(`div`,{className:`between-body`,children:[(u.stamp||u.chips.length>0||n.length>0)&&(0,$.jsxs)(`section`,{className:`res-player`,children:[u.stamp&&(0,$.jsx)(`div`,{className:`stamp-row`,children:(0,$.jsx)(`span`,{className:`stamp ${u.stamp.cls}`,children:u.stamp.label})}),u.chips.length>0&&(0,$.jsx)(`div`,{className:`delta-chips`,children:u.chips.map((e,t)=>(0,$.jsx)(`span`,{className:`dchip d-${e.kind}`,children:e.text},t))}),n.map((e,t)=>e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome`,children:a(e.text)},t):he(e,t))]}),e.loose.map(he),e.auto.length>0&&(0,$.jsxs)(`section`,{className:`years-sec`,children:[(0,$.jsx)(`div`,{className:`years-head`,children:`这些年里`}),e.auto.map(_e)]})]}),e.transition&&(0,$.jsx)(`div`,{className:`passage trans`,children:a(e.transition.text)}),(0,$.jsx)(`div`,{className:`page-foot`,children:(0,$.jsx)(`button`,{className:`primary-btn`,onClick:me,children:o?.kind===`gameover`?`盖 棺`:`继 续`})})]})},F=()=>{if(!o)return null;if(o.kind===`event`){let e=o.card.tags?.includes(`岔路`),t=a(o.text).split(`
`).filter(e=>e.trim()!==``),n=.1,r=Math.min(t.length*n+.2,1.3);return(0,$.jsxs)(`div`,{className:`page-card`,ref:le,children:[P(o.card.id,o.card.tags),(0,$.jsxs)(`div`,{className:`page-body`,children:[e&&(0,$.jsx)(`div`,{className:`fork-badge rv`,children:`岔 · 人生节点`}),(0,$.jsxs)(`div`,{className:`t rv`,children:[`【`,o.card.title,`】`]}),t.map((e,t)=>(0,$.jsx)(`p`,{className:`rv`,style:{animationDelay:`${Math.min(t*n,1.1)}s`},children:e},t))]}),(0,$.jsx)(`div`,{className:`page-foot`,children:ee?(0,$.jsx)(`div`,{className:`roll`,children:`天 机 演 算`}):(0,$.jsx)(`div`,{className:`inline-choices rv`,style:{animationDelay:`${r}s`},children:o.choices.map((e,t)=>{if(S===t){let n=Co(o.card,e);return(0,$.jsxs)(`div`,{className:`confirm-block`,children:[(0,$.jsx)(`div`,{className:`confirm-choice`,children:a(e.text)}),(0,$.jsx)(`div`,{className:`risk-tags`,children:n.map((e,t)=>(0,$.jsx)(`span`,{className:`risk-tag r-${e.level}`,children:e.text},t))}),(0,$.jsxs)(`div`,{className:`confirm-row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>C(null),children:`再想想`}),(0,$.jsx)(`button`,{className:`confirm-go`,onClick:()=>fe(t),children:`依此而行`})]})]},t)}return(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>fe(t),children:[(0,$.jsx)(`span`,{className:`idx`,children:t+1}),a(e.text),wo(o.card,e)&&(0,$.jsx)(`span`,{className:`grave-mark`,children:`重`}),e.check&&(0,$.jsx)(`span`,{className:`check-mark`,children:`占`})]},t)})})})]},o.card.id)}if(o.kind!==`breakthrough`)return null;let e=t.ctx.actor;return(0,$.jsxs)(`div`,{className:`page-card`,ref:le,children:[P(`命关`),(0,$.jsxs)(`div`,{className:`page-body`,children:[(0,$.jsx)(`div`,{className:`t rv`,children:`【命关】`}),(0,$.jsx)(`p`,{className:`rv`,style:{animationDelay:`0.1s`},children:a(`修为已至大圆满，气机满盈，可冲击【${H(t.ctx.actor.path,o.toTier)}】。\n你掂量了一下 —— 约莫${Vs(o.estimate)}把握。`)})]}),(0,$.jsx)(`div`,{className:`page-foot`,children:(0,$.jsxs)(`div`,{className:`inline-choices rv`,style:{animationDelay:`0.4s`},children:[(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>pe(!0,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`1`}),`冲关`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>pe(!0,!0),children:[(0,$.jsx)(`span`,{className:`idx`,children:`2`}),`稳中求进，兼冲隐藏之境`,e.道心>58?``:`（道心尚浅，凶险）`]}),(0,$.jsxs)(`button`,{className:`choice-btn`,onClick:()=>pe(!1,!1),children:[(0,$.jsx)(`span`,{className:`idx`,children:`3`}),`再温养几年`]})]})})]},`bt-${t.ctx.tick}`)},I=t.ctx.actor,ye=H(I.path,I.tier),be=Wt(I.path,I.tier,I.sublevel);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`topbar`,children:[(0,$.jsx)(`button`,{className:`tb-name`,onClick:()=>p(!0),children:i}),(0,$.jsxs)(`button`,{className:`tb-sub`,onClick:()=>p(!0),children:[be,I.tier<10?` ${Math.round(I.sublevel*100)}%`:``,` · `,Math.floor(t.ctx.year),`年`]}),(0,$.jsx)(`span`,{className:`grow`}),Hs(e.game).map((e,t)=>(0,$.jsx)(`span`,{className:`chip ${e.cls}`,children:e.text},t)),(()=>{let e=t.bagSlots(),n=e.free===0;return(0,$.jsxs)(`button`,{className:`tb-bag ${n?`full`:``}`,onClick:()=>T(!0),"aria-label":`行囊，${t.stones()} 下品灵石，${e.used} 之 ${e.total} 格`,title:n?`${e.container} 已满`:e.container,children:[(0,$.jsxs)(`span`,{className:`tbb-stone`,children:[`⟡`,Fs(t.stones())]}),(0,$.jsxs)(`span`,{className:`tbb-slot`,children:[e.used,`/`,e.total]})]})})(),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>_(!0),children:`回顾`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onQuit,children:`搁笔`})]}),(0,$.jsx)(`div`,{className:`realm-bar`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(I.sublevel*100)}%`}})}),c===`between`?ve():F(),b&&(0,$.jsxs)(`div`,{className:`bt-overlay ${b.ok?`bt-ok`:`bt-fail`}`,onClick:()=>x(null),children:[(0,$.jsx)(`div`,{className:`bt-word`,children:b.ok?b.name:`劫`}),(0,$.jsx)(`div`,{className:`bt-sub`,children:b.ok?b.hidden?`且入隐秘之境`:`境界已成`:`未过 · ${b.name}`}),b.ok&&I.goldenCoreGrade>0&&I.tier===3&&(0,$.jsx)(`div`,{className:`bt-core ${y(I.goldenCoreGrade)?`top`:``}`,children:Rt(I.path,I.goldenCoreGrade)})]}),t.availablePools().length===0?null:(0,$.jsx)(`button`,{className:`oracle-pill`,onClick:()=>{w(!0),se(null),D(null),ie([])},children:`✦ 机缘`}),te&&(()=>{let e=t.availablePools(),r=e.find(e=>e.id===ae)??e[0],i=t.poolInfo(r.id),o=()=>{if(k)return;D(null);let e=t.poolInfo(r.id);if(e&&!e.affordable){D(e.missing.map(e=>e.text).join(`；`));return}oe(!0),se(null),setTimeout(()=>{let e=t.tryDrawFrom(r.id);ie(t.notices.slice(1)),j.current=t.beats.length,t.notices.length=0,se(e.result??null),e.ok||D(e.reason??`这一卦求不得`),oe(!1),ce(e=>e+1);let i=t.snapshot();i&&as(i,n)},900)},s=(A?.prize.effects??[]).map(e=>/^give\s+(\S+)/.exec(e)?.[1]).filter(e=>!!e).map(e=>B(e)).find(e=>e?.equip&&t.bag().some(t=>t.def.id===e.id&&!t.stack.equipped));return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>!k&&w(!1)}),(0,$.jsxs)(`div`,{className:`oracle-panel fade-in`,children:[(0,$.jsx)(`div`,{className:`oracle-tabs`,children:e.map(e=>(0,$.jsx)(`button`,{className:`oracle-tab ${e.id===r.id?`on`:``}`,onClick:()=>{O(e.id),se(null),D(null),ie([])},children:e.name},e.id))}),(0,$.jsx)(`div`,{className:`oracle-stage`,children:k?(0,$.jsx)(`div`,{className:`oracle-shake`,children:`签 筒 摇 动`}):A?(0,$.jsxs)(`div`,{className:`oracle-prize r-${ai.indexOf(A.rarity)}`,children:[(0,$.jsx)(`div`,{className:`op-rarity`,children:A.rarity===`极品`?`✦ 极 品 ✦`:A.rarity}),(0,$.jsx)(`div`,{className:`op-name`,children:A.prize.name}),(0,$.jsx)(`div`,{className:`op-desc`,children:a(A.prize.desc)}),A.rarity===`极品`&&(0,$.jsx)(`div`,{className:`op-uniq`,children:`此物世上只此一件。你拿了它，就不会再有第二件。`}),A.byPity&&(0,$.jsx)(`div`,{className:`op-pity`,children:`连番落空之后，天道补了你一次`})]}):(0,$.jsx)(`div`,{className:`oracle-idle`,children:Rs[r.id]??``})}),re.length>0&&!k&&(0,$.jsx)(`div`,{className:`oracle-notes`,children:re.map((e,t)=>(0,$.jsx)(`div`,{className:`on-line`,children:a(e)},t))}),s&&!k&&(0,$.jsxs)(`button`,{className:`oracle-wear`,onClick:()=>{let e=t.equipItem(s.id);ie(t=>[...t,e.text]),j.current=t.beats.length,t.notices.length=0,ce(e=>e+1);let r=t.snapshot();r&&as(r,n)},children:[`即刻佩上「`,s.name,`」（`,s.equip?.slot,`）`]}),i&&(()=>{let e=pi(I,r,t.gacha),n=i.odds.极品,a=t.gacha,o=(r.prizes.极品?.length??0)>0,s=I.tier>=W.minTier,c=I.气运>=W.minLuck,l=H(I.path,W.minTier),u=[{ok:s,text:s?`修为已至【${l}】`:`修为须至【${l}】—— 今为【${ye}】`},{ok:c,text:c?`气运 ${Math.round(I.气运)}，已过 ${W.minLuck} 这道坎`:`气运须过 ${W.minLuck} —— 今为 ${Math.round(I.气运)}`},{ok:!!a.seenSecret,text:a.seenSecret?`本局已亲见过一件秘藏`:`本局须亲见过一件秘藏 —— 没见过的东西，天不会先给你`}];a.supremeTaken&&u.push({ok:!1,text:`此生已得过一件独一无二之物 —— 天不予二`}),o||u.push({ok:!1,text:`${r.name}里本就没有这样的东西`});let d=!e.ok&&u.every(e=>e.ok)?e.reasons:[],f=Math.max(0,ci.threshold-i.pityLeft);return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`odds-bar`,children:ai.map((e,t)=>e===`极品`?n>0?(0,$.jsx)(`div`,{className:`odds-seg r-5 hair`,title:`极品 ${Bs(n)}`},e):null:(0,$.jsx)(`div`,{className:`odds-seg r-${t}`,style:{flex:Math.max(.02,i.odds[e])},title:`${e} ${Bs(i.odds[e])}`},e))}),(0,$.jsx)(`div`,{className:`odds-legend`,children:ai.map((e,t)=>(0,$.jsxs)(`span`,{className:`ol r-${t}${e===`极品`&&n<=0?` off`:``}`,children:[e,` `,Bs(i.odds[e])]},e))}),(0,$.jsxs)(`div`,{className:`supreme-box ${e.ok?`open`:``}`,children:[(0,$.jsxs)(`div`,{className:`sb-head`,children:[(0,$.jsx)(`span`,{className:`sb-mark`,children:`✦`}),(0,$.jsx)(`span`,{className:`sb-t`,children:`极品`}),(0,$.jsx)(`span`,{className:`sb-x`,children:e.ok?`此刻确在筒里 · ${Bs(n)}`:`此刻不在筒里 —— 摇多少次都不会出`})]}),(0,$.jsxs)(`div`,{className:`sb-list`,children:[u.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li ${e.ok?`yes`:`no`}`,children:[(0,$.jsx)(`i`,{children:e.ok?`✓`:`✗`}),e.text]},t)),d.map((e,t)=>(0,$.jsxs)(`div`,{className:`sb-li no`,children:[(0,$.jsx)(`i`,{children:`✗`}),e]},`f${t}`))]}),(0,$.jsx)(`div`,{className:`sb-fine`,children:`世上只此一件，一局只出一件。`})]}),(0,$.jsxs)(`div`,{className:`pity-row`,children:[(0,$.jsx)(`div`,{className:`pity-bar`,"aria-hidden":`true`,children:(0,$.jsx)(`i`,{style:{width:`${Math.round(f/ci.threshold*100)}%`}})}),(0,$.jsxs)(`div`,{className:`pity-t`,children:[i.pityLeft>0?`再 ${i.pityLeft} 次落空，必得【宝品】以上`:`时来运转已满 —— 下一次必得【宝品】以上`,(0,$.jsxs)(`em`,{children:[`保底只保到宝品／仙品／秘藏这三档。`,(0,$.jsx)(`b`,{children:`极品不在保底之列`}),` —— 攒出来的东西不叫意外。`]})]})]}),(0,$.jsxs)(`div`,{className:`oracle-meta`,children:[`气运 `,Math.round(I.气运),` · 已求 `,i.count,` 次`]})]})})(),(0,$.jsxs)(`div`,{className:`oracle-cost ${i&&!i.affordable?`lack`:``}`,children:[`代价：`,i?.costText??r.costLabel]}),(0,$.jsxs)(`div`,{className:`oracle-purse`,children:[`囊中 ⟡ `,Fs(t.stones()),` 下品 · 余 `,t.bagSlots().free,` 格`]}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:i.missing.map((e,t)=>(0,$.jsx)(`div`,{className:`om-line`,children:e.text},t))}),E&&(0,$.jsx)(`div`,{className:`oracle-missing`,children:(0,$.jsx)(`div`,{className:`om-line`,children:E})}),(0,$.jsx)(`button`,{className:`oracle-btn`,disabled:k||!!i&&!i.affordable,onClick:o,children:k?`……`:i&&!i.affordable?`付 不 起`:`求 一 次`}),i&&!i.affordable&&(0,$.jsx)(`div`,{className:`oracle-fine`,children:`先去挣够了再来 —— 这里从没有免费的运气。`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>!k&&w(!1),children:`收手`})]})]})})(),t.ctx.systems.length>0&&(0,$.jsxs)(`button`,{className:`sys-pill`,onClick:()=>h(!0),children:[(0,$.jsx)(`span`,{className:`sys-dot`}),`系统`]}),m&&(()=>{let n=t.ctx.systems.map(t=>e.game.session.systemDef(t)).filter(e=>!!e);return n.length===0?null:(0,$.jsx)(As,{session:t,systems:n,onClose:()=>h(!1),onAct:()=>{t.signIn(),j.current=t.beats.length,t.notices.length=0,ce(e=>e+1)}})})(),ne&&(0,$.jsx)(Ls,{session:t,transform:a,onClose:()=>T(!1),onAct:()=>{j.current=t.beats.length,t.notices.length=0,ce(e=>e+1);let e=t.snapshot();e&&as(e,n)}}),g&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>_(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:`回顾`}),(0,$.jsx)(`span`,{className:`sheet-sub`,children:`此生至今 · 亦即将来书上的正文`}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>_(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`history-scroll`,children:[t.beats.map((e,t)=>e.kind===`scene`?(0,$.jsxs)(`div`,{className:`scene past`,style:{margin:`14px 0 4px`},children:[e.title&&(0,$.jsxs)(`div`,{className:`t`,children:[`【`,e.title,`】`]}),(0,$.jsx)(`div`,{className:`x`,children:a(e.text)})]},t):e.kind===`choice`?(0,$.jsx)(`div`,{className:`choice-line past`,children:a(e.text)},t):e.kind===`outcome`?(0,$.jsx)(`div`,{className:`outcome`,children:a(e.text)},t):e.kind===`milestone`?(0,$.jsxs)(`div`,{className:`milestone`,children:[`◈ `,a(e.text)]},t):e.kind===`transition`?(0,$.jsx)(`div`,{className:`passage`,children:a(e.text)},t):(0,$.jsx)(`div`,{className:`notice`,children:a(e.text)},t)),t.beats.length===0&&(0,$.jsx)(`div`,{className:`notice`,children:`故事才刚要开始。`})]})]})]}),f&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`sheet-overlay`,onClick:()=>p(!1)}),(0,$.jsxs)(`div`,{className:`sheet fade-in`,children:[(0,$.jsxs)(`div`,{className:`sheet-head`,children:[(0,$.jsx)(`span`,{className:`sheet-title`,children:i}),(0,$.jsxs)(`span`,{className:`sheet-sub`,children:[I.path,I.sect?` · ${Xr(I.sect)?.name??I.sect}`:``,` · `,I.talent.root,` · `,I.originRevealed?`身负「${I.origin}」`:`身世未明`]}),(0,$.jsx)(`button`,{className:`linklike`,onClick:()=>p(!1),children:`收起`})]}),(0,$.jsxs)(`div`,{className:`kv`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`境界`}),(0,$.jsxs)(`b`,{children:[be,`（`,Math.round(I.sublevel*100),`%）`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`近来修行`}),(0,$.jsx)(`b`,{children:Fr(t.stance)})]}),I.goldenCoreGrade>0&&(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`结丹`}),(0,$.jsx)(`b`,{className:y(I.goldenCoreGrade)?`core-top`:``,children:Rt(I.path,I.goldenCoreGrade)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`寿元`}),(0,$.jsxs)(`b`,{children:[Math.floor(I.ageMonths/12),` / `,I.lifespanYears]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`道心`}),(0,$.jsx)(`b`,{children:Math.round(I.道心)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`气运`}),(0,$.jsx)(`b`,{children:Math.round(I.气运)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`功德`}),(0,$.jsx)(`b`,{children:Math.round(I.功德)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`业障`}),(0,$.jsx)(`b`,{children:Math.round(I.业障)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`僭越`}),(0,$.jsx)(`b`,{children:Math.round(I.僭越)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`堕度`}),(0,$.jsx)(`b`,{children:Math.round(I.堕度)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`丹毒`}),(0,$.jsx)(`b`,{children:Math.round(I.丹毒)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`名望`}),(0,$.jsx)(`b`,{children:Math.round(I.名望)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`悟性`}),(0,$.jsx)(`b`,{children:I.talent.悟性})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`根骨`}),(0,$.jsx)(`b`,{children:I.talent.根骨})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`神魂`}),(0,$.jsx)(`b`,{children:I.talent.神魂})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`纯度`}),(0,$.jsx)(`b`,{children:Math.round(I.talent.purity)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`真实战力`}),(0,$.jsx)(`b`,{children:we(I).toFixed(2)})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:`藏拙`}),(0,$.jsxs)(`b`,{children:[Math.round(Te(I)*100),`%`]})]})]}),(t.ctx.systems.length>0||I.souls.some(e=>!e.dissipated))&&(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[t.ctx.systems.length>0&&(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`金手指：`,t.ctx.systems.join(`、`)]}),I.souls.filter(e=>!e.dissipated).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`残魂 `,e.name,` —— 好感 `,Math.round(e.favor),` · 夺舍 `,Math.round(e.possession),`%`]},e.id))]}),(0,$.jsxs)(`div`,{className:`sheet-sec`,children:[(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`未了因果：恶 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity<0).length,`· 善 `,t.ctx.karmaLedger.filter(e=>!e.resolved&&e.polarity>0).length,t.ctx.knowers.length?` · 知情者 ${t.ctx.knowers.length} 人`:``]}),[`金手指`,`残魂`,`真实修为`,`杀过某人`,`身世`].filter(e=>I.secrets[e]>=25).map(e=>(0,$.jsxs)(`div`,{className:`sheet-line`,children:[`暴露 · `,e,`：`,Math.round(I.secrets[e])]},e))]})]})]})]})}function Gs(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Ks(e){return Gs(e).replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`).replace(/`([^`]+)`/g,`<code>$1</code>`)}function qs(e){let t=[],n=!1,r=[],i=[],a=[],o=()=>{a.length&&(t.push(`<p>${a.map(Ks).join(`
`)}</p>`),a=[])},s=()=>{i.length&&(t.push(`<blockquote>${i.map(Ks).join(`
`)}</blockquote>`),i=[])};for(let c of e.split(`
`)){if(c.startsWith("```")){o(),s(),n&&(t.push(`<pre class="mono">${Gs(r.join(`
`))}</pre>`),r.length=0),n=!n;continue}if(n){r.push(c);continue}if(c.startsWith(`### `)){o(),s(),t.push(`<h3>${Ks(c.slice(4))}</h3>`);continue}if(c.startsWith(`## `)){o(),s(),t.push(`<h2>${Ks(c.slice(3))}</h2>`);continue}if(c.startsWith(`# `)){o(),s(),t.push(`<h1>${Ks(c.slice(2))}</h1>`);continue}if(c.trim()===`---`){o(),s(),t.push(`<hr/>`);continue}if(c.startsWith(`> `)||c===`>`){o(),i.push(c.replace(/^> ?/,``));continue}if(c.startsWith(`- `)){o(),s(),t.push(`<li>${Ks(c.slice(2))}</li>`);continue}if(c.trim()===``){o(),s();continue}s(),a.push(c)}return o(),s(),n&&r.length&&t.push(`<pre class="mono">${Gs(r.join(`
`))}</pre>`),t.join(`
`)}function Js(e){let{game:t,result:n}=e,[i,a]=(0,r.useState)(`成书`),[o,s]=(0,r.useState)(t.pov===`我`?`我`:`他`),c=(0,r.useMemo)(()=>o===`他`?n.novel:bo({daoName:t.name,seed:t.seed,beats:t.session.beats,chronicle:n.chronicle,stele:n.stele,signature:t.session.signature(),pov:`我`}),[o,t,n]);return(0,$.jsxs)(`div`,{className:`over fade-in`,children:[(0,$.jsxs)(`div`,{className:`ending-grade`,children:[n.stele.grade,` · `,n.stele.serial]}),(0,$.jsx)(`div`,{className:`ending-name`,children:n.ending.name}),(0,$.jsx)(`div`,{className:`ending-text`,children:n.ending.text}),(0,$.jsxs)(`div`,{className:`ending-text`,style:{marginTop:4},children:[`道果 +`,n.daoFruit,`（累计 `,e.save.registry.daoFruit,`）`]}),(0,$.jsx)(`div`,{className:`tabs`,children:[`成书`,`一生录`,`道碑`].map(e=>(0,$.jsx)(`button`,{className:`tab ${i===e?`on`:``}`,onClick:()=>a(e),children:e},e))}),i===`成书`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`row`,children:[(0,$.jsx)(`button`,{className:`ghost-btn ${o===`他`?`on`:``}`,onClick:()=>s(`他`),children:`传记体`}),(0,$.jsx)(`button`,{className:`ghost-btn ${o===`我`?`on`:``}`,onClick:()=>s(`我`),children:`自述体`}),(0,$.jsx)(`span`,{className:`grow`}),(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:()=>{let e=new Blob([c],{type:`text/markdown;charset=utf-8`}),n=document.createElement(`a`);n.href=URL.createObjectURL(e),n.download=`藏锋录·${t.name}${o===`我`?`自述`:`卷`}.md`,n.click(),URL.revokeObjectURL(n.href)},children:`下载此书`})]}),(0,$.jsx)(`div`,{className:`book`,dangerouslySetInnerHTML:{__html:qs(c)}})]}),i===`一生录`&&(0,$.jsx)(`pre`,{className:`mono`,children:pr(n.chronicle)}),i===`道碑`&&(0,$.jsx)(`pre`,{className:`mono`,children:Sr(n.stele)}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:10},children:(0,$.jsx)(`button`,{className:`primary-btn`,style:{flex:1},onClick:e.onRestart,children:`再 入 轮 回`})}),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`},children:(0,$.jsx)(`button`,{className:`linklike`,onClick:e.onGallery,children:`去碑林看看`})})]})}function Ys(e){let[t,n]=(0,r.useState)(null),i=[...e.save.steles].reverse(),a=es(e.save);return(0,$.jsxs)(`div`,{className:`gallery fade-in`,children:[(0,$.jsx)(`h2`,{children:`碑 林`}),(0,$.jsxs)(`div`,{className:`row`,style:{justifyContent:`center`,color:`var(--dim)`,fontSize:`0.85rem`},children:[Object.entries(a).map(([e,t])=>(0,$.jsxs)(`span`,{children:[e,`×`,t]},e)),i.length===0&&(0,$.jsx)(`span`,{children:`（空山无碑。去走一遭吧。）`})]}),i.map(e=>(0,$.jsxs)(`div`,{className:`stele-item`,onClick:()=>n(t===e.serial?null:e.serial),children:[(0,$.jsxs)(`div`,{className:`sh`,children:[(0,$.jsx)(`span`,{className:`grade`,children:e.grade}),(0,$.jsx)(`span`,{className:`nm`,children:e.daoName}),(0,$.jsxs)(`span`,{className:`meta`,children:[e.ending,` · `,e.finalRealm,` · 寿`,e.lifespan,`载 · 完满度`,e.perfection]}),(0,$.jsx)(`span`,{className:`meta`,children:`★`.repeat(e.rarity)})]}),t===e.serial&&(0,$.jsx)(`pre`,{className:`mono`,style:{marginTop:10},children:Sr(e)})]},e.serial)),(0,$.jsx)(`div`,{className:`row`,style:{justifyContent:`center`,marginTop:12},children:(0,$.jsx)(`button`,{className:`ghost-btn`,onClick:e.onBack,children:`回到入口`})})]})}function Xs(){let[e,t]=(0,r.useState)(Ro);return(0,r.useEffect)(()=>zo(t),[]),e}function Zs({load:e}){let t=e.total>0?e.done/e.total:0;return e.status===`error`?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(vs,{progress:t,label:`香火中断`}),(0,$.jsx)(`div`,{style:{position:`fixed`,inset:0,zIndex:61,pointerEvents:`none`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`flex-end`,paddingBottom:`14vh`},children:(0,$.jsxs)(`div`,{style:{pointerEvents:`auto`,maxWidth:`20rem`,textAlign:`center`},children:[(0,$.jsx)(`div`,{style:{fontSize:`.78rem`,opacity:.75,lineHeight:1.6},children:e.error}),(0,$.jsx)(`button`,{className:`primary-btn`,onClick:Zo,children:`重 燃`})]})})]}):(0,$.jsx)(vs,{progress:t})}function Qs(){let e=Xs(),t=e.db,[n]=(0,r.useState)(()=>ns()),[i,a]=(0,r.useState)(`cover`),[o,s]=(0,r.useState)(null),[c,l]=(0,r.useState)(null),[u,d]=(0,r.useState)(null),f=(e,t)=>{cs();let r=new Ao({seed:t.seed,db:e,registry:n.registry,name:t.name,birthplace:t.birthplace});l({session:r,seed:t.seed,name:t.name,pov:t.pov,birthplace:t.birthplace}),d(null),a(`play`)},p=e=>{let t=ss();if(t)try{let r=new Ao({seed:t.snap.seed,db:e,registry:n.registry,restore:t.snap});l({session:r,seed:t.snap.seed,name:t.snap.name,pov:t.pov}),d(null),a(`play`)}catch{cs()}},m=e=>{t?f(t,e):s({kind:`start`,cfg:e})},h=()=>{t?p(t):s({kind:`resume`})};return(0,r.useEffect)(()=>{!t||!o||(s(null),o.kind===`start`?f(t,o.cfg):p(t))},[t,o]),e.total<=0&&!t?(0,$.jsx)(Zs,{load:e}):(0,$.jsxs)(`div`,{className:`shell`,children:[i===`cover`&&(0,$.jsx)(ys,{save:n,onEnter:()=>a(`start`),onResume:h,onGallery:()=>a(`gallery`)}),i===`start`&&(0,$.jsx)(hs,{save:n,onStart:m,onResume:h,onGallery:()=>a(`gallery`)}),i===`play`&&c&&(0,$.jsx)(Ws,{game:c,onOver:e=>{cs(),n.steles.push(e.stele),rs(n),d(e),a(`over`)},onQuit:()=>a(`start`)}),i===`over`&&c&&u&&(0,$.jsx)(Js,{game:c,result:u,save:n,onRestart:()=>a(`start`),onGallery:()=>a(`gallery`)}),i===`gallery`&&(0,$.jsx)(Ys,{save:n,onBack:()=>a(`cover`)}),o&&(0,$.jsx)(Zs,{load:e})]})}(0,i.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(Qs,{}));